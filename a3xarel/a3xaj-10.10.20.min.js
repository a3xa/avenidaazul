...
{this.jm_bDebug=(ji_bDebug==true);this.jm_bCanEdit=ji_bCanEdit;this.jm_bCanLike=ji_bCanLike;this.jm_sDirBase=(ji_sDirBase?ji_sDirBase:"/");this.jm_sHomeDir=(ji_sHomeDir?ji_sHomeDir:"/");this.jm_sLang=(ji_sLang?ji_sLang:"en");this.jm_sSitemapDate=(ji_sSitemapDate?ji_sSitemapDate:"");this.jm_oGLData=ji_oGLDataJSObject;return true;};this.CheckInitDone=function(){return true;};this.jm_oMgrStorage=null;this.Get_MgrStorage=function(){return this.jm_oMgrStorage;};this.jm_odb=null;this.Set_Database=function(ji_odb){this.jm_odb=ji_odb;return true;};this.Get_Database=function(){return this.jm_odb;};this.jm_oHostReporter=null;this.Set_Reporter=function(ji_oHostReporter)
...
jr_o.jm_odt.jm_o3xJSDS=jr_o.jm_o3xJSDS;jr_o.jm_odt.Set_Glid(jr_o.jm_glid);jr_o.jm_odt.Set_Version(jr_o.jm_header_release);jr_o.jm_odt.jm_oDTStatus.SetCacheStatusSuccess();return(jr_o.jm_odt.jm_oDTStatus.IsSuccess());};return jr_o;}
...
{return ji_TypEntityTarget+","+this.jm_o3xxeid.Get_3xAZNMC2().Get_String()+","+this.jm_o3xxeid.Get_3xPS2().Get_String();}
else if(ji_TypEntityTarget==jg_oe.jc_oEntity.jc_Typ_Category)
{if(!this.jm_o3xxeid.Get_3xCat2().IsEmpty())
return ji_TypEntityTarget+","+this.jm_o3xxeid.Get_3xCat2().Get_String();}
else if(ji_TypEntityTarget==jg_oe.jc_oEntity.jc_Typ_GeoTopArea)
{var jt_o3xaznmc=this.jm_o3xxeid.Get_3xAZNMC2();if(jt_o3xaznmc.Get_A())
return ji_TypEntityTarget+","+jt_o3xaznmc.Get_A();}
else if(ji_TypEntityTarget==jg_oe.jc_oEntity.jc_Typ_GeoArea)
{var jt_o3xaznmc=this.jm_o3xxeid.Get_3xAZNMC2();if(jt_o3xaznmc.Get_Z())
return ji_TypEntityTarget+","+jt_o3xaznmc.Get_String(false,false);}
else if(ji_TypEntityTarget==jg_oe.jc_oEntity.jc_Typ_GeoRegion)
{var jt_o3xaznmc=this.jm_o3xxeid.Get_3xAZNMC2();if(jt_o3xaznmc.Get_N())
return ji_TypEntityTarget+","+jt_o3xaznmc.Get_String(true,false);}
else if(ji_TypEntityTarget==jg_oe.jc_oEntity.jc_Typ_GeoCity)
{var jt_o3xaznmc=this.jm_o3xxeid.Get_3xAZNMC2();if(jt_o3xaznmc.Get_C())
return ji_TypEntityTarget+","+jt_o3xaznmc.Get_String();}
else if(ji_TypEntityTarget==jg_oe.jc_oEntity.jc_Typ_GeoCountry)
{var jt_o3xPS=this.jm_o3xxeid.Get_3xPS2();var jt_P=A3xaToString(jt_o3xPS.Get_P());if(jt_P)
return ji_TypEntityTarget+","+jt_P;}
else if(ji_TypEntityTarget==jg_oe.jc_oEntity.jc_Typ_GeoState)
{var jt_o3xPS=this.jm_o3xxeid.Get_3xPS2();var jt_P=A3xaToString(jt_o3xPS.Get_P());var jt_S=A3xaToString(jt_o3xPS.Get_S());if(jt_P&&jt_S)
return ji_TypEntityTarget+","+jt_P+","+jt_S;}
else if(ji_TypEntityTarget==jg_oe.jc_oEntity.jc_Typ_Enterprise)
{var jt_o3xaznmc=this.jm_o3xxeid.Get_3xAZNMC2();var jt_o3xcat=this.jm_o3xxeid.Get_3xCat2();return ji_TypEntityTarget+","+jt_o3xaznmc.Get_String(true,false)+","+jt_o3xcat.Get_String();}
else if(ji_TypEntityTarget==jg_oe.jc_oEntity.jc_Typ_Enterprise)
{return null;}
...
return jr_oglrMSC;}
New_A3xaAZNMC_XApp(jt_o3xxeidxur.Get_3xAZNMC2()).Set_LA();jr_oglrMSC=jt_ogldtMSC.Get_3xDbEntityAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));if(jr_oglrMSC)
return jr_oglrMSC;jt_o3xxeidxur.Get_3xAZNMC2().Clear();jr_oglrMSC=jt_ogldtMSC.Get_3xDbEntityAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));return jr_oglrMSC;};this._A3xaDbZero();}
...
{if(!ji_sValue)
return ji_sValue;return ji_sValue.replace(/__at2__/g,"@").replace(/&#40;/g,"(").replace(/&#41;/g,")").replace(/&apos;/g,"'");};this.Set_SubDbEntity=function(ji_SubType,ji_oglrSub)
...
jt_oglrAltKeySource=this;var jt_oAltKeySource3xxeid_xapp=new A3xaXEID_XApp(jt_oglrAltKeySource);if(jt_oglrAltKeySource&&jt_oglrAltKeySource.Get_3xXEID().Get_3xPS2().Get_P())
{jt_oglrGeoCountry=jt_ogldtGeoCountry.Get_3xDbEntityAX(jt_oAltKeySource3xxeid_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_GeoCountry));if(jt_oglrGeoCountry&&jt_oglrAltKeySource.Get_3xXEID().Get_3xPS2().Get_S())
...
{var jt_o3xaznmc=ji_oxeid.Get_3xXEID().Get_3xAZNMC2();var jt_A=jt_o3xaznmc.Get_A();var jt_Z=jt_o3xaznmc.Get_Z();var jt_N=jt_o3xaznmc.Get_N();var jt_M=jt_o3xaznmc.Get_M();var jt_C=jt_o3xaznmc.Get_C();if(ji_bSub&&!ji_bTop)
{if(!jt_N)
...
{var jt_o3xcat=ji_oxeid.Get_3xXEID().Get_3xCat2();var jt_Ucat=jt_o3xcat.Get_Ucat();if(!jt_Ucat)
...
return false;var jt_o3xaznmcSelect=ji_oxeid.Get_3xAZNMC2();var jt_Select_A=jt_o3xaznmcSelect.Get_A();var jt_Select_Z=jt_o3xaznmcSelect.Get_Z();var jt_Select_N=jt_o3xaznmcSelect.Get_N();var jt_odt_Cities=ji_odb.Get_DataTable(GLIDR(A3xa2DefineTbid().jc_GGLID_GeoCity));var jt_o3xait_Cities=null;if(jt_odt_Cities)
...
var jt_o3xaznmc=jt_o3xeid.Get_3xAZNMC2();if((jt_Select_A&&jt_Select_A!=jt_o3xaznmc.Get_A())||(jt_Select_Z&&jt_Select_Z!=jt_o3xaznmc.Get_Z())||(jt_Select_N&&jt_Select_N!=jt_o3xaznmc.Get_N()))
{jt_o3xait_Cities.Next();continue;}
...
{var jt_o3xe=ji_o3xe;var jt_A=jt_o3xe.Get_3xXEID().Get_3xAZNMC2().Get_A();var jt_Z=jt_o3xe.Get_3xXEID().Get_3xAZNMC2().Get_Z();var jt_N=jt_o3xe.Get_3xXEID().Get_3xAZNMC2().Get_N();var jt_Ucat=jt_o3xe.Get_3xXEID().Get_3xCat2().Get_Ucat();var jt_Vcat=jt_o3xe.Get_3xXEID().Get_3xCat2().Get_Vcat();if(!jt_Select_Ucat||(jt_Ucat==jt_Select_Ucat&&(!jt_Select_Vcat||(jt_Vcat==jt_Select_Vcat))))
...
jt_o3xehbox_IdTag.UpdateHtml_Score();return true;};this._A3xaEntity_Html();}
...
return false;jt_sCatGroup=jt_oglrCategoryGroup.Get_3xXEID().Get_3xCat2().Get_String("-");var jt_oddig=this.Get_Child(jt_sCatGroup);if(!jt_oddig)
