...
return false;ji_o3xxur.jm_FormName=jg_oe.jc_oXUR.jc_XURFN_AjaxEntity;ji_o3xxur.jm_TypAjaxResponse=jg_oe.jc_oXUR.jc_sAjaxTypEntitySet;jr_o.jm_oxur=ji_o3xxur;return jr_o.jxt._requestMain_POST(ji_fnOnDone,ji_o3xxur,ji_Itbtn);};jr_o.jxt._requestMain_POST=function(ji_fnOnDone,ji_o3xxur,ji_Itbtn)
...
{return false;}
var jt_aoJSDB=jg_oe.jc_oUrls.Get_PathJSDB({bRelease:jg_oe.jm_bReleaseJSDB,bGold:true,tbtnames:jt_tbtnames,xurcc:jt_o3xxurFIX.Get_XURCC()});if(!(jt_aoJSDB&&jt_aoJSDB.length>0))
{if(ji_fnOnDone)
...
{jg_oe.LogStatusBar2(new A3xaString(["Request Cities info","Solicitud Ciudades info","Solicitação Ciudades info","Richiesta Città info"]));var jt_tbtnames=(ji_Itbtn?ji_Itbtn.getTbtnames():[]);var jt_aoJSDBei=jg_oe.jc_oUrls.Get_PathJSDB({bRelease:jg_oe.jm_bReleaseJSDB,bCommon:true,bCities:true,tbtnames:jt_tbtnames});if(!(jt_aoJSDBei&&jt_aoJSDBei.length>0))
{if(ji_fnOnDone)
...
{jt_o.src="https://rawgit.com/a3xa/avenidaazul/master/a3xarel/a3xajdbei-10.18.20-01703221200.min.js";jt_o.integrity="sha384-l5tqCbhTwHJVhZndbXQ8vKgBBo5nTUdJINqV+Pu57G43G553DCndgtnf2DTKdadZ";}
else
