...
{if(!ji_ohia)
return false;this.jm_bDebug=(ji_ohia.bDebug==true);this.jm_bCanEdit=ji_ohia.bCanEdit;this.jm_bCanLike=ji_ohia.bCanLike;this.jm_bReleaseJSDB=ji_ohia.bReleaseJSDB;this.jm_sWebbot=ji_ohia.webbot;this.jm_sDirIcons=(ji_ohia.dirIcons?ji_ohia.dirIcons:"/");this.jm_sDirHome=(ji_ohia.dirHome?ji_ohia.dirHome:"/");this.jm_sLang=(ji_ohia.lang?ji_ohia.lang:"en");this.jm_sSitemapDate=(ji_ohia.dateSitemap?ji_ohia.dateSitemap:"");this.jm_sUserName=(ji_ohia.userName?ji_ohia.userName:"");this.jm_sUserLevel=(ji_ohia.userLevel?ji_ohia.userLevel:"");this.jm_sServerMessage=(ji_ohia.serverMessage?ji_ohia.serverMessage:"");this.jm_oGLData=ji_ohia.oGLData;return true;};this.CheckInitDone=function(){return true;};this.jm_oMgrStorage=null;this.Get_MgrStorage=function(){return this.jm_oMgrStorage;};this.jm_odb=null;this.Set_Database=function(ji_odb){this.jm_odb=ji_odb;return true;};this.Get_Database=function(){return this.jm_odb;};this.jm_oHostReporter=null;this.Set_Reporter=function(ji_oHostReporter)
...
function A3xa3Array()
{var jr_o={jm_am:new Map(),jm_ax:[],ar:A3xa3IArray(),};jr_o.ar.I=function(){return jr_o._IPool();};jr_o._IPool=function(){return{Iar:jr_o.ar};};jr_o.ar.Iar=function(){return jr_o.ar;};jr_o.ar.clear=function(){jr_o.jm_ax=[];jr_o.jm_am=new Map();return true;};jr_o.ar.getKeys=function(){return jr_o.jm_ax;};jr_o.ar.getCount=function(){return(jr_o.jm_ax&&jr_o.jm_am.size)?jr_o.jm_ax.length:0;};jr_o.ar.merge=function(ji_Iar)
{if(!ji_Iar)
...
{var jr_o={jm_IArray:null,jm_ix:-1,jm_If:null,ar:A3xa3IArray(),arit:A3xa3IArrayIt()};jr_o.ar.I=function(){return jr_o._IPool();};jr_o.arit.I=function(){return jr_o._IPool();};jr_o._IPool=function(){return{Iar:jr_o.ar,Iarit:jr_o.arit};};jr_o.ar.Iar=function(){return jr_o.ar;};jr_o.ar.Iarit=function(){return jr_o.arit;};jr_o.arit.Iar=function(){return jr_o.ar;};jr_o.arit.Iarit=function(){return jr_o.arit;};jr_o.arit.getTargetIArray=function(){return jr_o.jm_IArray;};jr_o.ar.getKeys=function()
...
{return(jr_o.jm_ix<0||jr_o.jm_ix>=jr_o.ar.getCount());};jr_o.ar.O=function(){return jr_o;};jr_o.arit.O=function(){return jr_o;};jr_o.Get_I3x3=function(){return jr_o.arit;};jr_o.arit.set3x2Array(ji_IArray_Target);return jr_o.arit;}"use strict";function A3xaString(ji_as)
...
{return(this.jm_aoddiChildren?this.jm_aoddiChildren.I().Iar.getCount():0);};this.Add_Child=function(ji_oddi)
{if(!ji_oddi)
return false;ji_oddi.jm_TreeLevel=this.jm_TreeLevel+1;if(!this.jm_aoddiChildren)
this.jm_aoddiChildren=A3xa3Array();return this.jm_aoddiChildren.addItem(ji_oddi.Get_Key(),ji_oddi);};this.Get_Child=function(ji_key)
{if(!this.jm_aoddiChildren)
return null;return this.jm_aoddiChildren.getItem(ji_key);};this.Get_Child_ByIndex=function(ji_index)
{if(!this.jm_aoddiChildren)
return null;var jt_aIddiChildren=this.jm_aoddiChildren.I().Iar;return jt_aIddiChildren.getItem_ByIndex(ji_index);};this.Get_ChildKey=function(ji_index)
{if(!this.jm_aoddiChildren)
return null;return this.jm_aoddiChildren.Get_Key(ji_index);};this.Sort_Children=function(ji_fnCompare,ji_bAllTreeRecursion)
{if(!this.jm_aoddiChildren)
return false;var jt_aIddiChildren=this.jm_aoddiChildren.I().Iar;jt_aIddiChildren.sortItems(ji_fnCompare);if(ji_bAllTreeRecursion)
...
function GLIDR(ji_GGLID,ji_slicech,ji_extension){return A3xa2DefineTbid().GLIDR(ji_GGLID,ji_slicech,ji_extension);};function GLIDP(ji_GGLID,ji_slicech,ji_extension){return A3xa2DefineTbid().GLIDP(ji_GGLID,ji_slicech,ji_extension);};function GLIDN(ji_GGLID,ji_slicech,ji_extension){return A3xa2DefineTbid().GLIDN(ji_GGLID,ji_slicech,ji_extension);};function GLIDF(ji_GGLID,ji_slicech,ji_extension){return A3xa2DefineTbid().GLIDF(ji_GGLID,ji_slicech,ji_extension);};function A3xa3ITbtnames()
{return{I:function(){return null;},D:function(){return null;},getTbtnames:function(){return[];},hastbt:function(ji_tbtname){return false;},hasEID:function(){return false;},hasEBIS:function(){return false;},hasEBID:function(){return false;},hasEI:function(){return false;}};}
function A3xa3Tbtnames(ji_atbtnames)
{var jr_o={jm_atbtnames:(ji_atbtnames||[]),jc:A3xa2DefineTbid(),tbtn:A3xa3ITbtnames()};jr_o.tbtn.I=function(){return jr_o._IPool();};jr_o._IPool=function(){return{Itbtn:jr_o.tbtn};};jr_o.tbtn.D=function(){return jr_o.jc;};jr_o.tbtn.getTbtnames=function(){return jr_o.jm_atbtnames||[];};jr_o.tbtn.hastbt=function(ji_tbtname)
{if(!ji_tbtname)
...
function A3xa3Tbid(ji_glid,ji_tbtype)
...
{var jr_aSchemaTableGroups=A3xa3Array();var jt_aTables=this.jm_aTables;for(var i=0;i<jt_aTables.length;i++)
...
{this.jm_oDTStatus=new GLDataStatus();this.jm_oDTStatusStore=new GLDataStatus();this.jm_glid=null;this.jm_release=null;this.jm_bSetupDone=false;this.jm_aoglr=A3xa3Array();this.jm_aaoglrSelect=A3xa3Array();this.jm_bAX=true;this.jm_aoglrAX=null;this.jm_odb=null;this.jm_IarSubDTLinked=null;this.Set_SubTable=function(ji_tbtname,ji_odt)
{if(!(ji_tbtname&&ji_odt))
return false;if(!this.jm_IarSubDTLinked)
this.jm_IarSubDTLinked=A3xa3Array();return this.jm_IarSubDTLinked.setItem(ji_tbtname,ji_odt);};this.Get_SubTable=function(ji_tbtname)
{if(!ji_tbtname)
...
{this.jm_oDTStatus.SetLoadStatusFail();}
return true;};this._GLDataTable(ji_oDatabase,ji_glid,ji_release);}"use strict";function A3xa3IDataSourcePage()
...
function A3xa3DataSourcePage()
{var jr_o={jm_d3x:null,jm_IdspParent:null,jm_dyn:null,dsp:A3xa3IDataSourcePage(),};jr_o.dsp.Idsp=function(){return jr_o.dsp;};jr_o.dsp.setDataSource=function(ji_d3x,ji_IdspParent)
...
{var jr_o3xdspChild=A3xa3DataSourcePage();jr_o3xdspChild.setDataSource(jr_item,jr_o.dsp);return jr_o3xdspChild;}
...
{var jr_I={I:function(){return null;},set3xXUR:function(ji_o3xxur){return false;},get3xXUR:function(){return null;},setDataSourceGLRSPool:function(ji_I3DSPool){return false;},enableTables:function(ji_bEID,ji_bEBIS,ji_bEBID,ji_bEI){return false;},enableTables2:function(ji_Itbtn){return false;},writeGLRS2All:function(){return false;},checkGLRS2:function(ji_GLent,ji_slicech,ji_idForeign){return false;},writeGLRS2:function(ji_GLent,ji_slicech,ji_idForeign){return false;},writeEmptyGLRS2:function(ji_GLent,ji_slicech,ji_idForeign){return false;},checkForeignGLRS2:function(ji_GLent,ji_slicech){return false;},writeForeignGLRS2:function(ji_GLent,ji_slicech){return false;}};return jr_I;}
...
{if(!ji_Itbtn)
return jr_o.dts.enableTables(true,true,true,true);return jr_o.dts.enableTables(ji_Itbtn.hasEID(),ji_Itbtn.hasEBIS(),ji_Itbtn.hasEBID(),ji_Itbtn.hasEI());};jr_o.dts.setDataSourceGLRSPool=function(ji_I3DSPool){jr_o.jm_I3DSPool=ji_I3DSPool;return true;};jr_o._getDataSourceGLRSPool=function(){return jr_o.jm_I3DSPool;};jr_o.dts.writeGLRS2All=function()
{var jt_oxur=new A3xaXur();if(jr_o._getDataSourceGLRSPool().getItem("p3xupd"))
{jt_oxur.Set_XURString(jr_o._getDataSourceGLRSPool().getItem("p3xupd"));jt_oxur.Set_XUDString(jr_o._getDataSourceGLRSPool().getItem("p3dupd"));jg_oApp.Get_MgrPage().Set_3xXUR(jt_oxur);jr_o.jm_o3xxur=jt_oxur;}
else if(jr_o._getDataSourceGLRSPool().getItem("p3x"))
{jt_oxur.Set_XURString(jr_o._getDataSourceGLRSPool().getItem("p3x"));jt_oxur.Set_XUDString(jr_o._getDataSourceGLRSPool().getItem("p3d"));jg_oApp.Get_MgrPage().Set_3xXUR(jt_oxur);jr_o.jm_o3xxur=jt_oxur;}
else
return false;jg_oe.CanLogInfo()&&jg_oe.LogInfo("jt_oxur.Set_XURString(p3x)="+jr_o._getDataSourceGLRSPool().getItem("p3x"),"","A3xa3DataTableSlice.writeGLRS2All");jg_oe.CanLogInfo()&&jg_oe.LogInfo("jt_oxur.Set_XUDString(p3d)="+jr_o._getDataSourceGLRSPool().getItem("p3d"),"","A3xa3DataTableSlice.writeGLRS2All");jg_oe.CanLogInfo()&&jg_oe.LogInfo("jg_oApp.Get_MgrPage().Get_3xXUR().XUDString2()="+jg_oApp.Get_MgrPage().Get_3xXUR().Get_XUDString2(),"","A3xa3DataTableSlice.writeGLRS2All");var jt_bEID=jr_o.jm_bEID;var jt_bEBIS=jr_o.jm_bEBIS;var jt_bEBID=jr_o.jm_bEBID;var jt_bEI=jr_o.jm_bEI;jr_o.dts.enableTables(true,false,true,false);if(jr_o.dts.checkGLRS2("SUME"))
...
{if(jr_o.jm_bEID&&!jr_o._getDataSourceGLRSPool().getGLItem2("EID",ji_GLent,ji_slicech,ji_idForeign).glid)
return false;if(jr_o.jm_bEBIS&&!jr_o._getDataSourceGLRSPool().getGLItem2("EBIS",ji_GLent,ji_slicech,ji_idForeign).glid)
return false;if(jr_o.jm_bEBID&&!jr_o._getDataSourceGLRSPool().getGLItem2("EBID",ji_GLent,ji_slicech,ji_idForeign).glid)
return false;if(jr_o.jm_bEI&&!jr_o._getDataSourceGLRSPool().getGLItem2("EI",ji_GLent,ji_slicech,ji_idForeign).glid)
...
jt_xitemEID.glid+","+jt_xitemEID.glrs,"","A3xa3DataTableSlice.writeGLRS2");if(jr_o.jm_bEID&&!jt_odb.WriteGLRS2(jt_xitemEID.glid,jt_xitemEID.oglh,jt_xitemEID.glrs))
...
{var jt_I3tbid=A3xa3Tbid(ji_glid);var jt_oxur=jg_oApp.Get_MgrPage().Get_3xXUR();if(!ji_glid)
...
{this.jm_oDTStatus.SetCacheStatusInProgress("Cache Tableset "+jt_glid_eid);var jt_bFail=false;if(this._IsGlidEnabled_(A3xa3Tbid(jt_glid_eid),ji_Itbtn))
...
if(this._IsGlidEnabled_(A3xa3Tbid(jt_glid_ebis),ji_Itbtn))
...
if(this._IsGlidEnabled_(A3xa3Tbid(jt_glid_ebid),ji_Itbtn))
...
if(this._IsGlidEnabled_(A3xa3Tbid(jt_glid_ei),ji_Itbtn))
...
jt_CountDT=this.Get_IArrayDTStore().I().Iar.getCount();if(!jt_CountDT)
...
{if(!ji_glid)
return null;jg_oe.CanLogInfo()&&jg_oe.LogInfo("1)ji_glid="+ji_glid,"","A3xaDatabase.Get_TOCItem");var jt_I3tbid=A3xa3Tbid(ji_glid);if(jt_I3tbid.isTOC())
...
{var jr_o={jm_oxur:null,jxt:A3xa3IAjaxTables()};jr_o.jxt.I=function(){return{Ijxt:jr_o.jxt};};jr_o.jxt.get3xXUR=function(){return jr_o.jm_oxur;};jr_o.jxt.requestMain=function(ji_fnOnDone,ji_o3xxur,ji_Itbtn)
...
{var ji_o3xxur=new A3xaXur();ji_o3xxur.CopyFromXUR(jg_oApp.Get_MgrPage().Get_3xXUR());ji_o3xxur.jm_FormName=jg_oe.jc_oXUR.jc_XURFN_ListEntity;ji_o3xxur.jm_TypAjaxResponse=jg_oe.jc_oXUR.jc_sAjaxTypEntitySet;}
...
return false;ji_o3xxur.jm_FormName=jg_oe.jc_oXUR.jc_XURFN_AjaxEntity;jr_o.jm_oxur=ji_o3xxur;var jt_tbtnames=(ji_Itbtn?ji_Itbtn.getTbtnames():[]);$.ajax({method:"POST",timeout:10000,url:jg_oe.jc_oXUR.jc_sUrlBase_A3xaFormDDAJOO+"?",data:{p3k:"1",p3x:ji_o3xxur.Get_XURCC(),p3n:JSON.stringify({mark:"J3",oppg:"app_entityset",optyp:"exec",code:"",msg:"",tbtnames:jt_tbtnames},function(ji_k,ji_v)
{return ji_v;})},success:function(ji_response)
...
{var jt_ogldtMain=this.jm_oDatabase.Get_DataTable();var jt_ogldtEI=(jt_ogldtMain?jt_ogldtMain.Get_SubTable(A3xa2DefineTbid().jc_tbtype_ei.tbtname):null);return(jt_ogldtEI?true:false);};this.RequestDataTableEI=function(ji_fnDone)
{var jt_o3xxur=jg_oApp.Get_MgrPage().Get_3xXUR();var jt_ogldtMain=this.jm_oDatabase.Get_DataTable();var jt_I3tbid=A3xa3Tbid();var jt_glid_ei=jt_I3tbid.makeByType(jt_ogldtMain.Get_Glid(),A3xa2DefineTbid().jc_tbtype_ei);var jt_bdt=false;var jt_Itbtn=A3xa3Tbtnames([A3xa2DefineTbid().jc_tbtype_ei.tbtname]);if(jt_I3tbid.isEnterprise())
{var jt_pisdsRecord_glidtoc=this.jm_oDatabase.Get_TOCItem(jt_glid_ei);if(jt_pisdsRecord_glidtoc)
return this.ManageData2({fnDone:ji_fnDone,bLoadEnterprise:true,Itbtn:jt_Itbtn});return this._ManageNewDataRequest(jt_o3xxur,ji_fnDone,jt_Itbtn);}
if(jt_I3tbid.isGeoCity())
{var jt_pisdsRecord_glidtoc=this.jm_oDatabase.Get_TOCItem(jt_glid_ei);if(!jt_pisdsRecord_glidtoc)
{var jt_oJSDBei=jg_oe.jc_oUrls.Get_UrlAjaxJSDBei(jg_oe.jm_bReleaseJSDB);$.ajax({type:"GET",dataType:"script",url:jt_oJSDBei.src,data:{"integrity":jt_oJSDBei.integrity,"crossorigin":"anonymous"},success:function()
{if(!jt_this._LoadCacheStoreCommon(GLIDR(A3xa2DefineTbid().jc_GGLID_GeoCity),jt_Itbtn))
...
{return true;},jt_o3xxur,jt_Itbtn);}}});return true;}
jt_this._DatabaseLoadCommon(function(ji_bSuccess)
{if(ji_bSuccess)
ji_fnDone(new GLDataStatusLoadSuccess());else
ji_fnDone(new GLDataStatusLoadFail());},null,jt_Itbtn);return true;}
return false;};this.RequestXURData=function(ji_o3xXUR,ji_fnDone)
{var jt_bdt=false;var jt_I3tbid=A3xa3Tbid();var jt_glidtoc=jt_I3tbid.makeByXEID(ji_o3xXUR);var jt_oxeidXUR=ji_o3xXUR.Get_3xXEID();var jt_bEnterprise=(!jt_oxeidXUR.Get_TypEntity()||jt_oxeidXUR.Get_TypEntity()==jg_oe.jc_oEntity.jc_Typ_Enterprise);var jt_bSilver=ji_o3xXUR.IsSilver();var jt_bGold=ji_o3xXUR.IsGold();var jt_Ucat=jt_oxeidXUR.Get_3xCat2().Get_Ucat();var jt_Vcat=jt_oxeidXUR.Get_3xCat2().Get_Vcat();if(jt_I3tbid.isEnterprise())
...
jt_Itbtn=A3xa3Tbtnames([A3xa2DefineTbid().jc_tbtype_eid.tbtname,A3xa2DefineTbid().jc_tbtype_ebis.tbtname,A3xa2DefineTbid().jc_tbtype_ebid.tbtname]);if(!jt_bdt)
...
{var jt_o3xxur=jg_oApp.Get_MgrPage().Get_3xXUR();var jt_oxeidXUR=jt_o3xxur.Get_3xXEID();var jt_bEnterprise=(!jt_oxeidXUR.Get_TypEntity()||jt_oxeidXUR.Get_TypEntity()==jg_oe.jc_oEntity.jc_Typ_Enterprise);var jt_ItbtnCommon=A3xa3Tbtnames([A3xa2DefineTbid().jc_tbtype_eid.tbtname,A3xa2DefineTbid().jc_tbtype_ebis.tbtname,A3xa2DefineTbid().jc_tbtype_ebid.tbtname]);var jt_fnThatsAllFolks=function(ji_oDTStatus)
...
var jt_IarDTLCommon=jt_this.jm_oDatabase.Get_IArrayDTLoad({jp_bTyp_Common:true});if(jt_IarDTLCommon&&jt_IarDTLCommon.I().Iar.getCount()>0)
...
{var jt_bSuccess=false;var jt_o3x3dtslice=A3xa3DataTableSlice(A3xa3DataSourceGLRSPool(jt_oglPreloadedData),(ji_bAlsoLoadCommon?null:ji_o3xxur));jt_o3x3dtslice.enableTables2(ji_Itbtn);if(jt_o3x3dtslice.writeGLRS2All())
...
return(ji_bSuccess?jt_this._DatabaseLoadCommon(ji_fnRequestDone,null,jt_ItbtnCommon):(ji_fnRequestDone?ji_fnRequestDone(false):false));return(ji_fnRequestDone?ji_fnRequestDone(ji_bSuccess):ji_bSuccess);},(ji_bAlsoLoadCommon?null:ji_o3xxur),ji_Itbtn);}
return jr_b;}
if(ji_bAlsoLoadCommon)
...
return jt_this._DatabaseLoadSlice(jt_fnOnLoadMajorDone,A3xa2DefineDataManager().jc_tbdctor_Major,ji_Itbtn);}
else if(jt_bSingle)
{return jt_this._DatabaseLoadSlice(jt_fnOnLoadMajorDone,A3xa2DefineDataManager().jc_tbdctor_Major,ji_Itbtn);}
...
{if(ji_oDTStatus.IsSuccessOrEmpty())
return jt_this._DatabaseLoadSlice(jt_fnOnLoadSubryDone,A3xa2DefineDataManager().jc_tbdctor_Subry,ji_Itbtn);}
else if(jt_bSingle)
...
return jt_this._DatabaseLoadSlice(ji_fnOnLoadEnterprisesDone,A3xa2DefineDataManager().jc_tbdctor_Silver,ji_Itbtn);if(jt_bGold)
return jt_this._DatabaseLoadSlice(ji_fnOnLoadEnterprisesDone,A3xa2DefineDataManager().jc_tbdctor_Gold,ji_Itbtn);return jt_this._DatabaseLoadSlice(function(ji_oDTStatus)
{if(ji_oDTStatus&&ji_oDTStatus.IsSuccessOrEmpty()&&(jt_bUnlimited||jt_bSingle))
return jt_this._DatabaseLoadSlice(jt_fnOnLoadUniqueDone,A3xa2DefineDataManager().jc_tbdctor_Unique,ji_Itbtn);return ji_fnOnLoadEnterprisesDone(ji_oDTStatus);},A3xa2DefineDataManager().jc_tbdctor_Main,ji_Itbtn);};this._ManageDataStoreAll=function(ji_fnOnStoreAllDone,ji_o3xxur,ji_Itbtn)
...
jr_b=this.jm_oDatabase.WriteGLRS2(GLIDR(A3xa2DefineTbid().jc_GGLID_GeoState),null,"");}
if(ji_glid==null||ji_glid==GLIDR(A3xa2DefineTbid().jc_GGLID_GeoCity))
{if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(GLIDR(A3xa2DefineTbid().jc_GGLID_GeoCity),null,"",ji_Itbtn);}}
catch(e)
...
{var jt_I3tbid=A3xa3Tbid(jt_oSchemaTable.jp_sName);var jt_sTableNameQUR=(jt_I3tbid.default2GlidXEID(jg_oApp.Get_MgrPage().Get_3xXUR())||"");if(jt_sTableNameQUR&&this._IsGlidToLoad_(jt_I3tbid,ji_Itbtn))
...
{continue;}
var jt_I3tbid=A3xa3Tbid(jt_oSchemaTable.jp_sName);var jt_sTableNameQUR=(jt_I3tbid.default2GlidXEID(jt_o3xxurxeid)||"");if(!(jt_sTableNameQUR&&this._IsGlidToLoad_(jt_I3tbid,ji_Itbtn)))
{continue;}
var jt_sTableParentQUR=(jt_oSchemaTable.jp_sParent?(A3xa3Tbid(jt_oSchemaTable.jp_sParent).default2GlidXEID(jt_o3xxurxeid)||""):"");var jt_IArray_dtl=this.jm_oDatabase.Get_IArrayDTLoad(this.jm_pTypTables);jg_oe.CanLogInfo()&&jg_oe.LogInfo("jt_sTableNameQUR,jt_oSchemaTable.jp_sName,jt_IArray_dtl.getCount(): "+
...
function A3xaEI()
{this.jm_o3x2aeifa=A3xa3Array();this.IsValid=function()
{return true;};this.IsEmpty=function()
{return false;};this.Get_3xEI=function(){return this;};this.CopyFrom=function(ji_o3xei)
{if(ji_o3xei)
ji_o3xei=ji_o3xei.Get_3xEI();if(!ji_o3xei)
return false;this.jm_o3x2aeifa=A3xa3Array();var jt_o3x2aeifa=ji_o3xei.Get_I3x2Info();var jt_c=0;if(jt_o3x2aeifa)
...
{this.jm_o3x2aeifa=A3xa3Array();return true;};this.Get_I3x2Info=function(ji_TypInfo,ji_IdInfo)
{if(!(ji_TypInfo||ji_IdInfo))
return this.jm_o3x2aeifa;var jr_o3x2aeifa_Selected=A3xa3Array();var jt_c=this.jm_o3x2aeifa.getCount();for(var i=0;i<jt_c;i++)
...
{var jr_o=A3xa2StaticDataSource_Db();jr_o.db.setDefaultDbVersion(jg_o3xdbZero.d3x_version);jr_o.db.new3x2Table=function(ji_sdsTable,ji_bJSON){return A3xa2StaticDataSource_TableEntity(ji_sdsTable,ji_bJSON);};jr_o._isGlidEnabled_=function(ji_I3tbid,ji_Itbtn)
...
return false;}
var jt_glidC=GLIDR(A3xa2DefineTbid().jc_GGLID_GeoCity);if(ji_glid==null||ji_glid==jt_glidC)
{var jt_I3tbid_eid=A3xa3Tbid();var jt_I3tbid_ebis=A3xa3Tbid();var jt_I3tbid_ebid=A3xa3Tbid();var jt_I3tbid_ei=A3xa3Tbid();jt_I3tbid_eid.makeByType(jt_glidC,A3xa2DefineTbid().jc_tbtype_eid);jt_I3tbid_ebis.makeByType(jt_glidC,A3xa2DefineTbid().jc_tbtype_ebis);jt_I3tbid_ebid.makeByType(jt_glidC,A3xa2DefineTbid().jc_tbtype_ebid);jt_I3tbid_ei.makeByType(jt_glidC,A3xa2DefineTbid().jc_tbtype_ei);if(jr_o._isGlidEnabled_(jt_I3tbid_eid,ji_Itbtn))
...
{var jt_o3xxeidxur=new A3xaXEID();jt_o3xxeidxur.CopyFrom(jg_oApp.Get_MgrPage().Get_3xXUR().Get_3xXEID());var jt_o3xxeidxur_xapp=new A3xaXEID_XApp(jt_o3xxeidxur);var jt_ogldtMSC=this.Get_DataTable(A3xa2DefineTbid().GLIDR(A3xa2DefineTbid().jc_GGLID_MetaSystemControl));if(!jt_ogldtMSC)
...
return false;return true;};this.Get_3xEBIS=function(){return this.Get_SubDbEntity(A3xa2DefineTbid().jc_tbtype_ebis.tbtname);};this.Get_3xEBID=function(){return this.Get_SubDbEntity(A3xa2DefineTbid().jc_tbtype_ebid.tbtname);};this.Get_3xEI=function(){return this.Get_SubDbEntity(A3xa2DefineTbid().jc_tbtype_ei.tbtname);};this.Get_3xsName=function(){return(this.Get_3xEI()?this.Get_3xEI().Get_3xsName():null);};this.Get_LName=function()
{var jt_o3xs4L=this.Get_3xsName();if(jt_o3xs4L&&jt_o3xs4L.Get_LString())
return jt_o3xs4L.Get_LString();if(this.Get_3xEBIS())
return this.Get_3xEBIS().Get_Name();return"";};this.Get_3xsDescr=function(){return(this.Get_3xEI()?this.Get_3xEI().Get_3xsDescr():null);};this.Get_LDescr=function()
...
{var jt_o3x2aeifa_Selected=A3xa3Array();var jt_arsInfo=this.Get_FieldArray_Recordset(jg_oe.jc_oA3xaDbZero.jc_sEifaName);jg_oe.CanLogInfo()&&this.Get_TypEntity()=="E"&&jg_oe.LogInfo("te,ide,jt_arsInfo: "+this.Get_TypEntity()+","+this.Get_IdEntity()+","+jt_arsInfo,"","GLREI.Get_I3x2Info");if(!(jt_arsInfo&&jt_arsInfo.length))
...
return null;var jc_oXUR=jg_oe.Get_MgrPage().jc_oXUR;var jt_te=null;var jt_A=null;var jt_Z=null;var jt_N=null;var jt_C=null;var jt_Ucat=null;var jt_Vcat=null;if(this.Get_3xXEID())
{jt_te=this.Get_3xXEID().Get_TypEntity();jt_A=this.Get_3xXEID().Get_3xAZNMC2().Get_A();jt_Z=this.Get_3xXEID().Get_3xAZNMC2().Get_Z();jt_N=this.Get_3xXEID().Get_3xAZNMC2().Get_N();jt_C=this.Get_3xXEID().Get_3xAZNMC2().Get_C();jt_Ucat=this.Get_3xXEID().Get_3xCat2().Get_Ucat();jt_Vcat=this.Get_3xXEID().Get_3xCat2().Get_Vcat();}
...
{var jt_o3xuv=(ji_oglr?ji_oglr.Get_3xXEID().Get_3xCat2():null);return((jt_o3xuv&&!jt_o3xuv.Get_Vcat())?1:0);};var jt_o3x2FilterUcatAX=A3xa3ArrayIt(jt_ogldt.Get_IRecordsetAX());jt_o3x2FilterUcatAX.selectItems(jt_fnU);var jt_o3x2FilterUcat=A3xa3ArrayIt(jt_ogldt.Get_IRecordset());jt_o3x2FilterUcat.selectItems(jt_fnU);return jr_o.ds.addUcats(jt_o3x2FilterUcat.I().Iar,jt_o3x2FilterUcatAX.I().Iar);};jr_o.ds.addTableUVcats=function()
{var jt_odb=jg_oApp.Get_Database();if(!jt_odb)
return false;var jt_ogldt=jt_odb.Get_DataTable(GLIDR(A3xa2DefineTbid().jc_GGLID_Category));if(!jt_ogldt)
return false;var jt_fnUV=function(ji_axkey,ji_oglr)
{var jt_o3xuv=(ji_oglr?ji_oglr.Get_3xXEID().Get_3xCat2():null);return((jt_o3xuv&&jt_o3xuv.Get_Vcat())?1:0);};var jt_o3x2FilterUVcatAX=A3xa3ArrayIt(jt_ogldt.Get_IRecordsetAX());jt_o3x2FilterUVcatAX.selectItems(jt_fnUV);var jt_o3x2FilterUVcat=A3xa3ArrayIt(jt_ogldt.Get_IRecordset());jt_o3x2FilterUVcat.selectItems(jt_fnUV);return jr_o.ds.addUVcats(jt_o3x2FilterUVcat.I().Iar,jt_o3x2FilterUVcatAX.I().Iar);};jr_o.ds.selectCommonTyp=function(ji_TypEntity)
...
{var jt_Idsp=A3xa3DataSourcePage();jt_Idsp.setDataSource(jg_o3xPagesMain);var jt_IdspSearchHotel=jt_Idsp.getItem("d3x_searchhotel");if(!jt_IdspSearchHotel)
return false;var jt_IPageSimpleArticle=A3xa3MgrPageSimpleArticle();jt_IPageSimpleArticle.setHtmHeader(jt_IdspSearchHotel.getHeader());jt_IPageSimpleArticle.setHtmBody(jt_IdspSearchHotel.getBody());jt_IPageSimpleArticle.printHtml();}
else if(this.IsPageHome())
{var jt_Idsp=A3xa3DataSourcePage();jt_Idsp.setDataSource(jg_o3xPagesMain);var jt_IdspHome=jt_Idsp.getItem("d3x_home");if(!jt_IdspHome)
return false;var jt_IPageSimpleArticle=A3xa3MgrPageSimpleArticle();jt_IPageSimpleArticle.setHtmHeader(jt_IdspHome.getHeader());jt_IPageSimpleArticle.setHtmBody(jt_IdspHome.getBody());jt_IPageSimpleArticle.printHtml();}
else if(this.IsPageOverview())
{var jt_Idsp=A3xa3DataSourcePage();jt_Idsp.setDataSource(jg_o3xPagesMain);var jt_IdspOverview=jt_Idsp.getItem("d3x_overview");if(!jt_IdspOverview)
return false;var jt_IPageSimpleArticle=A3xa3MgrPageSimpleArticle();var jt_IdspOverviewChild=null;if(this.IsPageOverviewSummary())
...
{var jt_Idsp=A3xa3DataSourcePage();jt_Idsp.setDataSource(jg_o3xPagesMain);jt_Idsp.setDynDataSource({"dyn_message1":jg_oe.jm_sServerMessage});var jt_IdspUsers=jt_Idsp.getItem("d3x_users");if(!jt_IdspUsers)
return false;var jt_IPageSimpleArticle=A3xa3MgrPageSimpleArticle();var jt_IdspUsersChild=null;if(this.IsPageUsersGuestbook())
...
{$("body").prepend("<div id='A3xaArticle' class='container bg-3 text-left'></div>");$("body").prepend("<section id='A3xaPageTopLogoBar' class='page-header'></section>");$("body").prepend("<nav id='A3xaMenu' class='navbar navbar-inverse navbar-fixed-top'></nav>");var jt_Idsp=A3xa3DataSourcePage();jt_Idsp.setDataSource(jg_o3xPagesMain);jt_Idsp.setDynDataSource({"dyn_mUsername1":(jg_oe.jm_sUserName?jg_oe.jm_sUserName:"Logout"),"dyn_mclassUserLevel2":(jg_oe.jm_sUserName?"":" hidden"),"dyn_mclassUserLevel1":(jg_oe.jm_sUserName?" hidden":""),"dyn_mclasshome1":(jt_this.IsPageHome()?" class='active'":""),"dyn_mclassSearchHotel1":(jt_this.IsPageSearchHotel()?" class='active'":""),"dyn_mclassOverview1":(jt_this.IsPageOverview()?" class='active'":""),"dyn_mclassUsers1":(jt_this.IsPageUsers()?" class='active'":"")});var jt_IdspMenuStd=jt_Idsp.getItem("d3x_menustd");if(!jt_IdspMenuStd)
return false;var jt_IPageTopMenu=A3xa3MgrPageMenu();jt_IPageTopMenu.setHtmBody(jt_IdspMenuStd.getBody());jt_IPageTopMenu.printHtml();var jt_IPageTopLogoBar=A3xa3MgrPageTopLogoBar();jt_IPageTopLogoBar.showLogo(this.IsPageHome());jt_IPageTopLogoBar.printHtml();this.ShowSimplePage();$("body").removeClass("a3xabs3-background1");$("body").addClass("a3xabs3-background1");}
else
{$("body").prepend("<div id='A3xaArticle' class='container bg-3 text-left'></div>");$("body").prepend("<section id='A3xaPageTopLogoBar' class='page-header'></section>");$("body").prepend("<nav id='A3xaMenu' class='navbar navbar-inverse navbar-fixed-top'></nav>");var jt_Idsp=A3xa3DataSourcePage();jt_Idsp.setDataSource(jg_o3xPagesMain);jt_Idsp.setDynDataSource({"dyn_mUsername1":(jg_oe.jm_sUserName?jg_oe.jm_sUserName:"Logout"),"dyn_mclassUserLevel2":(jg_oe.jm_sUserName?"":" hidden"),"dyn_mclassUserLevel1":(jg_oe.jm_sUserName?" hidden":""),"dyn_mclassDirectories1":" class='active'"});var jt_IdspMenuStd=jt_Idsp.getItem("d3x_menustd");if(!jt_IdspMenuStd)
return false;var jt_IPageTopMenu=A3xa3MgrPageMenu();jt_IPageTopMenu.setHtmBody(jt_IdspMenuStd.getBody());jt_IPageTopMenu.printHtml();var jt_IPageTopLogoBar=A3xa3MgrPageTopLogoBar();jt_IPageTopLogoBar.printHtml();var jt_IPageSimpleArticle=A3xa3MgrPageSimpleArticle();jt_IPageSimpleArticle.setHtmBody("<table id='A3xaTableMain'"+" style='border-width: 0px; border-style: solid;' border='0'"+" cellspacing='0' cellpadding='3' align='left'>"+"<tbody id='A3xaTableMainBody'></tbody></table>");jt_IPageSimpleArticle.printHtml();this.ShowCPTemplate();$("body").removeClass("a3xabs3-background1");$("body").addClass("a3xabs3-background1");jg_oApp.LogStatusBar2(new A3xaString(["Ready","Listo","Pronto","Pronto"]),false,true);var jt_Itbtn=null;if(this.Get_3xXUR().IsMultiple())
jt_Itbtn=A3xa3Tbtnames([A3xa2DefineTbid().jc_tbtype_eid.tbtname,A3xa2DefineTbid().jc_tbtype_ebis.tbtname,A3xa2DefineTbid().jc_tbtype_ebid.tbtname]);jg_oApp.Get_DataManager().ManageData2({fnDone:jt_this.OnDataManagerDone,bLoadTOC:true,bLoadCommon:true,bLoadEnterprise:true,bStoreAll:true,bPreloaded:jg_oApp.Get_GLPreloadedData()&&!jQuery.isEmptyObject(jg_oApp.Get_GLPreloadedData()),Itbtn:jt_Itbtn});}
...
jr_b=false;jg_oApp.HideLeftPanel();return jr_b;};this.OnDataManagerDone=function(ji_oDTStatus)
{if(ji_oDTStatus.IsOpLoad()&&ji_oDTStatus.IsDone())
{var jt_otmDocumentShow=setTimeout(function()
{jg_oApp.Set_3xXEMSC_ByXUR(jg_oApp.Get_Database().Get_3xXEMSC_ByXUR(true));jg_oApp.Get_Database().OnDataLoadedSetup();jt_this.OnDataLoadedSetup();jg_oApp.SetupSummary();jg_oApp.DocumentShow();$("body").removeClass("a3xabs3-background1");$("body").addClass("a3xabs3-background1");},10);}
...
return true;};this.OnChange_QUR=function(ji_sUrlParams)
{if(!ji_sUrlParams)
return false;var jt_o3xXUR=new A3xaXur();jt_o3xXUR.Set_UrlParams(jg_oe.jc_oXUR.jc_XURFN_ListEntity,null,jg_oe.jc_oXUR.jc_sAjaxTypEntitySet,null,null,null,null,ji_sUrlParams);jg_oApp.ClearView();return jg_oApp.Get_DataManager().RequestXURData(jt_o3xXUR,jt_this.OnDataManagerDone);}
this.OnChangeDD_QUR=function(ji_eDropDown)
...
return true;};}"use strict";function A3xaAppMngIcons()
...
{if(!ji_sName)
return null;return jg_oe.jm_sDirIcons+this.jc_oIcons.jc_sImageUrlBase_Main+ji_sName+".jpg";};this.MakeUrlIcon_QUR=function(ji_sName,ji_bExt)
{if(!ji_sName)
...
ji_oxeid=ji_oxeid.Get_3xXEID();if(!ji_oxeid)
return false;var jt_te=ji_oxeid.Get_TypEntity();var jt_odt_Areas=ji_odb.Get_DataTable(GLIDR(A3xa2DefineTbid().jc_GGLID_GeoArea));var jt_Iarit_Areas=(jt_odt_Areas?A3xa3ArrayIt(jt_odt_Areas.Get_IRecordset()):null);if(!jt_Iarit_Areas)
...
return false;if(ji_oxeid)
ji_oxeid=ji_oxeid.Get_3xXEID();if(!ji_oxeid)
return false;var jt_te=ji_oxeid.Get_TypEntity();var jt_odt_Regions=ji_odb.Get_DataTable(GLIDR(A3xa2DefineTbid().jc_GGLID_GeoRegion));var jt_Iarit_Regions=(jt_odt_Regions?A3xa3ArrayIt(jt_odt_Regions.Get_IRecordset()):null);if(!jt_Iarit_Regions)
...
return false;var jt_o3xaznmcSelect=ji_oxeid.Get_3xAZNMC();var jt_Select_A=jt_o3xaznmcSelect.Get_A();var jt_Select_Z=jt_o3xaznmcSelect.Get_Z();var jt_Select_N=jt_o3xaznmcSelect.Get_N();var jt_odt_Cities=ji_odb.Get_DataTable(GLIDR(A3xa2DefineTbid().jc_GGLID_GeoCity));var jt_Iarit_Cities=(jt_odt_Cities?A3xa3ArrayIt(jt_odt_Cities.Get_IRecordset()):null);if(!jt_Iarit_Cities)
...
this.jm_o3xSummaryByLandAll=new A3xaSummaryInfoItem();this.jm_o3xaSummaryByTopArea=A3xa3Array();this.jm_o3xaSummaryByArea=A3xa3Array();this.jm_o3xaSummaryByRegion=A3xa3Array();if(ji_oxeid.Get_TypEntity()!=jg_oe.jc_oEntity.jc_Typ_GeoCity)
this.jm_o3xaSummaryByCity=A3xa3Array();this.jm_o3xSummaryByCatAll=new A3xaSummaryInfoItem();this.jm_o3xaSummaryByCatGroup=A3xa3Array();this.jm_o3xaSummaryByCat=A3xa3Array();jt_IaritDTSummary.I().Iar.foreachItem(function(ji_o3xe,ji_ix,ji_key)
...
return false;var jt_IaritDTMain=(this.jm_odtMain?A3xa3ArrayIt(this.jm_odtMain.Get_IRecordset()):null);if(!jt_IaritDTMain)
...
ji_IarSummary.addItem(jt_skey,ji_o3xsii);return true;};}"use strict";function A3xa2IScore()
...
{A3xaAbsEnvironment.call(this);this.Get_ECPMgr=function(){return null;};this.jm_o3xxeCP=null;this.Get_3xXEMSC_ByXUR=function(){return this.jm_o3xxeCP;};this.Set_3xXEMSC_ByXUR=function(ji_o3xxeCP){this.jm_o3xxeCP=ji_o3xxeCP;return true;};this.jm_oMgrPage=null;this.Get_MgrPage=function(){return this.jm_oMgrPage;};this.jm_oMgrStorage=null;this.jm_oAppMngIcons=null;this.Get_3xAppMngIcons=function(){return this.jm_oAppMngIcons;};this.Get_DefIcons=function(){return this.Get_3xAppMngIcons().Get_DefIcons();};this.jm_oPopupDim={w:400,h:300};this.Set_PopupDim=function(ji_oPopupDim)
...
{var jr_oxur=new A3xaXur();jr_oxur.CopyFromXUR(jg_oApp.Get_MgrPage().Get_3xXUR());if(ji_odc)
...
jt_sUrlParams=jt_asUrlParams[0];return jg_oApp.Get_MgrPage().OnChange_QUR(jt_sUrlParams);};this.jm_oddbox.Set_ColorsBGHL(this.jc_o3xdef.jc_ColorsBGHL);return true;};this._CompareEntityOrder=function(ji_oddi_a,ji_oddi_b)
...
return false;return jg_oApp.Get_MgrPage().OnChange_QUR(jt_sUrlParams);};if(this.IsArea())
...
{ji_event.stopImmediatePropagation();jt_this.OnZoom(qt_oMapDiv,-100,ji_Row,ji_Col);return jg_oApp.Get_MgrPage().OnChange_QUR("p3x="+jt_oxur.Get_XURCC());};return jr_fnClick;};this._MakeId=function(ji_Row,ji_Col)
...
return false;jt_oxurNew.SortByTime();return jg_oApp.Get_MgrPage().OnChange_QUR("p3x="+jt_oxurNew.Get_XURCC());}
else if(ji_oddi.Get_Value()==this.jc_o3xdef.jc_Opt_ByLatestClickDesc)
{if(jt_oxurNew.IsSortByLatestClick())
return false;jt_oxurNew.SortByLatestClick();return jg_oApp.Get_MgrPage().OnChange_QUR("p3x="+jt_oxurNew.Get_XURCC());}
else if(ji_oddi.Get_Value()==this.jc_o3xdef.jc_Opt_ByScoreDesc)
{if(jt_oxurNew.IsSortByScore())
return false;jt_oxurNew.SortByScore();return jg_oApp.Get_MgrPage().OnChange_QUR("p3x="+jt_oxurNew.Get_XURCC());}
else if(ji_oddi.Get_Value()==this.jc_o3xdef.jc_Opt_ByClickDesc)
{if(jt_oxurNew.IsSortByClick())
return false;jt_oxurNew.SortByClick();return jg_oApp.Get_MgrPage().OnChange_QUR("p3x="+jt_oxurNew.Get_XURCC());}
else if(ji_oddi.Get_Value()==this.jc_o3xdef.jc_Opt_ByName)
{if(jt_oxurNew.IsSortByName())
return false;jt_oxurNew.SortByName();return jg_oApp.Get_MgrPage().OnChange_QUR("p3x="+jt_oxurNew.Get_XURCC());}
else
...
{var jt_this=this;this.jm_TimerLoPry=null;this.jm_bReleased=false;this.jm_FirstFrameRow=0;this.jm_nRows=0;this.jm_o3x2xeha=A3xa3Array();this.jm_ao3xehf=[];this.jm_ao3xeh=[];this.jm_bCanRemoveStick=false;this.jm_bUpdateHtml=false;this._A3xaHtmlEntityAbs=function()
...
{jt_o3x2xehaCP=A3xa2Entity_HtmlAssoc();jt_o3x2xehaCP.jm_o3xehf=new A3xaEntity_HtmlFrame(this.jm_FirstFrameRow);jt_o3x2xehaCP.jm_o3xeh=new A3xaECP_Mgr(null,jt_o3x2xehaCP.jm_o3xehf);this.jm_o3x2xeha.addItem("1",jt_o3x2xehaCP);this.jm_ao3xehf[0]=jt_o3x2xehaCP.jm_o3xehf;this.jm_ao3xeh[0]=jt_o3x2xehaCP.jm_o3xeh;}
else
...
jt_ogldtMain=jt_odb.Get_DataTable();var jt_Iarit=(jt_ogldtMain?jt_ogldtMain.Get_IRecordsel():null);this.jm_nRows=(jt_Iarit?jt_Iarit.I().Iar.getCount():0);if(!(this.jm_nRows>0))
...
return null;return jr_odcUpdated;};jr_o.ef.loadData=function(ji_oxe,ji_bNew)
{jr_o.jm_bNew=ji_bNew;jr_o.jm_oxe=ji_oxe;if(!jr_o.jm_oxe)
return false;jr_o.jm_o3xeiModified=new A3xaEI();jr_o.jm_o3xeiModified.CopyFrom(jr_o.jm_oxe);var jt_o3x2aei_descr=A3xa3Array();var jt_o3x2aei=jr_o.jm_o3xeiModified.Get_I3x2Info();var jt_count=jt_o3x2aei.getCount();for(var i=0;i<jt_count;i++)
...
{return true;};return jr_o;}"use strict";function A3xa3IMgrPageMenu()
{var jr_I={setHtmBody:function(ji_s){return false;},printHtml:function(){return false;},};return jr_I;}
function A3xa3MgrPageMenu()
{var jr_o={jm_shBody:"",pm:A3xa3IMgrPageMenu(),};jr_o.pm.Ipm=function(){return jr_o.pm;};jr_o.pm.setHtmBody=function(ji_s){jr_o.jm_shBody=ji_s;return true;};jr_o.pm.printHtml=function()
{var qt_ohpm=$("#A3xaMenu");if(!(qt_ohpm&&qt_ohpm.length))
return false;qt_ohpm.append(jr_o.jm_shBody);return true;};return jr_o.pm;}"use strict";function A3xa3IMgrPageHeaderBar()
{var jr_I={printHtml:function(){return false;},};return jr_I;}
function A3xa3IMgrPageTopLogoBar()
{var jr_I={showLogo:function(ji_b){return false;},printHtml:function(){return false;}};return jr_I;}
function A3xa3MgrPageHeaderBar()
{var jr_o={phb:A3xa3IMgrPageHeaderBar(),};jr_o.phb.Iphb=function(){return jr_o.phb;};jr_o.phb.printHtml=function()
...
return false;}
jr_o.phb._printIcon(qt_ohW20,jg_oe.jc_oIcons.jc_oIconSS_Sitemap.absid,jg_oe.jm_sDirHome+jg_oe.jm_sLang+"/sitemap",true,"Sitemap-xml-Index-"+jg_oe.jm_sSitemapDate,"smx");var qt_ohUL=$("<div class='list-inline'>");qt_ohUL.css({"display":"inline-block","vertical-align":"top"});qt_ohW20.append(qt_ohUL);if(!(qt_ohUL&&qt_ohUL.length))
...
return false;jr_o.phb._printIcon(qt_ohUL,jg_oe.jc_oIcons.jc_oIconSS_Url.absid,"http://avenidaazul.a3xa.com/",true,"Avenida Azul 3x","a3x");jr_o.phb._printIcon(qt_ohUL,jg_oe.jc_oIcons.jc_oIconSS_Email.absid,EmailAntispam_UrlLink("avenida.azul__at__a3xa__dot__com"),true,"info","nfo");jr_o.phb._printIcon(qt_ohUL,jg_oe.jc_oIcons.jc_oIconSS_Email.absid,EmailAntispam_UrlLink("orapaz.webmaster__at__a3xa__dot__com"),true,"orapaz","orz");jr_o.phb._printIcon(qt_ohUL,jg_oe.jc_oIcons.jc_oIconSS_Skypetxt.absid,"skype:avenida.azul?call",true,"Skype","skp");jr_o.phb._printIcon(qt_ohUL2,jg_oe.jc_oIcons.jc_oIconSS_Pinterest.absid,"https://pinterest.com/avenidaazul",true,"Pinterest","pnt");jr_o.phb._printIcon(qt_ohUL2,jg_oe.jc_oIcons.jc_oIconSS_FacebookPage.absid,"https://www.facebook.com/AvenidaAzul.A3xa/",true,"Facebook page","fbp");jr_o.phb._printIcon(qt_ohUL2,jg_oe.jc_oIcons.jc_oIconSS_Flickr.absid,"https://www.flickr.com/people/avenidaazul/",true,"Flickr","fkr");jr_o.phb._printIcon(qt_ohUL2,jg_oe.jc_oIcons.jc_oIconSS_Flickr.absid,"https://www.flickr.com/avenidaazul/map",true,"Flickr map","fkm");jr_o.phb._printIcon(qt_ohUL2,jg_oe.jc_oIcons.jc_oIconSS_Gplus.absid,"https://plus.google.com/+Avenidaazulcom",true,"G+ page","");jr_o.phb._printIcon(qt_ohUL2,jg_oe.jc_oIcons.jc_oIconSS_Twitter.absid,"https://twitter.com/avenidaazul",true,"Twitter","twt");jr_o.phb._printIcon(qt_ohUL2,jg_oe.jc_oIcons.jc_oIconSS_Video.absid,"https://youtube.com/avenidazul",true,"Youtube","ytb");jr_o.phb._printIcon(qt_ohUL2,jg_oe.jc_oIcons.jc_oIconSS_WCUrl.absid,"https://en.wikipedia.org/wiki/Flush_toilet",true,"Flush toilet","wct");var qt_ohLI_fblike=$("<div>");qt_ohLI_fblike.css({"display":"inline-block","vertical-align":"top"});qt_ohW20.append(qt_ohLI_fblike);if(!(qt_ohLI_fblike&&qt_ohLI_fblike.length))
return false;qt_ohLI_fblike.append("<iframe "+" src='//www.facebook.com/plugins/like.php?href=https%3A%2F%2Ffacebook.com%2FAvenidaAzul.A3xa%2F&amp;width&amp;layout=standard&amp;action=like&amp;show_faces=false&amp;share=false&amp;height=35' "+" scrolling='no' frameborder='0' "+" style='border:none; overflow:hidden; width:300px; height:40px;' allowTransparency='true'>");return true;};jr_o.phb._printIcon=function(qi_ohParent,ji_idIcon,ji_sUrl,ji_bTargetNew,ji_sTitle,ji_sAlt,ji_ppStatus,ji_bLI)
{var jt_o3xmngic=jg_oe.Get_3xAppMngIcons();var jt_odfic=jt_o3xmngic.Get_DefIcons();var jt_o3xhici=jt_o3xmngic.NewSprite(ji_idIcon);jt_o3xhici.Set_UrlLink(ji_sUrl,ji_bTargetNew?true:false);jt_o3xhici.Set_Title(ji_sTitle,ji_sAlt);jt_o3xhici.Set_Options(null,false);var jt_ohButton=new A3xaSimpleButton3(jt_o3xhici);if(ji_ppStatus!=null)
jt_ohButton.Set_Status(ji_ppStatus);var qt_ohLI=null;if(ji_bLI)
...
return false;jt_ohButton.PrintHtml(qt_ohLI);return true;};return jr_o.phb;}
function A3xa3MgrPageTopLogoBar()
{var jr_o={jc_asHomePageTitle:["Travels Nature and Crafts in South America","Turismo Naturaleza y Artesanía en América Latina","Viagens Natureza e Artes na América do Sul","Turismo Natura e Artigianato in America Latina"],jm_bShowLogo:false,jm_IPageHeaderBar:A3xa3MgrPageHeaderBar(),ptb:A3xa3IMgrPageTopLogoBar()};jr_o.ptb.Iptb=function(){return jr_o.ptb;};jr_o.ptb.showLogo=function(ji_b){jr_o.jm_bShowLogo=(ji_b?true:false);return true;};jr_o.ptb.printHtml=function()
...
return false;return true;};return jr_o.ptb;}"use strict";function A3xa3IMgrPageSimpleArticle()
...
function A3xa3MgrPageSimpleArticle()
{var jr_o={jm_shHeader:"",jm_shFooter:"",jm_shBody:"",jm_shAside:"",psa:A3xa3IMgrPageSimpleArticle(),};jr_o.psa.Ipsa=function(){return jr_o.psa;};jr_o.psa.setHtmHeader=function(ji_s){jr_o.jm_shHeader=ji_s;return true;};jr_o.psa.setHtmFooter=function(ji_s){jr_o.jm_shFooter=ji_s;return true;};jr_o.psa.setHtmBody=function(ji_s){jr_o.jm_shBody=ji_s;return true;};jr_o.psa.setHtmAside=function(ji_s){jr_o.jm_shAside=ji_s;return true;};jr_o.psa.printHtml=function()
...
jt_shAll+="</div>";jt_shAll+="</div></div></div></div>";qt_ohpsa.append(jt_shAll);return true;};return jr_o.psa;}"use strict";function A3xaTopMenu()
...
this.A3xaAbsEnvironment_Set_CommonValues2(jt_ohia);this.Set_Debug((jt_ohia.bDebug?1:0),{DB:3,DBT:"idb"});var jt_o3xxur=new A3xaXur();jt_o3xxur.Set_XURString(jt_ohia.xur);this.Get_MgrPage().Set_3xXUR(jt_o3xxur);this.Get_MgrPage().Set_Page(jt_ohia.page);this.jm_o3x2Clock.ck.enableHost(this.Get_WebbotName()?false:true);return true;}
...
jt_Itbtn=A3xa3Tbtnames([A3xa2DefineTbid().jc_tbtype_eid.tbtname,A3xa2DefineTbid().jc_tbtype_ebis.tbtname,A3xa2DefineTbid().jc_tbtype_ebid.tbtname]);jt_this.Get_DataManager().ManageData2({fnDone:jt_this.Get_MgrPage().OnDataManagerDone,bLoadTOC:true,bLoadCommon:true,bLoadEnterprise:true,bStoreAll:true,Itbtn:jt_Itbtn});},10);return true;};this.Set_ItemsNarrowView=function(ji_IdNarrowView)
