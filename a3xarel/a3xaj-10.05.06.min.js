...
jg_oe.CanLogInfo()&&jg_oe.LogInfo("w2sb:"+ji_o3xsText.Get_LString(),"","A3xaAbsEnvironment.LogStatusBar");if(!this._ExecLogStatusBar2(ji_o3xsText,ji_bAsChild,ji_bClear));return true;};this._ExecLogStatusBar2=function(ji_o3xsText,ji_bAsChild,ji_bClear){return false;};this.jm_o3x2Envars=A3xa2EnvironmentVariables();this.Set_CommonValues=function(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_sDirBase,ji_sHomeDir,ji_sLang,ji_sSitemapDate)
{return this.A3xaAbsEnvironment_Set_CommonValues(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_sDirBase,ji_sHomeDir,ji_sLang,ji_sSitemapDate);}
this.A3xaAbsEnvironment_Set_CommonValues=function(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_sDirBase,ji_sHomeDir,ji_sLang,ji_sSitemapDate)
{this.jm_bDebug=(ji_bDebug==true);this.jm_bCanEdit=ji_bCanEdit;this.jm_bCanLike=ji_bCanLike;this.jm_sDirBase=(ji_sDirBase?ji_sDirBase:"/");this.jm_sHomeDir=(ji_sHomeDir?ji_sHomeDir:"/");this.jm_sLang=(ji_sLang?ji_sLang:"en");this.jm_sSitemapDate=(ji_sSitemapDate?ji_sSitemapDate:"");return true;};this.CheckInitDone=function(){return true;};this.jm_oAjax2=new A3xaAjax2();this.jm_oMgrStorage=null;this.Get_MgrStorage=function(){return this.jm_oMgrStorage;};this.jm_odb=null;this.Set_Database=function(ji_odb){this.jm_odb=ji_odb;return true;};this.Get_Database=function(){return this.jm_odb;};this.jm_oHostReporter=null;this.Set_Reporter=function(ji_oHostReporter)
...
var jt_otbn=this.NewDataTableCacheStore(jt_glid_ebid);this.jm_aoglDataTableStore.Set_Item(jt_glid_ebid,jt_otbn);var jt_o3x2tbn=this.Get_SDSDBStore().db.get3x2Table(jt_glid_ebid);if(!(jt_otbn&&jt_o3x2tbn&&jt_otbn.Get_Glid()==jt_o3x2tbn.tb.getGlid()))
{jt_bFail=true;if(jt_otbn)
jt_otbn.jm_oDTStatus.SetCacheStatusFail("Missing Table Name(2)");}
else
{jt_otbn.Set_Release(jt_o3x2tbn.tb.getVersion());jt_otbn.Build_3xJSDS(jt_o3x2tbn);jt_otbn.jm_oDTStatus.SetCacheStatusSuccess();}
...
{var jt_oxur=new A3xaXur();jt_oxur.Set_XURString(ji_ogAjaxResponse.Get_ItemValue("p3x"));jt_oxur.Set_XUDString(ji_ogAjaxResponse.Get_ItemValue("p3d"));var jt_glidEID=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEID_SUME");var jt_sGLRSEID=ji_ogAjaxResponse.Get_ItemValue("p_GLEID_SUME");var jt_glidEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEBID_SUME");var jt_sGLRSEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLEBID_SUME");if(!jg_oApp.WriteGLRS2(jt_glidEID,jt_sGLRSEID))
...
jr_sxj+='}';return jr_sxj;};this.jm_TypEntity=null;this.jm_IdEntity=null;this.jm_Count=null;this.jm_Likes=null;this.jm_LikesBonus=null;this.jm_Clicks=null;this.jm_ClickTime="";this.jm_Score=null;this.jm_MaxClicks=null;this.jm_MaxScore=null;}
...
{var jt_this=this;var jt_o3xxeCP=jg_oApp.Get_3xXEMSC_ByXUR();if(jt_o3xxeCP)
...
{jt_sEnt=encodeURIComponent(this.HyphenSpecialChars(jt_sEnt,false,2));jt_sCat=encodeURIComponent(this.HyphenSpecialChars(jt_sCat,false,2));jt_sCit=encodeURIComponent(this.HyphenSpecialChars(jt_sCit,false,2));jt_sSta=encodeURIComponent(this.HyphenSpecialChars(jt_sSta,false,2));jt_sCou=encodeURIComponent(this.HyphenSpecialChars(jt_sCou,false,2));jt_sReg=encodeURIComponent(this.HyphenSpecialChars(jt_sReg,false,2));jt_sAre=encodeURIComponent(this.HyphenSpecialChars(jt_sAre,false,2));}
...
var jr_s=jt_sEnt+","+jt_sCat+","+jt_sCit+","+jt_sSta+","+jt_sCou+","+jt_sReg+","+jt_sAre;return jr_s;};this.HyphenSpecialChars=function(ji_s,ji_bUnescape,ji_type)
{if(!ji_s)
return"";var jr_s="";if(ji_bUnescape===true)
return ji_s;if(ji_type==2)
...
this.CopyFrom(jt_oglrMain,false,true,false,false);return true;};this.CopyFrom=function(ji_odc,ji_bXEID,ji_bEBIS,ji_bEBID,ji_bEI)
...
{var jt_squrDescr=jg_oe.Get_AppXUR().QUR_Get_Descr2(this.jm_QUR,this.jm_Single,this.Get_3xXEID());this.Set_XUDParams(jt_squrDescr,jt_sCategory,jt_sGeoCity,jt_sGeoState,jt_sGeoCountry,jt_sGeoRegion,jt_sGeoArea);return true;}
...
this.Get_3xXUR().jm_FormName=jg_oe.jc_oXUR.jc_XURFN_ListEntity;jQuery(document).prop('title',this.Get_3xXUR().Get_XUDString2());var jt_o3xurl=this.Get_3xXUR().Get_A3xaUrl(false,true);if(jt_o3xurl)
...
ji_oxeid=ji_oxeid.Get_3xXEID();if(!ji_oxeid)
return false;var jt_te=ji_oxeid.Get_TypEntity();var jt_odt_Areas=ji_odb.Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoArea);var jt_o3xait_Areas=null;if(jt_odt_Areas)
jt_o3xait_Areas=new A3xaArrayIt(jt_odt_Areas.Get_Recordset());if(!jt_o3xait_Areas)
...
return false;if(ji_oxeid)
ji_oxeid=ji_oxeid.Get_3xXEID();if(!ji_oxeid)
return false;var jt_te=ji_oxeid.Get_TypEntity();var jt_odt_Regions=ji_odb.Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoRegion);var jt_o3xait_Regions=null;if(jt_odt_Regions)
jt_o3xait_Regions=new A3xaArrayIt(jt_odt_Regions.Get_Recordset());if(!jt_o3xait_Regions)
...
return false;var jt_Select_A=ji_oxeid.Get_3xAZNMC().Get_A();var jt_Select_Z=ji_oxeid.Get_3xAZNMC().Get_Z();var jt_Select_N=ji_oxeid.Get_3xAZNMC().Get_N();var jt_odt_Cities=ji_odb.Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoCity);var jt_o3xait_Cities=null;if(jt_odt_Cities)
jt_o3xait_Cities=new A3xaArrayIt(jt_odt_Cities.Get_Recordset());if(!jt_o3xait_Cities)
...
var jt_A=jt_o3xeid.Get_3xAZNMC().Get_A();var jt_Z=jt_o3xeid.Get_3xAZNMC().Get_Z();var jt_N=jt_o3xeid.Get_3xAZNMC().Get_N();var jt_M=jt_o3xeid.Get_3xAZNMC().Get_M();var jt_C=jt_o3xeid.Get_3xAZNMC().Get_C();if((jt_Select_A&&jt_Select_A!=jt_A)||(jt_Select_Z&&jt_Select_Z!=jt_Z)||(jt_Select_N&&jt_Select_N!=jt_N))
{jt_o3xait_Cities.Next();continue;}
...
return false;var jt_te=ji_oxeidXUR.Get_TypEntity();var jt_Select_A=ji_oxeidXUR.Get_3xAZNMC().Get_A();var jt_Select_Z=ji_oxeidXUR.Get_3xAZNMC().Get_Z();var jt_Select_N=ji_oxeidXUR.Get_3xAZNMC().Get_N();var jt_Select_M=ji_oxeidXUR.Get_3xAZNMC().Get_M();var jt_Select_C=ji_oxeidXUR.Get_3xAZNMC().Get_C();var jt_Select_Ucat=ji_oxeidXUR.Get_3xCat().Get_Ucat();var jt_Select_Vcat=ji_oxeidXUR.Get_3xCat().Get_Vcat();var jt_bYB=New_A3xaAZNMC_XApp(ji_oxeidXUR).IsBestFromBabylon();var jt_bLA=New_A3xaAZNMC_XApp(ji_oxeidXUR).IsLA();var jt_o3xsiiCP=null;if(jt_bLA)
...
{if(!ji_odb)
return false;this.jm_odtMain=ji_odb.Get_MainDataTable();if(!this.IsValid())
return false;if(ji_oxeid)
ji_oxeid=ji_oxeid.Get_3xXEID();if(!ji_oxeid)
return false;if(!(ji_oxeid.Get_TypEntity()==jg_oe.jc_oEntity.jc_Typ_Enterprise&&ji_oxeid.Get_3xAZNMC().Get_N()))
...
{var jr_I={onClickEntity:function(ji_enty,ji_U,ji_V){return"";}};return jr_I;}
function A3xa2MgrScore()
{var jr_o={ms:A3xa2IMgrScore()};jr_o.ms.onClickEntity=function(ji_enty,ji_A,ji_Z,ji_N,ji_M,ji_C)
{};return jr_o;}
...
return false;return true;};this.Set_ItemsNarrowView=function(ji_IdNarrowView){return true;};this.jm_o3xDataManager=null;this.Get_DataManager=function(){return null;};this.jm_oMgrSummary=null;this.Get_MgrSummary=function(){return this.jm_oMgrSummary;};this.jm_o3x2MgrScore=null;this.Get_MgrScore=function(){return this.jm_o3x2MgrScore;};}
...
{return jg_oApp.OnClickEntity2(this.jm_o3xehbenv.jm_oxe,jt_xTypEntity,jt_xIdEntity,'',0,'');});qt_oParent=null;qt_oParent=qt_oWebsite;}}
...
{qt_oParent.append(qt_oWebsite);qt_oWebsite.click(function()
{return jg_oApp.OnClickEntity2(this.jm_o3xehbenv.jm_oxe,jt_xTypEntity,jt_xIdEntity,jg_oe.jc_oEntityInfo.jc_TI_Image,0,'');});qt_oParent=null;qt_oParent=qt_oWebsite;}}
...
{if(!this.IsValid())
return false;this.PrintHtml_Score(qi_oCell,ji_Row,ji_Col);this.PrintHtml_Clicks(qi_oCell,ji_Row,ji_Col);return true;};}
...
{qt_oDivEditForm.remove();}
return true;};return jr_o;}
function A3xa2IMgrPageHeaderBar()
...
return false;}
jr_o.phb._printIcon(qt_ohW20,jg_oe.jc_oIcons.jc_oIconSS_Sitemap.absid,jg_oe.jm_sHomeDir+jg_oe.jm_sLang+"/sitemap","Sitemap-xml-Index-"+jg_oe.jm_sSitemapDate,"smx");var qt_ohUL=$("<div class='list-inline'>");qt_ohUL.css({"display":"inline-block","vertical-align":"top"});qt_ohW20.append(qt_ohUL);if(!(qt_ohUL&&qt_ohUL.length))
...
return false;jt_ohButton.PrintHtml(qt_ohLI);return true;};return jr_o;}
...
{var jt_sQS=jg_oe.jc_oUrls.jc_surlRelHomeDirDDAJOO_LA;jt_o3xhici_LA.Set_UrlLink(jg_oe.jm_sHomeDir+jg_oe.jm_sLang+"/"+jt_sQS,false);}
...
{var jt_sQS=jg_oe.jc_oUrls.jc_surlRelHomeDirDDAJOO_YB;jt_o3xhici_YB.Set_UrlLink(jg_oe.jm_sHomeDir+jg_oe.jm_sLang+"/"+jt_sQS,false);}
...
{this.jc_oStorage=new A3xaDefines_Storage();this.jc_oA3xaDbZero=new A3xaDefines_A3xaDbZero();this.jc_oEntity=new A3xaDefines_Entity();this.jc_oEntityInfo=new A3xaDefines_EntityInfo();this.jc_oHtml=new A3xaDefines_Html();this.jc_oUrls=new A3xaDefines_Urls();this.jm_oAppXUR=new A3xaAppXUR();this.jm_oAppXUR.Set_DefXUR(new A3xaDefines_XUR());this.jc_oXUR=this.jm_oAppXUR.Get_DefXUR();this.jm_oAppMngIcons=new A3xaAppMngIcons();this.jm_oAppMngIcons.Set_DefIcons(new A3xaDefines_Icons());this.jc_oIcons=this.jm_oAppMngIcons.Get_DefIcons();this.jm_oMgrStorage=new A3xaStorageManager();this.Set_Reporter(new A3xaReporter());this.Set_Database(new A3xaDbZero());this.Get_MgrStorage().EnableStorage(function(ji_bReady){return jt_this.CheckInitDone();});this.jm_oMgrSummary=new A3xaMgrSummary();this.jm_o3x2MgrScore=A3xa2MgrScore();};this.HostInitApplication=function(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_sPage,ji_sxur,ji_sDirBase,ji_sHomeDir,ji_sLang,ji_sSitemapDate)
{this.A3xaAbsEnvironment_Set_CommonValues(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_sDirBase,ji_sHomeDir,ji_sLang,ji_sSitemapDate);this.Set_Debug((ji_bDebug?1:0),{DB:3,DBT:"idb"});this.Get_AppXUR().Set_XURString(ji_sxur);this.Get_AppXUR().Set_Page(ji_sPage);return true;};this.Get_ECPMgr=function()
...
return false;return true;};this.OnClickEntity2=function(ji_oxe,ji_TypEntity,ji_IdEntity,ji_TypInfo,ji_IdInfo,ji_CodInfo)
{try
