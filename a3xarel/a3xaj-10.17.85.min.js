...
{jg_oe.LogStatusBar2(new A3xaString(["Request Cities info","Solicitud Ciudades info","Solicitação Ciudades info","Richiesta Città info"]));var jt_aoJSDBei=jg_oe.jc_oUrls.Get_PathJSDB({bRelease:jg_oe.jm_bReleaseJSDB,bCommon:true,bCities:true,tbtnames:["ei"]});$.ajax({type:"GET",dataType:"script",url:jt_aoJSDBei[0].src,data:{"integrity":jt_aoJSDBei[0].integrity,"crossorigin":"anonymous"},success:function()
{if(ji_fnOnDone)
...
{var jt_pisdsRecord_glidtoc=this.jm_oDatabase.Get_TOCItem(jt_glid_ei);if(!jt_pisdsRecord_glidtoc)
{var jr_b=A3xaAjaxTables().requestCities(function(ji_bSuccess,jt_o3xxur,jt_Itbtn)
{if(ji_bSuccess)
...
{return true;},jt_o3xxur,jt_Itbtn);}}},null,null);}
else
