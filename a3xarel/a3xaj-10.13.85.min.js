...
{var jt_o3xxur=jg_oApp.Get_AppXUR().Get_3xXUR();var jt_ogldtMain=this.jm_oDatabase.Get_DataTable();var jt_I3tbid=A3xa3Tbid();var jt_glid_ei=jt_I3tbid.makeByType(jt_ogldtMain.Get_Glid(),A3xa2DefineTbid().jc_tbtype_ei);var jt_bdt=false;if(jt_I3tbid.isEnterprise())
{var jt_pisdsRecord_glidtoc=this.jm_oDatabase.Get_TOCItem(jt_glid_ei);if(jt_pisdsRecord_glidtoc)
jt_bdt=true;}
else
{return false;}
var jt_Itbtn=A3xa3Tbtnames([A3xa2DefineTbid().jc_tbtype_ei.tbtname]);if(!jt_bdt)
return this._ManageNewDataRequest(jt_o3xxur,ji_fnDone,jt_Itbtn);return this.ManageData2({fnDone:ji_fnDone,bLoadEnterprise:true,Itbtn:jt_Itbtn});};this.RequestXURData=function(ji_o3xXUR,ji_fnDone)
...
return jt_fnOnLoadEnterprisesDone(new GLDataStatusLoadSuccess());};if(ji_oParams.bLoadCommon)
{this._ManageDataLoadCommon(function(ji_bSuccess)
{if(ji_bSuccess)
return jt_this._ManageDataRequest(jt_fnOnLoadCommon2Done,jt_o3xxur,true,ji_oParams.bPreloaded,ji_oParams.Itbtn);return jt_fnThatsAllFolks(new GLDataStatusLoadFail());});}
else
{jt_fnOnLoadCommon2Done(true);}
return true;};this._ManageDataLoadCommon=function(ji_fnOnLoadCommonDone)
{var jt_fnOnLoadCommonDone=function(ji_bSuccess)
{if(!ji_bSuccess)
{if(jt_this._LoadCacheStoreCommon())
ji_bSuccess=true;}
if(ji_fnOnLoadCommonDone)
return ji_fnOnLoadCommonDone(ji_bSuccess);return true;};this._DatabaseLoadTOC(function(ji_bSuccess)
{if(ji_bSuccess)
{if(!(jt_this.jm_oDatabase.Get_IArrayDTLoad({jp_bTyp_Common:true})&&jt_this.jm_oDatabase.Get_IArrayDTLoad({jp_bTyp_Common:true}).I().Iar.getCount()>0))
...
return jt_fnOnLoadCommonDone(false);return jt_this._DatabaseLoadCommon(jt_fnOnLoadCommonDone);}
return jt_fnOnLoadCommonDone(true);}});return true;};this._ManageDataRequest=function(ji_fnRequestDone,ji_o3xxur,ji_bAlsoLoadCommon,ji_bPreloaded,ji_Itbtn)
...
return(jt_bSuccess?jt_this._DatabaseLoadCommon(ji_fnRequestDone):(ji_fnRequestDone?ji_fnRequestDone(false):false));return(ji_fnRequestDone?ji_fnRequestDone(jt_bSuccess):jt_bSuccess);}
else
{var jr_b=A3xa3AjaxTables().requestMain(function(ji_bSuccess)
{if(ji_bAlsoLoadCommon)
return(ji_bSuccess?jt_this._DatabaseLoadCommon(ji_fnRequestDone):(ji_fnRequestDone?ji_fnRequestDone(false):false));return(ji_fnRequestDone?ji_fnRequestDone(ji_bSuccess):ji_bSuccess);},(ji_bAlsoLoadCommon?null:ji_o3xxur),ji_Itbtn);}
return jr_b;}
if(ji_bAlsoLoadCommon)
return jt_this._DatabaseLoadCommon(ji_fnRequestDone);return(ji_fnRequestDone?ji_fnRequestDone(true):true);};this._ManageDataLoadEnterprises=function(ji_fnOnLoadEnterprisesDone,ji_o3xxur,ji_Itbtn)
...
{if(ji_bSuccess)
return jt_this._StoreTOC(ji_fnOnStoreAllDone);return ji_fnOnStoreAllDone(false);});}},10);return true;};this._LoadCacheStoreCommon=function()
...
return true;}
this.jm_oDatabase.StoreTOC(true);return true;};this._DatabaseLoadCommon=function(ji_fnOnDone)
...
return true;},this.jm_oDatabase);this.jm_odbLoader.LoadTables({jp_bTyp_Common:true},false);return true;};}
...
{var jt_I3tbid=A3xa3Tbid(jt_oSchemaTable.jp_sName);var jt_sTableNameQUR=(jt_I3tbid.default2GlidXEID(jg_oApp.Get_AppXUR().Get_3xXUR())||"");if(jt_sTableNameQUR&&($.isEmptyObject(ji_Itbtn)||(ji_Itbtn.hasEID()&&jt_I3tbid.isEID())||(ji_Itbtn.hasEBIS()&&jt_I3tbid.isEBIS())||(ji_Itbtn.hasEBID()&&jt_I3tbid.isEBID())||(ji_Itbtn.hasEI()&&jt_I3tbid.isEI())))
...
{continue;}
var jt_I3tbid=A3xa3Tbid(jt_oSchemaTable.jp_sName);if(!(jt_oSchemaTable.jp_sName&&($.isEmptyObject(ji_Itbtn)||(ji_Itbtn.hasEID()&&jt_I3tbid.isEID())||(ji_Itbtn.hasEBIS()&&jt_I3tbid.isEBIS())||(ji_Itbtn.hasEBID()&&jt_I3tbid.isEBID())||(ji_Itbtn.hasEI()&&jt_I3tbid.isEI()))))
{continue;}
var jt_sTableNameQUR=(A3xa3Tbid(jt_oSchemaTable.jp_sName).default2GlidXEID(jt_o3xxurxeid)||"");if(!jt_sTableNameQUR)
continue;var jt_sTableParentQUR=(jt_oSchemaTable.jp_sParent?(A3xa3Tbid(jt_oSchemaTable.jp_sParent).default2GlidXEID(jt_o3xxurxeid)||""):"");var jt_IArray_dtl=this.jm_oDatabase.Get_IArrayDTLoad(this.jm_pTypTables);jg_oe.CanLogInfo()&&jg_oe.LogInfo("jt_sTableNameQUR,jt_oSchemaTable.jp_sName,jt_IArray_dtl.getCount(): "+
...
{this.ResetApp();this.Get_DataManager().ManageData2({fnDone:jg_oApp.OnDataManagerDone,bLoadCommon:true,bLoadEnterprise:true,bStoreAll:true});}
...
jt_Itbtn=A3xa3Tbtnames([A3xa2DefineTbid().jc_tbtype_eid.tbtname,A3xa2DefineTbid().jc_tbtype_ebis.tbtname,A3xa2DefineTbid().jc_tbtype_ebid.tbtname]);var jt_oglPreloadedData=this.Get_GLPreloadedData();if(jt_oglPreloadedData&&!jQuery.isEmptyObject(jt_oglPreloadedData))
this.Get_DataManager().ManageData2({fnDone:jg_oApp.OnDataManagerDone,bLoadCommon:true,bLoadEnterprise:true,bStoreAll:true,bPreloaded:true,Itbtn:jt_Itbtn});else
this.Get_DataManager().ManageData2({fnDone:jg_oApp.OnDataManagerDone,bLoadCommon:true,bLoadEnterprise:true,bStoreAll:true,Itbtn:jt_Itbtn});}
...
jt_Itbtn=A3xa3Tbtnames([A3xa2DefineTbid().jc_tbtype_eid.tbtname,A3xa2DefineTbid().jc_tbtype_ebis.tbtname,A3xa2DefineTbid().jc_tbtype_ebid.tbtname]);jt_this.Get_DataManager().ManageData2({fnDone:jg_oApp.OnDataManagerDone,bLoadCommon:true,bLoadEnterprise:true,bStoreAll:true,Itbtn:jt_Itbtn});},10);return true;};this.ShowCPTemplate=function()
