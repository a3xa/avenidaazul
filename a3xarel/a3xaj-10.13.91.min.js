...
jr_a.push(jt_item);}
return jr_a;};jr_o.Get_I3x3=function(){return jr_o.ar;};jr_o.Set_Item=jr_o.ar.setItem;jr_o.Add_Item=jr_o.ar.addItem;jr_o.Get_Item=jr_o.ar.getItem;jr_o.Get_Key=jr_o.ar.getKey;return jr_o.ar;}
...
{return(jr_o.jm_ix<0||jr_o.jm_ix>=jr_o.ar.getCount());};jr_o.Get_I3x3=function(){return jr_o.arit;};jr_o.Set_Item=jr_o.ar.setItem;jr_o.Add_Item=jr_o.ar.addItem;jr_o.Get_Item=jr_o.ar.getItem;jr_o.Get_Key=jr_o.ar.getKey;jr_o.arit.set3x2Array(ji_IArray_Target);return jr_o.arit;}"use strict";function A3xaString(ji_as)
...
{return(this.jm_aoddiChildren?this.jm_aoddiChildren.Get_I3x3().I().Iar.getCount():0);};this.Add_Child=function(ji_oddi)
{if(!ji_oddi)
...
{if(!this.jm_aoddiChildren)
return null;var jt_aIddiChildren=this.jm_aoddiChildren.Get_I3x3().I().Iar;return jt_aIddiChildren.getItem_ByIndex(ji_index);};this.Get_ChildKey=function(ji_index)
{if(!this.jm_aoddiChildren)
return null;return this.jm_aoddiChildren.Get_Key(ji_index);};this.Sort_Children=function(ji_fnCompare,ji_bAllTreeRecursion)
{if(!this.jm_aoddiChildren)
return false;var jt_aIddiChildren=this.jm_aoddiChildren.Get_I3x3().I().Iar;jt_aIddiChildren.sortItems(ji_fnCompare);if(ji_bAllTreeRecursion)
...
return false;if(jr_o.jm_bEI&&jt_xitemEI&&jt_xitemEI.glid&&!jg_oApp.WriteGLRS2(jt_xitemEI.glid,jt_xitemEI.oglh,jt_xitemEI.glrs))
return false;return true;};jr_o.dts.writeEmptyGLRS2=function(ji_GLent,ji_slicech,ji_idForeign)
{if(ji_GLent!="E")
return false;var jt_tbrelease=(jg_oApp.Get_Database().Get_SDSDBWork().db.getDefaultDbVersion()||"");var jt_I3tbid=A3xa3Tbid();var jt_xitemEID={glid:"",oglh:null,glh:"",oglrs:null,glrs:""};var jt_xitemEBIS={glid:"",oglh:null,glh:"",oglrs:null,glrs:""};var jt_xitemEBID={glid:"",oglh:null,glh:"",oglrs:null,glrs:""};var jt_xitemEI={glid:"",oglh:null,glh:"",oglrs:null,glrs:""};if(jr_o.jm_bEID)
...
{var jt_otb=this.NewDataTableCacheStore(jt_glid_eid);this.Get_ArrayDTStore().Set_Item(jt_glid_eid,jt_otb);var jt_o3x2tb=this.Get_SDSDBStore().db.get3x2Table(jt_glid_eid);if(!(jt_otb&&jt_o3x2tb&&jt_otb.Get_Glid()==jt_o3x2tb.tb.getGlid()))
...
jt_bdt=true;}
else if(jg_oApp.Get_AppXUR().Get_3xXUR().Matches(ji_o3xXUR,true)&&this.jm_oDatabase.Get_DataTable())
jt_bdt=true;}
...
jg_oApp.Get_AppXUR().Set_3xXUR(ji_o3xXUR);jg_oApp.ResetApp();this.ManageData2({fnDone:ji_fnDone,bLoadEnterprise:true,Itbtn:jt_Itbtn});return true;};this._ManageNewDataRequest=function(ji_o3xxurNew,ji_fnDone,ji_Itbtn)
...
{var jt_I3tbid=A3xa3Tbid(jt_oSchemaTable.jp_sName);var jt_sTableNameQUR=(jt_I3tbid.default2GlidXEID(jg_oApp.Get_AppXUR().Get_3xXUR())||"");if(jt_sTableNameQUR&&this._IsGlidToLoad_(jt_I3tbid,ji_Itbtn))
...
{jt_odtToReuse=null;jt_o3xtbsds=null;}}}
if(jt_odtToReuse)
{jt_odtToReuse.jm_oDTStatus=new GLDataStatusLoadSuccess();jt_aodtToLoad.Set_Item(jt_glidToReuse,jt_odtToReuse);jg_oe.CanLogInfo()&&jg_oe.LogInfo("jt_glidToReuse,jt_odtToReuse="+jt_glidToReuse+","+jt_odtToReuse,"","A3xaDbLoader._MoveStore2Load");}
else
...
return true;this.jm_bSetupLoadedRecords=true;var jt_o3xxurxeid=jg_oApp.Get_AppXUR().Get_3xXUR().Get_3xXEID();for(var i=0;i<this.jm_oDatabase.jm_oDbSchema.jm_aTables.length;i++)
...
{jr_o.src="https://rawgit.com/a3xa/avenidaazul/master/a3xarel/a3xajdbei-10.13.90-01609161800.min.js";jr_o.integrity="sha384-t0dhjHPfXpkZJQzgY5sADp7h91rx/OGjj/qo8ptB6K0A3g26oWuLfLzaWn9hY0Va";}
else
...
{return((ji_level>=0&&this.jm_aPage&&this.jm_aPage[ji_level])?this.jm_aPage[ji_level]:"");};this.IsPageSitemap=function(ji_sPage0)
{if(!ji_sPage0)
ji_sPage0=this.Get_Page(0);ji_sPage0=(ji_sPage0?ji_sPage0.toLowerCase():"");return ji_sPage0=="sitemap";};this.IsPageSimple=function(ji_sPage0)
{if(!ji_sPage0)
ji_sPage0=this.Get_Page(0);ji_sPage0=(ji_sPage0?ji_sPage0.toLowerCase():"");return ji_sPage0=="home"||ji_sPage0=="search-hotel"||ji_sPage0=="overview"||ji_sPage0=="users";};this.IsPageEntity=function(ji_sPage0)
{return!(this.IsPageSimple(ji_sPage0)||this.IsPageSitemap(ji_sPage0));};this.QUR_Get_Descr2=function(ji_sQUR,ji_Single,ji_o3xxeid)
...
return"Update";}
return ji_sQUR+"_unknown";};this.jm_oxur=new A3xaXur();this.Get_3xXUR=function(){return this.jm_oxur;};this.Set_3xXUR=function(ji_oxur){this.jm_oxur=(ji_oxur||null);return true;};this.OnDataLoadedSetup=function()
...
{if(!ji_sUrlParams)
return false;var jt_o3xXUR=new A3xaXur();jt_o3xXUR.Set_UrlParams(jg_oe.jc_oXUR.jc_XURFN_ListEntity,null,jg_oe.jc_oXUR.jc_sAjaxTypEntitySet,null,null,null,null,ji_sUrlParams);jg_oApp.ClearView();return jg_oApp.Get_DataManager().RequestXURData(jt_o3xXUR,jg_oApp.OnDataManagerDone);}
...
this.jm_o3xaSummaryByCity=A3xa3Array().O();this.jm_o3xSummaryByCatAll=new A3xaSummaryInfoItem();this.jm_o3xaSummaryByCatGroup=A3xa3Array().O();this.jm_o3xaSummaryByCat=A3xa3Array().O();jt_IaritDTSummary.I().Iar.foreachItem(function(ji_o3xe,ji_ix,ji_key)
...
this.jm_o3xSummaryByCatAll.Add(jt_o3xsiiCatGroup,jt_bRestricted);this._AddSummaryItem(this.jm_o3xaSummaryByCatGroup,jt_o3xsiiCatGroup,jt_bRestricted);this._AddSummaryItem(this.jm_o3xaSummaryByCat,new A3xaSummaryInfoItem(jt_o3xeMain,true,true,false,jt_bSummaryMain),jt_bRestricted);jt_IaritDTMain.next();}
return true;};this._AddSummaryItem=function(ji_o3xaSummary,ji_o3xsii,ji_bRestricted)
{return this._AddSummaryItem2((ji_o3xaSummary?ji_o3xaSummary.Get_I3x3():null),ji_o3xsii,ji_bRestricted);};this._AddSummaryItem2=function(ji_IarSummary,ji_o3xsii,ji_bRestricted)
...
this.A3xaAbsEnvironment_Set_CommonValues2(jt_ohia);this.Set_Debug((jt_ohia.bDebug?1:0),{DB:3,DBT:"idb"});var jt_o3xxur=new A3xaXur();jt_o3xxur.Set_XURString(jt_ohia.xur);this.Get_AppXUR().Set_3xXUR(jt_o3xxur);this.Get_AppXUR().Set_Page(jt_ohia.page);this.jm_o3x2Clock.ck.enableHost(this.Get_WebbotName()?false:true);return true;}
...
return false;this.jm_bCheckInitDone=true;var jt_pg0=this.Get_AppXUR().Get_Page(0);if(this.Get_AppXUR().IsPageSitemap(jt_pg0))
{this.ResetApp();this.Get_DataManager().ManageData2({fnDone:jg_oApp.OnDataManagerDone,bLoadTOC:true,bLoadCommon:true,bLoadEnterprise:true,bStoreAll:true});}
else if(this.Get_AppXUR().IsPageSimple(jt_pg0))
{this.DocumentShow();}
else
{this.ResetApp();this.ShowCPTemplate();this.LogStatusBar2(new A3xaString(["Ready","Listo","Pronto","Pronto"]),false,true);var jt_Itbtn=null;if(this.Get_AppXUR().Get_3xXUR().IsMultiple())
jt_Itbtn=A3xa3Tbtnames([A3xa2DefineTbid().jc_tbtype_eid.tbtname,A3xa2DefineTbid().jc_tbtype_ebis.tbtname,A3xa2DefineTbid().jc_tbtype_ebid.tbtname]);this.Get_DataManager().ManageData2({fnDone:jg_oApp.OnDataManagerDone,bLoadTOC:true,bLoadCommon:true,bLoadEnterprise:true,bStoreAll:true,bPreloaded:this.Get_GLPreloadedData()&&!jQuery.isEmptyObject(this.Get_GLPreloadedData()),Itbtn:jt_Itbtn});}
...
this.jm_o3xDataManager=new A3xaDataManager(this.Get_Database());return this.jm_o3xDataManager;};this.OnDataManagerDone=function(ji_oDTStatus)
{if(ji_oDTStatus.IsOpLoad()&&ji_oDTStatus.IsDone())
{var jt_otmDocumentShow=setTimeout(function()
{jt_this.Set_3xXEMSC_ByXUR(jt_this.Get_Database().Get_3xXEMSC_ByXUR(true));jt_this.Get_Database().OnDataLoadedSetup();jt_this.Get_AppXUR().OnDataLoadedSetup();jt_this.SetupSummary();jt_this.DocumentShow();},10);}
return true;};this.SetupSummary=function()
...
{var jr_b=true;var jt_pg0=this.Get_AppXUR().Get_Page(0);if(this.Get_AppXUR().IsPageSitemap(jt_pg0))
return this.ShowSitemap();if(this.Get_AppXUR().IsPageSimple(jt_pg0))
return this.ShowSimplePage();try
...
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("ji_glid,ji_sGLRS="+ji_glid+","+ji_sGLRS,"","A3xaAppManager.WriteGLRS2");var jr_b=false;try
...
{jt_this.ClearView();jt_this.ResetApp();jt_this.Get_DataManager(true);jt_this.Get_Database().ClearArrayDTLoad({jp_bTyp_Gold:true,jp_bTyp_Silver:true,jp_bTyp_Main:true,jp_bTyp_Unique:true,jp_bTyp_Major:true,jp_bTyp_Subry:true});var jt_Itbtn=null;if(jt_this.Get_AppXUR().Get_3xXUR().IsMultiple())
jt_Itbtn=A3xa3Tbtnames([A3xa2DefineTbid().jc_tbtype_eid.tbtname,A3xa2DefineTbid().jc_tbtype_ebis.tbtname,A3xa2DefineTbid().jc_tbtype_ebid.tbtname]);jt_this.Get_DataManager().ManageData2({fnDone:jg_oApp.OnDataManagerDone,bLoadTOC:true,bLoadCommon:true,bLoadEnterprise:true,bStoreAll:true,Itbtn:jt_Itbtn});},10);return true;};this.ShowCPTemplate=function()
