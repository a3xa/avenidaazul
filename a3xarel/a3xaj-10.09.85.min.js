...
jg_oe.CanLogInfo()&&jg_oe.LogInfo("w2sb:"+ji_o3xsText.Get_LString(),"","A3xaAbsEnvironment.LogStatusBar");if(!this._ExecLogStatusBar2(ji_o3xsText,ji_bAsChild,ji_bClear));return true;};this._ExecLogStatusBar2=function(ji_o3xsText,ji_bAsChild,ji_bClear){return false;};this.jm_o3x2Envars=A3xa2EnvironmentVariables();this.jm_oGLData={};this.Get_GLPreloadedData=function(){return this.jm_oGLData;};this.Set_CommonValues=function(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_sDirBase,ji_sHomeDir,ji_sLang,ji_sSitemapDate,ji_oGLDataJSObject)
{return this.A3xaAbsEnvironment_Set_CommonValues(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_sDirBase,ji_sHomeDir,ji_sLang,ji_sSitemapDate,ji_oGLDataJSObject);}
this.A3xaAbsEnvironment_Set_CommonValues=function(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_sDirBase,ji_sHomeDir,ji_sLang,ji_sSitemapDate,ji_oGLDataJSObject)
{this.jm_bDebug=(ji_bDebug==true);this.jm_bCanEdit=ji_bCanEdit;this.jm_bCanLike=ji_bCanLike;this.jm_sDirBase=(ji_sDirBase?ji_sDirBase:"/");this.jm_sHomeDir=(ji_sHomeDir?ji_sHomeDir:"/");this.jm_sLang=(ji_sLang?ji_sLang:"en");this.jm_sSitemapDate=(ji_sSitemapDate?ji_sSitemapDate:"");this.jm_oGLData=ji_oGLDataJSObject;return true;};this.CheckInitDone=function(){return true;};this.jm_oAjax2=new A3xaAjax2();this.jm_oMgrStorage=null;this.Get_MgrStorage=function(){return this.jm_oMgrStorage;};this.jm_odb=null;this.Set_Database=function(ji_odb){this.jm_odb=ji_odb;return true;};this.Get_Database=function(){return this.jm_odb;};this.jm_oHostReporter=null;this.Set_Reporter=function(ji_oHostReporter)
...
{var jr_I={I:function(){return null;},getItem:function(ji_sName){return"";},getGLItem:function(ji_sGLnameGLID,ji_sGLnameGLH,ji_sGLnameGL){return{glid:"",glh:"",glrs:""};},getGLItem2:function(ji_tbtname,ji_GLent,ji_slicech,ji_idForeign){return{glid:"",glh:"",glrs:""};}};return jr_I;}
...
{var jr_oitem={glid:jr_o.dsp.getItem(ji_sGLnameGLID),oglh:null,glh:jr_o.dsp.getItem(ji_sGLnameGLH),glrs:jr_o.dsp.getItem(ji_sGLnameGL)};if(jr_oitem.glh)
...
return"";return jr_o.jm_osPool[ji_sName];};jr_o.dsp.getGLItem=function(ji_sGLnameGLID,ji_sGLnameGLH,ji_sGLnameGL)
{jr_oitem={glid:jr_o.dsp.getItem(ji_sGLnameGLID),oglh:jr_o.dsp.getItem(ji_sGLnameGLH),glh:"",glrs:jr_o.dsp.getItem(ji_sGLnameGL)};return jr_oitem;};return jr_o.dsp;}
...
{var jr_o={jm_odb:null,jm_glid:null,jm_header_glid:null,jm_header_release:null,jm_o3xJSDS:null,jm_odt:null,jm_aglRS:null,jm_sGLRS:null,jm_oglh:null,csw:A3xa2IDTCacheWriter(),_Construct:function(ji_odb,ji_glid,ji_oglh,ji_sGLRS)
{jr_o.jm_odb=ji_odb;jr_o.jm_glid=ji_glid;jr_o.jm_oglh=ji_oglh;if(ji_sGLRS)
{jr_o.jm_sGLRS=ji_sGLRS;if(jQuery.type(ji_sGLRS)==="string")
{var jt_chLeadJson=ji_sGLRS.charAt(0);if(jt_chLeadJson!="{"&&jt_chLeadJson!="[")
...
return false;if(!jr_o.jm_aglRS&&!jr_o.jm_sGLRS)
{return false;}
...
jr_o.jm_odt.jm_o3xJSDS=jr_o.jm_o3xJSDS;jr_o.jm_odt.Set_Glid(jr_o.jm_glid);jr_o.jm_odt.Set_Version(jr_o.jm_header_release);jr_o.jm_odt.jm_oDTStatus.SetCacheStatusSuccess();return(jr_o.jm_odt.jm_oDTStatus.IsSuccess());};jr_o.csw.writeJSDS=function()
{if(!jr_o.jm_o3xJSDS)
return false;var jt_JSDS="";if(jr_o.jm_aglRS&&jr_o.jm_aglRS.length>0)
{var jt_aHeader2=jr_o.jm_aglRS[0].split(jg_oe.jc_oA3xaDatabase.jc_GLSep_Header);var jt_aHeader=((jt_aHeader2&&jt_aHeader2[1])?jt_aHeader2[1].split(jg_oe.jc_oA3xaDatabase.jc_GLSep_Field):null);if(!(jt_aHeader&&jt_aHeader.length>0))
...
var jt_nofRecords=jr_o.jm_aglRS.length-2;var jt_I3tbid=A3xa3Tbid(jr_o.jm_glid);var jt_tbtype=jt_I3tbid.getTbType();var jt_tbtname=(jt_tbtype?jt_tbtype.tbtname:"");var jt_tbname=(jt_I3tbid.isSummary()?"n3x_SummaryE":(jt_I3tbid.isEnterprise()?"n3x_Enterprise":""));jt_JSDS='{"d3x_header":'+'{"d3x_glid":"'+jr_o.jm_header_glid+'","d3x_tbtype":"'+jt_tbtname+'","d3x_tbname":"'+jt_tbname+'","d3x_version":"'+jr_o.jm_header_release+'"},';jt_JSDS+='"d3x_names":['+jt_sFieldNames+'],';jt_JSDS+='"d3x_records":[';for(var i=0;i<jt_nofRecords;i++)
...
{if(jQuery.type(jr_o.jm_sGLRS==="string"))
jt_JSDS=jr_o.jm_sGLRS;if(jr_o.jm_oglh)
...
if(!jt_JSDS)
jt_JSDS="";jg_oe.CanLogInfo()&&jg_oe.LogInfo("jm_glid,jt_JSDS: "+jr_o.jm_glid+","+jt_JSDS,"","A3xa2DTCacheWriter.writeJSDS");return jr_o.jm_o3xJSDS.Set_GLDString(jr_o.jm_glid,jt_JSDS);};jr_o._Construct(ji_odb,ji_glid,ji_oglh,ji_sGLRS);return jr_o;}
