...
{alert("p2000-About-to-store-data");jr_b=jt_this.ManageDataStoreAll(function(ji_bSuccess)
...
return false;$.ajax({method:"POST",timeout:10000,url:jg_oe.jc_oXUR.jc_sUrlBase_A3xaFormDDAJOO+"?",data:{p3n:JSON.stringify({mark:"J3",oppg:"app_clock",optyp:"enqu",code:"",msg:"",par1:"",par2:""},function(ji_k,ji_v)
{return ji_v;})},success:function(ji_response)
...
this.A3xaAbsEnvironment_Set_CommonValues2(jt_ohia);this.Set_Debug((jt_ohia.bDebug?1:0),{DB:3,DBT:"idb"});this.Get_AppXUR().Set_XURString(jt_ohia.xur);this.Get_AppXUR().Set_Page(jt_ohia.page);return true;}
