...
this.A3xaAbsEnvironment_Set_CommonValues(jt_ohia.bDebug,jt_ohia.bCanEdit,jt_ohia.bCanLike,jt_ohia.dirIcons,jt_ohia.dirHome,jt_ohia.lang,jt_ohia.dateSitemap,jt_ohia.oGLData);this.Set_Debug((jt_ohia.bDebug?1:0),{DB:3,DBT:"idb"});this.Get_AppXUR().Set_XURString(jt_ohia.xur);this.Get_AppXUR().Set_Page(jt_ohia.page);return true;}
...
this.HostInitApplication2(qt_hia.attr("data-a3xa-hia"));this.CheckInitDone();return true;};this.jm_bCheckInitDone=false;this.CheckInitDone=function()
