...
{var jt_Ilg=jr_o._s._getILang();return jr_o._s.s.getById(jt_Ilg?jt_Ilg.getCurrentLang().id:1);};jr_o._s.s.copyFrom=function(ji_Is){return(ji_Is?jr_o._s.s.setA(ji_Is.getA()):false);};jr_o._s.s.setA(ji_as);return jr_o._s;}
﻿ function A3xaIArray()
{var jr_I={O:function(){return null;},getCount:function(){return 0;},checkIndex:function(ji_ix){return false;},getItem_ByIndex:function(ji_ix){return null;},foreachItem:function(ji_fnDo){return null;},findItem:function(ji_fnCheck){return null;},findItem2:function(ji_fnCheck){return null;},sortItems:function(ji_fnCompare){return false;},getKeys:function(){return null;},merge:function(ji_Iar){return false;},setItem:function(ji_key,ji_value){return false;},addItem:function(ji_key,ji_value){return false;},getItem:function(ji_key){return null;},getKey:function(ji_ix){return null;},clear:function(){return false;},getArray:function(ji_fnFilter){return null;}};return jr_I;}
function A3xaIArray2()
{var jr_I=A3xaIArray();jr_I.checkIndex=function(ji_ix){return ji_ix>=0&&ji_ix<jr_I.getCount();};jr_I.getItem_ByIndex=function(ji_ix){return jr_I.getItem(jr_I.getKey(ji_ix));};jr_I.findItem=function(ji_fnCheck)
...
{var jr_I={O:function(){return null;},set3x2Array:function(ji_IArray_Target){false;},getTargetIArray:function(){return null;},selectItems:function(ji_fnSelect,ji_MaxItems){return true;},getIndex:function(){return-1;},resetIndex:function(){return false;},getCurrentKey:function(){return null;},getCurrentItem:function(){return null;},next:function(){return false;},iseof:function(){return true;},seteof:function(){return false;}};return jr_I;}
function A3xaArray()
{var jr_o={jm_am:new Map(),jm_ax:[],ar:A3xaIArray2(),};jr_o.ar.Iar=function(){return jr_o.ar;};jr_o.ar.clear=function(){jr_o.jm_ax=[];jr_o.jm_am=new Map();return true;};jr_o.ar.getKeys=function(){return jr_o.jm_ax;};jr_o.ar.getCount=function(){return(jr_o.jm_ax&&jr_o.jm_am.size)?jr_o.jm_ax.length:0;};jr_o.ar.merge=function(ji_Iar)
{if(!ji_Iar)
...
jr_a.push(jt_item);}
return jr_a;};jr_o.ar.O=function(){return jr_o;};jr_o.Get_I3x3=function(){return jr_o.ar;};return jr_o.ar;}
function A3xaArrayIt(ji_IArray_Target)
{var jr_o={jm_IArray:null,jm_ix:-1,jm_If:null,ar:A3xaIArray2(),arit:A3xaIArrayIt()};jr_o.ar.Iar=function(){return jr_o.ar;};jr_o.ar.Iarit=function(){return jr_o.arit;};jr_o.arit.Iar=function(){return jr_o.ar;};jr_o.arit.Iarit=function(){return jr_o.arit;};jr_o.arit.getTargetIArray=function(){return jr_o.jm_IArray;};jr_o.ar.getKeys=function()
...
{return(jr_o.jm_ix<0||jr_o.jm_ix>=jr_o.ar.getCount());};jr_o.arit.seteof=function(){jr_o.jm_ix=-1;return true;};jr_o.arit.set3x2Array=function(ji_IArray_Target)
...
jr_o.jm_ix=0;return true;};jr_o.ar.O=function(){return jr_o;};jr_o.arit.O=function(){return jr_o;};jr_o.Get_I3x3=function(){return jr_o.arit;};jr_o.arit.set3x2Array(ji_IArray_Target);return jr_o.arit;}
...
{var jr_o={jm_Ilg:_A3xaLang(),jm_Igd:_A3xaGuid(),fw:A3xaIFramework()};jr_o.fw.Ifw=function(){return jr_o.fw;};jr_o.fw.getILang=function(){return jr_o.jm_Ilg;};jr_o.fw.newIString=function(ji_as)
...
﻿ function A3xaIDatabase()
{var jr_I={getIDataTable:function(ji_glid,ji_bDontCheck){return null;},};return jr_I;}
function _A3xaDatabase()
{var jr_o={_db:{db:A3xaIDatabase()}};jr_o._db.db.Idb=jr_o._db.Idb=function(){return jr_o._db.db;};jr_o._db.db.getIDataTable=function(ji_glid,ji_bDontCheck)
{var jt_odb=jr_o._getOCDatabase();if(!jt_odb)
return null;var jt_odt=jt_odb.Get_DataTable(ji_glid,ji_bDontCheck);if(!jt_odt)
return null;var jt_otb=_A3xaDataTable(jt_odt);return jt_otb.Itb();};jr_o._getOCDatabase=function(){return jg_oe.Get_Database();};return jr_o._db;}
﻿ function A3xaIDataTable()
{var jr_I={getIRecordset:function(){return null;},getIRecordsel:function(){return null;},getGLDString:function(){return null;},getISubTable:function(ji_tbtname){return null;}};return jr_I;}
function _A3xaDataTable(ji_odt)
{var jr_o={jm_odt:ji_odt,_tb:{tb:A3xaIDataTable()},};jr_o._tb.tb.Itb=jr_o._tb.Itb=function(){return jr_o._tb.tb;};jr_o._tb.tb.getIRecordset=function()
{if($.isEmptyObject(jr_o.jm_odt))
return null;return jr_o.jm_odt.Get_IRecordset();};jr_o._tb.tb.getIRecordsel=function()
{if($.isEmptyObject(jr_o.jm_odt))
return null;return jr_o.jm_odt.Get_IRecordsel();};jr_o._tb.tb.getGLDString=function()
{if($.isEmptyObject(jr_o.jm_odt))
return null;var jt_o3xJSDS=jr_o.jm_odt.Get_3xJSDS();if($.isEmptyObject(jt_o3xJSDS))
return null;return jt_o3xJSDS.Get_GLDString();};jr_o._tb.tb.getISubTable=function(ji_tbtname)
{if($.isEmptyObject(jr_o.jm_odt))
return null;if(!ji_tbtname)
return null;return _A3xaDataTable(jr_o.jm_odt.Get_SubTable(ji_tbtname)).Itb();}
return jr_o._tb;}
﻿ function A3xaIJDBit()
...
{var jr_I={getIDatabase:function(){return null;},newIJDBit:function(){return null;},getIDataTable:function(ji_glid,ji_bDontCheck){return null;},getIRecordset:function(ji_glid,ji_bDontCheck){return null;},getIRecordsel:function(ji_glid,ji_bDontCheck){return null;},};return jr_I;}
function _A3xaFWDatabase()
{var jr_o={jm_IDatabase:null,_fwdb:{_getIfw:function(){return null;},_newOJDBit:function(){return null;},fwdb:A3xaIFWDatabase()}};jr_o._fwdb.fwdb.Ifwdb=jr_o._fwdb.Ifwdb=function(){return jr_o._fwdb.fwdb;};jr_o._fwdb.fwdb.getIDatabase=function()
{if($.isEmptyObject(jr_o.jm_IDatabase))
{var jt_odb=_A3xaDatabase();jr_o.jm_IDatabase=jt_odb.Idb();}
return jr_o.jm_IDatabase;};jr_o._fwdb.fwdb.newIJDBit=function()
{var jr_oJDBit=jr_o._fwdb._newOJDBit();jr_oJDBit._getIDataTable=jr_o._fwdb.fwdb.getIDataTable;jr_oJDBit._getIRecordset=jr_o._fwdb.fwdb.getIRecordset;jr_oJDBit._init();return jr_oJDBit.Ijdbit();};jr_o._fwdb.fwdb.getIDataTable=function(ji_glid,ji_bDontCheck)
{return jr_o._fwdb.fwdb.getIDatabase().getIDataTable(ji_glid,ji_bDontCheck);};jr_o._fwdb.fwdb.getIRecordset=function(ji_glid,ji_bDontCheck)
{var jt_Itb=jr_o._fwdb.fwdb.getIDataTable(ji_glid,ji_bDontCheck);if(!jt_Itb)
return null;return jt_Itb.getIRecordset(ji_glid,ji_bDontCheck);};jr_o._fwdb.fwdb.getIRecordsel=function(ji_glid,ji_bDontCheck)
{var jt_Itb=jr_o._fwdb.fwdb.getIDataTable(ji_glid,ji_bDontCheck);if(!jt_Itb)
return null;return jt_Itb.getIRecordsel(ji_glid,ji_bDontCheck);};return jr_o._fwdb;}
...
{var jr_o={jm_xo3type:"typ-con",jm_IsiMain:null,jm_IsiMdown:null,jm_IsiFlash:null,jm_IsiXtra:null,jm_o3pbtnStatus:null,jm_aFlashCodes:[],jm_XtraCode:null,jm_tmMover:null,jm_tmMdown:null,jm_tmFlash:null,jm_bEblMdown:true,_si:{_newIsi:function(ji_xo3type,ji_bEmbed,ji_Ihic){return null;},_newIsiMdown:function(ji_Ihic,ji_bClickAction){return null;},_newIsiFlash:function(ji_code,ji_Ihic){return null;},_newIsiXtra:function(ji_code,ji_Ihic){return null;},_newSprite2:function(ji_absiconid,ji_SpriteId){return null;},si:A3xaISpriteImage(),sis:A3xaISpriteImagePile(),}};jr_o._si.sis.Isi=jr_o._si.si.Isi=jr_o._si.Isi=function(){return jr_o._si.si;};jr_o._si.sis.Isis=jr_o._si.si.Isis=jr_o._si.Isis=function(){return jr_o._si.sis;};jr_o._si.si.isValid=function()
{if(!(jr_o.jm_IsiMain&&jr_o.jm_IsiMain.isValid()))
return false;return true;};jr_o._si.si.getTitle=function(){return(jr_o.jm_IsiMain?jr_o.jm_IsiMain.getTitle():"");};jr_o._si.si.getAlt=function(){return(jr_o.jm_IsiMain?jr_o.jm_IsiMain.getAlt():"");};jr_o._si.si.getHtmId=function(ji_bPrefix)
{var jr_s=(jr_o.jm_IsiMain?jr_o.jm_IsiMain.getHtmId(ji_bPrefix):"");if(jr_s)
jr_s="con_"+jr_s;return jr_s;};jr_o._si.si.getXO3=function(ji_oappend)
{return $.extend(true,{},ji_oappend,{xo3class:"xo3-sprimg",type:(jr_o.jm_xo3type||""),o3pbtnStatus:jr_o.jm_o3pbtnStatus});};jr_o._si.si.attachQ=function()
{var qt_ohContainer=jr_o._si.si.getQ();if(!(qt_ohContainer&&qt_ohContainer.length))
return false;if(!jr_o._attachQEventHandlers(qt_ohContainer))
return false;jr_o._getStatusQ(qt_ohContainer);return true;};jr_o._si.si.updateQ=function(qi_oh,ji_o3pbtnStatus,ji_bFilterOnly)
{var qt_ohContainer=jr_o._si.si.getQ();if(!(qt_ohContainer&&qt_ohContainer.length))
return false;if(!ji_bFilterOnly)
A3xaXO3tag(jr_o._si.si.getXO3()).applyAttr(qt_ohContainer);jr_o.jm_IsiMain.updateQ(jr_o._getInnerQ(qt_ohContainer,jr_o.jm_IsiMain.getXO3type()),jr_o.jm_o3pbtnStatus,ji_bFilterOnly);return true;};jr_o._si.si.newQ=function()
{if(!jr_o._si.si.isValid())
return null;var jt_sHtmId=jr_o._si.si.getHtmId();var qr_ohContainer=$("<div>",{id:jt_sHtmId,width:16,height:16,border:"0"});A3xaXO3tag(jr_o._si.si.getXO3()).applyAttr(qr_ohContainer);qr_ohContainer.css({position:"relative",display:"inline-block"});var jt_Ihic=jr_o.jm_IsiMain.getIconInfo2();if(jt_Ihic)
...
return null;return qr_ohContainer;};jr_o._si.si.getQ=function()
{var jt_sHtmId=jr_o._si.si.getHtmId();var qr_ohContainer=$("#"+jt_sHtmId);if(!(qr_ohContainer&&qr_ohContainer.length))
...
return null;return qr_ohContainer;};jr_o._si.sis.setIsiMain=function(ji_Isi)
{if(!ji_Isi)
return false;jr_o.jm_IsiMain=ji_Isi;return true;};jr_o._si.sis.getIsiMain=function(){return jr_o.jm_IsiMain;};jr_o._si.sis.setIsiMdown=function(ji_Isi)
{jr_o.jm_IsiMdown=ji_Isi;return true;};jr_o._si.sis.setIsiFlash=function(ji_Isi)
{jr_o.jm_IsiFlash=ji_Isi;return true;};jr_o._si.sis.setIsiXtra=function(ji_Isi)
{jr_o.jm_IsiXtra=ji_Isi;return true;};jr_o._si.sis.enableMdown=function(ji_b){jr_o.jm_bEblMdown=!(ji_b===false);return true;};jr_o._si.sis.setStatus=function(ji_o3pbtnStatus,ji_code)
{var jt_oUpd=jr_o._setStatus(ji_o3pbtnStatus,ji_code);return jr_o._onSetStatus(jt_oUpd);};jr_o._si.sis.getStatus=function(){return(jr_o.jm_o3pbtnStatus||{});};jr_o._si.sis.isFlashing=function(){return(jr_o._si.sis.getStatus().flash||false);};jr_o._si.sis.isDisabled=function(){return(jr_o._si.sis.getStatus().dis||false);};jr_o._si.sis.isOn=function(){return(jr_o._si.sis.getStatus().on||false);};jr_o._si.sis.isOff=function(){return jr_o._si.sis.getStatus().on===false;};jr_o._si.sis.updateMdown=function(ji_bXStatus)
{if(ji_bXStatus)
{jr_o._si.sis.setIsiMdown(jr_o._si._newIsiMdown(jr_o.jm_IsiMain.getIconInfo2(),jr_o._si.sis.hasClickAction()));if(!jr_o.jm_IsiMdown);}
...
{jr_o._getStatusQ();jr_o._si.sis.setStatus({mdown:false});jr_o.jm_tmMdown=null;},500);else if(jr_o.jm_o3pbtnStatus.mdown==false)
jr_o.jm_tmMdown=null;if(!ji_bXStatus)
{jr_o._si.sis.setIsiMdown(null);}
return jr_b;};jr_o._si.sis.updateFlash=function(ji_bXStatus,ji_code)
{if(ji_bXStatus)
{jr_o._si.sis.setIsiFlash(jr_o._si._newIsiFlash(ji_code,jr_o.jm_IsiMain.getIconInfo2()));if(!jr_o.jm_IsiFlash);}
...
{jr_o._getStatusQ();jr_o._si.sis.setStatus({flash:false});jr_o.jm_tmFlash=null;},1000);else if(jr_o.jm_o3pbtnStatus.flash==false)
jr_o.jm_tmFlash=null;if(!ji_bXStatus)
{jr_o._si.sis.setIsiFlash(null);}
return jr_b;};jr_o._si.sis.updateXtra=function(ji_bXStatus,ji_code)
{if(ji_bXStatus)
{jr_o._si.sis.setIsiXtra(jr_o._si._newIsiXtra(ji_code,jr_o.jm_IsiMain.getIconInfo2()));if(!jr_o.jm_IsiXtra);}
var jr_b=jr_o._updateXstatus(ji_bXStatus,jr_o.jm_IsiXtra);if(!ji_bXStatus)
{jr_o._si.sis.setIsiXtra(null);}
...
{jr_o._getStatusQ();jr_o._si.sis.setStatus({mover:false});jr_o.jm_tmMover=null;},2000);else if(jr_o.jm_o3pbtnStatus.mover==false)
jr_o.jm_tmMover=null;jt_bUpdateStyle=true;}
if(ji_oUpdate.bUpdMdown)
{jr_o._si.sis.updateMdown(jr_o.jm_o3pbtnStatus.mdown);jt_bUpdateStyle=true;}
if(ji_oUpdate.bUpdFlash)
{var jt_code=(jr_o.jm_o3pbtnStatus.flash?jr_o.jm_aFlashCodes.shift():null);jr_o._si.sis.updateFlash(jr_o.jm_o3pbtnStatus.flash,jt_code);}
if(ji_oUpdate.bUpdXtra)
{var jt_code=(jr_o.jm_o3pbtnStatus.xtra?jr_o.jm_XtraCode:null);jr_o.jm_XtraCode=null;jr_o._si.sis.updateXtra(jr_o.jm_o3pbtnStatus.xtra,jt_code);}
if(jt_bReplaceAttr)
jr_o._si.si.updateQ();else if(jt_bUpdateStyle)
jr_o._si.si.updateQ(null,null,true);jg_oe.CanLogInfo()&&jg_oe.LogInfo("HtmId="+jr_o._si.si.getHtmId()+","+
...
{var qt_ohContainer=jr_o._si.si.getQ();if(!qt_ohContainer)
...
{if(!qi_oh)
{qi_oh=jr_o._si.si.getQ();if(!(qi_oh&&qi_oh.length))
return false;}
...
{jr_o._si.sis.setStatus({mover:true});});qi_oh.on("mouseleave",function()
{jr_o._si.sis.setStatus({mover:false});});if(jr_o.jm_bEblMdown)
{qi_oh.on("mousedown",function()
{jr_o._si.sis.setStatus({mdown:true});});qi_oh.on("mouseup",function()
{jr_o._si.sis.setStatus({mdown:false});});}
...
{var jr_o={jm_oActionInfo:null,jm_Isis:null,_b:{_newIsis:function(ji_Ihic){return null;},b:A3xaIButton()},};jr_o._b.b.Ib=jr_o._b.Ib=function(){return jr_o._b.b;};jr_o._b._init=function()
{jr_o.jm_Isis=jr_o._b._newIsis(ji_Ihic,ji_oFlashIcons);jr_o.jm_Isis.hasClickAction=jr_o._b.b.hasClickAction;return true;};jr_o._b._getIsis=function(){return jr_o.jm_Isis;};jr_o._b.b.setIconInfo2=function(ji_Ihic)
{return jr_o.jm_Isis.getIsiMain().setIconInfo2(ji_Ihic);};jr_o._b.b.getIconInfo2=function(){return jr_o.jm_Isis.getIsiMain().getIconInfo2();};jr_o._b.b.attachQ=function(){return jr_o.jm_Isis.Isi().attachQ();};jr_o._b.b.getQ=function(){return jr_o.jm_Isis.Isi().getQ();};jr_o._b.b.enableMdown=function(ji_b){return jr_o.jm_Isis.enableMdown(ji_b);};jr_o._b.b.isValid=function(){return jr_o.jm_Isis&&jr_o.jm_Isis.Isi().isValid();};jr_o._b.b.setStatus=function(ji_o3pbtnStatus,ji_code)
{if(!jr_o.jm_Isis)
...
ji_code,"Set_Status","A3xaSimpleButton3");return jr_o.jm_Isis.setStatus(ji_o3pbtnStatus,ji_code);};jr_o._b.b.getStatus=function()
{if(!jr_o.jm_Isis)
return null;return jr_o.jm_Isis.getStatus();};jr_o._b.b.setActionInfo=function(ji_oActionInfo){jr_o.jm_oActionInfo=ji_oActionInfo;return true;};jr_o._b._getActionInfo=function(){return jr_o.jm_oActionInfo;};jr_o._b.b.hasClickAction=function()
{if(jr_o.jm_Isis.getStatus().dis)
return false;if(!jr_o.jm_oActionInfo)
return false;return true;};jr_o._b.b.printHtml=function(qi_oParent,ji_bPrepend)
{if(!(qi_oParent&&qi_oParent.length))
return false;if(!jr_o._b.b.isValid())
return false;var jt_sHtmId=jr_o._b.b.getIconInfo2().Ihi().getHid();var qt_ohImg=jr_o.jm_Isis.Isi().newQ();if(!qt_ohImg)
return false;var qt_ohLink=jr_o._newAnchorQ();if(qt_ohLink&&qt_ohLink.length)
qt_ohLink.append(qt_ohImg);else
qt_ohLink=qt_ohImg;if(jr_o._b.b.getIconInfo2().Ihi().hasParagraph())
...
return null;var jt_sHtmId=jr_o._b.b.getIconInfo2().Ihi().getHid();if(jr_o.jm_oActionInfo.mediatype=="youtube")
...
{if(!jr_o.jm_oActionInfo)
return false;var jt_sHtmId=jr_o._b.b.getIconInfo2().Ihi().getHid();if(jr_o.jm_oActionInfo.mediatype=="youtube")
...
return false;qt_ohSinf.text(ji_sMessage||"");return true;};jr_o._p.p.isPlaying=function()
{if($.isEmptyObject(jr_o.jm_IbPlay)||$.isEmptyObject(jr_o.jm_IbStop)||$.isEmptyObject(jr_o.jm_IbPause))
return false;var jt_bsplay=jr_o.jm_IbPlay.getStatus();var jt_bsstop=jr_o.jm_IbStop.getStatus();var jt_bspause=jr_o.jm_IbPause.getStatus();return(!jt_bsplay.dis&&jt_bsplay.on&&!jt_bsstop.on&&!jt_bspause.on);};jr_o._p.p.isPaused=function()
{if($.isEmptyObject(jr_o.jm_IbPlay)||$.isEmptyObject(jr_o.jm_IbStop)||$.isEmptyObject(jr_o.jm_IbPause))
return false;var jt_bsplay=jr_o.jm_IbPlay.getStatus();var jt_bsstop=jr_o.jm_IbStop.getStatus();var jt_bspause=jr_o.jm_IbPause.getStatus();return(!jt_bsplay.dis&&jt_bsplay.on&&!jt_bsstop.on&&!jt_bspause.dis&&jt_bspause.on);};jr_o._p.p.play=function()
{if(!jr_o.jm_Ipe)
...
return false;};jr_o._p.p.stop=function()
{if(!jr_o.jm_Ipe)
...
return false;};jr_o._p.p.pause=function()
{if(!jr_o.jm_Ipe)
...
return false;};jr_o._p.p.resume=function()
{if(!jr_o.jm_Ipe)
return false;var jt_obsPlay=jr_o.jm_IbPlay.getStatus();var jt_obsStop=jr_o.jm_IbStop.getStatus();var jt_obsPause=jr_o.jm_IbPause.getStatus();if(jt_obsPause.dis)
{return false;}
else if(jt_obsPause.on)
...
{return false;}
return false;};jr_o._p.p.printHtml=function(qi_ohParent)
...
{return jr_o._p.p.resume();}
else if(jt_obsPause.on===false)
{return jr_o._p.p.pause();}
...
{var jr_o={_fwwg:{_getIfw:function(){return null;},fwwg:A3xaIFWWidget()}};jr_o._fwwg.fwwg.Ifwwg=jr_o._fwwg.Ifwwg=function(){return jr_o._fwwg.fwwg;};jr_o._fwwg.fwwg.getDefIcons=function()
{return(jg_oe.Get_3xAppMngIcons()?jg_oe.Get_3xAppMngIcons().Get_DefIcons():null);};jr_o._fwwg.fwwg.newSprite2=function(ji_absiconid,ji_SpriteId)
{return jg_oe.Get_3xAppMngIcons()?jg_oe.Get_3xAppMngIcons().NewSprite2(ji_absiconid,ji_SpriteId):null;};jr_o._fwwg.fwwg.newIHItem=function()
{var jt_hi_=_A3xaHtmItem();jt_hi_._getGuid=jr_o._fwwg._getIfw().getGuid;return jt_hi_.Ihi();};jr_o._fwwg.fwwg.newIHIcon=function()
{var jt_hi_=_A3xaHtmIcon();jt_hi_._getGuid=jr_o._fwwg._getIfw().getGuid;return jt_hi_.Ihic();};jr_o._fwwg.fwwg.newIsi=function(ji_xo3type,ji_bEmbed,ji_Ihic)
{var jr_Isi=_A3xaSpriteImage(ji_xo3type,ji_bEmbed);jr_Isi.setIconInfo2(ji_Ihic);return jr_Isi;};jr_o._fwwg.fwwg.newIsis=function(ji_Ihic,ji_oFlashIcons)
{var jt_odfic=jr_o._fwwg.fwwg.getDefIcons();if(!ji_oFlashIcons)
...
var jt_si=_A3xaSpriteImagePile();jt_si._newIsi=jr_o._fwwg.fwwg.newIsi;jt_si._newSprite2=jr_o._fwwg.fwwg.newSprite2;jt_si._getDefIcons=jr_o._fwwg.fwwg.getDefIcons;_A3xaSISFlashStars(jt_si,ji_oFlashIcons);jt_si.Isis().setIsiMain(jr_o._fwwg.fwwg.newIsi("typ-mnm",true,ji_Ihic));return jt_si.Isis();};jr_o._fwwg.fwwg.newICdnmg=function(ji_cdnname)
{if(!ji_cdnname)
...
return null;};jr_o._fwwg.fwwg.newISimpleButton=function(ji_Ihic,ji_typehandler)
...
jt_b_._newIsis=jr_o._fwwg.fwwg.newIsis;jt_b_._newICdnmg=jr_o._fwwg.fwwg.newICdnmg;jt_b_._init();return jt_b_.Ib();};jr_o._fwwg.fwwg.newIPlayer=function()
{var jt_odfic=jr_o._fwwg.fwwg.getDefIcons();var jt_op=_A3xaPlayer({oMain:jt_odfic.jc_oIconMS_BatchJDB,oPlay:jt_odfic.jc_oIconMS_PlayBarRun,oPause:jt_odfic.jc_oIconMS_PlayBarPause,oStop:jt_odfic.jc_oIconMS_PlayBarStop,});jt_op._newSprite2=jr_o._fwwg.fwwg.newSprite2;jt_op._newIHItem=jr_o._fwwg.fwwg.newIHItem;jt_op._getDefIcons=jr_o._fwwg.fwwg.getDefIcons;jt_op._newISimpleButton=jr_o._fwwg.fwwg.newISimpleButton;jt_op._init();return jt_op.Ip();};return jr_o._fwwg;}
...
{var jr_o={jm_IAdminBatchJDB:null,_fwss:{_getIfw:function(){return null;},_getIfwdb:function(){return null;},_getIfwwg:function(){return null;},_newOabjdb:function(){return null;},fwss:A3xaIFWSubsys()}};jr_o._fwss.fwss.Ifwss=jr_o._fwss.Ifwss=function(){return jr_o._fwss.fwss;};jr_o._fwss.fwss.getIAdminBatchJDB=function()
{if($.isEmptyObject(jr_o.jm_IAdminBatchJDB))
{var jt_abjdb=jr_o._fwss._newOabjdb();jt_abjdb._newIPlayer=jr_o._fwss._getIfwwg().newIPlayer;jt_abjdb._getIDataTable=jr_o._fwss._getIfwdb().getIDataTable;jt_abjdb._newIJDBit=jr_o._fwss._getIfwdb().newIJDBit;jr_o.jm_IAdminBatchJDB=jt_abjdb.Iabjdb();}
return jr_o.jm_IAdminBatchJDB;};return jr_o._fwss;}
﻿ function _A3xaJDBCit()
{var jr_o={jm_oScanEntity:null,jm_bReleased:false,jm_oTypScan:null,jm_boptDescr:false,jm_boptXur:false,_jdbit:{_getIDataTable:function(ji_glid,ji_bDontCheck){return null;},_getIRecordset:function(ji_glid,ji_bDontCheck){return null;},jdbit:A3xaIJDBit()}};jr_o._jdbit.jdbit.Ijdbit=jr_o._jdbit.Ijdbit=function(){return jr_o._jdbit.jdbit;};jr_o._jdbit._init=function()
{return true;};jr_o._jdbit.jdbit.setOptions=function(ji_opt)
{if(!ji_opt)
return false;jr_o.jm_boptDescr=(ji_opt.bDescr||false);jr_o.jm_boptXur=(ji_opt.bXur||false);return true;};jr_o._jdbit.jdbit.forall=function(ji_fnDoItem,ji_fnFinished,ji_oTypScan)
{if(!(ji_fnDoItem&&ji_fnFinished))
return false;if($.isEmptyObject(ji_oTypScan))
return false;if(jr_o._jdbit.jdbit.iseof())
{jr_o.jm_oTypScan=$.extend({},ji_oTypScan);jr_o._jdbit.jdbit.reset();}
else if(!jr_o._checkRecover(ji_oTypScan))
return ji_fnFinished(false);jr_o._doCurrentItem(ji_fnDoItem,ji_fnFinished);return true;};jr_o._jdbit.jdbit.release=function(){return jr_o.jm_bReleased=true;};jr_o._jdbit.jdbit.reset=function(){jr_o.jm_oScanEntity=null;return jr_o._nextScanEntity();};jr_o._nextScanEntity=function()
...
{if($.isEmptyObject(jr_o.jm_oScanEntity))
jr_o.jm_oScanEntity=jr_o._A3xaScanEnterpriseTopGoldNoCat();else if(jr_o.jm_oScanEntity._typEntity()==jg_oe.jc_oEntity.jc_Typ_Enterprise&&jr_o.jm_oScanEntity._typQuery()==jr_o._A3xaScanEntity._GoldNC())
jr_o.jm_oScanEntity=jr_o._A3xaScanEnterpriseTopGoldWithCat();else if(jr_o.jm_oScanEntity._typEntity()==jg_oe.jc_oEntity.jc_Typ_Enterprise&&jr_o.jm_oScanEntity._typQuery()==jr_o._A3xaScanEntity._GoldC())
{jr_o.jm_oScanEntity=null;jr_o.jm_oTypScan.bMainE=null;return jr_o._nextScanEntity();}
else
{jr_o.jm_oScanEntity=null;jr_o.jm_oTypScan=null;return false;}}
else if(jr_o.jm_oTypScan.bMiddleE)
{if($.isEmptyObject(jr_o.jm_oScanEntity))
jr_o.jm_oScanEntity=jr_o._A3xaScanEnterpriseTopSilverNoCat();else if(jr_o.jm_oScanEntity._typEntity()==jg_oe.jc_oEntity.jc_Typ_Enterprise&&jr_o.jm_oScanEntity._typQuery()==jr_o._A3xaScanEntity._SilverNC())
jr_o.jm_oScanEntity=jr_o._A3xaScanEnterpriseTopSilverWithCat();else if(jr_o.jm_oScanEntity._typEntity()==jg_oe.jc_oEntity.jc_Typ_Enterprise&&jr_o.jm_oScanEntity._typQuery()==jr_o._A3xaScanEntity._SilverC())
{jr_o.jm_oScanEntity=null;jr_o.jm_oTypScan.bMiddleE=null;return jr_o._nextScanEntity();}
else
{jr_o.jm_oScanEntity=null;jr_o.jm_oTypScan=null;return false;}}
else if(jr_o.jm_oTypScan.bLowE)
{if($.isEmptyObject(jr_o.jm_oScanEntity))
jr_o.jm_oScanEntity=jr_o._A3xaScanEnterpriseTopBronzeNoCat();else if(jr_o.jm_oScanEntity._typEntity()==jg_oe.jc_oEntity.jc_Typ_Enterprise&&jr_o.jm_oScanEntity._typQuery()==jr_o._A3xaScanEntity._BronzeNC())
jr_o.jm_oScanEntity=jr_o._A3xaScanEnterprise();else if(jr_o.jm_oScanEntity._typEntity()==jg_oe.jc_oEntity.jc_Typ_Enterprise&&jr_o.jm_oScanEntity._typQuery()==jr_o._A3xaScanEntity._ListC())
{jr_o.jm_oScanEntity=null;jr_o.jm_oTypScan.bLowE=null;return jr_o._nextScanEntity();}
else
{jr_o.jm_oScanEntity=null;jr_o.jm_oTypScan=null;return false;}}
return true;};jr_o._jdbit.jdbit.iseof=function(){return $.isEmptyObject(jr_o.jm_oScanEntity)?true:false;};jr_o._jdbit.jdbit.getCurrentItem=function()
{return($.isEmptyObject(jr_o.jm_oScanEntity)?{}:jr_o.jm_oScanEntity._getCurrentItem());};jr_o._jdbit.jdbit.next=function()
{if($.isEmptyObject(jr_o.jm_oScanEntity))
...
{return ji_fnDoItem(jr_o._jdbit.jdbit.getCurrentItem(),function(ji_bSuccess,ji_bStop)
{var jt_otmTaskBreaker=setTimeout(function()
{if(jr_o.jm_bReleased);else if(ji_bSuccess&&jr_o._jdbit.jdbit.next()&&!ji_bStop)
...
return null;return{xurcc:jt_oxur.Get_XURCC(),aznmuv:jt_oxur.Get_3xXEID().Get_AZNMUV()};},_getCode:function()
...
jt_oxurcc={};var jr_oitem={typEntity:jr_ox._typEntity(),typQuery:jr_ox._typQuery(),xurcc:jt_oxurcc.xurcc,aznmuv:jt_oxurcc.aznmuv,code:(jr_o.jm_boptDescr?jr_ox._getCode():""),descr:(jr_o.jm_boptDescr?jr_ox._getDescr():""),oxeTopArea:jr_ox._getCurrentTopArea(),oxeArea:jr_ox._getCurrentArea(),oxeRegion:jr_ox._getCurrentRegion(),oxeCategory:jr_ox._getCurrentCategory(),oxeCountry:jr_ox._getCurrentCountry()};return jr_oitem;},_checkCurrent:function()
...
{if(!$.isEmptyObject(jr_ox.jm_IaritArea))
jr_ox.jm_IaritArea.resetIndex();return jr_ox._resetRegion();},_resetRegion:function()
{if(!$.isEmptyObject(jr_ox.jm_IaritRegion))
...
{var jr_b=(!$.isEmptyObject(jr_ox.jm_IaritArea)&&jr_ox.jm_IaritArea.next());jr_ox._resetRegion();return jr_b;},_nextRegion:function()
{var jr_b=(!$.isEmptyObject(jr_ox.jm_IaritRegion)&&jr_ox.jm_IaritRegion.next());jr_ox._resetCategory();return jr_b;},_nextCategory:function()
...
{jr_ox.jm_IaritTopArea=A3xaArrayIt(jr_o._jdbit._getIRecordset(GLIDR(A3xaDefineTbid().jc_GGLID_GeoTopArea)));jr_ox.jm_IaritArea=A3xaArrayIt(jr_o._jdbit._getIRecordset(GLIDR(A3xaDefineTbid().jc_GGLID_GeoArea)));jr_ox.jm_IaritRegion=A3xaArrayIt(jr_o._jdbit._getIRecordset(GLIDR(A3xaDefineTbid().jc_GGLID_GeoRegion)));jr_ox.jm_IaritCategory=A3xaArrayIt(jr_o._jdbit._getIRecordset(GLIDR(A3xaDefineTbid().jc_GGLID_Category)));jr_ox.jm_IaritCountry=A3xaArrayIt(jr_o._jdbit._getIRecordset(GLIDR(A3xaDefineTbid().jc_GGLID_GeoCountry)));jr_ox._onInitSelect();var jr_bArea=jr_ox._resetTopArea();var jr_bCountry=jr_ox._resetCountry();if(!(jr_bArea&&jr_bCountry))
...
{return(!$.isEmptyObject(ji_oTypScan)&&ji_oTypScan.bLowE);};return jr_o._jdbit;}
﻿ function _A3xaAdminBatchJDBE()
{var jr_o={jm_Ip:null,jm_oCheckbar:null,jm_Ijdbit:null,jm_bAutoStop:false,jm_oItem:{},jm_oZipJDBE:null,_abjdb:{_newIPlayer:function(){return null;},_getIDataTable:function(ji_glid,ji_bDontCheck){return null;},_newIJDBit:function(){return null;},pe:A3xaIPlayerEvents(),abjdb:A3xaIAdminBatchJDB()}};jr_o._abjdb.abjdb.Iabjdb=jr_o._abjdb.Iabjdb=function(){return jr_o._abjdb.abjdb;};jr_o._abjdb.abjdb.printHtml=function(qi_ohParent)
...
jr_o.jm_Ip.setEventsHandler(jr_o._abjdb.pe);var jt_ohFrame=$("<div>");jt_ohFrame.appendTo(qi_ohParent);if(!jr_o.jm_oCheckbar._printHtml(jt_ohFrame));if(!jr_o.jm_Ip.printHtml(jt_ohFrame))
return false;jr_o._setStatusInfo();return true;};jr_o._abjdb.abjdb.runBatch=function()
{if($.isEmptyObject(jr_o.jm_Ijdbit))
return false;if($.isEmptyObject(jr_o.jm_oCheckbar))
return false;var jt_oTypScan=jr_o.jm_oCheckbar._getTypScan();if($.isEmptyObject(jr_o.jm_oZipJDBE))
{jr_o.jm_oZipJDBE=jr_o._A3xaZipJDBE(jt_oTypScan);}
jr_o.jm_Ijdbit.forall(function(ji_oItem,ji_fnDoneItem)
{jr_o.jm_oItem=ji_oItem;var jt_bPlaying=false;var jt_bStopped=false;var jt_bPaused=false;if(!$.isEmptyObject(jr_o.jm_Ip))
{jr_o._setStatusInfo("query");if(jr_o.jm_Ip.isPaused())
jt_bPaused=true;else if(jr_o.jm_Ip.isPlaying())
jt_bPlaying=true;else
jt_bStopped=true;}
var jt_fnLoadDeferred=function(ji_bSuccess)
{if(jg_oApp.Get_DataManager().IsAvailableDataTableEI())
{return jt_fnFinished(ji_bSuccess);}
jg_oApp.Get_DataManager().RequestDataTableEI(function(ji_oDTStatus)
{if(ji_oDTStatus.IsOpLoad()&&ji_oDTStatus.IsDone())
{return jt_fnFinished(ji_bSuccess);}});return true;};var jt_fnFinished=function(ji_bSuccess)
{jr_o._setStatusInfo();if(!$.isEmptyObject(jr_o.jm_oZipJDBE)&&jr_o.jm_oZipJDBE._valid())
{jr_o.jm_oZipJDBE._saveCurrentPage(ji_oItem);}
if(jt_bPaused)
...
return true;};if(!ji_oItem.xurcc)
{jt_fnFinished(true);return true;}
jg_oApp.Get_MgrPage().OnChange_XUR(ji_oItem.xurcc,jt_fnLoadDeferred);return true;},function(ji_bSuccess,ji_bStop)
{if(!ji_bSuccess)
{if(!$.isEmptyObject(jr_o.jm_Ip))
{if(jr_o.jm_Ip.isPlaying())
{jr_o.jm_bAutoStop=true;jr_o.jm_Ip.stop();jr_o.jm_bAutoStop=false;}}
jr_o._setStatusInfo("failed");alert("failed");}
else if(ji_bStop)
...
{jr_o._setStatusInfo("stopped");alert("stopped");}
else if(jt_bPlaying)
{alert("still playing");}
else
...
{if(jr_o.jm_Ip.isPlaying())
{jr_o.jm_bAutoStop=true;jr_o.jm_Ip.stop();jr_o.jm_bAutoStop=false;}}
if(!$.isEmptyObject(jr_o.jm_oZipJDBE)&&jr_o.jm_oZipJDBE._valid())
{jr_o.jm_oZipJDBE._saveAs();}
jr_o._setStatusInfo("finished");}
return true;},jt_oTypScan);return true;};jr_o._abjdb.pe.onPlay=function()
{try
{if(!$.isEmptyObject(jr_o.jm_Ijdbit))
jr_o.jm_Ijdbit.release();jr_o.jm_Ijdbit=jr_o._abjdb._newIJDBit();jr_o.jm_Ijdbit.setOptions({bXur:true,bDescr:true});jr_o.jm_oZipJDBE=null;jr_o._abjdb.abjdb.runBatch();}
catch(e)
{jt_sMsg=e.message;alert(jt_sMsg);}
return true;};jr_o._abjdb.pe.onStop=function()
{return true;};jr_o._abjdb.pe.onPause=function()
{return true;};jr_o._abjdb.pe.onResume=function()
{if(!$.isEmptyObject(jr_o.jm_Ijdbit))
jr_o._abjdb.abjdb.runBatch();return true;};jr_o._setStatusInfo=function(ji_sHead)
{if($.isEmptyObject(jr_o.jm_Ip))
return false;var jt_info=(!$.isEmptyObject(jr_o.jm_oItem)?jr_o.jm_oItem.code+"-"+jr_o.jm_oItem.descr:"***");if(!ji_sHead)
{if(jr_o.jm_Ip.isPlaying())
...
{var jr_ox={jm_sHtmId:ji_sHtmId,jm_oTypScan:{},jm_av:[{value:"MG",title:"Main Geo",fns:function(b){jr_ox.jm_oTypScan.bMainGeo=b;},fng:function(){return jr_ox.jm_oTypScan.bMainGeo;}},{value:"mG",title:"Mid Geo",fns:function(b){jr_ox.jm_oTypScan.bMiddleGeo=b;},fng:function(){return jr_ox.jm_oTypScan.bMiddleGeo;}},{value:"LG",title:"Low Geo",fns:function(b){jr_ox.jm_oTypScan.bLowGeo=b;},fng:function(){return jr_ox.jm_oTypScan.bLowGeo;}},{value:"ME",title:"Main E",fns:function(b){jr_ox.jm_oTypScan.bMainE=b;},fng:function(){return jr_ox.jm_oTypScan.bMainE;}},{value:"mE",title:"Mid E",fns:function(b){jr_ox.jm_oTypScan.bMiddleE=b;},fng:function(){return jr_ox.jm_oTypScan.bMiddleE;}},{value:"LE",title:"Low E",fns:function(b){jr_ox.jm_oTypScan.bLowE=b;},fng:function(){return jr_ox.jm_oTypScan.bLowE;}}],_init:function()
...
return true;},_getTypScan:function(){return jr_ox.jm_oTypScan;},_thatsallfolks:function(){return true;}};jr_ox._init();return jr_ox;};jr_o._A3xaZipJDBE=function(ji_oTypScan)
{var jr_ox={jm_oJSZip:null,jm_oTypScan:ji_oTypScan,jm_oFolderHtmPages:{},jm_oFolderJDBPages:{},_init:function()
{jr_ox.jm_oJSZip=new JSZip();if($.isEmptyObject(jr_ox.jm_oJSZip))
return false;jr_ox.jm_oFolderHtmPages.foMain=jr_ox.jm_oJSZip.folder("htmpages");jr_ox.jm_oFolderJDBPages.foMain=jr_ox.jm_oJSZip.folder("jdbpages");if($.isEmptyObject(jr_ox.jm_oFolderHtmPages.foMain))
return false;if($.isEmptyObject(jr_ox.jm_oFolderJDBPages.foMain))
return false;var jt_afoMain=[jr_ox.jm_oFolderHtmPages,jr_ox.jm_oFolderJDBPages];for(var i=0;i<jt_afoMain.length;i++)
{var jt_oFolderCur=jt_afoMain[i];var jt_foCur=jt_oFolderCur.foMain;if(jr_ox.jm_oTypScan.bMainGeo)
{jt_oFolderCur.foGeoAZP=jt_foCur.folder("geoazp");}
if(jr_ox.jm_oTypScan.bMiddleGeo)
{jt_oFolderCur.foGeoN=jt_foCur.folder("geon");jt_oFolderCur.foGeoS=jt_foCur.folder("geos");}
if(jr_ox.jm_oTypScan.bLowGeo)
{jt_oFolderCur.foGeoC=jt_foCur.folder("geoc");jt_oFolderCur.foGeoC_ei=jt_foCur.folder("geoc_ei");}
if(jr_ox.jm_oTypScan.bMainE)
{jt_oFolderCur.foEGold=jt_foCur.folder("egold");jt_oFolderCur.foEGold_ei=jt_foCur.folder("egold_ei");}
if(jr_ox.jm_oTypScan.bMiddleE)
{jt_oFolderCur.foESilver=jt_foCur.folder("esilver");jt_oFolderCur.foESilvercat=jt_foCur.folder("esilvercat");}
if(jr_ox.jm_oTypScan.bLowE)
{jt_oFolderCur.foEBronze=jt_foCur.folder("ebronze");jt_oFolderCur.foEList=jt_foCur.folder("elist");}}
return true;},_valid:function()
{if($.isEmptyObject(jr_ox.jm_oJSZip))
return false;if($.isEmptyObject(jr_ox.jm_oFolderHtmPages.foMain))
return false;if($.isEmptyObject(jr_ox.jm_oFolderJDBPages.foMain))
return false;return true;},_saveCurrentPage:function(ji_oPageInfo)
{if($.isEmptyObject(ji_oPageInfo))
return false;if(!ji_oPageInfo.xurcc)
return false;if(!jr_ox._saveCurrentPageHtm(ji_oPageInfo))
return false;if(!jr_ox._saveCurrentPageJsonTable(ji_oPageInfo))
return false;return true;},_saveCurrentPageHtm:function(ji_oPageInfo)
{var jt_sHtmPage="\uFEFF<!DOCTYPE html>"+$("html")[0].outerHTML;var jt_foDest=null;if(ji_oPageInfo.typEntity==jg_oe.jc_oEntity.jc_Typ_GeoArea)
{jt_foDest=jr_ox.jm_oFolderHtmPages.foGeoAZP;if($.isEmptyObject(jt_foDest))
return!jr_ox.jm_oTypScan.bMainGeo;}
...
{jt_foDest=jr_ox.jm_oFolderHtmPages.foGeoN;if($.isEmptyObject(jt_foDest))
return!jr_ox.jm_oTypScan.bMiddleGeo;}
else if(ji_oPageInfo.typEntity==jg_oe.jc_oEntity.jc_Typ_GeoState)
{jt_foDest=jr_ox.jm_oFolderHtmPages.foGeoS;if($.isEmptyObject(jt_foDest))
return!jr_ox.jm_oTypScan.bMiddleGeo;}
else if(ji_oPageInfo.typEntity==jg_oe.jc_oEntity.jc_Typ_GeoCity)
{jt_foDest=jr_ox.jm_oFolderHtmPages.foGeoC;if($.isEmptyObject(jt_foDest))
return!jr_ox.jm_oTypScan.bLowGeo;}
else if(ji_oPageInfo.typEntity==jg_oe.jc_oEntity.jc_Typ_Enterprise)
{if(ji_oPageInfo.typQuery=="GN")
{jt_foDest=jr_ox.jm_oFolderHtmPages.foEGold;if($.isEmptyObject(jt_foDest))
return!jr_ox.jm_oTypScan.bMainE;}
else if(ji_oPageInfo.typQuery=="GC")
{jt_foDest=jr_ox.jm_oFolderHtmPages.foEGold;if($.isEmptyObject(jt_foDest))
return!jr_ox.jm_oTypScan.bMainE;}
else if(ji_oPageInfo.typQuery=="SN")
{jt_foDest=jr_ox.jm_oFolderHtmPages.foESilver;if($.isEmptyObject(jt_foDest))
return!jr_ox.jm_oTypScan.bMiddleE;}
else if(ji_oPageInfo.typQuery=="SC")
{jt_foDest=jr_ox.jm_oFolderHtmPages.foESilvercat;if($.isEmptyObject(jt_foDest))
return!jr_ox.jm_oTypScan.bMiddleE;}
else if(ji_oPageInfo.typQuery=="BN")
{jt_foDest=jr_ox.jm_oFolderHtmPages.foEBronze;if($.isEmptyObject(jt_foDest))
return!jr_ox.jm_oTypScan.bLowE;}
else if(ji_oPageInfo.typQuery=="BC")
{jt_foDest=jr_ox.jm_oFolderHtmPages.foEList;if($.isEmptyObject(jt_foDest))
return!jr_ox.jm_oTypScan.bLowE;}
else
return false;}
else
...
{var jt_foDest=null;var jt_foDest_ei=null;var jt_sQueryPaddingName="";if(ji_oPageInfo.typEntity==jg_oe.jc_oEntity.jc_Typ_GeoArea)
{jt_foDest=jr_ox.jm_oFolderJDBPages.foGeoAZP;if($.isEmptyObject(jt_foDest))
return!jr_ox.jm_oTypScan.bMainGeo;jt_foDest=null;}
else if(ji_oPageInfo.typEntity==jg_oe.jc_oEntity.jc_Typ_GeoCountry)
{jt_foDest=jr_ox.jm_oFolderJDBPages.foGeoAZP;if($.isEmptyObject(jt_foDest))
return!jr_ox.jm_oTypScan.bMainGeo;jt_foDest=null;}
else if(ji_oPageInfo.typEntity==jg_oe.jc_oEntity.jc_Typ_GeoRegion)
{jt_foDest=jr_ox.jm_oFolderJDBPages.foGeoN;if($.isEmptyObject(jt_foDest))
return!jr_ox.jm_oTypScan.bMiddleGeo;jt_foDest=null;}
else if(ji_oPageInfo.typEntity==jg_oe.jc_oEntity.jc_Typ_GeoState)
{jt_foDest=jr_ox.jm_oFolderJDBPages.foGeoS;if($.isEmptyObject(jt_foDest))
return!jr_ox.jm_oTypScan.bMiddleGeo;jt_foDest=null;}
else if(ji_oPageInfo.typEntity==jg_oe.jc_oEntity.jc_Typ_GeoCity)
{jt_foDest=jr_ox.jm_oFolderJDBPages.foGeoC;jt_foDest_ei=jr_ox.jm_oFolderJDBPages.foGeoC_ei;if($.isEmptyObject(jt_foDest)||$.isEmptyObject(jt_foDest_ei))
return!jr_ox.jm_oTypScan.bLowGeo;jt_foDest=null;jt_foDest_ei=null;}
else if(ji_oPageInfo.typEntity==jg_oe.jc_oEntity.jc_Typ_Enterprise)
{if(ji_oPageInfo.typQuery=="GN")
{jt_foDest=jr_ox.jm_oFolderJDBPages.foEGold;jt_foDest_ei=jr_ox.jm_oFolderJDBPages.foEGold_ei;if($.isEmptyObject(jt_foDest)||$.isEmptyObject(jt_foDest_ei))
return!jr_ox.jm_oTypScan.bMainE;jt_sQueryPaddingName="Gold";}
else if(ji_oPageInfo.typQuery=="GC")
{jt_foDest=jr_ox.jm_oFolderJDBPages.foEGold;jt_foDest_ei=jr_ox.jm_oFolderJDBPages.foEGold_ei;if($.isEmptyObject(jt_foDest)||$.isEmptyObject(jt_foDest_ei))
return!jr_ox.jm_oTypScan.bMainE;jt_sQueryPaddingName="Gold";}
else if(ji_oPageInfo.typQuery=="SN")
{jt_foDest=jr_ox.jm_oFolderJDBPages.foESilver;if($.isEmptyObject(jt_foDest))
return!jr_ox.jm_oTypScan.bMiddleE;jt_sQueryPaddingName="Silver";}
else if(ji_oPageInfo.typQuery=="SC")
{jt_foDest=jr_ox.jm_oFolderJDBPages.foESilvercat;if($.isEmptyObject(jt_foDest))
return!jr_ox.jm_oTypScan.bMiddleE;jt_sQueryPaddingName="Silver";}
else if(ji_oPageInfo.typQuery=="BN")
{jt_foDest=jr_ox.jm_oFolderJDBPages.foEBronze;if($.isEmptyObject(jt_foDest))
return!jr_ox.jm_oTypScan.bLowE;jt_sQueryPaddingName="Full";}
else if(ji_oPageInfo.typQuery=="BC")
{jt_foDest=jr_ox.jm_oFolderJDBPages.foEList;if($.isEmptyObject(jt_foDest))
return!jr_ox.jm_oTypScan.bLowE;jt_foDest=null;}
else
return false;}
else
return false;if($.isEmptyObject(jt_foDest))
return true;var jt_Itb_eid=jr_o._abjdb._getIDataTable();if($.isEmptyObject(jt_Itb_eid))
return false;var jt_sJsonTable_eid=jt_Itb_eid.getGLDString();if(jt_sJsonTable_eid)
{jt_foDest.file("a3xajdb_eeid_"+ji_oPageInfo.xurcc+".js",jt_sJsonTable_eid,{compression:"deflate"});var jt_sJsonTable_ebis="";var jt_Itb_ebis=jt_Itb_eid.getISubTable(A3xaDefineTbid().jc_tbtype_ebis.tbtname);if(!$.isEmptyObject(jt_Itb_ebis))
jt_sJsonTable_ebis=jt_Itb_ebis.getGLDString();if(jt_sJsonTable_ebis)
{jt_foDest.file("a3xajdb_eebis_"+ji_oPageInfo.xurcc+".js",jt_sJsonTable_ebis,{compression:"deflate"});}
var jt_sJsonTable_ebid="";var jt_Itb_ebid=jt_Itb_eid.getISubTable(A3xaDefineTbid().jc_tbtype_ebid.tbtname);if(!$.isEmptyObject(jt_Itb_ebid))
jt_sJsonTable_ebid=jt_Itb_ebid.getGLDString();if(jt_sJsonTable_ebid)
{jt_foDest.file("a3xajdb_eebid_"+ji_oPageInfo.xurcc+".js",jt_sJsonTable_ebid,{compression:"deflate"});}
var jt_sJsonTable_ei="";var jt_Itb_ei=jt_Itb_eid.getISubTable(A3xaDefineTbid().jc_tbtype_ei.tbtname);if(!$.isEmptyObject(jt_Itb_ei))
jt_sJsonTable_ei=jt_Itb_ei.getGLDString();if(jt_sJsonTable_ei&&jt_foDest_ei)
{jt_foDest_ei.file("a3xajdb_eei_"+ji_oPageInfo.xurcc+".js",jt_sJsonTable_ei,{compression:"deflate"});}}
return true;},_saveAs:function()
{if(!jr_ox._valid())
return false;var jt_zipfilename="a3xajdb_";var jt_hyp="";if(jr_ox.jm_oTypScan.bMainGeo)
...
jt_zipfilename+=".zip";jr_ox.jm_oJSZip.generateAsync({type:"blob"}).then(function(ji_blob)
{window.saveAs(ji_blob,jt_zipfilename);});return true;},_thatsallfolks:function(){return true;}};jr_ox._init();return jr_ox;};return jr_o._abjdb;}
﻿ function A3xaIApp()
...
{jr_o.jm_Ifw=_A3xaFramework();var jt_ofwdb=_A3xaFWDatabase();jt_ofwdb._getIfw=jr_o.app.getIfw;jt_ofwdb._newOJDBit=function(){return _A3xaJDBCit();};jr_o.jm_Ifwdb=jt_ofwdb.Ifwdb();var jt_ofwwg=_A3xaFWWidget();jt_ofwwg._getIfw=jr_o.app.getIfw;jr_o.jm_Ifwwg=jt_ofwwg.Ifwwg();var jt_ofwss=_A3xaFWSubsys();jt_ofwss._getIfw=jr_o.app.getIfw;jt_ofwss._getIfwdb=jr_o.app.getIfwdb;jt_ofwss._getIfwwg=jr_o.app.getIfwwg;jt_ofwss._newOabjdb=function(){return _A3xaAdminBatchJDBE();};jr_o.jm_Ifwss=jt_ofwss.Ifwss();};jr_o._init();A3xaApp=function(){return jr_o.app;};return jr_o.app;}
...
jg_oe.CanLogInfo()&&jg_oe.LogInfo("w2sb:"+ji_o3xsText.Get_LString(),"","A3xaAbsEnvironment.LogStatusBar");if(!this._ExecLogStatusBar2(ji_o3xsText,ji_bAsChild,ji_bClear));return true;};this._ExecLogStatusBar2=function(ji_o3xsText,ji_bAsChild,ji_bClear){return false;};this.jm_o3x2Envars=A3xaEnvironmentVariables();this.jm_oGLData={};this.Get_GLPreloadedData=function(){return this.jm_oGLData;};this.IsAdmin=function(){return this.jm_bAdmin;};this.Get_WebbotName=function(){return this.jm_sWebbot;};this.Set_CommonValues2=function(ji_ohia)
{return this.A3xaAbsEnvironment_Set_CommonValues2(ji_ohia);}
this.A3xaAbsEnvironment_Set_CommonValues2=function(ji_ohia)
{if(!ji_ohia)
return false;this.jm_bDebug=(ji_ohia.bDebug==true);this.jm_bCanEdit=ji_ohia.bCanEdit;this.jm_bCanLike=ji_ohia.bCanLike;this.jm_bReleaseJSDB=ji_ohia.bReleaseJSDB;this.jm_bAdmin=ji_ohia.bAdmin;this.jm_sWebbot=ji_ohia.webbot;this.jm_sDirIcons=(ji_ohia.dirIcons?ji_ohia.dirIcons:"/");this.jm_sDirHome=(ji_ohia.dirHome?ji_ohia.dirHome:"/");A3xaApp().getIfw().getILang().setCurrentLang({tag:(ji_ohia.lang?ji_ohia.lang:"en")});this.jm_sSitemapDate=(ji_ohia.dateSitemap?ji_ohia.dateSitemap:"");this.jm_sUserName=(ji_ohia.userName?ji_ohia.userName:"");this.jm_sUserLevel=(ji_ohia.userLevel?ji_ohia.userLevel:"");this.jm_sServerMessage=(ji_ohia.serverMessage?ji_ohia.serverMessage:"");this.jm_oGLData=ji_ohia.oGLData;return true;};this.CheckInitDone=function(){return true;};this.jm_oMgrStorage=null;this.Get_MgrStorage=function(){return this.jm_oMgrStorage;};this.jm_odb=null;this.Set_Database=function(ji_odb){this.jm_odb=ji_odb;return true;};this.Get_Database=function(){return this.jm_odb;};this.jm_oHostReporter=null;this.Set_Reporter=function(ji_oHostReporter)
...
{var jt_oxur=new A3xaXur();jt_oxur.Set_XurParams({form:jg_oe.jc_oXUR.jc_XURFN_AjaxEntity,tar:jg_oe.jc_oXUR.jc_sAjaxTypControlIcons});var jt_oUrl=jt_oxur.Get_A3xaUrl(true);jt_sAjaxUrlParams=jt_oUrl.Get_UrlParams();}
...
function GLIDR(ji_GGLID,ji_slicech,ji_extension){return A3xaDefineTbid().GLIDR(ji_GGLID,ji_slicech,ji_extension);};function GLIDP(ji_GGLID,ji_slicech,ji_extension){return A3xaDefineTbid().GLIDP(ji_GGLID,ji_slicech,ji_extension);};function GLIDN(ji_GGLID,ji_slicech,ji_extension){return A3xaDefineTbid().GLIDN(ji_GGLID,ji_slicech,ji_extension);};function GLIDF(ji_GGLID,ji_slicech,ji_extension){return A3xaDefineTbid().GLIDF(ji_GGLID,ji_slicech,ji_extension);};function A3xaITbtnames()
{return{D:function(){return null;},getTbtnames:function(){return[];},hastbt:function(ji_tbtname){return false;},hasEID:function(){return false;},hasEBIS:function(){return false;},hasEBID:function(){return false;},hasEI:function(){return false;}};}
function A3xaTbtnames(ji_atbtnames)
{var jr_o={jm_atbtnames:(ji_atbtnames||[]),jc:A3xaDefineTbid(),tbtn:A3xaITbtnames()};jr_o.tbtn.D=function(){return jr_o.jc;};jr_o.tbtn.getTbtnames=function(){return jr_o.jm_atbtnames||[];};jr_o.tbtn.hastbt=function(ji_tbtname)
{if(!ji_tbtname)
return false;if(!jr_o.jm_atbtnames)
return true;for(var i=0;i<jr_o.jm_atbtnames.length;i++)
{if(jr_o.jm_atbtnames[i]==ji_tbtname)
return true;}
return false;};jr_o.tbtn.hasEID=function(){return jr_o.tbtn.hastbt(jr_o.jc.jc_tbtype_eid.tbtname);};jr_o.tbtn.hasEBIS=function(){return jr_o.tbtn.hastbt(jr_o.jc.jc_tbtype_ebis.tbtname);};jr_o.tbtn.hasEBID=function(){return jr_o.tbtn.hastbt(jr_o.jc.jc_tbtype_ebid.tbtname);};jr_o.tbtn.hasEI=function(){return jr_o.tbtn.hastbt(jr_o.jc.jc_tbtype_ei.tbtname);};return jr_o.tbtn;}
...
return jr_o.gd.makeEnterpriseGold("0000",ji_tbtype);jr_o.jm_glid=null;}
return jr_o.jm_glid;}
...
{var jt_I3tbid=A3xaTbid(ji_GLID);if(jr_o.gd.isMetaSystemControl())
...
return jr_o.jc.jc_tbtype_ei;return{tbtname:"",tbtkeyname:"",leadch:""};};jr_o.gd.getSDSTbType=function(){return jr_o.gd.getTbType();};jr_o.gd.getGlid=function(){return jr_o.jm_glid;};jr_o.gd.set(ji_glid,ji_tbtype);return jr_o.gd;} function A3xaDbSchema(ji_sDbName,ji_DbVersion,ji_sDbDefaultKeyName,ji_aTables)
...
{var jt_I3tbid=A3xaTbid(ji_aTableNames[j]);if(jt_I3tbid.getDefault()==jt_aTables[i].jp_sName)
{jt_bMatch=true;break;}}}
if(jt_bMatch)
{var jt_oSTG=jt_aTables[i].jp_oSTG;if(jt_oSTG&&jt_oSTG.jp_sGroupName&&jt_oSTG.jp_sKeyName)
{if(!jr_aSchemaTableGroups.getItem(jt_oSTG.jp_sGroupName))
jr_aSchemaTableGroups.addItem(jt_oSTG.jp_sGroupName,jt_oSTG);}}}
...
{var jt_ostg=jt_aSchemaTableGroups.getItem_ByIndex(i);if(jt_ostg&&jt_ostg.jp_sGroupName)
...
{this.jm_oDTStatus=new GLDataStatus();this.jm_oDTStatusStore=new GLDataStatus();this.jm_glid=null;this.jm_release=null;this.jm_bSetupDone=false;this.jm_aoglr=A3xaArray();this.jm_aaoglrSelect=A3xaArray();this.jm_bAX=true;this.jm_aoglrAX=null;this.jm_odb=null;this.jm_IarSubDTLinked=null;this.Set_SubTable=function(ji_tbtname,ji_odt)
{if(!(ji_tbtname&&ji_odt))
return false;if(!this.jm_IarSubDTLinked)
this.jm_IarSubDTLinked=A3xaArray();return this.jm_IarSubDTLinked.setItem(ji_tbtname,ji_odt);};this.Get_SubTable=function(ji_tbtname)
{if(!ji_tbtname)
return null;if(!this.jm_IarSubDTLinked)
return null;var jr_odt=this.jm_IarSubDTLinked.getItem(ji_tbtname);return jr_odt;};this.jm_aoglrMerged=null;this.jm_aoglrAXMerged=null;this._GLDataTable=function(ji_oDatabase,ji_glid,ji_release)
...
return new A3xaAbsDbEntity();else if(jt_oDbSchemaTable.jp_SubTable==A3xaDefineTbid().jc_tbtype_ebis.tbtname)
return new A3xaAbsDbEntity();else if(jt_oDbSchemaTable.jp_SubTable==A3xaDefineTbid().jc_tbtype_ebid.tbtname)
return new A3xaAbsDbEntity();else if(jt_oDbSchemaTable.jp_SubTable==A3xaDefineTbid().jc_tbtype_ei.tbtname)
...
this.jm_o3xJSDS=jt_o3xJSDS;jg_oe.Get_Reporter().OnDataRead();return true;};this.AlreadySetupLoadedRecords=function()
{return this.jm_bSetupDone;};this.SetupLoadedRecords=function(ji_ogldtParent){return this.GLDataTable_SetupLoadedRecords(ji_ogldtParent);};this.GLDataTable_SetupLoadedRecords=function(ji_ogldtParent)
{this.jm_oDTStatus.SetLoadStatusSuccess();this.jm_bSetupDone=true;return true;};this.Get_IRecordset=function(ji_bNative)
...
{var jr_aoglrSelectNew=A3xaArrayIt(this.Get_IRecordset());if(!jr_aoglrSelectNew.selectItems(ji_fnSelect,ji_MaxItems))
...
{return this.jm_aaoglrSelect.getItem(ji_sSelectName||"DefaultSelect")||A3xaArrayIt(this.Get_IRecordset());};this.MergeRecordset=function(ji_ogldt)
...
{this.jm_aoglrMerged=A3xaArray();this.jm_aoglrAXMerged=A3xaArray();this.jm_aoglrMerged.merge(jt_aoglrMain);this.jm_aoglrAXMerged.merge(jt_aoglrAXMain);}
...
{this.jm_oDTStatus.SetLoadStatusFail();}
return true;};this._GLDataTable(ji_oDatabase,ji_glid,ji_release);} function A3xaIDataSourcePage()
...
function A3xaIStaticDataSource_Record()
...
ji_o3x2a=A3xaArray().O();else
ji_o3x2a.Get_I3x3().Iar().clear();var jt_c=jr_I.getCount();for(var i=0;i<jt_c;i++)
{var jt_pisdsrec=PISDSRecord();jt_pisdsrec.index=i;jt_pisdsrec.o3x2rec=jr_I._get3x2Record(i);jt_pisdsrec=ji_fnKeyMaker(jt_pisdsrec);if(!ji_o3x2a.Get_I3x3().Iar().addItem(jt_pisdsrec.key,jt_pisdsrec.o3x2rec))
{return null;}}
...
{jr_pisdsrec.key=jt_o3x2index.Get_I3x3().Iar().getKey(ji_ixRecord);jr_pisdsrec.o3x2rec=jt_o3x2index.Get_I3x3().Iar().getItem(jr_pisdsrec.key);}}
...
function A3xaIStaticDataSource_Db()
...
{var jr_o3x2tb=A3xaStaticDataSource_Table(ji_sdsTable,ji_bJSON);return jr_o3x2tb;};return jr_I;}
function A3xaStaticDataSource_FieldPropArray(ji_sdsfpa,ji_name)
{var jr_o={jm_name:null,jm_sdsfpa:null,fpa:A3xaIStaticDataSource_FieldPropArray(),_Construct:function(ji_sdsfpa,ji_name)
...
{return A3xaStaticDataSource_FieldPropArray(ji_fp.d3x_names,ji_fp.d3x_name);};jr_o._Construct(ji_sdsfpa,ji_name);return jr_o;}
function A3xaStaticDataSource_Record(ji_sdsrec,ji_o3x2FieldPropArray)
{var jr_o={jm_sdsrec:null,jm_o3x2FieldPropArray:null,rec:A3xaIStaticDataSource_Record(),_Construct:function(ji_sdsrec,ji_o3x2FieldPropArray)
...
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("1,ji_ix,jr_o.jm_sdsrec[ji_ix]: "+ji_ix+","+(jr_o.jm_sdsrec?jr_o.jm_sdsrec[ji_ix]:"null"),"","A3xaStaticDataSource_Record.get3x2Recordset");if(!jr_o.rec.isRecordset(ji_ix))
return null;jg_oe.CanLogInfo()&&jg_oe.LogInfo("2: ","","A3xaStaticDataSource_Record.get3x2Recordset");if(!(jr_o.jm_o3x2FieldPropArray&&jr_o.jm_o3x2FieldPropArray.fpa.isFieldArray(ji_ix)))
return null;jg_oe.CanLogInfo()&&jg_oe.LogInfo("3,jr_o.jm_sdsrec[ji_ix]: "+jr_o.jm_sdsrec[ji_ix],"","A3xaStaticDataSource_Record.get3x2Recordset");return A3xaStaticDataSource_Recordset(jr_o.jm_sdsrec[ji_ix],jr_o.jm_o3x2FieldPropArray.fpa.get3x2FieldPropArray(ji_ix));};jr_o.rec.getFieldPos=function(ji_fieldName)
...
function A3xaStaticDataSource_Recordset(ji_sdsrs,ji_o3x2FieldPropArray)
{var jr_o={jm_sdsrs:null,jm_o3x2FieldPropArray:null,rs:A3xaIStaticDataSource_Recordset(),_Construct:function(ji_sdsrs,ji_o3x2FieldPropArray)
...
{var jt_rec=jr_o.rs._getD3xRecord(ji_ix);return(jt_rec?A3xaStaticDataSource_Record(jt_rec,jr_o.jm_o3x2FieldPropArray):null);};jr_o.rs.getIRecord=function(ji_ix)
...
function A3xaStaticDataSource_Table(ji_sdsTable,ji_bJSON)
{var jr_o={jm_sdstb:null,jm_a3x2Indexes:A3xaArray().O(),tb:A3xaIStaticDataSource_Table(),_Construct:function(ji_sdsTable,ji_bJSON)
{if(ji_bJSON)
...
{return A3xaStaticDataSource_FieldPropArray(jr_o.tb.getD3xFieldNames(),null);};jr_o.tb.getIFieldPropArray=function(){return jr_o.tb.get3x2FieldPropArray().fpa;};jr_o.tb.get3x2Recordset=function()
{return A3xaStaticDataSource_Recordset(jr_o.tb.getD3xRecordset(),jr_o.tb.get3x2FieldPropArray());};jr_o.tb.getIRecordset=function()
...
return false;return jr_o.jm_a3x2Indexes.Get_I3x3().Iar().setItem(ji_keyName,jt_o3x2ax);};jr_o.tb.getTableIndex=function(ji_keyName){return jr_o.jm_a3x2Indexes.Get_I3x3().Iar().getItem(ji_keyName);};jr_o.tb.getCountOfRecords=function()
...
function A3xaStaticDataSource_Db()
{var jr_o={jm_DbDefaultVersion:"",jm_o3x2a:A3xaArray().O(),db:A3xaIStaticDataSource_Db()};jr_o.db.setDefaultDbVersion=function(ji_DbVersion){jr_o.db.jm_DbDefaultVersion=ji_DbVersion;return true;};jr_o.db.getDefaultDbVersion=function(){return jr_o.db.jm_DbDefaultVersion;};jr_o.db.addD3xTable=function(ji_sdsTable,ji_bJSON)
{if(!ji_sdsTable)
...
return false;var jt_glid=ji_o3x2tb.tb.getGlid();var jt_name=ji_o3x2tb.tb.getName();var jt_type=ji_o3x2tb.tb.getType();var jt_id=jt_glid+","+jt_type;if(!jr_o.jm_o3x2a.Get_I3x3().Iar().setItem(jt_id,ji_o3x2tb))
return false;return true;};jr_o.db.get3x2Table=function(ji_glid,ji_name,ji_type)
{var jt_I3tbid=A3xaTbid(ji_glid);var jt_tbtype=jt_I3tbid.getTbType();var jt_tbtname=(jt_tbtype?jt_tbtype.tbtname:"");if(ji_glid)
{if(!ji_type)
ji_type=jt_tbtype.tbtname;return jr_o.jm_o3x2a.Get_I3x3().Iar().getItem(ji_glid+","+ji_type);}
else if(ji_type&&ji_name)
{return jr_o.jm_o3x2a.Get_I3x3().Iar().findItem(function(ji_o3x2tb)
{return(ji_name==ji_o3x2tb.tb.getName()&&ji_type==ji_o3x2tb.tb.getType());});}
return null;};return jr_o;} function A3xaIDataSourceGLRSPool()
{var jr_I={getItem:function(ji_sName){return"";},getGLItem:function(ji_sGLnameGLID,ji_sGLnameGLH,ji_sGLnameGL){return{glid:"",oglh:"",glh:"",glrs:""};},getGLItem2:function(ji_tbtname,ji_GLent,ji_slicech,ji_idForeign){return{glid:"",oglh:"",glh:"",glrs:""};},checkGLItem2:function(ji_tbtname,ji_GLent,ji_slicech,ji_idForeign){return false;}};return jr_I;}
...
{return((!ji_GLtype||!ji_tbtname||!ji_GLent||ji_idForeign<0)?"":"p_"+ji_GLtype+ji_tbtname+"_"+ji_GLent+(ji_slicech?ji_slicech:"")+(ji_idForeign>0?ji_idForeign:""));};jr_o.makeGLname=function(ji_tbtname,ji_GLent,ji_slicech,ji_idForeign)
...
{return jr_o._makeGLname("GLH",ji_tbtname,ji_GLent,ji_slicech,ji_idForeign);};jr_o.dsp.getGLItem=function(ji_sGLnameGLID,ji_sGLnameGLH,ji_sGLnameGL)
{var jr_oitem={glid:"",oglh:null,glh:"",oglrs:null,glrs:""};var jt_xglrs=jr_o.dsp.getItem(ji_sGLnameGL);if(jt_xglrs&&jQuery.type(jt_xglrs)==="string")
...
return false;}
jr_o.dts.enableTables(jt_bEID,jt_bEBIS,jt_bEBID,jt_bEI);if(jr_o.jm_o3xxur.Get_3xXEID().Get_TypEntity()==jg_oe.jc_oEntity.jc_Typ_Enterprise)
...
return false;}
else if(jr_o.dts.checkGLRS2("E",A3xaDefineTbid().jc_tbslice_major))
{if(!jr_o.dts.writeGLRS2("E",A3xaDefineTbid().jc_tbslice_major))
return false;if(jr_o.dts.checkGLRS2("E",A3xaDefineTbid().jc_tbslice_subry))
...
return false;}}
else if(jr_o.dts.checkGLRS2("E",A3xaDefineTbid().jc_tbslice_subry))
{if(!jr_o.dts.writeGLRS2("E",A3xaDefineTbid().jc_tbslice_subry))
return false;}}
...
{if(!jr_o.dts.writeEmptyGLRS2("E"))
return false;if(jr_o.dts.checkGLRS2("E",A3xaDefineTbid().jc_tbslice_unique)&&!jr_o.dts.writeGLRS2("E",A3xaDefineTbid().jc_tbslice_unique))
return false;if(jr_o.dts.checkGLRS2("E",A3xaDefineTbid().jc_tbslice_major)&&!jr_o.dts.writeGLRS2("E",A3xaDefineTbid().jc_tbslice_major))
return false;if(jr_o.dts.checkGLRS2("E",A3xaDefineTbid().jc_tbslice_subry)&&!jr_o.dts.writeGLRS2("E",A3xaDefineTbid().jc_tbslice_subry))
return false;}}
...
{var jt_odb=jg_oApp.Get_Database();var jt_xitemEID={glid:"",glrs:""};var jt_xitemEBIS={glid:"",glrs:""};var jt_xitemEBID={glid:"",glrs:""};var jt_xitemEI={glid:"",glrs:""};if(jr_o.jm_bEID)
...
return false;}
if(jr_o.jm_bEI)
{jt_xitemEI=jr_o._getDataSourceGLRSPool().getGLItem2("EI",ji_GLent,ji_slicech,ji_idForeign);}
jg_oe.CanLogInfo()&&jg_oe.LogInfo("xur.QUR,xur.XEID,ji_GLent,ji_slicech,idForeign,glid,glrs="+
jr_o.jm_o3xxur.jm_QUR+","+jr_o.jm_o3xxur.Get_3xXEID().Get_CompactCode()+","+
ji_GLent+","+ji_slicech+","+ji_idForeign+","+
jt_xitemEID.glid+","+jt_xitemEID.glrs,"","A3xaDataTableSlice.writeGLRS2");if(jr_o.jm_bEID&&!jt_odb.WriteGLRS2(jt_xitemEID.glid,jt_xitemEID.oglh,jt_xitemEID.glrs))
return false;if(jr_o.jm_bEBIS&&!jt_odb.WriteGLRS2(jt_xitemEBIS.glid,jt_xitemEBIS.oglh,jt_xitemEBIS.glrs))
return false;if(jr_o.jm_bEBID&&!jt_odb.WriteGLRS2(jt_xitemEBID.glid,jt_xitemEBID.oglh,jt_xitemEBID.glrs))
return false;if(jr_o.jm_bEI&&jt_xitemEI&&jt_xitemEI.glid&&!jt_odb.WriteGLRS2(jt_xitemEI.glid,jt_xitemEI.oglh,jt_xitemEI.glrs))
return false;return true;};jr_o.dts.writeEmptyGLRS2=function(ji_GLent,ji_slicech,ji_idForeign)
{if(ji_GLent!="E")
return false;var jt_odb=jg_oApp.Get_Database();var jt_tbrelease=(jt_odb.Get_SDSDBWork().db.getDefaultDbVersion()||"");var jt_I3tbid=A3xaTbid();var jt_xitemEID={glid:"",oglh:null,glh:"",oglrs:null,glrs:""};var jt_xitemEBIS={glid:"",oglh:null,glh:"",oglrs:null,glrs:""};var jt_xitemEBID={glid:"",oglh:null,glh:"",oglrs:null,glrs:""};var jt_xitemEI={glid:"",oglh:null,glh:"",oglrs:null,glrs:""};if(jr_o.jm_bEID)
{jt_xitemEID={glid:jt_I3tbid.makeByXEID(jr_o.jm_o3xxur,ji_slicech,A3xaDefineTbid().jc_tbtype_eid)};if(!jt_xitemEID.glid)
return false;jt_xitemEID.oglh={"d3x_header":{"d3x_glid":jt_xitemEID.glid,"d3x_tbtype":"t3x_eid","d3x_tbname":"n3x_Enterprise","d3x_version":jt_tbrelease}};jt_xitemEID.glrs=JSON.stringify(jt_xitemEID.oglh,function(ji_k,ji_v){return ji_v;});}
if(jr_o.jm_bEBIS)
{jt_xitemEBIS={glid:jt_I3tbid.makeByXEID(jr_o.jm_o3xxur,ji_slicech,A3xaDefineTbid().jc_tbtype_ebis)};if(!jt_xitemEBIS.glid)
return false;jt_xitemEBIS.oglh={"d3x_header":{"d3x_glid":jt_xitemEBIS.glid,"d3x_tbtype":"t3x_ebis","d3x_tbname":"n3x_Enterprise","d3x_version":jt_tbrelease}};jt_xitemEBIS.glrs=JSON.stringify(jt_xitemEBIS.oglh,function(ji_k,ji_v){return ji_v;});}
if(jr_o.jm_bEBID)
{jt_xitemEBID={glid:jt_I3tbid.makeByXEID(jr_o.jm_o3xxur,ji_slicech,A3xaDefineTbid().jc_tbtype_ebid)};if(!jt_xitemEBID.glid)
return false;jt_xitemEBID.oglh={"d3x_header":{"d3x_glid":jt_xitemEBID.glid,"d3x_tbtype":"t3x_ebid","d3x_tbname":"n3x_Enterprise","d3x_version":jt_tbrelease}};jt_xitemEBID.glrs=JSON.stringify(jt_xitemEBID.oglh,function(ji_k,ji_v){return ji_v;});}
if(jr_o.jm_bEI)
{jt_xitemEI={glid:jt_I3tbid.makeByXEID(jr_o.jm_o3xxur,ji_slicech,A3xaDefineTbid().jc_tbtype_ei)};if(!jt_xitemEI.glid)
return false;jt_xitemEI.oglh={"d3x_header":{"d3x_glid":jt_xitemEI.glid,"d3x_tbtype":"t3x_ei","d3x_tbname":"n3x_Enterprise","d3x_version":jt_tbrelease}};jt_xitemEI.glrs=JSON.stringify(jt_xitemEI.oglh,function(ji_k,ji_v){return ji_v;});}
jg_oe.CanLogInfo()&&jg_oe.LogInfo("xur.QUR,xur.XEID,ji_GLent,ji_slicech,idForeign,glid,glrs="+
jr_o.jm_o3xxur.jm_QUR+","+jr_o.jm_o3xxur.Get_3xXEID().Get_CompactCode()+","+
ji_GLent+","+ji_slicech+","+ji_idForeign+","+
jt_xitemEID.glid+","+jt_xitemEID.glrs,"","A3xaDataTableSlice.writeGLRS2");if(jr_o.jm_bEID&&!jt_odb.WriteGLRS2(jt_xitemEID.glid,jt_xitemEID.oglh,jt_xitemEID.glrs))
return false;if(jr_o.jm_bEBIS&&!jt_odb.WriteGLRS2(jt_xitemEBIS.glid,jt_xitemEBIS.oglh,jt_xitemEBIS.glrs))
return false;if(jr_o.jm_bEBID&&!jt_odb.WriteGLRS2(jt_xitemEBID.glid,jt_xitemEBID.oglh,jt_xitemEBID.glrs))
return false;if(jr_o.jm_bEI&&!jt_odb.WriteGLRS2(jt_xitemEI.glid,jt_xitemEI.oglh,jt_xitemEI.glrs))
...
return true;};return jr_o.dts;} function A3xaIDTCacheWriter()
{var jr_I={writeTable:function(){return false;},writeJSDS:function(){return false;},};return jr_I;}
function A3xaDTCacheWriter(ji_odb,ji_glid,ji_oglh,ji_sGLRS)
{var jr_o={jm_odb:ji_odb,jm_glid:ji_glid,jm_oglh:ji_oglh,jm_sGLRS:(ji_sGLRS||""),jm_header_glid:null,jm_header_release:null,jm_o3xJSDS:null,jm_odt:null,csw:A3xaIDTCacheWriter(),};jr_o.csw.writeTable=function()
...
return false;jr_o.jm_odb.jm_oDTStatus.SetCacheStatusInProgress("Cache Tableset "+jr_o.jm_glid);jr_o.jm_odb.Get_IArrayDTStore().setItem(jr_o.jm_glid,jr_o.jm_odt);jr_o.jm_odt.jm_oDTStatus.SetCacheStatusInProgress();jr_o.jm_o3xJSDS=jr_o.jm_odt.New3xJSDS(jr_o.jm_glid);if(!jr_o.jm_o3xJSDS)
...
jr_o.jm_odt.jm_o3xJSDS=jr_o.jm_o3xJSDS;jr_o.jm_odt.Set_Glid(jr_o.jm_glid);jr_o.jm_odt.Set_Version(jr_o.jm_header_release);jr_o.jm_odt.jm_oDTStatus.SetCacheStatusSuccess();return(jr_o.jm_odt.jm_oDTStatus.IsSuccess());};return jr_o;} function A3xaDefines_A3xaDatabase()
...
this.jm_o3x3aDataTableLoad_TOC=A3xaArray();if(ji_pTypTables.jp_bTyp_Common)
this.jm_o3x3aDataTableLoad_Common=A3xaArray();if(ji_pTypTables.jp_bTyp_Gold)
this.jm_o3x3aDataTableLoad_Gold=A3xaArray();if(ji_pTypTables.jp_bTyp_Silver)
this.jm_o3x3aDataTableLoad_Silver=A3xaArray();if(ji_pTypTables.jp_bTyp_Main)
this.jm_o3x3aDataTableLoad_Main=A3xaArray();if(ji_pTypTables.jp_bTyp_Unique)
this.jm_o3x3aDataTableLoad_Unique=A3xaArray();if(ji_pTypTables.jp_bTyp_Major)
this.jm_o3x3aDataTableLoad_Major=A3xaArray();if(ji_pTypTables.jp_bTyp_Subry)
this.jm_o3x3aDataTableLoad_Subry=A3xaArray();return true;}
...
return this.jm_o3x3aDataTableLoad_Subry;return null;};this.NewDataTableCacheStore=function(ji_glid){return this.NewDataTable(ji_glid);};this.NewDataTable=function(ji_glid){return null;};this.Get_DataTable=function(ji_glid,ji_bDontCheck)
{var jt_I3tbid=A3xaTbid(ji_glid);var jt_oxur=jg_oApp.Get_MgrPage().Get_3xXUR();if(!ji_glid)
...
{jt_aodt=this.Get_IArrayDTLoad({jp_bTyp_Common:true});jr_odt=jt_aodt.getItem(ji_glid);}
if(!jr_odt)
{jt_aodt=this.Get_IArrayDTLoad({jp_bTyp_Gold:true});jr_odt=jt_aodt.getItem(ji_glid);}
if(!jr_odt)
{jt_aodt=this.Get_IArrayDTLoad({jp_bTyp_Silver:true});jr_odt=jt_aodt.getItem(ji_glid);}
if(!jr_odt)
{jt_aodt=this.Get_IArrayDTLoad({jp_bTyp_Main:true});jr_odt=jt_aodt.getItem(ji_glid);}
if(!jr_odt)
{jt_aodt=this.Get_IArrayDTLoad({jp_bTyp_Unique:true});jr_odt=jt_aodt.getItem(ji_glid);}
if(!jr_odt)
{jt_aodt=this.Get_IArrayDTLoad({jp_bTyp_Major:true});jr_odt=jt_aodt.getItem(ji_glid);}
if(!jr_odt)
{jt_aodt=this.Get_IArrayDTLoad({jp_bTyp_Subry:true});jr_odt=jt_aodt.getItem(ji_glid);}
if(!jr_odt)
{jt_aodt=this.Get_IArrayDTLoad({jp_bTyp_TOC:true});jr_odt=jt_aodt.getItem(ji_glid);}
if(ji_bDontCheck)
...
{if(!ji_glid)
return null;if(!this.Get_IArrayDTStore())
return null;var jt_ogldt=this.Get_IArrayDTStore().getItem(ji_glid);if(!(jt_ogldt&&jt_ogldt.Get_Glid()==ji_glid))
return null;return jt_ogldt;};this.OnDataLoadedSetup=function()
{return true;};this._IsGlidEnabled_=function(ji_I3tbid,ji_Itbtn)
{return($.isEmptyObject(ji_Itbtn)||(!ji_I3tbid.isEnterprise()&&!ji_I3tbid.isGeoCity())||(ji_Itbtn.hasEID()&&ji_I3tbid.isEID())||(ji_Itbtn.hasEBIS()&&ji_I3tbid.isEBIS())||(ji_Itbtn.hasEBID()&&ji_I3tbid.isEBID())||(ji_Itbtn.hasEI()&&ji_I3tbid.isEI()));};this.WriteGLRS2=function(ji_glid,ji_oglh,ji_sGLRS,ji_Itbtn)
{var jr_b=false;if(!ji_glid)
return false;var jt_StorageType=this.Get_StorageType(ji_glid);var jt_I3tbid=A3xaTbid(ji_glid);if(jt_I3tbid.isDefault()&&jt_StorageType==jg_oe.jc_oStorage.jc_FLY)
{}
var jt_tbtype=jt_I3tbid.getTbType();var jt_keyname=(jt_tbtype?jt_tbtype.tbtkeyname:"");var jt_glid_ei=jt_I3tbid.makeByType(ji_glid,A3xaDefineTbid().jc_tbtype_ei);var jt_glid_ebid=jt_I3tbid.makeByType(ji_glid,A3xaDefineTbid().jc_tbtype_ebid);var jt_glid_ebis=jt_I3tbid.makeByType(ji_glid,A3xaDefineTbid().jc_tbtype_ebis);var jt_glid_eid=jt_I3tbid.makeByType(ji_glid,A3xaDefineTbid().jc_tbtype_eid);jt_I3tbid.set(ji_glid);if(this.Get_SDSDBStore()&&jt_I3tbid.isEID()&&jt_I3tbid.isCommon()&&!jt_I3tbid.isSummary())
{this.jm_oDTStatus.SetCacheStatusInProgress("Cache Tableset "+jt_glid_eid);var jt_bFail=false;if(this._IsGlidEnabled_(A3xaTbid(jt_glid_eid),ji_Itbtn))
{var jt_otb=this.NewDataTableCacheStore(jt_glid_eid);this.Get_IArrayDTStore().setItem(jt_glid_eid,jt_otb);var jt_o3x2tb=this.Get_SDSDBStore().db.get3x2Table(jt_glid_eid);if(!(jt_otb&&jt_o3x2tb&&jt_otb.Get_Glid()==jt_o3x2tb.tb.getGlid()))
...
if(this._IsGlidEnabled_(A3xaTbid(jt_glid_ebis),ji_Itbtn))
{var jt_otbp=this.NewDataTableCacheStore(jt_glid_ebis);this.Get_IArrayDTStore().setItem(jt_glid_ebis,jt_otbp);var jt_o3x2tbp=this.Get_SDSDBStore().db.get3x2Table(jt_glid_ebis);if(!(jt_otbp&&jt_o3x2tbp&&jt_otbp.Get_Glid()==jt_o3x2tbp.tb.getGlid()))
...
if(this._IsGlidEnabled_(A3xaTbid(jt_glid_ebid),ji_Itbtn))
{var jt_otbn=this.NewDataTableCacheStore(jt_glid_ebid);this.Get_IArrayDTStore().setItem(jt_glid_ebid,jt_otbn);var jt_o3x2tbn=this.Get_SDSDBStore().db.get3x2Table(jt_glid_ebid);if(!(jt_otbn&&jt_o3x2tbn&&jt_otbn.Get_Glid()==jt_o3x2tbn.tb.getGlid()))
...
if(this._IsGlidEnabled_(A3xaTbid(jt_glid_ei),ji_Itbtn))
{var jt_otbf=this.NewDataTableCacheStore(jt_glid_ei);this.Get_IArrayDTStore().setItem(jt_glid_ei,jt_otbf);var jt_o3x2tbf=this.Get_SDSDBStore().db.get3x2Table(jt_glid_ei);if(!(jt_otbf&&jt_o3x2tbf&&jt_otbf.Get_Glid()==jt_o3x2tbf.tb.getGlid()))
...
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("ji_glid,ji_sGLRS: "+ji_glid+","+ji_sGLRS,"","A3xaDatabase.WriteGLRS2");var jt_o3x2dtcsw=A3xaDTCacheWriter(this,ji_glid,ji_oglh,ji_sGLRS);jr_b=jt_o3x2dtcsw.csw.writeTable();}
...
{var jt_ogldt=this.Get_IArrayDTStore().getItem_ByIndex(j);var jt_this=this;jt_ogldt.jm_oDTStatus.jm_fnOnChange=function(ji_oDTStatus)
...
for(i=0;i<jt_CountDT;i++)
{var jt_ogldt=this.Get_IArrayDTStore().getItem_ByIndex(i);if(!jt_ogldt.jm_oDTStatus.IsOpStore()&&jt_ogldt.jm_oDTStatus.IsSuccess()&&!jt_ogldt.jm_oDTStatusStore.IsOpStore())
...
{var jt_glid=A3xaDefineTbid().jc_GLID_TOC;var jt_I3tbid=A3xaTbid(jt_glid);var jt_tbtype=jt_I3tbid.getTbType();var jt_keyname=(jt_tbtype?jt_tbtype.tbtkeyname:"");var jr_odtTOC=this.Get_DataTable(jt_glid,true);if(!jr_odtTOC)
return null;return jr_odtTOC;};this.Get_3x2TOC=function()
{return this.Get_SDSDBWork().db.get3x2Table(A3xaDefineTbid().jc_GLID_TOC,null,null);};this.Get_TOCItem=function(ji_glid,ji_bCheckVersion)
{if(!ji_glid)
return null;jg_oe.CanLogInfo()&&jg_oe.LogInfo("1)ji_glid="+ji_glid,"","A3xaDatabase.Get_TOCItem");var jt_I3tbid=A3xaTbid(ji_glid);if(jt_I3tbid.isTOC())
return null;jg_oe.CanLogInfo()&&jg_oe.LogInfo("2)ji_glid="+ji_glid,"","A3xaDatabase.Get_TOCItem");var jt_odtTOC=this.Get_TOC();if(!jt_odtTOC)
return null;jg_oe.CanLogInfo()&&jg_oe.LogInfo("3)ji_glid="+ji_glid,"","A3xaDatabase.Get_TOCItem");var jt_o3x2tbTOC=this.Get_3x2TOC();if(!jt_o3x2tbTOC)
return null;var jr_pisdsRecord=jt_o3x2tbTOC.tb.getRecord_ByKey(ji_glid);jg_oe.CanLogInfo()&&jg_oe.LogInfo("ji_glid,jr_pisdsRecord.fields[1]="+ji_glid+","+(jr_pisdsRecord?jr_pisdsRecord.fields[1]:"NOK"),"","A3xaDatabase.Get_TOCItem");if(jr_pisdsRecord&&!(ji_bCheckVersion===false))
...
return false;var jt_o3x2tbTOC=this.Get_SDSDBWork().db.get3x2Table(A3xaDefineTbid().jc_GLID_TOC,null,null);if(!jt_o3x2tbTOC)
return false;if(jg_oe.CanLogInfo())
{jg_oe.LogInfo("ji_glid,ji_release="+ji_glid+","+ji_release,"p5","A3xaDatabase.AddTOCItem");}
var jr_pisdsRecord=jt_o3x2tbTOC.tb.getRecord_ByKey(ji_glid);if(jr_pisdsRecord)
{var jt_DbDefaultVersion=this.Get_SDSDBStore().db.getDefaultDbVersion();if(jr_pisdsRecord.fields&&jr_pisdsRecord.fields[1]&&jt_DbDefaultVersion&&jt_DbDefaultVersion!=jr_pisdsRecord.fields[1])
...
ji_glid+","+(jt_pisdsRecord?jt_pisdsRecord.fields[1]:"NOK")+","+(jr_pisdsRecord?jr_pisdsRecord.fields[1]:"NOK"),"p10","A3xaDatabase.AddTOCItem");}
...
{var jt_glid=ji_odbtr.jm_aDbTableName[i];var jt_odt=null;var jt_I3tbid=A3xaTbid(jt_glid);if(jt_I3tbid.isTOC())
...
{for(var i=0;i<ji_odbtr.jm_aDbTableName.length;i++)
{var jt_odt=null;var jt_glid=ji_odbtr.jm_aDbTableName[i];var jt_I3tbid=A3xaTbid(jt_glid);if(jt_I3tbid.isTOC())
...
this.jm_aGlidQueue.push(this.jm_aGlidToLoad[i]);return true;};} function A3xaIAjaxTables()
{var jr_I={requestMain:function(ji_fnOnDone){return false;},get3xXUR:function(){return null;}};return jr_I;}
function A3xaAjaxTables()
{var jr_o={jm_oxur:null,jxt:A3xaIAjaxTables()};jr_o.jxt.get3xXUR=function(){return jr_o.jm_oxur;};jr_o.jxt.requestMain=function(ji_fnOnDone,ji_o3xxur,ji_Itbtn)
...
return false;var jt_oxeidXUR=ji_o3xxur.Get_3xXEID();var jt_te=jt_oxeidXUR.Get_TypEntity();if(jt_te&&jt_te!=jg_oe.jc_oEntity.jc_Typ_Enterprise)
return false;ji_o3xxur.jm_FormName=jg_oe.jc_oXUR.jc_XURFN_AjaxEntity;ji_o3xxur.jm_TypAjaxResponse=jg_oe.jc_oXUR.jc_sAjaxTypEntitySet;jr_o.jm_oxur=ji_o3xxur;var jr_b=jr_o.jxt._requestMain_ZIP(function(ji_bSuccess)
{return jr_o.jxt._requestMain_POST(ji_fnOnDone,ji_o3xxur,ji_Itbtn);},ji_o3xxur,ji_Itbtn);return jr_b;};jr_o.jxt._requestMain_POST=function(ji_fnOnDone,ji_o3xxur,ji_Itbtn)
{var jt_tbtnames=(ji_Itbtn?ji_Itbtn.getTbtnames():[]);$.ajax({method:"POST",timeout:10000,url:jg_oe.jc_oXUR.jc_sUrlBase_A3xaFormDDAJOO+"?",data:{p3k:"1",p3x:ji_o3xxur.Get_XURCC(),p3n:JSON.stringify({mark:"J3",oppg:"app_entityset",optyp:"exec",code:"",msg:"",tbtnames:jt_tbtnames},function(ji_k,ji_v)
{return ji_v;})},success:function(ji_response)
...
{var jt_o3x3dtslice=A3xaDataTableSlice(A3xaDataSourceGLRSPool(jt_oResponse.data),jr_o.jxt.get3xXUR());jt_o3x3dtslice.enableTables2(ji_Itbtn);if(jt_o3x3dtslice.writeGLRS2All())
jt_bSuccess=true;}
if(ji_fnOnDone)
ji_fnOnDone(jt_bSuccess,jr_o.jxt.get3xXUR());}},error:function(ji_response)
{}});return true;};jr_o.jxt._requestMain_ZIP=function(ji_fnOnDone,ji_o3xxur,ji_Itbtn)
{var jt_tbtnames=(ji_Itbtn?ji_Itbtn.getTbtnames():[]);var jt_o3xxurFIX=new A3xaXur();jt_o3xxurFIX.CopyFromXUR(ji_o3xxur);jt_o3xxurFIX.jm_FormName="";jt_o3xxurFIX.jm_TypAjaxResponse="";jt_o3xxurFIX.jm_SubEntity=jg_oe.jc_oXUR.jc_XURTG_Master;if(ji_o3xxur.IsGold())
{}
else
{if(ji_fnOnDone)
ji_fnOnDone(false,jr_o.jxt.get3xXUR());return false;}
if(ji_fnOnDone)
ji_fnOnDone(false,jr_o.jxt.get3xXUR());return false;var jt_aoJSDB=jg_oe.jc_oUrls.Get_PathJSDB({bReleaseJSDB:jg_oe.jm_bReleaseJSDB,bGold:true,tbtnames:jt_tbtnames,xurcc:jt_o3xxurFIX.Get_XURCC()});if(!(jt_aoJSDB&&jt_aoJSDB.length>0))
{if(ji_fnOnDone)
ji_fnOnDone(false,jr_o.jxt.get3xXUR());return false;}
var jt_fnOnLoadJsonTable=function(ji_aoJSDB,ji_cursor)
{var jt_bSuccess=false;if(!(ji_aoJSDB&&ji_cursor<ji_aoJSDB.length))
return(ji_fnOnDone?ji_fnOnDone(jt_bSuccess,jr_o.jxt.get3xXUR()):false);var jt_oJSDB=ji_aoJSDB[ji_cursor];if(!(jt_oJSDB.xstatus==1&&jt_oJSDB.jsontable))
return(ji_fnOnDone?ji_fnOnDone(jt_bSuccess,jr_o.jxt.get3xXUR()):false);if(++ji_cursor<ji_aoJSDB.length)
...
{return(ji_fnOnDone?ji_fnOnDone(jt_bSuccess,jr_o.jxt.get3xXUR()):false);}
jt_oDSPool[ji_aoJSDB[i].GLname]=ji_aoJSDB[i].jsontable;}
if($.isEmptyObject(jt_oDSPool))
{return(ji_fnOnDone?ji_fnOnDone(jt_bSuccess,jr_o.jxt.get3xXUR()):false);}
var jt_o3x3dtslice=A3xaDataTableSlice(A3xaDataSourceGLRSPool(jt_oDSPool),jr_o.jxt.get3xXUR());jt_o3x3dtslice.enableTables2(ji_Itbtn);if(jt_o3x3dtslice.writeGLRS2All({bIgnoreServerXur:true}))
jt_bSuccess=true;alert("p9100="+jt_bSuccess);return(ji_fnOnDone?ji_fnOnDone(jt_bSuccess,jr_o.jxt.get3xXUR()):true);};jr_o.jxt._UnzipJsonTable(jt_fnOnLoadJsonTable,jt_aoJSDB,0);return true;};jr_o.jxt._UnzipJsonTable=function(ji_fnOnDone,ji_aoJSDB,ji_cursor)
...
ji_fnOnDone(ji_aoJSDB,ji_cursor);}});return true;};jr_o.jxt.requestCities=function(ji_fnOnDone,ji_o3xxur,ji_Itbtn)
{jg_oe.LogStatusBar2(new A3xaString(["Request Cities info","Solicitud Ciudades info","Solicitação Ciudades info","Richiesta Città info"]));var jt_tbtnames=(ji_Itbtn?ji_Itbtn.getTbtnames():[]);var jt_aoJSDBei=jg_oe.jc_oUrls.Get_PathJSDB({bReleaseJSDB:jg_oe.jm_bReleaseJSDB,bCommon:true,bCities:true,tbtnames:jt_tbtnames});if(!(jt_aoJSDBei&&jt_aoJSDBei.length>0))
{if(ji_fnOnDone)
ji_fnOnDone(false,null,null);return false;}
...
{if(ji_fnOnDone)
ji_fnOnDone(true,null);},error:function()
{if(ji_fnOnDone)
ji_fnOnDone(false,null);}});return true;};return jr_o.jxt;} function A3xaDefineDataManager()
{var jr_o={jc_tbdctor_TOC:{tbtyp:"TOC",pTypTables:{jp_bTyp_TOC:true},asLoading:["Loading TOC","Cargando TOC","Carregando TOC","Caricamento TOC"]},jc_tbdctor_Common:{tbtyp:"Common",pTypTables:{jp_bTyp_Common:true},asLoading:["Loading common","Cargando datos común","Carregando dados comum","Caricamento dati comuni"]},jc_tbdctor_Gold:{tbtyp:"Gold",pTypTables:{jp_bTyp_Gold:true},asLoading:["Loading T10-Gold","Cargando T10-Gold","Carregando T10-Gold","Caricamento T10-Oro"]},jc_tbdctor_Silver:{tbtyp:"Silver",pTypTables:{jp_bTyp_Silver:true},asLoading:["Loading T10-Silver","Cargando T10-Silver","Carregando T10-Silver","Caricamento T10-Argento"]},jc_tbdctor_Main:{tbtyp:"Main",pTypTables:{jp_bTyp_Main:true},asLoading:["Loading main","Cargando principal","Carregando principal","Caricamento principale"]},jc_tbdctor_Unique:{tbtyp:"Unique",pTypTables:{jp_bTyp_Unique:true},asLoading:["Loading unique","Cargando unique","Carregando unique","Caricamento unique"]},jc_tbdctor_Major:{tbtyp:"Major",pTypTables:{jp_bTyp_Major:true},asLoading:["Loading major","Cargando major","Carregando major","Caricamento major"]},jc_tbdctor_Subry:{tbtyp:"Subry",pTypTables:{jp_bTyp_Subry:true},asLoading:["Loading subsidiary","Cargando sucursal","Carregando subsidiária","Caricamento succursale"]}};A3xaDefineDataManager=function(){return jr_o;};return jr_o;}
function A3xaDataManager(ji_oDatabase)
{this.jm_oDatabase=ji_oDatabase;this.jm_odbLoader=null;var jt_this=this;this.IsAvailableDataTableEI=function()
{var jt_ogldtMain=this.jm_oDatabase.Get_DataTable();var jt_ogldtEI=(jt_ogldtMain?jt_ogldtMain.Get_SubTable(A3xaDefineTbid().jc_tbtype_ei.tbtname):null);return(jt_ogldtEI?true:false);};this.RequestDataTableEI=function(ji_fnDone)
{var jt_o3xxur=jg_oApp.Get_MgrPage().Get_3xXUR();var jt_ogldtMain=this.jm_oDatabase.Get_DataTable();var jt_I3tbid=A3xaTbid();var jt_glid_ei=jt_I3tbid.makeByType(jt_ogldtMain.Get_Glid(),A3xaDefineTbid().jc_tbtype_ei);var jt_bdt=false;var jt_Itbtn=A3xaTbtnames([A3xaDefineTbid().jc_tbtype_ei.tbtname]);if(jt_I3tbid.isEnterprise())
{if(!(jt_o3xxur.IsGold()||jt_o3xxur.IsSilver()))
{var jt_pisdsRecord_glidtoc=this.jm_oDatabase.Get_TOCItem(jt_glid_ei);if(jt_pisdsRecord_glidtoc)
{return this.ManageData2({fnDone:ji_fnDone,bLoadEnterprise:true,Itbtn:jt_Itbtn});}}
return this._ManageNewDataRequest(jt_o3xxur,ji_fnDone,jt_Itbtn);}
if(jt_I3tbid.isGeoCity())
{var jt_pisdsRecord_glidtoc=this.jm_oDatabase.Get_TOCItem(jt_glid_ei);if(!jt_pisdsRecord_glidtoc)
{var jr_b=A3xaAjaxTables().requestCities(function(ji_bSuccess,ji_o3xxur,ji_Itbtn)
{if(ji_bSuccess)
{if(!jt_this._LoadCacheStoreCommon(GLIDR(A3xaDefineTbid().jc_GGLID_GeoCity),jt_Itbtn))
return false;jt_this._DatabaseLoadCommon(function(ji_bSuccess)
{if(ji_bSuccess)
ji_fnDone(new GLDataStatusLoadSuccess());else
ji_fnDone(new GLDataStatusLoadFail());},null,jt_Itbtn);if(!jg_oApp.Get_WebbotName())
{jt_this._ManageDataStoreAll(function(ji_bSuccess)
{return true;},jt_o3xxur,jt_Itbtn);}}},null,jt_Itbtn);}
else
{jt_this._DatabaseLoadCommon(function(ji_bSuccess)
{if(ji_bSuccess)
ji_fnDone(new GLDataStatusLoadSuccess());else
ji_fnDone(new GLDataStatusLoadFail());},null,jt_Itbtn);}
return true;}
return false;};this.RequestXURData=function(ji_o3xXUR,ji_fnDone)
{var jt_bdt=false;var jt_I3tbid=A3xaTbid();var jt_glidtoc=jt_I3tbid.makeByXEID(ji_o3xXUR);var jt_oxeidXUR=ji_o3xXUR.Get_3xXEID();var jt_bEnterprise=(!jt_oxeidXUR.Get_TypEntity()||jt_oxeidXUR.Get_TypEntity()==jg_oe.jc_oEntity.jc_Typ_Enterprise);var jt_bSilver=ji_o3xXUR.IsSilver();var jt_bGold=ji_o3xXUR.IsGold();var jt_Ucat=jt_oxeidXUR.Get_3xCat2().Get_Ucat();var jt_Vcat=jt_oxeidXUR.Get_3xCat2().Get_Vcat();if(jt_I3tbid.isEnterprise())
{if(jt_bGold||jt_bSilver)
{}
else if(jt_glidtoc)
{var jt_pisdsRecord_glidtoc=this.jm_oDatabase.Get_TOCItem(jt_glidtoc);if(jt_pisdsRecord_glidtoc)
jt_bdt=true;}
else if(jg_oApp.Get_MgrPage().Get_3xXUR().Matches(ji_o3xXUR,true)&&this.jm_oDatabase.Get_DataTable())
jt_bdt=true;}
else if(jt_glidtoc&&this.jm_oDatabase.Get_DataTable(jt_glidtoc))
jt_bdt=true;var jt_Itbtn=null;if(ji_o3xXUR.IsMultiple())
jt_Itbtn=A3xaTbtnames([A3xaDefineTbid().jc_tbtype_eid.tbtname,A3xaDefineTbid().jc_tbtype_ebis.tbtname,A3xaDefineTbid().jc_tbtype_ebid.tbtname]);if(!jt_bdt)
{this._ManageNewDataRequest(ji_o3xXUR,ji_fnDone,jt_Itbtn);return true;}
jg_oApp.Get_MgrPage().Set_3xXUR(ji_o3xXUR);jg_oApp.ResetApp();this.ManageData2({fnDone:ji_fnDone,bLoadEnterprise:true,Itbtn:jt_Itbtn});return true;};this._ManageNewDataRequest=function(ji_o3xxurNew,ji_fnDone,ji_Itbtn)
{jt_this._ManageDataRequest(function(ji_bSuccess)
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("begin"+"","","A3xaDataManager._ManageDataRequest");if(ji_bSuccess)
{if($.isEmptyObject(ji_Itbtn)||ji_Itbtn.hasEID())
{jg_oApp.ResetApp();jt_this.jm_oDatabase.ClearArrayDTLoad({jp_bTyp_Gold:true,jp_bTyp_Silver:true,jp_bTyp_Main:true,jp_bTyp_Unique:true,jp_bTyp_Major:true,jp_bTyp_Subry:true});}
jt_this.ManageData2({fnDone:ji_fnDone,bLoadEnterprise:true,bStoreAll:true,Itbtn:ji_Itbtn});}
return true;},ji_o3xxurNew,false,false,ji_Itbtn);return true;};this.ManageData2=function(ji_oParams)
{var jt_o3xxur=jg_oApp.Get_MgrPage().Get_3xXUR();var jt_oxeidXUR=jt_o3xxur.Get_3xXEID();var jt_bEnterprise=(!jt_oxeidXUR.Get_TypEntity()||jt_oxeidXUR.Get_TypEntity()==jg_oe.jc_oEntity.jc_Typ_Enterprise);var jt_ItbtnCommon=A3xaTbtnames([A3xaDefineTbid().jc_tbtype_eid.tbtname,A3xaDefineTbid().jc_tbtype_ebis.tbtname,A3xaDefineTbid().jc_tbtype_ebid.tbtname]);var jt_fnThatsAllFolks=function(ji_oDTStatus)
{if(ji_oParams.fnDone)
ji_oParams.fnDone(ji_oDTStatus);return true;};var jt_fnOnLoadEnterprisesDone=function(ji_oDTStatus)
{var jr_b=false;if(ji_oParams.bStoreAll&&!jg_oApp.Get_WebbotName()&&ji_oDTStatus&&ji_oDTStatus.IsSuccessOrEmpty())
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("begin _ManageDataStoreAll"+"","jt_fnOnLoadEnterprisesDone","A3xaDataManager.ManageData2");jr_b=jt_this._ManageDataStoreAll(function(ji_bSuccess)
...
{if(!ji_bSuccess)
return jt_fnThatsAllFolks(new GLDataStatusLoadFail());if(ji_oParams.bLoadEnterprise&&jt_bEnterprise)
{return jt_this._ManageDataLoadEnterprises(jt_fnOnLoadEnterprisesDone,jt_o3xxur,ji_oParams.Itbtn)}
return jt_fnOnLoadEnterprisesDone(new GLDataStatusLoadSuccess());};var jt_fnOnLoadTOCDone=function(ji_bSuccess)
{if(!ji_bSuccess)
{return jt_fnThatsAllFolks(new GLDataStatusLoadFail());}
if(!ji_oParams.bLoadCommon)
{return jt_fnOnLoadCommon2Done(true);}
var jt_IarDTLCommon=jt_this.jm_oDatabase.Get_IArrayDTLoad({jp_bTyp_Common:true});if(jt_IarDTLCommon&&jt_IarDTLCommon.Iar().getCount()>0)
{return jt_this._ManageDataRequest(jt_fnOnLoadCommon2Done,jt_o3xxur,true,ji_oParams.bPreloaded,ji_oParams.Itbtn);}
var jt_pisdsRecord_glidtoc=jt_this.jm_oDatabase.Get_TOCItem(GLIDR(A3xaDefineTbid().jc_GGLID_MetaSystemControl));if(!jt_pisdsRecord_glidtoc)
{if(!jt_this._LoadCacheStoreCommon(null,jt_ItbtnCommon))
return jt_fnThatsAllFolks(new GLDataStatusLoadFail());return jt_this._ManageDataRequest(jt_fnOnLoadCommon2Done,jt_o3xxur,true,ji_oParams.bPreloaded,ji_oParams.Itbtn);}
jt_this._DatabaseLoadCommon(function(ji_bSuccess)
{if(!ji_bSuccess)
{if(!jt_this._LoadCacheStoreCommon(null,jt_ItbtnCommon))
return jt_fnThatsAllFolks(new GLDataStatusLoadFail());}
return jt_this._ManageDataRequest(jt_fnOnLoadCommon2Done,jt_o3xxur,true,ji_oParams.bPreloaded,ji_oParams.Itbtn);},null,jt_ItbtnCommon);};if(ji_oParams.bLoadTOC)
{jt_this._DatabaseLoadTOC(jt_fnOnLoadTOCDone);}
else
{jt_fnOnLoadTOCDone(true);}
return true;};this._ManageDataRequest=function(ji_fnRequestDone,ji_o3xxur,ji_bAlsoLoadCommon,ji_bPreloaded,ji_Itbtn)
{var jt_oxeidXUR=ji_o3xxur.Get_3xXEID();var jt_bEnterprise=(!jt_oxeidXUR.Get_TypEntity()||jt_oxeidXUR.Get_TypEntity()==jg_oe.jc_oEntity.jc_Typ_Enterprise);var jt_ItbtnCommon=A3xaTbtnames([A3xaDefineTbid().jc_tbtype_eid.tbtname,A3xaDefineTbid().jc_tbtype_ebis.tbtname,A3xaDefineTbid().jc_tbtype_ebid.tbtname]);if(jt_bEnterprise)
{var jt_oglPreloadedData=null;if(ji_bPreloaded)
jt_oglPreloadedData=jg_oApp.Get_GLPreloadedData();if(!jQuery.isEmptyObject(jt_oglPreloadedData))
{var jt_bSuccess=false;var jt_o3x3dtslice=A3xaDataTableSlice(A3xaDataSourceGLRSPool(jt_oglPreloadedData),ji_o3xxur);jt_o3x3dtslice.enableTables2(ji_Itbtn);if(jt_o3x3dtslice.writeGLRS2All())
jt_bSuccess=true;if(ji_bAlsoLoadCommon)
return(jt_bSuccess?jt_this._DatabaseLoadCommon(ji_fnRequestDone,null,jt_ItbtnCommon):(ji_fnRequestDone?ji_fnRequestDone(false):false));return(ji_fnRequestDone?ji_fnRequestDone(jt_bSuccess):jt_bSuccess);}
else
{var jr_b=A3xaAjaxTables().requestMain(function(ji_bSuccess)
{if(ji_bAlsoLoadCommon)
return(ji_bSuccess?jt_this._DatabaseLoadCommon(ji_fnRequestDone,null,jt_ItbtnCommon):(ji_fnRequestDone?ji_fnRequestDone(false):false));return(ji_fnRequestDone?ji_fnRequestDone(ji_bSuccess):ji_bSuccess);},ji_o3xxur,ji_Itbtn);}
return jr_b;}
if(ji_bAlsoLoadCommon)
return jt_this._DatabaseLoadCommon(ji_fnRequestDone,null,jt_ItbtnCommon);return(ji_fnRequestDone?ji_fnRequestDone(true):true);};this._ManageDataLoadEnterprises=function(ji_fnOnLoadEnterprisesDone,ji_o3xxur,ji_Itbtn)
...
return jt_this._DatabaseLoadSlice(ji_fnOnLoadEnterprisesDone,A3xaDefineDataManager().jc_tbdctor_Silver,ji_Itbtn);if(jt_bGold)
return jt_this._DatabaseLoadSlice(ji_fnOnLoadEnterprisesDone,A3xaDefineDataManager().jc_tbdctor_Gold,ji_Itbtn);return jt_this._DatabaseLoadSlice(function(ji_oDTStatus)
{if(ji_oDTStatus&&ji_oDTStatus.IsSuccessOrEmpty()&&(jt_bUnlimited||jt_bSingle))
return jt_this._DatabaseLoadSlice(jt_fnOnLoadUniqueDone,A3xaDefineDataManager().jc_tbdctor_Unique,ji_Itbtn);return ji_fnOnLoadEnterprisesDone(ji_oDTStatus);},A3xaDefineDataManager().jc_tbdctor_Main,ji_Itbtn);};this._ManageDataStoreAll=function(ji_fnOnStoreAllDone,ji_o3xxur,ji_Itbtn)
...
{if(ji_bSuccess)
return jt_this._StoreTOC(ji_fnOnStoreAllDone);return ji_fnOnStoreAllDone(false);});}},10);return true;};this._LoadCacheStoreCommon=function(ji_glid,ji_Itbtn)
{var jr_b=false;var jt_odb=this.jm_oDatabase;if(!jt_odb)
return false;var jt_o3x2sdsdb=jt_odb.Get_SDSDBStore();if(!jt_o3x2sdsdb)
return false;try
{jr_b=true;if(jr_b)
jr_b=jt_o3x2sdsdb.db.addTablesJSDS({jp_bTyp_Common:true},ji_glid,ji_Itbtn);if(ji_glid==null)
{if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(GLIDR(A3xaDefineTbid().jc_GGLID_MetaSystemControl),null,"");if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(GLIDR(A3xaDefineTbid().jc_GGLID_Category),null,"");if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(GLIDR(A3xaDefineTbid().jc_GGLID_GeoTopArea),null,"");if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(GLIDR(A3xaDefineTbid().jc_GGLID_GeoArea),null,"");if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(GLIDR(A3xaDefineTbid().jc_GGLID_GeoRegion),null,"");if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(GLIDR(A3xaDefineTbid().jc_GGLID_GeoCountry),null,"");if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(GLIDR(A3xaDefineTbid().jc_GGLID_GeoState),null,"");}
if(ji_glid==null||ji_glid==GLIDR(A3xaDefineTbid().jc_GGLID_GeoCity))
{if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(GLIDR(A3xaDefineTbid().jc_GGLID_GeoCity),null,"",ji_Itbtn);}}
catch(e)
{jr_b=false;jg_oe.ExceptionMessage(e,"DataManager.WriteLocalStorage");}
return jr_b;};this._DatabaseLoadSlice=function(ji_fnOnDone,ji_tbdctor,ji_Itbtn)
...
jt_bLoadTOCempty=false;var jt_odtTOC=null;var jt_glid=A3xaDefineTbid().jc_GLID_TOC;var jt_I3tbid=A3xaTbid(jt_glid);var jt_tbtype=jt_I3tbid.getTbType();var jt_keyname=(jt_tbtype?jt_tbtype.tbtkeyname:"");if(jt_bLoadTOCempty)
...
return true;}
return true;},this.jm_oDatabase);this.jm_odbLoader.LoadTables({jp_bTyp_TOC:true},true);return true;};this._StoreData=function(ji_fnOnDone)
...
return true;}
this.jm_oDatabase.StoreTOC(true);return true;};this._DatabaseLoadCommon=function(ji_fnOnDone,ji_dummy,ji_Itbtn)
...
{if(ji_fnOnDone)
{if(ji_oDTStatus.IsFail())
return ji_fnOnDone(false);if(ji_oDTStatus.IsOpLoad()&&ji_oDTStatus.IsSuccessOrEmpty()&&jt_this.jm_odbLoader.IsTable({jp_bTyp_Common:true}))
return ji_fnOnDone(true);}
return true;},this.jm_oDatabase);this.jm_odbLoader.LoadTables({jp_bTyp_Common:true},false,ji_Itbtn);return true;};}
...
{if(this.jm_pTypTables.jp_bTyp_TOC&&ji_pTypTables.jp_bTyp_TOC)
return true;if(this.jm_pTypTables.jp_bTyp_Common&&ji_pTypTables.jp_bTyp_Common)
return true;if(this.jm_pTypTables.jp_bTyp_Gold&&ji_pTypTables.jp_bTyp_Gold)
return true;if(this.jm_pTypTables.jp_bTyp_Silver&&ji_pTypTables.jp_bTyp_Silver)
return true;if(this.jm_pTypTables.jp_bTyp_Main&&ji_pTypTables.jp_bTyp_Main)
return true;if(this.jm_pTypTables.jp_bTyp_Unique&&ji_pTypTables.jp_bTyp_Unique)
return true;if(this.jm_pTypTables.jp_bTyp_Major&&ji_pTypTables.jp_bTyp_Major)
return true;if(this.jm_pTypTables.jp_bTyp_Subry&&ji_pTypTables.jp_bTyp_Subry)
...
this.jm_oDatabase.ClearArrayDTLoad(this.jm_pTypTables);var jt_ogtl=this._Get_GlidsToLoad_SLICE(ji_Itbtn);if(!jt_ogtl)
...
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("call _SetupLoadedRecords()","","A3xaDbLoader.LoadTables");this._SetupLoadedRecords(ji_Itbtn);this.jm_oDTStatus.SetFrom(new GLDataStatusLoadSuccess());}
else
...
return ji_oDTStatusEnd;jg_oe.CanLogInfo()&&jg_oe.LogInfo("call _SetupLoadedRecords()","","A3xaDbLoader._OnEnd");this._SetupLoadedRecords(this.jm_Itbtn);jg_oe.CanLogInfo()&&jg_oe.LogInfo("Callback: "+
...
{var jt_sTableNameQUR=null;if(this.IsTable(jt_oSchemaTable))
{var jt_I3tbid=A3xaTbid(jt_oSchemaTable.jp_sName);var jt_sTableNameQUR=(jt_I3tbid.default2GlidXEID(jg_oApp.Get_MgrPage().Get_3xXUR())||"");if(jt_sTableNameQUR&&this._IsGlidToLoad_(jt_I3tbid,ji_Itbtn))
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("jt_sTableNameQUR: "+
jt_sTableNameQUR,"","A3xaDbLOader._Get_GlidsToLoad_SLICE");jr_aGlidToLoad.push(jt_sTableNameQUR);}}
jt_posTable++;jt_oSchemaTable=this.jm_oDatabase.jm_oDbSchema.Get_Table_ByIndex(jt_posTable);}
jr_ogtl.jarr=jr_aGlidToLoad;jr_ogtl.jbsuccess=true;return jr_ogtl;};this._IsGlidToLoad_=function(ji_I3tbid,ji_Itbtn)
{return($.isEmptyObject(ji_Itbtn)||(!ji_I3tbid.isEnterprise()&&!ji_I3tbid.isGeoCity())||(ji_Itbtn.hasEID()&&ji_I3tbid.isEID())||(ji_Itbtn.hasEBIS()&&ji_I3tbid.isEBIS())||(ji_Itbtn.hasEBID()&&ji_I3tbid.isEBID())||(ji_Itbtn.hasEI()&&ji_I3tbid.isEI()));};this._MoveStore2Load=function(ji_aGlidToLoad)
{if(!ji_aGlidToLoad)
return null;var jt_odbsds=this.jm_oDatabase.Get_SDSDBStore();var jt_odbsdswk=this.jm_oDatabase.Get_SDSDBWork();var jt_aodtToLoad=this.jm_oDatabase.Get_IArrayDTLoad(this.jm_pTypTables);var jr_aGlidToLoad=[];var jt_IArray_dtcs=this.jm_oDatabase.Get_IArrayDTStore();for(var i=0;i<ji_aGlidToLoad.length;i++)
...
jt_odtToReuse=jt_IArray_dtcs.getItem(jt_glidToReuse);else if(this.IsTable({jp_bTyp_Subry:true}))
{var jt_I3xtbid=A3xaTbid(jt_glid);var jt_I3xtbidToReuse=A3xaTbid(jt_glidToReuse);if(jt_I3xtbid.isSliceSubsidiary()&&jt_I3xtbidToReuse.isSliceSubsidiary()&&jt_I3xtbid.getLeadch()==jt_I3xtbidToReuse.getLeadch())
{jt_odtToReuse=jt_IArray_dtcs.getItem(jt_glidToReuse);}}
if(!jt_odtToReuse)
continue;jt_bFound_dtcs=true;if(!(this.IsTable({jp_bTyp_TOC:true})))
...
{jt_odtToReuse=null;jt_o3xtbsds=null;}}}
if(jt_odtToReuse)
{jt_odtToReuse.jm_oDTStatus=new GLDataStatusLoadSuccess();jt_aodtToLoad.setItem(jt_glidToReuse,jt_odtToReuse);jg_oe.CanLogInfo()&&jg_oe.LogInfo("jt_glidToReuse,jt_odtToReuse="+jt_glidToReuse+","+jt_odtToReuse,"","A3xaDbLoader._MoveStore2Load");}
else
...
{var jt_glid=ji_aGlidToLoad[i];var jt_odtToReuse=null;var jt_o3xtbsds=null;if(this.IsTable({jp_bTyp_Common:true}))
...
{jr_aGlidToLoad.push(jt_glid);}}
return jr_aGlidToLoad;};this._SetupLoadedRecords=function(ji_Itbtn)
{if(this.jm_bSetupLoadedRecords)
return true;this.jm_bSetupLoadedRecords=true;var jt_o3xxurxeid=jg_oApp.Get_MgrPage().Get_3xXUR().Get_3xXEID();for(var i=0;i<this.jm_oDatabase.jm_oDbSchema.jm_aTables.length;i++)
{var jt_oSchemaTable=this.jm_oDatabase.jm_oDbSchema.Get_Table_ByIndex(i);if(!jt_oSchemaTable)
{continue;}
var jt_I3tbid=A3xaTbid(jt_oSchemaTable.jp_sName);var jt_sTableNameQUR=(jt_I3tbid.default2GlidXEID(jt_o3xxurxeid)||"");if(!(jt_sTableNameQUR&&this._IsGlidToLoad_(jt_I3tbid,ji_Itbtn)))
{continue;}
var jt_sTableParentQUR=(jt_oSchemaTable.jp_sParent?(A3xaTbid(jt_oSchemaTable.jp_sParent).default2GlidXEID(jt_o3xxurxeid)||""):"");var jt_IArray_dtl=this.jm_oDatabase.Get_IArrayDTLoad(this.jm_pTypTables);jg_oe.CanLogInfo()&&jg_oe.LogInfo("jt_sTableNameQUR,jt_oSchemaTable.jp_sName,jt_IArray_dtl.getCount(): "+
jt_sTableNameQUR+","+jt_oSchemaTable.jp_sName+","+(jt_IArray_dtl?jt_IArray_dtl.getCount():"null"),"","A3xaDbLOader._SetupLoadedRecords");for(var jt_ixdtl=0;jt_IArray_dtl&&jt_ixdtl<jt_IArray_dtl.getCount();jt_ixdtl++)
{var jt_gliddtl=jt_IArray_dtl.getKey(jt_ixdtl);var jt_gliddtlParent=jt_sTableParentQUR;var jt_odt=null;var jt_odtParent=null;if(jt_gliddtl==jt_sTableNameQUR);else if(this.IsTable({jp_bTyp_Subry:true}))
{var jt_I3xtbid=A3xaTbid(jt_sTableNameQUR);var jt_I3xtbiddtl=A3xaTbid(jt_gliddtl);if(!(jt_I3xtbid.isSliceSubsidiary()&&jt_I3xtbiddtl.isSliceSubsidiary()&&jt_I3xtbid.getLeadch()==jt_I3xtbiddtl.getLeadch()))
{jt_gliddtl="";}
else if(jt_gliddtlParent)
jt_gliddtlParent=A3xaTbid(jt_gliddtlParent).replaceExtension(jt_I3xtbiddtl.getExtension());}
else
continue;if(jt_gliddtl)
{jt_odt=jt_IArray_dtl.getItem(jt_gliddtl);jg_oe.CanLogInfo()&&jg_oe.LogInfo("jt_gliddtl,jt_gliddtlParent,jt_odt.Get_Glid(),jt_odt: "+
jt_gliddtl+","+jt_gliddtlParent+","+(jt_odt?jt_odt.Get_Glid():"-")+","+jt_odt,"","A3xaDbLOader._SetupLoadedRecords");if(jt_gliddtlParent)
...
{}}}}
return true;};} function A3xaDefines_Storage()
...
{var jt_oSTG=jt_aSchemaTableGroups.getItem_ByIndex(i);if(jt_oSTG&&jt_oSTG.jp_sGroupName&&jt_oSTG.jp_sKeyName)
...
{if(!ji_sep)
ji_sep=",";if(!ji_s)
return false;return this.Set_Array(ji_s.split(ji_sep),0)>=0?true:false;};this.Get_AZNMUV=function()
{var jr_s="";var jt_o3xaznmc=this.Get_3xAZNMC2();var jt_o3xcat=this.Get_3xCat2();jr_s+=(jt_o3xaznmc.Get_A()||"0");jr_s+=(jt_o3xaznmc.Get_Z()||"0");jr_s+=(jt_o3xaznmc.Get_N()||"0");jr_s+=(jt_o3xaznmc.Get_M()||"0");jr_s+=(jt_o3xcat.Get_Ucat()||"0");jr_s+=(jt_o3xcat.Get_Vcat()||"0");return jr_s;};this.Get_CompactCode=function()
...
jt_s=this.Get_3xEBIS().Get_Descr();return new A3xaString([jt_s,jt_s,jt_s,jt_s]);};this.Get_LDescr=function(){return this.Get_3xsDescr().Get_LString();};this.LinkCommonData=function(ji_odb){return false;};this.Get_CommonLinkedRecord=function(ji_TypEntity){return null;};} function A3xaIStaticDataSource_TableEntity()
{var jr_I={};return jr_I;}
function A3xaISDS_DbEntity()
{var jr_I={};return jr_I;}
function A3xaStaticDataSource_TableEntity(ji_sdsTable,ji_bJSON)
{var jr_o=A3xaStaticDataSource_Table(ji_sdsTable,ji_bJSON);jr_o.tb._tbeparent_buildTableIndex=jr_o.tb.buildTableIndex;jr_o.tb.buildTableIndexes=function()
...
{var jr_pisdsKeyMaker=PISDSKeyMaker();jr_pisdsKeyMaker.keyname=ji_keyName;if(jr_o.tb.getType()==A3xaDefineTbid().jc_tbtype_tid.tbtname)
{if(!jr_pisdsKeyMaker.keyname)
jr_pisdsKeyMaker.keyname=A3xaDefineTbid().jc_tbtype_tid.tbtkeyname;jr_pisdsKeyMaker.fnkeymaker=function(ji_pisdsRecord)
...
else if(jr_o.tb.getType()==A3xaDefineTbid().jc_tbtype_eid.tbtname)
{if(!jr_pisdsKeyMaker.keyname)
jr_pisdsKeyMaker.keyname=A3xaDefineTbid().jc_tbtype_eid.tbtkeyname;jr_pisdsKeyMaker.fnkeymaker=function(ji_pisdsRecord)
...
ji_pisdsRecord.iseq=true;return ji_pisdsRecord;};}
else if(jr_o.tb.getType()==A3xaDefineTbid().jc_tbtype_ebis.tbtname)
{if(!jr_pisdsKeyMaker.keyname)
jr_pisdsKeyMaker.keyname=A3xaDefineTbid().jc_tbtype_ebis.tbtkeyname;jr_pisdsKeyMaker.fnkeymaker=function(ji_pisdsRecord)
...
ji_pisdsRecord.iseq=true;return ji_pisdsRecord;};}
else if(jr_o.tb.getType()==A3xaDefineTbid().jc_tbtype_ebid.tbtname)
{if(!jr_pisdsKeyMaker.keyname)
jr_pisdsKeyMaker.keyname=A3xaDefineTbid().jc_tbtype_ebid.tbtkeyname;jr_pisdsKeyMaker.fnkeymaker=function(ji_pisdsRecord)
...
ji_pisdsRecord.key=jt_te+","+jt_ide;if(ji_matchingKey!=null&&ji_matchingKey==ji_pisdsRecord.key)
ji_pisdsRecord.iseq=true;return ji_pisdsRecord;};}
else if(jr_o.tb.getType()==A3xaDefineTbid().jc_tbtype_ei.tbtname)
{if(!jr_pisdsKeyMaker.keyname)
jr_pisdsKeyMaker.keyname=A3xaDefineTbid().jc_tbtype_ei.tbtkeyname;jr_pisdsKeyMaker.fnkeymaker=function(ji_pisdsRecord)
...
function A3xaSDS_DbEntity()
{var jr_o=A3xaStaticDataSource_Db();jr_o.db.setDefaultDbVersion(jg_o3xdbZero.d3x_version);jr_o.db.new3x2Table=function(ji_sdsTable,ji_bJSON){return A3xaStaticDataSource_TableEntity(ji_sdsTable,ji_bJSON);};jr_o._isGlidEnabled_=function(ji_I3tbid,ji_Itbtn)
{return($.isEmptyObject(ji_Itbtn)||(!ji_I3tbid.isEnterprise()&&!ji_I3tbid.isGeoCity())||(ji_Itbtn.hasEID()&&ji_I3tbid.isEID())||(ji_Itbtn.hasEBIS()&&ji_I3tbid.isEBIS())||(ji_Itbtn.hasEBID()&&ji_I3tbid.isEBID())||(ji_Itbtn.hasEI()&&ji_I3tbid.isEI()));};jr_o.db.addTablesJSDS=function(ji_pTypTables,ji_glid,ji_Itbtn)
...
{this.Set_SDSDBStore(A3xaSDS_DbEntity());this.Set_SDSDBWork(A3xaSDS_DbEntity());};this.NewDataTable=function(ji_glid)
{return new GLDTEntity(this,ji_glid);};this.OnDataLoadedSetup=function()
{if(!this._SetupSlices())
return false;return true;};this._SetupSlices=function()
{var jt_this=this;var jt_ogldtMain=this.Get_DataTable();if(!jt_ogldtMain)
return false;jt_ogldtMain.OnDataLoadedSetup();var jt_I3tbid=A3xaTbid(jt_ogldtMain.Get_Glid());if(jt_I3tbid.isEnterprise())
{var jt_glidUnique=GLIDR(A3xaDefineTbid().jc_GGLID_Enterprise,A3xaDefineTbid().jc_tbslice_unique,jt_I3tbid.getExtension());var jt_ogldtMainUnique=this.Get_DataTable(jt_glidUnique);if(jt_ogldtMainUnique)
{jt_ogldtMainUnique.OnDataLoadedSetup();jt_ogldtMain.MergeRecordset(jt_ogldtMainUnique);}
var jt_glidMajor=GLIDR(A3xaDefineTbid().jc_GGLID_Enterprise,A3xaDefineTbid().jc_tbslice_major,jt_I3tbid.getExtension());var jt_ogldtMainMajor=this.Get_DataTable(jt_glidMajor);if(jt_ogldtMainMajor)
{jt_ogldtMainMajor.OnDataLoadedSetup();jt_ogldtMain.MergeRecordset(jt_ogldtMainMajor);}
var jt_glidSubry=GLIDR(A3xaDefineTbid().jc_GGLID_Enterprise,A3xaDefineTbid().jc_tbslice_subry,jt_I3tbid.getExtension());var jt_ogldtMainSubry=this.Get_DataTable(jt_glidSubry);if(jt_ogldtMainSubry)
...
{var jt_glidForeignSubry=jt_I3x3dt_ForeignSubryes.getKey(i);if(jt_glidForeignSubry&&jt_glidForeignSubry!=jt_glidSubry&&A3xaTbid(jt_glidForeignSubry).isEID())
...
jt_ogldtMain.SortByName(false);return true;};this.Get_3xXEMSC_ByXUR=function(ji_bSetup)
{var jr_o3xxeCP=this._Get_3xXEMSC_ByXUR();if(!jr_o3xxeCP)
return null;if(ji_bSetup)
{jr_o3xxeCP.LinkCommonData(this);jr_o3xxeCP.Get_3xEBIS().Set_DefaultColor("FFFFFF");}
return jr_o3xxeCP;};this._Get_3xXEMSC_ByXUR=function()
{var jt_o3xxeidxur=new A3xaXEID();jt_o3xxeidxur.CopyFrom(jg_oApp.Get_MgrPage().Get_3xXUR().Get_3xXEID());var jt_o3xxeidxur_xapp=new A3xaXEID_XApp(jt_o3xxeidxur);var jt_ogldtMSC=this.Get_DataTable(A3xaDefineTbid().GLIDR(A3xaDefineTbid().jc_GGLID_MetaSystemControl));if(!jt_ogldtMSC)
...
return jr_oglrMSC;}
jt_o3xxeidxur=new A3xaXEID();jt_o3xxeidxur.CopyFrom(jg_oApp.Get_MgrPage().Get_3xXUR().Get_3xXEID());jt_o3xxeidxur_xapp=new A3xaXEID_XApp(jt_o3xxeidxur);jt_o3xxeidxur.Get_3xPS2().Clear();if(jt_o3xxeidxur.Get_3xAZNMC2().Get_C())
...
return jr_oglrMSC;}
New_A3xaAZNMC_XApp(jt_o3xxeidxur.Get_3xAZNMC2()).Set_LA();jr_oglrMSC=jt_ogldtMSC.Get_3xDbEntityAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));if(jr_oglrMSC)
return jr_oglrMSC;jt_o3xxeidxur.Get_3xAZNMC2().Clear();jr_oglrMSC=jt_ogldtMSC.Get_3xDbEntityAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));return jr_oglrMSC;};this._A3xaDbZero();} function GLDTEntity(ji_oDatabase,ji_glid)
...
return null;if(jt_oDbSchemaTable.jp_SubTable==A3xaDefineTbid().jc_tbtype_tid.tbtname)
{return new A3xaAbsDbEntity();}
else if(jt_oDbSchemaTable.jp_SubTable==A3xaDefineTbid().jc_tbtype_eid.tbtname||!jt_oDbSchemaTable.jp_sParent)
{return new A3xaREntity(new A3xaXtdEntity());}
else if(jt_oDbSchemaTable.jp_SubTable==A3xaDefineTbid().jc_tbtype_ebis.tbtname)
{return new GLREBIS();}
else if(jt_oDbSchemaTable.jp_SubTable==A3xaDefineTbid().jc_tbtype_ebid.tbtname)
{return new GLREBID();}
else if(jt_oDbSchemaTable.jp_SubTable==A3xaDefineTbid().jc_tbtype_ei.tbtname)
{return new GLREI();}
...
return false;var jt_I3tbid=A3xaTbid(jt_glid);var jt_tbtype=jt_I3tbid.getTbType();if(!jt_tbtype)
...
return false;var jt_a3x2oglr=A3xaArray();var jt_nofrec=jt_o3x2index.ar.getCount();for(var i=0;i<jt_nofrec;i++)
...
{if(this.AlreadySetupLoadedRecords())
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("AlreadySetupLoadedRecords(): Y","","GLDTEntity.SetupLoadedRecords");return true;}
jg_oe.CanLogInfo()&&jg_oe.LogInfo("AlreadySetupLoadedRecords(): N","","GLDTEntity.SetupLoadedRecords");var jt_odb=this.Get_Database();var jt_glid=this.Get_Glid();var jt_oSchemaTable=jt_odb.jm_oDbSchema.Get_Table_ByName(jt_glid);this.SetupSDSRecords(ji_ogldtParent);var jt_oa3xRecordset=this.Get_IRecordset();var jt_aoglrAX=A3xaArray();var jt_nRecords=(jt_oa3xRecordset?jt_oa3xRecordset.getCount():0);if(this.jm_bAX)
...
return false;ji_ogldtParent.Set_SubTable(jt_oSchemaTable.jp_SubTable,this);jg_oe.CanLogInfo()&&jg_oe.LogInfo("jt_nRecords,jp_SubTable,glid,glidparent: "+
jt_nRecords+","+jt_oSchemaTable.jp_SubTable+","+this.Get_Glid()+","+(ji_ogldtParent?ji_ogldtParent.Get_Glid():"null"),"","GLDTEntity.SetupLoadedRecords");for(var irecord=0;irecord<jt_nRecords;irecord++)
...
continue;jg_oe.CanLogInfo()&&jg_oe.LogInfo("jt_oglr.Set_SubDbEntity(jt_id): "+
jt_id,"","GLDTEntity.SetupLoadedRecords");jt_oglr.Set_SubDbEntity(jt_oSchemaTable.jp_SubTable,this.Get_3xDbEntity(jt_id));}}
else
{}
...
(jt_oxe?jt_oxe.Get_3xXEID().Get_CompactCode():"null"),"","GLDTEntity.OnDataLoadedSetup");jt_oxe.LinkCommonData(this.Get_Database());jt_oxe.Get_3xEBIS().Set_DefaultColor("FFFFFF");}
...
{if(!(this.Get_IRecordsel()&&this.Get_IRecordsel().Iar().getCount()>0))
return true;var jt_1=(ji_bDesc?1:-1);this.Get_IRecordsel().Iar().sortItems(function(ji_oglr_a,ji_oglr_b)
{if(ji_oglr_a.Get_3xXEID().Get_TypEntity()==jg_oe.jc_oEntity.jc_Typ_MetaSystemControl)
return-jt_1;if(ji_oglr_b.Get_3xXEID().Get_TypEntity()==jg_oe.jc_oEntity.jc_Typ_MetaSystemControl)
...
return jt_1;if(jt_delta>0)
return-jt_1;return 0;});return true;};} function A3xaAbsDbEntity()
...
return false;return true;};this.Get_3xEBIS=function(){return this.Get_SubDbEntity(A3xaDefineTbid().jc_tbtype_ebis.tbtname);};this.Get_3xEBID=function(){return this.Get_SubDbEntity(A3xaDefineTbid().jc_tbtype_ebid.tbtname);};this.Get_3xEI=function(){return this.Get_SubDbEntity(A3xaDefineTbid().jc_tbtype_ei.tbtname);};this.Get_3xsName=function(){return(this.Get_3xEI()?this.Get_3xEI().Get_3xsName():null);};this.Get_LName=function()
{var jt_o3xs4L=this.Get_3xsName();if(jt_o3xs4L&&jt_o3xs4L.Get_LString())
return jt_o3xs4L.Get_LString();if(this.Get_3xEBIS())
return this.Get_3xEBIS().Get_Name();return"";};this.Get_AName=function()
{var jt_o3xs4L=this.Get_3xsName();if(jt_o3xs4L&&jt_o3xs4L.Get_AString())
return jt_o3xs4L.Get_AString();if(this.Get_3xEBIS())
return[this.Get_3xEBIS().Get_Name(),this.Get_3xEBIS().Get_Name(),this.Get_3xEBIS().Get_Name(),this.Get_3xEBIS().Get_Name()];return[];};this.Get_3xsDescr=function(){return(this.Get_3xEI()?this.Get_3xEI().Get_3xsDescr():null);};this.Get_LDescr=function()
...
function GLREI()
{A3xaAbsDbEntity.call(this,null);this.Get_3xEI=function(){return this;};this.Get_TypEntity=function(){return this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eif_enty);};this.Get_IdEntity=function(){return this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eif_enid);};this.Get_I3x2Info=function(ji_TypInfo,ji_IdInfo)
{var jt_o3x2aeifa_Selected=A3xaArray();var jt_arsInfo=this.Get_FieldArray_Recordset(jg_oe.jc_oA3xaDbZero.jc_sEifaName);jg_oe.CanLogInfo()&&this.Get_TypEntity()=="E"&&jg_oe.LogInfo("te,ide,jt_arsInfo: "+this.Get_TypEntity()+","+this.Get_IdEntity()+","+jt_arsInfo,"","GLREI.Get_I3x2Info");if(!(jt_arsInfo&&jt_arsInfo.length))
...
{var jt_o3x2aeifa_Selected=this.Get_I3x2Info(ji_TypInfo,ji_IdInfo);return jt_o3x2aeifa_Selected?jt_o3x2aeifa_Selected.getArray(null):null;};this.Get_3xsField=function(ji_TypInfo,ji_CodInfo)
{var jt_o3x2aoeifa4L=this.Get_I3x2Info(ji_TypInfo,null);var jt_b=false;var jr_o3xs4L=new A3xaString();for(var i=0;jt_o3x2aoeifa4L&&i<jt_o3x2aoeifa4L.getCount();i++)
...
return"";return jt_o3xs4L.Get_LString();};this.Get_AName=function()
{var jt_o3xs4L=this.Get_3xsName();if(!jt_o3xs4L)
return[];return jt_o3xs4L.Get_AString();};this.Get_3xsDescr=function()
...
return"";return jt_o3xs4L.Get_LString();};} function A3xaXtdEntity()
...
{if(!ji_odb)
return false;var jt_TypEntity=this.Get_3xXEID().Get_TypEntity();var jt_oThis3xxeid_xapp=new A3xaXEID_XApp(this);var jt_oglrCategory=null;var jt_ogldtCategory=null;{jt_ogldtCategory=ji_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_Category));if(jt_ogldtCategory)
{jt_oglrCategory=jt_ogldtCategory.Get_3xDbEntityAX(jt_oThis3xxeid_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_Category));}}
var jt_oglrGeoTopArea=null;var jt_oglrGeoArea=null;var jt_oglrGeoRegion=null;var jt_oglrGeoCity=null;var jt_oglrGeoCountry=null;var jt_oglrGeoState=null;var jt_ogldtGeoTopArea=null;var jt_ogldtGeoArea=null;var jt_ogldtGeoRegion=null;var jt_ogldtGeoCity=null;var jt_ogldtGeoCountry=null;var jt_ogldtGeoState=null;jt_ogldtGeoTopArea=ji_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoTopArea));jt_ogldtGeoArea=ji_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoArea));if(jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoTopArea&&jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoArea)
jt_ogldtGeoRegion=ji_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoRegion));if(jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoTopArea&&jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoArea&&jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoRegion)
jt_ogldtGeoCity=ji_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoCity));if(jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoTopArea&&jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoArea&&jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoRegion)
jt_ogldtGeoCountry=ji_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoCountry));if(jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoTopArea&&jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoArea&&jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoRegion&&jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoCountry)
jt_ogldtGeoState=ji_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoState));if(jt_ogldtGeoTopArea)
...
if(ji_oxp.form)
this.jm_FormName=ji_oxp.form;if(ji_oxp.tar)
this.jm_TypAjaxResponse=ji_oxp.tar;if(ji_oxp.qur)
this.jm_QUR=ji_oxp.qur;if(ji_oxp.single)
this.jm_Single=ji_oxp.single;if(ji_oxp.subenty)
this.jm_SubEntity=ji_oxp.subenty;if(ji_oxp.o3xxeid)
this.Get_3xXEID().CopyFrom(ji_oxp.o3xxeid);return true;};this.MakeXur=function(ji_o3xxeid)
{if(!ji_o3xxeid)
return false;var jt_o3xxeid=new A3xaXEID();jt_o3xxeid.CopyFrom(ji_o3xxeid);var jt_qur=jg_oe.jc_oXUR.jc_QUR_QuerySBS;var jt_single=jg_oe.jc_oXUR.jc_XURTG_Limited;var jt_subenty=jg_oe.jc_oXUR.jc_XURTG_Master;var jt_te=jt_o3xxeid.Get_TypEntity();if(jt_o3xxeid.Get_3xCat2()&&jt_o3xxeid.Get_3xCat2().Get_Ucat())
...
this.Set_XurParams({qur:jt_qur,single:jt_single,subenty:jt_subenty,o3xxeid:jt_o3xxeid});return true;};this.Get_XURCC=function()
{if(!this.IsValid())
return"";var jt_sxeidcc=this.Get_3xXEID().Get_CompactCode();if(!jt_sxeidcc)
return"";var jr_s="X3"+(this.jm_FormName||"00")+"0"+
...
jt_QUR=null;jt_cursor+=1;this.jm_FormName=jt_FN;this.jm_TypAjaxResponse=jt_TAR;this.jm_Single=jt_Single;this.jm_SubEntity=jt_SubEntity;this.jm_QUR=jt_QUR;if(!this.Get_3xXEID().Set_CompactCode(ji_scc.substring(jt_cursor)))
...
jr_oQueryOrderby_Icon=jt_odfic.jc_oIconMS_QueryOrderby_Latest;else if(this.IsSortByClick());else if(this.IsSortByName());else if(this.IsSortByLatestClick());return jr_oQueryOrderby_Icon;};this.Set_XUDParams=function(ji_sEnterprise,ji_sCategory,ji_sCity,ji_sState,ji_sCountry,ji_sRegion,ji_sArea)
{if(ji_sEnterprise)
...
return"Update";}
return this.jm_QUR+"_unknown";};this.LinkMainData=function(ji_odb)
{if(!ji_odb)
...
{this.jm_FormName=jg_oe.jc_oXUR.jc_XURFN_AjaxEntity;var jt_sxur=this.Get_XURCC();jr_oUrl=new A3xaUrl(jg_oe.jc_oXUR.jc_sUrlBase_A3xaFormDDAJOO+jt_sxur,"");}
else
{var jt_sxur=this.Get_XURCC();var jt_xud=(ji_bAppendDescrParam===true?this.Get_XUDString2("encode","/"):"");jr_oUrl=new A3xaUrl(jg_oe.jc_oXUR.jc_sUrlBase_A3xaFormDDAJOO+
(jt_xud?jt_xud+"/":"")+jt_sxur+"/","");}
if(!jt_sxur)
...
{var jr_o={jm_Iar_IArrayCommon:A3xaArray(),jm_TypEntity:"",jm_TypEntityStrength:0,ar:A3xaIArray2(),ds:A3xaIDataSourceCommon(),};jr_o.ar.Iar=function(){return jr_o.ar;};jr_o.ar.Ids=function(){return jr_o.ds;};jr_o.ds.Iar=function(){return jr_o.ar;};jr_o.ds.Ids=function(){return jr_o.ds;};jr_o.ds.addTopAreas=function(ji_IArray_TopArea,ji_IArrayAX_TopArea)
...
return false;var jt_ogldt=jt_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoTopArea));if(!jt_ogldt)
return false;return jr_o.ds.addTopAreas(jt_ogldt.Get_IRecordset(),jt_ogldt.Get_IRecordsetAX());};jr_o.ds.addTableAreas=function()
{var jt_odb=jg_oApp.Get_Database();if(!jt_odb)
return false;var jt_ogldt=jt_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoArea));if(!jt_ogldt)
return false;return jr_o.ds.addAreas(jt_ogldt.Get_IRecordset(),jt_ogldt.Get_IRecordsetAX());};jr_o.ds.addTableRegions=function()
{var jt_odb=jg_oApp.Get_Database();if(!jt_odb)
return false;var jt_ogldt=jt_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoRegion));if(!jt_ogldt)
...
{var jt_odb=jg_oApp.Get_Database();if(!jt_odb)
return false;var jt_ogldt=jt_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoMicroRegion));if(!jt_ogldt)
...
{var jt_odb=jg_oApp.Get_Database();if(!jt_odb)
return false;var jt_ogldt=jt_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoCity));if(!jt_ogldt)
...
{var jt_odb=jg_oApp.Get_Database();if(!jt_odb)
return false;var jt_ogldt=jt_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoCountry));if(!jt_ogldt)
...
{var jt_odb=jg_oApp.Get_Database();if(!jt_odb)
return false;var jt_ogldt=jt_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoState));if(!jt_ogldt)
return false;return jr_o.ds.addStates(jt_ogldt.Get_IRecordset(),jt_ogldt.Get_IRecordsetAX());};jr_o.ds.addTableUcats=function()
{var jt_odb=jg_oApp.Get_Database();if(!jt_odb)
return false;var jt_ogldt=jt_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_Category));if(!jt_ogldt)
return false;var jt_fnU=function(ji_axkey,ji_oglr)
{var jt_o3xuv=(ji_oglr?ji_oglr.Get_3xXEID().Get_3xCat2():null);return((jt_o3xuv&&!jt_o3xuv.Get_Vcat())?1:0);};var jt_o3x2FilterUcatAX=A3xaArrayIt(jt_ogldt.Get_IRecordsetAX());jt_o3x2FilterUcatAX.selectItems(jt_fnU);var jt_o3x2FilterUcat=A3xaArrayIt(jt_ogldt.Get_IRecordset());jt_o3x2FilterUcat.selectItems(jt_fnU);return jr_o.ds.addUcats(jt_o3x2FilterUcat.Iar(),jt_o3x2FilterUcatAX.Iar());};jr_o.ds.addTableUVcats=function()
{var jt_odb=jg_oApp.Get_Database();if(!jt_odb)
return false;var jt_ogldt=jt_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_Category));if(!jt_ogldt)
return false;var jt_fnUV=function(ji_axkey,ji_oglr)
{var jt_o3xuv=(ji_oglr?ji_oglr.Get_3xXEID().Get_3xCat2():null);return((jt_o3xuv&&jt_o3xuv.Get_Vcat())?1:0);};var jt_o3x2FilterUVcatAX=A3xaArrayIt(jt_ogldt.Get_IRecordsetAX());jt_o3x2FilterUVcatAX.selectItems(jt_fnUV);var jt_o3x2FilterUVcat=A3xaArrayIt(jt_ogldt.Get_IRecordset());jt_o3x2FilterUVcat.selectItems(jt_fnUV);return jr_o.ds.addUVcats(jt_o3x2FilterUVcat.Iar(),jt_o3x2FilterUVcatAX.Iar());};jr_o.ds.selectCommonTyp=function(ji_TypEntity)
...
{var jr_o={jm_IArray_dsCommon:ji_IArray_dsCommon,jm_bChainAZDescr:(ji_bChainAZDescr===false?false:true),jm_sChainDescrSep:(ji_sep?ji_sep:" - "),jm_bChainName:true,ar:A3xaIArray2(),};jr_o.ar.getCount=function(){return jr_o.jm_IArray_dsCommon.getCount();};jr_o.ar.getKey=function(ji_ix){return jr_o.jm_IArray_dsCommon.getKey(ji_ix);};jr_o.ar.getItem=function(ji_keyAX)
...
return jr_sDescr;};return jr_o.ar;} function A3xaDefines_AppLogger()
...
{jr_o.jm_bHostConnected=false;jr_o.jm_bHostError=true;jr_o.jm_bReset=false;}});return true;};jr_o.ck._onTick();jr_o.jm_oTimerTick=setInterval(function(){jr_o.ck._onTick();},jr_o.jm_tickSec*1000);return jr_o;} function A3xaDefines_XUR()
...
{this.jc_surlVideoYoutube="https://www.youtube.com/watch?v=";this.jc_surlVideoVimeo="https://www.vimeo.com/";this.jc_surlGoogleMap="https://www.google.com/maps?";this.jc_surlEmbedVideoYoutube="https://www.youtube.com/embed/";this.jc_surlEmbedVideoVimeo="https://player.vimeo.com/video/";this.jc_surlRelHomeDirDDAJOO_LA="X3LE0000L0SA0E0M0A00000000000";this.jc_surlRelHomeDirDDAJOO_YB="X3LE0000N0SA0E0M0AYB000000000";this.Get_PathJSDB=function(ji_oTypeJSDB)
{var jr_ao=[];if(!ji_oTypeJSDB)
return null;var jt_tbtnames=ji_oTypeJSDB.tbtnames;if(!(jt_tbtnames&&jt_tbtnames.length>0))
jt_tbtnames=["t3x_eid","t3x_ebis","t3x_ebid","t3x_ei"];for(var i=0;i<jt_tbtnames.length;i++)
{var jt_tbtname=jt_tbtnames[i];var jt_tbtnamePfxless="";if(!(jt_tbtname=="t3x_eid"||jt_tbtname=="t3x_ebis"||jt_tbtname=="t3x_ebid"||jt_tbtname=="t3x_ei"))
continue;if(jt_tbtname&&jt_tbtname.substring(0,4)=="t3x_")
jt_tbtnamePfxless=jt_tbtname.substring(4);var jt_o={tbtname:jt_tbtname,src:"",zipmainfolder:"",zipsubfolder:"",zippath:"",integrity:""};if(ji_oTypeJSDB.bCommon||ji_oTypeJSDB.bCities)
{if(ji_oTypeJSDB.bCities&&jt_tbtname=="t3x_ei")
{if(ji_oTypeJSDB.bReleaseJSDB==null||ji_oTypeJSDB.bReleaseJSDB)
{jt_o.src="https://rawgit.com/a3xa/avenidaazul/master/a3xarel/a3xajdbei-10.19.05-01703262100.min.js";jt_o.integrity="sha384-l5tqCbhTwHJVhZndbXQ8vKgBBo5nTUdJINqV+Pu57G43G553DCndgtnf2DTKdadZ";}
else
...
{if(jt_tbtname=="t3x_ei")
{jt_o.src="/jdb/a3xajdb_egold_ei.zip";jt_o.zipmainfolder="jdbpages";jt_o.zipsubfolder="egold_ei";jt_o.zippath=jt_o.zipmainfolder+"/"+jt_o.zipsubfolder+"/"+"a3xajdb_e"+jt_tbtnamePfxless+"_"+ji_oTypeJSDB.xurcc+".js";jt_o.GLname="p_GL"+jt_tbtnamePfxless.toUpperCase()+"_E";}
else if(jt_tbtname=="t3x_eid"||jt_tbtname=="t3x_ebis"||jt_tbtname=="t3x_ebid")
{jt_o.src="/jdb/a3xajdb_egold.zip";jt_o.zipmainfolder="jdbpages";jt_o.zipsubfolder="egold";jt_o.zippath=jt_o.zipmainfolder+"/"+jt_o.zipsubfolder+"/"+"a3xajdb_e"+jt_tbtnamePfxless+"_"+ji_oTypeJSDB.xurcc+".js";jt_o.GLname="p_GL"+jt_tbtnamePfxless.toUpperCase()+"_E";}
jr_ao.push(jt_o);}
...
{jg_oApp.Get_DataManager().ManageData2({fnDone:jt_this.OnDataManagerDone,bLoadTOC:true,bLoadCommon:true,bLoadEnterprise:true,bStoreAll:true});}
...
jt_Itbtn=A3xaTbtnames([A3xaDefineTbid().jc_tbtype_eid.tbtname,A3xaDefineTbid().jc_tbtype_ebis.tbtname,A3xaDefineTbid().jc_tbtype_ebid.tbtname]);jg_oApp.Get_DataManager().ManageData2({fnDone:jt_this.OnDataManagerDone,bLoadTOC:true,bLoadCommon:true,bLoadEnterprise:true,bStoreAll:true,bPreloaded:jg_oApp.Get_GLPreloadedData()&&!jQuery.isEmptyObject(jg_oApp.Get_GLPreloadedData()),Itbtn:jt_Itbtn});}
...
jr_b=false;jg_oApp.HideLeftPanel();return jr_b;};this.OnDataManagerDone=function(ji_oDTStatus,ji_fnFinished)
{if(ji_oDTStatus.IsOpLoad()&&ji_oDTStatus.IsDone())
{var jt_otmDocumentShow=setTimeout(function()
{jg_oApp.Set_3xXEMSC_ByXUR(jg_oApp.Get_Database().Get_3xXEMSC_ByXUR(true));jg_oApp.Get_Database().OnDataLoadedSetup();jt_this.OnDataLoadedSetup();jg_oApp.SetupSummary();jg_oApp.DocumentShow();if(ji_fnFinished)
{var jt_otmFinished=setTimeout(function()
{if(ji_fnFinished)
ji_fnFinished(true);},200);}},10);}
return true;};this.OnDataLoadedSetup=function()
...
this.Get_3xXUR().jm_FormName=jg_oe.jc_oXUR.jc_XURFN_ListEntity;jg_oe.CanLogInfo()&&jg_oe.LogInfo("XUDString2()="+this.Get_3xXUR().Get_XUDString2(),"","A3xaMgrPage.UpdatePageTitle");jQuery(document).prop("title",this.Get_3xXUR().Get_XUDString2());var jt_o3xurl=this.Get_3xXUR().Get_A3xaUrl(false,true);if(jt_o3xurl)
{jt_o3xurl.History_ReplaceState("",this.Get_3xXUR().Get_XUDString2());}
return true;};this.OnChange_XUR=function(ji_xurcc,ji_fnFinished)
{if(!ji_xurcc)
return false;if(ji_xurcc.substring(0,4)=="p3x=")
ji_xurcc=ji_xurcc.substring(4);var jt_o3xXUR=new A3xaXur();jt_o3xXUR.Set_XurParams({form:jg_oe.jc_oXUR.jc_XURFN_ListEntity,tar:jg_oe.jc_oXUR.jc_sAjaxTypEntitySet,xurcc:ji_xurcc});jg_oApp.ClearView();return jg_oApp.Get_DataManager().RequestXURData(jt_o3xXUR,function(ji_oDTStatus)
{return jt_this.OnDataManagerDone(ji_oDTStatus,ji_fnFinished);});};} function A3xaAppMngIcons()
...
return null;return ji_o3xaSummary.getItem(jt_sik.jm_siXeid.Get_String());};this.IsValid=function(){return this.jm_odtSummary?true:false;};this.OverrideAreaScore=function(ji_odb,ji_oxeid)
{if(!ji_odb)
return false;if(!this.IsValid())
return false;if(ji_oxeid)
ji_oxeid=ji_oxeid.Get_3xXEID();if(!ji_oxeid)
return false;var jt_te=ji_oxeid.Get_TypEntity();var jt_odt_Areas=ji_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoArea));var jt_Iarit_Areas=(jt_odt_Areas?A3xaArrayIt(jt_odt_Areas.Get_IRecordset()):null);if(!jt_Iarit_Areas)
...
return false;if(ji_oxeid)
ji_oxeid=ji_oxeid.Get_3xXEID();if(!ji_oxeid)
return false;var jt_te=ji_oxeid.Get_TypEntity();var jt_odt_Regions=ji_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoRegion));var jt_Iarit_Regions=(jt_odt_Regions?A3xaArrayIt(jt_odt_Regions.Get_IRecordset()):null);if(!jt_Iarit_Regions)
...
return false;var jt_o3xaznmcSelect=ji_oxeid.Get_3xAZNMC();var jt_Select_A=jt_o3xaznmcSelect.Get_A();var jt_Select_Z=jt_o3xaznmcSelect.Get_Z();var jt_Select_N=jt_o3xaznmcSelect.Get_N();var jt_odt_Cities=ji_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoCity));var jt_Iarit_Cities=(jt_odt_Cities?A3xaArrayIt(jt_odt_Cities.Get_IRecordset()):null);if(!jt_Iarit_Cities)
...
{var jt_o3xsiiTopArea=new A3xaSummaryInfoItem(jt_o3xe,false,false,true);jt_this.jm_o3xSummaryByLandAll.Add(jt_o3xsiiTopArea);jt_this._AddSummaryItem2(jt_this.jm_o3xaSummaryByTopArea,jt_o3xsiiTopArea);jt_this._AddSummaryItem2(jt_this.jm_o3xaSummaryByArea,new A3xaSummaryInfoItem(jt_o3xe));if(jt_Select_Z)
...
return false;var jt_IaritDTMain=(this.jm_odtMain?A3xaArrayIt(this.jm_odtMain.Get_IRecordset()):null);if(!jt_IaritDTMain)
...
return false;var jt_IaritDTMain=(this.jm_odtMain?this.jm_odtMain.Get_IRecordsel():null);if(!jt_IaritDTMain)
return false;jt_IaritDTMain.resetIndex();var jt_bSummaryMain=false;var jt_bRestricted=true;while(!jt_IaritDTMain.iseof())
...
function A3xaScore()
{var jr_o={jm_oxe:null,jm_oxeSummary:null,jm_oxeCP:null,jm_keyEntity:"",jm_TypEntity:"",jm_IdEntity:0,jm_TypInfo:"",jm_IdInfo:0,jm_CodInfo:"",jm_Clicks:0.0,jm_Score:0.0,jm_sClickTimeNew:"",jm_ClicksPhNew:0.0,jm_ScoreWeightNew:0.0,jm_ScoreWeightToAdd:0.0,jm_ScoreNew:0.0,sc:A3xaIScore()};jr_o.sc.onClickEntity_WebsiteUrl=function(ji_keyEntity,ji_TypEntity,ji_IdEntity,ji_TypInfo,ji_IdInfo,ji_CodInfo)
...
{var jt_oxur=new A3xaXur();jt_oxur.Set_XurParams({form:jg_oe.jc_oXUR.jc_XURFN_AjaxEntity,tar:jg_oe.jc_oXUR.jc_sAjaxTypEntity,qur:jg_oe.jc_oXUR.jc_QUR_QueryUpdateEntity,o3xxeid:jr_o.jm_oxe});var jt_sxurcc=jt_oxur.Get_XURCC();var jt_einfo=""+jr_o.jm_TypEntity+","+jr_o.jm_IdEntity+","+
...
{var jt_ao3x2Score=A3xaScore();var jr_b=jt_ao3x2Score.sc.onClickEntity_WebsiteUrl(ji_keyEntity,ji_TypEntity,ji_IdEntity,ji_TypInfo,ji_IdInfo,ji_CodInfo);return jr_b;};return jr_o;} function A3xaEnvironment()
...
{var jt_oxur=new A3xaXur();jt_oxur.Set_XurParams({form:jg_oe.jc_oXUR.jc_XURFN_AjaxEntity,tar:jg_oe.jc_oXUR.jc_sAjaxTypControlIcons,o3xxeid:this.jm_o3xehbenv.jm_oxe});jt_oAjaxUrlParams=jt_oxur.Get_A3xaUrl(true);jt_oAjaxUrlParams.Add_UrlParam2("p_TypRelation","F");jt_oAjaxUrlParams.Add_UrlParam2("p_Op","I");jt_oAjaxUrlParams.Add_UrlParam2("p_Rating","0");}
...
return false;var jt_ogldtCategory=jt_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_Category));if(!jt_ogldtCategory)
...
{var jt_oxur=new A3xaXur();jt_oxur.Set_XurParams({form:jg_oe.jc_oXUR.jc_XURFN_ListEntity,qur:jg_oe.jc_oXUR.jc_QUR_QueryViewEntity,single:jg_oe.jc_oXUR.jc_XURTG_Single});jt_oxur.CopyFrom(jt_oglrGeoCountry,true,true,false,false);var jt_o3xmngic=jg_oe.Get_3xAppMngIcons();var jt_odfic=jt_o3xmngic.Get_DefIcons();var jt_o3xurl=jt_oxur.Get_A3xaUrl(false,true);var jt_Ihic=jt_o3xmngic.NewSprite2(jt_oglrGeoCountry.Get_3xEBIS().Get_Idsym());jt_Ihic.Ihi().setDim(24,16);jt_Ihic.Ihi().setATitle(jt_oglrGeoCountry.Get_AName(),jt_oglrGeoCountry.Get_3xXEID().Get_3xPS2().Get_P());jt_Ihic.Ihi().setOptions({bParagraph:false});var jt_Ib=A3xaApp().getIfwwg().newISimpleButton(jt_Ihic);jt_Ib.setActionInfo({mediatype:"hyperlink",targetlink:jt_o3xurl.Get_Url(),btargetnew:true});if(!jt_Ib.printHtml(qi_oParent))
return false;}
...
{var jt_oxur=new A3xaXur();jt_oxur.Set_XurParams({form:jg_oe.jc_oXUR.jc_XURFN_ListEntity,qur:jg_oe.jc_oXUR.jc_QUR_QueryViewEntity,single:jg_oe.jc_oXUR.jc_XURTG_Single});jt_oxur.CopyFrom(jt_oglrGeoCity,true,true,false,false);jt_oxur.LinkCommonData(jg_oe.Get_Database(),true);var jt_o3xcat_Category_Geo_City=new A3xaCategoryCode();jt_o3xcat_Category_Geo_City.Set_Category(jg_oe.jc_oEntity.jc_UCat_Geo,jg_oe.jc_oEntity.jc_VCat_Geo_City);var jt_o3xmngic=jg_oe.Get_3xAppMngIcons();var jt_odfic=jt_o3xmngic.Get_DefIcons();var jt_o3xurl=jt_oxur.Get_A3xaUrl(false,true);var jt_Ihic=jt_o3xmngic.NewSprite2(jt_odfic.jc_oIconCat_City.absid);jt_Ihic.Ihi().setDim(24,24);jt_Ihic.Ihi().setATitle(jt_oglrGeoCity.Get_AName(),"CTY");jt_Ihic.Ihi().setOptions({bParagraph:false});var jt_Ib=A3xaApp().getIfwwg().newISimpleButton(jt_Ihic);jt_Ib.setActionInfo({mediatype:"hyperlink",targetlink:jt_o3xurl.Get_Url(),btargetnew:true});if(!jt_Ib.printHtml(qi_oParent))
return false;}
...
{var jt_sxeidcc=this.jm_odce.Get_3xXEID().Get_CompactCode();this.jm_odce.Get_3xXEID().Set_TypEntity(jg_oe.jc_oEntity.jc_Typ_Enterprise);this.Set_Key(jt_sxeidcc);var jt_oxur=new A3xaXur();jt_oxur.MakeXur(this.jm_odce);this.Set_Value("p3x="+jt_oxur.Get_XURCC());}
...
return false;jt_oddirNew.Set_Descr(ji_ocg.o3xe.Get_LName());jt_oddig.Add_Child(jt_oddirNew);var jt_I3tbid=A3xaTbid();var jt_glidtoc=jt_I3tbid.makeByXEID(jt_odcer);var jt_pisdsRecord_glidtoc=null;if(jt_I3tbid.isEnterprise()&&jt_glidtoc)
...
return false;jt_oddirNew.Set_Descr(ji_ocg.o3xe.Get_LName());this.Add_Child(jt_oddirNew);var jt_I3tbid=A3xaTbid();var jt_glidtoc=jt_I3tbid.makeByXEID(jt_odcer);var jt_pisdsRecord_glidtoc=null;if(jt_I3tbid.isEnterprise()&&jt_glidtoc)
...
return false;var jt_xurcc=(jt_sUrlParams.substring(0,3)=="p3x"?jt_sUrlParams.substring(4):jt_sUrlParams);return jg_oApp.Get_MgrPage().OnChange_XUR(jt_xurcc);};if(this.IsArea())
...
{jt_odcSelected.Get_3xXEID().Get_3xAZNMC2().Clear_NC();this.jm_oddbox.jm_sKeySelected=jt_odcSelected.Get_3xXEID().Get_CompactCode();jt_odcSelected.Get_3xXEID().Get_3xAZNMC2().Clear_ZNC();this.jm_oddbox.jm_sKeyGroupFocus=jt_odcSelected.Get_3xXEID().Get_CompactCode();}
else if(this.IsRegion())
{this.jm_oddbox.jm_sKeySelected=jt_odcSelected.Get_3xXEID().Get_CompactCode();jt_odcSelected.Get_3xXEID().Get_3xAZNMC2().Clear_C();this.jm_oddbox.jm_sKeyGroupFocus=jt_odcSelected.Get_3xXEID().Get_CompactCode();}
else
{}
...
var jt_ogldtCategory=jt_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_Category));var jt_ogldtTopArea=jt_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoTopArea));var jt_ogldtArea=jt_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoArea));var jt_ogldtRegion=jt_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoRegion));var jt_ogldtCity=jt_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoCity));if(!jt_ogldtCategory)
...
{var jt_odb=jg_oe.Get_Database();if(!jt_odb)
{jg_oe.LogErr("Fail","Get Database","A3xaMgrLand_RequestArea::LoadDataDD");return false;}
var jt_ogldtCategory=jt_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_Category));var jt_ogldtArea=jt_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoArea));var jt_ogldtRegion=jt_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoRegion));var jt_ogldtCity=jt_odb.Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoCity));if(!jt_ogldtCategory)
{jg_oe.LogErr("Fail","Get Tb Category","A3xaMgrLand_RequestArea::LoadDataDD");return false;}
if(!jt_ogldtArea)
{jg_oe.LogErr("Fail","Get Tb Area","A3xaMgrLand_RequestArea::LoadDataDD");return false;}
...
{var jt_oxur=jg_oApp.Get_MgrPage().Get_3xXUR().Get_3xXEID();this.jm_o3ximapTabs=new A3xaImageMap_Tabs(null);var jt_ogldtGeoArea=jg_oe.Get_Database().Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoArea));this.jm_o3ximapLA=new A3xaImageMap_AZNMC(jt_ogldtGeoArea,null);if(jt_oxur&&jt_oxur.Get_3xXEID().Get_3xAZNMC2().Get_Z()&&!New_A3xaAZNMC_XApp(jt_oxur.Get_3xXEID()).IsLA()&&!New_A3xaAZNMC_XApp(jt_oxur.Get_3xXEID()).IsBestFromBabylon())
{this.jm_o3ximapTabs.jm_bEnableArea=true;var jt_ogldtGeoRegion=jg_oe.Get_Database().Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoRegion));var jt_oxeidArea=new A3xaDCEntity();jt_oxeidArea.Get_3xXEID().Set_3xAZ(jt_oxur);this.jm_o3ximapArea=new A3xaImageMap_AZNMC(jt_ogldtGeoRegion,jt_oxeidArea);if(jt_oxur.Get_3xXEID().Get_3xAZNMC2().Get_N())
{this.jm_o3ximapTabs.jm_bEnableRegion=true;var jt_ogldtGeoCity=jg_oe.Get_Database().Get_DataTable(GLIDR(A3xaDefineTbid().jc_GGLID_GeoCity));var jt_oxeidRegion=new A3xaDCEntity();jt_oxeidRegion.Get_3xXEID().Set_3xAZN(jt_oxur.Get_3xXEID());var jt_fnZoom=null;this.jm_o3ximapRegion=new A3xaImageMap_AZNMC(jt_ogldtGeoCity,jt_oxeidRegion,jt_fnZoom);}}};this.PrintHtml=function(qi_oCell,ji_Row,ji_Col)
...
return false;jt_oxurNew.SortByClick();return jg_oApp.Get_MgrPage().OnChange_XUR(jt_oxurNew.Get_XURCC());}
...
{this.jm_oddbox.jm_bShowCount=false;var jt_oxur=jg_oApp.Get_MgrPage().Get_3xXUR();if(jt_oxur.IsSortByClick())
...
jt_RowElem=document.getElementById("RowS_"+jt_Row);if(jt_RowElem==null)
return true;var jt_oxeid=new A3xaDCEntity();var jt_o3xxeid=jt_oxeid.Get_3xXEID();jt_o3xxeid.Set_CompactCode(jt_RowElem.getAttribute("xeidcode"));var jt_TypEntity=jt_o3xxeid.Get_TypEntity();if(!(jt_TypEntity==jg_oe.jc_oEntity.jc_Typ_MetaSystemControl))
...
{var jt_oxeid=new A3xaDCEntity();if(jt_oxeid.Get_3xXEID().Set_CompactCode(jt_sxeid))
...
(jt_bMatchesLand?"y":"n")+","+
this.jm_oxeid.Get_CompactCode()+","+ji_oxeidLand.Get_CompactCode(),"","A3xaEntity_HtmlFrame.ShowByFilter");}
...
return null;return this.jm_ao3xehc[ji_Col-1];};this.Get_XEIDCode=function(){return(this.jm_oxe?this.jm_oxe.Get_3xXEID().Get_CompactCode():"");};this.Get_RowHeaderHtmlID=function(){return"RowH_"+this.jm_RowHF;};this.Get_RowBodyHtmlID=function(){return(this.IsStick()?"RowS_":"Row_")+this.jm_RowHF;};this.CheckNarrowView=function()
...
jt_ogldtMain=jt_odb.Get_DataTable();var jt_Iarit=(jt_ogldtMain?jt_ogldtMain.Get_IRecordsel():null);this.jm_nRows=(jt_Iarit?jt_Iarit.Iar().getCount():0);if(!(this.jm_nRows>0))
...
this.jm_o3xDataManager=new A3xaDataManager(this.Get_Database());return this.jm_o3xDataManager;};this.SetupSummary=function()
{this.Get_MgrSummary().MakeSummaryGlobalEnterprises(this.Get_Database(),this.Get_MgrPage().Get_3xXUR());this.Get_MgrSummary().MakeSummaryCityEnterprises(this.Get_Database(),this.Get_MgrPage().Get_3xXUR());this.Get_MgrSummary().OverrideAreaScore(this.Get_Database(),this.Get_MgrPage().Get_3xXUR());this.Get_MgrSummary().OverrideRegionScore(this.Get_Database(),this.Get_MgrPage().Get_3xXUR());this.Get_MgrSummary().OverrideCityScore(this.Get_Database(),this.Get_MgrPage().Get_3xXUR());this.Get_MgrSummary().OverrideCPScore(this.Get_Database(),this.Get_MgrPage().Get_3xXUR(),this.Get_3xXEMSC_ByXUR());this.Get_Database().ApplyFiltersAndSorting(this.Get_MgrPage().Get_3xXUR());this.Get_MgrSummary().MakeSummaryMainEnterprises(this.Get_Database(),this.Get_MgrPage().Get_3xXUR());return true;};this.DocumentShow=function()
{var jr_b=true;try
...
{jt_this.ClearView();jt_this.ResetApp();jt_this.Get_DataManager(true);jt_this.Get_Database().ClearArrayDTLoad({jp_bTyp_Gold:true,jp_bTyp_Silver:true,jp_bTyp_Main:true,jp_bTyp_Unique:true,jp_bTyp_Major:true,jp_bTyp_Subry:true});var jt_Itbtn=null;if(jt_this.Get_MgrPage().Get_3xXUR().IsMultiple())
jt_Itbtn=A3xaTbtnames([A3xaDefineTbid().jc_tbtype_eid.tbtname,A3xaDefineTbid().jc_tbtype_ebis.tbtname,A3xaDefineTbid().jc_tbtype_ebid.tbtname]);jt_this.Get_DataManager().ManageData2({fnDone:jt_this.Get_MgrPage().OnDataManagerDone,bLoadTOC:true,bLoadCommon:true,bLoadEnterprise:true,bStoreAll:true,Itbtn:jt_Itbtn});},10);return true;};this.Set_ItemsNarrowView=function(ji_IdNarrowView)
...
{if(!(ji_oParams&&ji_oParams.bStatus)||this.Get_DataManager().IsAvailableDataTableEI())
...
return true;this.Get_DataManager().RequestDataTableEI(function(ji_oDTStatus)
{if(ji_oDTStatus.IsOpLoad()&&ji_oDTStatus.IsDone())
...
jt_this.jm_aOnGLMore=[];});return true;}
