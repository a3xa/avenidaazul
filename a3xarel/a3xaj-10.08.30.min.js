...
jg_oe.CanLogInfo()&&jg_oe.LogInfo("w2sb:"+ji_o3xsText.Get_LString(),"","A3xaAbsEnvironment.LogStatusBar");if(!this._ExecLogStatusBar2(ji_o3xsText,ji_bAsChild,ji_bClear));return true;};this._ExecLogStatusBar2=function(ji_o3xsText,ji_bAsChild,ji_bClear){return false;};this.jm_o3x2Envars=A3xa2EnvironmentVariables();this.jm_oGLData={};this.Get_GLPreloadedData=function(){return this.jm_oGLData;};this.Set_CommonValues=function(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_sDirBase,ji_sHomeDir,ji_sLang,ji_sSitemapDate,ji_sGLDataJSON)
{return this.A3xaAbsEnvironment_Set_CommonValues(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_sDirBase,ji_sHomeDir,ji_sLang,ji_sSitemapDate,ji_sGLDataJSON);}
this.A3xaAbsEnvironment_Set_CommonValues=function(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_sDirBase,ji_sHomeDir,ji_sLang,ji_sSitemapDate,ji_sGLDataJSON)
{this.jm_bDebug=(ji_bDebug==true);this.jm_bCanEdit=ji_bCanEdit;this.jm_bCanLike=ji_bCanLike;this.jm_sDirBase=(ji_sDirBase?ji_sDirBase:"/");this.jm_sHomeDir=(ji_sHomeDir?ji_sHomeDir:"/");this.jm_sLang=(ji_sLang?ji_sLang:"en");this.jm_sSitemapDate=(ji_sSitemapDate?ji_sSitemapDate:"");this.jm_oGLData=JSON.parse(ji_sGLDataJSON||"",function(ji_k,ji_v)
{return ji_v;});return true;};this.CheckInitDone=function(){return true;};this.jm_oAjax2=new A3xaAjax2();this.jm_oMgrStorage=null;this.Get_MgrStorage=function(){return this.jm_oMgrStorage;};this.jm_odb=null;this.Set_Database=function(ji_odb){this.jm_odb=ji_odb;return true;};this.Get_Database=function(){return this.jm_odb;};this.jm_oHostReporter=null;this.Set_Reporter=function(ji_oHostReporter)
...
return false;if(this.jm_aQueueRequest.length>5)
...
return"";var jt_o3xaznmc=ji_o3xxeid.Get_3xAZNMC();var jt_te=ji_o3xxeid.Get_TypEntity();var jt_A=jt_o3xaznmc.Get_A();var jt_Z=jt_o3xaznmc.Get_Z();var jt_N=jt_o3xaznmc.Get_N();if((!jt_te||jt_te==jg_oe.jc_oEntity.jc_Typ_Enterprise))
...
return jr_o.jc.jc_tbtype_ei;return{tbtname:"",tbtkeyname:"",leadch:""};};jr_o.gd.getSDSTbType=function(){return jr_o.gd.getTbType();};jr_o.gd.getGlid=function(){return jr_o.jm_glid;};jr_o.gd.set(ji_glid,ji_tbtype);return jr_o.gd;}
...
{var jt_I3tbid=A3xa3Tbid(ji_sName);ji_sdx=jt_I3tbid.getDescrExtra();var jt_pTable=this.Get_Table_ByName(ji_sName);if(!jt_pTable)
return"";if(!jt_pTable.jp_sDescr)
return"";return jt_pTable.jp_sDescr+" "+ji_sdx;};this.Get_TableGroups=function(ji_aTableNames)
...
this.jm_bAX=false;jg_oe.CanLogInfo()&&jg_oe.LogInfo("ji_glid,AX,jt_oSchemaTable="+ji_glid+","+this.jm_bAX+","+jt_oSchemaTable,"","GLDataTable._GLDataTable");this.Set_Glid(ji_glid);this.Set_Release(ji_release);}};this.jm_o3xJSDS=null;this.New3xJSDS=function(ji_glid){return new GLData(ji_glid);};this.Get_3xJSDS=function()
...
{var jt_subrs="";var jt_sepr=jg_oe.jc_oA3xaDatabase.jc_GLSep_FieldArray;var jt_sepf=jg_oe.jc_oA3xaDatabase.jc_GLSep_Compact;for(var j=0;j<jt_f.length;j++)
...
function A3xa3IDataSourceGLRSPool()
{var jr_I={I:function(){return null;},getItem:function(ji_sName){return"";},getGLItem:function(ji_sGLnameGLID,ji_sGLnameGL){return{glid:"",glrs:""};},getGLItem2:function(ji_tbtname,ji_GLent,ji_slicech,ji_idForeign){return{glid:"",glrs:""};}};return jr_I;}
...
{return((!ji_GLtype||!ji_tbtname||!ji_GLent||ji_idForeign<0)?"":"p_"+ji_GLtype+ji_tbtname+"_"+ji_GLent+(ji_slicech?ji_slicech:"")+(ji_idForeign>0?ji_idForeign:""));};jr_o.dsp.getGLItem=function(ji_sGLnameGLID,ji_sGLnameGL)
{return{glid:jr_o.dsp.getItem(ji_sGLnameGLID),glrs:jr_o.dsp.getItem(ji_sGLnameGL)};};jr_o.dsp.getGLItem2=function(ji_tbtname,ji_GLent,ji_slicech,ji_idForeign)
{var jt_sGLnameGLID=jr_o._makeGLname("GLID",ji_tbtname,ji_GLent,ji_slicech,ji_idForeign);var jt_sGLnameGL=jr_o._makeGLname("GL",ji_tbtname,ji_GLent,ji_slicech,ji_idForeign);return jr_o.dsp.getGLItem(jt_sGLnameGLID,jt_sGLnameGL);}
return jr_o.dsp;}
...
jt_xitemEID.glid+","+jt_xitemEID.glrs,"","A3xa3DataTableSlice.writeGLRS2");if(jr_o.jm_bEID&&!jg_oApp.WriteGLRS2(jt_xitemEID.glid,jt_xitemEID.glrs))
return false;if(jr_o.jm_bEBIS&&!jg_oApp.WriteGLRS2(jt_xitemEBIS.glid,jt_xitemEBIS.glrs))
return false;if(jr_o.jm_bEBID&&!jg_oApp.WriteGLRS2(jt_xitemEBID.glid,jt_xitemEBID.glrs))
return false;if(jr_o.jm_bEI&&!jg_oApp.WriteGLRS2(jt_xitemEI.glid,jt_xitemEI.glrs))
return false;return true;};jr_o.dts.writeEmptyGLRS2=function(ji_GLent,ji_slicech,ji_idForeign)
{if(ji_GLent!="E")
return false;if(!ji_slicech)
ji_slicech="";var jt_tbrelease=(jg_oApp.Get_Database().Get_SDSDBWork().db.getDefaultDbVersion()||"");var jt_I3tbid=A3xa3Tbid();var jt_xitemEID={glid:"",glrs:""};var jt_xitemEBIS={glid:"",glrs:""};var jt_xitemEBID={glid:"",glrs:""};var jt_xitemEI={glid:"",glrs:""};if(jr_o.jm_bEID)
{jt_xitemEID={glid:jt_I3tbid.makeByXEID(jr_o.jm_o3xxur,ji_slicech,A3xa2DefineTbid().jc_tbtype_eid)};if(!jt_xitemEID.glid)
return false;jt_xitemEID.glrs=jt_xitemEID.glid+jg_oe.jc_oA3xaDatabase.jc_GLSep_Header+jt_tbrelease;}
if(jr_o.jm_bEBIS)
{jt_xitemEBIS={glid:jt_I3tbid.makeByXEID(jr_o.jm_o3xxur,ji_slicech,A3xa2DefineTbid().jc_tbtype_ebis)};if(!jt_xitemEBIS.glid)
return false;jt_xitemEBIS.glrs=jt_xitemEBIS.glid+jg_oe.jc_oA3xaDatabase.jc_GLSep_Header+jt_tbrelease;}
if(jr_o.jm_bEBID)
{jt_xitemEBID={glid:jt_I3tbid.makeByXEID(jr_o.jm_o3xxur,ji_slicech,A3xa2DefineTbid().jc_tbtype_ebid)};if(!jt_xitemEBID.glid)
return false;jt_xitemEBID.glrs=jt_xitemEBID.glid+jg_oe.jc_oA3xaDatabase.jc_GLSep_Header+jt_tbrelease;}
if(jr_o.jm_bEI)
{jt_xitemEI={glid:jt_I3tbid.makeByXEID(jr_o.jm_o3xxur,ji_slicech,A3xa2DefineTbid().jc_tbtype_ei)};if(!jt_xitemEI.glid)
return false;jt_xitemEI.glrs=jt_xitemEI.glid+jg_oe.jc_oA3xaDatabase.jc_GLSep_Header+jt_tbrelease;}
jg_oe.CanLogInfo()&&jg_oe.LogInfo("xur.QUR,xur.XEID,ji_GLent,ji_slicech,idForeign,glid,glrs="+
jr_o.jm_o3xxur.jm_QUR+","+jr_o.jm_o3xxur.Get_3xXEID().Get_String()+","+
ji_GLent+","+ji_slicech+","+ji_idForeign+","+
jt_xitemEID.glid+","+jt_xitemEID.glrs,"","A3xa3DataTableSlice.writeGLRS2");if(jr_o.jm_bEID&&!jg_oApp.WriteGLRS2(jt_xitemEID.glid,jt_xitemEID.glrs))
...
jr_o.jm_aglRS=ji_sGLRS.split(jg_oe.jc_oA3xaDatabase.jc_GLSep_Block);}};jr_o.csw.writeTable=function()
{if(!(jr_o.jm_odb&&jr_o.jm_glid))
return false;if(!jr_o.jm_aglRS)
{return false;}
jr_o.jm_odt=jr_o.jm_odb.NewDataTableCacheStore(jr_o.jm_glid);if(!jr_o.jm_odt)
return false;jr_o.jm_odb.jm_oDTStatus.SetCacheStatusInProgress("Cache Tableset "+jr_o.jm_glid);jr_o.jm_odb.Get_ArrayDTStore().Set_Item(jr_o.jm_glid,jr_o.jm_odt);jr_o.jm_odt.jm_oDTStatus.SetCacheStatusInProgress();jr_o.jm_o3xJSDS=jr_o.jm_odt.New3xJSDS(jr_o.jm_glid);if(!jr_o.csw.writeJSDS())
{if(jr_o.jm_odb)
...
{if(!jr_o.jm_o3xJSDS)
return false;var jt_aHeader2=jr_o.jm_aglRS[0].split(jg_oe.jc_oA3xaDatabase.jc_GLSep_Header);var jt_aHeader=((jt_aHeader2&&jt_aHeader2[1])?jt_aHeader2[1].split(jg_oe.jc_oA3xaDatabase.jc_GLSep_Field):null);if(!(jt_aHeader&&jt_aHeader.length>0))
return false;jr_o.jm_header_glid=jt_aHeader2[0];jr_o.jm_header_release=jt_aHeader[0];var jt_aFieldNames2=(jr_o.jm_aglRS[1]?jr_o.jm_aglRS[1].split(jg_oe.jc_oA3xaDatabase.jc_GLSep_Header):null);var jt_aFieldNames=((jt_aFieldNames2&&jt_aFieldNames2[1])?jt_aFieldNames2[1].split(jg_oe.jc_oA3xaDatabase.jc_GLSep_Field):null);if(!(jt_aFieldNames&&jt_aFieldNames.length>1));var jt_keynameTrashed="";var jt_posFieldArray=-1;var jt_sFieldNames="";if(jt_aFieldNames&&jt_aFieldNames.length>0)
{jg_oe.CanLogInfo()&&jr_o.jm_glid=="Z3XGFEE0000"&&jg_oe.LogInfo("jt_aFieldNames2,jt_aFieldNames: "+jt_aFieldNames2+"----"+jt_aFieldNames,"","A3xa2DTCacheWriter.writeJSDS");jt_keynameTrashed=jt_aFieldNames.shift();for(var ifa=0;ifa<jt_aFieldNames.length;ifa++)
{jg_oe.CanLogInfo()&&jr_o.jm_glid=="Z3XGFEE0000"&&jg_oe.LogInfo("ifa,jt_aFieldNames[ifa],jc_sEifaName: "+ifa+","+jt_aFieldNames[ifa]+"=="+jg_oe.jc_oA3xaDbZero.jc_sEifaName,"","A3xa2DTCacheWriter.writeJSDS");if(jt_aFieldNames[ifa]!=jg_oe.jc_oA3xaDbZero.jc_sEifaName)
...
var jt_nofRecords=jr_o.jm_aglRS.length-2;var jt_I3tbid=A3xa3Tbid(jr_o.jm_glid);var jt_tbtype=jt_I3tbid.getTbType();var jt_tbtname=(jt_tbtype?jt_tbtype.tbtname:"");var jt_JSDS='{"d3x_header":'+'{"d3x_glid":"'+jr_o.jm_header_glid+'","d3x_tbtype":"'+jt_tbtname+'","d3x_tbname":"","d3x_version":"'+jr_o.jm_header_release+'"},';jt_JSDS+='"d3x_names":['+jt_sFieldNames+'],';jt_JSDS+='"d3x_records":[';for(var i=0;i<jt_nofRecords;i++)
{var jt_aRecord2=jr_o.jm_aglRS[i+2].split(jg_oe.jc_oA3xaDatabase.jc_GLSep_Header);var jt_aRecord=((jt_aRecord2&&jt_aRecord2[1])?jt_aRecord2[1].split(jg_oe.jc_oA3xaDatabase.jc_GLSep_Field):null);if(jt_aRecord&&jt_aRecord.length>1)
...
jt_JSDS+=('[[""]]');}}
jt_JSDS+=']';}}
jt_JSDS+=']}';jg_oe.CanLogInfo()&&jg_oe.LogInfo("jm_glid,jt_JSDS: "+jr_o.jm_glid+","+jt_JSDS,"","A3xa2DTCacheWriter.writeJSDS");return jr_o.jm_o3xJSDS.Set_GLDString(jr_o.jm_glid,jt_JSDS);};jr_o._Construct(ji_odb,ji_glid,ji_sGLRS);return jr_o;}
function A3xaDefines_A3xaDatabase()
{this.jc_GLSep_Block="__glk__";this.jc_GLSep_Header="__glv__";this.jc_GLSep_Field="__glf__";this.jc_GLSep_FieldArray="__glr__";this.jc_GLSep_Compact="~";this.jc_tidf_tid="f3x_tid";this.jc_DbSchemaVersion=52;this.jc_sDbDefaultPrimaryKeyName="xkey";this.jc_sDbName="A3xaDbZeroA";this.jc_oSTG_Common={jp_sGroupName:"A3XADB0STG_COMMON",jp_sKeyName:"xkey"};this.jc_oSTG_ComDyn={jp_sGroupName:"A3XADB0STG_COMDYN",jp_sKeyName:"xkey"};this.jc_oSTG_Enterp={jp_sGroupName:"A3XADB0STG_ENTERP",jp_sKeyName:"xkey"};this.jc_oSTG_EntDyn={jp_sGroupName:"A3XADB0STG_ENTDYN",jp_sKeyName:"xkey"};this.jc_aSchemaTableGroups=[this.jc_oSTG_Common,this.jc_oSTG_ComDyn,this.jc_oSTG_Enterp,this.jc_oSTG_EntDyn];}
...
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("ji_glid,ji_sGLRS: "+ji_glid+","+ji_sGLRS,"","A3xaDatabase.WriteGLRS2");var jt_o3x2dtcsw=A3xa2DTCacheWriter(this,ji_glid,ji_sGLRS);jr_b=jt_o3x2dtcsw.csw.writeTable();}
...
return false;jr_o.jm_oxur=ji_o3xxur;var jt_oUrl=ji_o3xxur.Get_A3xaUrl(true);jg_oe.jm_oAjax2.QueueRequest(new A3xaAjaxRequest2(jt_oUrl.Get_UrlBase(),"p3k=1"+jt_oUrl.Get_UrlParams(),{OnAjaxReadyFn:function(ji_ogAjaxResponse)
{var jt_bSuccess=false;var jt_xmlAjaxTablesEnterp="";var jt_o3x3dtslice=null;if(ji_ogAjaxResponse)
jt_xmlAjaxTablesEnterp=ji_ogAjaxResponse.Get_ItemElement(jg_oe.jc_oXUR.jc_sAjaxTypEntitySet);if(jt_xmlAjaxTablesEnterp)
{jt_o3x3dtslice=A3xa3DataTableSlice(A3xa3DataSourceGLRSPoolAjax(ji_ogAjaxResponse),jr_o.jm_oxur);if(jt_o3x3dtslice.writeGLRS2All())
jt_bSuccess=true;}
if(ji_fnOnDone)
ji_fnOnDone(jt_bSuccess,jr_o.jxt.get3xXUR());return true;}}));return true;};return jr_o.jxt;}
...
{var jr_b=false
if(!(ji_bStoreAll===false)&&ji_oDTStatus&&ji_oDTStatus.IsSuccessOrEmpty())
jr_b=jt_this.ManageDataStoreAll(function(ji_bSuccess)
{return true;},jt_o3xxur);jr_b=jt_fnThatsAllFolks(ji_oDTStatus);return jr_b;};var jt_fnOnLoadCommon2Done=function(ji_bSuccess)
{if(!ji_bSuccess)
...
{var jt_oxeidXUR=ji_o3xxur.Get_3xXEID();var jt_bEnterprise=(!jt_oxeidXUR.Get_TypEntity()||jt_oxeidXUR.Get_TypEntity()==jg_oe.jc_oEntity.jc_Typ_Enterprise);var jt_bSilver=ji_o3xxur.IsSilver();var jt_bGold=ji_o3xxur.IsGold();var jt_Ucat=jt_oxeidXUR.Get_3xCat().Get_Ucat();var jt_Vcat=jt_oxeidXUR.Get_3xCat().Get_Vcat();var jt_oTimerAsyncDecouple=setTimeout(function()
...
jr_b=this.jm_oDatabase.WriteGLRS2(GLIDR(A3xa2DefineTbid().jc_GGLID_MetaSystemControl),"");if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(GLIDR(A3xa2DefineTbid().jc_GGLID_Category),"");if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(GLIDR(A3xa2DefineTbid().jc_GGLID_GeoTopArea),"");if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(GLIDR(A3xa2DefineTbid().jc_GGLID_GeoArea),"");if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(GLIDR(A3xa2DefineTbid().jc_GGLID_GeoRegion),"");if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(GLIDR(A3xa2DefineTbid().jc_GGLID_GeoCountry),"");if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(GLIDR(A3xa2DefineTbid().jc_GGLID_GeoState),"");if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(GLIDR(A3xa2DefineTbid().jc_GGLID_GeoCity),"");}
catch(e)
...
return false;this.Set_GEID(jt_oxjebis.f3x_enty,jt_oxjebis.f3x_enid,jt_oxjebis.f3x_egty,jt_oxjebis.f3x_egid);this.Get_3xCat().Set_Category(jt_oxjebis.f3x_cU,jt_oxjebis.f3x_cV);this.Get_3xAZNMC().Set_AZNMC(jt_oxjebis.f3x_gnA,jt_oxjebis.f3x_gnZ,jt_oxjebis.f3x_gnN,jt_oxjebis.f3x_gnM,jt_oxjebis.f3x_gnC);this.Get_3xPS().Set_PS(jt_oxjebis.f3x_gpP,jt_oxjebis.f3x_gpS);return true;};this.CanBeUnlimitedEnterprise=function()
{if(this.Get_TypEntity()&&this.Get_TypEntity()!=jg_oe.jc_oEntity.jc_Typ_Enterprise)
return false;return this.Get_3xAZNMC()&&this.Get_3xAZNMC().CanBeUnlimited();};this.CanBeSilverEnterprise=function()
{if(this.Get_TypEntity()&&this.Get_TypEntity()!=jg_oe.jc_oEntity.jc_Typ_Enterprise)
return false;return this.Get_3xAZNMC()&&this.Get_3xAZNMC().CanBeSilver();};this.CanBeSilverTopEnterprise=function()
{if(this.Get_TypEntity()&&this.Get_TypEntity()!=jg_oe.jc_oEntity.jc_Typ_Enterprise)
return false;return this.Get_3xAZNMC()&&this.Get_3xAZNMC().CanBeSilverTop();};this.CanBeGoldEnterprise=function()
{if(this.Get_TypEntity()&&this.Get_TypEntity()!=jg_oe.jc_oEntity.jc_Typ_Enterprise)
return false;return this.Get_3xAZNMC()&&this.Get_3xAZNMC().CanBeGold();};this.jm_TypEntity=null;this.jm_IdEntity=null;this.jm_TypGroup=null;this.jm_IdGroup=null;this.jm_o3xaznmc=new A3xaAZNMC();this.jm_o3xps=new A3xaPS();this.jm_o3xcat=new A3xaCategoryCode();}
...
{jt_ogldtMain.New_IRecordsel(null,function(ji_k,ji_oxe)
{var jt_3xxeid=ji_oxe.Get_3xXEID();var jt_3xaznmc=jt_3xxeid.Get_3xAZNMC();var jt_3xcat=jt_3xxeid.Get_3xCat();jg_oe.CanLogInfo()&&jg_oe.LogInfo("xur-ide,ide,idg="+jt_o3xxur_xeid.Get_IdEntity()+","+jt_3xxeid.Get_IdEntity()+","+jt_3xxeid.Get_IdGroup(),"","A3xaDbZero.ApplyFiltersAndSorting");if(jt_o3xxur_xeid.Get_IdEntity())
...
return false;var jt_Select_A=ji_oxeid.Get_3xAZNMC().Get_A();var jt_Select_Z=ji_oxeid.Get_3xAZNMC().Get_Z();var jt_Select_N=ji_oxeid.Get_3xAZNMC().Get_N();var jt_odt_Cities=ji_odb.Get_DataTable(GLIDR(A3xa2DefineTbid().jc_GGLID_GeoCity));var jt_o3xait_Cities=null;if(jt_odt_Cities)
...
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("jt_glidtoc="+jt_glidtoc,"","A3xaDDItemRequestArea.Add_Area");jt_pisdsRecord_glidtoc=jg_oApp.Get_Database().Get_TOCItem(jt_glidtoc);}
...
{jt_odc.Get_3xXEID().Get_3xAZNMC().Clear_NC();if(jt_odc.Get_3xXEID().CanBeUnlimitedEnterprise())
...
{var jt_oxur=jg_oApp.Get_AppXUR().Get_3xXUR().Get_3xXEID();this.jm_o3ximapTabs=new A3xaImageMap_Tabs(null);var jt_ogldtGeoArea=jg_oe.Get_Database().Get_DataTable(GLIDR(A3xa2DefineTbid().jc_GGLID_GeoArea));this.jm_o3ximapLA=new A3xaImageMap_AZNMC(jt_ogldtGeoArea,null);if(jt_oxur&&jt_oxur.Get_3xXEID().Get_3xAZNMC().Get_Z()&&!New_A3xaAZNMC_XApp(jt_oxur.Get_3xXEID()).IsLA()&&!New_A3xaAZNMC_XApp(jt_oxur.Get_3xXEID()).IsBestFromBabylon())
{this.jm_o3ximapTabs.jm_bEnableArea=true;var jt_ogldtGeoRegion=jg_oe.Get_Database().Get_DataTable(GLIDR(A3xa2DefineTbid().jc_GGLID_GeoRegion));var jt_oxeidArea=new A3xaDCEntity();jt_oxeidArea.Get_3xXEID().Set_3xAZ(jt_oxur);this.jm_o3ximapArea=new A3xaImageMap_AZNMC(jt_ogldtGeoRegion,jt_oxeidArea);if(jt_oxur.Get_3xXEID().Get_3xAZNMC().Get_N())
