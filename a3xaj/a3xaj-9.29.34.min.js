...
{if(!this.CheckGlid(ji_s))
return"";return this.MakeGlid(ji_s.substr(0,this.jc_GLIDPREFIXLEN));};this.jc_SubTable_EID=1;this.jc_SubTable_EBIS=2;this.jc_SubTable_EBID=4;this.jc_SubTable_EI=8;this.jc_sEifaName="f3x_ei";this.jc_Eifa_Typ=0;this.jc_Eifa_Cod=1;this.jc_Eifa_Id=2;this.jc_Eifa_IdParent=3;this.jc_Eifa_Info=4;this.jc_DTStatus2_StSuccess=1;this.jc_DTStatus2_StFail=4;this.jc_DTStatus2_StEmpty=5;this.jc_DTStatus2_StInProgress=6;this.jc_DTStatus2_StOpen=8;this.jc_DTStatus2_StReady=9;this.jc_DTStatus2_OpCache=10;this.jc_DTStatus2_OpClear=20;this.jc_DTStatus2_OpStore=30;this.jc_DTStatus2_OpLoad=40;this.jc_DTStatus2_TgTable=100;this.jc_DTStatus2_TgTableHeader=200;this.jc_DTStatus2_TgTableHX=300;this.jc_DTStatus2_TgRecord=400;this.jc_DTStatus2_TgCommonTable=1000;this.jc_DTStatus2_TgMainTable=2000;this.jc_DTStatus2_TgDependentTable=3000;this.jc_DTStatus2_TgExtTableHeader=4000;this.jc_DTStatus_Empty=0;this.jc_DTStatus_Cached=1;this.jc_DTStatus_CacheFail=4;this.jc_DTStatus_CacheInProgress=6;this.jc_DTStatus_Loaded=21;this.jc_DTStatus_LoadedRecord=22;this.jc_DTStatus_LoadedTable=23;this.jc_DTStatus_LoadFail=24;this.jc_DTStatus_LoadEmpty=25;this.jc_DTStatus_LoadRecordInProgress=26;this.jc_DTStatus_LoadTableInProgress=27;this.jc_DTStatus_LoadOpen=29;this.jc_DTStatus_Stored=31;this.jc_DTStatus_StoreFail=34;this.jc_DTStatus_StoreEmpty=35;this.jc_DTStatus_StoreInProgress=36;this.jc_DTStatus_StoreOpen=39;this.jc_DTStatus_Cleared=41;this.jc_DTStatus_ClearFail=44;this.jc_DTStatus_ClearInProgress=46;this.jc_DTStatus_ClearOpen=49;this.jc_DbVersion=33;this.jc_sDbDefaultPrimaryKeyName="xkey";this.jc_sDbName="A3xaDbZeroA";this.jc_aSchemaTables=[{jp_sName:this.jc_GLID_MetaSystemControl,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"ControlPanels"},{jp_sName:this.jc_GLID_Category,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"Categories"},{jp_sName:this.jc_GLID_GeoArea,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"Areas"},{jp_sName:this.jc_GLID_GeoRegion,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"Regions"},{jp_sName:this.jc_GLID_GeoCity,jp_bTyp_Common:true,jp_bMandatory:false,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"Cities"},{jp_sName:this.jc_GLID_GeoCountry,jp_bTyp_Common:true,jp_bMandatory:false,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"Countries"},{jp_sName:this.jc_GLID_GeoState,jp_bTyp_Common:true,jp_bMandatory:false,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"States"},{jp_sName:this.jc_GLID_SummaryEnterprises,jp_bTyp_Common:true,jp_bMandatory:false,jp_bCacheAll:true,jp_sDescr:"Summary Enterprises"},{jp_sName:this.jc_GLID_PMetaSystemControl,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBIS,jp_sParent:this.jc_GLID_MetaSystemControl,jp_sDescr:"ControlPanels BasicInfo"},{jp_sName:this.jc_GLID_PCategory,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBIS,jp_sParent:this.jc_GLID_Category,jp_sDescr:"Categories BasicInfo"},{jp_sName:this.jc_GLID_PGeoArea,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBIS,jp_sParent:this.jc_GLID_GeoArea,jp_sDescr:"Areas BasicInfo"},{jp_sName:this.jc_GLID_PGeoRegion,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBIS,jp_sParent:this.jc_GLID_GeoRegion,jp_sDescr:"Regions BasicInfo"},{jp_sName:this.jc_GLID_PGeoCity,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBIS,jp_sParent:this.jc_GLID_GeoCity,jp_sDescr:"Cities BasicInfo"},{jp_sName:this.jc_GLID_PGeoCountry,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBIS,jp_sParent:this.jc_GLID_GeoCountry,jp_sDescr:"Countries BasicInfo"},{jp_sName:this.jc_GLID_PGeoState,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBIS,jp_sParent:this.jc_GLID_GeoState,jp_sDescr:"States BasicInfo"},{jp_sName:this.jc_GLID_NMetaSystemControl,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBID,jp_sParent:this.jc_GLID_MetaSystemControl,jp_sDescr:"ControlPanels DynamicInfo"},{jp_sName:this.jc_GLID_NCategory,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBID,jp_sParent:this.jc_GLID_Category,jp_sDescr:"Categories DynamicInfo"},{jp_sName:this.jc_GLID_NGeoArea,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBID,jp_sParent:this.jc_GLID_GeoArea,jp_sDescr:"Areas DynamicInfo"},{jp_sName:this.jc_GLID_NGeoRegion,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBID,jp_sParent:this.jc_GLID_GeoRegion,jp_sDescr:"Regions DynamicInfo"},{jp_sName:this.jc_GLID_NGeoCity,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBID,jp_sParent:this.jc_GLID_GeoCity,jp_sDescr:"Cities DynamicInfo"},{jp_sName:this.jc_GLID_NGeoCountry,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBID,jp_sParent:this.jc_GLID_GeoCountry,jp_sDescr:"Countries DynamicInfo"},{jp_sName:this.jc_GLID_NGeoState,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBID,jp_sParent:this.jc_GLID_GeoState,jp_sDescr:"States DynamicInfo"},{jp_sName:this.jc_GLID_FMetaSystemControl,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EI,jp_sParent:this.jc_GLID_MetaSystemControl,jp_sDescr:"ControlPanels Info"},{jp_sName:this.jc_GLID_FCategory,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EI,jp_sParent:this.jc_GLID_Category,jp_sDescr:"Categories Info"},{jp_sName:this.jc_GLID_FGeoArea,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EI,jp_sParent:this.jc_GLID_GeoArea,jp_sDescr:"Areas Info"},{jp_sName:this.jc_GLID_FGeoRegion,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EI,jp_sParent:this.jc_GLID_GeoRegion,jp_sDescr:"Regions Info"},{jp_sName:this.jc_GLID_FGeoCity,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EI,jp_sParent:this.jc_GLID_GeoCity,jp_sDescr:"Cities Info"},{jp_sName:this.jc_GLID_FGeoCountry,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EI,jp_sParent:this.jc_GLID_GeoCountry,jp_sDescr:"Countries Info"},{jp_sName:this.jc_GLID_FGeoState,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EI,jp_sParent:this.jc_GLID_GeoState,jp_sDescr:"States Info"},{jp_sName:this.jc_GLID_FSummaryEnterprises,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EI,jp_sParent:this.jc_GLID_SummaryEnterprises,jp_sDescr:"Summary Enterprises Info"},{jp_sName:this.jc_GLID_Enterprise,jp_bTyp_Main:true,jp_bMandatory:true,jp_sDescr:"Enterprises"},{jp_sName:this.jc_GLID_PEnterprise,jp_bTyp_Main:true,jp_bMandatory:true,jp_SubTable:this.jc_SubTable_EBIS,jp_sParent:this.jc_GLID_Enterprise,jp_sDescr:"Enterprises BasicInfo"},{jp_sName:this.jc_GLID_NEnterprise,jp_bTyp_Main:true,jp_bMandatory:true,jp_SubTable:this.jc_SubTable_EBID,jp_sParent:this.jc_GLID_Enterprise,jp_sDescr:"Enterprises DynamicInfo"},{jp_sName:this.jc_GLID_FEnterprise,jp_bTyp_Main:true,jp_bMandatory:true,jp_SubTable:this.jc_SubTable_EI,jp_sParent:this.jc_GLID_Enterprise,jp_sDescr:"Enterprises Info"}];this.jc_eidf_key="TEID";this.jc_eidf_xeidcc="f3x_xeidcc";this.jc_eidf_enty="f3x_enty";this.jc_eidf_enid="f3x_enid";this.jc_eidf_egty="f3x_egty";this.jc_eidf_egid="f3x_egid";this.jc_eidf_ucat="f3x_cU";this.jc_eidf_vcat="f3x_cV";this.jc_eidf_a="f3x_gnA";this.jc_eidf_z="f3x_gnZ";this.jc_eidf_n="f3x_gnN";this.jc_eidf_c="f3x_gnC";this.jc_eidf_p="f3x_gpP";this.jc_eidf_s="f3x_gpS";this.jc_ebisf_key="TEID";this.jc_ebisf_enty="f3x_enty";this.jc_ebisf_enid="f3x_enid";this.jc_ebisf_created="f3x_ucretime";this.jc_ebisf_modified="f3x_umodtime";this.jc_ebisf_order="f3x_esorder";this.jc_ebisf_sym="f3x_esym";this.jc_ebisf_color="f3x_escolor";this.jc_ebisf_lat="f3x_eslat";this.jc_ebisf_lon="f3x_eslon";this.jc_ebisf_name="f3x_esname";this.jc_ebisf_descr="f3x_esdescr";this.jc_ebisf_url="f3x_esurl";this.jc_ebidf_key="TEID";this.jc_ebidf_enty="f3x_enty";this.jc_ebidf_enid="f3x_enid";this.jc_ebidf_likes="f3x_likes";this.jc_ebidf_likesbonus="f3x_likesbonus";this.jc_ebidf_clicks="f3x_clicks";this.jc_ebidf_clicksphtime="f3x_clicksphtime";this.jc_ebidf_score="f3x_score";this.jc_eif_key="TEID";this.jc_eif_enty="f3x_enty";this.jc_eif_enid="f3x_enid";this.Init=function(jc_oStorage)
...
{this.jm_oDTStatus=new GLDataStatus();this.jm_oglHeader=null;this.jm_aoglr=new A3xaArray();this.jm_aaoglrSelect=new A3xaArray();this.jm_oglIxHeader=null;this.jm_bAX=true;this.jm_aoglrAX=null;this.jm_odb=(ji_oDatabase||null);this.NewHeader=GLDataTable_NewHeader;this.NewNames=GLDataTable_NewNames;this.NewRecord=function()
...
return new GLRecord();return null;};this.NewIndexHeader=GLDataTable_NewIndexHeader;this.NewIndex=GLDataTable_NewIndex;this.NewGTHeader=GLDataTable_NewGTHeader;this.NewGT=GLDataTable_NewGT;this.Get_Header=GLDataTable_Get_Header;this.Get_IxHeader=GLDataTable_Get_IxHeader;this.Get_Index=GLDataTable_Get_Index;this.Get_Glid=GLDataTable_Get_Glid;this.Set_Glid=GLDataTable_Set_Glid;this.StoreToGLS=GLDataTable_StoreToGLS;this.LoadFromGLS=GLDataTable_LoadFromGLS;this.LoadRecordsFromGLS=GLDataTable_LoadRecordsFromGLS;this.Get_FieldNames=GLDataTable_Get_FieldNames;this.Get_CountRecords=function()
{var jt_oglIx=this.Get_Index();if(!jt_oglIx)
return 0;var jt_aIndex=jt_oglIx.Get_Record_Array();if(!jt_aIndex||jt_aIndex.length<=1)
return 0;return jt_aIndex.length-1;};this.IndirectIndex_2_PrimaryKey=function(ji_IndirectIndex)
{var jt_oglIx=this.Get_Index();if(!jt_oglIx)
return null;var jr_id=jt_oglIx.Get_Id(ji_IndirectIndex);return jr_id;};this.LoadRecordFromGLS=GLDataTable_LoadRecordFromGLS;this.CheckRecordsStatus=GLDataTable_CheckRecordsStatus;this.OnTransactionError=GLDataTable_OnTransactionError;this.OnTransactionComplete=GLDataTable_OnTransactionComplete;this.CheckLoadTableStatus=GLDataTable_CheckLoadTableStatus;this.SetupLoadedRecords=function(ji_ogldtParent){return this.GLDataTable_SetupLoadedRecords(ji_ogldtParent);};this.GLDataTable_SetupLoadedRecords=function(ji_ogldtParent)
...
{return this.jm_aaoglrSelect.Get_Item(ji_sSelectName||"DefaultSelect")||new A3xaArrayIt(this.Get_Recordset());};this.ClearGLSAndFail=GLDataTable_ClearGLSAndFail;this.Get_Database=GLDataTable_Get_Database;this.Get_Storage=GLDataTable_Get_Storage;if(this.jm_odb&&ji_glid)
...
{var jt_this=this;var jt_sGlid=this.Get_Glid();var jt_oglNames=this.jm_oglHeader.Get_FieldNames();var jt_oglIx=this.jm_oglIxHeader.Get_Recordset();this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreInProgress);if(!this.jm_oglHeader.StoreToGLS(ji_oDbTransaction))
...
this.jm_oglHeader=jt_oglHeader;this.jm_oglHeader.Set_FieldNames(jt_oglNames);this.jm_oglHeader.Set_Recordset(null);this.jm_oglIxHeader=jt_oglIxHeader;this.jm_oglIxHeader.Set_Recordset(jt_oglIx);return true;}
...
{this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_LoadFail,"Load Records Cache");return false;}
var jt_glid=this.Get_Glid();var jt_nRecords=this.Get_CountRecords();jg_oe.CanLogInfo()&&jg_oe.LogInfo("GLDataTable_LoadRecordsFromGLS: p2="+jt_nRecords);if(!(jt_nRecords>0))
...
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("GLDataTable_CheckRecordsStatus: "+this.Get_Glid()+" null Record="+jt_id);if(jr_odtStatus.Get()==jg_oe.jc_oA3xaDbZero.jc_DTStatus_LoadedRecord)
...
{if(!jr_o3x2a.ar.addItem(ji_fnKeyMaker(jr_I._get3x2Record(i)),i))
{return null;}}
...
{var jr_I={addTables:function(){return false;},addD3xTable:function(ji_sdsTable){return null;},get3x2Table:function(ji_glid,ji_name,ji_type){return null;}};return jr_I;}
...
{var jr_o3x2tb=A3xa2StaticDataSource_Table(ji_sdsTable);if(!(jr_o3x2tb&&jr_o3x2tb.tb.isValid()))
return null;var jt_glid=jr_o3x2tb.tb.getGlid();var jt_name=jr_o3x2tb.tb.getName();var jt_type=jr_o3x2tb.tb.getType();var jt_id=jt_glid+","+jt_type;if(!jr_o.jm_o3x2a.ar.addItem(jt_id,jr_o3x2tb))
...
function A3xa2IDTCacheStoreWriter()
{var jr_I={setDataTable:function(ji_odt){return false;},writeTable:function(){return false;},writeHeader:function(){return false;},writeNames:function(){return false;},writeRecordset:function(){return false;},writeIxIndex:function(){return false;},integrityCheck:function(){return null;}};return jr_I;}
function A3xa2IDTCacheStoreWriterExec()
{var jr_I={checkDataSource:function(){return false;},writeHeader:function(){return false;},writeNames:function(){return false;},writeRecord:function(){return false;},iseof:function(){return true;},resetRecord:function(){return false;},nextRecord:function(){return false;}};return jr_I;}
function A3xa2DTCacheStoreWriter(ji_odt,ji_odb,ji_glid)
{var jr_o={jm_odb:null,jm_glid:null,jm_oglHeader:null,jm_a3x2oglr:null,jm_oglIxHeader:null,jm_odt:null,csw:A3xa2IDTCacheStoreWriter(),_cswxec:A3xa2IDTCacheStoreWriterExec(),_Construct:function(ji_odt,ji_odb,ji_glid)
{if(ji_glid)
ji_glid=jg_oe.jc_oA3xaDbZero.XGlid2Glid(ji_glid);else if(ji_odt)
ji_glid=ji_odt.Get_Glid();jr_o.jm_odb=ji_odb;jr_o.jm_glid=ji_glid;jr_o.csw.setDataTable(ji_odt);}};jr_o.csw.setDataTable=function(ji_odt){jr_o.jm_odt=ji_odt;return true;};jr_o.csw.writeTable=function()
{if(!(jr_o.jm_glid))
...
jr_o.jm_odt.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_Empty);jr_o.jm_odt.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheInProgress);if(!jr_o.csw.writeHeader())
{if(jr_o.jm_odb)
...
{if(jr_o.jm_odb)
jr_o.jm_odb.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Cache Tableset Cache "+jr_o.jm_glid);return false;}
if(!jr_o.csw.writeIxIndex())
{if(jr_o.jm_odb)
jr_o.jm_odb.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Cache Tableset Cache "+jr_o.jm_glid);return false;}
jr_o.jm_odt.jm_oglHeader=jr_o.jm_oglHeader;jr_o.jm_odt.jm_aoglr=new A3xaArray(jr_o.jm_a3x2oglr);jr_o.jm_odt.jm_oglIxHeader=jr_o.jm_oglIxHeader;jr_o.jm_odt.jm_oDTStatus.SetFrom(jr_o.csw.integrityCheck());return(jr_o.jm_odt.jm_oDTStatus.Get()==jg_oe.jc_oA3xaDbZero.jc_DTStatus_Cached);};jr_o.csw.writeHeader=function()
...
return true;};jr_o.csw.writeIxIndex=function()
{var jt_oglNames=jr_o.jm_oglHeader.Get_FieldNames();var jt_sKeyName=jt_oglNames.Get_KeyName();jr_o.jm_oglIxHeader=jr_o.jm_odt.NewIndexHeader();jr_o.jm_oglIxHeader.Set_Record_Array(jr_o.jm_glid,null,new Array(jr_o.jm_oglHeader.Get_Release()));if(!jr_o.jm_oglIxHeader.IsValid())
{jr_o.jm_odt.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Index Header not valid");return false;}
var jt_aIndex=new Array();jt_aIndex.push(jt_sKeyName);for(var ix2=0;ix2<jr_o.jm_a3x2oglr.ar.getCount();ix2++)
{var jt_id=jr_o.jm_a3x2oglr.ar.getKey(ix2);if(!jt_id)
{jr_o.jm_odt.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Index lost key");return false;}
jt_aIndex.push(jt_id);}
var jt_oglIx=jr_o.jm_odt.NewIndex();jt_oglIx.Set_Record_Array(jr_o.jm_glid,1,jt_aIndex);if(!jt_oglIx.IsValid())
{jr_o.jm_odt.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Index not valid");return false;}
jr_o.jm_oglIxHeader.Set_Recordset(jt_oglIx);return true;};jr_o.csw.integrityCheck=function()
...
return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Missing Field Names");if(!(jr_o.jm_odt.jm_oglIxHeader&&jr_o.jm_odt.jm_oglIxHeader.IsValid()))
return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Index Header not valid");var jt_oglIx=jr_o.jm_odt.jm_oglIxHeader.Get_Recordset();if(!jt_oglIx)
...
function A3xa2DTCacheStoreWriter_GLRS(ji_odt,ji_odb,ji_glid,ji_sGLRS)
{var jr_o=A3xa2DTCacheStoreWriter(ji_odt,ji_odb,ji_glid);jr_o.jm_aglRS=null;jr_o.jm_dsindex=-1;if(ji_sGLRS)
jr_o.jm_aglRS=ji_sGLRS.split(jg_oe.jc_oA3xaDbZero.jc_GLSep_Block);jr_o._cswxec.checkDataSource=function(){return(jr_o.jm_aglRS?true:false);};jr_o._cswxec.writeHeader=function()
...
function A3xa2DTCacheStoreWriter_sds(ji_odt,ji_odb,ji_glid,ji_keyname)
{var jr_o=A3xa2DTCacheStoreWriter(ji_odt,ji_odb,ji_glid);jr_o.jm_o3x2tbe=null;jr_o.jm_dsindex=-1;jr_o.jm_dscount=0;jr_o.jm_dskeyname=(ji_keyname||"");jr_o._cswxec.checkDataSource=function(){return!!jr_o.jm_o3x2tbe;};jr_o._cswxec.writeHeader=function()
...
return false;var jt_akrec=[jt_oInfoRecord.key].concat(jt_oInfoRecord.rec||[]);return ji_oglRecord.Set_Record_Array(jr_o.jm_glid,jt_oInfoRecord.key,ji_oglRecord.ConvertSpecialChars(jt_akrec));};jr_o.jm_o3x2tbe=null;if(jr_o.jm_odb&&jr_o.jm_odb.Get_SDSDB()&&jr_o.jm_glid)
jr_o.jm_o3x2tbe=jr_o.jm_odb.Get_SDSDB().db.get3x2Table(jr_o.jm_glid,null,null);return jr_o;}
...
{return jg_oe.Get_Storage(ji_StorageType);};this.Open=A3xaDatabase_Open;this.IsOpen=A3xaDatabase_IsOpen;this.IsOpening=A3xaDatabase_IsOpening;this.LoadSchemaDefault=function(){return true;};this.LoadSchemaStore=function(){return true;};this.LoadSchemaLoad=function(){return true;};this.OpenTransaction=A3xaDatabase_OpenTransaction;this.StoreAllData=A3xaDatabase_StoreAllData;this.CheckCache=A3xaDatabase_CheckCache;this.ClearStored=A3xaDatabase_ClearStored;this.StoreCache=A3xaDatabase_StoreCache;this.jm_o3x2sdsdb=null;this.Set_SDSDB=function(ji_o3x2sdsdb){this.jm_o3x2sdsdb=ji_o3x2sdsdb;return true;};this.Get_SDSDB=function(){return this.jm_o3x2sdsdb;};this.jm_oDbSchema=(ji_oDbSchema||null);this.jm_oDTStatus=new GLDataStatus();this.jm_moreOnStoreAllData=0;this.jm_aoDTStatus_TableToClear=null;this.jm_aoglDataTableStore=new A3xaArray();this.jm_aoglDataTableLoad_Common=new A3xaArray();this.jm_aoglDataTableLoad_ExtHeader=new A3xaArray();this.jm_aoglDataTableLoad_Main=new A3xaArray();this.jm_aoglDataTableLoad_Dependent=new A3xaArray();this.jm_aoglDataTableLoad_TurboHeader=new A3xaArray();this.jm_odbTransaction=null;this.MirrorToTurboHeaders=function()
...
jg_oe.LogStatusBar2(new A3xaString(["Storing... "+this.jm_oDbSchema.Get_Descr(jt_ogldt.Get_Glid()),"Almacenamiento... "+this.jm_oDbSchema.Get_Descr(jt_ogldt.Get_Glid()),"Armazenando... "+this.jm_oDbSchema.Get_Descr(jt_ogldt.Get_Glid()),"Memorizzando... "+this.jm_oDbSchema.Get_Descr(jt_ogldt.Get_Glid())]),true);jt_oDbTransaction.UsingTable(jt_ogldt.Get_Glid());var jt_o3x2dtcsw=A3xa2DTCacheStoreWriter(jt_ogldt);var jt_oDTStatus2=jt_o3x2dtcsw.csw.integrityCheck();if(!(jt_oDTStatus2&&jt_oDTStatus2.Get()==jg_oe.jc_oA3xaDbZero.jc_DTStatus_Cached))
...
{var jr_I={};return jr_I;}
function A3xa2StaticDataSource_TableEntity(ji_o3x2tb_eid,ji_o3x2tb_ebis,ji_o3x2tb_ebid,ji_o3x2tb_ei)
{var jr_o={jm_o3x2tb_eid:ji_o3x2tb_eid,jm_o3x2tb_ebis:ji_o3x2tb_ebis,jm_o3x2tb_ebid:ji_o3x2tb_ebid,jm_o3x2tb_ei:ji_o3x2tb_ei,jm_o3x2key_eid:null,jm_o3x2key_ebis:null,jm_o3x2key_ebid:null,jm_o3x2key_ei:null,tb:A3xa2IStaticDataSource_Table(),};jr_o.tb.getFieldNames=function()
{var jt_aFieldNames_eid=null;var jt_aFieldNames_ebis=null;var jt_aFieldNames_ei=null;jt_aFieldNames_eid=jr_o.jm_o3x2tb_eid.tb.getFieldNames();if(!jt_aFieldNames_eid)
return null;if(jr_o.jm_o3x2tb_ebis)
jt_aFieldNames_ebis=jr_o.jm_o3x2tb_ebis.tb.getFieldNames();if(jr_o.jm_o3x2tb_ei)
jt_aFieldNames_ei=jr_o.jm_o3x2tb_ei.tb.getFieldNames();return jt_aFieldNames_eid.concat(jt_aFieldNames_ebis||[],jt_aFieldNames_ei||[]);};jr_o.tb.getFields2=function(ji_ixRecord,ji_keyname)
{if(!(ji_ixRecord>=0))
return null;var jt_aRecord_eid=null;var jt_aRecord_ebis=null;var jt_aRecord_ebid=null;var jt_aRecord_ei=null;var jt_joiningKey=null;if(jr_o.jm_o3x2key_eid)
jt_joiningKey=jr_o.jm_o3x2key_eid.ar.getKey(ji_ixRecord);if(!jt_joiningKey)
return null;var jt_ix_eid=ji_ixRecord;var jt_ix_ebis=(jr_o.jm_o3x2key_ebis?jr_o.jm_o3x2key_ebis.ar.getItem(jt_joiningKey):-1);if(jt_ix_ebis===null)
jt_ix_ebis=-1;var jt_ix_ebid=(jr_o.jm_o3x2key_ebid?jr_o.jm_o3x2key_ebid.ar.getItem(jt_joiningKey):-1);if(jt_ix_ebid===null)
jt_ix_ebid=-1;var jt_ix_ei=(jr_o.jm_o3x2key_ei?jr_o.jm_o3x2key_ei.ar.getItem(jt_joiningKey):-1);if(jt_ix_ei===null)
jt_ix_ei=-1;if(jr_o.jm_o3x2tb_eid)
jt_aRecord_eid=jr_o.jm_o3x2tb_eid.tb.getFields(jt_ix_eid);if(!jt_aRecord_eid)
return false;if(jr_o.jm_o3x2tb_ebis&&jt_ix_ebis>=0)
jt_aRecord_ebis=jr_o.jm_o3x2tb_ebis.tb.getFields(jt_ix_ebis);if(jr_o.jm_o3x2tb_ebid&&jt_ix_ebid>=0)
jt_aRecord_ebid=jr_o.jm_o3x2tb_ebid.tb.getFields(jt_ix_ebid);if(jr_o.jm_o3x2tb_ei&&jt_ix_ei>=0)
jt_aRecord_ei=jr_o.jm_o3x2tb_ei.tb.getFields(jt_ix_ei);return{key:jt_joiningKey,rec:jt_aRecord_eid.concat(jt_aRecord_ebis||[],jt_aRecord_ebid||[],jt_aRecord_ei||[])};};jr_o.tb.getVersion=function(){return jr_o.jm_o3x2tb_eid?jr_o.jm_o3x2tb_eid.tb.getVersion():0;};jr_o.tb.getCountOfRecords=function(){return jr_o.jm_o3x2key_eid?jr_o.jm_o3x2key_eid.ar.getCount():0;};if(jr_o.jm_o3x2tb_eid)
jr_o.jm_o3x2key_eid=jr_o.jm_o3x2tb_eid.tb.getIndex(jg_oe.jc_oA3xaDbZero.jc_eidf_key);if(jr_o.jm_o3x2tb_ebis)
jr_o.jm_o3x2key_ebis=jr_o.jm_o3x2tb_ebis.tb.getIndex(jg_oe.jc_oA3xaDbZero.jc_ebisf_key);if(jr_o.jm_o3x2tb_ebid)
jr_o.jm_o3x2key_ebid=jr_o.jm_o3x2tb_ebid.tb.getIndex(jg_oe.jc_oA3xaDbZero.jc_ebidf_key);if(jr_o.jm_o3x2tb_ei)
jr_o.jm_o3x2key_ei=jr_o.jm_o3x2tb_ei.tb.getIndex(jg_oe.jc_oA3xaDbZero.jc_eif_key);return jr_o;}
...
return null;if(jr_o3x2tb.tb.getType()=="t3x_eid")
{if(!jr_o3x2tb.tb.buildIndex(jg_oe.jc_oA3xaDbZero.jc_eidf_key,function(ji_o3x2Record)
{var jt_o3xxeid=new A3xaXEID();if(!jt_o3xxeid.Set_CompactCode(ji_o3x2Record.rec.getFieldValue_ByName(jg_oe.jc_oA3xaDbZero.jc_eidf_xeidcc)))
return null;var jr_key=jt_o3xxeid.Get_PrimaryKey();return jr_key;}))
return null;}
else if(jr_o3x2tb.tb.getType()=="t3x_ebis")
...
return null;}
else if(jr_o3x2tb.tb.getType()=="t3x_ei")
{if(!jr_o3x2tb.tb.buildIndex(jg_oe.jc_oA3xaDbZero.jc_eif_key,function(ji_o3x2Record)
...
{if(ji_type)
return jr_o.db._dbeparent_get3x2Table(ji_glid,ji_name,ji_type);if(ji_glid==jg_oe.jc_oA3xaDbZero.jc_GLID_PMetaSystemControl)
return jr_o.db._dbeparent_get3x2Table(ji_glid,ji_name,"t3x_ebis");if(ji_glid==jg_oe.jc_oA3xaDbZero.jc_GLID_FMetaSystemControl)
return jr_o.db._dbeparent_get3x2Table(ji_glid,ji_name,"t3x_ei");return A3xa2StaticDataSource_TableEntity(jr_o.db._dbeparent_get3x2Table(ji_glid,ji_name,"t3x_eid"),jr_o.db._dbeparent_get3x2Table(ji_glid,ji_name,"t3x_ebis"),jr_o.db._dbeparent_get3x2Table(ji_glid,ji_name,"t3x_ebid"),jr_o.db._dbeparent_get3x2Table(ji_glid,ji_name,"t3x_ei"));};jr_o.db.addTables=function()
...
function A3xaDbZero()
{A3xaDatabase.call(this,new A3xaDbSchema(jg_oe.jc_oA3xaDbZero.jc_sDbName,jg_oe.jc_oA3xaDbZero.jc_DbVersion,jg_oe.jc_oA3xaDbZero.jc_sDbDefaultPrimaryKeyName,jg_oe.jc_oA3xaDbZero.jc_aSchemaTables));var jt_o3x2sdsdb=A3xa2SDS_DbEntity();jt_o3x2sdsdb.db.addTables();this.Set_SDSDB(jt_o3x2sdsdb);this.GLID2Typ=function(ji_GLID)
...
jt_sKeyName=jt_oglNames.Get_KeyName();var jt_oa3xRecordset=this.Get_Recordset();var jt_aoglrAX=new A3xaArray();if(this.jm_bAX&&jt_sKeyName)
...
if(jg_oe.jc_oA3xaDbZero.XGlid2Glid(ji_glid)==jg_oe.jc_oA3xaDbZero.jc_GLID_MetaSystemControl)
{var jt_o3x2dtcsw=A3xa2DTCacheStoreWriter_sds(null,this.Get_Database(),ji_glid,jg_oe.jc_oA3xaDbZero.jc_eidf_key);jr_b=jt_o3x2dtcsw.csw.writeTable();var jt_o3x2dtcsw_ebis=A3xa2DTCacheStoreWriter_sds(null,this.Get_Database(),jg_oe.jc_oA3xaDbZero.jc_GLID_PMetaSystemControl,jg_oe.jc_oA3xaDbZero.jc_ebisf_key);jt_o3x2dtcsw_ebis.csw.writeTable();var jt_o3x2dtcsw_ei=A3xa2DTCacheStoreWriter_sds(null,this.Get_Database(),jg_oe.jc_oA3xaDbZero.jc_GLID_FMetaSystemControl,jg_oe.jc_oA3xaDbZero.jc_eif_key);jt_o3x2dtcsw_ei.csw.writeTable();}
else
{var jt_o3x2dtcsw=A3xa2DTCacheStoreWriter_GLRS(null,this.Get_Database(),ji_glid,ji_sGLRS);jr_b=jt_o3x2dtcsw.csw.writeTable();}}}
catch(e)
