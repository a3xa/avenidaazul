...
{this.jc_MaxViewRows=50;this.jc_Col_IdTag=1;this.jc_Col_LandIcons=2;this.jc_Col_CtrlInfoIcons=3;this.jc_Col_Identity=4;this.jc_Col_Info=5;this.jc_Col_Last=6;}
...
return false;var jt_ociPanel=new A3xaPanelControlIcons(null,-1,ji_Row,ji_Col,true,true);var jt_oBtnTurbo=jt_ociPanel.Get_Button("Turbo");jt_oBtnTurbo.PrintHtml(qi_oCell);this.PrintHtml_IconsQuery(qi_oCell,ji_Row,ji_Col);if(!this.PrintHtml_ControlIconsBox_Footer(qi_oCell,ji_Row,ji_Col))
return false;this.PrintHtml_IconsAdminBox(qi_oCell,ji_Row,ji_Col);this.PrintHtml_InfoIconsBox(qi_oCell,ji_Row,ji_Col);return true;};this.PrintHtml_CtrlLikes=function(qi_oCell,ji_Row,ji_Col){return true;};this.PrintHtml_IconsQuery=function(qi_oCell,ji_Row,ji_Col)
...
jg_oe.jc_oA3xaDbZero.jc_GLMID_AX);jt_oHostReporter.Set_ExecDevice(jt_oExecPanel);var jt_bSingle=false;var jt_oxur=null;var jt_oAppXUR=jg_oApp.Get_AppXUR();if(jt_oAppXUR)
...
{this.Set_Options_Header(110,null,null,null,null,null);this.Set_Options_Body(110,null,"top","none","none");}
else if(this.jm_Col==jg_oe.jc_oHtml.jc_Col_Identity)
{this.Set_Options_Header(210,null,null,null,null,null);this.Set_Options_Body(210,"1px","top","none","none");this.Set_Options_Header_Bkgnd(jt_sBgColor);}
