...
{var jt_this=this;this.jm_nRows=null;this.jm_TimerLoPry=null;this.jm_bReleased=false;this.jm_o3xxeCP=null;this.jm_o3xehfCP=null;this.jm_o3xehCP=null;this.jm_ao3xehf=new Array();this.jm_ao3xeh=new Array();this.Release=function(ji_bClearHtml)
...
jg_oe.CanLogInfo({VW:4})&&jg_oe.LogInfo("OK","","A3xaHtmlEntitySet.Release");return true;};this.HasCP=function(){return this.jm_o3xxeCP&&this.jm_o3xehfCP&&this.jm_o3xehCP;};this.AbortPrintHtmlLowPriority=function(ji_bClearHtml,ji_bClearCP)
{var jt_o3xAppWindow=new A3xaAppWindow();jt_o3xAppWindow.Stop();this.jm_TimerLoPry=null;return true;}
this.Init=function()
{this.jm_o3xxeCP=null;this.jm_o3xehfCP=null;this.jm_o3xehCP=null;this.jm_ao3xehf=new Array();this.jm_ao3xeh=new Array();var jt_ogldtMain=null;var jt_odb=jg_oe.Get_Database();if(jt_odb)
jt_ogldtMain=jt_odb.Get_MainDataTable();var jt_o3xxeCP=jt_odb.Get_3xXEMSC_ByXUR();if(jt_o3xxeCP)
this.jm_o3xxeCP=jt_o3xxeCP;var jt_nRows=0;var jt_aoglr=null;if(jt_ogldtMain)
jt_aoglr=jt_ogldtMain.Get_Recordsel();if(jt_aoglr)
jt_nRows=jt_aoglr.Get_Count();this.jm_nRows=jt_nRows;if(jt_nRows>0||jt_o3xxeCP)
return true;return false;};this.PrintHtmlFrameCP=function()
{var jt_odb=jg_oe.Get_Database();if(!jt_odb)
return false;if(!this.jm_o3xxeCP)
return false;jg_oe.CanLogInfo()&&jg_oe.LogInfo("PrintHtml-CP row:1");var jt_o3xehf=new A3xaEntity_HtmlFrame(1);jt_o3xehf.Set_XtdEntity(this.jm_o3xxeCP);this.jm_o3xehfCP=jt_o3xehf;jt_o3xehf.PrintHtml();return true;};this.PrintHtmlContentsCP=function(ji_bLowPriority)
{var jt_odb=jg_oe.Get_Database();if(!jt_odb)
return false;if(!this.jm_o3xxeCP)
return false;var jt_o3xehf=this.jm_o3xehfCP;var jt_o3xeh=new A3xaECP_Mgr(this.jm_o3xxeCP,jt_o3xehf);jg_oApp.jm_oecp=jt_o3xeh;this.jm_o3xehCP=jt_o3xeh;jt_o3xeh.PrintHtml(true);jt_o3xeh.PrintHtml(false,false);return true;};this.PrintHtmlFrame=function()
...
{var jt_bCP=this.PrintHtmlContentsCP(ji_bLowPriority);if(!(this.jm_nRows>0))
...
{if(jt_this.jm_o3xehCP)
jt_this.jm_o3xehCP.PrintHtml(false,true);for(var i=0;i<jt_ehCount;i++)
