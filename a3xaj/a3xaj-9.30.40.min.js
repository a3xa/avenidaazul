...
function A3xa2Array()
{var jr_o={jm_aa:{},jm_ax:[],ar:A3xa2IArray()};jr_o.ar.getCount=function(){return(jr_o.jm_ax&&jr_o.jm_aa)?jr_o.jm_ax.length:0;};jr_o.ar.setItem=function(ji_key,ji_value)
{if(!ji_key)
...
return false;if(ji_value==null)
return false;if(jr_o.jm_aa&&jr_o.jm_aa[ji_key]!=null)
return false;jr_o.jm_aa[ji_key]=ji_value;jr_o.jm_ax.push(ji_key);return true;};jr_o.ar.getItem=function(ji_key)
{if(!ji_key)
...
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("Begin","","A3xaTaskManager.Task");var jt_oDTStatusNext=jt_this._CheckStatus();if(!jt_oDTStatusNext)
{jt_this.jm_Semaph--;return true;}
jg_oe.CanLogInfo()&&jg_oe.LogInfo("DTSNext-Descr"+jt_oDTStatusNext.Get_Descr2(),"","A3xaTaskManager.Task");if(jt_oDTStatusNext.IsDone())
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("IsDone","","A3xaTaskManager.Task");jt_this.jm_oDTStatus.SetFrom(jt_this._OnEnd(jt_oDTStatusNext));this.Release();return true;}
jt_this.jm_Semaph--;}
...
{if(!ji_glid)
return"";var jt_c=ji_glid.charAt(0);if(jt_c=='R')
return this.jc_tbtype_eid;if(jt_c=='P')
return this.jc_tbtype_ebis;if(jt_c=='N')
return this.jc_tbtype_ebid;if(jt_c=='F')
return this.jc_tbtype_ei;return"";};this.IsGlidEnterprise=function(ji_glid,ji_tbtype)
...
return true;var jt_c=jt_gliddflt.charAt(0);if(jt_c=='R'&&ji_tbtype==this.jc_tbtype_eid)
return true;if(jt_c=='P'&&ji_tbtype==this.jc_tbtype_ebis)
return true;if(jt_c=='N'&&ji_tbtype==this.jc_tbtype_ebid)
return true;if(jt_c=='F'&&ji_tbtype==this.jc_tbtype_ei)
return true;return false;};this.jc_SubTable_EID=1;this.jc_SubTable_EBIS=2;this.jc_SubTable_EBID=4;this.jc_SubTable_EI=8;this.jc_sEifaName="f3x_ei";this.jc_Eifa_Typ=0;this.jc_Eifa_Cod=1;this.jc_Eifa_Id=2;this.jc_Eifa_IdParent=3;this.jc_Eifa_Info=4;this.jc_DTStatus2_StSuccess=1;this.jc_DTStatus2_StFail=4;this.jc_DTStatus2_StEmpty=5;this.jc_DTStatus2_StInProgress=6;this.jc_DTStatus2_StOpen=8;this.jc_DTStatus2_StReady=9;this.jc_DTStatus2_OpCache=10;this.jc_DTStatus2_OpClear=20;this.jc_DTStatus2_OpStore=30;this.jc_DTStatus2_OpLoad=40;this.jc_DTStatus2_TgTable=100;this.jc_DTStatus2_TgTableHeader=200;this.jc_DTStatus2_TgTableHX=300;this.jc_DTStatus2_TgRecord=400;this.jc_DTStatus2_TgCommonTable=1000;this.jc_DTStatus2_TgMainTable=2000;this.jc_DTStatus2_TgDependentTable=3000;this.jc_DTStatus2_TgExtTableHeader=4000;this.jc_DTStatus_Empty=0;this.jc_DTStatus_Cached=1;this.jc_DTStatus_CacheFail=4;this.jc_DTStatus_CacheInProgress=6;this.jc_DTStatus_Loaded=21;this.jc_DTStatus_LoadedRecord=22;this.jc_DTStatus_LoadedTable=23;this.jc_DTStatus_LoadFail=24;this.jc_DTStatus_LoadEmpty=25;this.jc_DTStatus_LoadRecordInProgress=26;this.jc_DTStatus_LoadTableInProgress=27;this.jc_DTStatus_LoadOpen=29;this.jc_DTStatus_Stored=31;this.jc_DTStatus_StoreFail=34;this.jc_DTStatus_StoreEmpty=35;this.jc_DTStatus_StoreInProgress=36;this.jc_DTStatus_StoreOpen=39;this.jc_DTStatus_Cleared=41;this.jc_DTStatus_ClearFail=44;this.jc_DTStatus_ClearInProgress=46;this.jc_DTStatus_ClearOpen=49;this.jc_DbVersion=33;this.jc_sDbDefaultPrimaryKeyName="xkey";this.jc_sDbName="A3xaDbZeroA";this.jc_aSchemaTables=[{jp_sName:this.jc_GLID_MetaSystemControl,jp_bTyp_Common:true,jp_bJSDS:true,jp_bMandatory:true,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"ControlPanels"},{jp_sName:this.jc_GLID_Category,jp_bTyp_Common:true,jp_bJSDS:true,jp_bMandatory:true,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"Categories"},{jp_sName:this.jc_GLID_GeoArea,jp_bTyp_Common:true,jp_bJSDS:true,jp_bMandatory:true,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"Areas"},{jp_sName:this.jc_GLID_GeoRegion,jp_bTyp_Common:true,jp_bJSDS:true,jp_bMandatory:true,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"Regions"},{jp_sName:this.jc_GLID_GeoCity,jp_bTyp_Common:true,jp_bJSDS:true,jp_bMandatory:false,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"Cities"},{jp_sName:this.jc_GLID_GeoCountry,jp_bTyp_Common:true,jp_bJSDS:true,jp_bMandatory:false,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"Countries"},{jp_sName:this.jc_GLID_GeoState,jp_bTyp_Common:true,jp_bJSDS:true,jp_bMandatory:false,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"States"},{jp_sName:this.jc_GLID_PMetaSystemControl,jp_bTyp_Common:true,jp_bJSDS:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBIS,jp_sParent:this.jc_GLID_MetaSystemControl,jp_sDescr:"ControlPanels BasicInfo"},{jp_sName:this.jc_GLID_PCategory,jp_bTyp_Common:true,jp_bJSDS:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBIS,jp_sParent:this.jc_GLID_Category,jp_sDescr:"Categories BasicInfo"},{jp_sName:this.jc_GLID_PGeoArea,jp_bTyp_Common:true,jp_bJSDS:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBIS,jp_sParent:this.jc_GLID_GeoArea,jp_sDescr:"Areas BasicInfo"},{jp_sName:this.jc_GLID_PGeoRegion,jp_bTyp_Common:true,jp_bJSDS:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBIS,jp_sParent:this.jc_GLID_GeoRegion,jp_sDescr:"Regions BasicInfo"},{jp_sName:this.jc_GLID_PGeoCity,jp_bTyp_Common:true,jp_bJSDS:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBIS,jp_sParent:this.jc_GLID_GeoCity,jp_sDescr:"Cities BasicInfo"},{jp_sName:this.jc_GLID_PGeoCountry,jp_bTyp_Common:true,jp_bJSDS:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBIS,jp_sParent:this.jc_GLID_GeoCountry,jp_sDescr:"Countries BasicInfo"},{jp_sName:this.jc_GLID_PGeoState,jp_bTyp_Common:true,jp_bJSDS:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBIS,jp_sParent:this.jc_GLID_GeoState,jp_sDescr:"States BasicInfo"},{jp_sName:this.jc_GLID_NMetaSystemControl,jp_bTyp_Common:true,jp_bJSDS:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBID,jp_sParent:this.jc_GLID_MetaSystemControl,jp_sDescr:"ControlPanels DynamicInfo"},{jp_sName:this.jc_GLID_NCategory,jp_bTyp_Common:true,jp_bJSDS:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBID,jp_sParent:this.jc_GLID_Category,jp_sDescr:"Categories DynamicInfo"},{jp_sName:this.jc_GLID_NGeoArea,jp_bTyp_Common:true,jp_bJSDS:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBID,jp_sParent:this.jc_GLID_GeoArea,jp_sDescr:"Areas DynamicInfo"},{jp_sName:this.jc_GLID_NGeoRegion,jp_bTyp_Common:true,jp_bJSDS:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBID,jp_sParent:this.jc_GLID_GeoRegion,jp_sDescr:"Regions DynamicInfo"},{jp_sName:this.jc_GLID_NGeoCity,jp_bTyp_Common:true,jp_bJSDS:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBID,jp_sParent:this.jc_GLID_GeoCity,jp_sDescr:"Cities DynamicInfo"},{jp_sName:this.jc_GLID_NGeoCountry,jp_bTyp_Common:true,jp_bJSDS:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBID,jp_sParent:this.jc_GLID_GeoCountry,jp_sDescr:"Countries DynamicInfo"},{jp_sName:this.jc_GLID_NGeoState,jp_bTyp_Common:true,jp_bJSDS:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EBID,jp_sParent:this.jc_GLID_GeoState,jp_sDescr:"States DynamicInfo"},{jp_sName:this.jc_GLID_FMetaSystemControl,jp_bTyp_Common:true,jp_bJSDS:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EI,jp_sParent:this.jc_GLID_MetaSystemControl,jp_sDescr:"ControlPanels Info"},{jp_sName:this.jc_GLID_FCategory,jp_bTyp_Common:true,jp_bJSDS:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EI,jp_sParent:this.jc_GLID_Category,jp_sDescr:"Categories Info"},{jp_sName:this.jc_GLID_FGeoArea,jp_bTyp_Common:true,jp_bJSDS:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EI,jp_sParent:this.jc_GLID_GeoArea,jp_sDescr:"Areas Info"},{jp_sName:this.jc_GLID_FGeoRegion,jp_bTyp_Common:true,jp_bJSDS:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EI,jp_sParent:this.jc_GLID_GeoRegion,jp_sDescr:"Regions Info"},{jp_sName:this.jc_GLID_FGeoCity,jp_bTyp_Common:true,jp_bJSDS:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EI,jp_sParent:this.jc_GLID_GeoCity,jp_sDescr:"Cities Info"},{jp_sName:this.jc_GLID_FGeoCountry,jp_bTyp_Common:true,jp_bJSDS:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EI,jp_sParent:this.jc_GLID_GeoCountry,jp_sDescr:"Countries Info"},{jp_sName:this.jc_GLID_FGeoState,jp_bTyp_Common:true,jp_bJSDS:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EI,jp_sParent:this.jc_GLID_GeoState,jp_sDescr:"States Info"},{jp_sName:this.jc_GLID_SummaryEnterprises,jp_bTyp_Common:true,jp_bJSDS:true,jp_bMandatory:false,jp_bCacheAll:true,jp_sDescr:"Summary Enterprises"},{jp_sName:this.jc_GLID_FSummaryEnterprises,jp_bTyp_Common:true,jp_bJSDS:true,jp_bCacheAll:true,jp_SubTable:this.jc_SubTable_EI,jp_sParent:this.jc_GLID_SummaryEnterprises,jp_sDescr:"Summary Enterprises Info"},{jp_sName:this.jc_GLID_Enterprise,jp_bTyp_Main:true,jp_bJSDS:true,jp_bMandatory:true,jp_sDescr:"Enterprises"},{jp_sName:this.jc_GLID_PEnterprise,jp_bTyp_Main:true,jp_bJSDS:true,jp_bMandatory:true,jp_SubTable:this.jc_SubTable_EBIS,jp_sParent:this.jc_GLID_Enterprise,jp_sDescr:"Enterprises BasicInfo"},{jp_sName:this.jc_GLID_NEnterprise,jp_bTyp_Main:true,jp_bJSDS:true,jp_bMandatory:true,jp_SubTable:this.jc_SubTable_EBID,jp_sParent:this.jc_GLID_Enterprise,jp_sDescr:"Enterprises DynamicInfo"},{jp_sName:this.jc_GLID_FEnterprise,jp_bTyp_Main:true,jp_bJSDS:true,jp_bMandatory:true,jp_SubTable:this.jc_SubTable_EI,jp_sParent:this.jc_GLID_Enterprise,jp_sDescr:"Enterprises Info"}];this.jc_eidf_key="TEID";this.jc_eidf_xeidcc="f3x_xeidcc";this.jc_eidf_enty="f3x_enty";this.jc_eidf_enid="f3x_enid";this.jc_eidf_egty="f3x_egty";this.jc_eidf_egid="f3x_egid";this.jc_eidf_ucat="f3x_cU";this.jc_eidf_vcat="f3x_cV";this.jc_eidf_a="f3x_gnA";this.jc_eidf_z="f3x_gnZ";this.jc_eidf_n="f3x_gnN";this.jc_eidf_c="f3x_gnC";this.jc_eidf_p="f3x_gpP";this.jc_eidf_s="f3x_gpS";this.jc_ebisf_key="TEID";this.jc_ebisf_enty="f3x_enty";this.jc_ebisf_enid="f3x_enid";this.jc_ebisf_created="f3x_ucretime";this.jc_ebisf_modified="f3x_umodtime";this.jc_ebisf_order="f3x_esorder";this.jc_ebisf_sym="f3x_esym";this.jc_ebisf_color="f3x_escolor";this.jc_ebisf_lat="f3x_eslat";this.jc_ebisf_lon="f3x_eslon";this.jc_ebisf_name="f3x_esname";this.jc_ebisf_descr="f3x_esdescr";this.jc_ebisf_url="f3x_esurl";this.jc_ebidf_key="TEID";this.jc_ebidf_enty="f3x_enty";this.jc_ebidf_enid="f3x_enid";this.jc_ebidf_likes="f3x_likes";this.jc_ebidf_likesbonus="f3x_likesbonus";this.jc_ebidf_clicks="f3x_clicks";this.jc_ebidf_clicksphtime="f3x_clicksphtime";this.jc_ebidf_score="f3x_score";this.jc_eif_key="TEID";this.jc_eif_enty="f3x_enty";this.jc_eif_enid="f3x_enid";this.Init=function(jc_oStorage)
...
return null;return this.jm_o3xJSDS;};this.NewHeader=function(){return new GLHeader(null,null);};this.NewNames=function(){return new GLFieldNames();};this.NewRecord=function()
...
return new GLRecord();else if(jt_oDbSchemaTable.jp_SubTable==jg_oe.jc_oA3xaDbZero.jc_SubTable_EBIS)
return new GLRecord();else if(jt_oDbSchemaTable.jp_SubTable==jg_oe.jc_oA3xaDbZero.jc_SubTable_EBID)
return new GLRecord();else if(jt_oDbSchemaTable.jp_SubTable==jg_oe.jc_oA3xaDbZero.jc_SubTable_EI)
...
{var jt_this=this;var jt_sGlid=this.Get_Glid();this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreInProgress);if(this.jm_o3xJSDS)
{if(!this.jm_o3xJSDS.StoreToGLS(ji_oDbTransaction))
return this.ClearGLSAndFail(jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreFail,"Store JSDS");}
if(this.jm_o3xJSDS&&!jg_oe.jc_oA3xaDbZero.IsGlidEnterprise(this.Get_Glid(),null))
{jg_oe.Get_Reporter().OnDataStored();return true;}
if(!this.jm_oglHeader.StoreToGLS(ji_oDbTransaction))
return this.ClearGLSAndFail(jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreFail,"Store Header");jg_oe.Get_Reporter().OnDataStored();return true;};this.CheckStoreTableStatus=function()
{if(!this.jm_oDTStatus.Get()==jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreInProgress)
{return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreInProgress);}
if(this.jm_o3xJSDS)
{if(!this.jm_o3xJSDS.jm_oDTStatus.IsDone())
return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreInProgress);if(!(this.jm_o3xJSDS.IsValid()&&this.jm_o3xJSDS.Get_JSDS()))
return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreFail);if(this.jm_o3xJSDS.jm_oDTStatus.IsFail())
return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreFail);if(this.jm_o3xJSDS.jm_oDTStatus.IsEmpty())
return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreEmpty);}
if(!(this.jm_oglHeader&&this.jm_oglHeader.IsValid()))
{return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreFail);}
if(!this.jm_oglHeader.jm_oDTStatus.IsDone())
return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreInProgress);if(this.jm_oglHeader.jm_oDTStatus.IsFail())
{return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreFail);}
return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_Stored);};this.LoadFromGLS=function(ji_glid,ji_oDbTransaction,ji_bHeaderOnly,ji_bJSDS)
...
var jt_o3xJSDS=null;if(ji_bJSDS&&!ji_bHeaderOnly)
{jt_o3xJSDS=this.New3xJSDS();if(!jt_o3xJSDS.LoadFromGLS(ji_oDbTransaction,ji_glid,null))
{this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_LoadFail,"Load JSDS");return false;}
this.jm_o3xJSDS=jt_o3xJSDS;jg_oe.Get_Reporter().OnDataRead();return true;}
...
this.jm_oglHeader=jt_oglHeader;return true;};this.Get_FieldNames=function(){return this.jm_oglHeader.Get_FieldNames();};this.SetupLoadedRecords=function(ji_ogldtParent){return this.GLDataTable_SetupLoadedRecords(ji_ogldtParent);};this.GLDataTable_SetupLoadedRecords=function(ji_ogldtParent)
{this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_Loaded);return true;};this.Get_GLRecord=function(ji_id){return this.Get_Recordset().Get_Item(ji_id);};this.Set_GLRecord=function(ji_id,ji_oglr){return this.Get_Recordset().Set_Item(ji_id,ji_oglr);};this.Get_GLRecordAX=function(ji_AltKey){return(this.jm_bAX?this.Get_RecordsetAX().Get_Item(ji_AltKey):null);};this.Get_Recordset=function(){return this.jm_aoglr||null;};this.Get_RecordsetAX=function(){return this.jm_aoglrAX||null;};this.New_Recordsel=function(ji_sSelectName,ji_fnSelect,ji_MaxItems)
...
{return this.jm_aaoglrSelect.Get_Item(ji_sSelectName||"DefaultSelect")||new A3xaArrayIt(this.Get_Recordset());};this.ClearGLSAndFail=function(ji_DTStatus,ji_sMessage)
{this.jm_oDTStatus.Set(ji_DTStatus,ji_sMessage);this.Get_Database().jm_aoglDataTableStore=null;this.Get_Database().jm_aoDTStatus_TableToClear=null;jg_oe.ClearStorage();return false;};this.Get_Database=function(){return this.jm_odb;};this.Get_Storage=function(){return jg_oe.Get_Database().Get_Storage(this.Get_Glid());};this.CheckLoadTableStatus=function(ji_bHeaderOnly)
...
if(this.jm_o3xJSDS&&this.jm_o3xJSDS.IsValid()&&!ji_bHeaderOnly)
...
{jg_oe.LogErr("HeaderOnly Empty","","GLDataTable_CheckLoadTableStatus");this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_LoadEmpty);return true;}
jg_oe.CanLogInfo({DB:4})&&jg_oe.LogInfo("HeaderOnly Loaded, rel: "+jt_sRelease,"","GLDataTable_CheckLoadTableStatus");this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_LoadedTable);return true;};this.OnTransactionComplete=function(ji_oidbEvent,ji_oStorageOpType)
...
{if(jt_odtStatus.Get()==jg_oe.jc_oA3xaDbZero.jc_DTStatus_Stored)
{this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_Stored);}
else if(jt_odtStatus.IsFail())
{this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreFail);}
else if(jt_odtStatus.IsEmpty())
{if(this.Get_Database().jm_oDbSchema.IsMandatory(this.Get_Glid()))
this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreFail);else
this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_Stored);}
else
{}}}
else if(ji_oStorageOpType.bLoad)
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("p4h","GLDataTable_OnTransactionComplete");this.CheckLoadTableStatus(ji_oStorageOpType.bHeaderOnly);}
...
{var jr_I={setD3xRecordset:function(ji_sdsrs){return false;},getCount:function(){return 0;},checkIndex:function(ji_ix){return false;},get3x2Record:function(ji_ix){return null;},getIRecord:function(ji_ix){return null;},_get3x2Record:function(ji_ix){return null;},_getD3xRecord:function(ji_ix){return null;},set3x2FieldPropArray:function(ji_o3x2FieldPropArray){return false;},makeIndex:function(ji_fnKeyMaker){return null;}};jr_I.checkIndex=function(ji_ix){return(ji_ix>=0&&ji_ix<jr_I.getCount());};jr_I.get3x2Record=function(ji_ix)
{return(jr_I.checkIndex(ji_ix)?jr_I._get3x2Record(ji_ix):null);};jr_I.makeIndex=function(ji_fnKeyMaker)
{if(!ji_fnKeyMaker)
return null;var jr_o3x2a=A3xa2Array();var jt_c=jr_I.getCount();for(var i=0;i<jt_c;i++)
{if(!jr_o3x2a.ar.addItem(ji_fnKeyMaker(jr_I._get3x2Record(i),i),i))
{return null;}}
return jr_o3x2a;};return jr_I;}
function A3xa2IStaticDataSource_Table()
{var jr_I={setD3xTable:function(ji_sdsTable){return false;},getD3xTable:function(){return null;},isValid:function(){return false;},getD3xHeader:function(){return null;},getGlid:function(){return null;},getType:function(){return null;},getName:function(){return null;},getVersion:function(){return null;},getD3xFieldNames:function(){return null;},getD3xRecordset:function(){return null;},get3x2FieldPropArray:function(){return null;},getIFieldPropArray:function(){return null;},getFieldNames:function(){return null;},get3x2Recordset:function(){return null;},getIRecordset:function(){return null;},getFields:function(ji_ixRecord){return null;},getFields2:function(ji_ixRecord,ji_keyName){return null;},buildIndex:function(ji_keyName,ji_fnKeyMaker){return false;},getIndex:function(ji_keyName){return null;},getCountOfRecords:function(){return null;}};jr_I.getD3xHeader=function()
...
{var jt_kr=jr_I.getFields2(ji_ixRecord);return(jt_kr?jt_kr.rec:null);};jr_I.getFields2=function(ji_ixRecord,ji_keyName)
{var jt_Irs=jr_I.getIRecordset();if(!jt_Irs)
return null;var jt_Irec=jt_Irs.getIRecord(ji_ixRecord);if(!jt_Irec)
return null;var jt_o3x2index=jr_I.getIndex(ji_keyName);var jt_k=(jt_o3x2index?jt_o3x2index.ar.getKey(ji_ixRecord):null);return{key:jt_k,rec:jt_Irec.getFields()};};return jr_I;}
function A3xa2IStaticDataSource_Db()
{var jr_I={addTablesJSDS:function(){return false;},addD3xTable:function(ji_sdsTable){return null;},get3x2Table:function(ji_glid,ji_name,ji_type){return null;}};return jr_I;}
...
{jr_o.rs.setD3xRecordset(ji_sdsrs);jr_o.rs.set3x2FieldPropArray(ji_o3x2FieldPropArray);}};jr_o.rs.setD3xRecordset=function(ji_sdsrs){jr_o.jm_sdsrs=ji_sdsrs;return true;};jr_o.rs.set3x2FieldPropArray=function(ji_o3x2FieldPropArray)
...
{var jt_o=jr_o.tb.get3x2Recordset();return(jt_o?jt_o.rs:null);};jr_o.tb.buildIndex=function(ji_keyName,ji_fnKeyMaker)
{if(!(ji_keyName&&ji_fnKeyMaker))
return false;var jt_o=jr_o.tb.get3x2Recordset();if(!jt_o)
return false;var jt_o3x2ax=jt_o.rs.makeIndex(ji_fnKeyMaker);if(!jt_o3x2ax)
return false;return jr_o.jm_a3x2Indexes.ar.setItem(ji_keyName,jt_o3x2ax);};jr_o.tb.getIndex=function(ji_keyName){return jr_o.jm_a3x2Indexes.ar.getItem(ji_keyName);};jr_o.tb.getCountOfRecords=function()
{var jt_o3x2rs=jr_o.tb.get3x2Recordset();if(!jt_o3x2rs)
return 0;return jt_o3x2rs.rs.getCount();}
return jr_o;}
...
{if(!ji_sdsTable)
return null;var jr_o3x2tb=A3xa2StaticDataSource_Table(ji_sdsTable);if(!(jr_o3x2tb&&jr_o3x2tb.tb.isValid()))
...
{if(!(ji_type&&(ji_glid||ji_name)))
return null;if(ji_glid)
return jr_o.jm_o3x2a.ar.getItem(ji_glid+","+ji_type);return jr_o.jm_o3x2a.ar.findItem(function(ji_o3x2tb)
{return(ji_name==ji_o3x2tb.tb.getName()&&ji_type==ji_o3x2tb.tb.getType());});};return jr_o;}
...
{var jr_o={jm_odb:null,jm_glid:null,jm_bEnableJSDS:false,jm_o3xJSDS:null,jm_oglHeader:null,jm_a3x2oglr:null,jm_odt:null,csw:A3xa2IDTCacheWriter(),_cswxec:A3xa2IDTCacheWriterExec(),_Construct:function(ji_odt,ji_odb,ji_glid)
{if(ji_glid)
...
return false;jr_o.jm_odb.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheInProgress,"Cache Tableset "+jr_o.jm_glid);jr_o.jm_odb.jm_aoglDataTableStore.Set_Item(jr_o.jm_glid,ji_odt);jr_o.csw.setDataTable(ji_odt);}
jr_o.jm_odt.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheInProgress);if(!jr_o.csw.writeHeader())
{if(jr_o.jm_odb)
jr_o.jm_odb.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Cache Tableset Cache "+jr_o.jm_glid);return false;}
...
jr_o.jm_odt.jm_o3xJSDS=jr_o.jm_o3xJSDS;jr_o.jm_odt.jm_oglHeader=jr_o.jm_oglHeader;jr_o.jm_odt.jm_aoglr=new A3xaArray(jr_o.jm_a3x2oglr);jr_o.jm_odt.jm_oDTStatus.SetFrom(jr_o.csw.integrityCheck());return(jr_o.jm_odt.jm_oDTStatus.Get()==jg_oe.jc_oA3xaDbZero.jc_DTStatus_Cached);};jr_o.csw.writeJSDS=function()
{jr_o.jm_o3xJSDS=jr_o.jm_odt.New3xJSDS();jr_o._cswxec.writeJSDS();if(jr_o.jm_o3xJSDS.Get_Glid()!=jr_o.jm_glid)
{jr_o.jm_odt.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"JSDS Glid");return false;}
if(!jr_o.jm_o3xJSDS.IsValid())
{jr_o.jm_odt.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"JSDS");return false;}
...
{jr_o.jm_odt.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Header Glid");return false;}
if(!jr_o.jm_oglHeader.IsValid())
{jr_o.jm_odt.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Header");return false;}
...
{jr_o.jm_odt.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Field Names");return false;}
if(jt_oglNames.Get_Glid()!=jr_o.jm_glid)
{jr_o.jm_odt.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Field Names TBID");return false;}
var jt_sKeyName=jt_oglNames.Get_KeyName();if(!jt_sKeyName)
{jr_o.jm_odt.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Missing Key Name");return false;}
jr_o.jm_oglHeader.Set_FieldNames(jt_oglNames);return true;};jr_o.csw.writeRecordset=function()
{jr_o.jm_a3x2oglr=A3xa2Array();var jt_oglNames=jr_o.jm_oglHeader.Get_FieldNames();var jt_sKeyName=jt_oglNames.Get_KeyName();if(!jr_o._cswxec.resetRecord())
{jr_o.jm_odt.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Records: no records to write");return false;}
while(!jr_o._cswxec.iseof())
{var jt_oglRecord=jr_o.jm_odt.NewRecord();if(!jt_oglRecord)
{jr_o.jm_odt.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Records: Record null");return false;}
if(!jt_oglRecord.Set_Names(jt_oglNames))
{jr_o.jm_odt.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Records: Set_Names");return false;}
if(!jr_o._cswxec.writeRecord(jt_oglRecord))
{jr_o.jm_odt.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Records: Set_XString");return false;}
var jt_id=jt_oglRecord.Get_Id();if(!(jt_id&&jt_id.length&&jt_id!=0))
{jr_o.jm_odt.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Records Id");return false;}
...
return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Missing Table Name");if((!jr_o.jm_odt.jm_oglHeader)||(!jr_o.jm_odt.jm_oglHeader.IsValid()))
return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Header not valid");var jt_oglNames=jr_o.jm_odt.jm_oglHeader.Get_FieldNames();if(!jt_oglNames)
return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Missing Field Names");jg_oe.CanLogInfo()&&jg_oe.LogInfo("end:glid"+
jt_sGlid,"","GLDataTable_IntegrityCheck");return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_Cached);};jr_o._Construct(ji_odt,ji_odb,ji_glid);return jr_o;}
...
{if(!jr_o.jm_o3xJSDS)
return false;var jt_aFieldNames=((jr_o.jm_oglHeader&&jr_o.jm_oglHeader.Get_FieldNames())?jr_o.jm_oglHeader.Get_FieldNames().Get_Record_Array():null);if(!(jt_aFieldNames&&jt_aFieldNames.length>1))
...
jg_oe.jc_oA3xaDbZero.Glid2SDSTbType(jr_o.jm_oglHeader.Get_Glid())+'","d3x_tbname":"","d3x_version":"'+jr_o.jm_oglHeader.Get_Release()+'"},';jt_JSDS+='"d3x_names":['+jt_sFieldNames+'],';jt_JSDS+='"d3x_records":[';for(var i=0;i<jt_nofRecords;i++)
...
return false;if(!jr_o.jm_dskeyname)
return false;var jt_oInfoRecord=jr_o.jm_o3x2tbe.tb.getFields2(jr_o.jm_dsindex,jr_o.jm_dskeyname);if(!(jt_oInfoRecord&&jt_oInfoRecord.key&&jt_oInfoRecord.rec))
return false;var jt_akrec=[jt_oInfoRecord.key].concat(jt_oInfoRecord.rec||[]);return ji_oglRecord.Set_Record_Array(jr_o.jm_glid,jt_oInfoRecord.key,ji_oglRecord.ConvertSpecialChars(jt_akrec));};if(jr_o.jm_odb&&jr_o.jm_o3xdbsds&&jr_o.jm_glid)
...
{return jg_oe.Get_Storage(ji_StorageType);};this.Open=A3xaDatabase_Open;this.IsOpen=A3xaDatabase_IsOpen;this.IsOpening=A3xaDatabase_IsOpening;this.LoadSchemaDefault=function(){return true;};this.LoadSchemaStore=function(){return true;};this.LoadSchemaLoad=function(){return true;};this.OpenTransaction=A3xaDatabase_OpenTransaction;this.StoreAllData=A3xaDatabase_StoreAllData;this.CheckCache=A3xaDatabase_CheckCache;this.ClearStored=A3xaDatabase_ClearStored;this.StoreCache=A3xaDatabase_StoreCache;this.jm_o3x2sdsdb_Store=null;this.Set_SDSDBStore=function(ji_o3x2sdsdb){this.jm_o3x2sdsdb_Store=ji_o3x2sdsdb;return true;};this.Get_SDSDBStore=function(){return this.jm_o3x2sdsdb_Store;};this.jm_o3x2sdsdb_Work=null;this.Set_SDSDBWork=function(ji_o3x2sdsdb){this.jm_o3x2sdsdb_Work=ji_o3x2sdsdb;return true;};this.Get_SDSDBWork=function(){return this.jm_o3x2sdsdb_Work;};this.jm_oDbSchema=(ji_oDbSchema||null);this.jm_oDTStatus=new GLDataStatus();this.jm_moreOnStoreAllData=0;this.jm_aoDTStatus_TableToClear=null;this.jm_aoglDataTableStore=new A3xaArray();this.jm_aoglDataTableLoad_Common=new A3xaArray();this.jm_aoglDataTableLoad_ExtHeader=new A3xaArray();this.jm_aoglDataTableLoad_Main=new A3xaArray();this.jm_aoglDataTableLoad_Dependent=new A3xaArray();this.jm_aoglDataTableLoad_TurboHeader=new A3xaArray();this.jm_odbTransaction=null;this.MirrorToTurboHeaders=function()
...
return null;};this.NewDataTableCacheStore=function(ji_glid)
...
jg_oe.LogStatusBar2(new A3xaString(["Storing... "+this.jm_oDbSchema.Get_Descr(jt_ogldt.Get_Glid()),"Almacenamiento... "+this.jm_oDbSchema.Get_Descr(jt_ogldt.Get_Glid()),"Armazenando... "+this.jm_oDbSchema.Get_Descr(jt_ogldt.Get_Glid()),"Memorizzando... "+this.jm_oDbSchema.Get_Descr(jt_ogldt.Get_Glid())]),true);jt_oDbTransaction.UsingTable(jt_ogldt.Get_Glid());var jt_o3x2dtcsw=A3xa2DTCacheWriter(jt_ogldt);var jt_oDTStatus2=jt_o3x2dtcsw.csw.integrityCheck();if(!(jt_oDTStatus2&&jt_oDTStatus2.Get()==jg_oe.jc_oA3xaDbZero.jc_DTStatus_Cached))
{jt_ogldt.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreFail,"Cache not valid for: "+(jt_oDTStatus2.jm_sMessage||""));return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreFail,"Store Database Table "+jt_ogldt.Get_Glid());}
var jt_bResult=jt_ogldt.StoreToGLS(jt_oDbTransaction);jt_oDbTransaction.Release();if(!jt_bResult)
{return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreFail,"Store Database Table "+jt_ogldt.Get_Glid());}
return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreInProgress);}}
for(i=0;i<jt_CountDT;i++)
...
{this.jm_odb.StoreAllData(false);}
return true;}
function A3xaTaskHXLoader(ji_fnOnChange,ji_oDatabase,ji_Glid,ji_bHeaderOnly,ji_bTurboHeader,ji_bJSDS)
...
this.jm_odtToLoad.jm_oDTStatus.jm_fnOnChange=function(){return jt_this.Task();};var jt_oDbTransaction=this.jm_oDatabase.OpenTransaction({bLoad:true,bHeaderOnly:ji_bHeaderOnly,bTurboHeader:ji_bTurboHeader},this,[this.jm_Glid]);jt_oDbTransaction.UsingTable(this.jm_Glid);var jt_bResult=this.jm_odtToLoad.LoadFromGLS(this.jm_Glid,jt_oDbTransaction,ji_bHeaderOnly,ji_bJSDS);jt_oDbTransaction.Release();if(jt_bResult)
{this.jm_oDTStatus.Set2(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StInProgress);return true;}
this.jm_oDTStatus.Set2(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StFail,null,null,"Load Table "+this.jm_Glid);return false;};this._OnEnd=function(ji_oDTStatusEnd)
{if(!ji_oDTStatusEnd)
...
{var jt_o3x2dtcsw=A3xa2DTCacheWriter_sds(this.jm_odtToLoad,this.jm_oDatabase,jt_glid,this.jm_oDatabase.Get_SDSDBWork(),jg_oe.jc_oA3xaDbZero.jc_eidf_key);var jr_b=jt_o3x2dtcsw.csw.writeTable();}
else if(ji_bJSDS)
{}}}
return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_LoadedRecord);};}
...
jg_oe.LogStatusBar2(new A3xaString(["Loading... "+this.jm_oDatabase.jm_oDbSchema.Get_Descr(jt_Glid),"Cargando... "+this.jm_oDatabase.jm_oDbSchema.Get_Descr(jt_Glid),"Carregando... "+this.jm_oDatabase.jm_oDbSchema.Get_Descr(jt_Glid),"Caricamento... "+this.jm_oDatabase.jm_oDbSchema.Get_Descr(jt_Glid)]),true);var jt_bJSDS=false;if(!(ji_pTypTables.jp_bTyp_ExtHeader||ji_pTypTables.jp_bTyp_TurboHeader))
{var jt_oSchemaTable=this.jm_oDatabase.jm_oDbSchema.Get_Table_ByName(jt_Glid,false);if(jt_oSchemaTable)
jt_bJSDS=jt_oSchemaTable.jp_bJSDS;}
var jt_otktbLoader=new A3xaTaskHXLoader(function(){return jt_this.Task();},this.jm_oDatabase,jt_Glid,ji_pTypTables.jp_bTyp_ExtHeader||ji_pTypTables.jp_bTyp_TurboHeader,ji_pTypTables.jp_bTyp_TurboHeader,jt_bJSDS);if(!jt_otktbLoader.jm_odtToLoad)
...
return this._CheckStatus_TableHX();return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_LoadFail,"Load Database Unexpected");};this._CheckStatus_TableHX=function()
{if(!this.jm_omthxLoader)
...
return this.jm_omthxLoader.jm_oDTStatus;}
return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_LoadFail,"Load Database Tableset Unexpected");};this._OnEnd=function(ji_oDTStatusEnd)
...
return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_LoadFail,"Load Database Unexpected");if(this.IsExtHeaderTables()||this.IsTurboHeaderTables())
return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_Loaded);for(var i=0;i<this.jm_oDatabase.jm_oDbSchema.jm_aTables.length;i++)
...
{var jr_o=A3xa2StaticDataSource_Db();jr_o.db._dbeparent_addD3xTable=jr_o.db.addD3xTable;jr_o.db._dbeparent_get3x2Table=jr_o.db.get3x2Table;jr_o.db.addD3xTable=function(ji_d3xtb)
{var jr_o3x2tb=jr_o.db._dbeparent_addD3xTable(ji_d3xtb);if(!jr_o3x2tb)
return null;if(jr_o3x2tb.tb.getType()==jg_oe.jc_oA3xaDbZero.jc_tbtype_eid)
{if(!jr_o3x2tb.tb.buildIndex(jg_oe.jc_oA3xaDbZero.jc_eidf_key,function(ji_o3x2Record)
{var jt_o3xxeid=new A3xaXEID();var jt_xeidcc=ji_o3x2Record.rec.getFieldValue_ByName(jg_oe.jc_oA3xaDbZero.jc_eidf_xeidcc);if(jt_xeidcc)
{if(!jt_o3xxeid.Set_CompactCode(jt_xeidcc))
return null;}
else
{var jt_te=ji_o3x2Record.rec.getFieldValue_ByName(jg_oe.jc_oA3xaDbZero.jc_eidf_enty);var jt_ide=ji_o3x2Record.rec.getFieldValue_ByName(jg_oe.jc_oA3xaDbZero.jc_eidf_enid);if(!(jt_te&&jt_ide))
return null;jt_o3xxeid.Set_TypEntity(jt_te);jt_o3xxeid.Set_IdEntity(jt_ide);}
var jr_key=jt_o3xxeid.Get_PrimaryKey();return jr_key;}))
return null;}
else if(jr_o3x2tb.tb.getType()==jg_oe.jc_oA3xaDbZero.jc_tbtype_ebis)
{if(!jr_o3x2tb.tb.buildIndex(jg_oe.jc_oA3xaDbZero.jc_ebisf_key,function(ji_o3x2Record)
{var jt_te=ji_o3x2Record.rec.getFieldValue_ByName(jg_oe.jc_oA3xaDbZero.jc_ebisf_enty);var jt_ide=ji_o3x2Record.rec.getFieldValue_ByName(jg_oe.jc_oA3xaDbZero.jc_ebisf_enid);if(!(jt_te&&jt_ide))
return null;return jt_te+","+jt_ide;}))
return null;}
else if(jr_o3x2tb.tb.getType()==jg_oe.jc_oA3xaDbZero.jc_tbtype_ebid)
{if(!jr_o3x2tb.tb.buildIndex(jg_oe.jc_oA3xaDbZero.jc_ebidf_key,function(ji_o3x2Record)
{var jt_te=ji_o3x2Record.rec.getFieldValue_ByName(jg_oe.jc_oA3xaDbZero.jc_ebidf_enty);var jt_ide=ji_o3x2Record.rec.getFieldValue_ByName(jg_oe.jc_oA3xaDbZero.jc_ebidf_enid);if(!(jt_te&&jt_ide))
return null;return jt_te+","+jt_ide;}))
return null;}
else if(jr_o3x2tb.tb.getType()==jg_oe.jc_oA3xaDbZero.jc_tbtype_ei)
{if(!jr_o3x2tb.tb.buildIndex(jg_oe.jc_oA3xaDbZero.jc_eif_key,function(ji_o3x2Record,ji_index)
{var jt_te=ji_o3x2Record.rec.getFieldValue_ByName(jg_oe.jc_oA3xaDbZero.jc_eif_enty);var jt_ide=ji_o3x2Record.rec.getFieldValue_ByName(jg_oe.jc_oA3xaDbZero.jc_eif_enid);if(!(jt_te&&jt_ide))
return null;return jt_te+","+jt_ide;}))
return null;}
return jr_o3x2tb;};jr_o.db.get3x2Table=function(ji_glid,ji_name,ji_type)
{if(!ji_type)
ji_type=jg_oe.jc_oA3xaDbZero.Glid2SDSTbType(ji_glid);return jr_o.db._dbeparent_get3x2Table(ji_glid,ji_name,ji_type);};jr_o.db.addTablesJSDS=function()
...
return false;return true;};return jr_o;}
function A3xaDbZero()
...
else if(jt_oDbSchemaTable.jp_SubTable==jg_oe.jc_oA3xaDbZero.jc_SubTable_EBIS)
{return new GLREBIS();}
else if(jt_oDbSchemaTable.jp_SubTable==jg_oe.jc_oA3xaDbZero.jc_SubTable_EBID)
{return new GLREBID();}
else if(jt_oDbSchemaTable.jp_SubTable==jg_oe.jc_oA3xaDbZero.jc_SubTable_EI)
{return new GLREI();}
return null;};this.SetupLoadedRecords=function(ji_ogldtParent)
{var jt_odb=this.Get_Database();var jt_glid=this.Get_Glid();var jt_oSchemaTable=jt_odb.jm_oDbSchema.Get_Table_ByName(jt_glid);var jt_oglNames=null;if(this.jm_oglHeader)
jt_oglNames=this.jm_oglHeader.Get_FieldNames();var jt_sKeyName="";if(jt_oglNames)
jt_sKeyName=jt_oglNames.Get_KeyName();var jt_oa3xRecordset=this.Get_Recordset();var jt_aoglrAX=new A3xaArray();var jt_nRecords=(jt_oa3xRecordset?jt_oa3xRecordset.Get_Count():0);if(this.jm_bAX&&jt_sKeyName)
...
return false;return this.GLRecord_Set_SubRecord(ji_SubType,ji_oglrSub);};this.Get_3xEBIS=function(){return this.Get_SubRecord(jg_oe.jc_oA3xaDbZero.jc_SubTable_EBIS);};this.Get_3xEBID=function(){return this.Get_SubRecord(jg_oe.jc_oA3xaDbZero.jc_SubTable_EBID);};this.Get_3xEI=function(){return this.Get_SubRecord(jg_oe.jc_oA3xaDbZero.jc_SubTable_EI);};this.Get_3xsName=function(){return this.Get_3xEI().Get_3xsName();};this.Get_LName=function()
...
return false;jt_oddirNew.Set_Descr(ji_ocg.o3xe.Get_LName());this.Add_Child(jt_oddirNew);var jt_odtExtH=null;if(jt_odcer.Get_3xXEID().Get_3xAZNC().Get_N())
jt_odtExtH=jg_oApp.Get_Database().Get_MainDataTable(jt_odcer.Get_3xXEID().Get_3xAZNC().Get_A(),jt_odcer.Get_3xXEID().Get_3xAZNC().Get_Z(),jt_odcer.Get_3xXEID().Get_3xAZNC().Get_N());jt_oddirNew.jm_bHighlight=(jt_odtExtH?true:false);if(ji_ocg.o3xsii)
...
return false;jt_oddirNew.Set_Descr(ji_ocg.o3xe.Get_LName());jt_oddig.Add_Child(jt_oddirNew);var jt_odtExtH=null;if(jt_odcer.Get_3xXEID().Get_3xAZNC().Get_N())
jt_odtExtH=jg_oApp.Get_Database().Get_MainDataTable(jt_odcer.Get_3xXEID().Get_3xAZNC().Get_A(),jt_odcer.Get_3xXEID().Get_3xAZNC().Get_Z(),jt_odcer.Get_3xXEID().Get_3xAZNC().Get_N());jt_oddirNew.jm_bHighlight=(jt_odtExtH?true:false);if(ji_ocg.o3xsii)
...
return false;return jt_o3x2sdsdb.db.addTablesJSDS();};this._OnDocumentReady=function()
...
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("Loaded OK","","A3xaAppManager.OnLoadDataDone");this.OnDataLoadedSetup();this.DocumentShow();}
...
if(false&&jg_oe.jc_oA3xaDbZero.XGlid2Glid(ji_glid)==jg_oe.jc_oA3xaDbZero.jc_GLID_MetaSystemControl&&this.Get_Database().Get_SDSDBStore())
{var jt_o3x2dtcsw=A3xa2DTCacheWriter_sds(null,this.Get_Database(),ji_glid,this.Get_Database().Get_SDSDBStore(),jg_oe.jc_oA3xaDbZero.jc_eidf_key);jt_o3x2dtcsw.csw.enableJSDS();jr_b=jt_o3x2dtcsw.csw.writeTable();var jt_o3x2dtcsw_ebis=A3xa2DTCacheWriter_sds(null,this.Get_Database(),jg_oe.jc_oA3xaDbZero.jc_GLID_PMetaSystemControl,this.Get_Database().Get_SDSDBStore(),jg_oe.jc_oA3xaDbZero.jc_ebisf_key);jt_o3x2dtcsw_ebis.csw.enableJSDS();jt_o3x2dtcsw_ebis.csw.writeTable();var jt_o3x2dtcsw_ei=A3xa2DTCacheWriter_sds(null,this.Get_Database(),jg_oe.jc_oA3xaDbZero.jc_GLID_FMetaSystemControl,this.Get_Database().Get_SDSDBStore(),jg_oe.jc_oA3xaDbZero.jc_eif_key);jt_o3x2dtcsw_ei.csw.enableJSDS();jt_o3x2dtcsw_ei.csw.writeTable();}
else
{var jt_oSchemaTable=this.Get_Database().jm_oDbSchema.Get_Table_ByName(ji_glid,false);var jt_o3x2dtcsw=A3xa2DTCacheWriter_GLRS(null,this.Get_Database(),ji_glid,ji_sGLRS);if(jt_oSchemaTable&&jt_oSchemaTable.jp_bJSDS)
