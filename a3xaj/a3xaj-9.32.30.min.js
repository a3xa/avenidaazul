...
function A3xaDebugReference(ji_o,ji_s){return" "+(ji_s||"")+(ji_o?" ok ":" nok ");}
...
﻿
function A3xa2IArray()
{var jr_I={getCount:function(){return 0;},checkIndex:function(ji_ix){return false;},getItem_ByIndex:function(ji_ix){return null;},foreachItem:function(ji_fnDo){return null;},findItem:function(ji_fnCheck){return null;},findItem2:function(ji_fnCheck){return null;},sortItems:function(ji_fnCompare){return false;},setItem:function(ji_key,ji_value){return false;},addItem:function(ji_key,ji_value){return false;},getItem:function(ji_key){return null;},getKey:function(ji_ix){return null;},clear:function(){return false;}};jr_I.checkIndex=function(ji_ix){return ji_ix>=0&&ji_ix<jr_I.getCount();};jr_I.getItem_ByIndex=function(ji_ix){return jr_I.getItem(jr_I.getKey(ji_ix));};jr_I.findItem=function(ji_fnCheck)
...
function A3xa2IArrayIt()
{var jr_I={set3x2Array:function(ji_o3x2a){false;},selectItems:function(ji_fnSelect,ji_MaxItems){return true;},getCount:function(){return 0;},getKey:function(ji_ix){return null;},getItem:function(ji_key){return null;},getIndex:function(){return-1;},resetIndex:function(){return false;},getCurrentKey:function(){return null;},getCurrentItem:function(){return null;},next:function(){return false;},iseof:function(){return true;}};jr_I.getCurrentKey=function(){return jr_I.getKey(jr_I.getIndex());};jr_I.getCurrentItem=function(){return jr_I.getItem(jr_I.getCurrentKey());};jr_I.next=function(){return false;};jr_I.iseof=function()
{var jt_ix=jr_I.getIndex();return(jt_ix<0||jt_ix>=jr_I.getCount());};return jr_I;}
function A3xa2Array()
{var jr_o={jm_aa:{},jm_ax:[],ar:A3xa2IArray()};jr_o.ar.clear=function(){jr_o.jm_ax=[];jr_o.jm_aa={};return true;};jr_o.ar.getCount=function(){return(jr_o.jm_ax&&jr_o.jm_aa)?jr_o.jm_ax.length:0;};jr_o.ar.setItem=function(ji_key,ji_value)
{if(!ji_key)
return false;if(ji_value==null)
return false;if(jr_o.jm_aa&&jr_o.jm_aa[ji_key]!=null)
{jr_o.jm_aa[ji_key]=ji_value;return true;}
jr_o.jm_aa[ji_key]=ji_value;jr_o.jm_ax.push(ji_key);return true;};jr_o.ar.addItem=function(ji_key,ji_value)
{if(!ji_key)
return false;if(ji_value==null)
return false;if(jr_o.jm_aa&&jr_o.jm_aa[ji_key]!=null)
return false;jr_o.jm_aa[ji_key]=ji_value;jr_o.jm_ax.push(ji_key);return true;};jr_o.ar.removeItems=function(ji_akey)
{if(!(ji_akey&&ji_akey.length))
return null;var jr_aaRemoved={};for(var ik=0;ik<ji_akey.length;ik++)
{var jt_k=ji_akey[ik];if(jr_o.jm_aa)
{jr_aaRemoved[jt_k]=jr_o.jm_aa[jt_k];jr_o.jm_aa[jt_k]=null;}
else
jr_aaRemoved[jt_k]=null;}
if(!(jr_o.jm_ax&&jr_o.jm_ax.length))
return jr_aaRemoved;var jt_axNew=[];for(var ix=0;ix<jr_o.jm_ax.length;ix++)
{var jt_kx=jr_o.jm_ax[ix];var jt_bremove=false;for(var ik=0;ik<ji_akey.length;ik++)
{if(jt_kx==ji_akey[ik])
{jt_bremove=true;break;}}
if(!jt_bremove)
jt_akNew.push(jt_kx);}
jr_o.jm_ax=jt_axNew;return jr_aaRemoved;};jr_o.ar.getItem=function(ji_key)
{if(!ji_key)
return null;var jr_v=jr_o.jm_aa[ji_key];return(jr_v==null?null:jr_v);};jr_o.ar.getKey=function(ji_ix)
...
{if(!(jr_o.jm_aa&&jr_o.jm_ax))
return false;jr_o.jm_ax.sort(function(ji_key_a,ji_key_b)
{if(!ji_fnCompare)
{if(ji_key_a<ji_key_b)
return-1;return 1;}
return ji_fnCompare(jr_o.jm_aa[ji_key_a]||null,jr_o.jm_aa[ji_key_b]||null);});return true;};return jr_o;}
function A3xa2ArrayIt(ji_o3x2a)
{var jr_o={jm_o3x2a:null,jm_ix:-1,jm_o3xf:null,ar:A3xa2IArray(),arit:A3xa2IArrayIt(),_Construct:function(ji_o3x2a)
{jr_o.arit.set3x2Array(ji_o3x2a);}};jr_o.ar.getCount=function()
{if(!jr_o.jm_o3x2a)
return 0;if(!jr_o.jm_o3xf)
return jr_o.jm_o3x2a.ar.getCount();return jr_o.jm_o3xf.ar.getCount();};jr_o.ar.setItem=function(ji_key,ji_value)
{if(!jr_o.jm_o3x2a)
return false;if(!jr_o.jm_o3xf)
return jr_o.jm_o3x2a.ar.setItem(ji_key,ji_value);return jr_o.jm_o3x2a.ar.setItem(ji_key,ji_value);};jr_o.ar.addItem=function(ji_key,ji_value)
{if(!jr_o.jm_o3x2a)
return false;if(!jr_o.jm_o3xf)
return jr_o.jm_o3x2a.ar.addItem(ji_key,ji_value);return jr_o.jm_o3x2a.ar.addItem(ji_key,ji_value);};jr_o.ar.getItem=function(ji_key)
{if(!jr_o.jm_o3x2a)
return null;if(!jr_o.jm_o3xf)
return jr_o.jm_o3x2a.ar.getItem(ji_key);if(jr_o.jm_o3xf.ar.getItem(ji_key))
return jr_o.jm_o3x2a.ar.getItem(ji_key);return null;};jr_o.ar.getKey=function(ji_ix)
{if(!jr_o.jm_o3x2a)
return null;if(!jr_o.jm_o3xf)
return jr_o.jm_o3x2a.ar.getKey(ji_ix);return jr_o.jm_o3xf.ar.getKey(ji_ix);};jr_o.ar.getItem_ByIndex=function(ji_ix)
{if(!jr_o.jm_o3x2a)
return null;if(!jr_o.jm_o3xf)
return jr_o.jm_o3x2a.ar.getItem_ByIndex(ji_ix);return jr_o.jm_o3x2a.ar.getItem(jr_o.jm_o3xf.ar.getKey(ji_ix));};jr_o.ar.foreachItem=function(ji_fnDo)
{if(!jr_o.jm_o3x2a)
return null;if(!jr_o.jm_o3xf)
return jr_o.jm_o3x2a.ar.foreachItem(ji_fnDo);if(!ji_fnDo)
return false;jr_o.jm_o3xf.foreachItem(function(ji_bdummy,ji_ix,ji_key)
{return ji_fnDo(jr_o.jm_o3x2a.ar.getItem(ji_key),ji_ix,ji_key);});return true;};jr_o.ar.findItem=function(ji_fnCheck)
{if(!jr_o.jm_o3x2a)
return null;if(!jr_o.jm_o3xf)
return jr_o.jm_o3x2a.ar.findItem(ji_fnCheck);var jt_c=jr_o.jm_o3xf.ar.getCount();if(!(jt_c>0))
return null;for(var ix=0;ix<jt_c;ix++)
{var jr_v=jr_o.jm_o3x2a.ar.getItem(jr_o.jm_o3xf.ar.getKey(ix));if(jr_v&&ji_fnCheck(jr_v))
return jr_v;}
return null;};jr_o.ar.sortItems=function(ji_fnCompare)
{if(!jr_o.jm_o3x2a)
return false;if(!jr_o.jm_o3xf)
return jr_o.jm_o3x2a.ar.sortItems(ji_fnCompare);jr_o.jm_o3xf.jm_ax.sort(function(ji_key_a,ji_key_b)
{if(!ji_fnCompare)
{if(ji_key_a<ji_key_b)
return-1;return 1;}
return ji_fnCompare(jr_o.jm_o3x2a.ar.getItem(ji_key_a),jr_o.jm_o3x2a.ar.getItem(ji_key_b));});return true;};jr_o.arit.set3x2Array=function(ji_o3x2a)
{jr_o.jm_o3x2a=(ji_o3x2a||null);return jr_o.arit.resetIndex();};jr_o.arit.selectItems=function(ji_fnSelect,ji_MaxItems)
{jr_o.jm_o3xf=null;if(!ji_fnSelect)
return true;var jt_c=(jr_o.jm_o3x2a?jr_o.jm_o3x2a.ar.getCount():0);if(!(jt_c>0))
return true;jr_o.jm_o3xf=A3xa2Array();var ixadd=0;for(var ix=0;ix<jt_c;ix++)
{if(ji_MaxItems>0&&ixadd>=ji_MaxItems)
break;var jt_k=jr_o.jm_o3x2a.ar.getKey(ix);var jt_v=jr_o.jm_o3x2a.ar.getItem(jt_k);if(jt_k&&jt_v&&ji_fnSelect(jt_k,jt_v)===1)
{jr_o.jm_o3xf.ar.addItem(jt_k,true);ixadd++;}}
return true;};jr_o.arit.getCount=jr_o.ar.getCount;jr_o.arit.getKey=jr_o.ar.getKey;jr_o.arit.getItem=jr_o.ar.getItem;jr_o.arit.getIndex=function(){return jr_o.jm_ix;};jr_o.arit.resetIndex=function()
{jr_o.jm_ix=-1;if(jr_o.arit.getCount()>0)
jr_o.jm_ix=0;return true;};jr_o.arit.next=function()
{if(jr_o.arit.iseof())
return false;jr_o.jm_ix++;return!jr_o.arit.iseof();};jr_o.arit.iseof=function()
{return(jr_o.jm_ix<0||jr_o.jm_ix>=jr_o.arit.getCount());};jr_o._Construct(ji_o3x2a);return jr_o;}
function A3xaArray(ji_o3x2a)
{this.jm_o3x2=(ji_o3x2a||A3xa2Array());this.Get_Count=this.jm_o3x2.ar.getCount;this.Set_Item=this.jm_o3x2.ar.setItem;this.Add_Item=this.jm_o3x2.ar.addItem;this.Get_Item=this.jm_o3x2.ar.getItem;this.Get_Key=this.jm_o3x2.ar.getKey;this.Sort=this.jm_o3x2.ar.sortItems;this.Get_Item_ByIndex=this.jm_o3x2.ar.getItem_ByIndex;this.Find=this.jm_o3x2.ar.findItem;}
function A3xaArrayIt(ji_o3xa,ji_o3x2ait)
{this.jm_o3x2=(ji_o3x2ait||A3xa2ArrayIt(ji_o3xa.jm_o3x2));this.Set_3xArray=function(ji_o3xa){return this.jm_o3x2.ar.set3x2Array(ji_o3xa.jm_o3x2);};this.Get_Count=this.jm_o3x2.ar.getCount;this.Set_Item=this.jm_o3x2.ar.setItem;this.Add_Item=this.jm_o3x2.ar.addItem;this.Get_Item=this.jm_o3x2.ar.getItem;this.Get_Key=this.jm_o3x2.ar.getKey;this.Get_Item_ByIndex=this.jm_o3x2.ar.getItem_ByIndex;this.Find=this.jm_o3x2.ar.findItem;this.Sort=this.jm_o3x2.ar.sortItems;this.SelectItems=this.jm_o3x2.arit.selectItems;this.Get_Index=this.jm_o3x2.arit.getIndex;this.Reset=this.jm_o3x2.arit.resetIndex;this.Get_CurrentKey=this.jm_o3x2.arit.getCurrentKey;this.Get_CurrentItem=this.jm_o3x2.arit.getCurrentItem;this.Next=this.jm_o3x2.arit.next;this.IsEOF=this.jm_o3x2.arit.iseof;}
...
{this.jc_GLSep_Block="__glk__";this.jc_GLSep_Header="__glv__";this.jc_GLSep_Field="__glf__";this.jc_GLSep_FieldArray="__glr__";this.jc_GLSep_Compact="~";this.jc_GLMID_FieldNames="GLN";this.jc_GLMID_GT="GLG";this.jc_GLMID_DT="GLH";this.jc_GLMID_JSDS="JSD";this.jc_GLIDPREFIXLEN=3;this.jc_GLIDSUFFIXLEN=4;this.jc_GLIDLEN=7;this.jc_GLIDMARKLEN=3;this.jc_GLID_All="ALLA3X0";this.jc_GLIDSUFFIXDEFAULT="A3X0";this.jc_GLID_TOC="TMTA3X0";this.jc_tbtype_tid={tbtname:"t3x_tid",tbtkeyname:"TTID"};this.jc_tidf_tid="f3x_tid";this.jc_GLID_MetaSystemControl="RMKA3X0";this.jc_GLID_Category="RMBA3X0";this.jc_GLID_GeoArea="RGGA3X0";this.jc_GLID_GeoRegion="RGRA3X0";this.jc_GLID_GeoCity="RGCA3X0";this.jc_GLID_GeoCountry="RGPA3X0";this.jc_GLID_GeoState="RGSA3X0";this.jc_GLID_SummaryEnterprises="RSEA3X0";this.jc_GLID_Enterprise="REEA3X0";this.jc_GLID_EnterprisePrefix="REE";this.jc_GLID_NMetaSystemControl="NMKA3X0";this.jc_GLID_NCategory="NMBA3X0";this.jc_GLID_NGeoArea="NGGA3X0";this.jc_GLID_NGeoRegion="NGRA3X0";this.jc_GLID_NGeoCity="NGCA3X0";this.jc_GLID_NGeoCountry="NGPA3X0";this.jc_GLID_NGeoState="NGSA3X0";this.jc_GLID_NEnterprise="NEEA3X0";this.jc_GLID_NEnterprisePrefix="NEE";this.jc_GLID_PMetaSystemControl="PMKA3X0";this.jc_GLID_PCategory="PMBA3X0";this.jc_GLID_PGeoArea="PGGA3X0";this.jc_GLID_PGeoRegion="PGRA3X0";this.jc_GLID_PGeoCity="PGCA3X0";this.jc_GLID_PGeoCountry="PGPA3X0";this.jc_GLID_PGeoState="PGSA3X0";this.jc_GLID_PEnterprise="PEEA3X0";this.jc_GLID_PEnterprisePrefix="PEE";this.jc_GLID_FMetaSystemControl="FMKA3X0";this.jc_GLID_FCategory="FMBA3X0";this.jc_GLID_FGeoArea="FGGA3X0";this.jc_GLID_FGeoRegion="FGRA3X0";this.jc_GLID_FGeoCity="FGCA3X0";this.jc_GLID_FGeoCountry="FGPA3X0";this.jc_GLID_FGeoState="FGSA3X0";this.jc_GLID_FSummaryEnterprises="FSEA3X0";this.jc_GLID_FEnterprise="FEEA3X0";this.jc_GLID_FEnterprisePrefix="FEE";this.jc_tbtype_eid={tbtname:"t3x_eid",tbtkeyname:"TEID"};this.jc_tbtype_ebis={tbtname:"t3x_ebis",tbtkeyname:"TEID"};this.jc_tbtype_ebid={tbtname:"t3x_ebid",tbtkeyname:"TEID"};this.jc_tbtype_ei={tbtname:"t3x_ei",tbtkeyname:"TEID"};this.XGlid2Mark=function(ji_s)
{if(!ji_s)
...
return"";return ji_s.substr(0,this.jc_GLIDLEN);};this.CheckGlid=function(ji_s)
{if(!ji_s)
...
ji_sExtension="A3X0";if(ji_sExtension.length!=4)
return null;return ji_sPrefix+ji_sExtension;};this.IsDefaultGlid=function(ji_s)
{if(!this.CheckGlid(ji_s))
return null;var jt_sExtension=ji_s.substr(this.jc_GLIDPREFIXLEN,this.jc_GLIDLEN-this.jc_GLIDPREFIXLEN);return jt_sExtension=="A3X0";};this.Glid2Default=function(ji_s)
{if(!this.CheckGlid(ji_s))
return"";return this.MakeGlid(ji_s.substr(0,this.jc_GLIDPREFIXLEN));};this.Glid2SDSTbType=function(ji_glid)
{if(!ji_glid)
return{tbtname:"",tbtkeyname:""};if(ji_glid==this.jc_GLID_TOC)
return this.jc_tbtype_tid;var jt_c=ji_glid.charAt(0);if(jt_c=='R')
return this.jc_tbtype_eid;if(jt_c=='P')
return this.jc_tbtype_ebis;if(jt_c=='N')
return this.jc_tbtype_ebid;if(jt_c=='F')
return this.jc_tbtype_ei;return{tbtname:"",tbtkeyname:""};};this.IsGlidEnterprise=function(ji_glid,ji_tbtype)
{if(!this.CheckGlid(ji_glid))
return false;var jt_gliddflt=ji_glid.substr(0,this.jc_GLIDPREFIXLEN);if(!(jt_gliddflt==jg_oe.jc_oA3xaDbZero.jc_GLID_EnterprisePrefix||jt_gliddflt==jg_oe.jc_oA3xaDbZero.jc_GLID_PEnterprisePrefix||jt_gliddflt==jg_oe.jc_oA3xaDbZero.jc_GLID_NEnterprisePrefix||jt_gliddflt==jg_oe.jc_oA3xaDbZero.jc_GLID_FEnterprisePrefix))
return false;if(!ji_tbtype)
return true;var jt_c=jt_gliddflt.charAt(0);if(jt_c=='R'&&ji_tbtype.tbtname==this.jc_tbtype_eid.tbtname)
return true;if(jt_c=='P'&&ji_tbtype.tbtname==this.jc_tbtype_ebis.tbtname)
return true;if(jt_c=='N'&&ji_tbtype.tbtname==this.jc_tbtype_ebid.tbtname)
return true;if(jt_c=='F'&&ji_tbtype.tbtname==this.jc_tbtype_ei.tbtname)
return true;return false;};this.IsGlidTOC=function(ji_glid,ji_tbtype)
{if(!this.CheckGlid(ji_glid))
return false;if(!(ji_glid==jg_oe.jc_oA3xaDbZero.jc_GLID_TOC))
return false;if(!ji_tbtype)
return true;var jt_c=ji_glid.charAt(0);if(jt_c=='T'&&ji_tbtype.tbtname==this.jc_tbtype_tid.tbtname)
return true;return false;};this.jc_sEifaName="f3x_ei";this.jc_Eifa_Typ=0;this.jc_Eifa_Cod=1;this.jc_Eifa_Id=2;this.jc_Eifa_IdParent=3;this.jc_Eifa_Info=4;this.jc_DTStatus2_StSuccess=1;this.jc_DTStatus2_StFail=4;this.jc_DTStatus2_StEmpty=5;this.jc_DTStatus2_StInProgress=6;this.jc_DTStatus2_StOpen=8;this.jc_DTStatus2_StReady=9;this.jc_DTStatus2_OpCache=10;this.jc_DTStatus2_OpClear=20;this.jc_DTStatus2_OpStore=30;this.jc_DTStatus2_OpLoad=40;this.jc_DTStatus2_OpAjax=50;this.jc_DbVersion=35;this.jc_sDbDefaultPrimaryKeyName="xkey";this.jc_sDbName="A3xaDbZeroA";this.jc_aSchemaTables=[{jp_sName:this.jc_GLID_MetaSystemControl,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"ControlPanels"},{jp_sName:this.jc_GLID_Category,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"Categories"},{jp_sName:this.jc_GLID_GeoArea,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"Areas"},{jp_sName:this.jc_GLID_GeoRegion,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"Regions"},{jp_sName:this.jc_GLID_GeoCity,jp_bTyp_Common:true,jp_bMandatory:false,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"Cities"},{jp_sName:this.jc_GLID_GeoCountry,jp_bTyp_Common:true,jp_bMandatory:false,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"Countries"},{jp_sName:this.jc_GLID_GeoState,jp_bTyp_Common:true,jp_bMandatory:false,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"States"},{jp_sName:this.jc_GLID_PMetaSystemControl,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebis.tbtname,jp_sParent:this.jc_GLID_MetaSystemControl,jp_sDescr:"ControlPanels BasicInfo"},{jp_sName:this.jc_GLID_PCategory,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebis.tbtname,jp_sParent:this.jc_GLID_Category,jp_sDescr:"Categories BasicInfo"},{jp_sName:this.jc_GLID_PGeoArea,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebis.tbtname,jp_sParent:this.jc_GLID_GeoArea,jp_sDescr:"Areas BasicInfo"},{jp_sName:this.jc_GLID_PGeoRegion,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebis.tbtname,jp_sParent:this.jc_GLID_GeoRegion,jp_sDescr:"Regions BasicInfo"},{jp_sName:this.jc_GLID_PGeoCity,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebis.tbtname,jp_sParent:this.jc_GLID_GeoCity,jp_sDescr:"Cities BasicInfo"},{jp_sName:this.jc_GLID_PGeoCountry,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebis.tbtname,jp_sParent:this.jc_GLID_GeoCountry,jp_sDescr:"Countries BasicInfo"},{jp_sName:this.jc_GLID_PGeoState,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebis.tbtname,jp_sParent:this.jc_GLID_GeoState,jp_sDescr:"States BasicInfo"},{jp_sName:this.jc_GLID_NMetaSystemControl,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebid.tbtname,jp_sParent:this.jc_GLID_MetaSystemControl,jp_sDescr:"ControlPanels DynamicInfo"},{jp_sName:this.jc_GLID_NCategory,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebid.tbtname,jp_sParent:this.jc_GLID_Category,jp_sDescr:"Categories DynamicInfo"},{jp_sName:this.jc_GLID_NGeoArea,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebid.tbtname,jp_sParent:this.jc_GLID_GeoArea,jp_sDescr:"Areas DynamicInfo"},{jp_sName:this.jc_GLID_NGeoRegion,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebid.tbtname,jp_sParent:this.jc_GLID_GeoRegion,jp_sDescr:"Regions DynamicInfo"},{jp_sName:this.jc_GLID_NGeoCity,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebid.tbtname,jp_sParent:this.jc_GLID_GeoCity,jp_sDescr:"Cities DynamicInfo"},{jp_sName:this.jc_GLID_NGeoCountry,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebid.tbtname,jp_sParent:this.jc_GLID_GeoCountry,jp_sDescr:"Countries DynamicInfo"},{jp_sName:this.jc_GLID_NGeoState,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebid.tbtname,jp_sParent:this.jc_GLID_GeoState,jp_sDescr:"States DynamicInfo"},{jp_sName:this.jc_GLID_FMetaSystemControl,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ei.tbtname,jp_sParent:this.jc_GLID_MetaSystemControl,jp_sDescr:"ControlPanels Info"},{jp_sName:this.jc_GLID_FCategory,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ei.tbtname,jp_sParent:this.jc_GLID_Category,jp_sDescr:"Categories Info"},{jp_sName:this.jc_GLID_FGeoArea,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ei.tbtname,jp_sParent:this.jc_GLID_GeoArea,jp_sDescr:"Areas Info"},{jp_sName:this.jc_GLID_FGeoRegion,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ei.tbtname,jp_sParent:this.jc_GLID_GeoRegion,jp_sDescr:"Regions Info"},{jp_sName:this.jc_GLID_FGeoCity,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ei.tbtname,jp_sParent:this.jc_GLID_GeoCity,jp_sDescr:"Cities Info"},{jp_sName:this.jc_GLID_FGeoCountry,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ei.tbtname,jp_sParent:this.jc_GLID_GeoCountry,jp_sDescr:"Countries Info"},{jp_sName:this.jc_GLID_FGeoState,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ei.tbtname,jp_sParent:this.jc_GLID_GeoState,jp_sDescr:"States Info"},{jp_sName:this.jc_GLID_SummaryEnterprises,jp_bTyp_Common:true,jp_bMandatory:false,jp_bCacheAll:true,jp_sDescr:"Summary Enterprises"},{jp_sName:this.jc_GLID_FSummaryEnterprises,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ei.tbtname,jp_sParent:this.jc_GLID_SummaryEnterprises,jp_sDescr:"Summary Enterprises Info"},{jp_sName:this.jc_GLID_TOC,jp_bTyp_TOC:true,jp_bMandatory:true,jp_bCacheAll:true,jp_sDescr:"Table of Contents"},{jp_sName:this.jc_GLID_Enterprise,jp_bTyp_Main:true,jp_bMandatory:true,jp_sDescr:"Enterprises"},{jp_sName:this.jc_GLID_PEnterprise,jp_bTyp_Main:true,jp_bMandatory:true,jp_SubTable:this.jc_tbtype_ebis.tbtname,jp_sParent:this.jc_GLID_Enterprise,jp_sDescr:"Enterprises BasicInfo"},{jp_sName:this.jc_GLID_NEnterprise,jp_bTyp_Main:true,jp_bMandatory:true,jp_SubTable:this.jc_tbtype_ebid.tbtname,jp_sParent:this.jc_GLID_Enterprise,jp_sDescr:"Enterprises DynamicInfo"},{jp_sName:this.jc_GLID_FEnterprise,jp_bTyp_Main:true,jp_bMandatory:true,jp_SubTable:this.jc_tbtype_ei.tbtname,jp_sParent:this.jc_GLID_Enterprise,jp_sDescr:"Enterprises Info"}];this.jc_aSchemaExtTables=["YB00","LA00","X300","XN10","XNB0","XNS0","XNO0","XNG0","XNJ0","XA10","XAP0","XAD0","XAA0","XAG0","N100","N200","N300","N400","N500","N600","N700","N800","N900","NX10","NXC0","NXM0","NXQ0","NXY0","NXP0","NY10","NYB0","NYC0","NYW0","NYG0","NYT0","NYL0","NYH0","NYK0","NYS0","NS10","NSN0","NSR0","NSA0","NSJ0","NSO0","NSC0","NSE0","NSW0","NSQ0","NSP0","C100","C300","C400","C500","C600","C700","CU10","CUB0","CUT0","CC10","CCH0","CCV0","CCO0","CCJ0","CCY0","CCC0","CCE0","CA10","CAJ0","CAM0","CAW0","CAY0","CH10","CHH0","CHD0","CHS0","CHC0","CHO0","CHP0","CHE0","CHV0","CL10","CLV0","CLA0","CLK0","CLT0","CLG0","CW10","CWQ0","CWG0","CWB0","P300","P400","PC10","PCT0","PCB0","PS10","PSD0","PSR0","PSM0","PSE0","PSV0","PSG0","PSC0","PG10","PGW0","PGZ0","PD10","PDB0","PDA0","PDP0","PDV0","PL10","PLC0","PLV0","A100","AG10","AGG0","AGS0","AGF0","AN10","ANV0","ANO0","ANC0","AO10","AOE0","AOP0","AOB0","AB10","ABC0","ABD0","ABX0","ABU0","ABA0","ABP0","ABB0","ABR0","ABM0","B300","BML0","BMM0","BMU0","BMT0","BC30","BCO0","BCF0","BCC0","BN10","BNG0","BNB0","BNN0","BNR0","BNP0","BNA0","BNS0","BNU0","BB30","BBQ0","BBS0","BBD0","BBU0","BBM0","BBB0","BO10","BOA0","BOR0","BON0","BOC0","BS10","BSD0","BSG0","BSH0","BSC0","BST0","BSS0","BSO0","BL10","BLE0","BLN0","BLL0","BLJ0","BLB0","BLV0","BLP0","BP10","BPM0","BPU0","BPQ0","BPT0","BPN0","BPO0","BU10","BUP0","BUF0","BUN0","BUO0","S300","S400","S500","ST10","STB0","STP0","STG0","STV0","STY0","SM10","SMY0","SMP0","SMM0","SMB0","SMU0","SP10","SPM0","SPP0","SPB0","SPS0","SPV0","SC10","SCB0","SCP0","SCS0","SCA0","D100","D300","D400","D500","D600","DK10","DKA0","DKL0","DKG0","DKN0","DKM0","DKC0","DKS0","DKZ0","DKB0","DKE0","DD10","DDP0","DDB0","DDG0","DDC0","DDA0","DS10","DSS0","DSV0","DSC0","DP10","DPN0","DPB0","DPL0","DPC0","DPH0","DA10","DAC0","DAP0","DAM0","DAT0","DAF0"];this.jc_eidf_xeidcc="f3x_xeidcc";this.jc_eidf_enty="f3x_enty";this.jc_eidf_enid="f3x_enid";this.jc_eidf_egty="f3x_egty";this.jc_eidf_egid="f3x_egid";this.jc_eidf_ucat="f3x_cU";this.jc_eidf_vcat="f3x_cV";this.jc_eidf_a="f3x_gnA";this.jc_eidf_z="f3x_gnZ";this.jc_eidf_n="f3x_gnN";this.jc_eidf_m="f3x_gnM";this.jc_eidf_c="f3x_gnC";this.jc_eidf_p="f3x_gpP";this.jc_eidf_s="f3x_gpS";this.jc_ebisf_enty="f3x_enty";this.jc_ebisf_enid="f3x_enid";this.jc_ebisf_created="f3x_ucretime";this.jc_ebisf_modified="f3x_umodtime";this.jc_ebisf_order="f3x_esorder";this.jc_ebisf_sym="f3x_esym";this.jc_ebisf_color="f3x_escolor";this.jc_ebisf_lat="f3x_eslat";this.jc_ebisf_lon="f3x_eslon";this.jc_ebisf_name="f3x_esname";this.jc_ebisf_descr="f3x_esdescr";this.jc_ebisf_url="f3x_esurl";this.jc_ebidf_enty="f3x_enty";this.jc_ebidf_enid="f3x_enid";this.jc_ebidf_likes="f3x_likes";this.jc_ebidf_likesbonus="f3x_likesbonus";this.jc_ebidf_clicks="f3x_clicks";this.jc_ebidf_clicksphtime="f3x_clicksphtime";this.jc_ebidf_score="f3x_score";this.jc_eif_enty="f3x_enty";this.jc_eif_enid="f3x_enid";this.Init=function(jc_oStorage)
...
return false;return this.Set_Glid(jt_glid);};this.Get_XKey=function(){return this.Get_XGlid()||"";};this.Get_GLDString=function()
{return(this.IsValid()?this.jm_sGLD||"":"");};this.Set_GLDString=function(ji_xglid,ji_sGLD)
{this.jm_sGLD=null;if(!this.Set_XGlid(ji_xglid))
return false;this.jm_sGLD=ji_sGLD;return true;};this.LoadFromGLS=function(ji_oDbTransaction,ji_xglid)
{if(ji_xglid)
this.Set_XGlid(ji_xglid);if(!this.IsValid())
...
{this.jm_Operation=(ji_Operation||null);this.jm_Status=(ji_Status||jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StEmpty);this.jm_sMessage=(ji_sMessage||"");this.jm_fnOnChange=(ji_fnOnChange||null);this.IsReady=function()
...
{return this.jm_Status==jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StSuccess;};this.IsSuccessOrEmpty=function(){return this.IsSuccess()||this.IsEmpty();};this.IsOpLoad=function(){return this.jm_Operation==jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpLoad;};this.IsOpStore=function(){return this.jm_Operation==jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpStore;};this.IsOpCache=function(){return this.jm_Operation==jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpCache;};this.IsOpClear=function(){return this.jm_Operation==jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpClear;};this.IsOpAjax=function(){return this.jm_Operation==jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpAjax;};this.IsLoading=function(){return this.IsOpLoad()&&this.IsInProgress();};this.IsStoring=function(){return this.IsOpStore()&&this.IsInProgress();};this.IsCaching=function(){return this.IsOpCache()&&this.IsInProgress();};this.IsClearing=function(){return this.IsOpClear()&&this.IsInProgress();};this.SetLoadStatus=function(ji_Status,ji_sMessage)
{return this.Set3(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpLoad,ji_Status,ji_sMessage);};this.SetLoadStatusFail=function(ji_sMessage)
{return this.SetLoadStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StFail,ji_sMessage);};this.SetLoadStatusSuccess=function(ji_sMessage)
{return this.SetLoadStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StSuccess,ji_sMessage);};this.SetLoadStatusInProgress=function(ji_sMessage)
{return this.SetLoadStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StInProgress,ji_sMessage);};this.SetLoadStatusEmpty=function(ji_sMessage)
{return this.SetLoadStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StEmpty,ji_sMessage);};this.SetStoreStatus=function(ji_Status,ji_sMessage)
{return this.Set3(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpStore,ji_Status,ji_sMessage);};this.SetStoreStatusFail=function(ji_sMessage)
{return this.SetStoreStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StFail,ji_sMessage);};this.SetStoreStatusInProgress=function(ji_sMessage)
{return this.SetStoreStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StInProgress,ji_sMessage);};this.SetStoreStatusSuccess=function(ji_sMessage)
{return this.SetStoreStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StSuccess,ji_sMessage);};this.SetStoreStatusOpen=function(ji_sMessage)
{return this.SetStoreStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StOpen,ji_sMessage);};this.SetCacheStatus=function(ji_Status,ji_sMessage)
{return this.Set3(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpCache,ji_Status,ji_sMessage);};this.SetCacheStatusFail=function(ji_sMessage)
{return this.SetCacheStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StFail,ji_sMessage);};this.SetCacheStatusInProgress=function(ji_sMessage)
{return this.SetCacheStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StInProgress,ji_sMessage);};this.SetCacheStatusEmpty=function(ji_sMessage)
{return this.SetCacheStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StEmpty,ji_sMessage);};this.SetCacheStatusSuccess=function(ji_sMessage)
{return this.SetCacheStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StSuccess,ji_sMessage);};this.SetClearStatus=function(ji_Status,ji_sMessage)
{return this.Set3(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpClear,ji_Status,ji_sMessage);};this.SetClearStatusFail=function(ji_sMessage)
{return this.SetClearStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StFail,ji_sMessage);};this.SetClearStatusInProgress=function(ji_sMessage)
{return this.SetClearStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StInProgress,ji_sMessage);};this.SetClearStatusSuccess=function(ji_sMessage)
{return this.SetClearStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StSuccess,ji_sMessage);};this.SetClearStatusOpen=function(ji_sMessage)
{return this.SetClearStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StOpen,ji_sMessage);};this.SetAjaxStatus=function(ji_Status,ji_sMessage)
{return this.Set3(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpAjax,ji_Status,ji_sMessage);};this.SetAjaxStatusFail=function(ji_sMessage)
{return this.SetAjaxStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StFail,ji_sMessage);};this.SetAjaxStatusInProgress=function(ji_sMessage)
{return this.SetAjaxStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StInProgress,ji_sMessage);};this.SetAjaxStatusSuccess=function(ji_sMessage)
{return this.SetAjaxStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StSuccess,ji_sMessage);};this.SetAjaxStatusOpen=function(ji_sMessage)
{return this.SetAjaxStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StOpen,ji_sMessage);};this.SetFrom=function(ji_oDTStatus)
{if(!ji_oDTStatus)
...
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpLoad,ji_Status,ji_sMessage,ji_fnOnChange);}
function GLDataStatusLoadFail(ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpLoad,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StFail,ji_sMessage,ji_fnOnChange);}
function GLDataStatusLoadSuccess(ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpLoad,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StSuccess,ji_sMessage,ji_fnOnChange);}
function GLDataStatusLoadInProgress(ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpLoad,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StInProgress,ji_sMessage,ji_fnOnChange);}
function GLDataStatusLoadEmpty(ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpLoad,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StEmpty,ji_sMessage,ji_fnOnChange);}
function GLDataStatusStore(ji_Status,ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpStore,ji_Status,ji_sMessage,ji_fnOnChange);}
function GLDataStatusStoreFail(ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpStore,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StFail,ji_sMessage,ji_fnOnChange);}
function GLDataStatusStoreSuccess(ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpStore,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StSuccess,ji_sMessage,ji_fnOnChange);}
function GLDataStatusStoreInProgress(ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpStore,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StInProgress,ji_sMessage,ji_fnOnChange);}
function GLDataStatusStoreEmpty(ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpStore,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StEmpty,ji_sMessage,ji_fnOnChange);}
function GLDataStatusCache(ji_Status,ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpCache,ji_Status,ji_sMessage,ji_fnOnChange);}
function GLDataStatusCacheFail(ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpCache,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StFail,ji_sMessage,ji_fnOnChange);}
function GLDataStatusCacheSuccess(ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpCache,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StSuccess,ji_sMessage,ji_fnOnChange);}
function GLDataStatusCacheEmpty(ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpCache,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StEmpty,ji_sMessage,ji_fnOnChange);}
function GLDataStatusClear(ji_Status,ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpClear,ji_Status,ji_sMessage,ji_fnOnChange);}
function GLDataStatusClearFail(ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpClear,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StFail,ji_sMessage,ji_fnOnChange);}
function GLDataStatusClearSuccess(ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpClear,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StSuccess,ji_sMessage,ji_fnOnChange);}
function GLDataStatusClearInProgress(ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpClear,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StInProgress,ji_sMessage,ji_fnOnChange);}
function GLDataStatusClearOpen(ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpClear,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StOpen,ji_sMessage,ji_fnOnChange);}
function GLDataStatusAjax(ji_Status,ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpAjax,ji_Status,ji_sMessage,ji_fnOnChange);}
function GLDataStatusAjaxFail(ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpAjax,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StFail,ji_sMessage,ji_fnOnChange);}
function GLDataStatusAjaxSuccess(ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpAjax,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StSuccess,ji_sMessage,ji_fnOnChange);}
function GLDataStatusAjaxOpen(ji_sMessage,ji_fnOnChange)
{GLDataStatus.call(this,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpAjax,jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StOpen,ji_sMessage,ji_fnOnChange);}
...
return this.Set_Result({bLoad:true,bError:true},"Load Record: "+this.Get_Key()+"=Empty Value");if(!this.jm_ogldTarget.Set_GLDString(this.jm_ogldTarget.Get_XGlid(),ji_value))
...
function GLRecord()
{this.Get_Field=function(ji_name)
{if(!this.Get_SDS3x2Record())
return null;return this.Get_SDS3x2Record().rec.getFieldValue_ByName(ji_name);};this.Get_FieldArray_Recordset=function(ji_name)
{if(!this.Get_SDS3x2Record())
return null;var jt_o3x2rsfa=this.Get_SDS3x2Record().rec.get3x2Recordset_ByName(ji_name);if(!jt_o3x2rsfa)
return null;return jt_o3x2rsfa.rs.getD3xRecordset();};this.jm_o3x2rec=null;this.Set_SDS3x2Record=function(ji_o3x2rec){this.jm_o3x2rec=ji_o3x2rec;return true;};this.Get_SDS3x2Record=function(){return this.jm_o3x2rec;};this.jm_aoglrSub=new Array();this.GLRecord_Set_SubRecord=function(ji_SubType,ji_oglrSub)
...
function GLDataTable(ji_oDatabase,ji_glid,ji_release)
{this.jm_oDTStatus=new GLDataStatus();this.jm_glid=null;this.jm_release=null;this.jm_aoglr=new A3xaArray();this.jm_aaoglrSelect=new A3xaArray();this.jm_bAX=true;this.jm_aoglrAX=null;this.jm_odb=null;this._GLDataTable=function(ji_oDatabase,ji_glid,ji_release)
...
this.jm_bAX=false;this.Set_Glid(ji_glid);this.Set_Release(ji_release);}};this.jm_o3xJSDS=null;this.New3xJSDS=function(){return new GLData(jg_oe.jc_oA3xaDbZero.jc_GLMID_JSDS);};this.Get_3xJSDS=function()
...
return false;this.jm_o3xJSDS=ji_o3xJSDS;return true;};this.Build_3xJSDS=function(ji_o3x2tbTOC)
{if(!ji_o3x2tbTOC)
return false;var jt_o3xJSDS=this.New3xJSDS();if(!jt_o3xJSDS.Set_GLDString(this.Get_Glid(),ji_o3x2tbTOC.tb.getJSDS()))
return false;if(!this.Set_3xJSDS(jt_o3xJSDS))
return false;return true;};this.NewRecord=function()
...
return new GLRecord();else if(jt_oDbSchemaTable.jp_SubTable==jg_oe.jc_oA3xaDbZero.jc_tbtype_ebis.tbtname)
return new GLRecord();else if(jt_oDbSchemaTable.jp_SubTable==jg_oe.jc_oA3xaDbZero.jc_tbtype_ebid.tbtname)
return new GLRecord();else if(jt_oDbSchemaTable.jp_SubTable==jg_oe.jc_oA3xaDbZero.jc_tbtype_ei.tbtname)
return new GLRecord();return null;};this.Get_Glid=function(){return this.jm_glid;};this.Set_Glid=function GLDataTable_Set_Glid(ji_glid)
...
return this.ClearGLSAndFail2(new GLDataStatusStoreFail("Store JSDS"));jg_oe.Get_Reporter().OnDataStored();}
...
var jt_o3xJSDS=this.New3xJSDS();if(!jt_o3xJSDS.LoadFromGLS(ji_oDbTransaction,ji_glid))
...
{this.jm_oDTStatus.SetLoadStatusSuccess();return true;};this.Get_GLRecord=function(ji_id){return this.Get_Recordset().Get_Item(ji_id);};this.Set_GLRecord=function(ji_id,ji_oglr){return this.Get_Recordset().Set_Item(ji_id,ji_oglr);};this.Get_GLRecordAX=function(ji_AltKey){return(this.jm_bAX?this.Get_RecordsetAX().Get_Item(ji_AltKey):null);};this.Get_Recordset=function(){return this.jm_aoglr||null;};this.Get_RecordsetAX=function(){return this.jm_aoglrAX||null;};this.New_Recordsel=function(ji_sSelectName,ji_fnSelect,ji_MaxItems)
...
{return this.jm_aaoglrSelect.Get_Item(ji_sSelectName||"DefaultSelect")||new A3xaArrayIt(this.Get_Recordset());};this.ClearGLSAndFail2=function(ji_oDTStatus)
{this.jm_oDTStatus.SetFrom(ji_oDTStatus);this.Get_Database().jm_aoglDataTableStore=null;this.Get_Database().jm_aoDTStatus_TableToClear=null;jg_oe.ClearStorage();return false;};this.Get_Database=function(){return this.jm_odb;};this.Get_Storage=function(){return jg_oe.Get_Database().Get_Storage(this.Get_Glid());};this.CheckLoadTableStatus=function()
{if(!this.jm_oDTStatus.IsInProgress())
...
return new GLDataStatusLoadEmpty();return new GLDataStatusLoadSuccess();};this.Set_Release=function(ji_release){this.jm_release=ji_release;return true;};this.Get_Release=function(){return this.jm_release;};this.OnTransactionComplete=function(ji_oidbEvent,ji_oStorageOpType)
...
{this.jm_oDTStatus.SetStoreStatusSuccess();}
else if(jt_odtStatus.IsFail())
{this.jm_oDTStatus.SetStoreStatusFail();}
else if(jt_odtStatus.IsEmpty())
{if(this.Get_Database().jm_oDbSchema.IsMandatory(this.Get_Glid()))
this.jm_oDTStatus.SetStoreStatusFail();else
this.jm_oDTStatus.SetStoreStatusSuccess();}
else
{}}}
...
{this.jm_oDTStatus.SetStoreStatusFail();this.ClearGLSAndFail2(new GLDataStatusStoreFail("Store Fail"));}
else if(ji_oStorageOpType.bLoad)
{this.jm_oDTStatus.SetLoadStatusFail();}
...
{if(!jr_I.checkIndex(ji_ix))
return null;return jr_I._getFieldValue(ji_ix);};jr_I.isRecordset=function(ji_ix)
{if(!jr_I.checkIndex(ji_ix))
...
{var jt_subrs="";var jt_sepr=jg_oe.jc_oA3xaDbZero.jc_GLSep_FieldArray;var jt_sepf=jg_oe.jc_oA3xaDbZero.jc_GLSep_Compact;for(var j=0;j<jt_f.length;j++)
{if(j)jt_subrs+=jt_sepr;var jt_rec=jt_f[j];for(var k=0;k<jt_rec.length;k++)
jt_subrs+=((k?jt_sepf:"")+jt_rec[k]);}
jr_aFields.push(jt_subrs||"");}}
...
ji_o3x2a=A3xa2Array();else
ji_o3x2a.ar.clear();var jt_c=jr_I.getCount();for(var i=0;i<jt_c;i++)
{var jt_pisdsrec=PISDSRecord();jt_pisdsrec.index=i;jt_pisdsrec.o3x2rec=jr_I._get3x2Record(i);jt_pisdsrec=ji_fnKeyMaker(jt_pisdsrec);if(!ji_o3x2a.ar.addItem(jt_pisdsrec.key,jt_pisdsrec.o3x2rec))
{return null;}}
...
{jr_pisdsrec.key=jt_o3x2index.ar.getKey(ji_ixRecord);jr_pisdsrec.o3x2rec=jt_o3x2index.ar.getItem(jr_pisdsrec.key);}}
...
{var jr_I={addTablesJSDS:function(){return false;},addD3xTable:function(ji_sdsTable,ji_bJSON){return null;},get3x2Table:function(ji_glid,ji_name,ji_type){return null;},new3x2Table:function(ji_sdsTable,ji_bJSON){return null;}};jr_I.new3x2Table=function(ji_sdsTable,ji_bJSON)
...
{return jr_o.jm_sdsrec[ji_ix];};jr_o.rec.get3x2Recordset=function(ji_ix)
{if(!jr_o.rec.isRecordset(ji_ix))
return null;if(!(jr_o.jm_o3x2FieldPropArray&&jr_o.jm_o3x2FieldPropArray.fpa.isFieldArray(ji_ix)))
return null;return A3xa2StaticDataSource_Recordset(jr_o.jm_sdsrec[ji_ix],jr_o.jm_o3x2FieldPropArray.fpa.get3x2FieldPropArray(ji_ix));};jr_o.rec.getFieldPos=function(ji_fieldName)
...
{var jr_o={jm_sdstb:null,jm_a3x2Indexes:A3xa2Array(),tb:A3xa2IStaticDataSource_Table(),_Construct:function(ji_sdsTable,ji_bJSON)
{if(ji_bJSON)
jr_o.tb.setJSDS(ji_sdsTable);else
jr_o.tb.setD3xTable(ji_sdsTable);}};jr_o.tb.setD3xTable=function(ji_sdsTable)
{jr_o.jm_sdstb=ji_sdsTable;return true;};jr_o.tb.getD3xTable=function(){return jr_o.jm_sdstb;};jr_o.tb.isValid=function()
...
return false;return jr_o.jm_a3x2Indexes.ar.setItem(ji_keyName,jt_o3x2ax);};jr_o.tb.getTableIndex=function(ji_keyName){return jr_o.jm_a3x2Indexes.ar.getItem(ji_keyName);};jr_o.tb.getCountOfRecords=function()
...
{var jr_o={jm_o3x2a:A3xa2Array(),db:A3xa2IStaticDataSource_Db()};jr_o.db.addD3xTable=function(ji_sdsTable,ji_bJSON)
{if(!ji_sdsTable)
return null;var jr_o3x2tb=jr_o.db.new3x2Table(ji_sdsTable,ji_bJSON);if(!(jr_o3x2tb&&jr_o3x2tb.tb.isValid()))
return null;var jt_glid=jr_o3x2tb.tb.getGlid();var jt_name=jr_o3x2tb.tb.getName();var jt_type=jr_o3x2tb.tb.getType();var jt_id=jt_glid+","+jt_type;if(!jr_o.jm_o3x2a.ar.setItem(jt_id,jr_o3x2tb))
return null;if(!jr_o3x2tb.tb.buildTableIndexes())
return null;return jr_o3x2tb;};jr_o.db.get3x2Table=function(ji_glid,ji_name,ji_type)
{if(ji_glid)
{if(!ji_type)
ji_type=jg_oe.jc_oA3xaDbZero.Glid2SDSTbType(ji_glid).tbtname;return jr_o.jm_o3x2a.ar.getItem(ji_glid+","+ji_type);}
else if(ji_type&&ji_name)
{return jr_o.jm_o3x2a.ar.findItem(function(ji_o3x2tb)
{return(ji_name==ji_o3x2tb.tb.getName()&&ji_type==ji_o3x2tb.tb.getType());});}
return null;};return jr_o;}
function A3xa2IDTCacheWriter()
{var jr_I={setDataTable:function(ji_odt){return false;},enableJSDS:function(ji_b){return false;},writeTable:function(){return false;},writeJSDS:function(){return false;},writeHeader:function(){return false;},integrityCheck:function(){return null;}};return jr_I;}
function A3xa2IDTCacheWriterExec()
{var jr_I={checkDataSource:function(){return false;},writeJSDS:function(){return false;},writeHeader:function(){return false;},};return jr_I;}
function A3xa2DTCacheWriter(ji_odt,ji_odb,ji_glid)
{var jr_o={jm_odb:null,jm_glid:null,jm_header_glid:null,jm_header_release:null,jm_bEnableJSDS:false,jm_o3xJSDS:null,jm_odt:null,csw:A3xa2IDTCacheWriter(),_cswxec:A3xa2IDTCacheWriterExec(),_Construct:function(ji_odt,ji_odb,ji_glid)
{if(ji_glid)
ji_glid=jg_oe.jc_oA3xaDbZero.XGlid2Glid(ji_glid);else if(ji_odt)
ji_glid=ji_odt.Get_Glid();jr_o.jm_odb=ji_odb;jr_o.jm_glid=ji_glid;jr_o.csw.setDataTable(ji_odt);}};jr_o.csw.setDataTable=function(ji_odt){jr_o.jm_odt=ji_odt;return true;};jr_o.csw.enableJSDS=function(ji_b){jr_o.jm_bEnableJSDS=!(ji_b===false);return true;};jr_o.csw.writeTable=function()
{if(!(jr_o.jm_glid))
return false;if(!jr_o._cswxec.checkDataSource())
return false;if(!jr_o.jm_odt)
{if(!(jr_o.jm_odb&&jr_o.jm_glid))
return false;var ji_odt=jr_o.jm_odb.NewDataTableCacheStore(jr_o.jm_glid);if(!ji_odt)
return false;jr_o.jm_odb.jm_oDTStatus.SetCacheStatusInProgress("Cache Tableset "+jr_o.jm_glid);jr_o.jm_odb.jm_aoglDataTableStore.Set_Item(jr_o.jm_glid,ji_odt);jr_o.csw.setDataTable(ji_odt);}
jr_o.jm_odt.jm_oDTStatus.SetCacheStatusInProgress();if(!jr_o.csw.writeHeader())
{if(jr_o.jm_odb)
jr_o.jm_odb.jm_oDTStatus.SetCacheStatusFail("Cache Tableset Cache "+jr_o.jm_glid);return false;}
if(jr_o.jm_bEnableJSDS&&!jr_o.csw.writeJSDS())
{if(jr_o.jm_odb)
jr_o.jm_odb.jm_oDTStatus.SetCacheStatusFail("Cache Tableset Cache "+jr_o.jm_glid);return false;}
if(jr_o.jm_bEnableJSDS)
jr_o.jm_odt.jm_o3xJSDS=jr_o.jm_o3xJSDS;jr_o.jm_odt.Set_Glid(jr_o.jm_glid);jr_o.jm_odt.Set_Release(jr_o.jm_header_release);jr_o.jm_odt.jm_oDTStatus.SetFrom(jr_o.csw.integrityCheck());return(jr_o.jm_odt.jm_oDTStatus.IsSuccess());};jr_o.csw.writeJSDS=function()
{jr_o.jm_o3xJSDS=jr_o.jm_odt.New3xJSDS();jr_o._cswxec.writeJSDS();if(jr_o.jm_o3xJSDS.Get_Glid()!=jr_o.jm_glid)
...
return true;};jr_o.csw.writeHeader=function()
{jr_o._cswxec.writeHeader();if(jr_o.jm_header_glid!=jr_o.jm_glid)
{jr_o.jm_odt.jm_oDTStatus.SetCacheStatusFail("Header glid");return false;}
return true;};jr_o.csw.integrityCheck=function()
{var jt_sGlid=jr_o.jm_odt.Get_Glid();if(!jt_sGlid)
return new GLDataStatusCacheFail("Missing Table Name");return new GLDataStatusCacheSuccess();};jr_o._Construct(ji_odt,ji_odb,ji_glid);return jr_o;}
function A3xa2DTCacheWriter_GLRS(ji_odt,ji_odb,ji_glid,ji_sGLRS)
{var jr_o=A3xa2DTCacheWriter(ji_odt,ji_odb,ji_glid);jr_o.jm_aglRS=null;if(ji_sGLRS)
jr_o.jm_aglRS=ji_sGLRS.split(jg_oe.jc_oA3xaDbZero.jc_GLSep_Block);jr_o._cswxec.checkDataSource=function(){return(jr_o.jm_aglRS?true:false);};jr_o._cswxec.writeJSDS=function()
{if(!jr_o.jm_o3xJSDS)
return false;var jt_aFieldNames2=jr_o.jm_aglRS[1].split(jg_oe.jc_oA3xaDbZero.jc_GLSep_Header);var jt_aFieldNames=((jt_aFieldNames2&&jt_aFieldNames2[1])?jt_aFieldNames2[1].split(jg_oe.jc_oA3xaDbZero.jc_GLSep_Field):null);if(!(jt_aFieldNames&&jt_aFieldNames.length>1))
return false;var jt_keynameTrashed=jt_aFieldNames.shift();var jt_posFieldArray=-1;var jt_sFieldNames="";for(var ifa=0;ifa<jt_aFieldNames.length;ifa++)
{if(jt_aFieldNames[ifa]!=jg_oe.jc_oA3xaDbZero.jc_sEifaName)
jt_sFieldNames+=((ifa>0?',"':'"')+jt_aFieldNames[ifa]+'"')
else
{jt_posFieldArray=ifa;jt_sFieldNames+=((ifa>0?',':'')+'{"d3x_name":"'+jt_aFieldNames[ifa]+'","d3x_names":["f3x_eityp","f3x_eicod","f3x_eiid","f3x_eipid","f3x_einfo"]}');}}
var jt_nofRecords=jr_o.jm_aglRS.length-2;var jt_JSDS='{"d3x_header":'+'{"d3x_glid":"'+jr_o.jm_header_glid+'","d3x_tbtype":"'+
jg_oe.jc_oA3xaDbZero.Glid2SDSTbType(jr_o.jm_glid).tbtname+'","d3x_tbname":"","d3x_version":"'+jr_o.jm_header_release+'"},';jt_JSDS+='"d3x_names":['+jt_sFieldNames+'],';jt_JSDS+='"d3x_records":[';for(var i=0;i<jt_nofRecords;i++)
{var jt_aRecord2=jr_o.jm_aglRS[i+2].split(jg_oe.jc_oA3xaDbZero.jc_GLSep_Header);var jt_aRecord=((jt_aRecord2&&jt_aRecord2[1])?jt_aRecord2[1].split(jg_oe.jc_oA3xaDbZero.jc_GLSep_Field):null);if(jt_aRecord&&jt_aRecord.length>1)
{var jt_keyTrashed=jt_aRecord.shift();jt_JSDS+=(i>0?',':'')+'[';if(jt_posFieldArray<0)
jt_JSDS+='"'+jt_aRecord.join('","')+'"';else
{var jt_subrs=jt_aRecord[jt_posFieldArray];for(var ifld=0;ifld<jt_aRecord.length;ifld++)
{jt_JSDS+=(ifld>0?',':'');if(ifld!=jt_posFieldArray)
jt_JSDS+='"'+jt_aRecord[ifld]+'"';else if(jt_subrs)
jt_JSDS+=('[["'+jt_subrs.replace(/__glr__/g,'"],["').replace(/~/g,'","')+'"]]');else
jt_JSDS+=('[[""]]');}}
jt_JSDS+=']';}}
jt_JSDS+=']}';return jr_o.jm_o3xJSDS.Set_GLDString(jr_o.jm_glid,jt_JSDS);};jr_o._cswxec.writeHeader=function()
{var jt_aHeader2=jr_o.jm_aglRS[0].split(jg_oe.jc_oA3xaDbZero.jc_GLSep_Header);var jt_aHeader=((jt_aHeader2&&jt_aHeader2[1])?jt_aHeader2[1].split(jg_oe.jc_oA3xaDbZero.jc_GLSep_Field):null);if(!(jt_aHeader&&jt_aHeader.length>0))
return false;jr_o.jm_header_glid=jg_oe.jc_oA3xaDbZero.XGlid2Glid(jt_aHeader2[0]);jr_o.jm_header_release=jt_aHeader[0];return true;};return jr_o;}
function A3xa2DTCacheWriter_sds(ji_odt,ji_odb,ji_glid,ji_o3xdbsds,ji_keyname)
{var jr_o=A3xa2DTCacheWriter(ji_odt,ji_odb,ji_glid);jr_o.jm_o3x2tbe=null;jr_o.jm_o3xdbsds=ji_o3xdbsds;jr_o._cswxec.checkDataSource=function(){return!!jr_o.jm_o3x2tbe;};jr_o._cswxec.writeJSDS=function()
{if(!(jr_o.jm_o3x2tbe&&jr_o.jm_o3x2tbe.tb.getD3xTable()))
return false;if(!jr_o.jm_o3xJSDS)
return false;return jr_o.jm_o3xJSDS.Set_GLDString(jr_o.jm_glid,jr_o.jm_o3x2tbe.tb.getJSDS());};jr_o._cswxec.writeHeader=function()
{jr_o.jm_header_glid=(jr_o.jm_o3x2tbe?jr_o.jm_o3x2tbe.tb.getGlid():"");jr_o.jm_header_release=(jr_o.jm_o3x2tbe?jr_o.jm_o3x2tbe.tb.getVersion():"");return true;};if(jr_o.jm_odb&&jr_o.jm_o3xdbsds&&jr_o.jm_glid)
jr_o.jm_o3x2tbe=jr_o.jm_o3xdbsds.db.get3x2Table(jr_o.jm_glid,null,null);return jr_o;}
function A3xaDatabase(ji_oDbSchema)
{var jt_this=this;this.Get_Storage=function(ji_glid)
...
{return jg_oe.Get_Storage(ji_StorageType);};this.jm_o3x2sdsdb_Store=null;this.Set_SDSDBStore=function(ji_o3x2sdsdb){this.jm_o3x2sdsdb_Store=ji_o3x2sdsdb;return true;};this.Get_SDSDBStore=function(){return this.jm_o3x2sdsdb_Store;};this.jm_o3x2sdsdb_Work=null;this.Set_SDSDBWork=function(ji_o3x2sdsdb){this.jm_o3x2sdsdb_Work=ji_o3x2sdsdb;return true;};this.Get_SDSDBWork=function(){return this.jm_o3x2sdsdb_Work;};this.jm_oDbSchema=(ji_oDbSchema||null);this.jm_oDTStatus=new GLDataStatusCache();this.jm_moreOnStoreAllData=0;this.jm_aoDTStatus_TableToClear=null;this.jm_aoglDataTableStore=new A3xaArray();this.jm_aoglDataTableLoad_TOC=new A3xaArray();this.jm_aoglDataTableLoad_Common=new A3xaArray();this.jm_aoglDataTableLoad_Main=new A3xaArray();this.jm_odbTransaction=null;this.ClearArrayDTLoad=function(ji_pTypTables)
{if(!ji_pTypTables)
return false;if(ji_pTypTables.jp_bTyp_TOC)
this.jm_aoglDataTableLoad_TOC=new A3xaArray();else if(ji_pTypTables.jp_bTyp_Common)
this.jm_aoglDataTableLoad_Common=new A3xaArray();else if(ji_pTypTables.jp_bTyp_Main)
this.jm_aoglDataTableLoad_Main=new A3xaArray();else
return false;return true;}
this.Get_ArrayDTLoad=function(ji_pTypTables)
{if(!ji_pTypTables)
return null;if(ji_pTypTables.jp_bTyp_TOC)
return this.jm_aoglDataTableLoad_TOC;else if(ji_pTypTables.jp_bTyp_Common)
return this.jm_aoglDataTableLoad_Common;else if(ji_pTypTables.jp_bTyp_Main)
return this.jm_aoglDataTableLoad_Main;return null;};this.NewDataTableCacheStore=function(ji_glid)
{return new GLDataTable(this,ji_glid);};this.NewDataTable=function(ji_glid){return null;};this.Get_MainDataTable=function(ji_A,ji_Z,ji_N){return null;};this.Get_DataTable=function(ji_glid,ji_bDontCheck)
...
ji_glid+"="+jr_odt.jm_oDTStatus.Get_Descr2());if(!jr_odt.jm_oDTStatus.IsSuccessOrEmpty())
...
return null;return jt_ogldt;};this.Open=function(ji_oStorageOpType,ji_otkm)
{var jt_os1=jg_oe.Get_Storage(jg_oe.jc_oStorage.jc_FLY);if(!jt_os1)
return false;if(!jt_os1.IsOpen())
{if(!jt_os1.Open(null,this.jm_oDbSchema))
return false;if(!jt_os1.IsOpen())
return false;}
if(jg_oe.jm_StorageTypeDefault==jg_oe.jc_oStorage.jc_FLY)
return true;var jt_os2=jg_oe.Get_Storage(jg_oe.jc_oStorage.jc_Default);if(!jt_os2)
return false;if(jt_os2.IsOpen()||jt_os2.IsOpening())
return true;if(!jt_os2.Open(jt_os2.NewTransaction(null,ji_oStorageOpType,new A3xaDatabase_TransactionListener(this,ji_otkm)),this.jm_oDbSchema))
{return false;}
return(jt_os2.IsOpen()||jt_os2.IsOpening());};this.IsOpen=function()
...
return false;return true;};this.IsOpening=function()
...
return true;if(this.jm_bOpening)
return true;return false;};this.OnDataLoadedSetup=function()
...
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("Open Storage","Store Tables","A3xaDatabase_StoreAllData");this.Open({bOpenStore:true});this.jm_oDTStatus.SetStoreStatusOpen();}
...
{var jt_ogldt=this.jm_aoglDataTableStore.Get_Item_ByIndex(j);var jt_this=this;jt_ogldt.jm_oDTStatus.jm_fnOnChange=function(ji_oDTStatus)
{jt_this.StoreAllData(false);}}
var jr_oDTStatus=new GLDataStatusCacheSuccess("");for(var i=0;i<jt_CountDT;i++)
{var jt_ogldt=this.jm_aoglDataTableStore.Get_Item_ByIndex(i);if(jt_ogldt.jm_oDTStatus.IsSuccess())
...
{var jt_ogldt=this.jm_aoglDataTableStore.Get_Item_ByIndex(i);if(jt_ogldt.jm_oDTStatus.IsFail())
...
{var jt_ogldt=this.jm_aoglDataTableStore.Get_Item_ByIndex(i);if(jt_ogldt.jm_oDTStatus.IsOpStore()&&jt_ogldt.jm_oDTStatus.IsInProgress())
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("p2000="+"Store Cache In Progress "+jt_ogldt.Get_Glid());return new GLDataStatusStoreInProgress();}}
for(i=0;i<jt_CountDT;i++)
{var jt_ogldt=this.jm_aoglDataTableStore.Get_Item_ByIndex(i);if(jt_ogldt.jm_oDTStatus.IsOpCache()&&jt_ogldt.jm_oDTStatus.IsSuccess())
...
{var jt_glid=jg_oe.jc_oA3xaDbZero.jc_GLID_TOC;var jt_keyname=jg_oe.jc_oA3xaDbZero.Glid2SDSTbType(jt_glid).tbtkeyname;var jr_odtTOC=this.Get_DataTable(jt_glid,true);if(!jr_odtTOC)
return null;return jr_odtTOC;};this.Get_3x2TOC=function()
{return this.Get_SDSDBWork().db.get3x2Table(jg_oe.jc_oA3xaDbZero.jc_GLID_TOC,null,null);};this.Get_TOCItem=function(ji_glid)
{if(!ji_glid)
return null;if(jg_oe.jc_oA3xaDbZero.IsGlidTOC(ji_glid))
return null;var jt_odtTOC=this.Get_TOC();if(!jt_odtTOC)
return null;var jt_o3x2tbTOC=this.Get_3x2TOC();if(!jt_o3x2tbTOC)
return null;var jr_pisdsRecord=jt_o3x2tbTOC.tb.getRecord_ByKey(ji_glid);return jr_pisdsRecord;};this.AddTOCItem=function(ji_glid,ji_release)
{if(!ji_glid)
return false;if(jg_oe.jc_oA3xaDbZero.IsGlidTOC(ji_glid))
return false;var jt_odtTOC=this.Get_TOC();if(!jt_odtTOC)
return false;var jt_o3x2tbTOC=this.Get_SDSDBWork().db.get3x2Table(jg_oe.jc_oA3xaDbZero.jc_GLID_TOC,null,null);if(!jt_o3x2tbTOC)
return false;var jt_pisdsRecord=jt_o3x2tbTOC.tb.addRecord_ByKey(ji_glid,[ji_glid,ji_release],true);return true;};this.RemoveTOCItem=function(ji_glid)
{if(!ji_glid)
return false;if(jg_oe.jc_oA3xaDbZero.IsGlidTOC(ji_glid))
return false;var jt_odtTOC=this.Get_TOC();if(!jt_odtTOC)
return false;var jt_o3x2tbTOC=this.Get_SDSDBWork().db.get3x2Table(jg_oe.jc_oA3xaDbZero.jc_GLID_TOC,null,null);if(!jt_o3x2tbTOC)
...
{var jt_glid=ji_odbtr.jm_aDbTableName[i];var jt_odt=null;if(jg_oe.jc_oA3xaDbZero.IsGlidTOC(jt_glid))
...
{jt_odt.OnTransactionComplete(ji_oidbEvent,ji_odbtr.jm_oStorageOpType);this.jm_odb.AddTOCItem(jt_glid,jt_odt.Get_Release());}}}}
else if(ji_odbtr.jm_oStorageOpType.bLoad)
{for(var i=0;i<ji_odbtr.jm_aDbTableName.length;i++)
{var jt_odt=null;var jt_glid=ji_odbtr.jm_aDbTableName[i];if(jg_oe.jc_oA3xaDbZero.IsGlidTOC(jt_glid))
...
return true;}
function A3xaTaskHXLoader(ji_fnOnChange,ji_oDatabase,ji_Glid)
{A3xaTaskManager.call(this,ji_fnOnChange);var jt_this=this;this.jm_oDTStatus.jm_Operation=jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpLoad;this.jm_oDatabase=(ji_oDatabase||null);this.jm_Glid=(ji_Glid||null);this.jm_odtToLoad=null;if(this.jm_oDatabase&&this.jm_Glid)
...
{var jt_keyname=jg_oe.jc_oA3xaDbZero.Glid2SDSTbType(jt_glid).tbtkeyname;var jt_o3x2dtcsw=A3xa2DTCacheWriter_sds(this.jm_odtToLoad,this.jm_oDatabase,jt_glid,this.jm_oDatabase.Get_SDSDBWork(),jt_keyname);var jr_b=jt_o3x2dtcsw.csw.writeTable();}}}
return new GLDataStatusLoadSuccess();};}
function A3xaMTHXLoader(ji_fnOnChange,ji_oDatabase,ji_aGlid,ji_aodtToLoad,ji_pTypTables)
{A3xaTaskManager.call(this,ji_fnOnChange);var jt_this=this;this.jm_oDTStatus.jm_Operation=jg_oe.jc_oA3xaDbZero.jc_DTStatus2_OpLoad;this.jm_oDatabase=(ji_oDatabase||null);this.jm_aGlidToLoad=(ji_aGlid||null);this.jm_aGlidQueue=null;this.jm_otktbLoader=null;this._OnRelease=function()
...
{this.jm_fnOnLoadDone=(ji_fnOnLoadDone||null);this.jm_oDatabase=(ji_oDatabase||null);this.jm_odbLoader=null;var jt_this=this;this.RunMain=function(ji_bLoadOnly)
{if(ji_bLoadOnly)
{return this.LoadData();}
this.DatabaseLoadTOC();return true;};this.DatabaseLoadTOC=function()
...
jt_bLoadTOCempty=false;var jt_odtTOC=null;var jt_glid=jg_oe.jc_oA3xaDbZero.jc_GLID_TOC;var jt_keyname=jg_oe.jc_oA3xaDbZero.Glid2SDSTbType(jt_glid).tbtkeyname;if(jt_bLoadTOCempty)
...
jt_bLoadTOCempty=false;}
if(jt_bLoadTOCempty)
{var jt_o3x2dtcsw=A3xa2DTCacheWriter_sds(jt_odtTOC,jt_this.jm_oDatabase,jt_glid,jt_this.jm_oDatabase.Get_SDSDBWork(),jt_keyname);var jr_b=jt_o3x2dtcsw.csw.writeTable();}
return jt_this.StoreData();}
return true;},this.jm_oDatabase);this.jm_odbLoader.LoadTOCTables();return true;};this.StoreData=function()
{this.jm_oDatabase.jm_oDTStatus.jm_fnOnChange=function(ji_oDTStatus)
{if(ji_oDTStatus.IsFail())
{jt_this.jm_oDatabase.jm_aoDTStatus_TableToClear=null;jt_this.jm_oDatabase.jm_aoglDataTableStore=new A3xaArray();return jt_this.StoreTOC(false);}
if((ji_oDTStatus.IsOpStore()&&ji_oDTStatus.IsSuccessOrEmpty())||ji_oDTStatus.IsEmpty())
{jt_this.jm_oDatabase.jm_aoDTStatus_TableToClear=null;jt_this.jm_oDatabase.jm_aoglDataTableStore=new A3xaArray();return jt_this.StoreTOC(true);}
return true;}
this.jm_oDatabase.StoreAllData(true);return true;};this.StoreTOC=function(ji_bStoreSuccess)
{this.jm_oDatabase.jm_oDTStatus.jm_fnOnChange=function(ji_oDTStatus)
{if(ji_oDTStatus.IsDone())
{ji_oDTStatus.jm_fnOnChange=function(){};if(ji_bStoreSuccess&&ji_oDTStatus.IsSuccessOrEmpty())
{return jt_this.LoadData();}
if(ji_oDTStatus.IsFail())
{}}
return true;}
this.jm_oDatabase.StoreTOC(true);return true;};this.LoadData=function()
{if(!(this.jm_oDatabase.jm_aoglDataTableLoad_Common&&this.jm_oDatabase.jm_aoglDataTableLoad_Common.Get_Count()>0))
this.DatabaseLoadCommon();else
...
jt_this.jm_fnOnLoadDone(ji_oDTStatus);return true;}
if(ji_oDTStatus.IsOpLoad()&&ji_oDTStatus.IsSuccessOrEmpty())
{if(jt_this.jm_odbLoader.IsCommonTables())
return jt_this.DatabaseLoadMain();}
return true;},this.jm_oDatabase);this.jm_odbLoader.LoadCommonTables();return true;};this.DatabaseLoadMain=function()
...
{if(jt_this.jm_odbLoader.IsMainTable())
{if(jt_this.jm_fnOnLoadDone)
jt_this.jm_fnOnLoadDone(ji_oDTStatus);}}
return true;},this.jm_oDatabase);this.jm_odbLoader.LoadMainTable();return true;};}
function A3xaDbLoader(ji_fnOnChange,ji_oDatabase)
{A3xaTaskManager.call(this,ji_fnOnChange);var jt_this=this;this.jm_oDatabase=(ji_oDatabase||null);this.jm_omthxLoader=null;this.jm_pTypTables={};this.IsTOCTables=function(){return this.jm_pTypTables.jp_bTyp_TOC||false;};this.IsCommonTables=function(){return this.jm_pTypTables.jp_bTyp_Common||false;};this.IsMainTable=function(){return this.jm_pTypTables.jp_bTyp_Main||false;};this.LoadTOCTables=function(){return this.LoadTables({jp_bTyp_TOC:true});};this.LoadCommonTables=function(){return this.LoadTables({jp_bTyp_Common:true});};this.LoadMainTable=function(){return this.LoadTables({jp_bTyp_Main:true});};this.LoadTables=function(ji_pTypTables)
{this.jm_pTypTables=ji_pTypTables;this.jm_oDatabase.ClearArrayDTLoad(this.jm_pTypTables);this.Reset();this.Start();return true;};this._OnReset=function()
...
{if(!this.jm_oDatabase)
return false;this.jm_oDatabase.Open({bOpenLoad:true},this);return true;};this._OnStart_TableHX=function()
...
{var jt_oSchemaTable=this.jm_oDatabase.jm_oDbSchema.Get_Table_ByIndex(jt_posTable);if(!jt_oSchemaTable)
break;var jt_bTargetTable=false;if(this.IsTOCTables())
jt_bTargetTable=jt_oSchemaTable.jp_bTyp_TOC;else if(this.IsCommonTables())
jt_bTargetTable=jt_oSchemaTable.jp_bTyp_Common;else if(this.IsMainTable())
jt_bTargetTable=jt_oSchemaTable.jp_bTyp_Main;if(jt_bTargetTable)
...
break;jt_aGlidToLoad.push(jt_sTableNameQUR);}
jt_posTable++;}
if(!(jt_aGlidToLoad&&jt_aGlidToLoad.length))
return false;this.jm_omthxLoader=new A3xaMTHXLoader(function(){return jt_this.Task();},this.jm_oDatabase,jt_aGlidToLoad,this.jm_oDatabase.Get_ArrayDTLoad(this.jm_pTypTables),this.jm_pTypTables);jg_oe.CanLogInfo()&&jg_oe.LogInfo("","","A3xaDbLoader._OnStart_TableHX");return true;};this._CheckStatus=function()
{if(this.IsOpening())
{if(this.jm_oDatabase.IsOpen())
{this.jm_oDTStatus.jm_Status=jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StInProgress;if(this._OnStart_TableHX())
...
{this.jm_oDTStatus.jm_Status=jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StFail;}
...
{if(ji_oDTStatusEnd.IsFail())
return ji_oDTStatusEnd;for(var i=0;i<this.jm_oDatabase.jm_oDbSchema.jm_aTables.length;i++)
{var jt_oSchemaTable=this.jm_oDatabase.jm_oDbSchema.Get_Table_ByIndex(i);if(!jt_oSchemaTable)
continue;var jt_sTableNameQUR=(jg_oApp.Get_AppXUR().Get_3xXUR().Default2GlidQUR(jt_oSchemaTable.jp_sName)||"");if(!jt_sTableNameQUR)
...
(this.jm_oDTStatus.jm_fnOnChange?"Y":"null"),"","A3xaDbLOader._OnEnd_Record");return new GLDataStatusLoadSuccess();};}
...
{jt_StorageType=jt_pTable.jp_DefaultStorageType;if(jt_bExtendedStorage)
...
{A3xaStorage.call(this);this.Get_Type=A3xaStorageFLY_Get_Type;this.ExecClear=A3xaStorageFLY_ExecClear;this.ExecWrite=A3xaStorageFLY_ExecWrite;this.ExecRead=A3xaStorageFLY_ExecRead;this.ExecOpen=function(ji_oDbTransaction,ji_oSchema){return true;};this.jm_bAvailable=true;this.jm_aFlyStorage=new Array();}
...
{A3xaStorage.call(this);this.Get_Type=A3xaStorageSS_Get_Type;this.Available=A3xaStorageSS_Available;this.ExecClear=A3xaStorageSS_ExecClear;this.ExecWrite=A3xaStorageSS_ExecWrite;this.ExecRead=A3xaStorageSS_ExecRead;this.ExecOpen=function(ji_oDbTransaction,ji_oSchema){return true;};}
...
{jg_oe.CanLogInfo({DB:3,DBT:"idb"})&&jg_oe.LogInfo("Available","Indexeddb","A3xaStorageIDB_Available");this.jm_bAvailable=true;}
else
{jg_oe.CanLogInfo({DB:3,DBT:"idb"})&&jg_oe.LogInfo("Not Available","Indexeddb","A3xaStorageIDB_Available");}
...
return true;jg_oe.CanLogInfo({DB:3,DBT:"idb"})&&jg_oe.LogInfo("Begin","Open Indexeddb","A3xaStorageIDB_ExecOpen");var jt_oidbRequestCV=window.indexedDB.open(ji_oSchema.Get_DbName());if(!jt_oidbRequestCV)
...
jg_oe.CanLogInfo({DB:3,DBT:"idb"})&&jg_oe.LogInfo("jt_oidbRequestCV==null - Granted","Open Indexeddb","A3xaStorageIDB_ExecOpen");jt_this.jm_bOpenGranted=true;return jt_this.ExecOpenGranted(ji_oDbTransaction,ji_oSchema);}
...
jg_oe.CanLogInfo({DB:3,DBT:"idb"})&&jg_oe.LogInfo("jt_oidbRequestCV.onerror - Granted ","Open Indexeddb","A3xaStorageIDB_ExecOpen");jt_this.jm_bOpenGranted=true;jt_this.ExecOpenGranted(ji_oDbTransaction,ji_oSchema);};jt_oidbRequestCV.onsuccess=function(event)
...
jg_oe.CanLogInfo({DB:3,DBT:"idb"})&&jg_oe.LogInfo("jt_oidbRequestCV.onsuccess - Granted - cv,nv:"+
...
return false;jg_oe.CanLogInfo({DB:3,DBT:"idb"})&&jg_oe.LogInfo("Begin","Open Indexeddb","A3xaStorageIDB_ExecOpenGranted");var jt_oidbRequest=window.indexedDB.open(ji_oSchema.Get_DbName(),ji_oSchema.Get_DbVersion());if(!jt_oidbRequest)
{this.jm_bOpen=false;if(ji_oDbTransaction)
ji_oDbTransaction.FireOpenStorageError(event,"Fail on Open IndexedDB: "+"Cannot open");return false;}
jg_oe.CanLogInfo({DB:3,DBT:"idb"})&&jg_oe.LogInfo("idbreq ok","Open Indexeddb","A3xaStorageIDB_ExecOpenGranted");jt_oidbRequest.onerror=function(event)
...
jt_this.jm_bOpen=true;jg_oe.CanLogInfo({DB:3,DBT:"idb"})&&jg_oe.LogInfo("Success","Open Indexeddb","A3xaStorageIDB_ExecOpenGranted");jt_this.jm_oidb.onerror=function(event)
...
{jg_oe.CanLogInfo({DB:3,DBT:"idb"})&&jg_oe.LogInfo("Begin","Upgrade Indexeddb","A3xaStorageIDB_ExecOpenGranted");var jt_oidb=event.target.result;if(!jt_oidb)
...
{if(!jt_aosNames[i])
continue;jg_oe.CanLogInfo({DB:3,DBT:"idb"})&&jg_oe.LogInfo("Delete old table: "+jt_aosNames[i],"Upgrade Indexeddb","A3xaStorageIDB_ExecOpenGranted");try
...
break;}
jg_oe.CanLogInfo({DB:3,DBT:"idb"})&&jg_oe.LogInfo("Create new Table "+jt_sTable,"Upgrade Indexeddb","A3xaStorageIDB_ExecOpenGranted");var jt_oidbObjectStore=jt_oidb.createObjectStore(jt_sTable,{keyPath:jt_sKey});jt_posTable++;}};return-1;}
...
{if(!jio_oStorageValue)
return;var jt_aidb=event.target.result;var jt_osValue=new A3xaStorage_Value(null,null);jt_osValue.Set_Pair(jt_aidb);if(!jt_osValue.Get_Key())
{jg_oe.CanLogInfo({DB:3,DBT:"idb"})&&jg_oe.LogInfo("Empty - ki,ko,vo: "+jio_oStorageValue.Get_Key()+","+jt_aidb["xkey"],"IDB Exec Read");jg_oe.CanLogInfo({DB:3,DBT:"idb"})&&jg_oe.LogInfo("Empty - ki,ko,vo: "+jio_oStorageValue.Get_Key()+",null,null","IDB Exec Read");jio_oStorageValue.Set_Result({bLoad:true,bEmpty:true},"Load Record Empty ");}
else if(!jio_oStorageValue.Set_Pair(jt_aidb))
{jg_oe.LogErr("Fail - ki,ko,vo: "+jio_oStorageValue.Get_Key()+", "+jt_osValue.Get_Key()+", "+jt_osValue.Get_Value(),"IDB Exec Read");jio_oStorageValue.Set_Result({bLoad:true,bError:true},"Load Record: "+event.target.result+" - "+jt_oidbRequest.error);}
else
{jg_oe.CanLogInfo({DB:3,DBT:"idb"})&&jg_oe.LogInfo("Success - k,v: "+jio_oStorageValue.Get_Key()+", "+
...
jg_oe.CanLogInfo({DB:3,DBT:"idb"})&&jg_oe.LogInfo("Transaction Open for Store "+(this.jm_oStorageOpType.bRecord?" Records":""));else if(this.jm_oStorageOpType.bLoad)
jg_oe.CanLogInfo({DB:3,DBT:"idb"})&&jg_oe.LogInfo("Transaction Open for Load "+(this.jm_oStorageOpType.bRecord?" Records":""));else if(this.jm_oStorageOpType.bClear)
jg_oe.CanLogInfo({DB:3,DBT:"idb"})&&jg_oe.LogInfo("Transaction Open for Clear "+(this.jm_oStorageOpType.bRecord?" Records":""));else
jg_oe.CanLogInfo({DB:3,DBT:"idb"})&&jg_oe.LogInfo("Transaction Open for ? "+(this.jm_oStorageOpType.bRecord?" Records":""));for(var j=0;j<this.jm_aDbTableName.length;j++)
...
jg_oe.CanLogInfo({DB:3,DBT:"idb"})&&jg_oe.LogInfo("Get_ObjectStore-Table: "+this.jm_sCurrentTableName+" "+(this.jm_oidbOS?"OK":"Null"));return this.jm_oidbOS;}
function A3xaAZNMC()
...
{if(!ji_A)ji_Z=null;if(!ji_Z)ji_N=null;if(!ji_N)ji_M=null;if(!ji_N)ji_C=null;this.jm_A=(ji_A||null);this.jm_Z=(ji_Z||null);this.jm_N=(ji_N||null);this.jm_M=(ji_M||null);this.jm_C=(ji_C||null);return true;};this.Get_String=function(ji_bN,ji_bC,ji_sep)
{if(!ji_sep)
...
return false;}
return true;};this.jm_A=null;this.jm_Z=null;this.jm_N=null;this.jm_M=null;this.jm_C=null;}
function A3xaAZNMC_XApp(ji_o3xaznmc)
{this.Get_3xAZNMC=function(){return this.jm_o3xaznmc;};this.TopAreaTo3xDCEntity=function()
{if(!this.jm_o3xaznmc)
return null;var jt_A=this.jm_o3xaznmc.Get_A();if(!jt_A)
...
{var jt_o3xdce=this.TopAreaTo3xDCEntity();return(jt_o3xdce?jt_o3xdce.Get_LName():"");};this.IsBestFromBabylon=function(){return this.jm_o3xaznmc.Get_A()=="Y";};this.IsLA=function(){return this.jm_o3xaznmc.Get_A()=="L";};this.IsLatinAmerica=function()
{var jt_A=this.jm_o3xaznmc.Get_A();if(!jt_A)
return false;return jt_A=="L"||jt_A=="X"||jt_A=="N"||jt_A=="C"||jt_A=="P"||jt_A=="A"||jt_A=="B"||jt_A=="S"||jt_A=="D";};this.Set_LA=function()
{this.jm_o3xaznmc.Set_AZNMC('L','A');return this.jm_o3xaznmc;};this.jm_o3xaznmc=(ji_o3xaznmc?ji_o3xaznmc.Get_3xAZNMC():new A3xaAZNMC());}
function New_A3xaAZNMC_XApp(ji_o3xaznmc){return new A3xaAZNMC_XApp(ji_o3xaznmc);}
function A3xaPS()
{this.IsValid=function()
{return true;};this.IsEmpty=function()
...
{this.Set_TypEntity(null);this.Set_IdEntity(null);this.Set_TypGroup(null);this.Set_IdGroup(null);return true;};this.Get_3xAZNMC=function(){return this.jm_o3xaznmc;};this.Set_3xAZNMC=function(ji_o3xaznmc){return this.jm_o3xaznmc.CopyFrom(ji_o3xaznmc);};this.Set_3xAZN=function(ji_o3xaznmc){return this.jm_o3xaznmc.CopyFromAZN(ji_o3xaznmc);};this.Set_3xAZ=function(ji_o3xaznmc){return this.jm_o3xaznmc.CopyFromAZ(ji_o3xaznmc);};this.Get_3xPS=function(){return this.jm_o3xps;};this.Set_3xPS=function(ji_o3xps){return this.jm_o3xps.CopyFrom(ji_o3xps);};this.Get_3xCat=function(){return this.jm_o3xcat;};this.Set_3xCat=function(ji_o3xcat){return this.jm_o3xcat.CopyFrom(ji_o3xcat);};this.Get_Code=function()
...
if(ji_bEC!==false)
{jr_s+=ji_sep+ji_sep+this.Get_3xAZNMC().Get_String();jr_s+=ji_sep+this.Get_3xPS().Get_String();jr_s+=ji_sep+this.Get_3xCat().Get_String();}
return jr_s;};this.Set_String=function(ji_s,ji_sep)
{if(!ji_sep)
ji_sep=",";if(!ji_s)
return false;return this.Set_Array(ji_s.split(ji_sep),0)>=0?true:false;};this.Get_CompactCode=function()
{var jr_scc="A0";var jt_o3xaznmc=this.Get_3xAZNMC();var jt_o3xps=this.Get_3xPS();var jt_o3xcat=this.Get_3xCat();jr_scc+=(this.Get_TypEntity()||"0");jr_scc+=(this.Get_IdEntity()||"0");jr_scc+=(this.Get_TypGroup()||"M");jr_scc+=(this.Get_IdGroup()||"0");jr_scc+="A";jr_scc+=(jt_o3xaznmc.Get_A()||"0");jr_scc+=(jt_o3xaznmc.Get_Z()||"0");jr_scc+=(jt_o3xaznmc.Get_N()||"0");jr_scc+=(jt_o3xaznmc.Get_M()||"0");jr_scc+=(jt_o3xaznmc.Get_C()||"0");jr_scc+="0";jr_scc+=(jt_o3xps.Get_P()||"0");jr_scc+=(jt_o3xps.Get_S()||"0");jr_scc+="0";jr_scc+=(jt_o3xcat.Get_Ucat()||"0");jr_scc+=(jt_o3xcat.Get_Vcat()||"0");return jr_scc;}
this.Set_CompactCode=function(ji_scc)
{if(!ji_scc)
...
return false;}
if(jt_cursor>=jt_lencc)
{this.Set_GEID(jt_te,jt_ide,jt_tg,jt_idg);this.Get_3xAZNMC().Set_AZNMC(jt_a,jt_z,jt_n,jt_m,jt_c);return true;}
...
return false;}
if(jt_cursor>=jt_lencc)
{this.Set_GEID(jt_te,jt_ide,jt_tg,jt_idg);this.Get_3xAZNMC().Set_AZNMC(jt_a,jt_z,jt_n,jt_m,jt_c);this.Get_3xPS().Set_PS(jt_p,jt_s);return true;}
...
if(jt_cursor!=jt_lencc)
return false;this.Set_GEID(jt_te,jt_ide,jt_tg,jt_idg);this.Get_3xAZNMC().Set_AZNMC(jt_a,jt_z,jt_n,jt_m,jt_c);this.Get_3xPS().Set_PS(jt_p,jt_s);this.Get_3xCat().Set_Category(jt_ucat,jt_vcat);return true;};this.Set_Array=function(ji_a,ji_offset)
{if(!ji_a||ji_offset<0||ji_offset>=ji_a.length)
...
{this.Get_3xAZNMC().Set_Array(ji_a,jt_i);jt_i+=4;this.Get_3xPS().Set_Array(ji_a,jt_i);jt_i+=2;this.Get_3xCat().Set_Array(ji_a,jt_i);jt_i+=2;}
...
return false;if(!this.Get_3xAZNMC().Matches(ji_oxeid,ji_bSkipSourceNull))
...
return true;}
return false;};this.jm_TypEntity=null;this.jm_IdEntity=null;this.jm_TypGroup=null;this.jm_IdGroup=null;this.jm_o3xaznmc=new A3xaAZNMC();this.jm_o3xps=new A3xaPS();this.jm_o3xcat=new A3xaCategoryCode();}
...
function A3xa2IStaticDataSource_TableEntity()
...
{var jr_pisdsKeyMaker=PISDSKeyMaker();jr_pisdsKeyMaker.keyname=ji_keyName;if(jr_o.tb.getType()==jg_oe.jc_oA3xaDbZero.jc_tbtype_tid.tbtname)
{if(!jr_pisdsKeyMaker.keyname)
jr_pisdsKeyMaker.keyname=jg_oe.jc_oA3xaDbZero.jc_tbtype_tid.tbtkeyname;jr_pisdsKeyMaker.fnkeymaker=function(ji_pisdsRecord)
{ji_pisdsRecord.key=ji_pisdsRecord.o3x2rec.rec.getFieldValue_ByName(jg_oe.jc_oA3xaDbZero.jc_tidf_tid);if(ji_matchingKey!=null&&ji_matchingKey==ji_pisdsRecord.key)
ji_pisdsRecord.iseq=true;return ji_pisdsRecord;};}
else if(jr_o.tb.getType()==jg_oe.jc_oA3xaDbZero.jc_tbtype_eid.tbtname)
{if(!jr_pisdsKeyMaker.keyname)
jr_pisdsKeyMaker.keyname=jg_oe.jc_oA3xaDbZero.jc_tbtype_eid.tbtkeyname;jr_pisdsKeyMaker.fnkeymaker=function(ji_pisdsRecord)
...
ji_pisdsRecord.iseq=true;return ji_pisdsRecord;};}
else if(jr_o.tb.getType()==jg_oe.jc_oA3xaDbZero.jc_tbtype_ebis.tbtname)
{if(!jr_pisdsKeyMaker.keyname)
jr_pisdsKeyMaker.keyname=jg_oe.jc_oA3xaDbZero.jc_tbtype_ebis.tbtkeyname;jr_pisdsKeyMaker.fnkeymaker=function(ji_pisdsRecord)
...
ji_pisdsRecord.iseq=true;return ji_pisdsRecord;};}
else if(jr_o.tb.getType()==jg_oe.jc_oA3xaDbZero.jc_tbtype_ebid.tbtname)
{if(!jr_pisdsKeyMaker.keyname)
jr_pisdsKeyMaker.keyname=jg_oe.jc_oA3xaDbZero.jc_tbtype_ebid.tbtkeyname;jr_pisdsKeyMaker.fnkeymaker=function(ji_pisdsRecord)
...
ji_pisdsRecord.key=jt_te+","+jt_ide;if(ji_matchingKey!=null&&ji_matchingKey==ji_pisdsRecord.key)
ji_pisdsRecord.iseq=true;return ji_pisdsRecord;};}
else if(jr_o.tb.getType()==jg_oe.jc_oA3xaDbZero.jc_tbtype_ei.tbtname)
{if(!jr_pisdsKeyMaker.keyname)
jr_pisdsKeyMaker.keyname=jg_oe.jc_oA3xaDbZero.jc_tbtype_ei.tbtkeyname;jr_pisdsKeyMaker.fnkeymaker=function(ji_pisdsRecord)
...
{var jr_o=A3xa2StaticDataSource_Db();jr_o.db.new3x2Table=function(ji_sdsTable,ji_bJSON){return A3xa2StaticDataSource_TableEntity(ji_sdsTable,ji_bJSON);};jr_o.db.addTablesJSDS=function(ji_pTypTables)
...
function A3xaDbZero()
{A3xaDatabase.call(this,new A3xaDbSchema(jg_oe.jc_oA3xaDbZero.jc_sDbName,jg_oe.jc_oA3xaDbZero.jc_DbVersion,jg_oe.jc_oA3xaDbZero.jc_sDbDefaultPrimaryKeyName,jg_oe.jc_oA3xaDbZero.jc_aSchemaTables));this._A3xaDbZero=function()
{this.ExtendSchema();this.Set_SDSDBStore(A3xa2SDS_DbEntity());this.Set_SDSDBWork(A3xa2SDS_DbEntity());};this.GLID2Typ=function(ji_GLID)
...
{var jt_oxur=jg_oApp.Get_AppXUR().Get_3xXUR();return this.Get_DataTable(this.Typ2GLID(jt_oxur.Get_3xXEID().Get_TypEntity()));}
if(ji_A&&ji_Z&&ji_N)
jt_glid=jg_oe.jc_oA3xaDbZero.MakeGlid(jg_oe.jc_oA3xaDbZero.jc_GLID_EnterprisePrefix,ji_A+ji_Z+ji_N+"0");if(!jt_glid)
return null;var jr_odt=this.Get_DataTable(jt_glid,true);if(!(jr_odt&&jr_odt.jm_oDTStatus.IsSuccess()))
return null;return jr_odt;};this.ExtendSchema=function()
{var jt_aSXT=jg_oe.jc_oA3xaDbZero.jc_aSchemaExtTables;var jt_pTableSource=this.jm_oDbSchema.Get_Table_ByName(jg_oe.jc_oA3xaDbZero.jc_GLID_Enterprise);if(!jt_pTableSource)
return false;var jt_pPTableSource=this.jm_oDbSchema.Get_Table_ByName(jg_oe.jc_oA3xaDbZero.jc_GLID_PEnterprise);if(!jt_pPTableSource)
...
return false;var jt_pFTableSource=this.jm_oDbSchema.Get_Table_ByName(jg_oe.jc_oA3xaDbZero.jc_GLID_FEnterprise);if(!jt_pFTableSource);var jt_aTablesAppend=[];var jt_aPTablesAppend=[];var jt_aNTablesAppend=[];var jt_aFTablesAppend=[];for(var i=0;i<jt_aSXT.length;i++)
{var jt_glidSuffix=jt_aSXT[i];if(!(jt_glidSuffix&&jt_glidSuffix.length==jg_oe.jc_oA3xaDbZero.jc_GLIDSUFFIXLEN))
continue;var jt_glidE=jg_oe.jc_oA3xaDbZero.MakeGlid(jg_oe.jc_oA3xaDbZero.jc_GLID_EnterprisePrefix,jt_glidSuffix);var jt_glidPE=jg_oe.jc_oA3xaDbZero.MakeGlid(jg_oe.jc_oA3xaDbZero.jc_GLID_PEnterprisePrefix,jt_glidSuffix);var jt_glidNE=jg_oe.jc_oA3xaDbZero.MakeGlid(jg_oe.jc_oA3xaDbZero.jc_GLID_NEnterprisePrefix,jt_glidSuffix);var jt_glidFE=jg_oe.jc_oA3xaDbZero.MakeGlid(jg_oe.jc_oA3xaDbZero.jc_GLID_FEnterprisePrefix,jt_glidSuffix);var jt_pTableSchema={};jQuery.extend(jt_pTableSchema,jt_pTableSource);jt_pTableSchema.jp_sName=jt_glidE;jt_pTableSchema.jp_bTyp_Common=false;jt_pTableSchema.jp_bTyp_Main=false;jt_pTableSchema.jp_bTyp_TOC=false;jt_pTableSchema.jp_bMandatory=false;jt_aTablesAppend.push(jt_pTableSchema);var jt_pPTableSchema={};jQuery.extend(jt_pPTableSchema,jt_pPTableSource);jt_pPTableSchema.jp_sName=jt_glidPE;jt_pPTableSchema.jp_sParent=jt_glidE;jt_pPTableSchema.jp_bTyp_Common=false;jt_pPTableSchema.jp_bTyp_Main=false;jt_pPTableSchema.jp_bTyp_TOC=false;jt_pPTableSchema.jp_bMandatory=false;jt_aPTablesAppend.push(jt_pPTableSchema);var jt_pNTableSchema={};jQuery.extend(jt_pNTableSchema,jt_pNTableSource);jt_pNTableSchema.jp_sName=jt_glidNE;jt_pNTableSchema.jp_sParent=jt_glidE;jt_pNTableSchema.jp_bTyp_Common=false;jt_pNTableSchema.jp_bTyp_Main=false;jt_pNTableSchema.jp_bTyp_TOC=false;jt_pNTableSchema.jp_bMandatory=false;jt_aNTablesAppend.push(jt_pNTableSchema);var jt_pFTableSchema={};jQuery.extend(jt_pFTableSchema,jt_pFTableSource);jt_pFTableSchema.jp_sName=jt_glidFE;jt_pFTableSchema.jp_sParent=jt_glidE;jt_pFTableSchema.jp_bTyp_Common=false;jt_pFTableSchema.jp_bTyp_Main=false;jt_pFTableSchema.jp_bTyp_TOC=false;jt_pFTableSchema.jp_bMandatory=false;jt_aFTablesAppend.push(jt_pFTableSchema);}
this.jm_oDbSchema.jm_aTablesExtension=new Array();for(var ii=0;ii<jt_aTablesAppend.length;ii++)
this.jm_oDbSchema.jm_aTablesExtension.push(jt_aTablesAppend[ii]);for(var ip=0;ip<jt_aTablesAppend.length;ip++)
this.jm_oDbSchema.jm_aTablesExtension.push(jt_aPTablesAppend[ip]);for(var ij=0;ij<jt_aTablesAppend.length;ij++)
this.jm_oDbSchema.jm_aTablesExtension.push(jt_aNTablesAppend[ij]);for(var iF=0;iF<jt_aTablesAppend.length;iF++)
this.jm_oDbSchema.jm_aTablesExtension.push(jt_aFTablesAppend[iF]);return true;};this.OnDataLoadedSetup=function()
...
return false;var jt_o3xxur_xeid=jt_oxur.Get_3xXEID();var jt_o3xxur_aznmc=jt_o3xxur_xeid.Get_3xAZNMC();var jt_o3xxur_ps=jt_o3xxur_xeid.Get_3xPS();var jt_o3xxur_cat=jt_o3xxur_xeid.Get_3xCat();var jt_o3xxur_aznmc_xapp=New_A3xaAZNMC_XApp(jt_o3xxur_xeid);var jt_te=jt_o3xxur_xeid.Get_TypEntity();var jt_MaxRecords=((jt_oxur.IsLimited()||jt_o3xxur_cat.IsEmpty())?20:0);if(jt_oxur.IsSortByTime())
...
{jt_ogldtMain.New_Recordsel(null,function(ji_k,ji_oxe)
{var jt_3xxeid=ji_oxe.Get_3xXEID();var jt_3xaznmc=jt_3xxeid.Get_3xAZNMC();if(jt_o3xxur_xeid.Get_IdEntity()&&jt_3xxeid.Get_IdEntity()!=jt_o3xxur_xeid.Get_IdEntity())
...
{jt_ogldtMain.New_Recordsel(null,function(ji_k,ji_oxe)
{var jt_3xxeid=ji_oxe.Get_3xXEID();var jt_3xaznmc=jt_3xxeid.Get_3xAZNMC();var jt_3xcat=jt_3xxeid.Get_3xCat();if(jt_o3xxur_aznmc.Get_A()&&!(jt_3xaznmc.Get_A()==jt_o3xxur_aznmc.Get_A()))
...
{if(!(New_A3xaAZNMC_XApp(jt_o3xxeidxur.Get_3xAZNMC()).IsLA()&&jt_o3xxeidxur.Get_3xAZNMC().Get_Z()))
New_A3xaAZNMC_XApp(jt_o3xxeidxur.Get_3xAZNMC()).Set_LA();jr_oglrMSC=jt_ogldtMSC.Get_GLRecordAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));if(jr_oglrMSC)
return jr_oglrMSC;jt_o3xxeidxur.Get_3xPS().Clear_S();jr_oglrMSC=jt_ogldtMSC.Get_GLRecordAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));if(jr_oglrMSC)
return jr_oglrMSC;}
jt_o3xxeidxur=new A3xaXEID();jt_o3xxeidxur.CopyFrom(jg_oApp.Get_AppXUR().Get_3xXUR().Get_3xXEID());jt_o3xxeidxur_xapp=new A3xaXEID_XApp(jt_o3xxeidxur);jt_o3xxeidxur.Get_3xPS().Clear();if(jt_o3xxeidxur.Get_3xAZNMC().Get_C())
{jr_oglrMSC=jt_ogldtMSC.Get_GLRecordAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));if(jr_oglrMSC)
return jr_oglrMSC;}
if(jt_o3xxeidxur.Get_3xAZNMC().Get_N())
{jt_o3xxeidxur.Get_3xAZNMC().Clear_C();jr_oglrMSC=jt_ogldtMSC.Get_GLRecordAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));if(jr_oglrMSC)
return jr_oglrMSC;}
if(jt_o3xxeidxur.Get_3xAZNMC().Get_Z())
{jt_o3xxeidxur.Get_3xAZNMC().Clear_NC();jr_oglrMSC=jt_ogldtMSC.Get_GLRecordAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));if(jr_oglrMSC)
return jr_oglrMSC;}
New_A3xaAZNMC_XApp(jt_o3xxeidxur.Get_3xAZNMC()).Set_LA();jr_oglrMSC=jt_ogldtMSC.Get_GLRecordAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));if(jr_oglrMSC)
return jr_oglrMSC;jt_o3xxeidxur.Get_3xAZNMC().Clear();jr_oglrMSC=jt_ogldtMSC.Get_GLRecordAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));return jr_oglrMSC;};this._A3xaDbZero();}
function GLDTEntity(ji_oDatabase,ji_glid)
{GLDataTable.call(this,ji_oDatabase,ji_glid);this.NewRecord=function()
...
return null;if(jt_oDbSchemaTable.jp_SubTable==jg_oe.jc_oA3xaDbZero.jc_tbtype_tid.tbtname)
{return new GLRecord();}
else if(jt_oDbSchemaTable.jp_SubTable==jg_oe.jc_oA3xaDbZero.jc_tbtype_eid.tbtname||!jt_oDbSchemaTable.jp_sParent)
{return new A3xaREntity(new A3xaXtdEntity());}
else if(jt_oDbSchemaTable.jp_SubTable==jg_oe.jc_oA3xaDbZero.jc_tbtype_ebis.tbtname)
{return new GLREBIS();}
else if(jt_oDbSchemaTable.jp_SubTable==jg_oe.jc_oA3xaDbZero.jc_tbtype_ebid.tbtname)
{return new GLREBID();}
else if(jt_oDbSchemaTable.jp_SubTable==jg_oe.jc_oA3xaDbZero.jc_tbtype_ei.tbtname)
{return new GLREI();}
...
return false;var jt_tbtype=jg_oe.jc_oA3xaDbZero.Glid2SDSTbType(jt_glid);if(!jt_tbtype)
...
return false;var jt_a3x2oglr=A3xa2Array();var jt_nofrec=jt_o3x2index.ar.getCount();for(var i=0;i<jt_nofrec;i++)
{var jt_key=jt_o3x2index.ar.getKey(i);var jt_o3x2rec=jt_o3x2index.ar.getItem(jt_key);var jt_oglRecord=this.NewRecord();jt_oglRecord.Set_SDS3x2Record(jt_o3x2rec);jt_a3x2oglr.ar.addItem(jt_key,jt_oglRecord);}
this.jm_aoglr=new A3xaArray(jt_a3x2oglr);return true;};this.SetupLoadedRecords=function(ji_ogldtParent)
{var jt_odb=this.Get_Database();var jt_glid=this.Get_Glid();var jt_oSchemaTable=jt_odb.jm_oDbSchema.Get_Table_ByName(jt_glid);this.SetupSDSRecords(ji_ogldtParent);var jt_oa3xRecordset=this.Get_Recordset();var jt_aoglrAX=new A3xaArray();var jt_nRecords=(jt_oa3xRecordset?jt_oa3xRecordset.Get_Count():0);if(this.jm_bAX)
{for(var jrec=0;jrec<jt_nRecords;jrec++)
{var jt_id=jt_oa3xRecordset.Get_Key(jrec);var jt_oglr=jt_oa3xRecordset.Get_Item(jt_id);if(jt_oglr)
jt_aoglrAX.Add_Item(New_A3xaXEID_XApp(jt_oglr).BuildAltKey(null,true),jt_oglr);}}
...
{var jt_id=ji_ogldtParent.Get_Recordset().Get_Key(irecord);if(!jt_id)
...
{jr_o3xxeid.Set_GEID(this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eidf_enty),this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eidf_enid),this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eidf_egty),this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eidf_egid));jr_o3xxeid.Get_3xCat().Set_Category(this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eidf_ucat),this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eidf_vcat));jr_o3xxeid.Get_3xAZNMC().Set_AZNMC(this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eidf_a),this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eidf_z),this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eidf_n),this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eidf_m),this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eidf_c));jr_o3xxeid.Get_3xPS().Set_PS(this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eidf_p),this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eidf_s));}
this.jm_ogle.Replace_3xEBID(this.Get_3xEBID());this.jm_ogle.Replace_3xEBIS(this.Get_3xEBIS());this.jm_ogle.Replace_3xEI(this.Get_3xEI());return true;};this.IsReady=function(){return this.IsValid()&&this.Get_3xXEID().IsValid();};this.Set_SubRecord=function(ji_SubType,ji_oglrSub)
{if(!(ji_SubType&&ji_oglrSub))
...
return false;return this.GLRecord_Set_SubRecord(ji_SubType,ji_oglrSub);};this.Get_3xEBIS=function(){return this.Get_SubRecord(jg_oe.jc_oA3xaDbZero.jc_tbtype_ebis.tbtname);};this.Get_3xEBID=function(){return this.Get_SubRecord(jg_oe.jc_oA3xaDbZero.jc_tbtype_ebid.tbtname);};this.Get_3xEI=function(){return this.Get_SubRecord(jg_oe.jc_oA3xaDbZero.jc_tbtype_ei.tbtname);};this.Get_3xsName=function(){return this.Get_3xEI().Get_3xsName();};this.Get_LName=function()
...
function GLREBIS()
{GLRecord.call(this,null);this.Get_3xEBIS=function(){return this;};this.Get_TypEntity=function(){return this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebidf_enty);};this.Get_IdEntity=function(){return this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebidf_enid);};this.Get_Created=function(){return this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebisf_created);};this.Get_Modified=function(){return this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebisf_modified);};this.Get_Order=function(){return this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebisf_order);};this.Get_Idsym=function(){return this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebisf_sym);};this.Get_Lat=function(){return this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebisf_lat);};this.Get_Lon=function(){return this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebisf_lon);};this.Get_Name=function()
{return this.ConvertSpecialChars_Field2(this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebisf_name));};this.Get_Descr=function()
{return this.ConvertSpecialChars_Field2(this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebisf_descr));};this.Get_Website=function()
{return this.ConvertSpecialChars_Field2(this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebisf_url));};this.jm_DefaultColor="FFFFFF";this.Set_DefaultColor=function(ji_Color){this.jm_DefaultColor=ji_Color;return true;};this.Get_DefaultColor=function(){return this.jm_DefaultColor;};this.jm_Color=null;this.Set_Color=function(ji_Color){this.jm_Color=ji_Color;return true;};this.Get_Color=function()
{if(!this.jm_Color)
this.jm_Color=this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebisf_color);if(this.jm_Color)
return this.jm_Color;return this.jm_DefaultColor;};this.ConvertSpecialChars_Field2=function(ji_sField)
{if(!ji_sField)
return ji_sField;return ji_sField.replace(/__at2__/g,"@").replace(/&#40;/g,"(").replace(/&#41;/g,")").replace(/&apos;/g,"'");};}
function GLREBID()
...
return false;return true;};this.Get_TypEntity=function(){return this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebidf_enty);};this.Get_IdEntity=function(){return this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebidf_enid);};this.Get_LikesTotal=function()
{return Number(this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebidf_likes))+
Number(this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebidf_likesbonus));};this.Get_Clicks=function(){return Number(this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebidf_clicks));};this.Get_ClickTime=function(){return this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebidf_clicksphtime);};this.Get_Score=function(){return Number(this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebidf_score));};}
...
function GLREI()
{GLRecord.call(this,null);this.jm_aoeifa=null;this.Get_3xEI=function(){return this;};this.IsReady=function()
{if(!this.IsValid())
return false;if(!this.Get_TypEntity())
return false;if(!this.Get_IdEntity())
return false;return true;};this.Get_TypEntity=function(){return this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eif_enty);};this.Get_IdEntity=function(){return this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eif_enid);};this.Get_Info=function(ji_TypInfo,ji_IdInfo)
{if(!this.jm_aoeifa)
...
this.jm_aoeifa=jt_aoeifa;return true;};this.Get_EInfoset=function(ji_TypInfo)
{var jt_aoeifa=this.Get_Info(ji_TypInfo,null);var jr_aei=[];for(var i=0;jt_aoeifa&&i<jt_aoeifa.length;i++)
{var jt_aMaster=jt_aoeifa[i].Get_Master();jr_aei.push({eityp:jt_aMaster[jg_oe.jc_oA3xaDbZero.jc_Eifa_Typ],eicod:jt_aMaster[jg_oe.jc_oA3xaDbZero.jc_Eifa_Cod],eiid:jt_aMaster[jg_oe.jc_oA3xaDbZero.jc_Eifa_Id],einfo:jt_aMaster[jg_oe.jc_oA3xaDbZero.jc_Eifa_Info]});}
return jr_aei;};this.Get_3xsField=function(ji_TypInfo,ji_CodInfo)
...
continue;jt_sInfo=jt_sInfo.replace(/__at2__/g,"@").replace(/&#40;/g,"(").replace(/&#41;/g,")").replace(/&apos;/g,"'");if(jr_o3xs4L.Set_IString(jt_IdInfo,jt_sInfo))
jt_b=true;}
if(!jt_b)
...
return"";return jt_o3xs4L.Get_LString();};}
...
{jt_oglrCategory=jt_ogldtCategory.Get_GLRecordAX(jt_oThis3xxeid_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_Category));}}
...
{jt_oglrGeoArea=jt_ogldtGeoArea.Get_GLRecordAX(jt_oThis3xxeid_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_GeoArea));if(jt_oglrGeoArea&&jt_ogldtGeoRegion)
{jt_oglrGeoRegion=jt_ogldtGeoRegion.Get_GLRecordAX(jt_oThis3xxeid_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_GeoRegion));if(jt_oglrGeoRegion&&jt_ogldtGeoCity)
jt_oglrGeoCity=jt_ogldtGeoCity.Get_GLRecordAX(jt_oThis3xxeid_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_GeoCity));}}
...
{jt_oglrGeoCountry=jt_ogldtGeoCountry.Get_GLRecordAX(jt_oAltKeySource3xxeid_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_GeoCountry));if(jt_oglrGeoCountry&&jt_oglrAltKeySource.Get_3xXEID().Get_3xPS().Get_S())
{if(jt_ogldtGeoState&&jt_oglrGeoCountry)
jt_oglrGeoState=jt_ogldtGeoState.Get_GLRecordAX(jt_oAltKeySource3xxeid_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_GeoState));}}}
...
this.Get_3xXEID().Set_String(ji_sxeid);return true;};this.Set_XURString=function(ji_s)
{if(!ji_s)
...
{var jr_oQueryRank_Icon=null;var jt_Ucat=this.Get_3xXEID().Get_3xCat().Get_Ucat();var jt_o3xaznmc=this.Get_3xXEID().Get_3xAZNMC();var jt_te=this.Get_3xXEID().Get_TypEntity();var jt_o3xmngic=jg_oe.Get_3xAppMngIcons();var jt_odfic=jt_o3xmngic.Get_DefIcons();if(this.IsSingle())
...
else if(jt_o3xaznmc.Get_N())
{if(jt_Ucat)
jr_oQueryRank_Icon=jt_odfic.jc_oIconMS_QueryRank_List;else
jr_oQueryRank_Icon=jt_odfic.jc_oIconMS_QueryRank_T10Bronze;}
else if(jt_o3xaznmc.Get_Z())
jr_oQueryRank_Icon=jt_odfic.jc_oIconMS_QueryRank_T10Silver;else if(jt_o3xaznmc.Get_A())
...
{var jr_oQueryEntity_Icon=null;var jt_Ucat=this.Get_3xXEID().Get_3xCat().Get_Ucat();var jt_o3xaznmc=this.Get_3xXEID().Get_3xAZNMC();var jt_te=this.Get_3xXEID().Get_TypEntity();var jt_o3xmngic=jg_oe.Get_3xAppMngIcons();var jt_odfic=jt_o3xmngic.Get_DefIcons();if(this.IsSingle())
...
{var jr_oQueryOrderby_Icon=null;var jt_Ucat=this.Get_3xXEID().Get_3xCat().Get_Ucat();var jt_o3xaznmc=this.Get_3xXEID().Get_3xAZNMC();var jt_te=this.Get_3xXEID().Get_TypEntity();var jt_o3xmngic=jg_oe.Get_3xAppMngIcons();var jt_odfic=jt_o3xmngic.Get_DefIcons();if(this.IsSingle())
...
{var jt_A=this.Get_3xXEID().Get_3xAZNMC().Get_A();var jt_Z=this.Get_3xXEID().Get_3xAZNMC().Get_Z();var jt_o3xaznmc_xapp=New_A3xaAZNMC_XApp(this.Get_3xXEID());var jt_o3xdce=jt_o3xaznmc_xapp.TopAreaTo3xDCEntity();if(jt_o3xdce&&(jt_o3xaznmc_xapp.IsLA()||(jt_A&&!jt_Z)))
jt_sGeoArea=jt_o3xdce.Get_LName();}
var jt_TypEntity=this.Get_3xXEID().Get_TypEntity();var jt_o3xaznmc=this.Get_3xXEID().Get_3xAZNMC();var jt_o3xcat=this.Get_3xXEID().Get_3xCat();if(jt_TypEntity==jg_oe.jc_oEntity.jc_Typ_Category||jt_TypEntity==jg_oe.jc_oEntity.jc_Typ_GeoCity||jt_TypEntity==jg_oe.jc_oEntity.jc_Typ_GeoState||jt_TypEntity==jg_oe.jc_oEntity.jc_Typ_GeoCountry||jt_TypEntity==jg_oe.jc_oEntity.jc_Typ_GeoRegion||jt_TypEntity==jg_oe.jc_oEntity.jc_Typ_GeoArea)
...
return ji_glidDefault;ji_glidPrefix=ji_glidDefault.substr(0,jg_oe.jc_oA3xaDbZero.jc_GLIDPREFIXLEN);if(!(ji_glidPrefix==jg_oe.jc_oA3xaDbZero.jc_GLID_EnterprisePrefix||ji_glidPrefix==jg_oe.jc_oA3xaDbZero.jc_GLID_PEnterprisePrefix||ji_glidPrefix==jg_oe.jc_oA3xaDbZero.jc_GLID_NEnterprisePrefix||ji_glidPrefix==jg_oe.jc_oA3xaDbZero.jc_GLID_FEnterprisePrefix))
...
var jt_A=jt_oxeidXUR.Get_3xAZNMC().Get_A();var jt_Z=jt_oxeidXUR.Get_3xAZNMC().Get_Z();var jt_N=jt_oxeidXUR.Get_3xAZNMC().Get_N();if(!(jt_A&&jt_Z&&jt_N))
return ji_glidDefault;var jr_glidQUR=jg_oe.jc_oA3xaDbZero.MakeGlid(ji_glidPrefix,jt_A+jt_Z+jt_N+"0");jg_oe.CanLogInfo()&&jg_oe.LogInfo("gliddef,glidqur: "+ji_glidDefault+","+jr_glidQUR,"","A3xaXUR.Default2GlidQUR");return jr_glidQUR;};this.Get_A3xaUrl=function(ji_bAjax,ji_bAppendDescrParam)
{var jr_oUrl=null;if(ji_bAjax)
{this.jm_FormName=jg_oe.jc_oXUR.jc_XURFN_AjaxEntity;var jt_sxur=this.Get_XURCC();jr_oUrl=new A3xaUrl(jg_oe.jc_oXUR.jc_sUrlBase_A3xaForm,"p3x="+jt_sxur);}
else
{var jt_sxur=this.Get_XURCC();jr_oUrl=new A3xaUrl(jg_oe.jc_oXUR.jc_sUrlBase_A3xaForm,(ji_bAppendDescrParam===true?"p3d="+this.Get_XUDString()+"&":"")+"p3x="+jt_sxur);}
if(!jt_sxur)
...
return"";var jr_oAjaxUrlParams=new A3xaUrl(null,null);jr_oAjaxUrlParams.CopyFrom(this.jm_oAjaxUrlParams);jr_oAjaxUrlParams.Modify_UrlParam("p_GLTurbo",jg_oe.Get_TurboString());var jt_sUrlParam_GLHeader=jr_oAjaxUrlParams.Get_UrlParam("p_GLHeader");if(!jt_sUrlParam_GLHeader)
return jr_oAjaxUrlParams.Get_UrlParams();var jt_aheader2=jt_sUrlParam_GLHeader.split(jg_oe.jc_oA3xaDbZero.jc_GLSep_Header);if(!jt_aheader2&&jt_aHeader2[0])
return jr_oAjaxUrlParams.Get_UrlParams();var jt_aheader=((jt_aHeader2&&jt_aHeader2[1])?jt_aHeader2[1].split(jg_oe.jc_oA3xaDbZero.jc_GLSep_Field):null);var jt_xglid=jt_aheader2[0];if(jt_xglid!=(jg_oe.jc_oA3xaDbZero.jc_GLID_All+jg_oe.jc_oA3xaDbZero.jc_GLMID_DT))
{var jt_sGLHeader="";var jt_pisdsRecord_glidtoc=jg_oApp.Get_Database().Get_TOCItem(jg_oe.jc_oA3xaDbZero.XGlid2Glid(jt_xglid));if(jt_pisdsRecord_glidtoc&&jt_pisdsRecord_glidtoc.fields)
{jt_pisdsRecord_glidtoc.fields.shift();jt_sGLHeader=jt_xglid+jg_oe.jc_oA3xaDbZero.jc_GLSep_Header+
jt_pisdsRecord_glidtoc.fields.join(jg_oe.jc_oA3xaDbZero.jc_GLSep_Field);}
if(jt_sGLHeader)
jr_oAjaxUrlParams.Modify_UrlParam("p_GLHeader",jt_sGLHeader);else
return jr_oAjaxUrlParams.Get_UrlParams();}
else
{var jt_o3x2tbTOC=jg_oe.Get_Database().Get_3x2TOC();if(!jt_o3x2tbTOC)
return jr_oAjaxUrlParams.Get_UrlParams();var jt_release=0;var jt_sGLHeaderReference="";var jt_pisdsRecord_glidtoc=jg_oApp.Get_Database().Get_TOCItem(jg_oe.jc_oA3xaDbZero.jc_GLID_Category);if(jt_pisdsRecord_glidtoc&&jt_pisdsRecord_glidtoc.fields)
{jt_pisdsRecord_glidtoc.fields.shift();jt_sGLHeaderReference=jg_oe.jc_oA3xaDbZero.jc_GLID_All+jg_oe.jc_oA3xaDbZero.jc_GLMID_DT+
jg_oe.jc_oA3xaDbZero.jc_GLSep_Header+
jt_pisdsRecord_glidtoc.fields.join(jg_oe.jc_oA3xaDbZero.jc_GLSep_Field);jt_release=jt_pisdsRecord_glidtoc.fields[0];}
if(!(jt_release>0&&jt_sGLHeaderReference))
{return jr_oAjaxUrlParams.Get_UrlParams();}
var jt_tocItems=jt_o3x2tbTOC.tb.getCountOfRecords();for(var i=0;i<jt_tocItems;i++)
{var jt_glidtoc=null;var jt_releasetoc=null;var jt_pisdsRecord_glidtoc=jt_o3x2tbTOC.tb.getFields2(i,null);if(jt_pisdsRecord_glidtoc&&jt_pisdsRecord_glidtoc.fields)
{jt_glidtoc=jt_pisdsRecord_glidtoc.fields[0];jt_releasetoc=jt_pisdsRecord_glidtoc.fields[1];}
if(jt_releasetoc!=jt_release)
return jr_oAjaxUrlParams.Get_UrlParams();}
...
{jt_te=ji_o3xxeid.Get_TypEntity();jt_A=ji_o3xxeid.Get_3xAZNMC().Get_A();jt_Z=ji_o3xxeid.Get_3xAZNMC().Get_Z();jt_N=ji_o3xxeid.Get_3xAZNMC().Get_N();jt_C=ji_o3xxeid.Get_3xAZNMC().Get_C();jt_Ucat=ji_o3xxeid.Get_3xCat().Get_Ucat();jt_Vcat=ji_o3xxeid.Get_3xCat().Get_Vcat();}
...
{if(!ji_sUrlParams)
return false;var jt_o3xXUR=new A3xaXur();jt_o3xXUR.Set_UrlParams(jg_oe.jc_oXUR.jc_XURFN_ListEntity,null,jg_oe.jc_oXUR.jc_sAjaxTypEntitySet,null,null,null,null,ji_sUrlParams);var jt_oxeidXUR=jt_o3xXUR.Get_3xXEID();var jt_o3xaznmcXUR=new A3xaAZNMC();jt_o3xaznmcXUR.CopyFrom(jt_oxeidXUR);var jt_te=jt_oxeidXUR.Get_TypEntity();var jt_A=jt_o3xaznmcXUR.Get_A();var jt_Z=jt_o3xaznmcXUR.Get_Z();var jt_N=jt_o3xaznmcXUR.Get_N();var jt_C=jt_o3xaznmcXUR.Get_C();var jt_bdt=false;var jt_odt=null;if((!jt_te||jt_te==jg_oe.jc_oEntity.jc_Typ_Enterprise))
{if(jt_A&&jt_Z&&jt_N)
{var jt_pisdsRecord_glidtoc=null;var jt_glidtoc=jg_oe.jc_oA3xaDbZero.MakeGlid(jg_oe.jc_oA3xaDbZero.jc_GLID_EnterprisePrefix,jt_A+jt_Z+jt_N+"0");jt_pisdsRecord_glidtoc=jg_oApp.Get_Database().Get_TOCItem(jt_glidtoc);if(jt_pisdsRecord_glidtoc)
jt_bdt=true;}
else if(this.Get_3xXUR().Matches(jt_o3xXUR,true))
...
jt_odt=jg_oApp.Get_Database().Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoState);if(jt_odt)
...
this.Set_3xXUR(jt_o3xXUR);jg_oApp.ResetApp();jg_oApp.MainData(true);return true;};this.AjaxQueueQueryRequest=function()
...
{jt_o3xXUR.jm_oDTStatus.SetAjaxStatusInProgress();var jt_oUrl=jt_o3xXUR.Get_A3xaUrl(true);jg_oe.jm_oAjax2.QueueRequest(new A3xaAjaxRequest2(jt_oUrl.Get_UrlBase(),jt_oUrl.Get_UrlParams(),this));return true;}
...
{var jt_oxur=new A3xaXur();jt_oxur.Set_XURString(ji_ogAjaxResponse.Get_ItemValue("p3x"));jt_oxur.Set_XUDString(ji_ogAjaxResponse.Get_ItemValue("p3d"));var jt_glid=ji_ogAjaxResponse.Get_ItemValue("p_GLID");var jt_sGLRS=ji_ogAjaxResponse.Get_ItemValue("p_GL");var jt_glidEBIS=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEBIS");var jt_sGLRSEBIS=ji_ogAjaxResponse.Get_ItemValue("p_GLEBIS");var jt_glidEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEBID");var jt_sGLRSEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLEBID");var jt_glidEI=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEI");var jt_sGLRSEI=ji_ogAjaxResponse.Get_ItemValue("p_GLEI");jg_oe.CanLogInfo()&&jg_oe.LogInfo("p3x.QUR,p3x.XEID,jt_sGLRS(p_GL)="+
jt_oxur.jm_QUR+","+jt_oxur.Get_3xXEID().Get_String()+","+jt_sGLRS,"","A3xaAppXUR.OnAjaxReadyFn");jg_oApp.WriteGLRS2(jt_glid,jt_sGLRS);jg_oApp.WriteGLRS2(jt_glidEBIS,jt_sGLRSEBIS);jg_oApp.WriteGLRS2(jt_glidEBID,jt_sGLRSEBID);jg_oApp.WriteGLRS2(jt_glidEI,jt_sGLRSEI);var jt_qulen=(this.jm_ao3xurQueue?this.jm_ao3xurQueue.length:0);for(var i=0;i<jt_qulen;i++)
{var jt_o3xXUR=this.jm_ao3xurQueue[i];var jt_bQUR=(jt_o3xXUR.jm_QUR==jt_oxur.jm_QUR);var jt_bXEID=(jt_o3xXUR.Get_3xXEID().Matches(jt_oxur.Get_3xXEID(),false));var jt_bStInProgress=jt_o3xXUR.jm_oDTStatus.IsInProgress();jg_oe.CanLogInfo()&&jg_oe.LogInfo("jt_qulen;qur==qur;xeid==xeid;dtstatus:"+jt_qulen+";"+
...
{jt_o3xXUR.jm_oDTStatus.SetAjaxStatusSuccess();jg_oe.CanLogInfo()&&jg_oe.LogInfo("jc_DTStatus2_StSuccess","","A3xaAppXUR.OnAjaxReadyFn");this.AjaxQueueQueryRequest();return true;}}}
return true;};this.AjaxStoreNewTables=function()
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("begin=","","A3xaAppXUR.AjaxStoreNewTables");var jt_qulen=(this.jm_ao3xurQueue?this.jm_ao3xurQueue.length:0);var i=0;var jt_o3xXUR=this.jm_ao3xurQueue[i];this.jm_ao3xurQueue=new Array();this.Set_3xXUR(jt_o3xXUR);jg_oApp.ResetApp();jg_oApp.jm_odbLoaderManagerMain=null;jg_oApp.Get_Database().ClearArrayDTLoad({jp_bTyp_Main:true});jg_oe.CanLogInfo()&&jg_oe.LogInfo("p2=","","A3xaAppXUR.AjaxStoreNewTables");jg_oApp.MainData(false);jg_oe.CanLogInfo()&&jg_oe.LogInfo("end=","","A3xaAppXUR.AjaxStoreNewTables");return true;};this.OnChangeDD_QUR=function(ji_eDropDown)
...
function A3xaSummaryInfoKey(ji_oxeid,ji_bCategory,ji_bSub,ji_bTop)
...
var jr_siXeid=new A3xaXEID();jr_siXeid.Get_3xAZNMC().Set_AZNMC(jt_A,jt_Z,jt_N,jt_M,jt_C);return jr_siXeid;};this._MakeKeyCategory=function(ji_oxeid,ji_bSub)
...
return null;}
var jr_siXeid=new A3xaXEID();jr_siXeid.Get_3xCat().Set_Category(jt_Ucat,jt_Vcat);return jr_siXeid;};if(ji_oxeid)
{if(ji_bCategory)
...
{A3xaSummaryInfoKey.call(this,ji_oxe,ji_bCategory,ji_bSub,ji_bTop);this.jm_siCountValue=0;this.jm_siCountRestricted=0;this.jm_bSummary=(ji_bSummary===false?false:true);this.Add=function(ji_o3xsii,ji_bRestricted)
{if(!ji_o3xsii)
...
{this.jm_siCountValue+=Number(ji_o3xsii.jm_siCountValue);return true;};this.AddRestricted=function(ji_o3xsii)
{this.jm_siCountRestricted+=Number(ji_o3xsii.jm_siCountRestricted);return true;};if(ji_oxe)
{if(this.jm_bSummary)
{var jt_aEISummary=ji_oxe.Get_3xEI().Get_EInfoset(jg_oe.jc_oEntityInfo.jc_TI_SummaryEnterprises);for(var i=0;jt_aEISummary&&i<jt_aEISummary.length;i++)
{if(jt_aEISummary[i].eicod==jg_oe.jc_oEntityInfo.jc_CI_SummaryEnterprises_Count)
this.jm_siCountValue=Number(jt_aEISummary[i].einfo);}}
else
{this.jm_siCountValue=Number(1);this.jm_siCountRestricted=Number(1);}}}
...
return null;return ji_o3xaSummary.Get_Item(jt_sik.jm_siXeid.Get_String());};this.IsValid=function(){return this.jm_odtSummary?true:false;};this.MakeSummary=function(ji_odb,ji_oxeid)
{if(!ji_odb)
return false;this.jm_odtSummary=ji_odb.Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_SummaryEnterprises);this.jm_odtMain=ji_odb.Get_MainDataTable();if(!this.IsValid())
return false;if(ji_oxeid)
ji_oxeid=ji_oxeid.Get_3xXEID();if(!ji_oxeid)
return false;var jr_b=false;if(ji_oxeid.Get_TypEntity()==jg_oe.jc_oEntity.jc_Typ_Enterprise)
{jr_b=this._MakeSummaryGlobalEnterprises(ji_oxeid);if(jr_b&&ji_oxeid.Get_3xAZNMC().Get_N())
jr_b=this._MakeSummaryCityEnterprises(ji_oxeid);if(jr_b&&!this._MakeSummaryMainEnterprises(ji_oxeid));}
return jr_b;};this._MakeSummaryGlobalEnterprises=function(ji_oxeid)
{var jt_o3xaitDTSummary=this.jm_odtSummary.Get_Recordsel();if(!jt_o3xaitDTSummary)
return false;jt_o3xaitDTSummary.Reset();var jt_Select_A=ji_oxeid.Get_3xAZNMC().Get_A();var jt_Select_Z=ji_oxeid.Get_3xAZNMC().Get_Z();var jt_Select_N=ji_oxeid.Get_3xAZNMC().Get_N();var jt_Select_Ucat=ji_oxeid.Get_3xCat().Get_Ucat();var jt_Select_Vcat=ji_oxeid.Get_3xCat().Get_Vcat();this.jm_o3xSummaryByLandAll=new A3xaSummaryInfoItem();this.jm_o3xaSummaryByTopArea=new A3xaArray();this.jm_o3xaSummaryByArea=new A3xaArray();this.jm_o3xaSummaryByRegion=new A3xaArray();this.jm_o3xaSummaryByCity=new A3xaArray();this.jm_o3xSummaryByCatAll=new A3xaSummaryInfoItem();this.jm_o3xaSummaryByCatGroup=new A3xaArray();this.jm_o3xaSummaryByCat=new A3xaArray();jt_o3xaitDTSummary.jm_o3x2.ar.foreachItem(function(ji_o3xe,ji_ix,ji_key)
...
return true;});return true;};this._MakeSummaryMainEnterprises=function(ji_oxeid)
{var jt_o3xaitDTMain=null;if(this.jm_odtMain)
jt_o3xaitDTMain=this.jm_odtMain.Get_Recordsel();if(!jt_o3xaitDTMain)
return false;jt_o3xaitDTMain.Reset();var jt_bSummaryMain=false;var jt_bRestricted=true;while(!jt_o3xaitDTMain.IsEOF())
{var jt_o3xeMain=jt_o3xaitDTMain.Get_CurrentItem();var jt_o3xsiiTopArea=new A3xaSummaryInfoItem(jt_o3xeMain,false,false,true,jt_bSummaryMain);this.jm_o3xSummaryByLandAll.Add(jt_o3xsiiTopArea,jt_bRestricted);this._AddSummaryItem(this.jm_o3xaSummaryByTopArea,jt_o3xsiiTopArea,jt_bRestricted);this._AddSummaryItem(this.jm_o3xaSummaryByArea,new A3xaSummaryInfoItem(jt_o3xeMain,false,false,false,jt_bSummaryMain),jt_bRestricted);if(ji_oxeid.Get_3xAZNMC().Get_Z())
this._AddSummaryItem(this.jm_o3xaSummaryByRegion,new A3xaSummaryInfoItem(jt_o3xeMain,false,true,false,jt_bSummaryMain),jt_bRestricted);if(ji_oxeid.Get_3xAZNMC().Get_N())
...
return true;};this._MakeSummaryRegionalEnterprises=function(ji_oxeid)
{var jt_o3xaitDTMain=null;if(this.jm_odtMain)
jt_o3xaitDTMain=new A3xaArrayIt(this.jm_odtMain.Get_Recordset());if(!jt_o3xaitDTMain)
return false;jt_o3xaitDTMain.Reset();var jt_bSummaryMain=false;while(!jt_o3xaitDTMain.IsEOF())
{var jt_o3xeMain=jt_o3xaitDTMain.Get_CurrentItem();var jt_o3xsiiTopArea=new A3xaSummaryInfoItem(jt_o3xeMain,false,false,true,jt_bSummaryMain);jt_o3xaitDTMain.Next();}
return true;};this._MakeSummaryCityEnterprises=function(ji_oxeid)
{var jt_o3xaitDTMain=null;if(this.jm_odtMain)
jt_o3xaitDTMain=new A3xaArrayIt(this.jm_odtMain.Get_Recordset());if(!jt_o3xaitDTMain)
return false;jt_o3xaitDTMain.Reset();var jt_Select_Ucat=ji_oxeid.Get_3xCat().Get_Ucat();var jt_Select_Vcat=ji_oxeid.Get_3xCat().Get_Vcat();var jt_bSummaryMain=false;var jt_bRestricted=false;while(!jt_o3xaitDTMain.IsEOF())
{var jt_o3xeMain=jt_o3xaitDTMain.Get_CurrentItem();var jt_Ucat=jt_o3xeMain.Get_3xXEID().Get_3xCat().Get_Ucat();var jt_Vcat=jt_o3xeMain.Get_3xXEID().Get_3xCat().Get_Vcat();if(!jt_Select_Ucat||(jt_Ucat==jt_Select_Ucat&&(!jt_Select_Vcat||(jt_Vcat==jt_Select_Vcat))))
{var jt_o3xsiiCity=new A3xaSummaryInfoItem(jt_o3xeMain,false,true,true,jt_bSummaryMain);if(!jt_bRestricted)
jt_o3xsiiCity.jm_siCountRestricted=0;this._AddSummaryItem(this.jm_o3xaSummaryByCity,jt_o3xsiiCity,jt_bRestricted);}
...
ji_o3xaSummary.Add_Item(jt_skey,ji_o3xsii);return true;};}
...
return false;return true;};this.Set_ItemsNarrowView=function(ji_IdNarrowView){return true;};this.jm_oMgrSummary=null;this.Get_MgrSummary=function(){return this.jm_oMgrSummary;};}
...
{var jt_aoeifa=this.jm_o3xehbenv.jm_oxe.Get_3xEI().Get_Info(jt_aTypInfo[i],null);var jt_ogeiattr=new A3xaEntityInfo_Attributes(this.jm_o3xehbenv.jm_oxe.Get_LName(),true,ji_Row,ji_Col);jg_oe.CanLogInfo()&&jg_oe.LogInfo("jt_aoeifa: "+
...
return false;var jt_sCatGroup=ji_ocg.o3xe.Get_3xXEID().Get_3xCat().Get_String("-");var jt_oddig=this.Get_Child(jt_sCatGroup);if(!jt_oddig)
...
{if(!(ji_ocg&&ji_ocg.o3xe))
return false;if(!(this.jm_TreeLevel==1))
return false;var jt_te=ji_ocg.o3xe.Get_3xXEID().Get_TypEntity();var jt_sCat=ji_ocg.o3xe.Get_3xXEID().Get_3xCat().Get_String("-");var jt_oxur=jg_oApp.Get_AppXUR().Get_3xXUR();var jt_o3xcat_xapp=new A3xaCategoryCode_XApp(ji_ocg.o3xe.Get_3xXEID());var jt_TypGeo=jt_o3xcat_xapp.ToTypGeo();if(jt_TypGeo)
{var jt_xA=jt_oxur.Get_3xXEID().Get_3xAZNMC().Get_A();var jt_xZ=jt_oxur.Get_3xXEID().Get_3xAZNMC().Get_Z();var jt_xN=jt_oxur.Get_3xXEID().Get_3xAZNMC().Get_N();var jt_xC=jt_oxur.Get_3xXEID().Get_3xAZNMC().Get_C();var jt_xP=jt_oxur.Get_3xXEID().Get_3xPS().Get_P();var jt_xS=jt_oxur.Get_3xXEID().Get_3xPS().Get_S();var jt_xV_cat=ji_ocg.o3xe.Get_3xXEID().Get_3xCat().Get_Vcat();var jt_xte=jt_oxur.Get_3xXEID().Get_TypEntity();var jt_xWholeCountry=(jt_xZ>="3"&&jt_xZ<="9");var jt_xWholeArea=(jt_xZ>="1"&&jt_xZ<="2");var jt_xWholeAC=(jt_xWholeArea||jt_xWholeCountry);if(jt_TypGeo==jg_oe.jc_oEntity.jc_Typ_GeoArea)
{if(jt_xA||jt_xS)
return false;}
...
{}
var jt_oglrCategoryGroup=ji_ocg.o3xdtCat.Get_Recordset().Find(function(ji_oglrCatCur)
{if(ji_oglrCatCur.Get_3xXEID().Get_3xCat().Get_Vcat())
return false;if(ji_oglrCatCur.Get_3xXEID().Get_3xCat().Get_Ucat()==ji_ocg.o3xe.Get_3xXEID().Get_3xCat().Get_Ucat())
...
{jr_oxur.Get_3xXEID().Set_GEID(jt_TypGeo,null,null,null);jr_oxur.Get_3xXEID().Get_3xAZNMC().Clear();jr_oxur.Get_3xXEID().Get_3xPS().Clear();jr_oxur.MakeQUR(true,false);jr_oxur.jm_Single=jg_oe.jc_oXUR.jc_XURTG_Unlimited;jr_oxur.jm_SubEntity=jg_oe.jc_oXUR.jc_XURTG_Master;}
else if(jt_TypGeo==jg_oe.jc_oEntity.jc_Typ_GeoRegion)
{if(!jr_oxur.Get_3xXEID().Get_3xAZNMC().Get_Z()||New_A3xaAZNMC_XApp(jr_oxur.Get_3xXEID()).IsBestFromBabylon())
return null;jr_oxur.Get_3xXEID().Get_3xCat().Clear();jr_oxur.Get_3xXEID().Set_GEID(jt_TypGeo,null,null,null);jr_oxur.Get_3xXEID().Get_3xAZNMC().Clear_NC();jr_oxur.Get_3xXEID().Get_3xPS().Clear();jr_oxur.MakeQUR(true,false);jr_oxur.jm_Single=jg_oe.jc_oXUR.jc_XURTG_Unlimited;jr_oxur.jm_SubEntity=jg_oe.jc_oXUR.jc_XURTG_Master;}
else if(jt_TypGeo==jg_oe.jc_oEntity.jc_Typ_GeoCity)
{if(!jr_oxur.Get_3xXEID().Get_3xAZNMC().Get_Z()||New_A3xaAZNMC_XApp(jr_oxur.Get_3xXEID()).IsBestFromBabylon())
return null;jr_oxur.Get_3xXEID().Get_3xCat().Clear();jr_oxur.Get_3xXEID().Set_GEID(jt_TypGeo,null,null,null);jr_oxur.Get_3xXEID().Get_3xAZNMC().Clear_C();jr_oxur.Get_3xXEID().Get_3xPS().Clear();jr_oxur.MakeQUR(true,false);jr_oxur.jm_Single=jg_oe.jc_oXUR.jc_XURTG_Unlimited;jr_oxur.jm_SubEntity=jg_oe.jc_oXUR.jc_XURTG_Master;}
else if(jt_TypGeo==jg_oe.jc_oEntity.jc_Typ_GeoCountry)
{jr_oxur.Get_3xXEID().Set_GEID(jt_TypGeo,null,null,null);jr_oxur.Get_3xXEID().Get_3xAZNMC().Clear();jr_oxur.Get_3xXEID().Get_3xPS().Clear();jr_oxur.MakeQUR(true,false);jr_oxur.jm_Single=jg_oe.jc_oXUR.jc_XURTG_Unlimited;jr_oxur.jm_SubEntity=jg_oe.jc_oXUR.jc_XURTG_Master;}
else if(jt_TypGeo==jg_oe.jc_oEntity.jc_Typ_GeoState)
{if(!jr_oxur.Get_3xXEID().Get_3xPS().Get_P()||New_A3xaAZNMC_XApp(jr_oxur.Get_3xXEID()).IsBestFromBabylon())
return null;jr_oxur.Get_3xXEID().Set_GEID(jt_TypGeo,null,null,null);jr_oxur.Get_3xXEID().Get_3xAZNMC().Clear();jr_oxur.Get_3xXEID().Get_3xPS().Clear_S();jr_oxur.MakeQUR(true,false);jr_oxur.jm_Single=jg_oe.jc_oXUR.jc_XURTG_Unlimited;jr_oxur.jm_SubEntity=jg_oe.jc_oXUR.jc_XURTG_Master;}
else
{jr_oxur.Get_3xXEID().Set_GEID(jg_oe.jc_oEntity.jc_Typ_Enterprise,null,null,null);jr_oxur.Get_3xXEID().Get_3xPS().Clear();if(New_A3xaAZNMC_XApp(jr_oxur.Get_3xXEID()).IsBestFromBabylon())
...
else if(!jr_oxur.Get_3xXEID().Get_3xAZNMC().Get_N())
{jr_oxur.MakeQUR(false,false);jr_oxur.jm_Single=jg_oe.jc_oXUR.jc_XURTG_Limited;}
else if(true)
...
{var jt_sxeid=this.jm_odce.Get_3xXEID().Get_String();this.jm_odce.Get_3xXEID().Set_TypEntity(jg_oe.jc_oEntity.jc_Typ_Enterprise);var jt_sxeidQUR=this.jm_odce.Get_3xXEID().Get_String();this.Set_Key(jt_sxeid);var jt_oxur=new A3xaXur();if(this.jm_odce.Get_3xXEID().Get_3xAZNMC().Get_N())
...
else if(this.jm_odce.Get_3xXEID().Get_3xAZNMC().Get_Z())
...
else if(this.jm_odce.Get_3xXEID().Get_3xAZNMC().Get_A())
{jt_oxur.Set_UrlParams(null,null,null,jg_oe.jc_oXUR.jc_QUR_QuerySBS,jt_sxeidQUR,jg_oe.jc_oXUR.jc_XURTG_Limited,null,null);this.Set_Value("p3x="+jt_oxur.Get_XURCC());}
else
{jt_oxur.Set_UrlParams(null,null,null,jg_oe.jc_oXUR.jc_QUR_QuerySBS,jt_sxeidQUR,jg_oe.jc_oXUR.jc_XURTG_Limited,null,null);this.Set_Value("p3x="+jt_oxur.Get_XURCC());}}
...
{if(!(ji_ocg&&ji_ocg.o3xe))
return false;if(!(this.jm_TreeLevel==1))
return false;var jt_te=ji_ocg.o3xe.Get_3xXEID().Get_TypEntity();var jt_oddigNew=new A3xaDDItemRequestArea();var jt_odceg=new A3xaDCEntity();jt_odceg.Get_3xXEID().CopyFrom(ji_ocg.o3xe);jt_odceg.Get_3xXEID().Clear_GEID();jt_odceg.Get_3xXEID().Get_3xCat().Clear();jt_odceg.Get_3xXEID().Get_3xAZNMC().Clear_ZNC();jt_odceg.Get_3xXEID().Get_3xPS().Clear();var jt_odcTopA=New_A3xaAZNMC_XApp(jt_odceg.Get_3xXEID()).TopAreaTo3xDCEntity();jt_odceg.Copy3xsNameFrom(jt_odcTopA);jt_odceg.Get_3xEBIS().CopyFrom(jt_odcTopA.Get_3xEBIS());jt_oddigNew.Set_DCEntity(jt_odceg);if(jt_oddigNew.IsEmpty())
return false;var jt_oddig=this.Get_Child(jt_oddigNew.Get_Key());if(!jt_oddig)
{jt_oddigNew.Set_Descr(New_A3xaAZNMC_XApp(jt_odceg.Get_3xXEID()).TopAreaToName2());jt_oddig=jt_oddigNew;if(ji_ocg.o3xsii)
...
{if(!(ji_ocg&&ji_ocg.o3xe))
return false;if(!(this.jm_TreeLevel==1))
return false;var jt_te=ji_ocg.o3xe.Get_3xXEID().Get_TypEntity();var jt_odceg=new A3xaDCEntity();jt_odceg.Get_3xXEID().CopyFrom(ji_ocg.o3xe);jt_odceg.Get_3xXEID().Clear_GEID();jt_odceg.Get_3xXEID().Get_3xCat().Clear();jt_odceg.Get_3xXEID().Get_3xAZNMC().Clear_ZNC();jt_odceg.Get_3xXEID().Get_3xPS().Clear();var jt_oddig=this.Get_Child(jt_odceg.Get_3xXEID().Get_String());if(jt_oddig)
{var jt_oddirNew=new A3xaDDItemRequestArea();var jt_odcer=new A3xaDCEntity();jt_odcer.Get_3xXEID().CopyFrom(ji_ocg.o3xe);jt_odcer.Get_3xXEID().Clear_GEID();jt_odcer.Get_3xXEID().Get_3xCat().Clear();jt_odcer.Get_3xXEID().Get_3xAZNMC().Clear_NC();jt_odcer.Get_3xXEID().Get_3xPS().Clear();jt_odcer.Get_3xEBIS().Set_Order(ji_ocg.o3xe.Get_3xEBIS().Get_Order());jt_oddirNew.Set_DCEntity(jt_odcer);if(jt_oddirNew.IsEmpty())
return false;jt_oddirNew.Set_Descr(ji_ocg.o3xe.Get_LName());jt_oddig.Add_Child(jt_oddirNew);if(ji_ocg.o3xsii)
...
{if(!(ji_ocg&&ji_ocg.o3xe))
return false;if(!(this.jm_TreeLevel==1))
return false;var jt_te=ji_ocg.o3xe.Get_3xXEID().Get_TypEntity();var jt_oddirNew=new A3xaDDItemRequestArea();var jt_odcer=new A3xaDCEntity();jt_odcer.Get_3xXEID().CopyFrom(ji_ocg.o3xe);jt_odcer.Get_3xXEID().Clear_GEID();jt_odcer.Get_3xXEID().Get_3xCat().Clear();jt_odcer.Get_3xXEID().Get_3xAZNMC().Clear_C();jt_odcer.Get_3xXEID().Get_3xPS().Clear();jt_odcer.Get_3xEBIS().Set_Order(ji_ocg.o3xe.Get_3xEBIS().Get_Order());jt_oddirNew.Set_DCEntity(jt_odcer);if(jt_oddirNew.IsEmpty())
return false;jt_oddirNew.Set_Descr(ji_ocg.o3xe.Get_LName());this.Add_Child(jt_oddirNew);var jt_pisdsRecord_glidtoc=null;if(jt_odcer.Get_3xXEID().Get_3xAZNMC().Get_N())
{var jt_glidtoc=jg_oe.jc_oA3xaDbZero.MakeGlid(jg_oe.jc_oA3xaDbZero.jc_GLID_EnterprisePrefix,jt_odcer.Get_3xXEID().Get_3xAZNMC().Get_A()+
jt_odcer.Get_3xXEID().Get_3xAZNMC().Get_Z()+
jt_odcer.Get_3xXEID().Get_3xAZNMC().Get_N()+"0");jt_pisdsRecord_glidtoc=jg_oApp.Get_Database().Get_TOCItem(jt_glidtoc);}
jt_oddirNew.jm_bHighlight=(jt_pisdsRecord_glidtoc?true:false);var jt_odtExtH=null;if(jt_odcer.Get_3xXEID().Get_3xAZNMC().Get_N())
jt_odtExtH=jg_oApp.Get_Database().Get_MainDataTable(jt_odcer.Get_3xXEID().Get_3xAZNMC().Get_A(),jt_odcer.Get_3xXEID().Get_3xAZNMC().Get_Z(),jt_odcer.Get_3xXEID().Get_3xAZNMC().Get_N());if(ji_ocg.o3xsii)
...
{if(!(ji_ocg&&ji_ocg.o3xe))
return false;if(!(this.jm_TreeLevel==1))
return false;var jt_te=ji_ocg.o3xe.Get_3xXEID().Get_TypEntity();var jt_odceg=new A3xaDCEntity();jt_odceg.Get_3xXEID().CopyFrom(ji_ocg.o3xe);jt_odceg.Get_3xXEID().Clear_GEID();jt_odceg.Get_3xXEID().Get_3xCat().Clear();jt_odceg.Get_3xXEID().Get_3xAZNMC().Clear_C();jt_odceg.Get_3xXEID().Get_3xPS().Clear();var jt_oddig=this.Get_Child(jt_odceg.Get_3xXEID().Get_String());if(jt_oddig)
{var jt_oddirNew=new A3xaDDItemRequestArea();var jt_odcer=new A3xaDCEntity();jt_odcer.Get_3xXEID().CopyFrom(ji_ocg.o3xe);jt_odcer.Get_3xXEID().Clear_GEID();jt_odcer.Get_3xXEID().Get_3xCat().Clear();jt_odcer.Get_3xXEID().Get_3xPS().Clear();jt_oddirNew.Set_DCEntity(jt_odcer);if(jt_oddirNew.IsEmpty())
return false;jt_oddirNew.Set_Descr(ji_ocg.o3xe.Get_LName());jt_oddig.Add_Child(jt_oddirNew);var jt_pisdsRecord_glidtoc=null;if(jt_odcer.Get_3xXEID().Get_3xAZNMC().Get_N())
{var jt_glidtoc=jg_oe.jc_oA3xaDbZero.MakeGlid(jg_oe.jc_oA3xaDbZero.jc_GLID_EnterprisePrefix,jt_odcer.Get_3xXEID().Get_3xAZNMC().Get_A()+
jt_odcer.Get_3xXEID().Get_3xAZNMC().Get_Z()+
jt_odcer.Get_3xXEID().Get_3xAZNMC().Get_N()+"0");jt_pisdsRecord_glidtoc=jg_oApp.Get_Database().Get_TOCItem(jt_glidtoc);}
jt_oddirNew.jm_bHighlight=(jt_pisdsRecord_glidtoc?true:false);var jt_odtExtH=null;if(jt_odcer.Get_3xXEID().Get_3xAZNMC().Get_N())
...
return false;}
return true;};this.ConfigDD=function()
{this.jm_oddbox.jm_sKeySelected=null;var jt_sxeidSelected=null;if(jg_oApp.Get_AppXUR().Get_3xXUR().Get_3xXEID()&&jg_oApp.Get_AppXUR().Get_3xXUR().Get_3xXEID().Get_3xAZNMC().Get_A())
{var jt_odcSelected=new A3xaDCEntity();var jt_o3xxeid=jt_odcSelected.Get_3xXEID();jt_o3xxeid.CopyFrom(jg_oApp.Get_AppXUR().Get_3xXUR().Get_3xXEID());jt_o3xxeid.Clear_GEID();jt_o3xxeid.Get_3xCat().Clear();jt_o3xxeid.Get_3xPS().Clear();if(this.IsArea())
{jt_odcSelected.Get_3xXEID().Get_3xAZNMC().Clear_NC();this.jm_oddbox.jm_sKeySelected=jt_odcSelected.Get_3xXEID().Get_String();jt_odcSelected.Get_3xXEID().Get_3xAZNMC().Clear_ZNC();this.jm_oddbox.jm_sKeyGroupFocus=jt_odcSelected.Get_3xXEID().Get_String();}
else if(this.IsRegion())
{this.jm_oddbox.jm_sKeySelected=jt_odcSelected.Get_3xXEID().Get_String();jt_odcSelected.Get_3xXEID().Get_3xAZNMC().Clear_C();this.jm_oddbox.jm_sKeyGroupFocus=jt_odcSelected.Get_3xXEID().Get_String();}
else
{}
...
continue;if(!jt_oddiRequestArea.Add_TopArea({o3xe:jt_oglrArea,o3xsii:jg_oApp.Get_MgrSummary().Get_SummaryItemByTopArea(jt_oglrArea)}))
...
jt_oddiRequestArea.Set_Counters(jt_o3xsiiAreaAll.jm_siCountValue,jt_o3xsiiAreaAll.jm_siCountRestricted);var jt_nOfRegions=jt_ogldtRegion.Get_Recordset().Get_Count();jg_oe.CanLogInfo()&&jg_oe.LogInfo("NOFRegion="+jt_nOfRegions,"","A3xaMgrLand_RequestArea.LoadDataDD");for(var ir=0;ir<jt_nOfRegions;ir++)
{var jt_oglrRegion=jt_ogldtRegion.Get_Recordset().Get_Item_ByIndex(ir);jg_oe.CanLogInfo()&&jg_oe.LogInfo("Region="+
(jt_oglrRegion?jt_oglrRegion.Get_LName():""),"","A3xaMgrLand_RequestArea.LoadDataDD");if(!(jt_oglrRegion.Get_3xXEID().Get_3xAZNMC().Get_A()&&jt_oglrRegion.Get_3xXEID().Get_3xAZNMC().Get_Z()))
continue;if(jt_oglrRegion.Get_3xXEID().Get_3xAZNMC().Get_A()!=jt_oxeidCurrent.Get_3xXEID().Get_3xAZNMC().Get_A())
continue;if(jt_oglrRegion.Get_3xXEID().Get_3xAZNMC().Get_Z()!=jt_oxeidCurrent.Get_3xXEID().Get_3xAZNMC().Get_Z())
...
(jt_oglrCity?jt_oglrCity.Get_LName():""),"","A3xaMgrLand_RequestArea.LoadDataDD");var jt_A=jt_oglrCity.Get_3xXEID().Get_3xAZNMC().Get_A();var jt_Z=jt_oglrCity.Get_3xXEID().Get_3xAZNMC().Get_Z();var jt_N=jt_oglrCity.Get_3xXEID().Get_3xAZNMC().Get_N();if(!(jt_A&&jt_Z))
continue;if(jt_A!=jt_oxeidCurrent.Get_3xXEID().Get_3xAZNMC().Get_A())
continue;if(jt_Z!=jt_oxeidCurrent.Get_3xXEID().Get_3xAZNMC().Get_Z())
continue;var jt_bSelectedRegion=false;if(jt_N==jt_oxeidCurrent.Get_3xXEID().Get_3xAZNMC().Get_N())
...
{this.jm_o3ximap_Scale=new A3xaImageMap_Scale(100,70,20,20);this.jm_AZNMC_code=this.jm_oxeidFilter.Get_3xXEID().Get_3xAZNMC().Get_Code(false,false);}
else if(this.IsRegion())
{this.jm_o3ximap_Scale=new A3xaImageMap_Scale(100,70,200,200);this.jm_AZNMC_code=this.jm_oxeidFilter.Get_3xXEID().Get_3xAZNMC().Get_Code(true,false);}};this.IsLA=function()
{if(!this.jm_oxeidFilter.Get_3xXEID().Get_3xAZNMC().Get_A()||this.jm_oxeidFilter.Get_3xXEID().Get_3xAZNMC().Get_A()=='L')
return true;return false;};this.IsYB=function()
{if(this.jm_oxeidFilter.Get_3xXEID().Get_3xAZNMC().IsEmpty()||New_A3xaAZNMC_XApp(this.jm_oxeidFilter.Get_3xXEID()).IsBestFromBabylon())
return true;return false;};this.IsArea=function()
{if(this.IsLA()||this.IsYB())
return false;if(!this.jm_oxeidFilter.Get_3xXEID().Get_3xAZNMC().Get_Z())
return false;if(!this.jm_oxeidFilter.Get_3xXEID().Get_3xAZNMC().Get_N())
return true;return false;};this.IsRegion=function()
{if(this.IsLA()||this.IsYB())
return false;if(this.IsArea())
return false;if(!this.jm_oxeidFilter.Get_3xXEID().Get_3xAZNMC().Get_C())
return true;return false;};this.IsCurrent=function(ji_odc)
{if(!ji_odc)
return false;if(!jg_oApp.Get_AppXUR().Get_3xXUR())
return false;return(jg_oApp.Get_AppXUR().Get_3xXUR().Get_3xXEID().Get_3xAZNMC().Matches(ji_odc.Get_3xXEID(),true,this.IsArea(),this.IsRegion()));};this._Get_OnClickCallback=function(ji_odc,ji_Row,ji_Col)
{if(!ji_odc)
...
{jt_QUR=jg_oe.jc_oXUR.jc_QUR_QuerySBS;jt_Single=jg_oe.jc_oXUR.jc_XURTG_Unlimited;jt_odc.Get_3xXEID().Get_3xAZNMC().Clear_C();}
else if(this.IsRegion())
{jt_QUR=jg_oe.jc_oXUR.jc_QUR_QuerySBS;jt_Single=jg_oe.jc_oXUR.jc_XURTG_Unlimited;}
else
{jt_odc.Get_3xXEID().Get_3xAZNMC().Clear_NC();}
...
continue;if(this.IsLA()||this.IsYB()||(this.IsArea()&&this.jm_oxeidFilter.Get_3xXEID().Get_3xAZNMC().Matches(jt_oglr.Get_3xXEID(),true,false,false))||(this.IsRegion()&&this.jm_oxeidFilter.Get_3xXEID().Get_3xAZNMC().Matches(jt_oglr.Get_3xXEID(),true,true,false)))
...
continue;if(jt_o3ximhs.jm_odc.Get_3xXEID().Get_3xAZNMC().Matches(jt_oxeidsel.Get_3xXEID(),false,true,true))
...
{var jt_oxur=jg_oApp.Get_AppXUR().Get_3xXUR().Get_3xXEID();this.jm_o3ximapTabs=new A3xaImageMap_Tabs(null);var jt_ogldtGeoArea=jg_oe.Get_Database().Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoArea);this.jm_o3ximapLA=new A3xaImageMap_AZNMC(jt_ogldtGeoArea,null);if(jt_oxur&&jt_oxur.Get_3xXEID().Get_3xAZNMC().Get_Z()&&!New_A3xaAZNMC_XApp(jt_oxur.Get_3xXEID()).IsLA()&&!New_A3xaAZNMC_XApp(jt_oxur.Get_3xXEID()).IsBestFromBabylon())
{this.jm_o3ximapTabs.jm_bEnableArea=true;var jt_ogldtGeoRegion=jg_oe.Get_Database().Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoRegion);var jt_oxeidArea=new A3xaDCEntity();jt_oxeidArea.Get_3xXEID().Set_3xAZ(jt_oxur);this.jm_o3ximapArea=new A3xaImageMap_AZNMC(jt_ogldtGeoRegion,jt_oxeidArea);if(jt_oxur.Get_3xXEID().Get_3xAZNMC().Get_N())
...
this.jm_o3xehbenv.jm_o3xMgrLand_IMap.ShowSelectedHotSpot(jt_oheSet.Get_XEIDRowList(true,false));return true;};this._A3xaECP_Mgr();}
...
{this.ResetApp();this.ShowCPTemplate();this.LogStatusBar2(new A3xaString(["Ready","Listo","Pronto","Pronto"]),false,true);this.MainData();return true;};this.MainData=function(ji_bLoadOnly)
{this.jm_odbLoaderManagerMain=new A3xaDbLoaderManager(function(ji_oDTStatus)
{if(ji_oDTStatus.IsOpLoad()&&ji_oDTStatus.IsDone())
{jt_this.OnDataLoadedSetup();jt_this.DocumentShow();}
return true;},this.Get_Database());this.jm_odbLoaderManagerMain.RunMain(ji_bLoadOnly);return true;};this.ResetApp=function()
{if(this.Get_ECPMgr())
...
this.Set_TurboStatus(!ji_bCurrentStatus);if(ji_fnChangeStatus)
ji_fnChangeStatus(new GLDataStatusLoadSuccess());return true;};this.ShowCPTemplate=function()
...
return false;return true;};this.OnDataLoadedSetup=function()
{this.Get_AppXUR().OnDataLoadedSetup();this.Get_Database().OnDataLoadedSetup();this.Get_MgrSummary().MakeSummary(this.Get_Database(),this.Get_AppXUR().Get_3xXUR());return true;};this.DocumentShow=function()
{var jr_b=true;try
...
var jt_keyname=jg_oe.jc_oA3xaDbZero.Glid2SDSTbType(ji_glid).tbtkeyname;if(false&&jg_oe.jc_oA3xaDbZero.XGlid2Glid(ji_glid)==jg_oe.jc_oA3xaDbZero.jc_GLID_MetaSystemControl&&this.Get_Database().Get_SDSDBStore())
{var jt_o3x2dtcsw=A3xa2DTCacheWriter_sds(null,this.Get_Database(),ji_glid,this.Get_Database().Get_SDSDBStore(),jt_keyname);jt_o3x2dtcsw.csw.enableJSDS();jr_b=jt_o3x2dtcsw.csw.writeTable();var jt_o3x2dtcsw_ebis=A3xa2DTCacheWriter_sds(null,this.Get_Database(),jg_oe.jc_oA3xaDbZero.jc_GLID_PMetaSystemControl,this.Get_Database().Get_SDSDBStore(),jt_keyname);jt_o3x2dtcsw_ebis.csw.enableJSDS();jt_o3x2dtcsw_ebis.csw.writeTable();var jt_o3x2dtcsw_ei=A3xa2DTCacheWriter_sds(null,this.Get_Database(),jg_oe.jc_oA3xaDbZero.jc_GLID_FMetaSystemControl,this.Get_Database().Get_SDSDBStore(),jt_keyname);jt_o3x2dtcsw_ei.csw.enableJSDS();jt_o3x2dtcsw_ei.csw.writeTable();}
else
{var jt_oSchemaTable=this.Get_Database().jm_oDbSchema.Get_Table_ByName(ji_glid,false);var jt_o3x2dtcsw=A3xa2DTCacheWriter_GLRS(null,this.Get_Database(),ji_glid,ji_sGLRS);if(jt_oSchemaTable)
jt_o3x2dtcsw.csw.enableJSDS();jr_b=jt_o3x2dtcsw.csw.writeTable();}}}
catch(e)
