...
{var jt_sxur=this.Get_XURCC();jr_oUrl=new A3xaUrl(jg_oe.jc_oXUR.jc_sUrlBase_A3xaFormDDAJOO+"?",(ji_bAppendDescrParam===true?"p3d="+this.Get_XUDString()+"&":"")+"p3x="+jt_sxur);}
if(!jt_sxur)
