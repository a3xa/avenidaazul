...
{this.jc_asReqArea=["Area, Region, Category","Area, Region, CategorÃ­a","Ãrea, RegiÃ£o, Categoria","Area, Regione, Categoria"];this.jc_asALL=["*** ALL ***","*** TODOS ***","*** TUDO ***","*** TUTTI ***"];this.jc_ColorsBGHL_Area=["80FF80","80FF80","C0FFC0"];this.jc_ColorsBGHL_Region=["8080FF","8000FF","C0C0FF"];}
