...
{this.jc_MaxViewRows=50;this.jc_Col_IdTag=1;this.jc_Col_LandIcons=2;this.jc_Col_CtrlInfoIcons=3;this.jc_Col_Identity=4;this.jc_Col_Info=5;this.jc_Col_Last=6;this.jc_Col_DefaultWidth=30;this.jc_Col_IdTagWidth=100;this.jc_Col_CtrlInfoIconsWidth=110;this.jc_Col_IdentityWidth=210;this.jc_Body_MicroWidth=500;this.jc_Body_SmallWidth=800;this.jc_Body_NormalWidth=1000;this.jc_Body_MicroWidthId=3;this.jc_Body_SmallWidthId=2;this.jc_Body_NormalWidthId=1;}
...
return false;var jt_idnv=jt_o3xhePilot.jm_ao3xehf[0].CheckNarrowView();if(this.jm_ao3xehf)
{for(var ixf=0;ixf<this.jm_ao3xehf.length;ixf++)
this.jm_ao3xehf[ixf].Set_NarrowView(jt_idnv||jt_o3xhePilot.jm_ao3xehf[0].Get_NarrowView());}
if(ji_bUpdateHtml&&jt_idnv)
