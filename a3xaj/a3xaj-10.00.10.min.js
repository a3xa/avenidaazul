...
{this.jm_bDebug=(ji_bDebug==true);this.jm_bCanEdit=ji_bCanEdit;this.jm_bCanLike=ji_bCanLike;this.jm_IdUser=ji_IdUser;this.jm_sDirBase=(ji_sDirBase?ji_sDirBase:"/");this.jm_sHomeDir=(ji_sHomeDir?ji_sHomeDir:"/");this.jm_sLang=(ji_sLang?ji_sLang:"en");return true;};this.CheckInitDone=function(){return true;};this.jm_oAjax2=new A3xaAjax2();this.jm_oMgrStorage=null;this.Get_MgrStorage=function(){return this.jm_oMgrStorage;};this.jm_odb=null;this.Set_Database=function(ji_odb){this.jm_odb=ji_odb;return true;};this.Get_Database=function(){return this.jm_odb;};this.jm_oHostReporter=null;this.Set_Reporter=function(ji_oHostReporter)
