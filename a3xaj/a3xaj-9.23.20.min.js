...
return true;};this.Set_CommonValues=function(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_IdUser,ji_Itemid,ji_sDirBase,ji_sHomeDir,ji_sLang)
...
{this.jm_o3xhIconInfo=ji_o3xhIconInfo;this.jm_bTipPopup=false;this.jm_sSimplePopupPlugin=null;this.jm_o3pbtnStatus=null;this.Get_HtmIconInfo=function(){return this.jm_o3xhIconInfo;};this.IsValid=function()
...
{this.jm_o3pbtnStatus=(ji_o3pbtnStatus||null);return true;};this.Set_Options=function(ji_bTipPopup,ji_sSimplePopupPlugin)
{if(ji_bTipPopup==true)
this.jm_bTipPopup=true;if(ji_sSimplePopupPlugin&&ji_sSimplePopupPlugin.length)
this.jm_sSimplePopupPlugin=ji_sSimplePopupPlugin;return true;};this.BtnStatus2Offsets=function(ji_o3pbtnStatus)
{if(!ji_o3pbtnStatus)
...
{if(!this.IsValid())
return"";var jt_ooffsets=this.BtnStatus2Offsets(this.jm_o3pbtnStatus);var jt_shStyle=this.jm_o3xhIconInfo.Get_StyleString(jt_ooffsets?jt_ooffsets.row-1:null,jt_ooffsets?jt_ooffsets.col-1:null);if(jt_shStyle)
...
jt_sUrlLink=this.jm_oUrlLink.Get_Url();if(this.jm_bTipPopup&&!jt_sUrlLink)
...
{this.jc_sIconExt=".png";this.jm_SpriteDivisor=10000;this.jc_ao3xSprites=new A3xaArray();this.jm_Idsprite_SingleStatus=1;this.jm_Absidsprite_SingleStatus=this.jm_Idsprite_SingleStatus*this.jm_SpriteDivisor;this.jc_ao3xSprites.Add_Item(this.jm_Idsprite_SingleStatus,{iddivisor:100,rows:10,cols:10,steprows:1,stepcols:10,height:72,width:240,path:"a3xas/a3xam/sprites/Sprite-SingleStatus-10x10x24x8c"});this.jm_Idsprite_MultiStatus=2;this.jm_Absidsprite_MultiStatus=this.jm_Idsprite_MultiStatus*this.jm_SpriteDivisor;this.jc_ao3xSprites.Add_Item(this.jm_Idsprite_MultiStatus,{iddivisor:100,rows:4,cols:40,steprows:1,stepcols:10,height:96,width:960,path:"a3xas/a3xam/sprites/Sprite-MultiStatus5-4x40x24x6"});this.jm_Idsprite_Category=10;this.jm_Absidsprite_Category=this.jm_Idsprite_Category*this.jm_SpriteDivisor;this.jc_ao3xSprites.Add_Item(this.jm_Idsprite_Category,{iddivisor:100,rows:12,cols:10,steprows:1,stepcols:10,height:288,width:240,path:"a3xas/a3xam/sprites/Sprite-Category-12x10x24x8c"});this.jm_Idsprite_CountryLA=20;this.jm_Absidsprite_CountryLA=this.jm_Idsprite_CountryLA*this.jm_SpriteDivisor;this.jc_ao3xSprites.Add_Item(this.jm_Idsprite_CountryLA,{iddivisor:100,rows:10,cols:10,steprows:1,stepcols:10,height:160,width:240,path:"a3xas/a3xam/sprites/Sprite-CountryLA-10x10x16x24x8"});this.jm_Idsprite_AreaFlag=50;this.jm_Absidsprite_AreaFlag=this.jm_Idsprite_AreaFlag*this.jm_SpriteDivisor;this.jc_ao3xSprites.Add_Item(this.jm_Idsprite_AreaFlag,{iddivisor:100,rows:10,cols:10,steprows:1,stepcols:10,height:160,width:240,path:"a3xas/a3xam/sprites/Sprite-AreaFlagLA-10x10x16x24x8"});this.jm_Idsprite_AreaBkgnd=(this.jm_Idsprite_AreaFlag+10);this.jm_Absidsprite_AreaBkgnd=this.jm_Idsprite_AreaBkgnd*this.jm_SpriteDivisor;this.jc_ao3xSprites.Add_Item(this.jm_Idsprite_AreaBkgnd,{iddivisor:100,rows:1,cols:100,steprows:1,stepcols:10,height:24,width:2400,path:"a3xas/a3xam/sprites/Sprite-AreaBkgndLA-1x100x32x8"});this.jm_Idsprite_StateLA=100;this.jm_Absidsprite_StateLA=this.jm_Idsprite_StateLA*this.jm_SpriteDivisor;this.jc_ao3xSprites.Add_Item(this.jm_Idsprite_StateLA,{iddivisor:100,rows:30,cols:40,steprows:1,stepcols:40,height:160,width:960,path:"a3xas/a3xam/sprites/Sprite-StateLA-30x40x16x24x6"});this.jc_sIconUrlBase_IMap="a3xas/a3xam/";this.jc_sIconUrlBase_Main="a3xas/a3xam/";this.jc_sIcon_Transparent="Transparent";this.jc_sIcon_Star="Star-icon-32x32";this.jc_sIcon_Turista="Turista-icon-64x96";this.jc_sIcon_Logo="Logo-84x84";this.jc_sIconUrlBase_QUR="a3xas/a3xam/";this.jc_sIconPrefix_QTT="QTop10gold-icon-32x32-";this.jc_sIconPrefix_QEN="QENT-icon-32x32-";this.jc_sIconPrefix_QLE="QLE-icon-32x32-";this.jc_oIconSS_FacebookPage={absid:this.jm_Absidsprite_SingleStatus+101};this.jc_oIconSS_FacebookGroup={absid:this.jm_Absidsprite_SingleStatus+102};this.jc_oIconSS_FacebookUser={absid:this.jm_Absidsprite_SingleStatus+103};this.jc_oIconSS_Twitter={absid:this.jm_Absidsprite_SingleStatus+104};this.jc_oIconSS_Gplus={absid:this.jm_Absidsprite_SingleStatus+105};this.jc_oIconSS_Pinterest={absid:this.jm_Absidsprite_SingleStatus+106};this.jc_oIconSS_Video={absid:this.jm_Absidsprite_SingleStatus+107};this.jc_oIconSS_VideoUrl={absid:this.jm_Absidsprite_SingleStatus+108};this.jc_oIconSS_Flickr={absid:this.jm_Absidsprite_SingleStatus+109};this.jc_oIconSS_Flickrtxt={absid:this.jm_Absidsprite_SingleStatus+109};this.jc_oIconSS_Wikipedia={absid:this.jm_Absidsprite_SingleStatus+201};this.jc_oIconSS_Wikiphoneprefix={absid:this.jm_Absidsprite_SingleStatus+202};this.jc_oIconSS_Wikitravel={absid:this.jm_Absidsprite_SingleStatus+203};this.jc_oIconSS_Skype={absid:this.jm_Absidsprite_SingleStatus+204};this.jc_oIconSS_Skypetxt={absid:this.jm_Absidsprite_SingleStatus+204};this.jc_oIconSS_Url={absid:this.jm_Absidsprite_SingleStatus+205};this.jc_oIconSS_Email={absid:this.jm_Absidsprite_SingleStatus+206};this.jc_oIconSS_Phone={absid:this.jm_Absidsprite_SingleStatus+207};this.jc_oIconSS_A3xaGallery={absid:this.jm_Absidsprite_SingleStatus+208};this.jc_oIconSS_Person={absid:this.jm_Absidsprite_SingleStatus+209};this.jc_oIconSS_Sitemap={absid:this.jm_Absidsprite_SingleStatus+301};this.jc_oIconSS_WCUrl={absid:this.jm_Absidsprite_SingleStatus+302};this.jc_oIconSS_Googlemap={absid:this.jm_Absidsprite_SingleStatus+303};this.jc_oIconSS_GooglemapBW={absid:this.jm_Absidsprite_SingleStatus+304};this.jc_oIconSS_ViewEntity={absid:this.jm_Absidsprite_SingleStatus+305};this.jc_oIconSS_NewEntity={absid:this.jm_Absidsprite_SingleStatus+601};this.jc_oIconSS_NewSEntity={absid:this.jm_Absidsprite_SingleStatus+602};this.jc_oIconSS_EditEntity={absid:this.jm_Absidsprite_SingleStatus+603};this.jc_oIconSS_DeleteEntity={absid:this.jm_Absidsprite_SingleStatus+605};this.jc_oIconSS_NewEntityInfo={absid:this.jm_Absidsprite_SingleStatus+701};this.jc_oIconSS_EditEntityInfo={absid:this.jm_Absidsprite_SingleStatus+703};this.jc_oIconSS_DeleteEntityInfo={absid:this.jm_Absidsprite_SingleStatus+705};this.jc_oIconMS_Turbo={absid:this.jm_Absidsprite_MultiStatus+101};this.jc_oIconMS_TurboX={absid:this.jm_Absidsprite_MultiStatus+102};this.jc_oIconMS_TurboDW={absid:this.jm_Absidsprite_MultiStatus+103};this.jc_oIconMS_TurboUP={absid:this.jm_Absidsprite_MultiStatus+103};this.jc_oIconMS_TurboFY={absid:this.jm_Absidsprite_MultiStatus+104};this.jc_oIconMS_TurboFB={absid:this.jm_Absidsprite_MultiStatus+104};this.jc_oIconMS_TurboFR={absid:this.jm_Absidsprite_MultiStatus+105};this.jc_oIconMS_TurboFG={absid:this.jm_Absidsprite_MultiStatus+105};this.jc_oIconMS_GLMore={absid:this.jm_Absidsprite_MultiStatus+107};this.jc_oIconMS_GLMoreX={absid:this.jm_Absidsprite_MultiStatus+108};this.jc_oIconMS_Like={absid:this.jm_Absidsprite_MultiStatus+109};this.jc_oIconMS_LikeX={absid:this.jm_Absidsprite_MultiStatus+110};this.jc_oIconMS_StaticMapLA={absid:this.jm_Absidsprite_MultiStatus+111};this.jc_oIconMS_StaticMapLAX={absid:this.jm_Absidsprite_MultiStatus+112};this.jc_oIconMS_StaticMapArea={absid:this.jm_Absidsprite_MultiStatus+113};this.jc_oIconMS_StaticMapAreaX={absid:this.jm_Absidsprite_MultiStatus+114};this.jc_oIconMS_StaticMapRegion={absid:this.jm_Absidsprite_MultiStatus+115};this.jc_oIconMS_StaticMapRegionX={absid:this.jm_Absidsprite_MultiStatus+116};this.jc_oIconMS_TopMenu_Home={absid:this.jm_Absidsprite_MultiStatus+121,title:"Home",alt:"HOM"};this.jc_oIconMS_TopMenu_LA={absid:this.jm_Absidsprite_MultiStatus+122,title:"Latin America",alt:"LA0"};this.jc_oIconMS_TopMenu_YB={absid:this.jm_Absidsprite_MultiStatus+123,title:"Best from Babylon",alt:"YB0"};this.jc_oIconMS_TopMenu_D3={absid:this.jm_Absidsprite_MultiStatus+124,title:"Third",alt:"D30"};this.jc_oIconMS_TopMenu_T10Gold={absid:this.jm_Absidsprite_MultiStatus+131,title:"Top10 Gold",alt:"TTG"};this.jc_oIconMS_TopMenu_T10Silver={absid:this.jm_Absidsprite_MultiStatus+132,title:"Top10 Silver",alt:"TTS"};this.jc_oIconMS_TopMenu_T10Bronze={absid:this.jm_Absidsprite_MultiStatus+133,title:"Top10 Bronze",alt:"TTB"};this.jc_oIconMS_TopMenu_T10Iron={absid:this.jm_Absidsprite_MultiStatus+134,title:"Top10 Iron",alt:"TTI"};this.jc_oIconMS_XStatus={norm:1,xtra:2,dwup:3,fyfb:4,frfg:5};this.jc_oIconMS_Status={offdis:1,off:2,ondis:3,on:4};this.jc_oIconMS_StatusXtra={offover:1,offclick:2,onover:3,onclick:4};this.jc_oIconCat_City={absid:this.jm_Absidsprite_Category+808};}
...
this.jm_bAjax=(ji_bAjax==true);return true;};this.Set_SrcInfo3=function(ji_o3xhIconInfo,ji_sTitle,ji_sAlt,ji_sfnOnClick,ji_ColTarget,ji_sAjaxUrlParams,ji_StatusInit)
...
{var jt_oxposON=this.jm_o3xhIconInfo.Get_XPos(jg_oe.jc_oIcons.jc_oIconMS_Status.on-1);var jt_oxposOFF=this.jm_o3xhIconInfo.Get_XPos(jg_oe.jc_oIcons.jc_oIconMS_Status.off-1);var jt_oxposONFLASH=null;var jt_oxposOFFFLASH=null;if(ji_FlashType=="FY")
...
{var jt_odce=new A3xaDCEntity();jt_odce.Get_3xXEID().Set_String(jt_RowElem.getAttribute('XEIDCode'));var jt_o3xcat_xapp=new A3xaCategoryCode_XApp(jt_odce.Get_3xXEID());if(jt_o3xcat_xapp.IsMetasystem_Control()&&jg_oApp.Get_ECPMgr()&&ji_Row==1)
...
return 0;if(jt_oebis_a.Get_Name()==jt_oebis_b.Get_Name())
return 0;if(jt_oebis_a.Get_Name()<jt_oebis_b.Get_Name())
...
{return(this.jm_Single==jg_oe.jc_oXUR.jc_XURTG_Limited||!this.jm_Single);};this.Get_XURString=function()
{if(!this.IsValid())
...
{A3xaAbsEnvironment.call(this);this.Get_ECPMgr=function(){return null;};this.jm_oAppXUR=null;this.Get_AppXUR=function(){return this.jm_oAppXUR;};this.jm_oAppMngIcons=null;this.Get_3xAppMngIcons=function(){return this.jm_oAppMngIcons;};this.Get_DefIcons=function(){return this.Get_3xAppMngIcons().Get_DefIcons();};}
function A3xaEntity_Html(ji_oxe,ji_o3xehf)
{var jt_this=this;this.jm_oxe=ji_oxe;this.jm_o3xehf=ji_o3xehf;this.jm_bNoShiftIdTag=false;this._A3xaEntity_Html=function()
{};this.IsValid=function()
...
{jt_oci.qm_oCell.text("");this.PrintHtml_IdentityBox(jt_oci.qm_oCell,jt_oci.jm_Row,jt_oci.jm_Col);}
...
return true;}
if(!ji_bHeader&&ji_bLowPriority&&!ji_bOnDemand)
{jt_oci=this._Get_CellInfo(jg_oe.jc_oHtml.jc_Col_Identity);if(jt_oci&&jt_oci.qm_oCell)
{this.PrintHtml_ImageBox(jt_oci.qm_oCell,jt_oci.jm_Row,jt_oci.jm_Col);}}
if(!ji_bHeader&&ji_bLowPriority&&ji_bOnDemand)
{jt_oci=this._Get_CellInfo(jg_oe.jc_oHtml.jc_Col_LandIcons);if(jt_oci&&jt_oci.qm_oCell)
{this.PrintHtml_LandBox(jt_oci.qm_oCell,jt_oci.jm_Row,jt_oci.jm_Col,false,jg_oe.jc_oHtml.jc_Col_Identity,true);}}
...
jt_sDescr+"</strong></span>");return true;};this.PrintHtml_SummaryBox=function(qi_oCell,ji_Row,ji_Col)
...
{var jt_aTypInfo=new Array(jg_oe.jc_oEntityInfo.jc_TI_Note);for(var i=0;i<jt_aTypInfo.length;i++)
{var jt_aoeifa=this.jm_oxe.Get_Info(jt_aTypInfo[i],null);var jt_ogeiattr=new A3xaEntityInfo_Attributes(null,this.jm_oxe.Get_3xEBIS().Get_Name(),true,ji_Row,ji_Col,"",jg_oApp.Get_AppXUR().Get_3xXUR().jm_QUR);var jt_ogeiset=new A3xaEntityInfoSet(this.jm_oxe,jt_aoeifa,jt_ogeiattr);jt_ogeiset.PrintHtml(qi_oCell);}
...
{if(ji_QUR==jg_oe.jc_oXUR.jc_QUR_QueryNewEntity&&ji_bSecundary&&(!this.jm_oxe.Get_3xXEID().IsGroupMajor()))
return false;var jt_oUrlLink=A3xaEntity_MakeUrl_Edit_Params2(jg_oe.jc_oXUR.jc_XURFN_EditEntity,ji_QUR,this.jm_oxe.Get_3xXEID(),ji_QUR==jg_oe.jc_oXUR.jc_QUR_QueryNewEntity?ji_bSecundary:null,jg_oe.jm_Itemid);if(!jt_oUrlLink)
return false;var jt_o3xmngic=jg_oe.Get_3xAppMngIcons();var jt_odfic=jt_o3xmngic.Get_DefIcons();var jt_absid=jt_o3xmngic.Get_AbsidIconAdmin(ji_QUR,ji_bSecundary,false);var jt_o3xhici=jt_o3xmngic.NewSprite(jt_absid);jt_o3xhici.Set_Dim(24,24);jt_o3xhici.Set_UrlLink(jt_oUrlLink.Get_Url());jt_o3xhici.Set_Title(this.jm_oxe.Get_3xEBIS().Get_Name(),jg_oe.Get_AppXUR().QUR_Get_Descr2(ji_QUR,jg_oe.jc_oXUR.jc_XURTG_Single,this.jm_oxe.Get_3xXEID()));jt_o3xhici.Set_Options(null,false);var jt_ohButton=new A3xaSimpleButton3(jt_o3xhici);jt_ohButton.PrintHtml(qi_oCell);return true;};this.PrintHtml_IconInfoAdmin=function(qi_oCell,ji_QUR,ji_IdFieldInfo)
{var jt_oUrlLink=A3xaEntity_MakeUrl_EditInfo_Params(jg_oe.jc_oXUR.jc_XURFN_EditEntityInfo,ji_QUR,ji_IdFieldInfo,this.jm_oxe.Get_3xXEID().Get_TypEntity(),this.jm_oxe.Get_3xXEID().Get_IdEntity(),jg_oe.jm_Itemid);if(!jt_oUrlLink)
return false;var jt_o3xmngic=jg_oe.Get_3xAppMngIcons();var jt_odfic=jt_o3xmngic.Get_DefIcons();var jt_absid=jt_o3xmngic.Get_AbsidIconAdmin(ji_QUR,null,true);var jt_o3xhici=jt_o3xmngic.NewSprite(jt_absid);jt_o3xhici.Set_Dim(24,24);jt_o3xhici.Set_UrlLink(jt_oUrlLink.Get_Url());jt_o3xhici.Set_Title(this.jm_oxe.Get_3xEBIS().Get_Name(),jg_oe.Get_AppXUR().QUR_Get_Descr2(ji_QUR,jg_oe.jc_oXUR.jc_XURTG_Single,this.jm_oxe.Get_3xXEID()));jt_o3xhici.Set_Options(null,false);var jt_ohButton=new A3xaSimpleButton3(jt_o3xhici);jt_ohButton.PrintHtml(qi_oCell);return true;};this.PrintHtml_LandBox=function(qi_oCell,ji_Row,ji_Col,ji_bCountryFlag,ji_ColImages,ji_bSRFlags)
{return this._A3xaEntity_Html_PrintHtml_LandBox(qi_oCell,ji_Row,ji_Col,ji_bCountryFlag,ji_ColImages,ji_bSRFlags);};this._A3xaEntity_Html_PrintHtml_LandBox=function(qi_oCell,ji_Row,ji_Col,ji_bCountryFlag,ji_ColImages,ji_bSRFlags)
{var jt_oglmLand=new A3xaMgrLand();if(ji_bCountryFlag)
{jt_oglmLand.PrintHtml_FlagGeoCountry(qi_oCell,this.jm_oxe);return true;}
if(ji_bSRFlags)
{jt_oglmLand.PrintHtml_FlagGeoRegion(qi_oCell,this.jm_oxe,true);jt_oglmLand.PrintHtml_FlagGeoState(qi_oCell,this.jm_oxe,true);return true;}
jt_oglmLand.PrintHtml_IconGeoCity(qi_oCell,this.jm_oxe);var jt_ocpLand=new A3xaPanelLandIcons3(null,-1,ji_Row,ji_Col,true,ji_ColImages);jt_ocpLand.PrintHtml_Buttons(qi_oCell);jt_oglmLand.PrintHtml_IconMap(qi_oCell,this.jm_oxe,ji_Row,ji_Col);return true;};this.PrintHtml_CategoryBox=function(qi_oCell)
...
{if(!this.PrintHtml_ControlIconsBox_Header(qi_oCell,ji_Row,ji_Col))
return false;if(!this.PrintHtml_ControlIconsBox_Footer(qi_oCell,ji_Row,ji_Col))
return false;return true;}
this.PrintHtml_ControlIconsBox_Header=function(qi_oCell,ji_Row,ji_Col)
{var jt_bBtnLikes=true;if(jt_bBtnLikes)
{var jt_oAjaxUrlParams=null;var jt_sfn="";if(jg_oe.jm_bCanLike)
{jt_sfn="jg_oPanelControlIcons_Builder.OnClick";var jt_oxur=new A3xaXur();jt_oxur.Set_UrlParams(jg_oe.jc_oXUR.jc_XURFN_AjaxEntity,null,jg_oe.jc_oXUR.jc_sAjaxTypFans,null,this.jm_oxe.Get_3xXEID().Get_String(),null,null,null);jt_oAjaxUrlParams=jt_oxur.Get_A3xaUrl(true);jt_oAjaxUrlParams.Add_UrlParam2("p_TypRelation","F");jt_oAjaxUrlParams.Add_UrlParam2("p_Op","I");jt_oAjaxUrlParams.Add_UrlParam2("p_Rating","0");}
...
{return true;}
this.OnClick=function(ji_TypEntity,ji_IdEntity,ji_TypInfo,ji_IdInfo,ji_CodInfo)
...
{return jg_oApp.Get_ECPMgr().OnChangeDD_Category(ji_eddbox,ji_oddi);};this.jm_oddboxCategory.Set_ColorsBGHL(["FF6080","FF80A0","FFC0E0"]);this._CompareEntityOrder=function(ji_oddi_a,ji_oddi_b)
...
{return jg_oApp.Get_ECPMgr().OnChangeDD_City(ji_eddbox,ji_oddi);};this.jm_oddboxLand.Set_ColorsBGHL(["FFFF80","FFFF80","FFFFC0"]);this.Get_DDSelected=function()
...
{var jt_this=this;this.jc_Opt_By=100;this.jc_Opt_ByScore=1000;this.jc_Opt_ByScoreDesc=1200;this.jc_Opt_ByTime=2000;this.jc_Opt_ByTimeDesc=2200;this.jc_Opt_ByClick=3000;this.jc_Opt_ByClickDesc=3200;this.jc_Opt_ByName=4000;this.jc_Opt_ByNameDesc=4200;this.jc_Opt_ByLatestClick=5000;this.jc_Opt_ByLatestClickDesc=5200;this.jm_oddi=new A3xaECPOrder_DDIOption();this.jm_oddbox=new A3xaDDSelectBox(this.jm_oddi,"ECPOrder","Orden");this.jm_oddbox.NewDDItem=function(){return new A3xaECPOrder_DDIOption();};this.jm_oddbox.OnChange=function(ji_eddbox,ji_oddi)
...
else if(ji_oddi.Get_Value()==this.jc_Opt_ByLatestClickDesc)
...
else if(ji_oddi.Get_Value()==this.jc_Opt_ByClickDesc)
...
else if(ji_oddi.Get_Value()==this.jc_Opt_ByName)
...
this.jm_oddbox.jm_sKeySelected=this.jc_Opt_ByClickDesc;else if(jt_oxur.IsSortByLatestClick())
this.jm_oddbox.jm_sKeySelected=this.jc_Opt_ByLatestClickDesc;else if(jt_oxur.IsSortByTime())
this.jm_oddbox.jm_sKeySelected=this.jc_Opt_ByTimeDesc;else if(jt_oxur.IsSortByName())
this.jm_oddbox.jm_sKeySelected=this.jc_Opt_ByName;else
this.jm_oddbox.jm_sKeySelected=this.jc_Opt_ByScoreDesc;this.jm_oddi.jm_bVisible=false;var jt_oddip=new A3xaECPOrder_DDIOption(this.jc_Opt_By,this.jc_Opt_By,"Order by");this.jm_oddi.Add_Child(jt_oddip);jt_oddip.jm_bVisible=false;jt_oddip.Add_Child(new A3xaECPOrder_DDIOption(this.jc_Opt_ByScoreDesc,this.jc_Opt_ByScoreDesc,"Clasificación"));jt_oddip.Add_Child(new A3xaECPOrder_DDIOption(this.jc_Opt_ByClickDesc,this.jc_Opt_ByClickDesc,"Clicks"));jt_oddip.Add_Child(new A3xaECPOrder_DDIOption(this.jc_Opt_ByLatestClickDesc,this.jc_Opt_ByLatestClickDesc,"Latest Click"));jt_oddip.Add_Child(new A3xaECPOrder_DDIOption(this.jc_Opt_ByTimeDesc,this.jc_Opt_ByTimeDesc,"Tiempo"));jt_oddip.Add_Child(new A3xaECPOrder_DDIOption(this.jc_Opt_ByName,this.jc_Opt_ByName,"Nombre"));return true;};}
function A3xaECP_Mgr(ji_oxe,ji_o3xehf)
{A3xaEntity_Html.call(this,ji_oxe,ji_o3xehf);var jt_this=this;this.jm_oDDCategoryCode=null;this.jm_oDDPairLand=null;this.jm_o3xMgrLand_IMap=null;this.jm_oecpOrder=null;this._A3xaECP_Mgr=function()
{var jt_oxeidHL=jg_oApp.Get_AppXUR().Get_3xXUR().Get_XEIDHighlights();if(jt_oxeidHL)
...
this.jm_oecpOrder=new A3xaECPOrder_Mgr();};this.ResetECP=function()
{this.jm_oDDCategoryCode=null;this.jm_oDDPairLand=null;this.jm_oecpOrder=null;this.jm_o3xMgrLand_IMap=null;return true;};this.PrintHtml_LandBox=function(qi_oCell,ji_Row,ji_Col,ji_bCountryFlag,ji_ColImages)
{if(!ji_bCountryFlag)
{var jt_o3xtopmenu=new A3xaTopMenu();jt_o3xtopmenu.PrintHtml(qi_oCell);}
return this._A3xaEntity_Html_PrintHtml_LandBox(qi_oCell,ji_Row,ji_Col,ji_bCountryFlag,ji_ColImages);}
this.PrintHtml_FilterBox=function(qi_oCell,ji_Row,ji_Col,ji_oCPLandButtonStatus)
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("","","A3xaECP_Mgr.PrintHtml_FilterBox");var jt_bBestFromBabylon=New_A3xaAZNC_XApp(this.jm_oxe.Get_3xXEID()).IsBestFromBabylon();var jt_oglmLand=new A3xaMgrLand();var jt_oglmCategory=new GLMgrCategory(jt_bBestFromBabylon);if(!jt_bBestFromBabylon)
...
ji_oCPLandButtonStatus.jm_Value="OFF";this.jm_oecpOrder.LoadDataDD();this.jm_oecpOrder.PrintHtmlDD(qi_oCell);return true;};this.PrintHtml_IdentityBox=function(qi_oCell,ji_Row,ji_Col)
...
{}
return true;};this.PrintHtml_SummaryBox=function(qi_oCell,ji_Row,ji_Col)
{if(!this.PrintHtml_SummaryBox_Header(qi_oCell,ji_Row,ji_Col))
return false;if(!this.jm_o3xMgrLand_IMap)
this.jm_o3xMgrLand_IMap=new A3xaMgrLand_InteractiveMap();this.jm_o3xMgrLand_IMap.PrintHtml(qi_oCell,ji_Row,ji_Col);if(!this.PrintHtml_SummaryBox_Footer(qi_oCell,ji_Row,ji_Col))
return false;return true;};this.PrintHtml_ControlIconsBox=function(qi_oCell,ji_Row,ji_Col)
{if(!this.PrintHtml_ControlIconsBox_Header(qi_oCell,ji_Row,ji_Col))
return false;var jt_ociPanel=new A3xaPanelControlIcons(null,-1,ji_Row,ji_Col,true,true);var jt_oBtnTurbo=jt_ociPanel.Get_Button("Turbo");jt_oBtnTurbo.PrintHtml(qi_oCell);if(!this.PrintHtml_ControlIconsBox_Footer(qi_oCell,ji_Row,ji_Col))
return false;return true;}
...
{this.jm_oDDPairLand=ji_oddi;return this.ShowHtmlSelected();};this._A3xaECP_Mgr();}
...
continue;var jt_sUrlImg="";var jt_sTitle="";var jt_QUR="";var jt_Single="";if(jt_addi[0].indexOf(jg_oe.jc_oXUR.jc_QUR_QuerySBS)>=0)
{jt_QUR=jg_oe.jc_oXUR.jc_QUR_QuerySBS;jt_Single=jg_oe.jc_oXUR.jc_XURTG_Limited;}
else if(jt_addi[0].indexOf(jg_oe.jc_oXUR.jc_QUR_QuerySBT)>=0)
{jt_QUR=jg_oe.jc_oXUR.jc_QUR_QuerySBT;jt_Single=jg_oe.jc_oXUR.jc_XURTG_Limited;}
if(jt_QUR)
{var jt_oxur=new A3xaXur();jt_oxur.Set_UrlParams(jg_oe.jc_oXUR.jc_XURFN_ListEntity,null,null,null,null,jt_Single,null,jt_addi[0]);jt_oxur.LinkCommonData(jg_oe.Get_Database(),true);var jt_ohButton=new A3xaSimpleButton(jg_oe.Get_3xAppMngIcons().Get_UrlIconQUR(jt_QUR,jt_Single,i==jt_ddiSelected?"ON":"OFF"),jt_oxur.Get_A3xaUrl(false,true),jg_oe.Get_AppXUR().QUR_Get_Descr2(jt_QUR,jt_Single,jt_oxur.Get_3xXEID()),jt_QUR);jt_ohButton.Set_Options(null,null,false,null,false,null,null);jt_ohButton.PrintHtml(qi_oParent);}}
...
{A3pqhfpair.call(this);this.jm_RowHF=(ji_RowHF||null);this.jm_oxeid=null;this.jm_oxe=null;this.jm_ao3xehc=new Array();this.Set_XtdEntity=function(ji_oxe)
...
this.bstick=true;}};this.Get_XtdEntity=function(){return this.jm_oxe;};this.IsPanel=function()
...
{var qt_oHeader=this.qoh;var qt_oBody=this.qob;var bstick=this.bstick;if(ji_bQReload)
...
return null;return this.jm_ao3xehc[ji_Col-1];};this.PrintHtml=function(ji_bUpdateOnly)
...
{var jt_this=this;this.jm_nRows=null;this.jm_TimerLoPry=null;this.jm_bReleased=false;this.jm_o3xxeCP=null;this.jm_o3xehfCP=null;this.jm_o3xehCP=null;this.jm_ao3xehf=new Array();this.jm_ao3xeh=new Array();this.jm_bUpdateCP=false;this.DoNotClearCP=function(ji_b){this.jm_bUpdateCP=(ji_b===false?false:true);return true;};this.jm_bFirstClickGLMore=false;this.Release=function(ji_bClearHtml)
{this.jm_bReleased=true;this.jm_TimerLoPry=null;this.jm_o3xxeCP=null;this.jm_o3xehfCP=null;this.jm_o3xehCP=null;this.jm_ao3xeh=new Array();this.jm_ao3xehf=new Array();if(ji_bClearHtml)
{this.RemoveHtmlRows();jQuery("#A3xaTableMainBody").text("");}
jg_oe.CanLogInfo({VW:4})&&jg_oe.LogInfo("OK","","A3xaHtmlEntitySet.Release");return true;};this.Get_ECPMgr=function(){return this.jm_o3xehCP;};this.RemoveHtmlCP=function()
{var jr_b=false;if(this.jm_o3xehfCP)
{this.jm_o3xehfCP.RemoveHtml(false,false);jr_b=true;}
this.jm_o3xehfCP=null;this.jm_o3xehCP=null;return jr_b;};this.RemoveHtmlRows=function()
{var jr_b=false;if(!this.jm_bUpdateCP)
{jr_b=this.RemoveHtmlCP();this.jm_o3xxeCP=null;}
if(this.jm_ao3xehf&&this.jm_ao3xehf.length)
{for(var i=0;i<this.jm_ao3xehf.length;i++)
{this.jm_ao3xehf[i].RemoveHtml(false,false);}
jr_b=true;}
this.jm_ao3xehf=new Array();this.jm_ao3xeh=new Array();return jr_b;};this.HasCP=function(){return this.jm_o3xxeCP&&this.jm_o3xehfCP&&this.jm_o3xehCP;};this.AbortPrintHtmlLowPriority=function(ji_bClearHtml,ji_bClearCP)
{var jt_o3xAppWindow=new A3xaAppWindow();jt_o3xAppWindow.Stop();this.jm_TimerLoPry=null;return true;}
this.InitCPDataSource=function()
{this.jm_o3xxeCP=null;var jt_odb=jg_oe.Get_Database();if(jt_odb)
{this.jm_o3xxeCP=jt_odb.Get_3xXEMSC_ByXUR();if(this.jm_o3xxeCP)
return true;}
return false;}
this.Init=function()
{this.jm_TimerLoPry=null;this.jm_bReleased=false;this.InitCPDataSource();this.jm_nRows=0;this.jm_ao3xehf=new Array();this.jm_ao3xeh=new Array();var jt_ogldtMain=null;var jt_odb=jg_oe.Get_Database();if(jt_odb)
jt_ogldtMain=jt_odb.Get_MainDataTable();var jt_aoglr=null;if(jt_ogldtMain)
jt_aoglr=jt_ogldtMain.Get_Recordsel();if(jt_aoglr)
this.jm_nRows=jt_aoglr.Get_Count();return(this.jm_nRows>0||this.jm_o3xxeCP);};this.PrintHtmlFrameCP=function()
{if(!(this.jm_bUpdateCP&&this.jm_o3xxeCP))
{this.RemoveHtmlCP();}
if(!this.jm_o3xxeCP)
return false;jg_oe.CanLogInfo()&&jg_oe.LogInfo("PrintHtml-CP row:1");var jt_bUpdate=true;if(!this.jm_o3xehfCP)
{this.jm_o3xehfCP=new A3xaEntity_HtmlFrame(1);jt_bUpdate=false;}
this.jm_o3xehfCP.Set_XtdEntity(this.jm_o3xxeCP);this.jm_o3xehfCP.PrintHtml(jt_bUpdate);return true;};this.PrintHtmlContentsCP=function()
{var jt_odb=jg_oe.Get_Database();if(!jt_odb)
return false;if(!this.jm_o3xxeCP)
return false;this.jm_o3xehCP=new A3xaECP_Mgr(this.jm_o3xxeCP,this.jm_o3xehfCP);this.jm_o3xehCP.PrintHtml(true);this.jm_o3xehCP.PrintHtml(false,false);return true;};this.PrintHtmlFrame=function()
{var jr_b=true;var jt_odb=jg_oe.Get_Database();if(!jt_odb)
return false;var jt_bPrintHeader=true;var jt_bPrintBody=true;if(!jg_oe.IsTurboON())
{jt_bPrintHeader=false;}
jg_oApp.HideLeftPanel();var jt_bCP=this.PrintHtmlFrameCP();jg_oe.CanLogInfo()&&jg_oe.LogInfo("PrintHtml-main Data Table:");jg_oe.CanLogInfo()&&jg_oe.LogInfo("PrintHtml-rows:"+this.jm_nRows);if(!(this.jm_nRows>0))
return jt_bCP;jg_oe.CanLogInfo()&&jg_oe.LogInfo("PrintHtml-rows2:"+this.jm_nRows);var jt_ogldtMain=jt_odb.Get_MainDataTable();if(!jt_ogldtMain)
return false;var jt_Row=1+(jt_bCP?1:0);var jt_o3xait=jt_ogldtMain.Get_Recordsel();while(!jt_o3xait.IsEOF())
{var jt_oxe=jt_o3xait.Get_CurrentItem();jg_oe.CanLogInfo()&&jg_oe.LogInfo("PrintHtml-current row:"+this.jm_nRows);var jt_o3xehf=new A3xaEntity_HtmlFrame(jt_Row);jt_o3xehf.Set_XtdEntity(jt_oxe);this.jm_ao3xehf.push(jt_o3xehf);jt_o3xehf.PrintHtml();jt_Row++;jt_o3xait.Next();}
return true;};this.PrintHtmlContents=function(ji_bLowPriority,ji_bOnDemand)
{var jr_b=true;if(this.jm_bReleased)
return false;var jt_odb=jg_oe.Get_Database();if(!jt_odb)
return false;if(!ji_bLowPriority)
{var jt_bCP=this.PrintHtmlContentsCP();if(!(this.jm_nRows>0))
return jt_bCP;var jt_ogldtMain=jt_odb.Get_MainDataTable();if(jt_ogldtMain)
{var jt_aoglr=jt_ogldtMain.Get_Recordsel();for(var jt_Row=1;jt_Row<=this.jm_nRows;jt_Row++)
{var jt_oxe=jt_aoglr.Get_Item_ByIndex(jt_Row-1);var jt_o3xehf=this.jm_ao3xehf[jt_Row-1];var jt_o3xeh=new A3xaEntity_Html(jt_oxe,jt_o3xehf);this.jm_ao3xeh.push(jt_o3xeh);jt_o3xeh.PrintHtml(true);}}
...
jg_oe.CanLogInfo({VW:4})&&jg_oe.LogInfo("End.LoPry.at:"+i+"of"+jt_ehCount,"","A3xaHtmlEntitySet.PrintHtmlContents");},(ji_bOnDemand?10:500));}
...
{if(this.Get_ECPMgr())
this.Get_ECPMgr().ResetECP();this.Set_Reporter(new GLReporter());return true;};this.OnClickTurbo=function(ji_bCurrentStatus,ji_fnChangeStatus)
...
{var jt_oheEdit=new A3xaHtmlEntityEdit();return jt_oheEdit.OnChangeDD_EditEntityInfoList(ji_eDropDown,ji_QUR,ji_TypEntity,ji_IdEntity,ji_Itemid);};this.HideLeftPanel=function()
{var qt_navLeftPanel=jQuery("#nav");if(qt_navLeftPanel&&qt_navLeftPanel.length)
{qt_navLeftPanel.hide();return true;}
return false;};this._A3xaAppManager();}
