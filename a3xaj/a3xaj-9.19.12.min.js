...
return false;jt_ogldtMain.OnDataLoadedSetup();var jt_oxur=jg_oApp.Get_AppXUR().Get_3xXUR();if(jt_oxur&&jt_oxur.IsQURUnlimited())
...
{var jt_nRows=this.jm_aoglr.Get_Count();if(!(jt_nRows>0))
return false;for(var jt_Row=1;jt_Row<=jt_nRows;jt_Row++)
{var jt_oxe=this.jm_aoglr.Get_Item_ByIndex(jt_Row-1);jt_oxe.LinkCommonData(this.Get_Database());jt_oxe.Get_3xEBIS().Set_DefaultColor("FFFFFF");}
...
jt_RowHF++;var jt_nRows=0;var jt_nRowsHF=0;if(jt_ogldtMain)
jt_nRows=jt_ogldtMain.jm_aoglr.Get_Count();jt_nRowsHF=jt_nRows+jt_RowHF-1;this.jm_nRows=jt_nRows;this.jm_nRowsHF=jt_nRowsHF;if(!(jt_nRows>0))
{if(jt_nRowsHF>0)
return true;return false;}
...
return null;for(var jt_Row=1;jt_Row<=jt_nRows;jt_Row++)
...
return false;for(var jt_Row=1;jt_Row<=jt_nRows;jt_Row++)
{var jt_oxe=jt_ogldtMain.jm_aoglr.Get_Item_ByIndex(jt_Row-1);if(jt_o3xxemsc&&jt_Row==1)
{if(jt_oxe.Get_3xXEID().Get_TypEntity()==jc_gl.jc_oEntity.jc_Typ_MetaSystemControl)
continue;}
jg_oe.CanLogInfo()&&jg_oe.LogInfo("PrintHtml-current row:"+jt_RowHF);var jt_o3xehf=new A3xaEntity_HtmlFrame(jt_RowHF);jt_o3xehf.Set_XtdEntity(jt_oxe);this.jm_ao3xehf.push(jt_o3xehf);jt_o3xehf.PrintHtml();jt_RowHF++;}
...
return false;var jt_ogldtMain=jt_odb.Get_MainDataTable();if(jt_ogldtMain)
{for(var jt_Row=1;jt_Row<=jt_nRows;jt_Row++)
{var jt_oxe=jt_ogldtMain.jm_aoglr.Get_Item_ByIndex(jt_Row-1);if(jt_Row==1&&jt_oxe.Get_3xXEID().Get_TypEntity()==jc_gl.jc_oEntity.jc_Typ_MetaSystemControl)
