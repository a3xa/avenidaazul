...
{var jt_oDatabase=jg_oe.Get_Database();var jt_odtMain=jt_oDatabase.Get_MainDataTable();var jt_ohes=jg_oe.Get_HtmlSetEntity();var jt_oxur=jg_oApp.Get_AppXUR().Get_3xXUR();var jt_oxurNew=new A3xaXur();jt_oxurNew.CopyFromXUR(jt_oxur);if(ji_oddi.Get_Value()==this.jc_Opt_ByTimeDesc)
...
{var jt_this=this;this.jm_TimerLoPry=null;this.jm_bReleased=false;this.jm_ao3xehf=new Array();this.jm_ao3xeh=new Array();this.Release=function(ji_bClearHtml)
...
return false;return true;};this.Get_EHRowList=function(ji_bIncludeCP)
{var jt_odb=jg_oe.Get_Database();if(!jt_odb)
...
var jt_nRows=0;var jt_nRowsHF=0;var jt_ogldtMain=jt_odb.Get_MainDataTable();if(jt_ogldtMain)
{jt_nRows=jt_ogldtMain.jm_aoglr.Get_Count();jt_nRowsHF=jt_nRows+jt_RowHF-1;}
if(!(jt_nRows>0))
{if(jt_nRowsHF>0)
...
var jt_odb=jg_oe.Get_Database();if(!jt_odb)
return false;jg_oe.CanLogInfo()&&jg_oe.LogInfo("PrintHtml-main Data Table:");var jt_ogldtMain=jt_odb.Get_MainDataTable();if(!jt_ogldtMain)
...
return false;jg_oe.CanLogInfo()&&jg_oe.LogInfo("PrintHtml-rows2:"+jt_nRows);var jt_RowHF=1;var jt_o3xxemsc=jt_odb.Get_3xXEMSC_ByXUR();if(jt_o3xxemsc)
