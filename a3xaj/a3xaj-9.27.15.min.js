...
{this.jc_Typ_MetaSystemControl="K";this.jc_Typ_Category="B";this.jc_Typ_Info="H";this.jc_Typ_Enterprise="E";this.jc_Typ_GeoNA="A";this.jc_Typ_GeoNZ="Z";this.jc_Typ_GeoNR="N";this.jc_Typ_GeoArea="G";this.jc_Typ_GeoRegion="R";this.jc_Typ_GeoCountry="P";this.jc_Typ_GeoState="S";this.jc_Typ_GeoCity="C";this.jc_UCat_Metasystem="M";this.jc_UCat_Category="C";this.jc_UCat_Topic="A";this.jc_UCat_Geo="P";this.jc_VCat_Metasystem_Control="C";this.jc_VCat_Geo_Area="A";this.jc_VCat_Geo_Region="R";this.jc_VCat_Geo_RegionNR="N";this.jc_VCat_Geo_RegionTR="T";this.jc_VCat_Geo_RegionMetr="M";this.jc_VCat_Geo_RegionIsland="I";this.jc_VCat_Geo_City="C";this.jc_VCat_Geo_Country="P";this.jc_VCat_Geo_State="S";this.jc_VCat_Geo_Provincie="V";this.jc_VCat_Geo_Department="D";this.jc_VCat_Geo_RegionAdmin="G";this.jc_o3xeTopA_LatinAmerica={L4Name:["Latin America","América Latina","América Latina","America Latina"],Order:100};this.jc_o3xeTopA_Mexico={L4Name:["Mexico","México","México","Messico"],Order:200};this.jc_o3xeTopA_Centroamerica={L4Name:["Central America","Centroamérica","Centroamérica","America Centrale"],Order:300};this.jc_o3xeTopA_Caribbean={L4Name:["Caribbean","Caribe","Caribe","Caraibi"],Order:400};this.jc_o3xeTopA_Tropical={L4Name:["Tropical","Tropical","Tropical","Tropicale"],Order:500};this.jc_o3xeTopA_Amazon={L4Name:["Amazon","Amazonia","Amazonia","Amazonia"],Order:600};this.jc_o3xeTopA_Brazil={L4Name:["Brazil","Brasil","Brasil","Brasile"],Order:700};this.jc_o3xeTopA_SE={L4Name:["Southeast","Sureste","Sudeste","Sudest"],Order:800};this.jc_o3xeTopA_Andean={L4Name:["Andean","Andes","Andes","Ande"],Order:900};this.jc_o3xeTopA_YB={L4Name:["Best from Babylon","Mejor desde Babilonia","Melhor da Babilónia","Meglio da Babilonia"],Order:5000};}
...
this.jm_oglHeader=jt_oglHeader;this.jm_oglHeader.Set_FieldNames(jt_oglNames);var jt_aAltIndex=[];jt_aAltIndex.push(jt_sKeyName);var jt_aIndex=new Array();jt_aIndex.push(jt_sKeyName);for(var i=2;i<jt_aglRS.length;i++)
...
i,"Set_GLRecord(jt_id,jt_oglRecord)","GLDataTable_Set_String");jt_aIndex.push(jt_id);if(this.jm_bAX)
{var jt_AltKey=this.BuildAltKey(jt_oglRecord,true);if(!jt_AltKey)
{this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Records AltKey");return false;}
jt_aAltIndex.push(jt_AltKey+"="+jt_id);}}
...
jt_oglIxHeader.Set_Recordset(jt_oglIx);this.jm_oglIxHeader=jt_oglIxHeader;if(this.jm_bAX)
{var jt_oglAxHeader=this.NewAltIndexHeader();var jt_oglAx=this.NewAltIndex();jt_oglAxHeader.Set_Record_Array(jt_sGlid,null,new Array(this.jm_oglHeader.Get_Release()));if(!jt_oglAxHeader.IsValid())
{this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"AltIndex Header not valid");return false;}
jt_oglAx.Set_Record_Array(jt_sGlid,1,jt_aAltIndex);if(!jt_oglAx.IsValid())
{this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"AltIndex not valid");return false;}
jt_oglAxHeader.Set_Recordset(jt_oglAx);this.jm_oglAxHeader=jt_oglAxHeader;}
this.jm_oDTStatus.SetFrom(this.IntegrityCheck());return true;}
...
return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Missing Index values");if(this.jm_oglAxHeader)
{if(!this.jm_oglAxHeader.IsValid())
return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"AltIndex Header not valid");var jt_oglAx=this.jm_oglAxHeader.Get_Recordset();if(!jt_oglAx)
return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Missing AltIndex values");}
else if(this.jm_bAX)
return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"Missing AltIndex Header");jg_oe.CanLogInfo()&&jg_oe.LogInfo("end:glid"+
...
{this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_LoadFail,"Load AltIndex");return false;}
if(!jt_oglAx.LoadFromGLS(ji_oDbTransaction,ji_glid,1))
{this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_LoadFail,"Load AltIndex values");return false;}}
if(!jt_oglHeader.IsValid())
{this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_LoadFail,"Load Header Cache");return false;}
...
{this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_LoadFail,"Load AltIndex Cache");return false;}}
...
{if(!this.jm_bAX||this.jm_oglAxHeader.jm_oDTStatus.Get()==jg_oe.jc_oA3xaDbZero.jc_DTStatus_Loaded)
...
{this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_LoadFail);return true;}
if(this.jm_bAX)
{if(this.jm_oglAxHeader.jm_oDTStatus.Get()==jg_oe.jc_oA3xaDbZero.jc_DTStatus_LoadFail)
{this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_LoadFail);return true;}}
...
{this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_LoadEmpty);return true;}
if(this.jm_bAX)
{if(this.jm_oglAxHeader.jm_oDTStatus.Get()==jg_oe.jc_oA3xaDbZero.jc_DTStatus_LoadEmpty||this.jm_oglAxHeader.jm_oDTStatus.Get()==jg_oe.jc_oA3xaDbZero.jc_DTStatus_Empty)
{this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_LoadEmpty);return true;}}
this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_LoadFail);return true;}
...
{var jt_this=this;jg_oe.CanLogInfo({DB:4})&&jg_oe.LogInfo("Start Common","","A3xaDbLoaderManager.DatabaseLoadCommon");jg_oe.LogStatusBar2(new A3xaString(["Loading common","Cargando datos común","Carregando dados comum","Caricamento dati comuni"]));this.jm_odbLoader=new A3xaDbLoader(function(ji_oDTStatus)
...
{var jt_this=this;jg_oe.CanLogInfo({DB:4})&&jg_oe.LogInfo("Start Ext Header","","A3xaDbLoaderManager.DatabaseLoadExtHeader");jg_oe.LogStatusBar2(new A3xaString(["Loading Extended Headers","Cargando extendido cabeceras","Carregando extensão cabeçalhos","Caricamento intestazioni estese"]));this.jm_odbLoader=new A3xaDbLoader(function(ji_oDTStatus)
...
{jg_oe.CanLogInfo({DB:4})&&jg_oe.LogInfo("Start Turbo Header","","A3xaDbLoaderManager.DatabaseLoadTurboHeader");jg_oe.LogStatusBar2(new A3xaString(["Loading Turbo Headers","Cargando Turbo cabeceras","Carregando Turbo cabeçalhos","Caricamento intestazioni Turbo"]));this.jm_odbLoader=new A3xaDbLoader(function(ji_oDTStatus)
...
{this.jc_asReqArea=["Area, Region, Category","Area, Region, Categoría","Área, Região, Categoria","Area, Regione, Categoria"];this.jc_asALL=["*** ALL ***","*** TODOS ***","*** TUDO ***","*** TUTTI ***"];this.jc_ColorsBGHL=["80FF80","80FF80","C0FFC0"];}
...
jg_oe.jc_oA3xaDbZero.jc_GLMID_DT);var jt_o3xhici=jg_oe.Get_3xAppMngIcons().NewSprite(jg_oe.jc_oIcons.jc_oIconMS_Turbo.absid);jt_oBtnTurbo.Set_SrcInfo4(jt_o3xhici,["A3xaTurboZero (...developing...) - now is "+jg_oe.Get_TurboDescr(),"A3xaTurboZero (...en desarrollo...) - ahora está "+jg_oe.Get_TurboDescr(),"A3xaTurboZero (...em construção...) - agora é "+jg_oe.Get_TurboDescr(),"A3xaTurboZero (...in sviluppo...) - ora è "+jg_oe.Get_TurboDescr()],"Turbo","jg_oPanelControlIcons_Builder.OnClick",-1,jt_oAjaxUrlParams?jt_oAjaxUrlParams.Get_UrlParams():"",jg_oe.IsTurboON()?"ON":"OFF");jt_oBtnTurbo.AttachProperties(false,false,true);}
