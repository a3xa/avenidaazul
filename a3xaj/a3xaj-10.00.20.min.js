...
jg_oe.CanLogInfo()&&jg_oe.LogInfo("w2sb:"+ji_o3xsText.Get_LString(),"","A3xaAbsEnvironment.LogStatusBar");if(!this._ExecLogStatusBar2(ji_o3xsText,ji_bAsChild,ji_bClear));return true;};this._ExecLogStatusBar2=function(ji_o3xsText,ji_bAsChild,ji_bClear){return false;};this.jm_o3x2Envars=A3xa2EnvironmentVariables();this.Set_CommonValues=function(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_sDirBase,ji_sHomeDir,ji_sLang)
{return this.A3xaAbsEnvironment_Set_CommonValues(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_sDirBase,ji_sHomeDir,ji_sLang);}
this.A3xaAbsEnvironment_Set_CommonValues=function(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_sDirBase,ji_sHomeDir,ji_sLang)
{this.jm_bDebug=(ji_bDebug==true);this.jm_bCanEdit=ji_bCanEdit;this.jm_bCanLike=ji_bCanLike;this.jm_sDirBase=(ji_sDirBase?ji_sDirBase:"/");this.jm_sHomeDir=(ji_sHomeDir?ji_sHomeDir:"/");this.jm_sLang=(ji_sLang?ji_sLang:"en");return true;};this.CheckInitDone=function(){return true;};this.jm_oAjax2=new A3xaAjax2();this.jm_oMgrStorage=null;this.Get_MgrStorage=function(){return this.jm_oMgrStorage;};this.jm_odb=null;this.Set_Database=function(ji_odb){this.jm_odb=ji_odb;return true;};this.Get_Database=function(){return this.jm_odb;};this.jm_oHostReporter=null;this.Set_Reporter=function(ji_oHostReporter)
...
return false;var qt_ohW20=$("<div>");qt_ohW20.css({"display":"inline-block","vertical-align":"top"});qt_ohphb.append(qt_ohW20);if(!(qt_ohW20&&qt_ohW20.length))
return false;jr_o.phb._printIcon(qt_ohW20,jg_oe.jc_oIcons.jc_oIconSS_Sitemap.absid,jg_oe.jm_sHomeDir+"a3xap_root.php?p3r=A3xaSitemap,"+jg_oe.jm_sLang,"Sitemap-xml-2016-03-12","smp");var qt_ohUL=$("<div class='list-inline'>");qt_ohUL.css({"display":"inline-block","vertical-align":"top"});qt_ohW20.append(qt_ohUL);if(!(qt_ohUL&&qt_ohUL.length))
...
{this.A3xaAbsEnvironment_Set_CommonValues(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_sDirBase,ji_sHomeDir,ji_sLang);this.Set_Debug((ji_bDebug?1:0),{DB:3,DBT:"idb"});this.Get_AppXUR().Set_XURString(ji_sxur);this.Get_AppXUR().Set_Page(ji_sPage);return true;};this.Get_ECPMgr=function()
