...
{this.jc_GLSep_Block="__glk__";this.jc_GLSep_Header="__glv__";this.jc_GLSep_Field="__glf__";this.jc_GLSep_FieldArray="__glr__";this.jc_GLSep_Compact="~";this.jc_GLMID_FieldNames="GLN";this.jc_GLMID_GT="GLG";this.jc_GLMID_IX="GLI";this.jc_GLMID_DT="GLH";this.jc_GLMID_JSDS="JSD";this.jc_GLIDPREFIXLEN=3;this.jc_GLIDLEN=6;this.jc_GLIDMARKLEN=3;this.jc_GLID_All="ALLA3X";this.jc_GLIDSUFFIXDEFAULT="A3X";this.jc_GLID_TOC="TMTA3X";this.jc_tbtype_tid={tbtname:"t3x_tid",tbtkeyname:"TTID"};this.jc_tidf_tid="f3x_tid";this.jc_GLID_MetaSystemControl="RMKA3X";this.jc_GLID_Category="RMBA3X";this.jc_GLID_GeoArea="RGGA3X";this.jc_GLID_GeoRegion="RGRA3X";this.jc_GLID_GeoCity="RGCA3X";this.jc_GLID_GeoCountry="RGPA3X";this.jc_GLID_GeoState="RGSA3X";this.jc_GLID_SummaryEnterprises="RSEA3X";this.jc_GLID_Enterprise="REEA3X";this.jc_GLID_EnterprisePrefix="REE";this.jc_GLID_NMetaSystemControl="NMKA3X";this.jc_GLID_NCategory="NMBA3X";this.jc_GLID_NGeoArea="NGGA3X";this.jc_GLID_NGeoRegion="NGRA3X";this.jc_GLID_NGeoCity="NGCA3X";this.jc_GLID_NGeoCountry="NGPA3X";this.jc_GLID_NGeoState="NGSA3X";this.jc_GLID_NEnterprise="NEEA3X";this.jc_GLID_NEnterprisePrefix="NEE";this.jc_GLID_PMetaSystemControl="PMKA3X";this.jc_GLID_PCategory="PMBA3X";this.jc_GLID_PGeoArea="PGGA3X";this.jc_GLID_PGeoRegion="PGRA3X";this.jc_GLID_PGeoCity="PGCA3X";this.jc_GLID_PGeoCountry="PGPA3X";this.jc_GLID_PGeoState="PGSA3X";this.jc_GLID_PEnterprise="PEEA3X";this.jc_GLID_PEnterprisePrefix="PEE";this.jc_GLID_FMetaSystemControl="FMKA3X";this.jc_GLID_FCategory="FMBA3X";this.jc_GLID_FGeoArea="FGGA3X";this.jc_GLID_FGeoRegion="FGRA3X";this.jc_GLID_FGeoCity="FGCA3X";this.jc_GLID_FGeoCountry="FGPA3X";this.jc_GLID_FGeoState="FGSA3X";this.jc_GLID_FSummaryEnterprises="FSEA3X";this.jc_GLID_FEnterprise="FEEA3X";this.jc_GLID_FEnterprisePrefix="FEE";this.jc_tbtype_eid={tbtname:"t3x_eid",tbtkeyname:"TEID"};this.jc_tbtype_ebis={tbtname:"t3x_ebis",tbtkeyname:"TEID"};this.jc_tbtype_ebid={tbtname:"t3x_ebid",tbtkeyname:"TEID"};this.jc_tbtype_ei={tbtname:"t3x_ei",tbtkeyname:"TEID"};this.XGlid2Mark=function(ji_s)
{if(!ji_s)
...
return"";if(!(ji_OptionConvert&&this.Get_FieldSeparator()))
{if(this.Get_FieldSeparator())
return jt_aRecord.join(this.Get_FieldSeparator());return jt_aRecord[0];}
var jr_sRecordConverted="";for(var i=0;i<jt_aRecord.length;i++)
...
{if(this.Get_FieldSeparator())
jt_aRecord=ji_sRecord.split(this.Get_FieldSeparator());else
jt_aRecord=[ji_sRecord];}
if(!(ji_id||ji_posid===null))
...
return false;this.jm_oDTStatus.SetStoreStatusInProgress();if(!ji_oDbTransaction.Get_Storage().Write3(ji_oDbTransaction,new GLData_Value(this.Get_XKey(),this.Get_Record_String(),this)))
return false;return true;}
...
function A3xaTbJSDS(ji_glidmark,ji_fieldseparator)
{if(ji_glidmark==null)
ji_glidmark=jg_oe.jc_oA3xaDbZero.jc_GLMID_JSDS;if(ji_fieldseparator==null)
ji_fieldseparator=null;GLData.call(this,ji_glidmark,ji_fieldseparator);this.Get_JSDS=function()
{var jt_aJSDSRecord=this.Get_Record_Array();return((jt_aJSDSRecord&&jt_aJSDSRecord.length>0)?jt_aJSDSRecord[0]:"");};this.Set_JSDS=function(ji_glid,ji_id,ji_jsds)
{if(!ji_jsds)
return false;return this.Set_Record_Array(ji_glid,ji_id,[ji_jsds]);};this.Get_D3xSDS=function()
{var jt_jsds=this.Get_JSDS();if(!jt_jsds)
return null;var jr_od3xsds=JSON.parse(jt_jsds,function(ji_k,ji_v)
{return ji_v;});return jr_od3xsds;};this.Set_D3xSDS=function(ji_glid,ji_id,ji_od3xsds)
{var jt_jsds="";if(ji_od3xsds)
jt_jsds=JSON.stringify(ji_od3xsds,function(ji_k,ji_v)
{return ji_v;});return this.Set_JSDS(ji_glid,ji_id,jt_jsds);};}
function GLHeader(ji_glidmark,ji_fieldseparator)
{if(ji_glidmark==null)
ji_glidmark=jg_oe.jc_oA3xaDbZero.jc_GLMID_DT;if(ji_fieldseparator==null)
ji_fieldseparator=jg_oe.jc_oA3xaDbZero.jc_GLSep_Field;GLData.call(this,ji_glidmark,ji_fieldseparator);this.Get_Release=function()
{var jt_aRecord=this.Get_Record_Array();return((jt_aRecord&&jt_aRecord.length)?jt_aRecord[0]:"");};}
...
{this.jm_oDTStatus=new GLDataStatus();this.jm_oglHeader=null;this.jm_aoglr=new A3xaArray();this.jm_aaoglrSelect=new A3xaArray();this.jm_bAX=true;this.jm_aoglrAX=null;this.jm_odb=(ji_oDatabase||null);this.jm_o3xJSDS=null;this.New3xJSDS=function(){return new A3xaTbJSDS(null,null);};this.Get_3xJSDS=function()
...
{if(!ji_o3x2tbTOC)
return false;var jt_o3xJSDS=this.New3xJSDS();if(!jt_o3xJSDS.Set_JSDS(this.Get_Glid(),null,ji_o3x2tbTOC.tb.getJSDS()))
return false;if(!this.Set_3xJSDS(jt_o3xJSDS))
return false;return true;};this.NewHeader=function(){return new GLHeader(null,null);};this.NewNames=function(){return new GLFieldNames();};this.NewRecord=function()
...
return new GLRecord();return null;};this.Get_Header=function()
{if((!this.jm_oglHeader)||(!this.jm_oglHeader.IsValid()))
return null;return this.jm_oglHeader;};this.Get_Glid=function()
{if((!this.jm_oglHeader)||(!this.jm_oglHeader.IsValid()))
return null;return this.jm_oglHeader.Get_Glid();};this.Set_Glid=function GLDataTable_Set_Glid(ji_glid)
{if(!this.jm_oglHeader)
this.jm_oglHeader=this.NewHeader();return this.jm_oglHeader.Set_Glid(ji_glid);};this.StoreToGLS=function(ji_oDbTransaction)
...
return new GLDataStatusStoreInProgress();if(!(this.jm_o3xJSDS.IsValid()&&this.jm_o3xJSDS.Get_JSDS()))
...
if(!(this.jm_oglHeader&&this.jm_oglHeader.IsValid()))
{return new GLDataStatusStoreFail();}
if(!this.jm_oglHeader.jm_oDTStatus.IsDone())
return new GLDataStatusStoreInProgress();if(this.jm_oglHeader.jm_oDTStatus.IsFail())
{return new GLDataStatusStoreFail();}
...
var jt_o3xJSDS=null;jt_o3xJSDS=this.New3xJSDS();if(!jt_o3xJSDS.LoadFromGLS(ji_oDbTransaction,ji_glid,null))
...
return new GLDataStatusLoadEmpty();return new GLDataStatusLoadSuccess();};this.Get_Release=function()
{if(!(this.jm_oglHeader&&this.jm_oglHeader.IsValid()))
return"";if(!this.jm_oglHeader.jm_oDTStatus.IsSuccessOrEmpty())
return"";return this.jm_oglHeader.Get_Release();};this.OnTransactionComplete=function(ji_oidbEvent,ji_oStorageOpType)
...
{this.jm_oDTStatus.SetLoadStatusFail();}
return true;};if(this.jm_odb&&ji_glid)
...
{var jr_I={addTablesJSDS:function(){return false;},addD3xTable:function(ji_sdsTable){return null;},get3x2Table:function(ji_glid,ji_name,ji_type){return null;},new3x2Table:function(ji_sdsTable){return null;}};jr_I.new3x2Table=function(ji_sdsTable)
{var jr_o3x2tb=A3xa2StaticDataSource_Table(ji_sdsTable);return jr_o3x2tb;};return jr_I;}
...
function A3xa2StaticDataSource_Table(ji_sdsTable)
{var jr_o={jm_sdstb:ji_sdsTable,jm_a3x2Indexes:A3xa2Array(),tb:A3xa2IStaticDataSource_Table()};jr_o.tb.setD3xTable=function(ji_sdsTable)
...
{var jr_o={jm_o3x2a:A3xa2Array(),db:A3xa2IStaticDataSource_Db()};jr_o.db.addD3xTable=function(ji_sdsTable)
{if(!ji_sdsTable)
return null;var jr_o3x2tb=jr_o.db.new3x2Table(ji_sdsTable);if(!(jr_o3x2tb&&jr_o3x2tb.tb.isValid()))
...
{var jr_I={setDataTable:function(ji_odt){return false;},enableJSDS:function(ji_b){return false;},writeTable:function(){return false;},writeJSDS:function(){return false;},writeHeader:function(){return false;},writeNames:function(){return false;},writeRecordset:function(){return false;},integrityCheck:function(){return null;}};return jr_I;}
function A3xa2IDTCacheWriterExec()
{var jr_I={checkDataSource:function(){return false;},writeJSDS:function(){return false;},writeHeader:function(){return false;},writeNames:function(){return false;},writeRecord:function(){return false;},iseof:function(){return true;},resetRecord:function(){return false;},nextRecord:function(){return false;}};return jr_I;}
function A3xa2DTCacheWriter(ji_odt,ji_odb,ji_glid)
{var jr_o={jm_odb:null,jm_glid:null,jm_bEnableJSDS:false,jm_o3xJSDS:null,jm_oglHeader:null,jm_oglFieldNames:null,jm_a3x2oglr:null,jm_odt:null,csw:A3xa2IDTCacheWriter(),_cswxec:A3xa2IDTCacheWriterExec(),_Construct:function(ji_odt,ji_odb,ji_glid)
{if(ji_glid)
...
if(!jr_o.csw.writeNames())
{if(jr_o.jm_odb)
jr_o.jm_odb.jm_oDTStatus.SetCacheStatusFail("Cache Tableset Cache "+jr_o.jm_glid);return false;}
if(!jr_o.csw.writeRecordset())
{if(jr_o.jm_odb)
jr_o.jm_odb.jm_oDTStatus.SetCacheStatusFail("Cache Tableset Cache "+jr_o.jm_glid);return false;}
...
jr_o.jm_odt.jm_o3xJSDS=jr_o.jm_o3xJSDS;jr_o.jm_odt.jm_oglHeader=jr_o.jm_oglHeader;jr_o.jm_odt.jm_aoglr=new A3xaArray(jr_o.jm_a3x2oglr);jr_o.jm_odt.jm_oDTStatus.SetFrom(jr_o.csw.integrityCheck());return(jr_o.jm_odt.jm_oDTStatus.IsSuccess());};jr_o.csw.writeJSDS=function()
...
{jr_o.jm_oglHeader=jr_o.jm_odt.NewHeader();jr_o._cswxec.writeHeader();if(jr_o.jm_oglHeader.Get_Glid()!=jr_o.jm_glid)
{jr_o.jm_odt.jm_oDTStatus.SetCacheStatusFail("Header glid");return false;}
if(!jr_o.jm_oglHeader.IsValid())
{jr_o.jm_odt.jm_oDTStatus.SetCacheStatusFail("Header");return false;}
return true;};jr_o.csw.writeNames=function()
{var jt_oglNames=jr_o.jm_odt.NewNames();jr_o._cswxec.writeNames(jt_oglNames);if(!jt_oglNames.IsValid())
{jr_o.jm_odt.jm_oDTStatus.SetCacheStatusFail("Field Names");return false;}
if(jt_oglNames.Get_Glid()!=jr_o.jm_glid)
{jr_o.jm_odt.jm_oDTStatus.SetCacheStatusFail("Field Names TBID");return false;}
var jt_sKeyName=jt_oglNames.Get_KeyName();if(!jt_sKeyName)
{jr_o.jm_odt.jm_oDTStatus.SetCacheStatusFail("Missing Key Name");return false;}
jr_o.jm_oglFieldNames=jt_oglNames;return true;};jr_o.csw.writeRecordset=function()
{jr_o.jm_a3x2oglr=A3xa2Array();var jt_oglNames=jr_o.jm_oglFieldNames;var jt_sKeyName=jt_oglNames.Get_KeyName();if(!jr_o._cswxec.resetRecord())
{jr_o.jm_odt.jm_oDTStatus.SetCacheStatusFail("no records to write");return false;}
while(!jr_o._cswxec.iseof())
{var jt_oglRecord=jr_o.jm_odt.NewRecord();if(!jt_oglRecord)
{jr_o.jm_odt.jm_oDTStatus.SetCacheStatusFail("Record null");return false;}
if(!jt_oglRecord.Set_Names(jt_oglNames))
{jr_o.jm_odt.jm_oDTStatus.SetCacheStatusFail("Set Names");return false;}
if(!jr_o._cswxec.writeRecord(jt_oglRecord))
{jr_o.jm_odt.jm_oDTStatus.SetCacheStatusFail("Write Record");return false;}
var jt_id=jt_oglRecord.Get_Id();if(!(jt_id&&jt_id.length&&jt_id!=0))
{jr_o.jm_odt.jm_oDTStatus.SetCacheStatusFail("Records Id");return false;}
jr_o.jm_a3x2oglr.ar.addItem(jt_id,jt_oglRecord);jr_o._cswxec.nextRecord();}
return true;};jr_o.csw.integrityCheck=function()
{var jt_sGlid=jr_o.jm_odt.Get_Glid();if(!jt_sGlid)
return new GLDataStatusCacheFail("Missing Table Name");if((!jr_o.jm_oglHeader)||(!jr_o.jm_oglHeader.IsValid()))
return new GLDataStatusCacheFail("Header not valid");if(!jr_o.jm_oglFieldNames)
return new GLDataStatusCacheFail("Missing Field Names");jg_oe.CanLogInfo()&&jg_oe.LogInfo("end:glid"+
jt_sGlid,"","GLDataTable_IntegrityCheck");return new GLDataStatusCacheSuccess();};jr_o._Construct(ji_odt,ji_odb,ji_glid);return jr_o;}
function A3xa2DTCacheWriter_GLRS(ji_odt,ji_odb,ji_glid,ji_sGLRS)
{var jr_o=A3xa2DTCacheWriter(ji_odt,ji_odb,ji_glid);jr_o.jm_aglRS=null;jr_o.jm_dsindex=-1;if(ji_sGLRS)
...
{if(!jr_o.jm_o3xJSDS)
return false;var jt_aFieldNames=(jr_o.jm_oglFieldNames?jr_o.jm_oglFieldNames.Get_Record_Array():null);if(!(jt_aFieldNames&&jt_aFieldNames.length>1))
...
var jt_nofRecords=(jr_o.jm_a3x2oglr?jr_o.jm_a3x2oglr.ar.getCount():0);var jt_JSDS='{"d3x_header":'+'{"d3x_glid":"'+jr_o.jm_oglHeader.Get_Glid()+'","d3x_tbtype":"'+
jg_oe.jc_oA3xaDbZero.Glid2SDSTbType(jr_o.jm_oglHeader.Get_Glid()).tbtname+'","d3x_tbname":"","d3x_version":"'+jr_o.jm_oglHeader.Get_Release()+'"},';jt_JSDS+='"d3x_names":['+jt_sFieldNames+'],';jt_JSDS+='"d3x_records":[';for(var i=0;i<jt_nofRecords;i++)
{var jt_oglRecord=jr_o.jm_a3x2oglr.ar.getItem_ByIndex(i);var jt_aRecord=(jt_oglRecord?jt_oglRecord.Get_Record_Array():null);if(jt_aRecord&&jt_aRecord.length>1)
...
jt_JSDS+=('[[""]]');}}
jt_JSDS+=']';}}
jt_JSDS+=']}';return jr_o.jm_o3xJSDS.Set_JSDS(jr_o.jm_glid,null,jt_JSDS);};jr_o._cswxec.writeHeader=function()
{return jr_o.jm_oglHeader.Set_String(jr_o.jm_aglRS[0]);};jr_o._cswxec.writeNames=function(ji_oglNames)
{return ji_oglNames.Set_String(jr_o.jm_aglRS[1]);};jr_o._cswxec.iseof=function()
{if(jr_o.jm_dsindex<0)
return true;if(jr_o.jm_dsindex>=(jr_o.jm_aglRS.length-2))
return true;return false;};jr_o._cswxec.nextRecord=function()
{if(jr_o.jm_dsindex<0)
return false;jr_o.jm_dsindex++;if(jr_o.jm_dsindex<(jr_o.jm_aglRS.length-2))
return true;jr_o.jm_dsindex=-1;return false;};jr_o._cswxec.resetRecord=function()
{if((jr_o.jm_aglRS.length-2)<=0)
{jr_o.jm_dsindex=-1;return true;}
jr_o.jm_dsindex=0;return true;};jr_o._cswxec.writeRecord=function(ji_oglRecord)
{if(jr_o.jm_dsindex<0)
return false;var jt_posid=0;return ji_oglRecord.Set_XString(jr_o.jm_glid,null,jt_posid,jr_o.jm_aglRS[jr_o.jm_dsindex+2]);};return jr_o;}
function A3xa2DTCacheWriter_sds(ji_odt,ji_odb,ji_glid,ji_o3xdbsds,ji_keyname)
{var jr_o=A3xa2DTCacheWriter(ji_odt,ji_odb,ji_glid);jr_o.jm_o3x2tbe=null;jr_o.jm_dsindex=-1;jr_o.jm_dscount=0;jr_o.jm_dskeyname=(ji_keyname||"");jr_o.jm_o3xdbsds=ji_o3xdbsds;jr_o._cswxec.checkDataSource=function(){return!!jr_o.jm_o3x2tbe;};jr_o._cswxec.writeJSDS=function()
{if(!(jr_o.jm_o3x2tbe&&jr_o.jm_o3x2tbe.tb.getD3xTable()))
return false;if(!jr_o.jm_o3xJSDS)
return false;return jr_o.jm_o3xJSDS.Set_D3xSDS(jr_o.jm_glid,null,jr_o.jm_o3x2tbe.tb.getD3xTable());};jr_o._cswxec.writeHeader=function()
{var jt_version=(jr_o.jm_o3x2tbe?jr_o.jm_o3x2tbe.tb.getVersion():"");return jr_o.jm_oglHeader.Set_Record_Array(jr_o.jm_glid,null,[jt_version||""]);};jr_o._cswxec.writeNames=function(ji_oglNames)
{if(!(ji_oglNames&&jr_o.jm_o3x2tbe))
return false;if(!jr_o.jm_dskeyname)
return false;var jt_aFieldNames=jr_o.jm_o3x2tbe.tb.getFieldNames();if(!jt_aFieldNames)
return false;return ji_oglNames.Set_Record_Array(jr_o.jm_glid,null,[jr_o.jm_dskeyname].concat(jt_aFieldNames));};jr_o._cswxec.iseof=function()
{if(jr_o.jm_dsindex<0)
return true;if(jr_o.jm_dscount<=0)
{if(jr_o.jm_o3x2tbe)
jr_o.jm_dscount=jr_o.jm_o3x2tbe.tb.getCountOfRecords();}
if(jr_o.jm_dsindex>=jr_o.jm_dscount)
return true;return false;};jr_o._cswxec.nextRecord=function()
{if(jr_o._cswxec.iseof())
return false;jr_o.jm_dsindex++;if(jr_o.jm_dsindex<jr_o.jm_dscount)
return true;jr_o.jm_dsindex=-1;return false;};jr_o._cswxec.resetRecord=function()
{if(jr_o.jm_dscount<=0)
{if(jr_o.jm_o3x2tbe)
jr_o.jm_dscount=jr_o.jm_o3x2tbe.tb.getCountOfRecords();if(jr_o.jm_dscount<=0)
{jr_o.jm_dsindex=-1;return true;}}
jr_o.jm_dsindex=0;return true;};jr_o._cswxec.writeRecord=function(ji_oglRecord)
{if(jr_o.jm_dsindex<0)
return false;if(!(ji_oglRecord&&jr_o.jm_o3x2tbe&&jr_o.jm_glid))
return false;if(!jr_o.jm_dskeyname)
return false;var jt_oInfoRecord=jr_o.jm_o3x2tbe.tb.getFields2(jr_o.jm_dsindex,jr_o.jm_dskeyname);if(!(jt_oInfoRecord&&jt_oInfoRecord.key&&jt_oInfoRecord.fields))
return false;var jt_akrec=[jt_oInfoRecord.key].concat(jt_oInfoRecord.fields||[]);return ji_oglRecord.Set_Record_Array(jr_o.jm_glid,jt_oInfoRecord.key,ji_oglRecord.ConvertSpecialChars(jt_akrec));};if(jr_o.jm_odb&&jr_o.jm_o3xdbsds&&jr_o.jm_glid)
...
{return jg_oe.Get_Storage(ji_StorageType);};this.LoadSchema=function(){return true;};this.jm_o3x2sdsdb_Store=null;this.Set_SDSDBStore=function(ji_o3x2sdsdb){this.jm_o3x2sdsdb_Store=ji_o3x2sdsdb;return true;};this.Get_SDSDBStore=function(){return this.jm_o3x2sdsdb_Store;};this.jm_o3x2sdsdb_Work=null;this.Set_SDSDBWork=function(ji_o3x2sdsdb){this.jm_o3x2sdsdb_Work=ji_o3x2sdsdb;return true;};this.Get_SDSDBWork=function(){return this.jm_o3x2sdsdb_Work;};this.jm_oDbSchema=(ji_oDbSchema||null);this.jm_oDTStatus=new GLDataStatusCache();this.jm_moreOnStoreAllData=0;this.jm_aoDTStatus_TableToClear=null;this.jm_aoglDataTableStore=new A3xaArray();this.jm_aoglDataTableLoad_TOC=new A3xaArray();this.jm_aoglDataTableLoad_Common=new A3xaArray();this.jm_aoglDataTableLoad_Main=new A3xaArray();this.jm_odbTransaction=null;this.ClearArrayDTLoad=function(ji_pTypTables)
{if(!ji_pTypTables)
...
{return new GLDataTable(this,ji_glid);};this.NewDataTable=function(ji_glid){return null;};this.Get_MainDataTable=function(ji_A,ji_Z,ji_N){return null;};this.Get_DataTable=function(ji_glid,ji_bDontCheck,ji_bTurboHeader)
...
{this.LoadSchema();var jt_os1=jg_oe.Get_Storage(jg_oe.jc_oStorage.jc_FLY);if(!jt_os1)
...
{jt_odt=this.jm_odb.Get_DataTable(jt_glid,true,false);}
if(jt_odt)
jt_odt.OnTransactionComplete(ji_oidbEvent,ji_odbtr.jm_oStorageOpType);}}
...
{for(var i=0;i<ji_odbtr.jm_aDbTableName.length;i++)
{var jt_odt=null;var jt_glid=ji_odbtr.jm_aDbTableName[i];if(jg_oe.jc_oA3xaDbZero.IsGlidTOC(jt_glid))
jt_odt=this.jm_odb.Get_TOC();else
jt_odt=this.jm_odb.Get_DataTableCacheStore(jt_glid);if(jt_odt)
...
{var jt_oD3xsds=this.jm_odtToLoad.Get_3xJSDS().Get_D3xSDS();if(this.jm_oDatabase.Get_SDSDBWork().db.addD3xTable(jt_oD3xsds))
...
if(this.IsOpening()||(this.jm_otktbLoader&&(this.jm_otktbLoader.IsSuccess()||this.jm_otktbLoader.IsEmpty()||(this.jm_otktbLoader.IsFail()))))
...
{if(ji_bLoadOnly)
return this.LoadData();this.DatabaseLoadTOC();return true;};this.DatabaseLoadTOC=function()
...
{this.jm_oDatabase.jm_oDTStatus.jm_fnOnChange=function(ji_oDTStatus)
{if(ji_bStoreSuccess&&ji_oDTStatus.IsSuccessOrEmpty())
...
{if(ji_oDTStatus.IsFail())
{ji_oDTStatus.SetLoadStatusEmpty();if(jt_this.jm_fnOnLoadDone)
jt_this.jm_fnOnLoadDone(ji_oDTStatus);return true;}
if(ji_oDTStatus.IsOpLoad()&&ji_oDTStatus.IsSuccessOrEmpty())
...
{if(!ji_sep)
ji_sep=",";if(!ji_s)
return false;return this.Set_Array(ji_s.split(ji_sep),0)>=0?true:false;};this.Set_CompactCode=function(ji_scc)
{if(!ji_scc)
...
var jt_a=null;var jt_z=null;var jt_n=null;var jt_c=null;jt_a=ji_scc.charAt(jt_cursor++);if(jt_cursor<jt_lencc)
...
return false;}}}
if(!jt_a||jt_a=="0"){jt_a=null;jt_z=null;jt_n=null;jt_c=null;}
else if(!jt_z||jt_z=="0"){jt_z=null;jt_n=null;jt_c=null;}
else if(!jt_n||jt_n=="0"){jt_n=null;jt_c=null;}
else if(!jt_c||jt_c=="0"){jt_c=null;}
if(jt_cursor<jt_lencc)
{var jt_markps=ji_scc.charAt(jt_cursor++);if(jt_markps!="0")
return false;}
if(jt_cursor>=jt_lencc)
{this.Set_GEID(jt_te,jt_ide,jt_tg,jt_idg);this.Get_3xAZNC().Set_AZNC(jt_a,jt_z,jt_n,jt_c);return true;}
...
return false;}
if(jt_cursor>=jt_lencc)
{this.Set_GEID(jt_te,jt_ide,jt_tg,jt_idg);this.Get_3xAZNC().Set_AZNC(jt_a,jt_z,jt_n,jt_c);this.Get_3xPS().Set_PS(jt_p,jt_s);return true;}
...
if(jt_cursor!=jt_lencc)
return false;this.Set_GEID(jt_te,jt_ide,jt_tg,jt_idg);this.Get_3xAZNC().Set_AZNC(jt_a,jt_z,jt_n,jt_c);this.Get_3xPS().Set_PS(jt_p,jt_s);this.Get_3xCat().Set_Category(jt_ucat,jt_vcat);return true;};this.Set_Array=function(ji_a,ji_offset)
{if(!ji_a||ji_offset<0||ji_offset>=ji_a.length)
...
{var jr_I={};return jr_I;}
function A3xa2StaticDataSource_TableEntity(ji_sdsTable)
{var jr_o=A3xa2StaticDataSource_Table(ji_sdsTable);jr_o.tb._tbeparent_buildTableIndex=jr_o.tb.buildTableIndex;jr_o.tb.buildTableIndexes=function()
...
{var jr_o=A3xa2StaticDataSource_Db();jr_o.db.new3x2Table=function(ji_sdsTable){return A3xa2StaticDataSource_TableEntity(ji_sdsTable);};jr_o.db.addTablesJSDS=function(ji_pTypTables)
...
function A3xaDbZero()
{A3xaDatabase.call(this,new A3xaDbSchema(jg_oe.jc_oA3xaDbZero.jc_sDbName,jg_oe.jc_oA3xaDbZero.jc_DbVersion,jg_oe.jc_oA3xaDbZero.jc_sDbDefaultPrimaryKeyName,jg_oe.jc_oA3xaDbZero.jc_aSchemaTables));this.Set_SDSDBStore(A3xa2SDS_DbEntity());this.Set_SDSDBWork(A3xa2SDS_DbEntity());this.GLID2Typ=function(ji_GLID)
...
return null;return jr_odt;};this.LoadSchema=function()
{return this.LoadSchemaExtended(this.Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoRegion,true)||this.Get_DataTableCacheStore(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoRegion));}
...
return false;var jt_pFTableSource=this.jm_oDbSchema.Get_Table_ByName(jg_oe.jc_oA3xaDbZero.jc_GLID_FEnterprise);if(!jt_pFTableSource);var jt_aTablesAppend=[];var jt_aPTablesAppend=[];var jt_aNTablesAppend=[];var jt_aFTablesAppend=[];for(var i=0;i<jt_CountRecords;i++)
{var jt_oglr=ji_odtRegion.Get_Recordset().Get_Item_ByIndex(i);if(!jt_oglr)
continue;var jt_N=jt_oglr.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eidf_n);if(!jt_N)
continue;var jt_A=jt_oglr.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eidf_a);var jt_Z=jt_oglr.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eidf_z);var jt_pTableSchema={};jQuery.extend(jt_pTableSchema,jt_pTableSource);jt_pTableSchema.jp_sName=jg_oe.jc_oA3xaDbZero.MakeGlid(jg_oe.jc_oA3xaDbZero.jc_GLID_EnterprisePrefix,jt_A+jt_Z+jt_N);jt_pTableSchema.jp_bTyp_Common=false;jt_pTableSchema.jp_bTyp_Main=false;jt_pTableSchema.jp_bTyp_TOC=false;jt_pTableSchema.jp_bMandatory=false;jt_aTablesAppend.push(jt_pTableSchema);var jt_pPTableSchema={};jQuery.extend(jt_pPTableSchema,jt_pPTableSource);jt_pPTableSchema.jp_sName=jg_oe.jc_oA3xaDbZero.MakeGlid(jg_oe.jc_oA3xaDbZero.jc_GLID_PEnterprisePrefix,jt_A+jt_Z+jt_N);jt_pPTableSchema.jp_sParent=jg_oe.jc_oA3xaDbZero.MakeGlid(jg_oe.jc_oA3xaDbZero.jc_GLID_EnterprisePrefix,jt_A+jt_Z+jt_N);jt_pPTableSchema.jp_bTyp_Common=false;jt_pPTableSchema.jp_bTyp_Main=false;jt_pPTableSchema.jp_bTyp_TOC=false;jt_pPTableSchema.jp_bMandatory=false;jt_aPTablesAppend.push(jt_pPTableSchema);var jt_pNTableSchema={};jQuery.extend(jt_pNTableSchema,jt_pNTableSource);jt_pNTableSchema.jp_sName=jg_oe.jc_oA3xaDbZero.MakeGlid(jg_oe.jc_oA3xaDbZero.jc_GLID_NEnterprisePrefix,jt_A+jt_Z+jt_N);jt_pNTableSchema.jp_sParent=jg_oe.jc_oA3xaDbZero.MakeGlid(jg_oe.jc_oA3xaDbZero.jc_GLID_EnterprisePrefix,jt_A+jt_Z+jt_N);jt_pNTableSchema.jp_bTyp_Common=false;jt_pNTableSchema.jp_bTyp_Main=false;jt_pNTableSchema.jp_bTyp_TOC=false;jt_pNTableSchema.jp_bMandatory=false;jt_aNTablesAppend.push(jt_pNTableSchema);var jt_pFTableSchema={};jQuery.extend(jt_pFTableSchema,jt_pFTableSource);jt_pFTableSchema.jp_sName=jg_oe.jc_oA3xaDbZero.MakeGlid(jg_oe.jc_oA3xaDbZero.jc_GLID_FEnterprisePrefix,jt_A+jt_Z+jt_N);jt_pFTableSchema.jp_sParent=jg_oe.jc_oA3xaDbZero.MakeGlid(jg_oe.jc_oA3xaDbZero.jc_GLID_EnterprisePrefix,jt_A+jt_Z+jt_N);jt_pFTableSchema.jp_bTyp_Common=false;jt_pFTableSchema.jp_bTyp_Main=false;jt_pFTableSchema.jp_bTyp_TOC=false;jt_pFTableSchema.jp_bMandatory=false;jt_aFTablesAppend.push(jt_pFTableSchema);}
...
New_A3xaAZNC_XApp(jt_o3xxeidxur.Get_3xAZNC()).Set_LA();jr_oglrMSC=jt_ogldtMSC.Get_GLRecordAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));if(jr_oglrMSC)
...
{jt_o3xxeidxur.Get_3xAZNC().Clear_C();jr_oglrMSC=jt_ogldtMSC.Get_GLRecordAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));if(jr_oglrMSC)
return jr_oglrMSC;}
if(jt_o3xxeidxur.Get_3xAZNC().Get_Z())
{jt_o3xxeidxur.Get_3xAZNC().Clear_NC();jr_oglrMSC=jt_ogldtMSC.Get_GLRecordAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));if(jr_oglrMSC)
return jr_oglrMSC;}
New_A3xaAZNC_XApp(jt_o3xxeidxur.Get_3xAZNC()).Set_LA();jr_oglrMSC=jt_ogldtMSC.Get_GLRecordAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));if(jr_oglrMSC)
return jr_oglrMSC;jt_o3xxeidxur.Get_3xAZNC().Clear();jr_oglrMSC=jt_ogldtMSC.Get_GLRecordAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));return jr_oglrMSC;};}
...
{return new GLREI();}
return null;};this.SetupLoadedRecords=function(ji_ogldtParent)
{var jt_odb=this.Get_Database();var jt_glid=this.Get_Glid();var jt_oSchemaTable=jt_odb.jm_oDbSchema.Get_Table_ByName(jt_glid);var jt_oa3xRecordset=this.Get_Recordset();var jt_aoglrAX=new A3xaArray();var jt_nRecords=(jt_oa3xRecordset?jt_oa3xRecordset.Get_Count():0);if(this.jm_bAX)
...
{if(!ji_sField)
return ji_sField;return ji_sField.replace(/__at2__/g,"@").replace(/&#40;/g,"(").replace(/&#41;/g,")").replace(/&apos;/g,"'");};this.ConvertSpecialChars_Field=function(jio_aRecord,ji_sFieldName)
...
return false;jio_aRecord[jt_pos]=this.ConvertSpecialChars_Field2(jio_aRecord[jt_pos]);return true;};this.ConvertSpecialChars=function(ji_aRecord)
{if(!ji_aRecord)
return ji_aRecord;if(!this.jm_oglFieldNames)
return ji_aRecord;this.ConvertSpecialChars_Field(ji_aRecord,jg_oe.jc_oA3xaDbZero.jc_ebisf_name);this.ConvertSpecialChars_Field(ji_aRecord,jg_oe.jc_oA3xaDbZero.jc_ebisf_descr);this.ConvertSpecialChars_Field(ji_aRecord,jg_oe.jc_oA3xaDbZero.jc_ebisf_url);return ji_aRecord;};}
function GLREBID()
...
{var jt_o3xaznc=ji_oxeid.Get_3xXEID().Get_3xAZNC();var jt_A=jt_o3xaznc.Get_A();var jt_Z=jt_o3xaznc.Get_Z();var jt_N=jt_o3xaznc.Get_N();var jt_C=jt_o3xaznc.Get_C();if(ji_bSub&&!ji_bTop)
{if(!jt_N)
...
var jr_siXeid=new A3xaXEID();jr_siXeid.Get_3xAZNC().Set_AZNC(jt_A,jt_Z,jt_N,jt_C);return jr_siXeid;};this._MakeKeyCategory=function(ji_oxeid,ji_bSub)
...
{jr_b=this._MakeSummaryGlobalEnterprises(ji_oxeid);if(jr_b&&ji_oxeid.Get_3xAZNC().Get_N())
...
return false;jt_o3xaitDTSummary.Reset();var jt_Select_A=ji_oxeid.Get_3xAZNC().Get_A();var jt_Select_Z=ji_oxeid.Get_3xAZNC().Get_Z();var jt_Select_N=ji_oxeid.Get_3xAZNC().Get_N();var jt_Select_Ucat=ji_oxeid.Get_3xCat().Get_Ucat();var jt_Select_Vcat=ji_oxeid.Get_3xCat().Get_Vcat();this.jm_o3xSummaryByLandAll=new A3xaSummaryInfoItem();this.jm_o3xaSummaryByTopArea=new A3xaArray();this.jm_o3xaSummaryByArea=new A3xaArray();this.jm_o3xaSummaryByRegion=new A3xaArray();this.jm_o3xaSummaryByCity=new A3xaArray();this.jm_o3xSummaryByCatAll=new A3xaSummaryInfoItem();this.jm_o3xaSummaryByCatGroup=new A3xaArray();this.jm_o3xaSummaryByCat=new A3xaArray();jt_o3xaitDTSummary.jm_o3x2.ar.foreachItem(function(ji_o3xe,ji_ix,ji_key)
{var jt_o3xe=ji_o3xe;var jt_A=jt_o3xe.Get_3xXEID().Get_3xAZNC().Get_A();var jt_Z=jt_o3xe.Get_3xXEID().Get_3xAZNC().Get_Z();var jt_N=jt_o3xe.Get_3xXEID().Get_3xAZNC().Get_N();var jt_Ucat=jt_o3xe.Get_3xXEID().Get_3xCat().Get_Ucat();var jt_Vcat=jt_o3xe.Get_3xXEID().Get_3xCat().Get_Vcat();if(!jt_Select_Ucat||(jt_Ucat==jt_Select_Ucat&&(!jt_Select_Vcat||(jt_Vcat==jt_Select_Vcat))))
...
{var jt_oxur=this._MakeXUR(ji_odc);this.Set_Value((jt_oxur?"p3x="+jt_oxur.Get_XURString():"")+(ji_s?"#"+ji_s:""));return true;};this.Add_CategoryGroup=function(ji_ocg)
...
{jt_oddigNew.Set_Descr(New_A3xaAZNC_XApp(jt_odceg.Get_3xXEID()).TopAreaToName2());jt_oddig=jt_oddigNew;if(ji_ocg.o3xsii)
...
return false;jt_oddirNew.Set_Descr(ji_ocg.o3xe.Get_LName());this.Add_Child(jt_oddirNew);var jt_pisdsRecord_glidtoc=null;if(jt_odcer.Get_3xXEID().Get_3xAZNC().Get_N())
{var jt_glidtoc=jg_oe.jc_oA3xaDbZero.MakeGlid(jg_oe.jc_oA3xaDbZero.jc_GLID_EnterprisePrefix,jt_odcer.Get_3xXEID().Get_3xAZNC().Get_A()+
jt_odcer.Get_3xXEID().Get_3xAZNC().Get_Z()+
jt_odcer.Get_3xXEID().Get_3xAZNC().Get_N());jt_pisdsRecord_glidtoc=jg_oApp.Get_Database().Get_TOCItem(jt_glidtoc);}
jt_oddirNew.jm_bHighlight=(jt_pisdsRecord_glidtoc?true:false);var jt_odtExtH=null;if(jt_odcer.Get_3xXEID().Get_3xAZNC().Get_N())
jt_odtExtH=jg_oApp.Get_Database().Get_MainDataTable(jt_odcer.Get_3xXEID().Get_3xAZNC().Get_A(),jt_odcer.Get_3xXEID().Get_3xAZNC().Get_Z(),jt_odcer.Get_3xXEID().Get_3xAZNC().Get_N());if(ji_ocg.o3xsii)
...
return false;jt_oddirNew.Set_Descr(ji_ocg.o3xe.Get_LName());jt_oddig.Add_Child(jt_oddirNew);var jt_pisdsRecord_glidtoc=null;if(jt_odcer.Get_3xXEID().Get_3xAZNC().Get_N())
{var jt_glidtoc=jg_oe.jc_oA3xaDbZero.MakeGlid(jg_oe.jc_oA3xaDbZero.jc_GLID_EnterprisePrefix,jt_odcer.Get_3xXEID().Get_3xAZNC().Get_A()+
jt_odcer.Get_3xXEID().Get_3xAZNC().Get_Z()+
jt_odcer.Get_3xXEID().Get_3xAZNC().Get_N());jt_pisdsRecord_glidtoc=jg_oApp.Get_Database().Get_TOCItem(jt_glidtoc);}
jt_oddirNew.jm_bHighlight=(jt_pisdsRecord_glidtoc?true:false);var jt_odtExtH=null;if(jt_odcer.Get_3xXEID().Get_3xAZNC().Get_N())
...
(jt_oglrCity?jt_oglrCity.Get_LName():""),"","A3xaMgrLand_RequestArea.LoadDataDD");var jt_A=jt_oglrCity.Get_3xXEID().Get_3xAZNC().Get_A();var jt_Z=jt_oglrCity.Get_3xXEID().Get_3xAZNC().Get_Z();var jt_N=jt_oglrCity.Get_3xXEID().Get_3xAZNC().Get_N();if(!(jt_A&&jt_Z))
continue;if(jt_A!=jt_oxeidCurrent.Get_3xXEID().Get_3xAZNC().Get_A())
continue;if(jt_Z!=jt_oxeidCurrent.Get_3xXEID().Get_3xAZNC().Get_Z())
continue;var jt_bSelectedRegion=false;if(jt_N==jt_oxeidCurrent.Get_3xXEID().Get_3xAZNC().Get_N())
