function A3xa2IEnvironmentVariables()
...
jg_oe.CanLogInfo()&&jg_oe.LogInfo("w2sb:"+ji_o3xsText.Get_LString(),"","A3xaAbsEnvironment.LogStatusBar");if(!this._ExecLogStatusBar2(ji_o3xsText,ji_bAsChild,ji_bClear));return true;};this._ExecLogStatusBar2=function(ji_o3xsText,ji_bAsChild,ji_bClear){return false;};this.jm_o3x2Envars=A3xa2EnvironmentVariables();this.Set_CommonValues=function(ji_bDDAJOO,ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_IdUser,ji_sDirBase,ji_sHomeDir,ji_sLang)
{return this.A3xaAbsEnvironment_Set_CommonValues(ji_bDDAJOO,ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_IdUser,ji_sDirBase,ji_sHomeDir,ji_sLang);}
this.A3xaAbsEnvironment_Set_CommonValues=function(ji_bDDAJOO,ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_IdUser,ji_sDirBase,ji_sHomeDir,ji_sLang)
{this.jm_bDDAJOO=(ji_bDDAJOO?true:false);this.jm_bDebug=(ji_bDebug==true);this.jm_bCanEdit=ji_bCanEdit;this.jm_bCanLike=ji_bCanLike;this.jm_IdUser=ji_IdUser;this.jm_sDirBase=(ji_sDirBase?ji_sDirBase:"/");this.jm_sHomeDir=(ji_sHomeDir?ji_sHomeDir:"/");this.jm_sLang=(ji_sLang?ji_sLang:"en");return true;};this.CheckInitDone=function(){return true;};this.jm_oAjax2=new A3xaAjax2();this.jm_oMgrStorage=null;this.Get_MgrStorage=function(){return this.jm_oMgrStorage;};this.jm_odb=null;this.Set_Database=function(ji_odb){this.jm_odb=ji_odb;return true;};this.Get_Database=function(){return this.jm_odb;};this.jm_oHostReporter=null;this.Set_Reporter=function(ji_oHostReporter)
...
{var jr_I={getObject:function(){return null;},set3x2Array:function(ji_o3x2a_Target,ji_IArray_Target){false;},getTargetIArray:function(){return null;},selectItems:function(ji_fnSelect,ji_MaxItems){return true;},getIndex:function(){return-1;},resetIndex:function(){return false;},getCurrentKey:function(){return null;},getCurrentItem:function(){return null;},next:function(){return false;},iseof:function(){return true;}};return jr_I;}
function A3xa2Array()
{var jr_o={jm_aa:{},jm_ax:[],ar:A3xa2IArray(),getIArray:function(){return jr_o.ar;}};jr_o.ar.getObject=function(){return jr_o;};jr_o.ar.clear=function(){jr_o.jm_ax=[];jr_o.jm_aa={};return true;};jr_o.ar.getCount=function(){return(jr_o.jm_ax&&jr_o.jm_aa)?jr_o.jm_ax.length:0;};jr_o.ar.setItem=function(ji_key,ji_value)
{if(!ji_key)
...
return-1;return 1;}
return ji_fnCompare(jr_o.jm_aa[ji_key_a]||null,jr_o.jm_aa[ji_key_b]||null);});return true;};jr_o.ar.getArray=function(ji_fnFilter)
...
jr_a.push(jt_item);}
return jr_a;};return jr_o;}
function A3xa2ArrayIt(ji_o3x2a_Target,ji_IArray_Target)
{var jr_o={jm_o3x2a:null,jm_IArray:null,jm_ix:-1,jm_o3xf:null,ar:A3xa2IArray(),getIArray:function(){return jr_o.ar;},arit:A3xa2IArrayIt(),getIArrayIt:function(){return jr_o.arit;},_Construct:function(ji_o3x2a_Target,ji_IArray_Target)
{jr_o.arit.set3x2Array(ji_o3x2a_Target,ji_IArray_Target);}};jr_o.ar.getObject=function(){return jr_o;};jr_o.arit.getObject=function(){return jr_o;};jr_o.arit.getTargetIArray=function()
{return jr_o.jm_IArray?jr_o.jm_IArray:(jr_o.jm_o3x2a?jr_o.jm_o3x2a.getIArray():null);};jr_o.ar.getCount=function()
{if(!jr_o.arit.getTargetIArray())
return 0;if(!jr_o.jm_o3xf)
return jr_o.arit.getTargetIArray().getCount();return jr_o.jm_o3xf.ar.getCount();};jr_o.ar.setItem=function(ji_key,ji_value)
{if(!jr_o.arit.getTargetIArray())
...
return jr_o.arit.getTargetIArray().getItem(ji_key);if(jr_o.jm_o3xf.ar.getItem(ji_key))
return jr_o.arit.getTargetIArray().getItem(ji_key);return null;};jr_o.ar.getKey=function(ji_ix)
{if(!jr_o.arit.getTargetIArray())
return null;if(!jr_o.jm_o3xf)
return jr_o.arit.getTargetIArray().getKey(ji_ix);return jr_o.jm_o3xf.ar.getKey(ji_ix);};jr_o.ar.getItem_ByIndex=function(ji_ix)
{if(!jr_o.arit.getTargetIArray())
return null;if(!jr_o.jm_o3xf)
return jr_o.arit.getTargetIArray().getItem_ByIndex(ji_ix);return jr_o.arit.getTargetIArray().getItem(jr_o.jm_o3xf.ar.getKey(ji_ix));};jr_o.ar.foreachItem=function(ji_fnDo)
{if(!jr_o.arit.getTargetIArray())
return null;if(!jr_o.jm_o3xf)
...
{if(!jr_o.arit.getTargetIArray())
return null;if(!jr_o.jm_o3xf)
return jr_o.arit.getTargetIArray().findItem(ji_fnCheck);var jt_c=jr_o.jm_o3xf.ar.getCount();if(!(jt_c>0))
return null;for(var ix=0;ix<jt_c;ix++)
{var jr_v=jr_o.arit.getTargetIArray().getItem(jr_o.jm_o3xf.ar.getKey(ix));if(jr_v&&ji_fnCheck(jr_v))
return jr_v;}
return null;};jr_o.ar.sortItems=function(ji_fnCompare)
{if(!jr_o.arit.getTargetIArray())
return false;if(!jr_o.jm_o3xf)
return jr_o.arit.getTargetIArray().sortItems(ji_fnCompare);jr_o.jm_o3xf.jm_ax.sort(function(ji_key_a,ji_key_b)
{if(!ji_fnCompare)
{if(ji_key_a<ji_key_b)
return-1;return 1;}
return ji_fnCompare(jr_o.arit.getTargetIArray().getItem(ji_key_a),jr_o.arit.getTargetIArray().getItem(ji_key_b));});return true;};jr_o.arit.getCurrentKey=function(){return jr_o.ar.getKey(jr_o.arit.getIndex());};jr_o.arit.getCurrentItem=function(){return jr_o.ar.getItem(jr_o.arit.getCurrentKey());};jr_o.arit.next=function(){return false;};jr_o.arit.iseof=function()
{var jt_ix=jr_o.arit.getIndex();return(jt_ix<0||jt_ix>=jr_o.ar.getCount());};jr_o.arit.set3x2Array=function(ji_o3x2a,ji_IArray_Target)
{jr_o.jm_o3x2a=(ji_o3x2a||null);jr_o.jm_IArray=(ji_IArray_Target||null);return jr_o.arit.resetIndex();};jr_o.arit.selectItems=function(ji_fnSelect,ji_MaxItems)
...
jr_sh+="</div>";return jr_sh;};jr_o._getHtmlBody=function(){return"";};jr_o._getHtml=function(){return jr_o._getHtmlHeader()+jr_o._getHtmlBody()+jr_o._getHtmlFooter();};return jr_o;}
function A3xa2IHtmEditBox()
...
jr_o.hb.setSizeChars(11,11);return jr_o;}
function A3xa2IHtmSelectBox()
...
{if(jg_oe.jm_bDDAJOO)
{var jt_xmlParser=new DOMParser();ji_responseXML=jt_xmlParser.parseFromString(ji_sResponseText,"text/xml");}
else
...
{var jt_oxml=new A3xaAjaxResponse2(null,jt_this.jm_oAjaXHR.responseText);var jt_sA3xaDebug=jt_oxml.Get_ItemValue("A3xaDebug");jg_oe.LogInfo("jt_this.jm_oAjaXHR.responseText="+
...
{this.jc_GLSep_Block="__glk__";this.jc_GLSep_Header="__glv__";this.jc_GLSep_Field="__glf__";this.jc_GLSep_FieldArray="__glr__";this.jc_GLSep_Compact="~";this.jc_GLIDPREFIXLEN=3;this.jc_GLIDSUFFIXLEN=4;this.jc_GLIDLEN=7;this.jc_GLID_All="ALLA3X0";this.jc_GLIDSUFFIXDEFAULT="A3X0";this.jc_GLID_TOC="TMTA3X0";this.jc_tbtype_tid={tbtname:"t3x_tid",tbtkeyname:"TTID"};this.jc_tidf_tid="f3x_tid";this.jc_GLID_MetaSystemControl="RMKA3X0";this.jc_GLID_Category="RMBA3X0";this.jc_GLID_GeoTopArea="RGAA3X0";this.jc_GLID_GeoArea="RGGA3X0";this.jc_GLID_GeoRegion="RGRA3X0";this.jc_GLID_GeoMicroRegion="RGMA3X0";this.jc_GLID_GeoCity="RGCA3X0";this.jc_GLID_GeoCountry="RGPA3X0";this.jc_GLID_GeoState="RGSA3X0";this.jc_GLID_SummaryEnterprises="RSEA3X0";this.jc_GLID_Enterprise="REEA3X0";this.jc_GLID_EnterprisePrefix="REE";this.jc_GLID_NMetaSystemControl="NMKA3X0";this.jc_GLID_NCategory="NMBA3X0";this.jc_GLID_NGeoTopArea="NGAA3X0";this.jc_GLID_NGeoArea="NGGA3X0";this.jc_GLID_NGeoRegion="NGRA3X0";this.jc_GLID_NGeoMicroRegion="NGMA3X0";this.jc_GLID_NGeoCity="NGCA3X0";this.jc_GLID_NGeoCountry="NGPA3X0";this.jc_GLID_NGeoState="NGSA3X0";this.jc_GLID_NEnterprise="NEEA3X0";this.jc_GLID_NEnterprisePrefix="NEE";this.jc_GLID_PMetaSystemControl="PMKA3X0";this.jc_GLID_PCategory="PMBA3X0";this.jc_GLID_PGeoTopArea="PGAA3X0";this.jc_GLID_PGeoArea="PGGA3X0";this.jc_GLID_PGeoRegion="PGRA3X0";this.jc_GLID_PGeoMicroRegion="PGMA3X0";this.jc_GLID_PGeoCity="PGCA3X0";this.jc_GLID_PGeoCountry="PGPA3X0";this.jc_GLID_PGeoState="PGSA3X0";this.jc_GLID_PEnterprise="PEEA3X0";this.jc_GLID_PEnterprisePrefix="PEE";this.jc_GLID_FMetaSystemControl="FMKA3X0";this.jc_GLID_FCategory="FMBA3X0";this.jc_GLID_FGeoTopArea="FGAA3X0";this.jc_GLID_FGeoArea="FGGA3X0";this.jc_GLID_FGeoRegion="FGRA3X0";this.jc_GLID_FGeoMicroRegion="FGMA3X0";this.jc_GLID_FGeoCity="FGCA3X0";this.jc_GLID_FGeoCountry="FGPA3X0";this.jc_GLID_FGeoState="FGSA3X0";this.jc_GLID_FSummaryEnterprises="FSEA3X0";this.jc_GLID_FEnterprise="FEEA3X0";this.jc_GLID_FEnterprisePrefix="FEE";this.jc_tbtype_eid={tbtname:"t3x_eid",tbtkeyname:"TEID",leadch:"R"};this.jc_tbtype_ebis={tbtname:"t3x_ebis",tbtkeyname:"TEID",leadch:"P"};this.jc_tbtype_ebid={tbtname:"t3x_ebid",tbtkeyname:"TEID",leadch:"N"};this.jc_tbtype_ei={tbtname:"t3x_ei",tbtkeyname:"TEID",leadch:"F"};this.CheckGlid=function(ji_s)
{if(!ji_s)
return false;if(ji_s.length!=this.jc_GLIDLEN)
return false;return true;};this.MakeGlid=function(ji_sPrefix,ji_sExtension)
{if(!ji_sPrefix)
return null;if(ji_sPrefix.length!=this.jc_GLIDPREFIXLEN)
return null;if(!ji_sExtension)
ji_sExtension="A3X0";if(ji_sExtension.length!=this.jc_GLIDSUFFIXLEN)
return null;return ji_sPrefix+ji_sExtension;};this.MakeGlid_ByType=function(ji_glid,ji_tbtype)
{if(!(ji_glid&&ji_tbtype))
return null;if(ji_glid.length!=this.jc_GLIDLEN)
return null;return ji_tbtype.leadch+ji_glid.substr(1,this.jc_GLIDLEN-1)};this.IsDefaultGlid=function(ji_s)
...
return this.jc_tbtype_tid;var jt_c=ji_glid.charAt(0);if(jt_c==this.jc_tbtype_eid.leadch)
return this.jc_tbtype_eid;if(jt_c==this.jc_tbtype_ebis.leadch)
return this.jc_tbtype_ebis;if(jt_c==this.jc_tbtype_ebid.leadch)
return this.jc_tbtype_ebid;if(jt_c==this.jc_tbtype_ei.leadch)
...
return true;var jt_c=jt_gliddflt.charAt(0);if(jt_c==ji_tbtype.leadch&&ji_tbtype.tbtname==this.jc_tbtype_eid.tbtname)
...
return true;return false;};this.jc_sEifaName="f3x_ei";this.jc_Eifa_Typ=0;this.jc_Eifa_Cod=1;this.jc_Eifa_Id=2;this.jc_Eifa_IdParent=3;this.jc_Eifa_Info=4;this.jc_EifaX_Mark=5;this.jc_EifaX_Typ=6;this.jc_EifaX_Cod=7;this.jc_EifaX_Id=8;this.jc_EifaX_IdParent=9;this.jc_EifaX_Info=10;this.jc_DTStatus2_StSuccess=1;this.jc_DTStatus2_StFail=4;this.jc_DTStatus2_StEmpty=5;this.jc_DTStatus2_StInProgress=6;this.jc_DTStatus2_StOpen=8;this.jc_DTStatus2_StReady=9;this.jc_DTStatus2_OpCache=10;this.jc_DTStatus2_OpClear=20;this.jc_DTStatus2_OpStore=30;this.jc_DTStatus2_OpLoad=40;this.jc_DTStatus2_OpAjax=50;this.jc_DbSchemaVersion=52;this.jc_sDbDefaultPrimaryKeyName="xkey";this.jc_sDbName="A3xaDbZeroA";this.jc_oSTG_Common={jp_sGroupName:"A3XADB0STG_COMMON",jp_sKeyName:"xkey"};this.jc_oSTG_ComDyn={jp_sGroupName:"A3XADB0STG_COMDYN",jp_sKeyName:"xkey"};this.jc_oSTG_Enterp={jp_sGroupName:"A3XADB0STG_ENTERP",jp_sKeyName:"xkey"};this.jc_oSTG_EntDyn={jp_sGroupName:"A3XADB0STG_ENTDYN",jp_sKeyName:"xkey"};this.jc_aSchemaTableGroups=[this.jc_oSTG_Common,this.jc_oSTG_ComDyn,this.jc_oSTG_Enterp,this.jc_oSTG_EntDyn];this.jc_aSchemaTables=[{jp_sName:this.jc_GLID_MetaSystemControl,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"ControlPanels"},{jp_sName:this.jc_GLID_Category,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"Categories"},{jp_sName:this.jc_GLID_GeoTopArea,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"TopAreas"},{jp_sName:this.jc_GLID_GeoArea,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"Areas"},{jp_sName:this.jc_GLID_GeoRegion,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"Regions"},{jp_sName:this.jc_GLID_GeoCity,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bMandatory:false,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"Cities"},{jp_sName:this.jc_GLID_GeoCountry,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bMandatory:false,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"Countries"},{jp_sName:this.jc_GLID_GeoState,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bMandatory:false,jp_bCacheAll:true,jp_bAX:true,jp_sDescr:"States"},{jp_sName:this.jc_GLID_PMetaSystemControl,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebis.tbtname,jp_sParent:this.jc_GLID_MetaSystemControl,jp_sDescr:"ControlPanels BasicInfo"},{jp_sName:this.jc_GLID_PCategory,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebis.tbtname,jp_sParent:this.jc_GLID_Category,jp_sDescr:"Categories BasicInfo"},{jp_sName:this.jc_GLID_PGeoTopArea,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebis.tbtname,jp_sParent:this.jc_GLID_GeoTopArea,jp_sDescr:"TopAreas BasicInfo"},{jp_sName:this.jc_GLID_PGeoArea,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebis.tbtname,jp_sParent:this.jc_GLID_GeoArea,jp_sDescr:"Areas BasicInfo"},{jp_sName:this.jc_GLID_PGeoRegion,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebis.tbtname,jp_sParent:this.jc_GLID_GeoRegion,jp_sDescr:"Regions BasicInfo"},{jp_sName:this.jc_GLID_PGeoCity,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebis.tbtname,jp_sParent:this.jc_GLID_GeoCity,jp_sDescr:"Cities BasicInfo"},{jp_sName:this.jc_GLID_PGeoCountry,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebis.tbtname,jp_sParent:this.jc_GLID_GeoCountry,jp_sDescr:"Countries BasicInfo"},{jp_sName:this.jc_GLID_PGeoState,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebis.tbtname,jp_sParent:this.jc_GLID_GeoState,jp_sDescr:"States BasicInfo"},{jp_sName:this.jc_GLID_NMetaSystemControl,jp_oSTG:this.jc_oSTG_ComDyn,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebid.tbtname,jp_sParent:this.jc_GLID_MetaSystemControl,jp_sDescr:"ControlPanels DynamicInfo"},{jp_sName:this.jc_GLID_NCategory,jp_oSTG:this.jc_oSTG_ComDyn,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebid.tbtname,jp_sParent:this.jc_GLID_Category,jp_sDescr:"Categories DynamicInfo"},{jp_sName:this.jc_GLID_NGeoArea,jp_oSTG:this.jc_oSTG_ComDyn,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebid.tbtname,jp_sParent:this.jc_GLID_GeoArea,jp_sDescr:"Areas DynamicInfo"},{jp_sName:this.jc_GLID_NGeoRegion,jp_oSTG:this.jc_oSTG_ComDyn,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebid.tbtname,jp_sParent:this.jc_GLID_GeoRegion,jp_sDescr:"Regions DynamicInfo"},{jp_sName:this.jc_GLID_NGeoCity,jp_oSTG:this.jc_oSTG_ComDyn,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebid.tbtname,jp_sParent:this.jc_GLID_GeoCity,jp_sDescr:"Cities DynamicInfo"},{jp_sName:this.jc_GLID_NGeoCountry,jp_oSTG:this.jc_oSTG_ComDyn,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebid.tbtname,jp_sParent:this.jc_GLID_GeoCountry,jp_sDescr:"Countries DynamicInfo"},{jp_sName:this.jc_GLID_NGeoState,jp_oSTG:this.jc_oSTG_ComDyn,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ebid.tbtname,jp_sParent:this.jc_GLID_GeoState,jp_sDescr:"States DynamicInfo"},{jp_sName:this.jc_GLID_FMetaSystemControl,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ei.tbtname,jp_sParent:this.jc_GLID_MetaSystemControl,jp_sDescr:"ControlPanels Info"},{jp_sName:this.jc_GLID_FCategory,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ei.tbtname,jp_sParent:this.jc_GLID_Category,jp_sDescr:"Categories Info"},{jp_sName:this.jc_GLID_FGeoTopArea,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ei.tbtname,jp_sParent:this.jc_GLID_GeoTopArea,jp_sDescr:"TopAreas Info"},{jp_sName:this.jc_GLID_FGeoArea,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bMandatory:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ei.tbtname,jp_sParent:this.jc_GLID_GeoArea,jp_sDescr:"Areas Info"},{jp_sName:this.jc_GLID_FGeoRegion,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ei.tbtname,jp_sParent:this.jc_GLID_GeoRegion,jp_sDescr:"Regions Info"},{jp_sName:this.jc_GLID_FGeoCity,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ei.tbtname,jp_sParent:this.jc_GLID_GeoCity,jp_sDescr:"Cities Info"},{jp_sName:this.jc_GLID_FGeoCountry,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ei.tbtname,jp_sParent:this.jc_GLID_GeoCountry,jp_sDescr:"Countries Info"},{jp_sName:this.jc_GLID_FGeoState,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ei.tbtname,jp_sParent:this.jc_GLID_GeoState,jp_sDescr:"States Info"},{jp_sName:this.jc_GLID_SummaryEnterprises,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bMandatory:false,jp_bCacheAll:true,jp_sDescr:"Summary Enterprises"},{jp_sName:this.jc_GLID_FSummaryEnterprises,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_Common:true,jp_bCacheAll:true,jp_SubTable:this.jc_tbtype_ei.tbtname,jp_sParent:this.jc_GLID_SummaryEnterprises,jp_sDescr:"Summary Enterprises Info"},{jp_sName:this.jc_GLID_TOC,jp_oSTG:this.jc_oSTG_Common,jp_bTyp_TOC:true,jp_bMandatory:true,jp_bCacheAll:true,jp_sDescr:"Table of Contents"},{jp_sName:this.jc_GLID_Enterprise,jp_oSTG:this.jc_oSTG_Enterp,jp_bTyp_Main:true,jp_bMandatory:true,jp_DefaultStorageType:jg_oe.jc_oStorage.jc_FLY,jp_ExtendedStorageType:jg_oe.jc_oStorage.jc_Default,jp_sDescr:"Enterprises"},{jp_sName:this.jc_GLID_PEnterprise,jp_oSTG:this.jc_oSTG_Enterp,jp_bTyp_Main:true,jp_bMandatory:true,jp_SubTable:this.jc_tbtype_ebis.tbtname,jp_sParent:this.jc_GLID_Enterprise,jp_DefaultStorageType:jg_oe.jc_oStorage.jc_FLY,jp_ExtendedStorageType:jg_oe.jc_oStorage.jc_Default,jp_sDescr:"Enterprises BasicInfo"},{jp_sName:this.jc_GLID_NEnterprise,jp_oSTG:this.jc_oSTG_EntDyn,jp_bTyp_Main:true,jp_bMandatory:true,jp_SubTable:this.jc_tbtype_ebid.tbtname,jp_sParent:this.jc_GLID_Enterprise,jp_DefaultStorageType:jg_oe.jc_oStorage.jc_FLY,jp_ExtendedStorageType:jg_oe.jc_oStorage.jc_Default,jp_sDescr:"Enterprises DynamicInfo"},{jp_sName:this.jc_GLID_FEnterprise,jp_oSTG:this.jc_oSTG_Enterp,jp_bTyp_Main:true,jp_bMandatory:true,jp_SubTable:this.jc_tbtype_ei.tbtname,jp_sParent:this.jc_GLID_Enterprise,jp_DefaultStorageType:jg_oe.jc_oStorage.jc_FLY,jp_ExtendedStorageType:jg_oe.jc_oStorage.jc_Default,jp_sDescr:"Enterprises Info"}];this.jc_eidf_xeidcc="f3x_xeidcc";this.jc_eidf_enty="f3x_enty";this.jc_eidf_enid="f3x_enid";this.jc_eidf_egty="f3x_egty";this.jc_eidf_egid="f3x_egid";this.jc_eidf_ucat="f3x_cU";this.jc_eidf_vcat="f3x_cV";this.jc_eidf_a="f3x_gnA";this.jc_eidf_z="f3x_gnZ";this.jc_eidf_n="f3x_gnN";this.jc_eidf_m="f3x_gnM";this.jc_eidf_c="f3x_gnC";this.jc_eidf_p="f3x_gpP";this.jc_eidf_s="f3x_gpS";this.jc_ebisf_enty="f3x_enty";this.jc_ebisf_enid="f3x_enid";this.jc_ebisf_created="f3x_ucretime";this.jc_ebisf_modified="f3x_umodtime";this.jc_ebisf_order="f3x_esorder";this.jc_ebisf_sym="f3x_esym";this.jc_ebisf_color="f3x_escolor";this.jc_ebisf_lat="f3x_eslat";this.jc_ebisf_lon="f3x_eslon";this.jc_ebisf_name="f3x_esname";this.jc_ebisf_descr="f3x_esdescr";this.jc_ebisf_url="f3x_esurl";this.jc_ebidf_enty="f3x_enty";this.jc_ebidf_enid="f3x_enid";this.jc_ebidf_likes="f3x_likes";this.jc_ebidf_likesbonus="f3x_likesbonus";this.jc_ebidf_clicks="f3x_clicks";this.jc_ebidf_clicksphtime="f3x_clicksphtime";this.jc_ebidf_score="f3x_score";this.jc_eif_enty="f3x_enty";this.jc_eif_enid="f3x_enid";}
function A3xaDefines_XUR()
{this.jc_sUrlBase_A3xaForm="a?";this.jc_sUrlBase_A3xaFormDDAJOO="a/";this.jc_XURFN_AjaxEntity="XE";this.jc_XURFN_ListEntity="LE";this.jc_sAjaxTypFans="XEF";this.jc_sAjaxTypControlIcons="XCI";this.jc_sAjaxTypEntity="XEN";this.jc_sAjaxTypEntity2="XE2";this.jc_sAjaxTypEntitySet="XES";this.jc_sAjaxTablesCommon="XTC";this.jc_AjaxOp_Write="AWR";this.jc_AjaxOp_WriteDelta="AWD";this.jc_XURTG_Single="Y";this.jc_XURTG_Limited="L";this.jc_XURTG_Unlimited="N";this.jc_XURTG_Secundary="S";this.jc_XURTG_Master="M";this.jc_QUR_QuerySBS="S";this.jc_QUR_QuerySBT="T";this.jc_QUR_QuerySBC="C";this.jc_QUR_QuerySBA="A";this.jc_QUR_QuerySBL="L";this.jc_QUR_QueryNewEntity="N";this.jc_QUR_QueryEditEntity="E";this.jc_QUR_QueryViewEntity="V";this.jc_QUR_QueryDeleteEntity="D";this.jc_QUR_QueryUpdateEntity="U";}
...
{if(!ji_sName)
return null;ji_sName=jg_oe.jc_oA3xaDbZero.Glid2Default(ji_sName);var jt_aTables=this.jm_aTables;for(var i=0;i<jt_aTables.length;i++)
...
{var jt_sNameDefault=jg_oe.jc_oA3xaDbZero.Glid2Default(ji_sName);var jt_pTable=this.Get_Table_ByName(jt_sNameDefault);var jt_bExtendedStorage=false;if(jt_sNameDefault!=ji_sName)
...
{var jt_pTable=this.Get_Table_ByName(ji_sName);if(!jt_pTable)
return"";return jt_pTable.jp_sDescr||"";};this.Get_TableGroups=function(ji_aTableNames)
{var jr_aSchemaTableGroups=A3xa2Array();var jt_aTables=this.jm_aTables;for(var i=0;i<jt_aTables.length;i++)
{var jt_bMatch=true;if(ji_aTableNames&&ji_aTableNames.length)
{jt_bMatch=false;for(var j=0;j<ji_aTableNames.length;j++)
{if(jg_oe.jc_oA3xaDbZero.Glid2Default(ji_aTableNames[j])==jt_aTables[i].jp_sName)
{jt_bMatch=true;break;}}}
if(jt_bMatch)
{var jt_oSTG=jt_aTables[i].jp_oSTG;if(jt_oSTG&&jt_oSTG.jp_sGroupName&&jt_oSTG.jp_sKeyName)
{if(!jr_aSchemaTableGroups.ar.getItem(jt_oSTG.jp_sGroupName))
jr_aSchemaTableGroups.ar.addItem(jt_oSTG.jp_sGroupName,jt_oSTG);}}}
...
return null;var jt_nofstg=jt_aSchemaTableGroups.ar.getCount();var jr_aSTGNames=[];for(var i=0;i<jt_nofstg;i++)
{var jt_ostg=jt_aSchemaTableGroups.ar.getItem_ByIndex(i);if(jt_ostg&&jt_ostg.jp_sGroupName)
...
{this.jm_oDTStatus=new GLDataStatus();this.jm_oDTStatusStore=new GLDataStatus();this.jm_glid=null;this.jm_release=null;this.jm_aoglr=new A3xaArray();this.jm_aaoglrSelect=new A3xaArray();this.jm_bAX=true;this.jm_aoglrAX=null;this.jm_odb=null;this._GLDataTable=function(ji_oDatabase,ji_glid,ji_release)
...
this.jm_bAX=false;this.Set_Glid(ji_glid);this.Set_Release(ji_release);}};this.jm_o3xJSDS=null;this.New3xJSDS=function(ji_glid){return new GLData(ji_glid);};this.Get_3xJSDS=function()
...
{this.jm_oDTStatus.SetLoadStatusSuccess();return true;};this.Get_3xDbEntity=function(ji_id){return this.Get_Recordset().Get_Item(ji_id);};this.Set_3xDbEntity=function(ji_id,ji_oglr){return this.Get_Recordset().Set_Item(ji_id,ji_oglr);};this.Get_3xDbEntityAX=function(ji_AltKey){return((this.jm_bAX&&this.Get_RecordsetAX())?this.Get_RecordsetAX().Get_Item(ji_AltKey):null);};this.Get_Recordset=function(){return this.jm_aoglr||null;};this.Get_RecordsetAX=function(){return this.jm_aoglrAX||null;};this.Get_IArray_Recordset=function(){return(this.jm_aoglr?this.jm_aoglr.Get_3x2().getIArray():null)||null;};this.Get_IArray_RecordsetAX=function(){return(this.jm_aoglrAX?this.jm_aoglrAX.Get_3x2().getIArray():null)||null;};this.New_Recordsel=function(ji_sSelectName,ji_fnSelect,ji_MaxItems)
...
{return this.jm_aaoglrSelect.Get_Item(ji_sSelectName||"DefaultSelect")||new A3xaArrayIt(this.Get_Recordset());};this.Get_3x2Recordsel=function(ji_sSelectName)
{var jt_aoglrit=this.Get_Recordsel(ji_sSelectName);return((jt_aoglrit?jt_aoglrit.Get_3x2():null)||null);};this.ClearGLSAndFail2=function(ji_oDTStatus)
{this.jm_oDTStatus.SetFrom(ji_oDTStatus);this.Get_Database().jm_aoglDataTableStore=new A3xaArray();this.Get_Database().jm_aoDTStatus_TableToClear=null;jg_oe.Get_MgrStorage().ClearStorage();return false;};this.Get_Database=function(){return this.jm_odb;};this.Get_Storage=function(){return jg_oe.Get_Database().Get_Storage(this.Get_Glid());};this.CheckLoadTableStatus=function()
{if(!this.jm_oDTStatus.IsInProgress())
...
{jr_o.jm_odb=ji_odb;jr_o.jm_glid=ji_glid;if(ji_sGLRS)
...
return false;jr_o.jm_odb.jm_oDTStatus.SetCacheStatusInProgress("Cache Tableset "+jr_o.jm_glid);jr_o.jm_odb.jm_aoglDataTableStore.Set_Item(jr_o.jm_glid,jr_o.jm_odt);jr_o.jm_odt.jm_oDTStatus.SetCacheStatusInProgress();jr_o.jm_o3xJSDS=jr_o.jm_odt.New3xJSDS(jr_o.jm_glid);if(!jr_o.csw.writeJSDS())
{if(jr_o.jm_odb)
...
{return jg_oe.Get_MgrStorage().Get_Storage(ji_StorageType);};this.jm_o3x2sdsdb_Store=null;this.Set_SDSDBStore=function(ji_o3x2sdsdb){this.jm_o3x2sdsdb_Store=ji_o3x2sdsdb;return true;};this.Get_SDSDBStore=function(){return this.jm_o3x2sdsdb_Store;};this.jm_o3x2sdsdb_Work=null;this.Set_SDSDBWork=function(ji_o3x2sdsdb){this.jm_o3x2sdsdb_Work=ji_o3x2sdsdb;return true;};this.Get_SDSDBWork=function(){return this.jm_o3x2sdsdb_Work;};this.jm_oDbSchema=(ji_oDbSchema||null);this.jm_oDTStatus=new GLDataStatusCache();this.jm_moreOnStoreAllData=0;this.jm_aoDTStatus_TableToClear=null;this.jm_aoglDataTableStore=new A3xaArray();this.jm_aoglDataTableLoad_TOC=new A3xaArray();this.jm_aoglDataTableLoad_Common=new A3xaArray();this.jm_aoglDataTableLoad_Main=new A3xaArray();this.jm_odbTransaction=null;this.ClearArrayDTLoad=function(ji_pTypTables)
{if(!ji_pTypTables)
...
{ji_glid=jg_oApp.Get_AppXUR().Get_3xXUR().Default2GlidQUR(ji_glid);if(!ji_glid)
...
return false;var jt_StorageType=this.Get_StorageType(ji_glid);if(jg_oe.jc_oA3xaDbZero.IsDefaultGlid(ji_glid)&&jt_StorageType==jg_oe.jc_oStorage.jc_FLY)
{this.Get_Storage_ByType(jt_StorageType).Clear();}
var jt_keyname=jg_oe.jc_oA3xaDbZero.Glid2SDSTbType(ji_glid).tbtkeyname;var jt_glid_X=ji_glid;var jt_glid_eid=jg_oe.jc_oA3xaDbZero.MakeGlid_ByType(jt_glid_X,jg_oe.jc_oA3xaDbZero.jc_tbtype_eid);var jt_glid_ebis=jg_oe.jc_oA3xaDbZero.MakeGlid_ByType(jt_glid_X,jg_oe.jc_oA3xaDbZero.jc_tbtype_ebis);var jt_glid_ebid=jg_oe.jc_oA3xaDbZero.MakeGlid_ByType(jt_glid_X,jg_oe.jc_oA3xaDbZero.jc_tbtype_ebid);var jt_glid_ei=jg_oe.jc_oA3xaDbZero.MakeGlid_ByType(jt_glid_X,jg_oe.jc_oA3xaDbZero.jc_tbtype_ei);if(this.Get_SDSDBStore()&&(jt_glid_X==jg_oe.jc_oA3xaDbZero.jc_GLID_MetaSystemControl||jt_glid_X==jg_oe.jc_oA3xaDbZero.jc_GLID_Category||jt_glid_X==jg_oe.jc_oA3xaDbZero.jc_GLID_GeoTopArea||jt_glid_X==jg_oe.jc_oA3xaDbZero.jc_GLID_GeoArea||jt_glid_X==jg_oe.jc_oA3xaDbZero.jc_GLID_GeoRegion||jt_glid_X==jg_oe.jc_oA3xaDbZero.jc_GLID_GeoCity||jt_glid_X==jg_oe.jc_oA3xaDbZero.jc_GLID_GeoCountry||jt_glid_X==jg_oe.jc_oA3xaDbZero.jc_GLID_GeoState))
{this.jm_oDTStatus.SetCacheStatusInProgress("Cache Tableset "+jt_glid_eid);var jt_bFail=false;var jt_otb=this.NewDataTableCacheStore(jt_glid_eid);this.jm_aoglDataTableStore.Set_Item(jt_glid_eid,jt_otb);var jt_o3x2tb=this.Get_SDSDBStore().db.get3x2Table(jt_glid_eid);if(!(jt_otb&&jt_o3x2tb&&jt_otb.Get_Glid()==jt_o3x2tb.tb.getGlid()))
...
var jt_otbp=this.NewDataTableCacheStore(jt_glid_ebis);this.jm_aoglDataTableStore.Set_Item(jt_glid_ebis,jt_otbp);var jt_o3x2tbp=this.Get_SDSDBStore().db.get3x2Table(jt_glid_ebis);if(!(jt_otbp&&jt_o3x2tbp&&jt_otbp.Get_Glid()==jt_o3x2tbp.tb.getGlid()))
...
var jt_otbf=this.NewDataTableCacheStore(jt_glid_ei);this.jm_aoglDataTableStore.Set_Item(jt_glid_ei,jt_otbf);var jt_o3x2tbf=this.Get_SDSDBStore().db.get3x2Table(jt_glid_ei);if(!(jt_otbf&&jt_o3x2tbf&&jt_otbf.Get_Glid()==jt_o3x2tbf.tb.getGlid()))
...
{var jt_o3x2dtcsw=A3xa2DTCacheWriter(this,ji_glid,ji_sGLRS);jr_b=jt_o3x2dtcsw.csw.writeTable();}
...
for(i=0;i<jt_CountDT;i++)
{var jt_ogldt=this.jm_aoglDataTableStore.Get_Item_ByIndex(i);if(!jt_ogldt.jm_oDTStatus.IsOpStore()&&jt_ogldt.jm_oDTStatus.IsSuccess()&&!jt_ogldt.jm_oDTStatusStore.IsOpStore())
...
{return this.Get_SDSDBWork().db.get3x2Table(jg_oe.jc_oA3xaDbZero.jc_GLID_TOC,null,null);};this.Get_TOCItem=function(ji_glid,ji_bCheckVersion)
{if(!ji_glid)
...
return true;}
var jt_pisdsRecord=jt_o3x2tbTOC.tb.addRecord_ByKey(ji_glid,[ji_glid,ji_release],true);return true;};this.RemoveTOCItem=function(ji_glid)
{if(!ji_glid)
return false;if(jg_oe.jc_oA3xaDbZero.IsGlidTOC(ji_glid))
return false;var jt_odtTOC=this.Get_TOC();if(!jt_odtTOC)
return false;var jt_o3x2tbTOC=this.Get_SDSDBWork().db.get3x2Table(jg_oe.jc_oA3xaDbZero.jc_GLID_TOC,null,null);if(!jt_o3x2tbTOC)
...
return true;};this.jm_odb=(ji_odb||null);this.jm_otkm=(ji_otkm||null);}
...
function A3xaDataManager(ji_fnOnLoadDone,ji_oDatabase)
{this.jm_fnOnLoadDone=(ji_fnOnLoadDone||null);this.jm_oDatabase=(ji_oDatabase||null);this.jm_odbLoader=null;var jt_this=this;this.LoadData=function(){return this.ManageData(true);};this.ManageNewAjaxData=function(){return this.ManageData(false,true);};this.ManageData=function(ji_bLoadOnly,ji_bNewAjax)
{var jt_bStoreDataSuccess=false;var jt_bAjaxCommonDone=false;var jt_bAjaxMainDone=false;var jt_oDTStatus=new GLDataStatusLoadFail();var jt_fnThatsAllFolks=function()
{if(jt_this.jm_fnOnLoadDone)
jt_this.jm_fnOnLoadDone(jt_oDTStatus);return true;};var jt_fnOnStoreTOCDone=function(ji_bSuccess)
{if(ji_bSuccess&&jt_bStoreDataSuccess)
{}
return true;};var jt_fnOnStoreDataDone=function(ji_bSuccess)
{jt_bStoreDataSuccess=ji_bSuccess;return jt_this.StoreTOC(jt_fnOnStoreTOCDone);};var jt_fnOnLoadMainDone=function(ji_oDTStatus)
{jt_oDTStatus=ji_oDTStatus;if(ji_bLoadOnly)
return jt_fnThatsAllFolks();var jt_oTimerAsyncDecouple=setTimeout(function()
{var jr_b=jt_this.StoreData(jt_fnOnStoreDataDone);},10);var jr_b=jt_fnThatsAllFolks();return jr_b;};var jt_fnOnLoadCommon2Done=function(ji_bSuccess)
{if(ji_bSuccess)
return jt_this.DatabaseLoadMain(jt_fnOnLoadMainDone);jt_oDTStatus=new GLDataStatusLoadFail();return jt_fnThatsAllFolks();};var jt_fnOnCacheStoreDataReady=function(ji_bSuccess)
{if(!(jt_bAjaxCommonDone&&jt_bAjaxMainDone))
return true;if(ji_bSuccess)
return jt_this.DatabaseLoadCommon(jt_fnOnLoadCommon2Done);jt_oDTStatus=new GLDataStatusLoadFail();return jt_fnThatsAllFolks();};var jt_fnOnAjaxMainDone=function(ji_bSuccess)
{jt_bAjaxMainDone=true;if(jt_bAjaxCommonDone&&jt_bAjaxMainDone)
return jt_fnOnCacheStoreDataReady(ji_bSuccess);return true;};var jt_fnOnAjaxCommonDone=function(ji_bSuccess)
{jt_bAjaxCommonDone=true;if(jt_bAjaxCommonDone&&jt_bAjaxMainDone)
return jt_fnOnCacheStoreDataReady(ji_bSuccess);return true;};var jt_fnOnLoadCommonDone=function(ji_bSuccess)
{if(!ji_bSuccess)
{if(!jt_this.LoadCacheStoreCommon())
return false;}
var jr_b=jt_this.AjaxCommon(jt_fnOnAjaxCommonDone);var jt_oxeidXUR=jg_oApp.Get_AppXUR().Get_3xXUR().Get_3xXEID();var jt_te=jt_oxeidXUR.Get_TypEntity();if(!jt_te||jt_te==jg_oe.jc_oEntity.jc_Typ_Enterprise)
jr_b=jt_this.AjaxMain(jt_fnOnAjaxMainDone);else
jt_fnOnAjaxMainDone(true);return jr_b;};var jt_fnOnLoadTOCDone=function(ji_bSuccess)
{if(ji_bSuccess)
{if(!(jt_this.jm_oDatabase.jm_aoglDataTableLoad_Common&&jt_this.jm_oDatabase.jm_aoglDataTableLoad_Common.Get_Count()>0))
{var jt_pisdsRecord_glidtoc=jt_this.jm_oDatabase.Get_TOCItem(jg_oe.jc_oA3xaDbZero.jc_GLID_MetaSystemControl);if(!jt_pisdsRecord_glidtoc)
return jt_fnOnLoadCommonDone(false);return jt_this.DatabaseLoadCommon(jt_fnOnLoadCommonDone);}
return jt_fnOnLoadCommonDone(true);}};if(ji_bLoadOnly)
{jt_bStoreDataSuccess=true;jt_fnOnLoadCommon2Done(true);}
else if(ji_bNewAjax)
{jt_fnOnLoadCommon2Done(true);}
else
this.DatabaseLoadTOC(jt_fnOnLoadTOCDone);return true;};this.LoadCacheStoreCommon=function()
...
jr_b=this.jm_oDatabase.WriteGLRS2(jg_oe.jc_oA3xaDbZero.jc_GLID_MetaSystemControl,"");if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(jg_oe.jc_oA3xaDbZero.jc_GLID_Category,"");if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoTopArea,"");if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoArea,"");if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoRegion,"");if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoCountry,"");if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoState,"");if(jr_b)
jr_b=this.jm_oDatabase.WriteGLRS2(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoCity,"");}
catch(e)
...
{jt_this.jm_oDatabase.jm_aoDTStatus_TableToClear=null;jt_this.jm_oDatabase.jm_aoglDataTableStore=new A3xaArray();if(ji_fnOnDone)
...
return true;},this.jm_oDatabase);this.jm_odbLoader.LoadCommonTables();return true;};this.DatabaseLoadMain=function(ji_fnOnDone)
...
return true;},this.jm_oDatabase);this.jm_odbLoader.LoadMainTable();return true;};this.AjaxCommon=function(ji_fnOnDone)
{jg_oe.LogStatusBar2(new A3xaString(["Request Common","Solicitud Datos Común","Solicitação Dados Comum","Richiesta Dati Comuni"]));var jt_oAjaxResponse={OnAjaxReadyFn:function(ji_ogAjaxResponse)
{var jt_bSuccess=true;var jt_xmlAjaxTablesCommon=ji_ogAjaxResponse.Get_ItemElement(jg_oe.jc_oXUR.jc_sAjaxTablesCommon);if(!jt_xmlAjaxTablesCommon)
jt_bSuccess=false;else
{var jt_oxur=new A3xaXur();jt_oxur.Set_XURString(ji_ogAjaxResponse.Get_ItemValue("p3x"));jt_oxur.Set_XUDString(ji_ogAjaxResponse.Get_ItemValue("p3d"));}
if(jt_bSuccess)
{var jt_glidEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEBID_CP");var jt_sGLRSEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLEBID_CP");if(!jg_oApp.WriteGLRS2(jt_glidEBID,jt_sGLRSEBID))
jt_bSuccess=false;}
if(jt_bSuccess)
{var jt_glidEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEBID_CAT");var jt_sGLRSEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLEBID_CAT");if(!jg_oApp.WriteGLRS2(jt_glidEBID,jt_sGLRSEBID))
jt_bSuccess=false;}
if(jt_bSuccess)
{if(!jg_oApp.WriteGLRS2(jg_oe.jc_oA3xaDbZero.jc_GLID_NGeoTopArea,""));}
if(jt_bSuccess)
{var jt_glidEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEBID_AREA");var jt_sGLRSEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLEBID_AREA");if(!jg_oApp.WriteGLRS2(jt_glidEBID,jt_sGLRSEBID))
jt_bSuccess=false;}
if(jt_bSuccess)
{var jt_glidEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEBID_REG");var jt_sGLRSEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLEBID_REG");if(!jg_oApp.WriteGLRS2(jt_glidEBID,jt_sGLRSEBID))
jt_bSuccess=false;}
if(jt_bSuccess)
{var jt_glidEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEBID_COUNTRY");var jt_sGLRSEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLEBID_COUNTRY");if(!jg_oApp.WriteGLRS2(jt_glidEBID,jt_sGLRSEBID))
jt_bSuccess=false;}
if(jt_bSuccess)
{var jt_glidEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEBID_STATE");var jt_sGLRSEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLEBID_STATE");if(!jg_oApp.WriteGLRS2(jt_glidEBID,jt_sGLRSEBID))
jt_bSuccess=false;}
if(jt_bSuccess)
{var jt_glidEID=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEID_SUME");var jt_sGLRSEID=ji_ogAjaxResponse.Get_ItemValue("p_GLEID_SUME");var jt_glidEI=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEI_SUME");var jt_sGLRSEI=ji_ogAjaxResponse.Get_ItemValue("p_GLEI_SUME");if(!jg_oApp.WriteGLRS2(jt_glidEID,jt_sGLRSEID))
jt_bSuccess=false;else if(!jg_oApp.WriteGLRS2(jt_glidEI,jt_sGLRSEI))
jt_bSuccess=false;}
if(jt_bSuccess)
{var jt_glidEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEBID_CITY");var jt_sGLRSEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLEBID_CITY");if(!jg_oApp.WriteGLRS2(jt_glidEBID,jt_sGLRSEBID))
jt_bSuccess=false;}
if(ji_fnOnDone)
ji_fnOnDone(jt_bSuccess);return true;}};var jt_o3xXUR=new A3xaXur();jt_o3xXUR.Set_UrlParams(jg_oe.jc_oXUR.jc_XURFN_ListEntity,null,jg_oe.jc_oXUR.jc_sAjaxTablesCommon,jg_oe.jc_oXUR.jc_QUR_QuerySBS,null,jg_oe.jc_oXUR.jc_XURTG_Unlimited,jg_oe.jc_oXUR.jc_XURTG_Master,null);var jt_oUrl=jt_o3xXUR.Get_A3xaUrl(true);jg_oe.jm_oAjax2.QueueRequest(new A3xaAjaxRequest2(jt_oUrl.Get_UrlBase(),"p3k=1"+jt_oUrl.Get_UrlParams(),jt_oAjaxResponse));return true;};this.AjaxMain=function(ji_fnOnDone)
{jg_oe.LogStatusBar2(new A3xaString(["Request Main","Solicitud Datos Principal","Solicitação Dados Principal","Richiesta Dati Principali"]));var jt_oAjaxResponse={OnAjaxReadyFn:function(ji_ogAjaxResponse)
{var jt_bSuccess=true;var jt_xmlAjaxTablesCommon=ji_ogAjaxResponse.Get_ItemElement(jg_oe.jc_oXUR.jc_sAjaxTablesCommon);if(!jt_xmlAjaxTablesCommon)
jt_bSuccess=false;else
{var jt_oxur=new A3xaXur();jt_oxur.Set_XURString(ji_ogAjaxResponse.Get_ItemValue("p3x"));jt_oxur.Set_XUDString(ji_ogAjaxResponse.Get_ItemValue("p3d"));}
if(jt_bSuccess)
{var jt_glidEID=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEID_E");var jt_sGLRSEID=ji_ogAjaxResponse.Get_ItemValue("p_GLEID_E");var jt_glidEBIS=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEBIS_E");var jt_sGLRSEBIS=ji_ogAjaxResponse.Get_ItemValue("p_GLEBIS_E");var jt_glidEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEBID_E");var jt_sGLRSEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLEBID_E");var jt_glidEI=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEI_E");var jt_sGLRSEI=ji_ogAjaxResponse.Get_ItemValue("p_GLEI_E");if(!jg_oApp.WriteGLRS2(jt_glidEID,jt_sGLRSEID))
jt_bSuccess=false;else if(!jg_oApp.WriteGLRS2(jt_glidEBIS,jt_sGLRSEBIS))
jt_bSuccess=false;else if(!jg_oApp.WriteGLRS2(jt_glidEBID,jt_sGLRSEBID))
jt_bSuccess=false;else if(!jg_oApp.WriteGLRS2(jt_glidEI,jt_sGLRSEI))
jt_bSuccess=false;}
if(ji_fnOnDone)
ji_fnOnDone(jt_bSuccess);return true;}};var jt_o3xXUR=new A3xaXur();jt_o3xXUR.CopyFromXUR(jg_oApp.Get_AppXUR().Get_3xXUR());jt_o3xXUR.jm_FormName=jg_oe.jc_oXUR.jc_XURFN_ListEntity;jt_o3xXUR.jm_TypAjaxResponse=jg_oe.jc_oXUR.jc_sAjaxTypEntitySet;var jt_oxeidXUR=jt_o3xXUR.Get_3xXEID();var jt_te=jt_oxeidXUR.Get_TypEntity();if(jt_te&&jt_te!=jg_oe.jc_oEntity.jc_Typ_Enterprise)
return false;var jt_oUrl=jt_o3xXUR.Get_A3xaUrl(true);jg_oe.jm_oAjax2.QueueRequest(new A3xaAjaxRequest2(jt_oUrl.Get_UrlBase(),"p3k=1"+jt_oUrl.Get_UrlParams(),jt_oAjaxResponse));return true;};}
...
{this.jm_pTypTables={jp_bTyp_Common:true};return this._LoadTables();};this.LoadMainTable=function()
{this.jm_pTypTables={jp_bTyp_Main:true};this.jm_oDatabase.ClearArrayDTLoad(this.jm_pTypTables);return this._LoadTables();};this._OnReset=function()
...
(this.jm_oDTStatus.jm_fnOnChange?"Y":"null"),"","A3xaDbLOader._OnEnd_Record");return new GLDataStatusLoadSuccess();};this._LoadTables=function()
{var jt_ogtl=this._Get_GlidsToLoad();if(jt_ogtl.jarr&&jt_ogtl.jarr.length)
...
{var jt_glid=ji_aGlidToLoad[i];var jt_odtToReuse=null;var jt_o3xtbsds=null;if(this.IsCommonTables()||this.IsMainTable())
...
{jt_odtToReuse=this.jm_oDatabase.Get_DataTable(jt_glid);jt_o3xtbsds=jt_odbsdswk.db.get3x2Table(jt_glid);if(!(jt_odtToReuse&&jt_odtToReuse.jm_oDTStatus.IsSuccess()&&!jt_odtToReuse.jm_oDTStatus.IsEmpty()))
{jt_odtToReuse=null;jt_o3xtbsds=null;}}
if(!jt_odtToReuse)
{jr_aGlidToLoad.push(jt_glid);}}
...
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("p1="+(jio_oStorageValue?jio_oStorageValue.Get_Key():"?"),"A3xaStorageFLY_ExecRead");return jio_oStorageValue.Set_Value(this.jm_aFlyStorage[jio_oStorageValue.Get_Key()]);};this.jm_bAvailable=true;this.jm_aFlyStorage=[];}
...
var jt_aSchemaTableGroups=ji_oSchema.Get_TableGroups();var jt_nofstg=jt_aSchemaTableGroups.ar.getCount();for(var i=0;i<jt_nofstg;i++)
{var jt_oSTG=jt_aSchemaTableGroups.ar.getItem_ByIndex(i);if(jt_oSTG&&jt_oSTG.jp_sGroupName&&jt_oSTG.jp_sKeyName)
...
{this.Get_3xAZNMC=function(){return this.jm_o3xaznmc;};this.IsBestFromBabylon=function(){return this.jm_o3xaznmc.Get_A()=="Y";};this.IsLA=function(){return this.jm_o3xaznmc.Get_A()=="L";};this.Set_LA=function()
...
jr_sxj+=',"'+jg_oe.jc_oA3xaDbZero.jc_eidf_egid+'":"'+this._S(this.Get_IdGroup())+'"';if(!ji_o3xxeidCompare||this._S(this.Get_3xCat().Get_Ucat())!=this._S(ji_o3xxeidCompare.Get_3xCat().Get_Ucat()))
jr_sxj+=',"'+jg_oe.jc_oA3xaDbZero.jc_eidf_ucat+'":"'+this._S(this.Get_3xCat().Get_Ucat())+'"';if(!ji_o3xxeidCompare||this._S(this.Get_3xCat().Get_Vcat())!=this._S(ji_o3xxeidCompare.Get_3xCat().Get_Vcat()))
jr_sxj+=',"'+jg_oe.jc_oA3xaDbZero.jc_eidf_vcat+'":"'+this._S(this.Get_3xCat().Get_Vcat())+'"';if(!ji_o3xxeidCompare||this._S(this.Get_3xAZNMC().Get_A())!=this._S(ji_o3xxeidCompare.Get_3xAZNMC().Get_A()))
jr_sxj+=',"'+jg_oe.jc_oA3xaDbZero.jc_eidf_a+'":"'+this._S(this.Get_3xAZNMC().Get_A())+'"';if(!ji_o3xxeidCompare||this._S(this.Get_3xAZNMC().Get_Z())!=this._S(ji_o3xxeidCompare.Get_3xAZNMC().Get_Z()))
jr_sxj+=',"'+jg_oe.jc_oA3xaDbZero.jc_eidf_z+'":"'+this._S(this.Get_3xAZNMC().Get_Z())+'"';if(!ji_o3xxeidCompare||this._S(this.Get_3xAZNMC().Get_N())!=this._S(ji_o3xxeidCompare.Get_3xAZNMC().Get_N()))
jr_sxj+=',"'+jg_oe.jc_oA3xaDbZero.jc_eidf_n+'":"'+this._S(this.Get_3xAZNMC().Get_N())+'"';if(!ji_o3xxeidCompare||this._S(this.Get_3xAZNMC().Get_M())!=this._S(ji_o3xxeidCompare.Get_3xAZNMC().Get_M()))
jr_sxj+=',"'+jg_oe.jc_oA3xaDbZero.jc_eidf_m+'":"'+this._S(this.Get_3xAZNMC().Get_M())+'"';if(!ji_o3xxeidCompare||this._S(this.Get_3xAZNMC().Get_C())!=this._S(ji_o3xxeidCompare.Get_3xAZNMC().Get_C()))
jr_sxj+=',"'+jg_oe.jc_oA3xaDbZero.jc_eidf_c+'":"'+this._S(this.Get_3xAZNMC().Get_C())+'"';if(!ji_o3xxeidCompare||this._S(this.Get_3xPS().Get_P())!=this._S(ji_o3xxeidCompare.Get_3xPS().Get_P()))
jr_sxj+=',"'+jg_oe.jc_oA3xaDbZero.jc_eidf_p+'":"'+this._S(this.Get_3xPS().Get_P())+'"';if(!ji_o3xxeidCompare||this._S(this.Get_3xPS().Get_S())!=this._S(ji_o3xxeidCompare.Get_3xPS().Get_S()))
jr_sxj+=',"'+jg_oe.jc_oA3xaDbZero.jc_eidf_s+'":"'+this._S(this.Get_3xPS().Get_S())+'"';jr_sxj+='}';return jr_sxj;};this.Set_XJSon=function(ji_sxjebis)
{var jt_oxjebis=JSON.parse(ji_sxjebis,function(ji_k,ji_v)
{return ji_v;});if(!jt_oxjebis)
return false;this.Set_GEID(jt_oxjebis.f3x_enty,jt_oxjebis.f3x_enid,jt_oxjebis.f3x_egty,jt_oxjebis.f3x_egid);this.Get_3xCat().Set_Category(jt_oxjebis.f3x_cU,jt_oxjebis.f3x_cV);this.Get_3xAZNMC().Set_AZNMC(jt_oxjebis.f3x_gnA,jt_oxjebis.f3x_gnZ,jt_oxjebis.f3x_gnN,jt_oxjebis.f3x_gnM,jt_oxjebis.f3x_gnC);this.Get_3xPS().Set_PS(jt_oxjebis.f3x_gpP,jt_oxjebis.f3x_gpS);return true;};this.jm_TypEntity=null;this.jm_IdEntity=null;this.jm_TypGroup=null;this.jm_IdGroup=null;this.jm_o3xaznmc=new A3xaAZNMC();this.jm_o3xps=new A3xaPS();this.jm_o3xcat=new A3xaCategoryCode();}
...
jr_sxj+='}';return jr_sxj;};this.jm_TypEntity=null;this.jm_IdEntity=null;this.jm_Likes=null;this.jm_LikesBonus=null;this.jm_Clicks=null;this.jm_ClickTime="";this.jm_Score=null;}
...
return true;this.jm_aMaster=jt_aMaster.slice(0);jt_arsSlaves=ji_oeifa.Get_Slaves();if(!jt_arsSlaves)
...
function A3xaEI()
{this.jm_o3x2aeifa=A3xa2Array();this.IsValid=function()
{return true;};this.IsEmpty=function()
{return false;};this.Get_3xEI=function(){return this;};this.CopyFrom=function(ji_o3xei)
{if(ji_o3xei)
ji_o3xei=ji_o3xei.Get_3xEI();if(!ji_o3xei)
return false;this.jm_o3x2aeifa=A3xa2Array();var jt_o3x2aeifa=ji_o3xei.Get_3x2Info();var jt_c=0;if(jt_o3x2aeifa)
...
{this.jm_o3x2aeifa=A3xa2Array();return true;};this.Get_3x2Info=function(ji_TypInfo,ji_IdInfo)
{if(!(ji_TypInfo||ji_IdInfo))
return this.jm_o3x2aeifa;var jr_o3x2aeifa_Selected=A3xa2Array();var jt_c=this.jm_o3x2aeifa.ar.getCount();for(var i=0;i<jt_c;i++)
...
{var jt_oxjebis=JSON.parse(ji_sxjebis,function(ji_k,ji_v)
{return ji_v;});if(!jt_oxjebis)
return false;this.Set_Created(jt_oxjebis.f3x_ucretime);this.Set_Modified(jt_oxjebis.f3x_umodtime);this.Set_Order(jt_oxjebis.f3x_esorder);this.Set_Idsym(jt_oxjebis.f3x_esym);this.Set_Color(jt_oxjebis.f3x_escolor);this.Set_Lat(jt_oxjebis.f3x_eslat);this.Set_Lon(jt_oxjebis.f3x_eslon);this.Set_Name(jt_oxjebis.f3x_esname);this.Set_Descr(jt_oxjebis.f3x_esdescr);this.Set_Website(jt_oxjebis.f3x_esurl);return true;};}
...
function A3xaDbZero()
{A3xaDatabase.call(this,new A3xaDbSchema(jg_oe.jc_oA3xaDbZero.jc_sDbName,jg_oe.jc_oA3xaDbZero.jc_DbSchemaVersion,jg_oe.jc_oA3xaDbZero.jc_sDbDefaultPrimaryKeyName,jg_oe.jc_oA3xaDbZero.jc_aSchemaTables));this._A3xaDbZero=function()
{this.Set_SDSDBStore(A3xa2SDS_DbEntity());this.Set_SDSDBWork(A3xa2SDS_DbEntity());};this.GLID2Typ=function(ji_GLID)
...
return jg_oe.jc_oEntity.jc_Typ_Category;if(ji_GLID==jg_oe.jc_oA3xaDbZero.jc_GLID_GeoTopArea)
return jg_oe.jc_oEntity.jc_Typ_GeoTopArea;if(ji_GLID==jg_oe.jc_oA3xaDbZero.jc_GLID_GeoArea)
...
return jg_oe.jc_oA3xaDbZero.jc_GLID_Category;if(ji_TypEntity==jg_oe.jc_oEntity.jc_Typ_GeoTopArea)
return jg_oe.jc_oA3xaDbZero.jc_GLID_GeoTopArea;if(ji_TypEntity==jg_oe.jc_oEntity.jc_Typ_GeoArea)
...
return null;var jr_odt=this.Get_DataTable(jt_glid,true);if(!jr_odt)
return null;if(!jr_odt.jm_oDTStatus.IsSuccess()&&!jr_odt.jm_oDTStatus.IsOpStore())
return null;return jr_odt;};this.OnDataLoadedSetup=function()
...
function GLREBID()
{A3xaAbsDbEntity.call(this,null);this.Get_3xEBID=function(){return this;};this.Get_TypEntity=function(){return this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebidf_enty);};this.Get_IdEntity=function(){return this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebidf_enid);};this.Get_Likes=function()
...
{var jt_o3x2aeifa_Selected=A3xa2Array();var jt_arsInfo=this.Get_FieldArray_Recordset(jg_oe.jc_oA3xaDbZero.jc_sEifaName);if(!(jt_arsInfo&&jt_arsInfo.length))
...
var jt_oglrGeoTopArea=null;var jt_oglrGeoArea=null;var jt_oglrGeoRegion=null;var jt_oglrGeoCity=null;var jt_oglrGeoCountry=null;var jt_oglrGeoState=null;var jt_ogldtGeoTopArea=null;var jt_ogldtGeoArea=null;var jt_ogldtGeoRegion=null;var jt_ogldtGeoCity=null;var jt_ogldtGeoCountry=null;var jt_ogldtGeoState=null;jt_ogldtGeoTopArea=ji_odb.Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoTopArea);jt_ogldtGeoArea=ji_odb.Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoArea);if(jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoTopArea&&jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoArea)
jt_ogldtGeoRegion=ji_odb.Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoRegion);if(jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoTopArea&&jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoArea&&jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoRegion)
jt_ogldtGeoCity=ji_odb.Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoCity);if(jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoTopArea&&jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoArea&&jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoRegion)
jt_ogldtGeoCountry=ji_odb.Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoCountry);if(jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoTopArea&&jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoArea&&jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoRegion&&jt_TypEntity!=jg_oe.jc_oEntity.jc_Typ_GeoCountry)
jt_ogldtGeoState=ji_odb.Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoState);if(jt_ogldtGeoTopArea)
...
{this.jm_FormName=jg_oe.jc_oXUR.jc_XURFN_AjaxEntity;var jt_sxur=this.Get_XURCC();var jt_sQS=jg_oe.jc_oXUR.jc_sUrlBase_A3xaForm;if(jg_oe.jm_bDDAJOO)
jt_sQS=jg_oe.jc_oXUR.jc_sUrlBase_A3xaFormDDAJOO+"?";jr_oUrl=new A3xaUrl(jt_sQS,"p3x="+jt_sxur);}
else
{var jt_sxur=this.Get_XURCC();var jt_sQS=jg_oe.jc_oXUR.jc_sUrlBase_A3xaForm;if(jg_oe.jm_bDDAJOO)
jt_sQS=jg_oe.jc_oXUR.jc_sUrlBase_A3xaFormDDAJOO+"?";jr_oUrl=new A3xaUrl(jt_sQS,(ji_bAppendDescrParam===true?"p3d="+this.Get_XUDString()+"&":"")+"p3x="+jt_sxur);}
if(!jt_sxur)
...
{if(ji_o3xxeid)
ji_o3xxeid=ji_o3xxeid.Get_3xXEID();var jt_o3xaznmc=(ji_o3xxeid?ji_o3xxeid.Get_3xAZNMC():null);if(!jt_o3xaznmc)
...
{if(ji_o3xxeid)
ji_o3xxeid=ji_o3xxeid.Get_3xXEID();var jt_o3xps=(ji_o3xxeid?ji_o3xxeid.Get_3xPS():null);if(!jt_o3xps)
...
{if(ji_o3xxeid)
ji_o3xxeid=ji_o3xxeid.Get_3xXEID();var jt_o3xuv=(ji_o3xxeid?ji_o3xxeid.Get_3xCat():null);if(!jt_o3xuv)
return"";return jr_o.ak.makeAltKeyUVcat(ji_enty,jt_o3xuv.Get_Ucat(),jt_o3xuv.Get_Vcat());};return jr_o;};function A3xa2IDataSourceCommon()
{var jr_I={getObject:function(){return null;},addTopAreas:function(ji_IArray_TopArea,ji_IArrayAX_TopArea){return false;},addAreas:function(ji_IArray_Area,ji_IArrayAX_Area){return false;},addRegions:function(ji_IArray_Region,ji_IArrayAX_Region){return false;},addMicroRegions:function(ji_IArray_MicroRegion,ji_IArrayAX_MicroRegion){return false;},addCities:function(ji_IArray_City,ji_IArrayAX_City){return false;},addCountries:function(ji_IArray_Country,ji_IArrayAX_Country){return false;},addStates:function(ji_IArray_States,ji_IArrayAX_States){return false;},addUcats:function(ji_IArray_Ucats,ji_IArrayAX_Ucats){return false;},addUVcats:function(ji_IArray_UVcats,ji_IArrayAX_UVcats){return false;},addTableTopAreas:function(){return false;},addTableAreas:function(){return false;},addTableRegions:function(){return false;},addTableMicroRegions:function(){return false;},addTableCities:function(){return false;},addTableCountries:function(){return false;},addTableStates:function(){return false;},addTableUcats:function(){return false;},addTableUVcats:function(){return false;},selectCommonTyp:function(ji_TypEntity){return false;},getSelectCommonTyp:function(){return null;}};return jr_I;}
function A3xa2DataSourceCommon()
{var jr_o={jm_o3x2a_IArrayCommon:A3xa2Array(),jm_TypEntity:"",jm_TypEntityStrength:0,ar:A3xa2IArray(),getIArray:function(){return jr_o.ar;},ds:A3xa2IDataSourceCommon(),getIDataSourceCommon:function(){return jr_o.ds;}};jr_o.ar.getObject=function(){return jr_o;};jr_o.ds.getObject=function(){return jr_o;};jr_o.ds.addTopAreas=function(ji_IArray_TopArea,ji_IArrayAX_TopArea)
{if(jr_o.jm_TypEntityStrength<5)
{jr_o.jm_TypEntity=jg_oe.jc_oEntity.jc_Typ_GeoTopArea;jr_o.jm_TypEntityStrength=5;}
return jr_o.jm_o3x2a_IArrayCommon.ar.addItem(jg_oe.jc_oEntity.jc_Typ_GeoTopArea,{Typ:jg_oe.jc_oEntity.jc_Typ_GeoTopArea,ICommon:ji_IArray_TopArea,ICommonAX:ji_IArrayAX_TopArea});};jr_o.ds.addAreas=function(ji_IArray_Area,ji_IArrayAX_Area)
{if(jr_o.jm_TypEntityStrength<10)
{jr_o.jm_TypEntity=jg_oe.jc_oEntity.jc_Typ_GeoArea;jr_o.jm_TypEntityStrength=10;}
return jr_o.jm_o3x2a_IArrayCommon.ar.addItem(jg_oe.jc_oEntity.jc_Typ_GeoArea,{Typ:jg_oe.jc_oEntity.jc_Typ_GeoArea,ICommon:ji_IArray_Area,ICommonAX:ji_IArrayAX_Area});};jr_o.ds.addRegions=function(ji_IArray_Region,ji_IArrayAX_Region)
{if(jr_o.jm_TypEntityStrength<15)
{jr_o.jm_TypEntity=jg_oe.jc_oEntity.jc_Typ_GeoRegion;jr_o.jm_TypEntityStrength=15;}
return jr_o.jm_o3x2a_IArrayCommon.ar.addItem(jg_oe.jc_oEntity.jc_Typ_GeoRegion,{Typ:jg_oe.jc_oEntity.jc_Typ_GeoRegion,ICommon:ji_IArray_Region,ICommonAX:ji_IArrayAX_Region});};jr_o.ds.addMicroRegions=function(ji_IArray_MicroRegion,ji_IArrayAX_MicroRegion)
{if(jr_o.jm_TypEntityStrength<20)
{jr_o.jm_TypEntity=jg_oe.jc_oEntity.jc_Typ_GeoMicroRegion;jr_o.jm_TypEntityStrength=20;}
return jr_o.jm_o3x2a_IArrayCommon.ar.addItem(jg_oe.jc_oEntity.jc_Typ_GeoMicroRegion,{Typ:jg_oe.jc_oEntity.jc_Typ_GeoMicroRegion,ICommon:ji_IArray_MicroRegion,ICommonAX:ji_IArrayAX_MicroRegion});};jr_o.ds.addCities=function(ji_IArray_City,ji_IArrayAX_City)
{if(jr_o.jm_TypEntityStrength<30)
{jr_o.jm_TypEntity=jg_oe.jc_oEntity.jc_Typ_GeoCity;jr_o.jm_TypEntityStrength=30;}
return jr_o.jm_o3x2a_IArrayCommon.ar.addItem(jg_oe.jc_oEntity.jc_Typ_GeoCity,{Typ:jg_oe.jc_oEntity.jc_Typ_GeoCity,ICommon:ji_IArray_City,ICommonAX:ji_IArrayAX_City});};jr_o.ds.addCountries=function(ji_IArray_Country,ji_IArrayAX_Country)
{if(jr_o.jm_TypEntityStrength<15)
{jr_o.jm_TypEntity=jg_oe.jc_oEntity.jc_Typ_GeoCountry;jr_o.jm_TypEntityStrength=15;}
return jr_o.jm_o3x2a_IArrayCommon.ar.addItem(jg_oe.jc_oEntity.jc_Typ_GeoCountry,{Typ:jg_oe.jc_oEntity.jc_Typ_GeoCountry,ICommon:ji_IArray_Country,ICommonAX:ji_IArrayAX_Country});};jr_o.ds.addStates=function(ji_IArray_State,ji_IArrayAX_State)
{if(jr_o.jm_TypEntityStrength<20)
{jr_o.jm_TypEntity=jg_oe.jc_oEntity.jc_Typ_GeoState;jr_o.jm_TypEntityStrength=20;}
return jr_o.jm_o3x2a_IArrayCommon.ar.addItem(jg_oe.jc_oEntity.jc_Typ_GeoState,{Typ:jg_oe.jc_oEntity.jc_Typ_GeoState,ICommon:ji_IArray_State,ICommonAX:ji_IArrayAX_State});};jr_o.ds.addUcats=function(ji_IArray_Ucats,ji_IArrayAX_Ucats)
{if(jr_o.jm_TypEntityStrength<50)
{jr_o.jm_TypEntity=jg_oe.jc_oEntity.jc_Typ_CategoryGroup;jr_o.jm_TypEntityStrength=50;}
return jr_o.jm_o3x2a_IArrayCommon.ar.addItem(jg_oe.jc_oEntity.jc_Typ_CategoryGroup,{Typ:jg_oe.jc_oEntity.jc_Typ_CategoryGroup,ICommon:ji_IArray_Ucats,ICommonAX:ji_IArrayAX_Ucats});};jr_o.ds.addUVcats=function(ji_IArray_UVcats,ji_IArrayAX_UVcats)
{if(jr_o.jm_TypEntityStrength<55)
{jr_o.jm_TypEntity=jg_oe.jc_oEntity.jc_Typ_Category;jr_o.jm_TypEntityStrength=55;}
return jr_o.jm_o3x2a_IArrayCommon.ar.addItem(jg_oe.jc_oEntity.jc_Typ_Category,{Typ:jg_oe.jc_oEntity.jc_Typ_Category,ICommon:ji_IArray_UVcats,ICommonAX:ji_IArrayAX_UVcats});};jr_o.ds.addTableTopAreas=function()
{var jt_odb=jg_oApp.Get_Database();if(!jt_odb)
return false;var jt_ogldt=jt_odb.Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoTopArea);if(!jt_ogldt)
return false;return jr_o.ds.addTopAreas(jt_ogldt.Get_IArray_Recordset(),jt_ogldt.Get_IArray_RecordsetAX());};jr_o.ds.addTableAreas=function()
{var jt_odb=jg_oApp.Get_Database();if(!jt_odb)
return false;var jt_ogldt=jt_odb.Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoArea);if(!jt_ogldt)
return false;return jr_o.ds.addAreas(jt_ogldt.Get_IArray_Recordset(),jt_ogldt.Get_IArray_RecordsetAX());};jr_o.ds.addTableRegions=function()
{var jt_odb=jg_oApp.Get_Database();if(!jt_odb)
return false;var jt_ogldt=jt_odb.Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoRegion);if(!jt_ogldt)
return false;return jr_o.ds.addRegions(jt_ogldt.Get_IArray_Recordset(),jt_ogldt.Get_IArray_RecordsetAX());};jr_o.ds.addTableMicroRegions=function()
{var jt_odb=jg_oApp.Get_Database();if(!jt_odb)
return false;var jt_ogldt=jt_odb.Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoMicroRegion);if(!jt_ogldt)
return false;return jr_o.ds.addMicroRegions(jt_ogldt.Get_IArray_Recordset(),jt_ogldt.Get_IArray_RecordsetAX());};jr_o.ds.addTableCities=function()
{var jt_odb=jg_oApp.Get_Database();if(!jt_odb)
return false;var jt_ogldt=jt_odb.Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoCity);if(!jt_ogldt)
return false;return jr_o.ds.addCities(jt_ogldt.Get_IArray_Recordset(),jt_ogldt.Get_IArray_RecordsetAX());};jr_o.ds.addTableCountries=function()
{var jt_odb=jg_oApp.Get_Database();if(!jt_odb)
return false;var jt_ogldt=jt_odb.Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoCountry);if(!jt_ogldt)
return false;return jr_o.ds.addCountries(jt_ogldt.Get_IArray_Recordset(),jt_ogldt.Get_IArray_RecordsetAX());};jr_o.ds.addTableStates=function()
{var jt_odb=jg_oApp.Get_Database();if(!jt_odb)
return false;var jt_ogldt=jt_odb.Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoState);if(!jt_ogldt)
return false;return jr_o.ds.addStates(jt_ogldt.Get_IArray_Recordset(),jt_ogldt.Get_IArray_RecordsetAX());};jr_o.ds.addTableUcats=function()
{var jt_odb=jg_oApp.Get_Database();if(!jt_odb)
return false;var jt_ogldt=jt_odb.Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_Category);if(!jt_ogldt)
return false;var jt_fnU=function(ji_axkey,ji_oglr)
{var jt_o3xuv=(ji_oglr?ji_oglr.Get_3xXEID().Get_3xCat():null);return((jt_o3xuv&&!jt_o3xuv.Get_Vcat())?1:0);};var jt_o3x2FilterUcatAX=A3xa2ArrayIt(null,jt_ogldt.Get_IArray_RecordsetAX());jt_o3x2FilterUcatAX.arit.selectItems(jt_fnU);var jt_o3x2FilterUcat=A3xa2ArrayIt(null,jt_ogldt.Get_IArray_Recordset());jt_o3x2FilterUcat.arit.selectItems(jt_fnU);return jr_o.ds.addUcats(jt_o3x2FilterUcat.ar,jt_o3x2FilterUcatAX.ar);};jr_o.ds.addTableUVcats=function()
{var jt_odb=jg_oApp.Get_Database();if(!jt_odb)
return false;var jt_ogldt=jt_odb.Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_Category);if(!jt_ogldt)
return false;var jt_fnUV=function(ji_axkey,ji_oglr)
{var jt_o3xuv=(ji_oglr?ji_oglr.Get_3xXEID().Get_3xCat():null);return((jt_o3xuv&&jt_o3xuv.Get_Vcat())?1:0);};var jt_o3x2FilterUVcatAX=A3xa2ArrayIt(null,jt_ogldt.Get_IArray_RecordsetAX());jt_o3x2FilterUVcatAX.arit.selectItems(jt_fnUV);var jt_o3x2FilterUVcat=A3xa2ArrayIt(null,jt_ogldt.Get_IArray_Recordset());jt_o3x2FilterUVcat.arit.selectItems(jt_fnUV);return jr_o.ds.addUVcats(jt_o3x2FilterUVcat.ar,jt_o3x2FilterUVcatAX.ar);};jr_o.ds.selectCommonTyp=function(ji_TypEntity)
...
{var jt_common=jr_o.jm_o3x2a_IArrayCommon.ar.getItem(ji_TypEntity);if(!(jt_common&&jt_common.Typ==ji_TypEntity&&jt_common.ICommonAX))
...
{var jt_common=jr_o.jm_o3x2a_IArrayCommon.ar.getItem(jr_o.jm_TypEntity);if(!(jt_common&&jt_common.Typ==jr_o.jm_TypEntity))
...
{var jr_o=A3xa2ArrayIt(null,ji_IArray_ds);jr_o.jm_o3xxeidFilter=(ji_o3xxeidFilter?ji_o3xxeidFilter.Get_3xXEID():null);jr_o.jm_o3xaznmcFilter=(jr_o.jm_o3xxeidFilter?jr_o.jm_o3xxeidFilter.Get_3xAZNMC():null);jr_o.jm_o3xpsFilter=(jr_o.jm_o3xxeidFilter?jr_o.jm_o3xxeidFilter.Get_3xPS():null);var jt_o3x2ds=(ji_IArray_ds?ji_IArray_ds.getObject():null);var jt_IDataSourceCommon=(jt_o3x2ds?jt_o3x2ds.getIDataSourceCommon():null);var jt_SelectTyp=(jt_IDataSourceCommon?jt_IDataSourceCommon.getSelectCommonTyp():null);if(jt_SelectTyp==jg_oe.jc_oEntity.jc_Typ_GeoRegion)
{jr_o.arit.selectItems(function(ji_k,ji_xtdent)
{var jt_oglr=(ji_xtdent?ji_xtdent.oglr_N:null);var jt_o3xaznmc_Current=(jt_oglr?jt_oglr.Get_3xXEID().Get_3xAZNMC():null);if(!(jr_o.jm_o3xaznmcFilter&&jt_o3xaznmc_Current&&jr_o.jm_o3xaznmcFilter.Get_A()))
...
{jr_o.arit.selectItems(function(ji_k,ji_xtdent)
{var jt_oglr=(ji_xtdent?ji_xtdent.oglr_C:null);var jt_o3xaznmc_Current=(jt_oglr?jt_oglr.Get_3xXEID().Get_3xAZNMC():null);if(!(jr_o.jm_o3xaznmcFilter&&jt_o3xaznmc_Current&&jr_o.jm_o3xaznmcFilter.Get_A()))
return 1;if(jr_o.jm_o3xaznmcFilter.Get_A()!=jt_o3xaznmc_Current.Get_A())
return 0;if(!jr_o.jm_o3xaznmcFilter.Get_Z())
return 1;if(jr_o.jm_o3xaznmcFilter.Get_Z()!=jt_o3xaznmc_Current.Get_Z())
...
{jr_o.arit.selectItems(function(ji_k,ji_xtdent)
{var jt_oglr=(ji_xtdent?ji_xtdent.oglr_S:null);var jt_o3xps_Current=(jt_oglr?jt_oglr.Get_3xXEID().Get_3xPS():null);if(!(jr_o.jm_o3xpsFilter&&jt_o3xps_Current&&jr_o.jm_o3xpsFilter.Get_P()))
return 1;if(jr_o.jm_o3xpsFilter.Get_P()!=jt_o3xps_Current.Get_P())
return 0;return 1;});}
return jr_o;}
function A3xa2DataSourceCommonDescr(ji_IArray_dsCommon,ji_sep,ji_bChainAZDescr)
{var jr_o={jm_IArray_dsCommon:ji_IArray_dsCommon,jm_bChainAZDescr:(ji_bChainAZDescr===false?false:true),jm_sChainDescrSep:(ji_sep?ji_sep:" - "),jm_bChainName:true,ar:A3xa2IArray(),getIArray:function(){return jr_o.ar;}};jr_o.ar.getObject=function(){return jr_o;};jr_o.ar.getCount=function(){return jr_o.jm_IArray_dsCommon.getCount();};jr_o.ar.getKey=function(ji_ix){return jr_o.jm_IArray_dsCommon.getKey(ji_ix);};jr_o.ar.getItem=function(ji_keyAX)
...
return true;return false;};this._A3xaStorageManager();}
function A3xaAppXUR()
...
jt_odt=jg_oApp.Get_Database().Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_Category);else if(jt_te==jg_oe.jc_oEntity.jc_Typ_GeoTopArea)
jt_odt=jg_oApp.Get_Database().Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoTopArea);else if(jt_te==jg_oe.jc_oEntity.jc_Typ_GeoArea)
...
this.Set_3xXUR(jt_o3xXUR);jg_oApp.ResetApp();jg_oApp.Get_DataManager().LoadData();return true;};this.AjaxQueueQueryRequest=function()
...
{jt_o3xXUR.jm_oDTStatus.SetAjaxStatusInProgress();var jt_oUrl=jt_o3xXUR.Get_A3xaUrl(true);jg_oe.jm_oAjax2.QueueRequest(new A3xaAjaxRequest2(jt_oUrl.Get_UrlBase(),"p3k=1"+jt_oUrl.Get_UrlParams(),this));return true;}
...
{var jt_oxur=new A3xaXur();jt_oxur.Set_XURString(ji_ogAjaxResponse.Get_ItemValue("p3x"));jt_oxur.Set_XUDString(ji_ogAjaxResponse.Get_ItemValue("p3d"));var jt_glidEID=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEID_E");var jt_sGLRSEID=ji_ogAjaxResponse.Get_ItemValue("p_GLEID_E");var jt_glidEBIS=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEBIS_E");var jt_sGLRSEBIS=ji_ogAjaxResponse.Get_ItemValue("p_GLEBIS_E");var jt_glidEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEBID_E");var jt_sGLRSEBID=ji_ogAjaxResponse.Get_ItemValue("p_GLEBID_E");var jt_glidEI=ji_ogAjaxResponse.Get_ItemValue("p_GLIDEI_E");var jt_sGLRSEI=ji_ogAjaxResponse.Get_ItemValue("p_GLEI_E");jg_oe.CanLogInfo()&&jg_oe.LogInfo("p3x.QUR,p3x.XEID,jt_sGLRS(p_GL)="+
jt_oxur.jm_QUR+","+jt_oxur.Get_3xXEID().Get_String()+","+jt_sGLRSEID,"","A3xaAppXUR.OnAjaxReadyFn");jg_oApp.WriteGLRS2(jt_glidEID,jt_sGLRSEID);jg_oApp.WriteGLRS2(jt_glidEBIS,jt_sGLRSEBIS);jg_oApp.WriteGLRS2(jt_glidEBID,jt_sGLRSEBID);jg_oApp.WriteGLRS2(jt_glidEI,jt_sGLRSEI);var jt_qulen=(this.jm_ao3xurQueue?this.jm_ao3xurQueue.length:0);for(var i=0;i<jt_qulen;i++)
...
{if(this.jm_bSummary)
{var jt_o3x2aoeifa=ji_oxe.Get_3xEI().Get_3x2Info(jg_oe.jc_oEntityInfo.jc_TI_SummaryEnterprises,null);for(var i=0;jt_o3x2aoeifa&&i<jt_o3x2aoeifa.ar.getCount();i++)
{var jt_aMaster=jt_o3x2aoeifa.ar.getItem_ByIndex(i).Get_Master();if(jt_aMaster[jg_oe.jc_oA3xaDbZero.jc_Eifa_Cod]==jg_oe.jc_oEntityInfo.jc_CI_SummaryEnterprises_Count)
this.jm_siCountValue=Number(jt_aMaster[jg_oe.jc_oA3xaDbZero.jc_Eifa_Info]);}}
else
...
return false;return true;};this.Set_ItemsNarrowView=function(ji_IdNarrowView){return true;};this.jm_o3xDataManager=null;this.Get_DataManager=function(){return null;};this.jm_oMgrSummary=null;this.Get_MgrSummary=function(){return this.jm_oMgrSummary;};}
...
{if(!this.IsValid())
return false;var jt_oglmCat=new GLMgrCategory(jg_oe.Get_Database().Get_MainDataTable());jt_oglmCat.PrintHtml_Icon(qi_oCell,this.jm_o3xehbenv.jm_oxe);return true;};this.PrintHtml_ControlIconsBox_Header=function(qi_oCell,ji_Row,ji_Col)
...
jr_b=false;return jr_b;};this.PrintHtml_IconAdmin=function(qi_oCell,ji_Row,ji_Col,ji_QUR,ji_bSecundary,ji_fnClick)
{if(!this.IsValid())
return false;var jt_o3xxeid=this.jm_o3xehbenv.jm_oxe.Get_3xXEID();if(ji_QUR==jg_oe.jc_oXUR.jc_QUR_QueryNewEntity&&ji_bSecundary&&(!jt_o3xxeid.IsGroupMajor()))
...
jt_oxur.Set_UrlParams2({form:jg_oe.jc_oXUR.jc_XURFN_AjaxEntity,tar:jg_oe.jc_oXUR.jc_sAjaxTypEntity2,qur:jg_oe.jc_oXUR.jc_QUR_QueryUpdateEntity,o3xxeid:ji_oefParams.oxeCur,single:jg_oe.jc_oXUR.jc_XURTG_Single});var jt_oUrl=jt_oxur.Get_A3xaUrl(true);var jt_sAjaxUrlParams=jt_oUrl.Get_UrlParams();jt_sAjaxUrlParams+="&p_XJEID="+
encodeURIComponent(ji_oefParams.oxeNew.Get_3xXEID().Get_XJSon(ji_oefParams.bNew?null:ji_oefParams.oxeCur));jt_sAjaxUrlParams+="&p_XJEBIS="+
encodeURIComponent(ji_oefParams.oxeNew.Get_3xEBIS().Get_XJSon(ji_oefParams.bNew?null:ji_oefParams.oxeCur));jt_sAjaxUrlParams+="&p_XJEBID="+
encodeURIComponent(ji_oefParams.oxeNew.Get_3xEBID().Get_XJSon(ji_oefParams.bNew?null:ji_oefParams.oxeCur));jg_oe.jm_oAjax2.QueueRequest(new A3xaAjaxRequest2(jt_oUrl.Get_UrlBase(),"p3k=1"+jt_sAjaxUrlParams,jt_this));}}
...
var jt_xmlAjaxTypEntity2=ji_ogAjaxResponse.Get_ItemElement(jg_oe.jc_oXUR.jc_sAjaxTypEntity2);if(jt_xmlAjaxTypEntity2)
{var jt_oxur=new A3xaXur();jt_oxur.Set_XURString(ji_ogAjaxResponse.Get_ItemValue("p3x"));var jt_TypEntity=jt_oxur.Get_3xXEID().Get_TypEntity();var jt_IdEntity=jt_oxur.Get_3xXEID().Get_IdEntity();var jt_xjeid=ji_ogAjaxResponse.Get_ItemValue("p_XJEID");var jt_xjebis=ji_ogAjaxResponse.Get_ItemValue("p_XJEBIS");var jt_xjebid=ji_ogAjaxResponse.Get_ItemValue("p_XJEBID");var jt_smsg=ji_ogAjaxResponse.Get_ItemValue("p_MSG");var jt_oebis=new A3xaEBIS();}
...
{var jt_oglrTopArea=jt_ogldtTopArea.Get_Recordset().Get_Item_ByIndex(i);if(!jt_oglrTopArea)
...
var jt_o3x2dsSelected=A3xa2DataSourceFilter(jr_o.jm_o3x2ds.ar,jr_o.hs.getFilter());var jt_o3x2dsdescr=A3xa2DataSourceCommonDescr(jt_o3x2dsSelected.ar);jr_o.hb.setName(jg_oe.jc_oA3xaDbZero.jc_eidf_n);jr_o.hb.setLabel("Region");jr_o.hb.setWidth(200);jr_o.hs.setEmptyDescr();jr_o.hs.setSelectedItem(jt_oAXKeyMaker.ak.makeAltKeyAZNMC_ByXeid(jg_oe.jc_oEntity.jc_Typ_GeoRegion,jr_o.hs.getFilter()));jr_o.hs._hsregionparent_setDataSource(jt_o3x2dsdescr.getIArray());return true;};jr_o.hs._hsregionparent_getSelectedItem=jr_o.hs.getSelectedItem;jr_o.hs.getSelectedItem=function(ji_bxtd)
...
var jt_o3x2dsdescr=A3xa2DataSourceCommonDescr(jr_o.jm_o3x2ds.ar);jr_o.hb.setName(jg_oe.jc_oA3xaDbZero.jc_eidf_p);jr_o.hb.setLabel("Country");jr_o.hb.setWidth(200);jr_o.hs.setEmptyDescr();jr_o.hs.setSelectedItem(jt_oAXKeyMaker.ak.makeAltKeyPS_ByXeid(jg_oe.jc_oEntity.jc_Typ_GeoCountry,jr_o.hs.getFilter()));jr_o.hs._hscountryparent_setDataSource(jt_o3x2dsdescr.getIArray());return true;};jr_o.hs._hscountryparent_getSelectedItem=jr_o.hs.getSelectedItem;jr_o.hs.getSelectedItem=function(ji_bxtd)
...
var jt_o3x2dsSelected=A3xa2DataSourceFilter(jr_o.jm_o3x2ds.ar,jr_o.hs.getFilter());var jt_o3x2dsdescr=A3xa2DataSourceCommonDescr(jt_o3x2dsSelected.ar);jr_o.hb.setName(jg_oe.jc_oA3xaDbZero.jc_eidf_s);jr_o.hb.setLabel("State");jr_o.hb.setWidth(200);jr_o.hs.setEmptyDescr();jr_o.hs.setSelectedItem(jt_oAXKeyMaker.ak.makeAltKeyPS_ByXeid(jg_oe.jc_oEntity.jc_Typ_GeoState,jr_o.hs.getFilter()));jr_o.hs._hsstateparent_setDataSource(jt_o3x2dsdescr.getIArray());return true;};jr_o.hs._hsstateparent_getSelectedItem=jr_o.hs.getSelectedItem;jr_o.hs.getSelectedItem=function(ji_bxtd)
...
var jt_o3x2dsdescr=A3xa2DataSourceCommonDescr(jr_o.jm_o3x2ds.ar);jr_o.hb.setName(jg_oe.jc_oA3xaDbZero.jc_eidf_vcat);jr_o.hb.setLabel("Category");jr_o.hb.setWidth(200);jr_o.hs.setEmptyDescr();jr_o.hs.setSelectedItem(jt_oAXKeyMaker.ak.makeAltKeyUVcat_ByXeid(jg_oe.jc_oEntity.jc_Typ_Category,jr_o.hs.getFilter()));jr_o.hs._hscategoryparent_setDataSource(jt_o3x2dsdescr.getIArray());return true;};jr_o.hs._hscategoryparent_getSelectedItem=jr_o.hs.getSelectedItem;jr_o.hs.getSelectedItem=function(ji_bxtd)
...
jt_A=jt_xtdent_Areas.oglr_A.Get_3xXEID().Get_3xAZNMC().Get_A();if(jt_xtdent_Areas&&jt_xtdent_Areas.oglr_Z)
jt_Z=jt_xtdent_Areas.oglr_Z.Get_3xXEID().Get_3xAZNMC().Get_Z();if(jt_xtdent_Regions&&jt_xtdent_Regions.oglr_N)
jt_N=jt_xtdent_Regions.oglr_N.Get_3xXEID().Get_3xAZNMC().Get_N();if(jt_xtdent_Regions&&jt_xtdent_Regions.oglr_M)
jt_M=jt_xtdent_Regions.oglr_M.Get_3xXEID().Get_3xAZNMC().Get_M();if(jt_xtdent_Cities&&jt_xtdent_Cities.oglr_C)
jt_C=jt_xtdent_Cities.oglr_C.Get_3xXEID().Get_3xAZNMC().Get_C();if(jt_xtdent_Countries&&jt_xtdent_Countries.oglr_P)
jt_P=jt_xtdent_Countries.oglr_P.Get_3xXEID().Get_3xPS().Get_P();if(jt_xtdent_States&&jt_xtdent_States.oglr_S)
jt_S=jt_xtdent_States.oglr_S.Get_3xXEID().Get_3xPS().Get_S();if(jt_xtdent_Categories&&jt_xtdent_Categories.oglr_U)
jt_U=jt_xtdent_Categories.oglr_U.Get_3xXEID().Get_3xCat().Get_Ucat();if(jt_xtdent_Categories&&jt_xtdent_Categories.oglr_V)
jt_V=jt_xtdent_Categories.oglr_V.Get_3xXEID().Get_3xCat().Get_Vcat();ji_odce.Get_3xXEID().Get_3xAZNMC().Set_AZNMC(jt_A,jt_Z,jt_N,jt_M,jt_C);ji_odce.Get_3xXEID().Get_3xPS().Set_PS(jt_P,jt_S);ji_odce.Get_3xXEID().Get_3xCat().Set_Category(jt_U,jt_V);return true;};jr_o.efsub.printHtml=function(ji_oci,qi_oCellEditForm)
{if(!ji_oci)
...
{var jr_o={jm_oxe:null,jm_bNew:false,jm_bSecundary:false,jm_o3x2ef_eid:A3xa2MgrEditSubForm_EID(),jm_o3x2ef_ebis:A3xa2MgrEditSubForm_EBIS(),jm_o3x2ef_ebid:A3xa2MgrEditSubForm_EBID(),ef:A3xa2IMgrEditForm()};jr_o.ef.getDCEntity=function()
...
return false;if(!jr_o.jm_oxe)
return false;var jt_o3xxeid=jr_o.jm_oxe.Get_3xXEID();var jt_o3xaznmc=(jt_o3xxeid?jt_o3xxeid.Get_3xAZNMC():null);var jt_idEditForm="efb_"+jt_o3xxeid.Get_TypEntity()+jt_o3xxeid.Get_IdEntity()+"_"+
(jt_o3xxeid.Get_TypGroup()||"M")+(jt_o3xxeid.Get_IdGroup()||"0");var qt_oDivEditForm=jQuery("#"+jt_idEditForm);if(qt_oDivEditForm&&qt_oDivEditForm.length)
{qt_oDivEditForm.remove();}
return true;};return jr_o;}
function A3xa2MgrEditInfoForm()
{var jr_o={jm_oxe:null,jm_bNew:false,jm_bSecundary:false,jm_o3xeiModified:null,jm_o3x2hebox_ei:null,jm_o3x2hebox_eityp:null,jm_o3x2hebox_eicod:null,jm_o3x2hebox_eiid:null,jm_o3x2hebox_eipar:null,jm_o3x2hebox_einfo:null,ef:A3xa2IMgrEditForm()};jr_o.ef.getDCEntity=function()
{var jr_odcUpdated=new A3xaDCEntity();if(!jr_o.jm_o3x2ef_eid.efsub.saveToDCEntity(jr_odcUpdated))
return null;if(!jr_o.jm_o3x2ef_ebis.efsub.saveToDCEntity(jr_odcUpdated))
return null;if(!jr_o.jm_o3x2ef_ebid.efsub.saveToDCEntity(jr_odcUpdated))
return null;return jr_odcUpdated;};jr_o.ef.loadData=function(ji_oxe,ji_bNew)
{jr_o.jm_bNew=ji_bNew;jr_o.jm_oxe=ji_oxe;if(!jr_o.jm_oxe)
return false;jr_o.jm_o3xeiModified=new A3xaEI();jr_o.jm_o3xeiModified.CopyFrom(jr_o.jm_oxe);var jt_o3x2aei_descr=A3xa2Array();var jt_o3x2aei=jr_o.jm_o3xeiModified.Get_3x2Info();var jt_count=jt_o3x2aei.ar.getCount();for(var i=0;i<jt_count;i++)
...
{if(!(ji_oci.qm_oCell&&ji_oci.qm_oCell.length))
return false;if(!jr_o.jm_oxe)
return false;var jt_o3xxeid=jr_o.jm_oxe.Get_3xXEID();var jt_o3xaznmc=(jt_o3xxeid?jt_o3xxeid.Get_3xAZNMC():null);var jt_idEditForm="eifb_"+jt_o3xxeid.Get_TypEntity()+jt_o3xxeid.Get_IdEntity()+"_"+
(jt_o3xxeid.Get_TypGroup()||"M")+(jt_o3xxeid.Get_IdGroup()||"0");var qt_oDivEditForm=jQuery("#"+jt_idEditForm);if(qt_oDivEditForm&&qt_oDivEditForm.length)
{qt_oDivEditForm.remove();}
return true;};return jr_o;}
function A3xa2IMgrPageUsersRegister()
...
{$.post(jg_oe.jc_oXUR.jc_sUrlBase_A3xaFormDDAJOO+"?",{p3j:"J3,users_register,exec,"+jt_username+","+jt_email+","+jt_password},function(response)
{var jt_aResponse=(response?response.split(","):null);if(jt_aResponse&&jt_aResponse.length>=4&&jt_aResponse[0]=="J3"&&jt_aResponse[1]=="users_register"&&jt_aResponse[2]&&jt_aResponse[3])
{if(jt_aResponse[2]=="success")
{alert(jt_aResponse[3]);var qt_ohFormUR=$("#users_register");if(qt_ohFormUR&&qt_ohFormUR.length)
qt_ohFormUR[0].reset();var jt_oUrl=new A3xaUrl(jg_oe.jc_oXUR.jc_sUrlBase_A3xaFormDDAJOO+"home?","");jt_oUrl.Redirect();}
else
alert(jt_aResponse[3]);}
else
alert("Registration Fails:"+jt_aResponse);});}});return true;};jr_o.pur.clearHtml=function()
{return true;};return jr_o;}
...
{$.post(jg_oe.jc_oXUR.jc_sUrlBase_A3xaFormDDAJOO+"?",{p3j:"J3,users_login,exec,"+jt_username+",,"+jt_password},function(response)
{var jt_aResponse=(response?response.split(","):null);if(jt_aResponse&&jt_aResponse.length>=4&&jt_aResponse[0]=="J3"&&jt_aResponse[1]=="users_login"&&jt_aResponse[2]&&jt_aResponse[3])
{if(jt_aResponse[2]=="success")
{alert(jt_aResponse[3]);var qt_ohFormUR=$("#users_login");if(qt_ohFormUR&&qt_ohFormUR.length)
qt_ohFormUR[0].reset();var jt_oUrl=new A3xaUrl(jg_oe.jc_oXUR.jc_sUrlBase_A3xaFormDDAJOO+"home?","");jt_oUrl.Redirect();}
else
alert(jt_aResponse[3]);}
else
alert("Login Fails:"+jt_aResponse);});}});return true;};jr_o.pul.clearHtml=function()
{return true;};return jr_o;}
...
{var jt_sQS=jg_oe.jc_oUrls.jc_surlRelHomeDirLA;if(jg_oe.jm_bDDAJOO)
jt_sQS=jg_oe.jc_oUrls.jc_surlRelHomeDirDDAJOO_LA;jt_o3xhici_LA.Set_UrlLink(jg_oe.jm_sHomeDir+jg_oe.jm_sLang+"/"+jt_sQS,false);}
...
{var jt_sQS=jg_oe.jc_oUrls.jc_surlRelHomeDirYB;if(jg_oe.jm_bDDAJOO)
jt_sQS=jg_oe.jc_oUrls.jc_surlRelHomeDirDDAJOO_YB;jt_o3xhici_YB.Set_UrlLink(jg_oe.jm_sHomeDir+jg_oe.jm_sLang+"/"+jt_sQS,false);}
...
{this.jc_oStorage=new A3xaDefines_Storage();this.jc_oA3xaDbZero=new A3xaDefines_A3xaDbZero();this.jc_oEntity=new A3xaDefines_Entity();this.jc_oEntityInfo=new A3xaDefines_EntityInfo();this.jc_oHtml=new A3xaDefines_Html();this.jc_oUrls=new A3xaDefines_Urls();this.jm_oAppXUR=new A3xaAppXUR();this.jm_oAppXUR.Set_DefXUR(new A3xaDefines_XUR());this.jc_oXUR=this.jm_oAppXUR.Get_DefXUR();this.jm_oAppMngIcons=new A3xaAppMngIcons();this.jm_oAppMngIcons.Set_DefIcons(new A3xaDefines_Icons());this.jc_oIcons=this.jm_oAppMngIcons.Get_DefIcons();this.jm_oMgrStorage=new A3xaStorageManager();this.Set_Reporter(new A3xaReporter());this.Set_Database(new A3xaDbZero());this.Get_MgrStorage().EnableStorage(function(ji_bReady){return jt_this.CheckInitDone();});this.jm_oMgrSummary=new A3xaMgrSummary();};this.HostInitApplication=function(ji_bDDAJOO,ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_IdUser,ji_sPage,ji_sxur,ji_sDirBase,ji_sHomeDir,ji_sLang)
{this.A3xaAbsEnvironment_Set_CommonValues(ji_bDDAJOO,ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_IdUser,ji_sDirBase,ji_sHomeDir,ji_sLang);this.Set_Debug((ji_bDebug?1:0),{DB:3,DBT:"idb"});this.Get_AppXUR().Set_XURString(ji_sxur);this.Get_AppXUR().Set_Page(ji_sPage);return true;};this.Get_ECPMgr=function()
...
{this.ResetApp();this.ShowCPTemplate();this.LogStatusBar2(new A3xaString(["Ready","Listo","Pronto","Pronto"]),false,true);this.Get_DataManager().ManageData();}
return true;};this.ResetApp=function()
{if(this.Get_ECPMgr())
this.Get_ECPMgr().ResetECP();this.Set_Reporter(new A3xaReporter());return true;};this.Get_DataManager=function()
{if(!this.jm_o3xDataManager)
{this.jm_o3xDataManager=new A3xaDataManager(function(ji_oDTStatus)
...
if(jr_b);return jr_b;};this.PageShow=function()
{if(this.Get_AppXUR().Get_Page(0)=="users")
...
{jt_this.ClearView();jt_this.ResetApp();jt_this.jm_o3xDataManager=null;jt_this.Get_Database().ClearArrayDTLoad({jp_bTyp_Main:true});jt_this.Get_DataManager().ManageData();},10);return true;};this.ShowCPTemplate=function()
...
return false;return true;};this.OnClickEntity=function(ji_TypEntity,ji_IdEntity,ji_TypInfo,ji_IdInfo,ji_CodInfo)
{try
