...
{A3xaAbsArray.call(this);var jt_this=this;this.jm_o3xa=null;this.jm_ix=-1;this.jm_o3xf=null;this.Construct=function(ji_o3xa)
...
return true;return false;};this.Construct(ji_o3xa);}
...
return"";return ji_s.substr(0,jc_gl.jc_oA3xaDbZero.jc_GLIDLEN);};this.XGlid2Prefix_v2=function(ji_xglid)
{if(!ji_xglid)
return"";if(ji_xglid.length==jc_gl.jc_oA3xaDbZero.jc_GLIDPREFIXLEN)
return ji_xglid;if(ji_xglid.length<jc_gl.jc_oA3xaDbZero.jc_GLIDPREFIXLEN)
return"";return ji_xglid.substr(0,jc_gl.jc_oA3xaDbZero.jc_GLIDPREFIXLEN);};this.XGlid2Mark_v2=function(ji_xglid)
{if(!ji_xglid)
return"";if(ji_xglid.length<jc_gl.jc_oA3xaDbZero.jc_GLIDLEN)
return"";var jr_mark=ji_xglid.substr(jc_gl.jc_oA3xaDbZero.jc_GLIDPREFIXLEN,jc_gl.jc_oA3xaDbZero.jc_GLIDMARKLEN);return jr_mark;};this.CheckGlid=function(ji_s)
{if(!ji_s)
...
{if(ji_TypEntity==this.jc_oEntity.jc_Typ_MetaSystemControl)
return this.jc_oA3xaDbZero.jc_GLID_MetaSystemControl;if(ji_TypEntity==this.jc_oEntity.jc_Typ_Category)
...
{return this.QUR_Get_Descr2(ji_sQUR,ji_TypEntity);}
function A3xaDefines_QUR_Get_Descr2(ji_sQUR,ji_TypEntity,ji_A,ji_Z,ji_N,ji_C,ji_bLimited)
...
{jg_oe.CanLogInfo({DB:4})&&jg_oe.LogInfo("Fail ("+ji_oDTStatus.Get_Descr()+")","","A3xaDbLoaderManager.OnDatabaseLoadMainDone");this.jm_oDatabase.MirrorToTurboHeaders();ji_oDTStatus.Set2(jc_gl.jc_oA3xaDbZero.jc_DTStatus2_StEmpty);if(this.jm_fnOnLoadDone)
this.jm_fnOnLoadDone(ji_oDTStatus);return true;}
var jt_DTStatus=ji_oDTStatus.Get();if(jt_DTStatus==jc_gl.jc_oA3xaDbZero.jc_DTStatus_Loaded)
...
return null;}
if(ji_TypEntityTarget==jc_gl.jc_oEntity.jc_Typ_MetaSystemControl)
{return ji_TypEntityTarget+","+this.jm_o3xxeid.Get_3xAZNC().Get_String()+","+this.jm_o3xxeid.Get_3xPS().Get_String();}
else if(ji_TypEntityTarget==jc_gl.jc_oEntity.jc_Typ_Category)
...
{var jt_oxur=jg_oApp.Get_AppXUR().Get_3xXUR();var jt_te=jt_oxur.Get_3xXEID().Get_TypEntity();if(jt_te==jc_gl.jc_oEntity.jc_Typ_MetaSystemControl)
jt_glid=jc_gl.jc_oA3xaDbZero.jc_GLID_MetaSystemControl;else if(jt_te==jc_gl.jc_oEntity.jc_Typ_Category)
jt_glid=jc_gl.jc_oA3xaDbZero.jc_GLID_Category;else if(jt_te==jc_gl.jc_oEntity.jc_Typ_GeoArea)
jt_glid=jc_gl.jc_oA3xaDbZero.jc_GLID_GeoArea;else if(jt_te==jc_gl.jc_oEntity.jc_Typ_GeoRegion)
jt_glid=jc_gl.jc_oA3xaDbZero.jc_GLID_GeoRegion;else if(jt_te==jc_gl.jc_oEntity.jc_Typ_GeoCity)
jt_glid=jc_gl.jc_oA3xaDbZero.jc_GLID_GeoCity;else if(jt_te==jc_gl.jc_oEntity.jc_Typ_GeoCountry)
jt_glid=jc_gl.jc_oA3xaDbZero.jc_GLID_GeoCountry;else if(jt_te==jc_gl.jc_oEntity.jc_Typ_GeoState)
jt_glid=jc_gl.jc_oA3xaDbZero.jc_GLID_GeoState;else if(jt_te==jc_gl.jc_oEntity.jc_Typ_Enterprise)
jt_glid=jc_gl.jc_oA3xaDbZero.jc_GLID_Enterprise;var jr_odt=this.Get_DataTable(jt_glid);return jr_odt;}
if(ji_A&&ji_Z&&ji_N)
...
return false;jg_oe.CanLogInfo()&&jg_oe.LogInfo("p2","","A3xaDbZero.LoadSchema");var jt_CountRecords=ji_odtRegion.Get_Recordset().Get_Count();var jt_pTableSource=this.jm_oDbSchema.Get_Table_ByName(jc_gl.jc_oA3xaDbZero.jc_GLID_Enterprise);if(!jt_pTableSource)
...
if(jt_te==jc_gl.jc_oEntity.jc_Typ_MetaSystemControl);else if(jt_te==jc_gl.jc_oEntity.jc_Typ_Category)
...
return 0;return 1;});}
else if(jt_te==jc_gl.jc_oEntity.jc_Typ_GeoArea)
{jt_ogldtMain.New_Recordsel(null,function(ji_k,ji_oxe)
...
else if(jt_te==jc_gl.jc_oEntity.jc_Typ_GeoRegion)
{jt_ogldtMain.New_Recordsel(null,function(ji_k,ji_oxe)
{var jt_3xxeid=ji_oxe.Get_3xXEID();var jt_3xaznc=jt_3xxeid.Get_3xAZNC();if(jt_o3xxur_xeid.Get_IdEntity()&&jt_3xxeid.Get_IdEntity()!=jt_o3xxur_xeid.Get_IdEntity())
return 0;if(!(jt_3xaznc.Get_A()==jt_o3xxur_aznc.Get_A()&&jt_3xaznc.Get_Z()==jt_o3xxur_aznc.Get_Z()))
return 0;return 1;});}
else if(jt_te==jc_gl.jc_oEntity.jc_Typ_GeoCity)
{jt_ogldtMain.New_Recordsel(null,function(ji_k,ji_oxe)
{var jt_3xxeid=ji_oxe.Get_3xXEID();var jt_3xaznc=jt_3xxeid.Get_3xAZNC();if(jt_o3xxur_xeid.Get_IdEntity()&&jt_3xxeid.Get_IdEntity()!=jt_o3xxur_xeid.Get_IdEntity())
...
return 0;return 1;});}
else if(jt_te==jc_gl.jc_oEntity.jc_Typ_GeoCountry)
{jt_ogldtMain.New_Recordsel(null,function(ji_k,ji_oxe)
...
return 0;return 1;});}
else if(jt_te==jc_gl.jc_oEntity.jc_Typ_GeoState)
{jt_ogldtMain.New_Recordsel(null,function(ji_k,ji_oxe)
{var jt_3xxeid=ji_oxe.Get_3xXEID();var jt_3xps=jt_3xxeid.Get_3xPS();if(jt_o3xxur_xeid.Get_IdEntity()&&jt_3xxeid.Get_IdEntity()!=jt_o3xxur_xeid.Get_IdEntity())
return 0;if(!(jt_3xps.Get_P()==jt_o3xxur_ps.Get_P()))
return 0;return 1;});}
else if(jt_te==jc_gl.jc_oEntity.jc_Typ_Enterprise)
...
{var jt_o3xxeidxur=new A3xaXEID();jt_o3xxeidxur.CopyFrom(jg_oApp.Get_AppXUR().Get_3xXUR().Get_3xXEID());var jt_o3xxeidxur_xapp=new A3xaXEID_XApp(jt_o3xxeidxur);var jt_ogldtMSC=this.Get_DataTable(jc_gl.jc_oA3xaDbZero.jc_GLID_MetaSystemControl);if(!jt_ogldtMSC)
return null;var jt_key=null;if(jt_o3xxeidxur.Get_TypEntity()==jc_gl.jc_oEntity.jc_Typ_GeoCountry||jt_o3xxeidxur.Get_TypEntity()==jc_gl.jc_oEntity.jc_Typ_GeoState)
{if(!(New_A3xaAZNC_XApp(jt_o3xxeidxur.Get_3xAZNC()).IsLA()&&jt_o3xxeidxur.Get_3xAZNC().Get_Z()))
New_A3xaAZNC_XApp(jt_o3xxeidxur.Get_3xAZNC()).Set_LA();jt_key=jt_ogldtMSC.AltKey_2_PrimaryKey(jt_o3xxeidxur_xapp.BuildAltKey(jc_gl.jc_oEntity.jc_Typ_MetaSystemControl));if(!jt_key)
{jt_o3xxeidxur.Get_3xPS().Clear_S();jt_key=jt_ogldtMSC.AltKey_2_PrimaryKey(jt_o3xxeidxur_xapp.BuildAltKey(jc_gl.jc_oEntity.jc_Typ_MetaSystemControl));}}
if(!jt_key)
...
jt_key=jt_ogldtMSC.AltKey_2_PrimaryKey(jt_o3xxeidxur_xapp.BuildAltKey(jc_gl.jc_oEntity.jc_Typ_MetaSystemControl));if(!jt_key)
{if(jt_o3xxeidxur.Get_3xAZNC().Get_N())
{jt_o3xxeidxur.Get_3xAZNC().Clear_C();jt_key=jt_ogldtMSC.AltKey_2_PrimaryKey(jt_o3xxeidxur_xapp.BuildAltKey(jc_gl.jc_oEntity.jc_Typ_MetaSystemControl));}}
if(!jt_key)
{if(jt_o3xxeidxur.Get_3xAZNC().Get_Z())
{jt_o3xxeidxur.Get_3xAZNC().Clear_NC();jt_key=jt_ogldtMSC.AltKey_2_PrimaryKey(jt_o3xxeidxur_xapp.BuildAltKey(jc_gl.jc_oEntity.jc_Typ_MetaSystemControl));}}
if(!jt_key)
{New_A3xaAZNC_XApp(jt_o3xxeidxur.Get_3xAZNC()).Set_LA();jt_key=jt_ogldtMSC.AltKey_2_PrimaryKey(jt_o3xxeidxur_xapp.BuildAltKey(jc_gl.jc_oEntity.jc_Typ_MetaSystemControl));}
if(!jt_key)
{jt_o3xxeidxur.Get_3xAZNC().Clear();jt_key=jt_ogldtMSC.AltKey_2_PrimaryKey(jt_o3xxeidxur_xapp.BuildAltKey(jc_gl.jc_oEntity.jc_Typ_MetaSystemControl));}}
if(!jt_key)
...
return false;return this.GLRecord_Set_SubRecord(ji_SubType,ji_oglrSub);};this.Get_3xEBID=function(){return this.Get_SubRecord(jc_gl.jc_oA3xaDbZero.jc_SubTable_EBID);};this.Get_Info=function(ji_TypInfo,ji_IdInfo)
...
{if(!ji_odb)
return false;var jt_TypEntity=this.Get_3xXEID().Get_TypEntity();var jt_oThis3xxeid_xapp=new A3xaXEID_XApp(this);var jt_oglrCategory=null;var jt_ogldtCategory=null;{jt_ogldtCategory=ji_odb.Get_DataTable(jc_gl.jc_oA3xaDbZero.jc_GLID_Category);if(jt_ogldtCategory)
...
var jt_oglrGeoArea=null;var jt_oglrGeoRegion=null;var jt_oglrGeoCity=null;var jt_oglrGeoCountry=null;var jt_oglrGeoState=null;var jt_ogldtGeoArea=null;var jt_ogldtGeoRegion=null;var jt_ogldtGeoCity=null;var jt_ogldtGeoCountry=null;var jt_ogldtGeoState=null;jt_ogldtGeoArea=ji_odb.Get_DataTable(jc_gl.jc_oA3xaDbZero.jc_GLID_GeoArea);if(jt_TypEntity!=jc_gl.jc_oEntity.jc_Typ_GeoArea)
jt_ogldtGeoRegion=ji_odb.Get_DataTable(jc_gl.jc_oA3xaDbZero.jc_GLID_GeoRegion);if(jt_TypEntity!=jc_gl.jc_oEntity.jc_Typ_GeoArea&&jt_TypEntity!=jc_gl.jc_oEntity.jc_Typ_GeoRegion)
jt_ogldtGeoCity=ji_odb.Get_DataTable(jc_gl.jc_oA3xaDbZero.jc_GLID_GeoCity);if(jt_TypEntity!=jc_gl.jc_oEntity.jc_Typ_GeoArea&&jt_TypEntity!=jc_gl.jc_oEntity.jc_Typ_GeoRegion)
jt_ogldtGeoCountry=ji_odb.Get_DataTable(jc_gl.jc_oA3xaDbZero.jc_GLID_GeoCountry);if(jt_TypEntity!=jc_gl.jc_oEntity.jc_Typ_GeoArea&&jt_TypEntity!=jc_gl.jc_oEntity.jc_Typ_GeoRegion&&jt_TypEntity!=jc_gl.jc_oEntity.jc_Typ_GeoCountry)
jt_ogldtGeoState=ji_odb.Get_DataTable(jc_gl.jc_oA3xaDbZero.jc_GLID_GeoState);if(jt_ogldtGeoArea)
...
var jt_TypEntity=this.Get_3xXEID().Get_TypEntity();var jt_o3xaznc=this.Get_3xXEID().Get_3xAZNC();var jt_o3xcat=this.Get_3xXEID().Get_3xCat();if(jt_TypEntity==jc_gl.jc_oEntity.jc_Typ_Category||jt_TypEntity==jc_gl.jc_oEntity.jc_Typ_GeoCity||jt_TypEntity==jc_gl.jc_oEntity.jc_Typ_GeoState||jt_TypEntity==jc_gl.jc_oEntity.jc_Typ_GeoCountry||jt_TypEntity==jc_gl.jc_oEntity.jc_Typ_GeoRegion||jt_TypEntity==jc_gl.jc_oEntity.jc_Typ_GeoArea)
...
{var jt_squrDescr=jc_gl.QUR_Get_Descr2(this.jm_QUR,jt_TypEntity,jt_o3xaznc.Get_A(),jt_o3xaznc.Get_Z(),jt_o3xaznc.Get_N(),jt_o3xaznc.Get_C(),!jt_o3xcat.Get_Ucat()&&jt_TypEntity==jc_gl.jc_oEntity.jc_Typ_Enterprise);jt_sCategory=jt_squrDescr+"-"+jt_sCategory;}
...
jt_odt=jg_oApp.Get_Database().Get_MainDataTable(jt_A,jt_Z,jt_N);else if(jt_te==jc_gl.jc_oEntity.jc_Typ_MetaSystemControl)
jt_odt=jg_oApp.Get_Database().Get_DataTable(jc_gl.jc_oA3xaDbZero.jc_GLID_MetaSystemControl);else if(jt_te==jc_gl.jc_oEntity.jc_Typ_Category)
jt_odt=jg_oApp.Get_Database().Get_DataTable(jc_gl.jc_oA3xaDbZero.jc_GLID_Category);else if(jt_te==jc_gl.jc_oEntity.jc_Typ_GeoArea)
jt_odt=jg_oApp.Get_Database().Get_DataTable(jc_gl.jc_oA3xaDbZero.jc_GLID_GeoArea);else if(jt_te==jc_gl.jc_oEntity.jc_Typ_GeoRegion)
jt_odt=jg_oApp.Get_Database().Get_DataTable(jc_gl.jc_oA3xaDbZero.jc_GLID_GeoRegion);else if(jt_te==jc_gl.jc_oEntity.jc_Typ_GeoCity)
jt_odt=jg_oApp.Get_Database().Get_DataTable(jc_gl.jc_oA3xaDbZero.jc_GLID_GeoCity);else if(jt_te==jc_gl.jc_oEntity.jc_Typ_GeoCountry)
jt_odt=jg_oApp.Get_Database().Get_DataTable(jc_gl.jc_oA3xaDbZero.jc_GLID_GeoCountry);else if(jt_te==jc_gl.jc_oEntity.jc_Typ_GeoState)
jt_odt=jg_oApp.Get_Database().Get_DataTable(jc_gl.jc_oA3xaDbZero.jc_GLID_GeoState);var jt_ohse=jg_oApp.Get_HtmlSetEntity();if(jt_ohse)
...
jt_oxeidGroup.Set_IdEntity(jt_oxeidGroup.Get_IdGroup());var jt_oxur=new A3xaXur();jt_oxur.Set_UrlParams(jc_gl.jc_XURFN_ListEntity,null,null,jc_gl.jc_oQUR.jc_QUR_QueryViewEntity,jt_oxeidGroup.Get_String(),jc_gl.jc_XURTG_Single,null,null);jt_oxur.LinkMainData(jg_oe.Get_Database());jt_oxur.LinkCommonData(jg_oe.Get_Database(),false);var jt_te=jt_oxur.Get_3xXEID().Get_TypEntity();var jt_o3xaznc=jt_oxur.Get_3xXEID().Get_3xAZNC();var jt_o3xcat=jt_oxur.Get_3xXEID().Get_3xCat();var jt_oButton=new A3xaSimpleButton(jc_gl.Get_UrlIconEntity(this.jm_oxe.Get_3xXEID().Get_TypEntity()),jt_oxur.Get_A3xaUrl(false,true),this.jm_oxe.Get_3xEBIS().Get_Name(),jc_gl.QUR_Get_Descr2(jc_gl.jc_oQUR.jc_QUR_QueryViewEntity,jt_te,jt_o3xaznc.Get_A(),jt_o3xaznc.Get_Z(),jt_o3xaznc.Get_N(),jt_o3xaznc.Get_C(),!jt_o3xcat.Get_Ucat()&&jt_te==jc_gl.jc_oEntity.jc_Typ_Enterprise));jt_oButton.Set_Options(null,null,null,null,false,null,null);jt_oButton.PrintHtml(qi_oCell);return true;};this.PrintHtml_IconsAdmin_NewMajor=function(qi_oCell,ji_Row,ji_Col)
...
if(this.IsArea())
{var jt_oddiRequestArea=new A3xaDDItemRequestArea();var jt_nOfRows=jt_ogldtArea.Get_Recordset().Get_Count();jt_oddiRequestArea.Set_Descr("*** TODOS ***");var jt_odcer=new A3xaDCEntity();jt_odcer.Get_3xXEID().Set_GEID(jc_gl.jc_oEntity.jc_Typ_Enterprise,null,null,null);jt_odcer.Get_3xXEID().Get_3xCat().Clear();jt_odcer.Get_3xXEID().Get_3xAZNC().Clear();jt_odcer.Get_3xXEID().Get_3xPS().Clear();jt_oddiRequestArea.Set_DCEntity(jt_odcer);for(var i=0;i<jt_nOfRows;i++)
...
{return this.jm_oxeid&&this.jm_oxeid.Get_3xXEID().Get_TypEntity()==jc_gl.jc_oEntity.jc_Typ_MetaSystemControl;};this.Get_3xXEID=function(){return this.jm_oxeid||null;};this.ReplaceId=function(ji_RowHF)
{if(this.IsEOT())
...
qt_oRowH.after(jt_shTableRow);else;this.jm_ao3xehc.push(new A3xaEntity_HtmlFrameColumn(this,this.jm_oxe,this.jm_RowHF,jc_gl.jc_oHtml.jc_Col_IdTag));this.jm_ao3xehc.push(new A3xaEntity_HtmlFrameColumn(this,this.jm_oxe,this.jm_RowHF,jc_gl.jc_oHtml.jc_Col_LandIcons));this.jm_ao3xehc.push(new A3xaEntity_HtmlFrameColumn(this,this.jm_oxe,this.jm_RowHF,jc_gl.jc_oHtml.jc_Col_Identity));this.jm_ao3xehc.push(new A3xaEntity_HtmlFrameColumn(this,this.jm_oxe,this.jm_RowHF,jc_gl.jc_oHtml.jc_Col_InfoIcons));this.jm_ao3xehc.push(new A3xaEntity_HtmlFrameColumn(this,this.jm_oxe,this.jm_RowHF,jc_gl.jc_oHtml.jc_Col_ControlIcons));this.jm_ao3xehc.push(new A3xaEntity_HtmlFrameColumn(this,this.jm_oxe,this.jm_RowHF,jc_gl.jc_oHtml.jc_Col_AdminIcons));this.jm_ao3xehc.push(new A3xaEntity_HtmlFrameColumn(this,this.jm_oxe,this.jm_RowHF,jc_gl.jc_oHtml.jc_Col_Info));for(var i=0;i<this.jm_ao3xehc.length;i++)
...
{if(jt_oxe.Get_3xXEID().Get_TypEntity()==jc_gl.jc_oEntity.jc_Typ_MetaSystemControl)
continue;}
...
{var jt_oxe=jt_aoglr.Get_Item_ByIndex(jt_Row-1);if(jt_Row==1&&jt_oxe.Get_3xXEID().Get_TypEntity()==jc_gl.jc_oEntity.jc_Typ_MetaSystemControl)
...
var jt_DTStatus=ji_oDTStatus.Get();if(jt_DTStatus==jc_gl.jc_oA3xaDbZero.jc_DTStatus_Loaded||ji_oDTStatus.IsEmpty())
...
{var jt_StorageType=this.Get_Database().Get_StorageType(ji_glid);if(jc_gl.jc_oA3xaDbZero.IsDefaultGlid(ji_glid)&&jt_StorageType==jc_gl.jc_oStorage.jc_FLY)
