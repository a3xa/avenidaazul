...
{this.jm_bDebug=(ji_bDebug==true);this.jm_bCanEdit=ji_bCanEdit;this.jm_bCanLike=ji_bCanLike;this.jm_IdUser=ji_IdUser;this.jm_Itemid=ji_Itemid;this.jm_sDirBase=(ji_sDirBase?ji_sDirBase:"/");this.jm_sHomeDir=(ji_sHomeDir?ji_sHomeDir:"/");this.jm_sLang=(ji_sLang?ji_sLang:"en");return true;};this.CheckInitDone=function(){return true;};this.jm_oAjax2=new A3xaAjax2();this.jm_oMgrStorage=null;this.Get_MgrStorage=function(){return this.jm_oMgrStorage;};this.jm_odb=null;this.Set_Database=function(ji_odb){this.jm_odb=ji_odb;return true;};this.Get_Database=function(){return this.jm_odb;};this.jm_oHostReporter=null;this.Set_Reporter=function(ji_oHostReporter)
...
{var jt_this=this;this.jm_o3xhIconInfo=ji_o3xhIconInfo;this.jm_bMagnificPopup=false;this.jm_bTipPopup=false;this.jm_oPopupPluginInfo=null;this.jm_o3pbtnStatus=null;this.Get_HtmIconInfo=function(){return this.jm_o3xhIconInfo;};this.IsValid=function()
...
{this.jm_o3pbtnStatus=(ji_o3pbtnStatus||null);return true;};this.Set_Options2=function(ji_bTipPopup,ji_oPopupPluginInfo)
...
jt_shStyle+"/>";}}
var jr_sh="";if(this.jm_oPopupPluginInfo)
{this.jm_bMagnificPopup=true;if(this.jm_bMagnificPopup)
{var jt_shmfpbUrl=""
if(this.jm_oPopupPluginInfo.mediatype=="youtube")
jt_shmfpbUrl="https://www.youtube.com/watch?v="+this.jm_oPopupPluginInfo.info;else if(this.jm_oPopupPluginInfo.mediatype=="vimeo")
jt_shmfpbUrl="https://www.vimeo.com/"+this.jm_oPopupPluginInfo.info;else if(this.jm_oPopupPluginInfo.mediatype=="gmap")
jt_shmfpbUrl="https://www.google.com/maps?"+this.jm_oPopupPluginInfo.info;jr_sh+=(this.jm_o3xhIconInfo.HasParagraph()?"<p>":"");jr_sh+="<a id='mfpa_"+jt_sHtmIdSuffix+"'"+" href='"+jt_shmfpbUrl+"'"+" title='"+this.jm_o3xhIconInfo.Get_Title()+"' target='_blank'>"+jr_shImg+"</a>";jr_sh+=(this.jm_o3xhIconInfo.HasParagraph()?"</p>":"");}
else
...
{this.jm_bMagnificPopup=true;if(this.jm_bMagnificPopup)
{jr_sh+=(this.jm_o3xhIconInfo.HasParagraph()?"<p>":"");jr_sh+="<a id='mfpa_"+this.jm_o3xhIconInfo.Get_HtmId()+"'"+" href='#mfpc_"+this.jm_o3xhIconInfo.Get_HtmId()+"'"+" data-effect='mfp-3d-unfold'>"+jr_shImg+"</a>"+"<div id='mfpc_"+this.jm_o3xhIconInfo.Get_HtmId()+"'"+" class='white-popup mfp-with-anim mfp-hide'>"+
...
{var qt_omfpbtn=$("#mfpa_"+jt_sHtmIdSuffix);var jt_shmfpc="";if(jt_oPopupPluginInfo.mediatype=="youtube")
jt_shmfpc="<div class='white-popup'>"+"<iframe id='mfpi_"+jt_sHtmIdSuffix+"' width='"+(jt_oPopupPluginInfo.width||40)+"' height='"+(jt_oPopupPluginInfo.height||40)+"' src='https://www.youtube.com/embed/"+jt_oPopupPluginInfo.info+"' frameborder='0' allowfullscreen>"+"</iframe></div>";else if(jt_oPopupPluginInfo.mediatype=="vimeo")
jt_shmfpc="<div class='white-popup'>"+"<iframe id='mfpi_"+jt_sHtmIdSuffix+"' width='"+(jt_oPopupPluginInfo.width||40)+"' height='"+(jt_oPopupPluginInfo.height||40)+"' src='https://player.vimeo.com/video/"+jt_oPopupPluginInfo.info+"' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen>"+"</iframe></div>";else if(jt_oPopupPluginInfo.mediatype=="gmap")
jt_shmfpc="<div class='white-popup'>"+"<iframe id='mfpi_"+jt_sHtmIdSuffix+"' width='"+(jt_oPopupPluginInfo.width||40)+"' height='"+(jt_oPopupPluginInfo.height||40)+"' src='https://www.google.com/maps?"+jt_oPopupPluginInfo.info+"' frameborder='0' allowFullScreen>"+"</iframe></div>";qt_omfpbtn.magnificPopup({items:{src:jt_shmfpc,type:"inline"},callbacks:{open:function()
...
var jt_opdim=jg_oe.Get_PopupDim();var jt_oPopupPluginInfo={mediatype:"gmap",width:jt_opdim.w,height:jt_opdim.h,info:"ll="+jt_Lat+","+jt_Lon+"&z="+jt_Zoom+"&t=h&output=embed",fnAlt:function()
...
jt_TypInfo+"_"+jt_CodInfo+"_"+jt_IdInfo;jt_sTitle=jt_oParSB.jm_sTitle;jt_oPopupPluginInfo=this.ConvertPopupPluginInfo(jt_sInfo,jt_oParSB);}
...
{this.jc_oStorage=new A3xaDefines_Storage();this.jc_oA3xaDbZero=new A3xaDefines_A3xaDbZero();this.jc_oA3xaDbZero.Init(this.jc_oStorage);this.jc_oEntity=new A3xaDefines_Entity();this.jc_oEntityInfo=new A3xaDefines_EntityInfo();this.jc_oHtml=new A3xaDefines_Html();this.jc_oUrls=new A3xaDefines_Urls();this.jm_oAppXUR=new A3xaAppXUR();this.jm_oAppXUR.Set_DefXUR(new A3xaDefines_XUR());this.jc_oXUR=this.jm_oAppXUR.Get_DefXUR();this.jm_oAppMngIcons=new A3xaAppMngIcons();this.jm_oAppMngIcons.Set_DefIcons(new A3xaDefines_Icons());this.jc_oIcons=this.jm_oAppMngIcons.Get_DefIcons();this.jm_oMgrStorage=new A3xaStorageManager();this.Set_Reporter(new A3xaReporter());this.Set_Database(new A3xaDbZero());this.Get_MgrStorage().EnableStorage(function(ji_bReady){return jt_this.CheckInitDone();});this.jm_oMgrSummary=new A3xaMgrSummary();};this.HostInitApplication=function(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_IdUser,ji_Itemid,ji_sxur,ji_sDirBase,ji_sHomeDir,ji_sLang)
{this.A3xaAbsEnvironment_Set_CommonValues(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_IdUser,ji_Itemid,ji_sDirBase,ji_sHomeDir,ji_sLang);this.Set_Debug((ji_bDebug?1:0),{DB:3,DBT:"idb"});this.Get_AppXUR().Set_XURString(ji_sxur);return true;};this.Get_ECPMgr=function()
