...
{var jr_o3xxeid=this.jm_ogle.Get_3xXEID();if(!jr_o3xxeid)
return false;jr_o3xxeid.Set_GEID(this.Get_Field("f3x_enty"),this.Get_Field("f3x_enid"),this.Get_Field("f3x_egty"),this.Get_Field("f3x_egid"));jr_o3xxeid.Get_3xCat().Set_Category(this.Get_Field("f3x_cU"),this.Get_Field("f3x_cV"));jr_o3xxeid.Get_3xAZNC().Set_AZNC(this.Get_Field("f3x_gnA"),this.Get_Field("f3x_gnZ"),this.Get_Field("f3x_gnN"),this.Get_Field("f3x_gnC"));jr_o3xxeid.Get_3xPS().Set_PS(this.Get_Field("f3x_gpP"),this.Get_Field("f3x_gpS"));this.jm_ogle.Replace_3xEBID(this.Get_3xEBID());this.jm_ogle.Replace_3xEBIS(this.Get_3xEBIS());return true;};this.Get_3xEBIS=function(){return null;};this.Get_EI=function(){return this;};this.IsReady=function(){return this.IsValid()&&this.Get_3xXEID().IsValid();};this.Set_SubRecord=function(ji_SubType,ji_oglrSub)
{if(!(ji_SubType&&ji_oglrSub))
...
{A3xaREntity.call(this,ji_odcCache);this.Get_3xEBIS=function(){return this;};this.Get_Created=function(){return this.Get_Field("f3x_ucretime");};this.Get_Modified=function(){return this.Get_Field("f3x_umodtime");};this.Get_Order=function(){return this.Get_Field("f3x_esorder");};this.Get_Idsym=function(){return this.Get_Field("f3x_esym");};this.Get_Name=function(){return this.Get_Field("f3x_esname");};this.Get_Descr=function(){return this.Get_Field("f3x_esdescr");};this.Get_Website=function(){return this.Get_Field("f3x_esurl");};this.Get_Lat=function(){return this.Get_Field("f3x_eslat");};this.Get_Lon=function(){return this.Get_Field("f3x_eslon");};this.Get_Color=function()
{if(!this.jm_Color)
this.jm_Color=this.Get_Field("f3x_escolor");if(this.jm_Color)
...
return ji_aRecord;this.ConvertSpecialChars_Field(ji_aRecord,"f3x_esname");this.ConvertSpecialChars_Field(ji_aRecord,"f3x_esdescr");this.ConvertSpecialChars_Field(ji_aRecord,"f3x_esurl");return ji_aRecord;};}
function GLREBID()
...
{return this.Get_Field("f3x_enty");};this.Get_IdEntity=function()
{return this.Get_Field("f3x_enid");};this.Get_LikesTotal=function()
{return Number(this.Get_Field("f3x_likes"))+Number(this.Get_Field("f3x_likesbonus"));};this.Get_Clicks=function()
{return Number(this.Get_Field("f3x_clicks"));};this.Get_ClickTime=function()
{return this.Get_Field("f3x_clicksphtime");};this.Get_Score=function()
{return Number(this.Get_Field("f3x_score"));};}
...
{if(this.jm_bSummary)
{var jt_aEISummary=ji_oxe.Get_EInfoset(jg_oe.jc_oEntityInfo.jc_TI_SummaryEnterprises);for(var i=0;jt_aEISummary&&i<jt_aEISummary.length;i++)
...
return false;jt_o3xaitDTSummary.Reset();var jt_Select_A=ji_oxeid.Get_3xAZNC().Get_A();var jt_Select_Z=ji_oxeid.Get_3xAZNC().Get_Z();var jt_Select_N=ji_oxeid.Get_3xAZNC().Get_N();var jt_Select_Ucat=ji_oxeid.Get_3xCat().Get_Ucat();var jt_Select_Vcat=ji_oxeid.Get_3xCat().Get_Vcat();this.jm_o3xSummaryByLandAll=new A3xaSummaryInfoItem();this.jm_o3xaSummaryByTopArea=new A3xaArray();this.jm_o3xaSummaryByArea=new A3xaArray();this.jm_o3xaSummaryByRegion=new A3xaArray();this.jm_o3xaSummaryByCity=new A3xaArray();this.jm_o3xSummaryByCatAll=new A3xaSummaryInfoItem();this.jm_o3xaSummaryByCatGroup=new A3xaArray();this.jm_o3xaSummaryByCat=new A3xaArray();while(!jt_o3xaitDTSummary.IsEOF())
{var jt_o3xe=jt_o3xaitDTSummary.Get_CurrentItem();var jt_A=jt_o3xe.Get_3xXEID().Get_3xAZNC().Get_A();var jt_Z=jt_o3xe.Get_3xXEID().Get_3xAZNC().Get_Z();var jt_N=jt_o3xe.Get_3xXEID().Get_3xAZNC().Get_N();var jt_Ucat=jt_o3xe.Get_3xXEID().Get_3xCat().Get_Ucat();var jt_Vcat=jt_o3xe.Get_3xXEID().Get_3xCat().Get_Vcat();if(!jt_Select_Ucat||(jt_Ucat==jt_Select_Ucat&&(!jt_Select_Vcat||(jt_Vcat==jt_Select_Vcat))))
{var jt_o3xsiiTopArea=new A3xaSummaryInfoItem(jt_o3xe,false,false,true);this.jm_o3xSummaryByLandAll.Add(jt_o3xsiiTopArea);this._AddSummaryItem(this.jm_o3xaSummaryByTopArea,jt_o3xsiiTopArea);this._AddSummaryItem(this.jm_o3xaSummaryByArea,new A3xaSummaryInfoItem(jt_o3xe));if(jt_Select_Z)
this._AddSummaryItem(this.jm_o3xaSummaryByRegion,new A3xaSummaryInfoItem(jt_o3xe,false,true));}
if(!jt_Select_A||(jt_A==jt_Select_A&&(!jt_Select_Z||(jt_Z==jt_Select_Z&&(!jt_Select_N||(jt_N==jt_Select_N))))))
{var jt_o3xsiiCatGroup=new A3xaSummaryInfoItem(jt_o3xe,true);this.jm_o3xSummaryByCatAll.Add(jt_o3xsiiCatGroup);this._AddSummaryItem(this.jm_o3xaSummaryByCatGroup,jt_o3xsiiCatGroup);this._AddSummaryItem(this.jm_o3xaSummaryByCat,new A3xaSummaryInfoItem(jt_o3xe,true,true));}
jt_o3xaitDTSummary.Next();}
return true;};this._MakeSummaryMainEnterprises=function(ji_oxeid)
{var jt_o3xaitDTMain=this.jm_odtMain.Get_Recordsel();if(!jt_o3xaitDTMain)
...
{var jt_o3xaitDTMain=new A3xaArrayIt(this.jm_odtMain.Get_Recordset());if(!jt_o3xaitDTMain)
...
{this.jm_o3xmcr=new A3xaMgrCategory_Request(ji_bShowLabel);this.Get_MgrRequestCategory=function(){return this.jm_o3xmcr;};this.jm_o3xmcs=null;this.Get_MgrSelectCategory=function(){return this.jm_o3xmcs;};this.PrintHtml_Icon=function(qi_oParent,ji_oglrMain)
...
{}
var jt_oglrCategoryGroup=ji_ocg.o3xdtCat.Find(function(ji_oglrCatCur)
{if(ji_oglrCatCur.Get_3xXEID().Get_3xCat().Get_Vcat())
...
this.jm_oddbox.jm_bShowCount=true;return true;};this.LoadDataDD=function(ji_oDDCategoryCodeFilter,ji_oDDPairLandFilter)
...
{this.jm_o3xmlra=new A3xaMgrLand_RequestArea(jg_oe.jc_oEntity.jc_Typ_GeoArea);this.jm_o3xmlrr=new A3xaMgrLand_RequestArea(jg_oe.jc_oEntity.jc_Typ_GeoRegion);this.jm_o3xmlsp=null;};this.Get_MgrRequestArea=function(ji_TypEntity)
...
{if(jt_oglmLand.Get_MgrSelectPlace())
...
if(jt_oglmCategory.Get_MgrSelectCategory())
...
return(this.jm_o3xheCP.Get_3xEH()?true:false);var jt_oglmLand=new A3xaMgrLand();if(jt_oglmLand.Get_MgrSelectPlace())
{var jt_bDDLand=jt_oglmLand.Get_MgrSelectPlace().LoadDataDD(ji_oDDCategoryCode,ji_oDDPairLand);var jt_oDDPairLand=jt_oglmLand.Get_MgrSelectPlace().Get_DDSelected();jt_bDDLand&&jt_oglmLand.Get_MgrSelectPlace().RefreshHtmlDD(ji_oDDCategoryCode,ji_oDDPairLand);}
var jt_oglmCategory=new GLMgrCategory();if(jt_oglmCategory.Get_MgrSelectCategory())
{var jt_bDDCategory=jt_oglmCategory.Get_MgrSelectCategory().LoadDataDD(ji_oDDCategoryCode,ji_oDDPairLand);jt_bDDCategory&&jt_oglmCategory.Get_MgrSelectCategory().RefreshHtmlDD(ji_oDDCategoryCode,ji_oDDPairLand);}
var jt_o3xmlrr=jt_oglmLand.Get_MgrRequestArea(jg_oe.jc_oEntity.jc_Typ_GeoRegion);var jt_bo3xmlrr=(jt_o3xmlrr?jt_o3xmlrr.LoadDataDD(ji_oDDCategoryCode,ji_oDDPairLand):false);jt_bo3xmlrr&&jt_o3xmlrr.RefreshHtmlDD(ji_oDDCategoryCode,ji_oDDPairLand);var jt_bHideOrGray=false;var jt_bLandCountHigher=false;if(this.jm_nRows>jg_oe.jc_oHtml.jc_MaxViewRows)
...
jt_o3xcatl=new A3xaCategoryList(ji_oDDCategoryCode.Get_Value());var jt_FrameRow=1;while(1)
{var jt_o3xehf=new A3xaEntity_HtmlFrame(jt_FrameRow,true);if(jt_o3xehf.IsEOT())
break;if(jt_o3xehf.IsStick())
{jt_FrameRow++;continue;}
jt_o3xehf.ShowHeader(true,false);jt_FrameRow++;}
