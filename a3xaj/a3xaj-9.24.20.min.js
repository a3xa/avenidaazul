...
{if(!this.IsValid())
return false;var jt_sDescr=this.jm_oxe.Get_LDescr();if(jt_sDescr)
...
{var jt_aoeifa=this.jm_oxe.Get_Info(jt_aTypInfo[i],null);var jt_ogeiattr=new A3xaEntityInfo_Attributes(this.jm_oxe.Get_LName(),true,ji_Row,ji_Col);var jt_ogeiset=new A3xaEntityInfoSet(this.jm_oxe,jt_aoeifa,jt_ogeiattr);jt_ogeiset.PrintHtml(qi_oCell);}
...
var jt_ogeiattrCommon=new A3xaEntityInfo_Attributes(this.jm_oxe.Get_LName(),true,ji_Row,ji_Col);var jt_aoeifaMain=this.jm_oxe.Get_Info(jg_oe.jc_oEntityInfo.jc_TI_Image,null);var jt_ogeiset=new A3xaEntityInfoSet(this.jm_oxe,jt_aoeifaMain,jt_ogeiattrCommon);jt_ogeiset.PrintHtml(qt_oParent);if(jt_oglrGeoRegion)
...
{var jt_aoeifa=this.jm_oxe.Get_Info(jt_aTypInfo[i],null);var jt_ogeiattr=new A3xaEntityInfo_Attributes(this.jm_oxe.Get_LName(),true,ji_Row,ji_Col);jg_oe.CanLogInfo()&&jg_oe.LogInfo("jt_aoeifa: "+
...
{jt_oddig=new A3xaDDItemRequestCategory();jt_oddig.Set_Key(jt_sCatGroup);jt_oddig.Set_Value(jt_sCatGroup);jt_oddig.Set_Descr(ji_oglr.Get_LDescr());jt_oddig.jm_bOnChange=false;jt_oddig.Set_Order(ji_oglr.Get_3xEBIS().Get_Order());this.Add_Child(jt_oddig);}
