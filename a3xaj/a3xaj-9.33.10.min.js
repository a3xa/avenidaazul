...
jr_s+="apagado";return jr_s;};this.jm_oAjax2=new A3xaAjax2();this.jm_StorageTypeDefault=null;this.jm_aoStorage=[];this.Set_Storage=function(ji_oStorage)
{if(!ji_oStorage)
...
function A3xaAjax2()
{this.QueueRequest=A3xaAjax2_QueueRequest;this.SendRequestQueued=A3xaAjax2_SendRequestQueued;this.SetTimeout=A3xaAjax2_SetTimeout;this.jm_aQueueRequest=[];this.jm_oAjaxRequestCurrent=null;this.jm_bBusy=false;this.jm_bTimeout=false;this.jm_oAjaXHR=null;this.jm_2ndTimer=null;this.jm_Id="a3xaajax2tag";}
...
{if(!ji_o3x2tb)
return false;var jt_o3xJSDS=this.New3xJSDS();if(!jt_o3xJSDS.Set_GLDString(this.Get_Glid(),ji_o3x2tb.tb.getJSDS()))
...
return new A3xaAbsDbEntity();else if(jt_oDbSchemaTable.jp_SubTable==jg_oe.jc_oA3xaDbZero.jc_tbtype_ebis.tbtname)
return new A3xaAbsDbEntity();else if(jt_oDbSchemaTable.jp_SubTable==jg_oe.jc_oA3xaDbZero.jc_tbtype_ebid.tbtname)
return new A3xaAbsDbEntity();else if(jt_oDbSchemaTable.jp_SubTable==jg_oe.jc_oA3xaDbZero.jc_tbtype_ei.tbtname)
...
{this.jm_oDTStatus.SetLoadStatusSuccess();return true;};this.Get_3xDbEntity=function(ji_id){return this.Get_Recordset().Get_Item(ji_id);};this.Set_3xDbEntity=function(ji_id,ji_oglr){return this.Get_Recordset().Set_Item(ji_id,ji_oglr);};this.Get_3xDbEntityAX=function(ji_AltKey){return(this.jm_bAX?this.Get_RecordsetAX().Get_Item(ji_AltKey):null);};this.Get_Recordset=function(){return this.jm_aoglr||null;};this.Get_RecordsetAX=function(){return this.jm_aoglrAX||null;};this.New_Recordsel=function(ji_sSelectName,ji_fnSelect,ji_MaxItems)
...
{var jr_I={addTablesJSDS:function(){return false;},addD3xTable:function(ji_sdsTable,ji_bJSON){return null;},add3x2Table:function(ji_o3x2tb){return false;},get3x2Table:function(ji_glid,ji_name,ji_type){return null;},new3x2Table:function(ji_sdsTable,ji_bJSON){return null;}};jr_I.new3x2Table=function(ji_sdsTable,ji_bJSON)
...
return false;var jt_glid=ji_o3x2tb.tb.getGlid();var jt_name=ji_o3x2tb.tb.getName();var jt_type=ji_o3x2tb.tb.getType();var jt_id=jt_glid+","+jt_type;if(!jr_o.jm_o3x2a.ar.setItem(jt_id,ji_o3x2tb))
...
function A3xa2DTCacheWriter(ji_odb,ji_glid,ji_sGLRS)
{var jr_o={jm_odb:null,jm_glid:null,jm_header_glid:null,jm_header_release:null,jm_o3xJSDS:null,jm_odt:null,jm_aglRS:null,csw:A3xa2IDTCacheWriter(),_Construct:function(ji_odb,ji_glid,ji_sGLRS)
{if(ji_glid)
ji_glid=jg_oe.jc_oA3xaDbZero.XGlid2Glid(ji_glid);jr_o.jm_odb=ji_odb;jr_o.jm_glid=ji_glid;if(ji_sGLRS)
jr_o.jm_aglRS=ji_sGLRS.split(jg_oe.jc_oA3xaDbZero.jc_GLSep_Block);}};jr_o.csw.writeTable=function()
{if(!(jr_o.jm_glid))
return false;if(!jr_o.jm_aglRS)
return false;if(!(jr_o.jm_odb&&jr_o.jm_glid))
return false;jr_o.jm_odt=jr_o.jm_odb.NewDataTableCacheStore(jr_o.jm_glid);if(!jr_o.jm_odt)
return false;jr_o.jm_odb.jm_oDTStatus.SetCacheStatusInProgress("Cache Tableset "+jr_o.jm_glid);jr_o.jm_odb.jm_aoglDataTableStore.Set_Item(jr_o.jm_glid,jr_o.jm_odt);jr_o.jm_odt.jm_oDTStatus.SetCacheStatusInProgress();jr_o.jm_o3xJSDS=jr_o.jm_odt.New3xJSDS();if(!jr_o.csw.writeJSDS())
{if(jr_o.jm_odb)
...
jr_o.jm_odt.jm_o3xJSDS=jr_o.jm_o3xJSDS;jr_o.jm_odt.Set_Glid(jr_o.jm_glid);jr_o.jm_odt.Set_Release(jr_o.jm_header_release);jr_o.jm_odt.jm_oDTStatus.SetCacheStatusSuccess();return(jr_o.jm_odt.jm_oDTStatus.IsSuccess());};jr_o.csw.writeJSDS=function()
{if(!jr_o.jm_o3xJSDS)
return false;var jt_aHeader2=jr_o.jm_aglRS[0].split(jg_oe.jc_oA3xaDbZero.jc_GLSep_Header);var jt_aHeader=((jt_aHeader2&&jt_aHeader2[1])?jt_aHeader2[1].split(jg_oe.jc_oA3xaDbZero.jc_GLSep_Field):null);if(!(jt_aHeader&&jt_aHeader.length>0))
return false;jr_o.jm_header_glid=jg_oe.jc_oA3xaDbZero.XGlid2Glid(jt_aHeader2[0]);jr_o.jm_header_release=jt_aHeader[0];var jt_aFieldNames2=jr_o.jm_aglRS[1].split(jg_oe.jc_oA3xaDbZero.jc_GLSep_Header);var jt_aFieldNames=((jt_aFieldNames2&&jt_aFieldNames2[1])?jt_aFieldNames2[1].split(jg_oe.jc_oA3xaDbZero.jc_GLSep_Field):null);if(!(jt_aFieldNames&&jt_aFieldNames.length>1))
...
jt_JSDS+=('[[""]]');}}
jt_JSDS+=']';}}
jt_JSDS+=']}';return jr_o.jm_o3xJSDS.Set_GLDString(jr_o.jm_glid,jt_JSDS);};jr_o._Construct(ji_odb,ji_glid,ji_sGLRS);return jr_o;}
...
return this.jm_aoglDataTableLoad_Main;return null;};this.NewDataTableCacheStore=function(ji_glid){return this.NewDataTable(ji_glid);};this.NewDataTable=function(ji_glid){return null;};this.Get_MainDataTable=function(ji_A,ji_Z,ji_N){return null;};this.Get_DataTable=function(ji_glid,ji_bDontCheck)
...
return new GLDataStatusCacheFail("Header glid");this.jm_odtToLoad.Set_Release(jt_o3x2tb.tb.getVersion());}}}
...
jt_odtTOC.jm_oDTStatus.SetCacheStatusFail("Header glid");else
{jt_odtTOC.Set_Release(jt_o3x2tbTOC.tb.getVersion());jt_odtTOC.jm_oDTStatus.SetCacheStatusSuccess();}}}
...
{jt_this.jm_oDatabase.jm_aoDTStatus_TableToClear=null;return jt_this.StoreTOC(true);}
return true;}
...
{jt_this.jm_oDatabase.jm_aoDTStatus_TableToClear=null;jt_this.jm_oDatabase.jm_aoglDataTableStore=new A3xaArray();if(jt_this.jm_fnOnLoadDone)
...
(this.jm_oDTStatus.jm_fnOnChange?"Y":"null"),"","A3xaDbLOader._OnEnd_Record");return new GLDataStatusLoadSuccess();};this._LoadTables=function(ji_pTypTables)
{this.jm_pTypTables=ji_pTypTables;this.jm_oDatabase.ClearArrayDTLoad(this.jm_pTypTables);var jt_ogtl=this._Get_GlidsToLoad();if(jt_ogtl.jarr&&jt_ogtl.jarr.length)
...
this.Reset();this.Start();return true;};this._Get_GlidsToLoad=function()
...
{var jt_bTargetTable=false;if(this.IsTOCTables())
...
break;jr_aGlidToLoad.push(jt_sTableNameQUR);}
...
{if(!ji_aGlidToLoad)
return null;var jt_odbsds=this.jm_oDatabase.Get_SDSDBStore();var jt_odbsdswk=this.jm_oDatabase.Get_SDSDBWork();var jt_aodtToLoad=this.jm_oDatabase.Get_ArrayDTLoad(this.jm_pTypTables);var jr_aGlidToLoad=[];for(var i=0;i<ji_aGlidToLoad.length;i++)
{var jt_glid=ji_aGlidToLoad[i];var jt_odtToReuse=null;var jt_o3xtbsds=null;if(this.IsCommonTables())
{jt_odtToReuse=this.jm_oDatabase.Get_DataTableCacheStore(jt_glid);jt_o3xtbsds=jt_odbsds.db.get3x2Table(jt_glid);if(!(jt_odbsds&&jt_odtToReuse&&jt_odtToReuse.jm_oDTStatus.IsSuccess()&&!jt_odtToReuse.jm_oDTStatus.IsEmpty()))
...
{jt_odtToReuse.Set_Release(jt_o3xtbsds.tb.getVersion());}
else
jt_o3xtbsds=null;}
if(!(jt_o3xtbsds&&jt_o3xtbsds.tb.getCountOfRecords()>0))
jt_odtToReuse=null;jt_o3xtbsds=null;}
...
{jt_odtToReuse=null;jt_o3xtbsds=null;}}}
if(jt_odtToReuse)
{jt_odtToReuse.jm_oDTStatus=new GLDataStatusLoadSuccess();jt_aodtToLoad.Set_Item(jt_glid,jt_odtToReuse);}
else
{jr_aGlidToLoad.push(jt_glid);}}
return jr_aGlidToLoad;};this._SetupLoadedRecords=function()
{for(var i=0;i<this.jm_oDatabase.jm_oDbSchema.jm_aTables.length;i++)
...
{A3xaStorage.call(this);this.Get_Type=A3xaStorageFLY_Get_Type;this.ExecClear=A3xaStorageFLY_ExecClear;this.ExecWrite=A3xaStorageFLY_ExecWrite;this.ExecRead=A3xaStorageFLY_ExecRead;this.ExecOpen=function(ji_oDbTransaction,ji_oSchema){return true;};this.jm_bAvailable=true;this.jm_aFlyStorage=[];}
function A3xaStorageFLY_Get_Type(){return jg_oe.jc_oStorage.jc_FLY;}
function A3xaStorageFLY_ExecClear(ji_oDbTransaction)
{this.jm_aFlyStorage=[];return true;}
...
this.jm_oDbSchema.jm_aTablesExtension=[];for(var ii=0;ii<jt_aTablesAppend.length;ii++)
...
New_A3xaAZNMC_XApp(jt_o3xxeidxur.Get_3xAZNMC()).Set_LA();jr_oglrMSC=jt_ogldtMSC.Get_3xDbEntityAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));if(jr_oglrMSC)
return jr_oglrMSC;jt_o3xxeidxur.Get_3xPS().Clear_S();jr_oglrMSC=jt_ogldtMSC.Get_3xDbEntityAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));if(jr_oglrMSC)
return jr_oglrMSC;}
...
{jt_o3xxeidxur.Get_3xAZNMC().Clear_C();jr_oglrMSC=jt_ogldtMSC.Get_3xDbEntityAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));if(jr_oglrMSC)
return jr_oglrMSC;}
if(jt_o3xxeidxur.Get_3xAZNMC().Get_Z())
{jt_o3xxeidxur.Get_3xAZNMC().Clear_NC();jr_oglrMSC=jt_ogldtMSC.Get_3xDbEntityAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));if(jr_oglrMSC)
return jr_oglrMSC;}
New_A3xaAZNMC_XApp(jt_o3xxeidxur.Get_3xAZNMC()).Set_LA();jr_oglrMSC=jt_ogldtMSC.Get_3xDbEntityAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));if(jr_oglrMSC)
return jr_oglrMSC;jt_o3xxeidxur.Get_3xAZNMC().Clear();jr_oglrMSC=jt_ogldtMSC.Get_3xDbEntityAX(jt_o3xxeidxur_xapp.BuildAltKey(jg_oe.jc_oEntity.jc_Typ_MetaSystemControl));return jr_oglrMSC;};this._A3xaDbZero();}
...
{var jt_key=jt_o3x2index.ar.getKey(i);var jt_o3x2rec=jt_o3x2index.ar.getItem(jt_key);var jt_o3xdbe=this.New3xDbEntity();jt_o3xdbe.Set_SDS3x2Record(jt_o3x2rec);jt_a3x2oglr.ar.addItem(jt_key,jt_o3xdbe);}
...
function A3xaAbsDbEntity()
{this.jm_o3x2rec=null;this.Set_SDS3x2Record=function(ji_o3x2rec){this.jm_o3x2rec=ji_o3x2rec;return true;};this.Get_SDS3x2Record=function(){return this.jm_o3x2rec;};this.Get_Field=function(ji_name)
...
return null;return jt_o3x2rsfa.rs.getD3xRecordset();};this.ConvertSpecialChars=function(ji_sValue)
{if(!ji_sValue)
return ji_sValue;return ji_sValue.replace(/__at2__/g,"@").replace(/&#40;/g,"(").replace(/&#41;/g,")").replace(/&apos;/g,"'");};this.jm_aoglrSub=[];this.Set_SubDbEntity=function(ji_SubType,ji_oglrSub)
...
{return(ji_SubType?this.jm_aoglrSub[ji_SubType]||null:null);};}
...
return false;return true;};this.Get_3xEBIS=function(){return this.Get_SubDbEntity(jg_oe.jc_oA3xaDbZero.jc_tbtype_ebis.tbtname);};this.Get_3xEBID=function(){return this.Get_SubDbEntity(jg_oe.jc_oA3xaDbZero.jc_tbtype_ebid.tbtname);};this.Get_3xEI=function(){return this.Get_SubDbEntity(jg_oe.jc_oA3xaDbZero.jc_tbtype_ei.tbtname);};this.Get_3xsName=function(){return this.Get_3xEI().Get_3xsName();};this.Get_LName=function()
...
return this.jm_Color;return this.jm_DefaultColor;};}
function GLREBID()
{A3xaAbsDbEntity.call(this,null);this.Get_3xEBID=function(){return this;};this.Get_TypEntity=function(){return this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebidf_enty);};this.Get_IdEntity=function(){return this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_ebidf_enid);};this.Get_LikesTotal=function()
...
function GLREI()
{A3xaAbsDbEntity.call(this,null);this.jm_aoeifa=null;this.Get_3xEI=function(){return this;};this.Get_TypEntity=function(){return this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eif_enty);};this.Get_IdEntity=function(){return this.Get_Field(jg_oe.jc_oA3xaDbZero.jc_eif_enid);};this.Get_Info=function(ji_TypInfo,ji_IdInfo)
{if(!this.jm_aoeifa)
{this.CacheInfo();if(!this.jm_aoeifa)
return null;}
if(!this.jm_aoeifa.length)
return null;var jt_aoeifa_Selected=[];for(var i=0;i<this.jm_aoeifa.length;i++)
...
return true;var jt_aoeifa=[];for(var i=0;i<jt_arsInfo.length;i++)
...
jt_oeifa.jm_arsSlaves=[];jt_oeifa.jm_arsSlaves.push(jt_aInfo);}}}
...
return"Update";}
return ji_sQUR+"_unknown";};this.jm_oxur=new A3xaXur();this.Get_3xXUR=function(){return this.jm_oxur;};this.Set_3xXUR=function(ji_oxur){this.jm_oxur=(ji_oxur||null);return true;};this.jm_ao3xurQueue=[];this.Set_XURString=function(ji_sxur)
...
{this.jm_ao3xurQueue=[];this.jm_ao3xurQueue.push(jt_o3xXUR);this.AjaxQueueQueryRequest();return true;}
...
var jg_aoglGoogleMap=[];function A3xaGoogleMap(ji_Row,ji_Col,ji_Lat,ji_Lon,ji_Zoom,ji_sTip)
...
{var jt_this=this;this.jm_TimerLoPry=null;this.jm_bReleased=false;this.jm_FirstFrameRow=0;this.jm_nRows=0;this.jm_ao3xehf=[];this.jm_ao3xeh=[];this.jm_bCanRemoveStick=false;this.jm_bUpdateHtml=false;this._A3xaHtmlEntityAbs=function()
...
var jt_keyname=jg_oe.jc_oA3xaDbZero.Glid2SDSTbType(ji_glid).tbtkeyname;if(jg_oe.jc_oA3xaDbZero.XGlid2Glid(ji_glid)==jg_oe.jc_oA3xaDbZero.jc_GLID_MetaSystemControl&&this.Get_Database().Get_SDSDBStore())
{this.Get_Database().jm_oDTStatus.SetCacheStatusInProgress("Cache Tableset "+
jg_oe.jc_oA3xaDbZero.jc_GLID_MetaSystemControl);var jt_bFail=false;var jt_otb=this.Get_Database().NewDataTableCacheStore(jg_oe.jc_oA3xaDbZero.jc_GLID_MetaSystemControl);this.Get_Database().jm_aoglDataTableStore.Set_Item(jg_oe.jc_oA3xaDbZero.jc_GLID_MetaSystemControl,jt_otb);var jt_o3x2tb=this.Get_Database().Get_SDSDBStore().db.get3x2Table(jg_oe.jc_oA3xaDbZero.jc_GLID_MetaSystemControl);if(!(jt_otb&&jt_o3x2tb&&jt_otb.Get_Glid()==jt_o3x2tb.tb.getGlid()))
{jt_bFail=true;if(jt_otb)
jt_otb.jm_oDTStatus.SetCacheStatusFail("Missing Table Name");}
else
{jt_otb.Set_Release(jt_o3x2tb.tb.getVersion());jt_otb.Build_3xJSDS(jt_o3x2tb);jt_otb.jm_oDTStatus.SetCacheStatusSuccess();}
var jt_otbp=this.Get_Database().NewDataTableCacheStore(jg_oe.jc_oA3xaDbZero.jc_GLID_PMetaSystemControl);this.Get_Database().jm_aoglDataTableStore.Set_Item(jg_oe.jc_oA3xaDbZero.jc_GLID_PMetaSystemControl,jt_otbp);var jt_o3x2tbp=this.Get_Database().Get_SDSDBStore().db.get3x2Table(jg_oe.jc_oA3xaDbZero.jc_GLID_PMetaSystemControl);if(!(jt_otbp&&jt_o3x2tbp&&jt_otbp.Get_Glid()==jt_o3x2tbp.tb.getGlid()))
{jt_bFail=true;if(jt_otbp)
jt_otbp.jm_oDTStatus.SetCacheStatusFail("Missing Table Name");}
else
{jt_otbp.Set_Release(jt_o3x2tbp.tb.getVersion());jt_otbp.Build_3xJSDS(jt_o3x2tbp);jt_otbp.jm_oDTStatus.SetCacheStatusSuccess();}
var jt_otbf=this.Get_Database().NewDataTableCacheStore(jg_oe.jc_oA3xaDbZero.jc_GLID_FMetaSystemControl);this.Get_Database().jm_aoglDataTableStore.Set_Item(jg_oe.jc_oA3xaDbZero.jc_GLID_FMetaSystemControl,jt_otbf);var jt_o3x2tbf=this.Get_Database().Get_SDSDBStore().db.get3x2Table(jg_oe.jc_oA3xaDbZero.jc_GLID_FMetaSystemControl);if(!(jt_otbf&&jt_o3x2tbf&&jt_otbf.Get_Glid()==jt_o3x2tbf.tb.getGlid()))
{jt_bFail=true;if(jt_otbf)
jt_otbf.jm_oDTStatus.SetCacheStatusFail("Missing Table Name");}
else
{jt_otbf.Set_Release(jt_o3x2tbf.tb.getVersion());jt_otbf.Build_3xJSDS(jt_o3x2tbf);jt_otbf.jm_oDTStatus.SetCacheStatusSuccess();}
if(jt_bFail)
this.Get_Database().jm_oDTStatus.SetCacheStatusFail("Missing Table Name"+
jg_oe.jc_oA3xaDbZero.jc_GLID_MetaSystemControl);else
this.Get_Database().jm_oDTStatus.SetCacheStatusSuccess();}
else
{var jt_o3x2dtcsw=A3xa2DTCacheWriter(this.Get_Database(),ji_glid,ji_sGLRS);jr_b=jt_o3x2dtcsw.csw.writeTable();}}}
catch(e)
