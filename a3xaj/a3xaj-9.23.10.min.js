...
{var jt_odce=new A3xaDCEntity();jt_odce.Get_3xXEID().Set_String(jt_RowElem.getAttribute('XEIDCode'));var jt_o3xcat_xapp=new A3xaCategoryCode_XApp(jt_odce.Get_3xXEID());if(jt_o3xcat_xapp.IsMetasystem_Control()&&jg_oApp.jm_oecp&&ji_Row==1)
...
{return this._A3xaEntity_Html_PrintHtml_LandBox(qi_oCell,ji_Row,ji_Col,ji_bCountryFlag,ji_ColImages);};this._A3xaEntity_Html_PrintHtml_LandBox=function(qi_oCell,ji_Row,ji_Col,ji_bCountryFlag,ji_ColImages)
...
this.PrintHtml_FilterBoxCP=function(qi_oCell,ji_Row,ji_Col,ji_oCPLandButtonStatus)
...
ji_oCPLandButtonStatus.jm_Value="OFF";this.jm_oecpOrder.LoadDataDD();this.jm_oecpOrder.PrintHtmlDD(qi_oCell);return true;};this.PrintHtml_IdentityBoxCP=function(qi_oCell,ji_Row,ji_Col)
...
{var jt_ociPanel=new A3xaPanelControlIcons(null,-1,ji_Row,ji_Col,true,true);var jt_oBtnTurbo=jt_ociPanel.Get_Button("Turbo");jt_oBtnTurbo.PrintHtml(qi_oCell);return true;};this.ShowHtmlSelected=function()
...
var jt_odb=jg_oe.Get_Database();if(!jt_odb)
return false;jg_oApp.HideLeftPanel();var jt_RowHF=1;var jt_o3xxemsc=jt_odb.Get_3xXEMSC_ByXUR();if(jt_o3xxemsc)
...
{this.A3xaAbsEnvironment_Set_CommonValues(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_IdUser,ji_Itemid,ji_sDirBase,ji_sHomeDir,ji_sLang);this.Set_Debug((ji_bDebug?1:0),{VW:3,DB:3});this.Get_AppXUR().Set_XURString(ji_sxur);return true;};this._OnDocumentReady=function()
