...
return false;};this.Get_Lang=function(){return this.jm_sLang;};}
...
jt_shStyleDIS+=" "+jt_sHtmlDIS_visibility;jt_shON="<img id='"+jt_Id+"_ON'"+" name='"+jt_Id+"_ON'"+" src='"+(this.jm_o3xhIconInfo.Get_UrlImageTransparent()||"")+"' "+" width='"+this.jm_o3xhIconInfo.Get_Width()+"' "+" height='"+this.jm_o3xhIconInfo.Get_Height()+"' "+" border='0' alt='"+this.jm_sAlt+"' title='"+this.jm_o3xsTitle.Get_LString()+"' "+" style='"+jt_shStyleON+"' "+" onclick = '"+jt_sfnOnClick_Full+"' "+"/>";jt_shOFF="<img id='"+jt_Id+"_OFF'"+" name='"+jt_Id+"_OFF'"+" src='"+(this.jm_o3xhIconInfo.Get_UrlImageTransparent()||"")+"' "+" width='"+this.jm_o3xhIconInfo.Get_Width()+"' "+" height='"+this.jm_o3xhIconInfo.Get_Height()+"' "+" border='0' alt='"+this.jm_sAlt+"' title='"+this.jm_o3xsTitle.Get_LString()+"' "+" style='"+jt_shStyleOFF+"' "+" onclick = '"+jt_sfnOnClick_Full+"' "+"/>";jt_shDIS="<img id='"+jt_Id+"_DIS'"+" name='"+jt_Id+"_DIS'"+" src='"+(this.jm_o3xhIconInfo.Get_UrlImageTransparent()||"")+"' "+" width='"+this.jm_o3xhIconInfo.Get_Width()+"' "+" height='"+this.jm_o3xhIconInfo.Get_Height()+"' "+" border='0' alt='"+this.jm_sAlt+"' title='"+this.jm_o3xsTitle.Get_LString()+"' "+" style='"+jt_shStyleDIS+"' "+" onclick = '"+jt_sfnOnClick_Full+"' "+"/>";}
else
{jt_shON="<img id='"+jt_Id+"_ON'"+" name='"+jt_Id+"_ON'"+" src='"+this.jm_sSrcBase+"ON"+jg_oe.jc_oIcons.jc_sIconExt+"'"+" border='0' alt='"+this.jm_sAlt+"' title='"+this.jm_o3xsTitle.Get_LString()+"'"+" width='"+this.jm_width+"' height='"+this.jm_height+"'"+" style='"+jt_sHtmlON_visibility+"'"+" onclick = '"+jt_sfnOnClick_Full+"' />";jt_shOFF="<img id='"+jt_Id+"_OFF'"+" name='"+jt_Id+"_OFF'"+" src='"+this.jm_sSrcBase+"OFF"+jg_oe.jc_oIcons.jc_sIconExt+"'"+" border='0' alt='"+this.jm_sAlt+"' title='"+this.jm_o3xsTitle.Get_LString()+"'"+" width='"+this.jm_width+"' height='"+this.jm_height+"'"+" style='"+jt_sHtmlOFF_visibility+"'"+" onclick = '"+jt_sfnOnClick_Full+"' />";jt_shDIS="<img id='"+jt_Id+"_DIS'"+" name='"+jt_Id+"_DIS'"+" src='"+this.jm_sSrcBase+"DIS"+jg_oe.jc_oIcons.jc_sIconExt+"'"+" border='0' alt='"+this.jm_sAlt+"' title='"+this.jm_o3xsTitle.Get_LString()+"'"+" width='"+this.jm_width+"' height='"+this.jm_height+"'"+" style='"+jt_sHtmlDIS_visibility+"' />";}
...
{if(!this.IsValid())
return false;var qt_oParent=qi_oCell;var jt_sName=(this.jm_oxe.Get_3xEBIS().Get_Name()||"Website");var jt_aoeifa4LName=this.jm_oxe.Get_Info(jg_oe.jc_oEntityInfo.jc_TI_4LName,null);var jt_o3xs4LName=new A3xaString();for(var iname=0;jt_aoeifa4LName&&iname<jt_aoeifa4LName.length;iname++)
{var jt_aMaster=jt_aoeifa4LName[iname].Get_Master();var jt_TypInfo=jt_aMaster[jg_oe.jc_oA3xaDbZero.jc_Eifa_Typ];var jt_CodInfo=jt_aMaster[jg_oe.jc_oA3xaDbZero.jc_Eifa_Cod];var jt_IdInfo=jt_aMaster[jg_oe.jc_oA3xaDbZero.jc_Eifa_Id];var jt_sInfo=jt_aMaster[jg_oe.jc_oA3xaDbZero.jc_Eifa_Info];if(jt_CodInfo!=jg_oe.jc_oEntityInfo.jc_CI_4LName_Text)
continue;jt_o3xs4LName.Set_IString(jt_IdInfo,jt_sInfo);}
if(jt_o3xs4LName.Get_LString())
jt_sName=jt_o3xs4LName.Get_LString();var jt_xTypEntity=this.jm_oxe.Get_3xXEID().Get_TypEntity();var jt_xIdEntity=this.jm_oxe.Get_3xXEID().Get_IdEntity();var jt_oUrlWebsite=new A3xaUrl(this.jm_oxe.Get_3xEBIS().Get_Website(),null);var jt_sUrlWebsite=jt_oUrlWebsite.Get_Url();if(jt_sUrlWebsite)
...
qt_oParent.append("<span style='color: #8080F0; text-shadow: 1px 1px 0px #000000;'>"+"<strong>"+jt_sName+"</strong></span>");return true;};this.PrintHtml_DescrBox=function(qi_oCell)
{if(!this.IsValid())
...
{var jt_aoeifa=this.jm_oxe.Get_Info(jt_aTypInfo[i],null);var jt_ogeiattr=new A3xaEntityInfo_Attributes(this.jm_oxe.Get_3xEBIS().Get_Name(),true,ji_Row,ji_Col);var jt_ogeiset=new A3xaEntityInfoSet(this.jm_oxe,jt_aoeifa,jt_ogeiattr);jt_ogeiset.PrintHtml(qi_oCell);}
...
var jt_ogeiattrCommon=new A3xaEntityInfo_Attributes(this.jm_oxe.Get_3xEBIS().Get_Name(),true,ji_Row,ji_Col);var jt_aoeifaMain=this.jm_oxe.Get_Info(jg_oe.jc_oEntityInfo.jc_TI_Image,null);var jt_ogeiset=new A3xaEntityInfoSet(this.jm_oxe,jt_aoeifaMain,jt_ogeiattrCommon);jt_ogeiset.PrintHtml(qt_oParent);if(jt_oglrGeoRegion)
...
{var jt_aoeifa=this.jm_oxe.Get_Info(jt_aTypInfo[i],null);var jt_ogeiattr=new A3xaEntityInfo_Attributes(this.jm_oxe.Get_3xEBIS().Get_Name(),true,ji_Row,ji_Col);jg_oe.CanLogInfo()&&jg_oe.LogInfo("jt_aoeifa: "+
...
{this.jm_aoParametersSB=ji_aoParametersSB;return true;};this.ConvertUrlLink=function(ji_s,ji_oParametersSB){return ji_s;};this.ConvertSimplePopupPluginContents=function(ji_s,ji_oParametersSB){return ji_s;};this.PrintHtml=function(qi_oParent)
{if(!this.IsValid())
return false;if(!(qi_oParent&&qi_oParent.length))
...
jg_oe.jc_oA3xaDbZero.jc_GLMID_AX);var jt_o3xhici=jg_oe.Get_3xAppMngIcons().NewSprite(jg_oe.jc_oIcons.jc_oIconMS_Turbo.absid);jt_oBtnTurbo.Set_SrcInfo4(jt_o3xhici,["A3xaTurboZero (...developing...) - now is "+jg_oe.Get_TurboDescr(),"A3xaTurboZero (...en desarrollo...) - ahora está "+jg_oe.Get_TurboDescr(),"A3xaTurboZero (...em construção...) - agora é "+jg_oe.Get_TurboDescr(),"A3xaTurboZero (...in sviluppo...) - ora è "+jg_oe.Get_TurboDescr()],"Turbo","jg_oPanelControlIcons_Builder.OnClick",-1,jt_oAjaxUrlParams?jt_oAjaxUrlParams.Get_UrlParams():"");jt_oBtnTurbo.AttachProperties(false,false,true);jt_oBtnTurbo.Set_Status(jg_oe.IsTurboON()?"ON":"OFF",false);}
...
{jg_oe.LogStatusBar2(new A3xaString(["Clean App Logger","Limpia de registrador","Limpo do registrador","Pulizia Registratore"]),false,true);jt_ohse.Release(true);this.AbortHttpRequests();}
