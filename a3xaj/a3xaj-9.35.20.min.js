...
for(i=0;i<jt_CountDT;i++)
{var jt_ogldt=this.jm_aoglDataTableStore.Get_Item_ByIndex(i);if(!jt_ogldt.jm_oDTStatus.IsOpStore()&&jt_ogldt.jm_oDTStatus.IsSuccess())
...
return jt_fnThatsAllFolks();var jr_b=jt_this.StoreData(jt_fnOnStoreDataDone);jr_b=jt_fnThatsAllFolks();return jr_b;};var jt_fnOnLoadCommon2Done=function(ji_bSuccess)
{if(ji_bSuccess)
...
return jr_oAjaxUrlParams.Get_UrlParams();var jt_aHeader=((jt_aHeader2&&jt_aHeader2[1])?jt_aHeader2[1].split(jg_oe.jc_oA3xaDbZero.jc_GLSep_Field):null);var jt_xglid=jt_aHeader2[0];if(jt_xglid!=(jg_oe.jc_oA3xaDbZero.jc_GLID_All))
{var jt_sGLHeader="";var jt_pisdsRecord_glidtoc=jg_oApp.Get_Database().Get_TOCItem(jt_xglid);if(jt_pisdsRecord_glidtoc&&jt_pisdsRecord_glidtoc.fields)
...
{jt_pisdsRecord_glidtoc.fields.shift();jt_sGLHeaderReference=jg_oe.jc_oA3xaDbZero.jc_GLID_All+jg_oe.jc_oA3xaDbZero.jc_GLSep_Header+
...
{this.jc_oStorage=new A3xaDefines_Storage();this.jm_StorageTypeDefault=this.jc_oStorage.jc_FLY;this.jc_oA3xaDbZero=new A3xaDefines_A3xaDbZero();this.jc_oA3xaDbZero.Init(this.jc_oStorage);this.jc_oEntity=new A3xaDefines_Entity();this.jc_oEntityInfo=new A3xaDefines_EntityInfo();this.jc_oHtml=new A3xaDefines_Html();this.jc_oUrls=new A3xaDefines_Urls();this.jm_oAppXUR=new A3xaAppXUR();this.jm_oAppXUR.Set_DefXUR(new A3xaDefines_XUR());this.jc_oXUR=this.jm_oAppXUR.Get_DefXUR();this.jm_oAppMngIcons=new A3xaAppMngIcons();this.jm_oAppMngIcons.Set_DefIcons(new A3xaDefines_Icons());this.jc_oIcons=this.jm_oAppMngIcons.Get_DefIcons();this.Set_Storage(new A3xaStorageFLY());this.Set_Storage(new A3xaStorageSS());this.Set_Storage(new A3xaStorageLS());this.Set_Storage(new A3xaStorageIDB());this.Set_Reporter(new A3xaReporter());this.Set_Database(new A3xaDbZero());this.Set_TurboStatus(false);this.jm_oMgrSummary=new A3xaMgrSummary();};this.HostInitApplication=function(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_IdUser,ji_Itemid,ji_sxur,ji_sDirBase,ji_sHomeDir,ji_sLang,ji_bTurboStatus,ji_bClearLocalStorage)
{this.A3xaAbsEnvironment_Set_CommonValues(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_IdUser,ji_Itemid,ji_sDirBase,ji_sHomeDir,ji_sLang);this.Set_Debug((ji_bDebug?1:0),{DB:3,DBT:"db"});this.Get_AppXUR().Set_XURString(ji_sxur);this.Set_TurboStatus(ji_bTurboStatus);if(ji_bClearLocalStorage)
this.ClearStorage();return true;};this.Get_ECPMgr=function()
...
{this.ResetApp();this.ShowCPTemplate();this.LogStatusBar2(new A3xaString(["Ready","Listo","Pronto","Pronto"]),false,true);this.Get_DataManager().ManageData();return true;};this.ResetApp=function()
{if(this.Get_ECPMgr())
