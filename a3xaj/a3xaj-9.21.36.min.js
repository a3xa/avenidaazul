...
{jg_oe=this;this.jm_bCanEdit=false;this.jm_bCanLike=false;this.jm_IdUser=0;this.jm_Itemid=0;this.jm_sDirBase="/";var jt_this=this;this.jc_oMisc=null;this.jc_oStorage=null;this.jc_oAjax=null;this.jc_oA3xaDbZero=null;this.jc_oEntity=null;this.jc_oEntityInfo=null;this.jc_oHtml=null;this.jc_oQUR=null;this.jc_oIcons=null;this.jm_bReady=false;jQuery(document).ready(function(){jt_this.jm_bReady=true;jt_this._OnDocumentReady();});this._OnDocumentReady=function()
...
{jt_bIE=true;}}
if(jt_bIE)
window.document.execCommand('Stop');return true;};}
...
{this.jm_o3xhIconInfo=ji_o3xhIconInfo;this.jm_bTipPopup=false;this.jm_sSimplePopupPlugin=null;this.Get_HtmIconInfo=function(){return this.jm_o3xhIconInfo;};this.IsValid=function()
{return this.jm_o3xhIconInfo&&(this.jm_o3xhIconInfo.Get_UrlImage()||this.jm_o3xhIconInfo.Get_Title());};this.Set_Options=function(ji_bTipPopup,ji_sSimplePopupPlugin)
{if(ji_bTipPopup==true)
this.jm_bTipPopup=true;if(ji_sSimplePopupPlugin&&ji_sSimplePopupPlugin.length)
this.jm_sSimplePopupPlugin=ji_sSimplePopupPlugin;return true;};this.Get_Html=function()
{if(!this.IsValid())
return"";var jt_shStyle=this.jm_o3xhIconInfo.Get_StyleString();if(jt_shStyle)
...
if(this.jm_bTipPopup&&!this.jm_o3xhIconInfo.Get_UrlLink())
...
if(!this.jm_o3xhIconInfo.Get_UrlLink())
...
jr_shImg+"</a>";jr_sh+=(this.jm_o3xhIconInfo.HasParagraph()?"</p>":"");return jr_sh;};this.PrintHtml=function(qi_oParent)
...
return true;};}
function A3xaSimpleButton2(ji_sUrlImg,ji_oSpriteInfo,ji_IconId,ji_oUrlLink,ji_sTitle,ji_sAlt,ji_sId)
{this.jm_sUrlImg=ji_sUrlImg;this.jm_oSpriteInfo=(ji_oSpriteInfo||null);this.jm_IconId=(ji_IconId||null);this.jm_oUrlLink=ji_oUrlLink;this.jm_sTitle=ji_sTitle;this.jm_sAlt=(ji_sAlt?ji_sAlt:ji_sTitle);this.jm_sId=(ji_sId?ji_sId:null);this.jm_sUrlImgTransparent=null;this.jm_width=24;this.jm_height=24;this.jm_bTargetNew=true;this.jm_bShadow=false;this.jm_bParagraph=true;this.jm_bTipPopup=false;this.jm_sSimplePopupPlugin=null;this.Set_UrlImgTransparent=function(ji_sUrlImg)
{this.jm_sUrlImgTransparent=(ji_sUrlImg||null);return true;};this.IsValid=function()
{return(this.jm_sUrlImg&&this.jm_sUrlImg.length)||(this.jm_sTitle&&this.jm_sTitle.length);};this.IsSprite=function()
{return this.jm_sUrlImg&&this.jm_IconId&&this.jm_oSpriteInfo;};this.Set_Options=function(ji_width,ji_height,ji_bTargetNew,ji_bShadow,ji_bParagraph,ji_bTipPopup,ji_sSimplePopupPlugin)
{if(ji_width)
...
this.jm_bTipPopup=true;if(ji_sSimplePopupPlugin&&ji_sSimplePopupPlugin.length)
this.jm_sSimplePopupPlugin=ji_sSimplePopupPlugin;return true;};this.Get_Html=function()
{var jr_shImg="";if(this.IsSprite())
{var jt_w=this.jm_width;var jt_h=this.jm_height;var jt_relcol=(this.jm_IconId%this.jm_oSpriteInfo.iddivisor);var jt_block=A3xaMathFloor(this.jm_IconId,this.jm_oSpriteInfo.iddivisor);var jt_col=jt_relcol;var jt_row=jt_block;if(jt_block>this.jm_oSpriteInfo.rows)
{jt_row=((jt_block-1)%this.jm_oSpriteInfo.rows)+1;jt_col=(A3xaMathFloor((jt_block-1),this.jm_oSpriteInfo.rows)*this.jm_oSpriteInfo.stepcols+jt_relcol);}
else
{}
if(jt_row>0&&jt_col>0)
jr_shImg="<img src='"+(this.jm_sUrlImgTransparent||"")+"' "+" width='"+jt_w+"' height='"+jt_h+"' "+" alt='"+this.jm_sAlt+"' title='"+this.jm_sTitle+"' "+" style='background: url("+this.jm_sUrlImg+") "+
((1-jt_col)*jt_w)+"px "+((1-jt_row)*jt_h)+"px; "+" background-repeat: no-repeat; "+" background-size: "+(jt_w*this.jm_oSpriteInfo.cols)+"px "+
(jt_h*this.jm_oSpriteInfo.rows)+"px;' "+"/>";}
else if(this.jm_sUrlImg)
...
(this.jm_bShadow?" style='box-shadow: 1px 1px 0px #404040;'":"")+"/>";}
else
{if(!this.jm_bShadow)
...
jr_shImg+"</a>";jr_sh+=(this.jm_bParagraph?"</p>":"");return jr_sh;};this.PrintHtml=function(qi_oParent)
{if(!(qi_oParent&&qi_oParent.length))
...
{A3xaSimpleButton2.call(this,ji_sUrlImg,null,null,ji_oUrlLink,ji_sTitle,ji_sAlt,ji_sId);}
...
{this.jc_sIconExt=".png";this.jm_SpriteDivisor=10000;this.jc_ao3xSprites=new A3xaArray();this.jm_Idsprite_SingleStatus=1;this.jm_Absidsprite_SingleStatus=this.jm_Idsprite_SingleStatus*this.jm_SpriteDivisor;this.jc_ao3xSprites.Add_Item(this.jm_Idsprite_SingleStatus,{iddivisor:100,rows:10,cols:10,steprows:1,stepcols:10,height:72,width:240,path:"a3xas/a3xam/sprites/Sprite-SingleStatus-10x10x24x8"});this.jm_Idsprite_MultiStatus=2;this.jm_Absidsprite_MultiStatus=this.jm_Idsprite_MultiStatus*this.jm_SpriteDivisor;this.jc_ao3xSprites.Add_Item(this.jm_Idsprite_MultiStatus,{iddivisor:100,rows:20,cols:10,steprows:1,stepcols:10,height:480,width:240,path:"a3xas/a3xam/sprites/Sprite-MultiStatus-20x10x24x8"});this.jm_Idsprite_Category=10;this.jm_Absidsprite_Category=this.jm_Idsprite_Category*this.jm_SpriteDivisor;this.jc_ao3xSprites.Add_Item(this.jm_Idsprite_Category,{iddivisor:100,rows:12,cols:10,steprows:1,stepcols:10,height:288,width:240,path:"a3xas/a3xam/sprites/Sprite-Category-12x10x24x8"});this.jm_Idsprite_CountryLA=20;this.jm_Absidsprite_CountryLA=this.jm_Idsprite_CountryLA*this.jm_SpriteDivisor;this.jc_ao3xSprites.Add_Item(this.jm_Idsprite_CountryLA,{iddivisor:100,rows:10,cols:10,steprows:1,stepcols:10,height:160,width:240,path:"a3xas/a3xam/sprites/Sprite-CountryLA-10x10x16x24x8"});this.jm_Idsprite_AreaFlag=50;this.jm_Absidsprite_AreaFlag=this.jm_Idsprite_AreaFlag*this.jm_SpriteDivisor;this.jc_ao3xSprites.Add_Item(this.jm_Idsprite_AreaFlag,{iddivisor:100,rows:10,cols:10,steprows:1,stepcols:10,height:160,width:240,path:"a3xas/a3xam/sprites/Sprite-AreaFlagLA-10x10x16x24x8"});this.jm_Idsprite_AreaBkgnd=(this.jm_Idsprite_AreaFlag+10);this.jm_Absidsprite_AreaBkgnd=this.jm_Idsprite_AreaBkgnd*this.jm_SpriteDivisor;this.jc_ao3xSprites.Add_Item(this.jm_Idsprite_AreaBkgnd,{iddivisor:100,rows:1,cols:100,steprows:1,stepcols:10,height:24,width:2400,path:"a3xas/a3xam/sprites/Sprite-AreaBkgndLA-1x100x32x8"});this.jm_Idsprite_StateLA=100;this.jm_Absidsprite_StateLA=this.jm_Idsprite_StateLA*this.jm_SpriteDivisor;this.jc_ao3xSprites.Add_Item(this.jm_Idsprite_StateLA,{iddivisor:100,rows:30,cols:40,steprows:1,stepcols:40,height:160,width:960,path:"a3xas/a3xam/sprites/Sprite-StateLA-30x40x16x24x8"});this.jc_sIconUrlBase_UserControls="a3xas/a3xam/icons-user-controls/";this.jc_sIconUrlBase_Main="a3xas/a3xam/icons-main/";this.jc_sIcon_Transparent="Transparent";this.jc_sIcon_Star="Star-icon-32x32";this.jc_sIcon_Turista="Turista-icon-64x96";this.jc_sIcon_Logo="Logo-84x84";this.jc_sIconUrlBase_Admin="a3xas/a3xam/icons-admin/";this.jc_sIconPrefix_EditEntity="Button-Edit-32x32";this.jc_sIconPrefix_NewEntity="Button-New-32x32";this.jc_sIconPrefix_NewSEntity="Button-New2-32x32";this.jc_sIconPrefix_DeleteEntity="Button-Trash-32x32";this.jc_sIconPrefix_EditEntityInfo="Button-FieldEdit-32x32";this.jc_sIconPrefix_NewEntityInfo="Button-FieldNew-32x32";this.jc_sIconPrefix_DeleteEntityInfo="Button-FieldTrash-32x32";this.jc_sIconUrlBase_QUR="a3xas/a3xam/icons-query/";this.jc_sIconPrefix_QTT="QTop10gold-icon-32x32-";this.jc_sIconPrefix_QEN="QENT-icon-32x32-";this.jc_sIconPrefix_QLE="QLE-icon-32x32-";this.jc_sIconUrlBase_UserEntityInfo="a3xas/a3xam/icons-entity-info/";this.jc_oIconSS_FacebookPage={absid:this.jm_Absidsprite_SingleStatus+101,name:"facebook-logo-page-32x32"};this.jc_oIconSS_FacebookGroup={absid:this.jm_Absidsprite_SingleStatus+102,name:"facebook-logo-group-32x32"};this.jc_oIconSS_FacebookUser={absid:this.jm_Absidsprite_SingleStatus+103,name:"facebook-logo-profile-32x32"};this.jc_oIconSS_Twitter={absid:this.jm_Absidsprite_SingleStatus+104,name:"Twitter-icon-32x32"};this.jc_oIconSS_Gplus={absid:this.jm_Absidsprite_SingleStatus+105,name:"Gplus-icon-32x32"};this.jc_oIconSS_Pinterest={absid:this.jm_Absidsprite_SingleStatus+106,name:"Pinterest-icon-32x32"};this.jc_oIconSS_Video={absid:this.jm_Absidsprite_SingleStatus+107,name:"Youtube-icon-32x32"};this.jc_oIconSS_VideoUrl={absid:this.jm_Absidsprite_SingleStatus+108,name:"Youtubeuser-icon-32x32"};this.jc_oIconSS_Flickr={absid:this.jm_Absidsprite_SingleStatus+109,name:"Flickr-icon-32x32"};this.jc_oIconSS_Flickrtxt={absid:this.jm_Absidsprite_SingleStatus+109,name:"Flickr-txt-32x32"};this.jc_oIconSS_Wikipedia={absid:this.jm_Absidsprite_SingleStatus+201,name:"Wikipedia-icon-32x32"};this.jc_oIconSS_Wikiphoneprefix={absid:this.jm_Absidsprite_SingleStatus+202,name:"Wikiprefix-icon-32x32"};this.jc_oIconSS_Wikitravel={absid:this.jm_Absidsprite_SingleStatus+203,name:"Wikitravel-icon-32x32"};this.jc_oIconSS_Skype={absid:this.jm_Absidsprite_SingleStatus+204,name:"Skype-icon-32x32"};this.jc_oIconSS_Skypetxt={absid:this.jm_Absidsprite_SingleStatus+204,name:"Skype-txt-32x32"};this.jc_oIconSS_Url={absid:this.jm_Absidsprite_SingleStatus+205,name:"Www-icon-32x32"};this.jc_oIconSS_Email={absid:this.jm_Absidsprite_SingleStatus+206,name:"Email-icon-32x32"};this.jc_oIconSS_Phone={absid:this.jm_Absidsprite_SingleStatus+207,name:"Phone-Icon-32x32"};this.jc_oIconSS_A3xaGallery={absid:this.jm_Absidsprite_SingleStatus+208,name:"A3xaGallery-icon-32x32"};this.jc_oIconSS_Person={absid:this.jm_Absidsprite_SingleStatus+209,name:"Man-icon-32x32-cav"};this.jc_oIconSS_Sitemap={absid:this.jm_Absidsprite_SingleStatus+301,name:"Sitemap-32x32"};this.jc_oIconSS_WCUrl={absid:this.jm_Absidsprite_SingleStatus+302,name:"Wc-icon-32x32"};this.jc_oIconSS_Googlemap={absid:this.jm_Absidsprite_SingleStatus+303,name:"Googlemap-icon-32x32"};this.jc_oIconSS_GooglemapBW={absid:this.jm_Absidsprite_SingleStatus+304,name:"Googlemap-icon-32x32-bw"};this.jc_oIconSS_ViewEntity={absid:this.jm_Absidsprite_SingleStatus+305,name:"Button-View-32x32"};this.jc_oIconSS_NewEntity={absid:this.jm_Absidsprite_SingleStatus+601,name:"Button-New-32x32"};this.jc_oIconSS_NewSEntity={absid:this.jm_Absidsprite_SingleStatus+602,name:"Button-New2-32x32"};this.jc_oIconSS_EditEntity={absid:this.jm_Absidsprite_SingleStatus+603,name:"Button-Edit-32x32"};this.jc_oIconSS_DeleteEntity={absid:this.jm_Absidsprite_SingleStatus+605,name:"Button-Trash-32x32"};this.jc_oIconSS_NewEntityInfo={absid:this.jm_Absidsprite_SingleStatus+701,name:"Button-FieldNew-32x32"};this.jc_oIconSS_EditEntityInfo={absid:this.jm_Absidsprite_SingleStatus+703,name:"Button-FieldEdit-32x32"};this.jc_oIconSS_DeleteEntityInfo={absid:this.jm_Absidsprite_SingleStatus+705,name:"Button-FieldTrash-32x32"};this.jc_oIconMS_Turbo={absid:this.jm_Absidsprite_MultiStatus+101,name:"Turbo-icon-32x32-"};this.jc_oIconMS_GLMore={absid:this.jm_Absidsprite_MultiStatus+102,name:"GLMore-icon-32x32-"};this.jc_oIconMS_Like={absid:this.jm_Absidsprite_MultiStatus+103,name:"Like-icon-32x32-"};this.jc_oIconMS_StaticMapLA={absid:this.jm_Absidsprite_MultiStatus+106,name:"StaticMapL-icon-32x32-"};this.jc_oIconMS_StaticMapArea={absid:this.jm_Absidsprite_MultiStatus+107,name:"StaticMapA-icon-32x32-"};this.jc_oIconMS_StaticMapRegion={absid:this.jm_Absidsprite_MultiStatus+108,name:"StaticMapR-icon-32x32-"};this.jc_oIconMS_Status={offdis:1,off:2,offover:3,offclick:4,ondis:5,on:6,onover:7,onclick:8,offdown:9,offup:10,offfb:11,offfg:12,offfr:13,offfy:14,ondown:15,onup:16,onfb:17,onfg:18,onfr:19,onfy:20};this.jc_oIconCat_City={absid:this.jm_Absidsprite_Category+808,name:""};}
...
this.jm_bAjax=(ji_bAjax==true);return true;};this.Set_SrcInfo2=function(ji_sSrcBase,ji_sTitle,ji_sAlt,ji_sfnOnClick,ji_ColTarget,ji_sAjaxUrlParams,ji_StatusInit)
...
this.jm_StatusInit=ji_StatusInit;return true;};this.Set_SrcInfo3=function(ji_o3xhIconInfo,ji_sTitle,ji_sAlt,ji_sfnOnClick,ji_ColTarget,ji_sAjaxUrlParams,ji_StatusInit)
{this.jm_o3xhIconInfo=ji_o3xhIconInfo;this.jm_sTitle=ji_sTitle;this.jm_sAlt=ji_sAlt;this.jm_sfnOnClick=ji_sfnOnClick;this.jm_ColTarget=ji_ColTarget;this.jm_sAjaxUrlParams=ji_sAjaxUrlParams;if(ji_StatusInit)
...
this.jm_ColTarget+"&quot;,&quot;"+
this.jm_sAjaxUrlParams+"&quot;);";var jt_shON="";var jt_shOFF="";var jt_shDIS="";if(this.IsSprite()&&this.jm_o3xhIconInfo.Get_SpriteRow()>0&&this.jm_o3xhIconInfo.Get_SpriteColumn()>0)
{var jt_shStyleON=this.jm_o3xhIconInfo.Get_StyleString(jg_oe.jc_oIcons.jc_oIconMS_Status.on-1,null);if(jt_shStyleON)
...
jt_shStyleDIS+=" "+jt_sHtmlDIS_visibility;jt_shON="<img id='"+jt_Id+"_ON'"+" name='"+jt_Id+"_ON'"+" src='"+(this.jm_o3xhIconInfo.Get_UrlImageTransparent()||"")+"' "+" width='"+this.jm_o3xhIconInfo.Get_Width()+"' "+" height='"+this.jm_o3xhIconInfo.Get_Height()+"' "+" border='0' alt='"+this.jm_sAlt+"' title='"+this.jm_sTitle+"' "+" style='"+jt_shStyleON+"' "+" onclick = '"+jt_sfnOnClick_Full+"' "+"/>";jt_shOFF="<img id='"+jt_Id+"_OFF'"+" name='"+jt_Id+"_OFF'"+" src='"+(this.jm_o3xhIconInfo.Get_UrlImageTransparent()||"")+"' "+" width='"+this.jm_o3xhIconInfo.Get_Width()+"' "+" height='"+this.jm_o3xhIconInfo.Get_Height()+"' "+" border='0' alt='"+this.jm_sAlt+"' title='"+this.jm_sTitle+"' "+" style='"+jt_shStyleOFF+"' "+" onclick = '"+jt_sfnOnClick_Full+"' "+"/>";jt_shDIS="<img id='"+jt_Id+"_DIS'"+" name='"+jt_Id+"_DIS'"+" src='"+(this.jm_o3xhIconInfo.Get_UrlImageTransparent()||"")+"' "+" width='"+this.jm_o3xhIconInfo.Get_Width()+"' "+" height='"+this.jm_o3xhIconInfo.Get_Height()+"' "+" border='0' alt='"+this.jm_sAlt+"' title='"+this.jm_sTitle+"' "+" style='"+jt_shStyleDIS+"' "+" onclick = '"+jt_sfnOnClick_Full+"' "+"/>";}
else
{jt_shON="<img id='"+jt_Id+"_ON'"+" name='"+jt_Id+"_ON'"+" src='"+this.jm_sSrcBase+"ON"+jg_oe.jc_oIcons.jc_sIconExt+"'"+" border='0' alt='"+this.jm_sAlt+"' title='"+this.jm_sTitle+"'"+" width='"+this.jm_width+"' height='"+this.jm_height+"'"+" style='"+jt_sHtmlON_visibility+"'"+" onclick = '"+jt_sfnOnClick_Full+"' />";jt_shOFF="<img id='"+jt_Id+"_OFF'"+" name='"+jt_Id+"_OFF'"+" src='"+this.jm_sSrcBase+"OFF"+jg_oe.jc_oIcons.jc_sIconExt+"'"+" border='0' alt='"+this.jm_sAlt+"' title='"+this.jm_sTitle+"'"+" width='"+this.jm_width+"' height='"+this.jm_height+"'"+" style='"+jt_sHtmlOFF_visibility+"'"+" onclick = '"+jt_sfnOnClick_Full+"' />";jt_shDIS="<img id='"+jt_Id+"_DIS'"+" name='"+jt_Id+"_DIS'"+" src='"+this.jm_sSrcBase+"DIS"+jg_oe.jc_oIcons.jc_sIconExt+"'"+" border='0' alt='"+this.jm_sAlt+"' title='"+this.jm_sTitle+"'"+" width='"+this.jm_width+"' height='"+this.jm_height+"'"+" style='"+jt_sHtmlDIS_visibility+"' />";}
...
{var jt_sxposOFF=this.jm_o3xhIconInfo.Get_XPos_String(jg_oe.jc_oIcons.jc_oIconMS_Status.off-1);var jt_sxposOFFCLICK=this.jm_o3xhIconInfo.Get_XPos_String(jg_oe.jc_oIcons.jc_oIconMS_Status.offclick-1);var jt_sxposOFFOVER=this.jm_o3xhIconInfo.Get_XPos_String(jg_oe.jc_oIcons.jc_oIconMS_Status.offover-1);var jt_IdOFF="#CellBtn_"+this.Get_Name()+"_"+this.jm_Row+"_"+this.jm_Col+"_OFF";var qr_ohOFF=jQuery(jt_IdOFF);if(qr_ohOFF&&qr_ohOFF.length)
...
var jt_sxposON=this.jm_o3xhIconInfo.Get_XPos_String(jg_oe.jc_oIcons.jc_oIconMS_Status.on-1);var jt_sxposONCLICK=this.jm_o3xhIconInfo.Get_XPos_String(jg_oe.jc_oIcons.jc_oIconMS_Status.onclick-1);var jt_sxposONOVER=this.jm_o3xhIconInfo.Get_XPos_String(jg_oe.jc_oIcons.jc_oIconMS_Status.onover-1);var jt_IdON="#CellBtn_"+this.Get_Name()+"_"+this.jm_Row+"_"+this.jm_Col+"_ON";var qr_ohON=jQuery(jt_IdON);if(qr_ohON&&qr_ohON.length)
...
{var jt_srcOFF=this.jm_sSrcBase+"OFF"+jg_oe.jc_oIcons.jc_sIconExt;var jt_srcOFFCLICK=this.jm_sSrcBase+"OFF-CLICK"+jg_oe.jc_oIcons.jc_sIconExt;var jt_srcOFFOVER=this.jm_sSrcBase+"OFF-OVER"+jg_oe.jc_oIcons.jc_sIconExt;var jt_IdOFF="#CellBtn_"+this.Get_Name()+"_"+this.jm_Row+"_"+this.jm_Col+"_OFF";var qr_ohOFF=jQuery(jt_IdOFF);if(qr_ohOFF&&qr_ohOFF.length)
...
var jt_srcON=this.jm_sSrcBase+"ON"+jg_oe.jc_oIcons.jc_sIconExt;var jt_srcONCLICK=this.jm_sSrcBase+"ON-CLICK"+jg_oe.jc_oIcons.jc_sIconExt;var jt_srcONOVER=this.jm_sSrcBase+"ON-OVER"+jg_oe.jc_oIcons.jc_sIconExt;var jt_IdON="#CellBtn_"+this.Get_Name()+"_"+this.jm_Row+"_"+this.jm_Col+"_ON";var qr_ohON=jQuery(jt_IdON);if(qr_ohON&&qr_ohON.length)
...
{var jt_oxposON=this.jm_o3xhIconInfo.Get_XPos(jg_oe.jc_oIcons.jc_oIconMS_Status.on-1);var jt_oxposOFF=this.jm_o3xhIconInfo.Get_XPos(jg_oe.jc_oIcons.jc_oIconMS_Status.off-1);var jt_oxposONFLASH=null;var jt_oxposOFFFLASH=null;if(ji_FlashType=="FB")
{jt_oxposONFLASH=this.jm_o3xhIconInfo.Get_XPos(jg_oe.jc_oIcons.jc_oIconMS_Status.onfb-1);jt_oxposOFFFLASH=this.jm_o3xhIconInfo.Get_XPos(jg_oe.jc_oIcons.jc_oIconMS_Status.offfb-1);}
else if(ji_FlashType=="FG")
{jt_oxposONFLASH=this.jm_o3xhIconInfo.Get_XPos(jg_oe.jc_oIcons.jc_oIconMS_Status.onfg-1);jt_oxposOFFFLASH=this.jm_o3xhIconInfo.Get_XPos(jg_oe.jc_oIcons.jc_oIconMS_Status.offfg-1);}
else if(ji_FlashType=="FR")
{jt_oxposONFLASH=this.jm_o3xhIconInfo.Get_XPos(jg_oe.jc_oIcons.jc_oIconMS_Status.onfr-1);jt_oxposOFFFLASH=this.jm_o3xhIconInfo.Get_XPos(jg_oe.jc_oIcons.jc_oIconMS_Status.offfr-1);}
else if(ji_FlashType=="FY")
{jt_oxposONFLASH=this.jm_o3xhIconInfo.Get_XPos(jg_oe.jc_oIcons.jc_oIconMS_Status.onfy-1);jt_oxposOFFFLASH=this.jm_o3xhIconInfo.Get_XPos(jg_oe.jc_oIcons.jc_oIconMS_Status.offfy-1);}
...
{return;}
jt_oxposON&&jt_oPartON&&jt_oPartON.Set_BkgndPosition2(jt_oxposON);jt_oxposOFF&&jt_oPartOFF&&jt_oPartOFF.Set_BkgndPosition2(jt_oxposOFF);jt_this.jm_oTimerFlash=null;jt_this.Flash("");return;},800);}
else if(this.jm_sSrcBase)
{if(jt_oPartON)
...
jt_oPartOFF.Set_Src(jt_this.jm_sSrcBase+"OFF.png");jt_this.jm_oTimerFlash=null;jt_this.Flash("");return;},800);}
else
return false;return true;};this.Show=function(ji_Status)
{if(!this.IsValid())
...
this.jm_bShowUP_running=true;jt_oPartON&&jt_oPartON.Set_BkgndPosition2(this.jm_o3xhIconInfo.Get_XPos(jg_oe.jc_oIcons.jc_oIconMS_Status.onup-1));jt_oPartOFF&&jt_oPartOFF.Set_BkgndPosition2(this.jm_o3xhIconInfo.Get_XPos(jg_oe.jc_oIcons.jc_oIconMS_Status.offup-1));}
else if(this.jm_sSrcBase)
{if(this.IsFlashing())
{this.jm_bShowUP_running=false;this.jm_bShowUP_pending=true;return true;}
...
{var jt_oxur=new A3xaXur();jt_oxur.Set_UrlParams(jg_oe.jc_oMisc.jc_XURFN_AjaxEntity,null,jg_oe.jc_oAjax.jc_sAjaxTypControlIcons,null,null,null,null,null);var jt_oUrl=jt_oxur.Get_A3xaUrl(true);var jt_sAjaxUrlParams=jt_oUrl.Get_UrlParams();jt_sAjaxUrlParams+="&p_ButtonName="+ji_Name+"&p_ButtonStatus="+ji_NewStatus;jt_sAjaxUrlParams+=this.Get_AjaxUrlParams(ji_Name,ji_NewStatus);jg_oe.jm_oAjax2.QueueRequest(new A3xaAjaxRequest2(jt_oUrl.Get_UrlBase(),jt_sAjaxUrlParams,this));return true;}
return false;}
...
{this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_Empty);this.jm_sGLRS=null;this.jm_sGLRS_AltIndex=null;if((!ji_sGLRS))
...
{jt_oglAxHeader=this.NewGTFromString(ji_sGLRS_AltIndex,jt_sGlid,jg_oe.jc_oA3xaDbZero.jc_GLMID_AX);if(!jt_oglAxHeader)
{this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"AltIndex");return false;}}
else if(this.jm_bAX)
{this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheFail,"AltIndex");return false;}
...
return false;this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_CacheInProgress,"Cache Tableset "+ji_glid);this.jm_aoglDataTableStore.Set_Item(ji_glid,jt_ogldt);jg_oe.CanLogInfo()&&jg_oe.LogInfo("A3xaDatabase_WriteGLRS2: "+ji_glid+"----"+ji_sGLRS+"-----"+ji_sGLRS_AltIndex);if(!jt_ogldt.Set_String(ji_sGLRS,ji_sGLRS_AltIndex))
...
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("Begin to","Store Tables","A3xaDatabase_StoreAllData");this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreInProgress);}
...
this.jm_oDatabase.jm_oDbSchema.Get_Descr(jt_odt.Get_Glid()));var jt_otkrLoader=new A3xaTaskRecordLoader(function(){return jt_this.Task();},this.jm_oDatabase,jt_odt);jg_oe.CanLogInfo()&&jg_oe.LogInfo("Table id: "+jt_odt.Get_Glid(),"","A3xaMTRecordLoader.StartNextRecordTaskLoader");this.jm_otkrLoader=jt_otkrLoader;this.jm_oDTStatus.Set2(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StInProgress);jt_otkrLoader.Start();return true;};this._OnEnd=function(ji_oDTStatusEnd)
{if(ji_oDTStatusEnd&&ji_oDTStatusEnd.IsFail())
...
{var jt_this=this;var jt_o3xxemsc=this.Get_3xXEMSC_ByXUR();if(jt_o3xxemsc)
{jt_o3xxemsc.LinkCommonData(this);jt_o3xxemsc.Get_3xEBIS().Set_DefaultColor("FFFFFF");}
...
return true;};this.Get_3xXEMSC_ByXUR=function()
...
{return true;}
this.IsSingle=function(){return this.jm_Single==jg_oe.jc_oMisc.jc_XURTG_Single};this.ConvertQURSort=function(ji_bSortByScore)
{if(ji_bSortByScore===false)
{if(this.jm_QUR==jg_oe.jc_oQUR.jc_QUR_QuerySBS)
this.jm_QUR=jg_oe.jc_oQUR.jc_QUR_QuerySBT;else if(this.jm_QUR==jg_oe.jc_oQUR.jc_QUR_QueryLimSBS)
this.jm_QUR=jg_oe.jc_oQUR.jc_QUR_QueryLimSBT;else return false;}
else
{if(this.jm_QUR==jg_oe.jc_oQUR.jc_QUR_QuerySBT)
this.jm_QUR=jg_oe.jc_oQUR.jc_QUR_QuerySBS;else if(this.jm_QUR==jg_oe.jc_oQUR.jc_QUR_QueryLimSBT)
this.jm_QUR=jg_oe.jc_oQUR.jc_QUR_QueryLimSBS;else return false;}
return true;};this.MakeQUR=function(ji_bUnlimited,ji_bSortByTime)
{if(ji_bUnlimited)
{if(ji_bSortByTime)
this.jm_QUR=jg_oe.jc_oQUR.jc_QUR_QuerySBT;else
this.jm_QUR=jg_oe.jc_oQUR.jc_QUR_QuerySBS;return true;}
if(ji_bSortByTime)
this.jm_QUR=jg_oe.jc_oQUR.jc_QUR_QueryLimSBT;else
this.jm_QUR=jg_oe.jc_oQUR.jc_QUR_QueryLimSBS;return true;};this.IsSortByScore=function()
{return this.jm_QUR==jg_oe.jc_oQUR.jc_QUR_QuerySBS||(this.jm_QUR==jg_oe.jc_oQUR.jc_QUR_QueryLimSBS);};this.IsSortByTime=function()
{return this.jm_QUR==jg_oe.jc_oQUR.jc_QUR_QuerySBT||(this.jm_QUR==jg_oe.jc_oQUR.jc_QUR_QueryLimSBT);};this.IsQURUnlimited=function()
{return this.jm_QUR==jg_oe.jc_oQUR.jc_QUR_QuerySBS||this.jm_QUR==jg_oe.jc_oQUR.jc_QUR_QuerySBT;};this.IsQURLimited=function()
{return this.jm_QUR==jg_oe.jc_oQUR.jc_QUR_QueryLimSBS||this.jm_QUR==jg_oe.jc_oQUR.jc_QUR_QueryLimSBT;};this.Get_XURString=function()
{if(!this.IsValid())
...
return false;var jt_keyMain=this.Get_3xXEID().Get_PrimaryKey();var jt_oglrMain=null;if(this.jm_Single==jg_oe.jc_oMisc.jc_XURTG_Single&&jt_keyMain)
...
return false;this.jm_oxeidHighlights=new A3xaDCEntity();this.jm_oxeidHighlights.Get_3xXEID().CopyFrom(this);var jt_sName=this.Get_3xEBIS().Get_Name();var jt_TypEntity=this.Get_3xXEID().Get_TypEntity();if(jt_TypEntity==jg_oe.jc_oEntity.jc_Typ_Category)
...
{var jt_oglrCategory=this.Get_CommonLinkedRecord(jg_oe.jc_oEntity.jc_Typ_Category);var jt_sCategory=(jt_oglrCategory?jt_oglrCategory.Get_3xEBIS().Get_Name():"");var jt_oglrGeoCity=this.Get_CommonLinkedRecord(jg_oe.jc_oEntity.jc_Typ_GeoCity);var jt_sGeoCity=(jt_oglrGeoCity?jt_oglrGeoCity.Get_3xEBIS().Get_Name():"");var jt_oglrGeoState=this.Get_CommonLinkedRecord(jg_oe.jc_oEntity.jc_Typ_GeoState);var jt_sGeoState=(jt_oglrGeoState?jt_oglrGeoState.Get_3xEBIS().Get_Name():"");var jt_oglrGeoCountry=this.Get_CommonLinkedRecord(jg_oe.jc_oEntity.jc_Typ_GeoCountry);var jt_sGeoCountry=(jt_oglrGeoCountry?jt_oglrGeoCountry.Get_3xEBIS().Get_Name():"");var jt_oglrGeoRegion=this.Get_CommonLinkedRecord(jg_oe.jc_oEntity.jc_Typ_GeoRegion);var jt_sGeoRegion=(jt_oglrGeoRegion?jt_oglrGeoRegion.Get_3xEBIS().Get_Name():"");var jt_oglrGeoArea=this.Get_CommonLinkedRecord(jg_oe.jc_oEntity.jc_Typ_GeoArea);var jt_sGeoArea=(jt_oglrGeoArea?jt_oglrGeoArea.Get_3xEBIS().Get_Name():"");if(!jt_sGeoArea)
{var jt_A=this.Get_3xXEID().Get_3xAZNC().Get_A();var jt_Z=this.Get_3xXEID().Get_3xAZNC().Get_Z();var jt_o3xaznc_xapp=New_A3xaAZNC_XApp(this.Get_3xXEID());var jt_o3xebis=jt_o3xaznc_xapp.TopAreaTo3xEBIS();if(jt_o3xebis&&(jt_o3xaznc_xapp.IsLA()||(jt_A&&!jt_Z)))
jt_sGeoArea=jt_o3xebis.Get_Name();}
...
if(this.jm_Single!=jg_oe.jc_oMisc.jc_XURTG_Single)
{var jt_squrDescr=jg_oe.Get_AppXUR().QUR_Get_Descr2(this.jm_QUR,jt_TypEntity,jt_o3xaznc.Get_A(),jt_o3xaznc.Get_Z(),jt_o3xaznc.Get_N(),jt_o3xaznc.Get_C(),!jt_o3xcat.Get_Ucat()&&jt_TypEntity==jg_oe.jc_oEntity.jc_Typ_Enterprise);jt_sCategory=jt_squrDescr+"-"+jt_sCategory;}
...
return ji_glidDefault;var jt_oxeidXUR=this.Get_3xXEID();if(!(this.IsQURUnlimited()&&jt_oxeidXUR&&jt_oxeidXUR.Get_TypEntity()==jg_oe.jc_oEntity.jc_Typ_Enterprise))
...
{this.jm_FormName=jg_oe.jc_oMisc.jc_XURFN_AjaxEntity;var jt_sxur=this.Get_XURString();jr_oUrl=new A3xaUrl(jg_oe.jc_oMisc.jc_sUrlBase_A3xaForm,"p3x="+jt_sxur);}
else
{var jt_sxur=this.Get_XURString();jr_oUrl=new A3xaUrl(jg_oe.jc_oMisc.jc_sUrlBase_A3xaForm,(ji_bAppendDescrParam===true?"p3d="+this.Get_XUDString()+"&":"")+"p3x="+jt_sxur);}
if(!jt_sxur)
...
{jg_oe.LogErr("table not found: "+jg_oe.jc_oA3xaDbZero.jc_aSchemaTables[i].jp_sName,"","GLReporter_Get_AjaxUrlParams");return jr_oAjaxUrlParams.Get_UrlParams();}
...
function A3xaAppXUR()
{var jt_this=this;this.jc_oQUR=null;this._A3xaAppXUR=function()
{};this.Set_DefQur=function(jc_oQUR){this.jc_oQUR=jc_oQUR;return true;};this.Get_DefQur=function(){return this.jc_oQUR;};this.QUR_Get_Descr2=function(ji_sQUR,ji_TypEntity,ji_A,ji_Z,ji_N,ji_C,ji_bLimited)
{if(!(ji_sQUR&&ji_sQUR.length==3))
return null;if(ji_bLimited)
{if(ji_sQUR==this.jc_oQUR.jc_QUR_QuerySBS)
ji_sQUR=this.jc_oQUR.jc_QUR_QueryLimSBS;else if(ji_sQUR==this.jc_oQUR.jc_QUR_QuerySBT)
ji_sQUR=this.jc_oQUR.jc_QUR_QueryLimSBT;}
if(ji_sQUR==this.jc_oQUR.jc_QUR_QueryLimSBS)
{if(!ji_A)
return(ji_A===null?"Lat-America-Top10":"Top10");if(!ji_N)
return"Area-Top10";if(!ji_C)
return"Region-Top10";return"City-Top10";}
else if(ji_sQUR==this.jc_oQUR.jc_QUR_QueryLimSBT)
return"Recent Enterprises";else if(ji_sQUR==this.jc_oQUR.jc_QUR_QuerySBS||ji_sQUR==this.jc_oQUR.jc_QUR_QuerySBT)
{if(!ji_TypEntity)
return"Items";if(ji_TypEntity==jg_oe.jc_oEntity.jc_Typ_Enterprise)
return"Enterprises";if(ji_TypEntity==jg_oe.jc_oEntity.jc_Typ_Category)
return"Categories";if(ji_TypEntity==jg_oe.jc_oEntity.jc_Typ_Info)
return"Topics";if(ji_TypEntity==jg_oe.jc_oEntity.jc_Typ_GeoArea)
return"Areas";if(ji_TypEntity==jg_oe.jc_oEntity.jc_Typ_GeoRegion)
return"Regions";if(ji_TypEntity==jg_oe.jc_oEntity.jc_Typ_GeoCity)
return"Cities";if(ji_TypEntity==jg_oe.jc_oEntity.jc_Typ_GeoCountry)
return"Countries";if(ji_TypEntity==jg_oe.jc_oEntity.jc_Typ_GeoState)
...
return"Update";return ji_sQUR+"_unknown";};this.jm_oxur=new A3xaXur();this.Get_3xXUR=function(){return this.jm_oxur;};this.Set_3xXUR=function(ji_oxur){this.jm_oxur=(ji_oxur||null);return true;};this.jm_ao3xurQueue=new Array();this.Set_XURString=function(ji_sxur)
...
{if(!this.Get_3xXUR())
return false;this.Get_3xXUR().jm_TypAjaxResponse=null;if(this.Get_3xXUR().jm_FormName==jg_oe.jc_oMisc.jc_XURFN_AjaxEntity)
this.Get_3xXUR().jm_FormName=jg_oe.jc_oMisc.jc_XURFN_ListEntity;jQuery(document).prop('title',this.Get_3xXUR().Get_XUDString(true));var jt_o3xurl=this.Get_3xXUR().Get_A3xaUrl(false,true);if(jt_o3xurl)
jt_o3xurl.History_ReplaceState("",this.Get_3xXUR().Get_XUDString(true));return true;};this.OnChange_QUR=function(ji_sUrlParams)
{if(!ji_sUrlParams)
return false;var jt_o3xXUR=new A3xaXur();jt_o3xXUR.Set_UrlParams(jg_oe.jc_oMisc.jc_XURFN_ListEntity,null,jg_oe.jc_oAjax.jc_sAjaxTypEntitySet,null,null,null,null,ji_sUrlParams);var jt_oxeidXUR=jt_o3xXUR.Get_3xXEID();var jt_o3xazncXUR=new A3xaAZNC();jt_o3xazncXUR.CopyFrom(jt_oxeidXUR);var jt_te=jt_oxeidXUR.Get_TypEntity();var jt_A=jt_o3xazncXUR.Get_A();var jt_Z=jt_o3xazncXUR.Get_Z();var jt_N=jt_o3xazncXUR.Get_N();var jt_C=jt_o3xazncXUR.Get_C();var jt_odt=null;if((!jt_te||jt_te==jg_oe.jc_oEntity.jc_Typ_Enterprise)&&jt_A&&jt_Z&&jt_N)
jt_odt=jg_oApp.Get_Database().Get_MainDataTable(jt_A,jt_Z,jt_N);else if(jt_te==jg_oe.jc_oEntity.jc_Typ_MetaSystemControl)
...
jt_odt=jg_oApp.Get_Database().Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_GeoState);var jt_ohse=jg_oApp.Get_HtmlSetEntity();if(jt_ohse)
...
jt_o3xXUR.Get_3xXUR().MakeQUR(true,false);this.Set_3xXUR(jt_o3xXUR);jg_oApp.ResetApp();jg_oApp.LoadData();return true;};this.AjaxQueueQueryRequest=function()
...
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("begin"+"","","A3xaAppXUR.OnAjaxReadyFn");var jt_xmlAjaxTypEntitySet=ji_ogAjaxResponse.Get_ItemElement(jg_oe.jc_oAjax.jc_sAjaxTypEntitySet);if(jt_xmlAjaxTypEntitySet)
...
{var jt_oxur=new A3xaXur();jt_oxur.Set_UrlParams(jg_oe.jc_oMisc.jc_XURFN_ListEntity,null,null,null,null,null,null,jt_selValue);jt_oxur.LinkCommonData(jg_oe.Get_Database(),true);jt_oxur.Redirect();}
...
{if(!ji_sName)
return null;return this.MakeUrlIcon_Base(this.jc_oIcons.jc_sIconUrlBase_Main+ji_sName,ji_bExt);};this.MakeUrlIcon_UserControls2=function(ji_oIconName,ji_sAppend,ji_bExt)
{if(!ji_oIconName||!ji_oIconName.name)
return null;return this.MakeUrlIcon_Base(this.jc_oIcons.jc_sIconUrlBase_UserControls+ji_oIconName.name+(ji_sAppend||""),ji_bExt);};this.MakeUrlIcon_UserEntityInfo2=function(ji_oIconName,ji_bExt)
{if(!ji_oIconName||!ji_oIconName.name)
return null;return this.MakeUrlIcon_Base(this.jc_oIcons.jc_sIconUrlBase_UserEntityInfo+ji_oIconName.name,ji_bExt);};this.MakeUrlIcon_QUR=function(ji_sName,ji_bExt)
{if(!ji_sName)
return null;return this.MakeUrlIcon_Base(this.jc_oIcons.jc_sIconUrlBase_QUR+ji_sName,ji_bExt);};this.Get_UrlSprite=function(ji_oSprite)
{return this.MakeUrlIcon_Base(ji_oSprite?ji_oSprite.path:"");};this.Get_Sprite=function(ji_absiconid,ji_SpriteId)
{if(!(ji_absiconid>0))
return null;if(!ji_SpriteId)
ji_SpriteId=A3xaMathFloor(ji_absiconid,this.jc_oIcons.jm_SpriteDivisor);if(!(ji_SpriteId>0))
return null;return this.jc_oIcons.jc_ao3xSprites.Get_Item(ji_SpriteId);};this.Get_Iconid=function(ji_absiconid)
{if(!(ji_absiconid>0))
return null;return A3xaMathFloor(ji_absiconid%this.jc_oIcons.jm_SpriteDivisor)||null;};this.NewSprite=function(ji_absiconid,ji_SpriteId)
{var jt_oSpriteInfo=this.Get_Sprite(ji_absiconid,ji_SpriteId);if(!jt_oSpriteInfo)
return null;var jt_oUrlImgSprite=this.Get_UrlSprite(jt_oSpriteInfo);if(!jt_oUrlImgSprite)
return null;var jt_IconId=this.Get_Iconid(ji_absiconid);if(!jt_IconId)
return null;var jr_o3xhIconInfo=new A3xaHtmIconInfo(jt_oUrlImgSprite,"",jt_IconId,jt_oSpriteInfo);jr_o3xhIconInfo.Set_ImageTransparent(this.MakeUrlIcon_Main(this.jc_oIcons.jc_sIcon_Transparent));jr_o3xhIconInfo.Set_Dim(24,24);jr_o3xhIconInfo.Set_UrlLink("",true);jr_o3xhIconInfo.Set_Title("Icon","ICO");jr_o3xhIconInfo.Set_Options(false,true);return jr_o3xhIconInfo;};this.Get_UrlIconEntityAdmin=function(ji_QUR,ji_bSecundary)
{if(ji_QUR==jg_oe.jc_oQUR.jc_QUR_QueryNewEntity)
...
if(ji_QUR==jg_oe.jc_oQUR.jc_QUR_QueryEditEntity)
return this.MakeUrlIcon_Base(this.jc_oIcons.jc_sIconUrlBase_Admin+
this.jc_oIcons.jc_sIconPrefix_EditEntity);if(ji_QUR==jg_oe.jc_oQUR.jc_QUR_QueryDeleteEntity)
return this.MakeUrlIcon_Base(this.jc_oIcons.jc_sIconUrlBase_Admin+
this.jc_oIcons.jc_sIconPrefix_DeleteEntity);return null;};this.Get_UrlIconEntityInfoAdmin=function(ji_QUR)
{if(ji_QUR==this.jc_oQUR.jc_QUR_QueryNewEntity)
return this.MakeUrlIcon_Base(this.jc_oIcons.jc_sIconUrlBase_Admin+
this.jc_oIcons.jc_sIconPrefix_NewEntityInfo);if(ji_QUR==jg_oe.jc_oQUR.jc_QUR_QueryEditEntity)
return this.MakeUrlIcon_Base(this.jc_oIcons.jc_sIconUrlBase_Admin+
this.jc_oIcons.jc_sIconPrefix_EditEntityInfo);if(ji_QUR==jg_oe.jc_oQUR.jc_QUR_QueryDeleteEntity)
return this.MakeUrlIcon_Base(this.jc_oIcons.jc_sIconUrlBase_Admin+
this.jc_oIcons.jc_sIconPrefix_DeleteEntityInfo);return null;};this.Get_AbsidIconAdmin=function(ji_QUR,ji_bSecundary,ji_bEntityInfo)
{if(ji_QUR==jg_oe.jc_oQUR.jc_QUR_QueryNewEntity)
{if(ji_bSecundary)
...
if(ji_QUR==jg_oe.jc_oQUR.jc_QUR_QueryEditEntity)
return(ji_bEntityInfo?this.jc_oIcons.jc_oIconSS_EditEntityInfo.absid:this.jc_oIcons.jc_oIconSS_EditEntity.absid);if(ji_QUR==jg_oe.jc_oQUR.jc_QUR_QueryDeleteEntity)
return(ji_bEntityInfo?this.jc_oIcons.jc_oIconSS_DeleteEntityInfo.absid:this.jc_oIcons.jc_oIconSS_DeleteEntity.absid);return null;};this.Get_UrlIconQUR=function(ji_QUR,ji_Status)
{var jr_sUrlImg="";if(ji_QUR==jg_oe.jc_oQUR.jc_QUR_QueryLimSBS)
jr_sUrlImg=this.MakeUrlIcon_QUR(this.jc_oIcons.jc_sIconPrefix_QTT+ji_Status);else if(ji_QUR==jg_oe.jc_oQUR.jc_QUR_QuerySBS)
jr_sUrlImg=this.MakeUrlIcon_QUR(this.jc_oIcons.jc_sIconPrefix_QEN+ji_Status);else if(ji_QUR==jg_oe.jc_oQUR.jc_QUR_QuerySBT)
jr_sUrlImg=this.MakeUrlIcon_QUR(this.jc_oIcons.jc_sIconPrefix_QEN+ji_Status);else if(ji_QUR==jg_oe.jc_oQUR.jc_QUR_QueryLimSBT)
...
{if(!ji_sAZN)
return null;return this.MakeUrlIcon_Base("a3xas/a3xam/misc/Map-"+ji_sAZN+"-200x150.jpg",false);};this._A3xaAppMngIcons();}
function A3xaEnvironment()
{A3xaAbsEnvironment.call(this);this.jm_oecp=null;this.jm_oAppXUR=null;this.Get_AppXUR=function(){return this.jm_oAppXUR;};this.jm_oAppMngIcons=null;this.Get_3xAppMngIcons=function(){return this.jm_oAppMngIcons;};this.Get_DefIcons=function(){return this.Get_3xAppMngIcons().Get_DefIcons();};}
function A3xaEntity_Html(ji_oxe,ji_o3xehf)
{var jt_this=this;this.jm_oxe=ji_oxe;this.jm_o3xehf=ji_o3xehf;this.jm_bNoShiftIdTag=false;this.IsValid=function()
{if(!(this.jm_oxe&&this.jm_oxe.IsValid()))
return false;if(!this.jm_o3xehf)
return false;return true;};this.DoNotShiftIdTag=function(){this.jm_bNoShiftIdTag=true;return true;};this._Get_CellInfo=function(ji_Col)
{if(!jt_this.jm_o3xehf)
return null;var jr_oci={jm_Row:jt_this.jm_o3xehf.jm_RowHF,jm_Col:ji_Col,jm_o3xehc:null,qm_oCellH:null,qm_oCell:null};if(!(jr_oci.jm_Row>=1))
...
{jt_oci=this._Get_CellInfo(jg_oe.jc_oHtml.jc_Col_IdTag);if(jt_oci)
{jt_oci.qm_oCellH.text("");this.PrintHtml_IdTagBox(jt_oci.qm_oCellH,jt_oci.jm_Row,jt_oci.jm_Col);}
jt_oci=this._Get_CellInfo(jg_oe.jc_oHtml.jc_Col_LandIcons);if(jt_oci)
{jt_oci.qm_oCellH.text("");this.PrintHtml_LandBox(jt_oci.qm_oCellH,jt_oci.jm_Row,jt_oci.jm_Col,true,jg_oe.jc_oHtml.jc_Col_Identity);}
jt_oci=this._Get_CellInfo(jg_oe.jc_oHtml.jc_Col_Identity);if(jt_oci)
...
jt_oci=this._Get_CellInfo(jg_oe.jc_oHtml.jc_Col_InfoIcons);if(jt_oci)
{}
jt_oci=this._Get_CellInfo(jg_oe.jc_oHtml.jc_Col_ControlIcons);if(jt_oci)
{jt_oci.qm_oCellH.text("");this.PrintHtml_IconsViewBox(jt_oci.qm_oCellH,jt_oci.jm_Row,jt_oci.jm_Col);}
jt_oci=this._Get_CellInfo(jg_oe.jc_oHtml.jc_Col_AdminIcons);if(jt_oci)
{}
jt_oci=this._Get_CellInfo(jg_oe.jc_oHtml.jc_Col_Info);if(jt_oci)
{jt_oci.qm_oCellH.text("");this.PrintHtml_DescrBox(jt_oci.qm_oCellH);}
return true;}
if(!ji_bHeader&&!ji_bLowPriority)
{jt_oci=this._Get_CellInfo(jg_oe.jc_oHtml.jc_Col_IdTag);if(jt_oci&&jt_oci.qm_oCell)
{jt_oci.qm_oCell.text("");this.PrintHtml_IdTagBoxStatus(jt_oci.qm_oCell,jt_oci.jm_Row,jt_oci.jm_Col);}
jt_oci=this._Get_CellInfo(jg_oe.jc_oHtml.jc_Col_LandIcons);if(jt_oci&&jt_oci.qm_oCell)
{jt_oci.qm_oCell.text("");this.PrintHtml_LandBox(jt_oci.qm_oCell,jt_oci.jm_Row,jt_oci.jm_Col,false,jg_oe.jc_oHtml.jc_Col_Identity);}
jt_oci=this._Get_CellInfo(jg_oe.jc_oHtml.jc_Col_Identity);if(jt_oci&&jt_oci.qm_oCell)
{jt_oci.qm_oCell.text("");this.PrintHtml_IdentityBoxCP(jt_oci.qm_oCell,jt_oci.jm_Row,jt_oci.jm_Col);}
jt_oci=this._Get_CellInfo(jg_oe.jc_oHtml.jc_Col_InfoIcons);if(jt_oci&&jt_oci.qm_oCell)
{jt_oci.qm_oCell.text("");this.PrintHtml_InfoIconsBox(jt_oci.qm_oCell,jt_oci.jm_Row,jt_oci.jm_Col);}
jt_oci=this._Get_CellInfo(jg_oe.jc_oHtml.jc_Col_ControlIcons);if(jt_oci&&jt_oci.qm_oCell)
{jt_oci.qm_oCell.text("");this.PrintHtml_ControlIconsBox(jt_oci.qm_oCell,jt_oci.jm_Row,jt_oci.jm_Col);}
jt_oci=this._Get_CellInfo(jg_oe.jc_oHtml.jc_Col_AdminIcons);if(jt_oci&&jt_oci.qm_oCell)
{jt_oci.qm_oCell.text("");this.PrintHtml_IconsAdminBox(jt_oci.qm_oCell,jt_oci.jm_Row,jt_oci.jm_Col);}
jt_oci=this._Get_CellInfo(jg_oe.jc_oHtml.jc_Col_Info);if(jt_oci&&jt_oci.qm_oCell)
...
{if(!this.jm_bNoShiftIdTag&&ji_Row>0)
ji_Row--;if(ji_Row>0)
...
{var jt_aTypInfo=new Array(jg_oe.jc_oEntityInfo.jc_TI_QueryUnifiedRequest);for(var i=0;i<jt_aTypInfo.length;i++)
...
this.PrintHtml_SummaryBoxCP(qi_oCell,ji_Row,ji_Col);var jt_aTypInfo=new Array(jg_oe.jc_oEntityInfo.jc_TI_Note);for(var i=0;i<jt_aTypInfo.length;i++)
{var jt_aoeifa=this.jm_oxe.Get_Info(jt_aTypInfo[i],null);var jt_ogeiattr=new A3xaEntityInfo_Attributes(null,this.jm_oxe.Get_3xEBIS().Get_Name(),true,ji_Row,ji_Col,"",jg_oApp.Get_AppXUR().Get_3xXUR().jm_QUR);var jt_ogeiset=new A3xaEntityInfoSet(this.jm_oxe,jt_aoeifa,jt_ogeiattr);jt_ogeiset.PrintHtml(qi_oCell);}
...
jt_oxeidGroup.Set_IdEntity(jt_oxeidGroup.Get_IdGroup());var jt_oxur=new A3xaXur();jt_oxur.Set_UrlParams(jg_oe.jc_oMisc.jc_XURFN_ListEntity,null,null,jg_oe.jc_oQUR.jc_QUR_QueryViewEntity,jt_oxeidGroup.Get_String(),jg_oe.jc_oMisc.jc_XURTG_Single,null,null);jt_oxur.LinkMainData(jg_oe.Get_Database());jt_oxur.LinkCommonData(jg_oe.Get_Database(),false);var jt_te=jt_oxur.Get_3xXEID().Get_TypEntity();var jt_o3xaznc=jt_oxur.Get_3xXEID().Get_3xAZNC();var jt_o3xcat=jt_oxur.Get_3xXEID().Get_3xCat();var jt_o3xmngic=jg_oe.Get_3xAppMngIcons();var jt_odfic=jt_o3xmngic.Get_DefIcons();var jt_o3xurl=jt_oxur.Get_A3xaUrl(false,true);var jt_o3xhici=jt_o3xmngic.NewSprite(jg_oe.jc_oIcons.jc_oIconSS_ViewEntity.absid);jt_o3xhici.Set_UrlLink(jt_o3xurl.Get_Url());jt_o3xhici.Set_Title(this.jm_oxe.Get_3xEBIS().Get_Name(),jg_oe.Get_AppXUR().QUR_Get_Descr2(jg_oe.jc_oQUR.jc_QUR_QueryViewEntity,jt_te,jt_o3xaznc.Get_A(),jt_o3xaznc.Get_Z(),jt_o3xaznc.Get_N(),jt_o3xaznc.Get_C(),!jt_o3xcat.Get_Ucat()&&jt_te==jg_oe.jc_oEntity.jc_Typ_Enterprise));jt_o3xhici.Set_Options(null,false);var jt_ohButton=new A3xaSimpleButton3(jt_o3xhici);jt_ohButton.PrintHtml(qi_oCell);return true;};this.PrintHtml_IconsAdmin_NewMajor=function(qi_oCell,ji_Row,ji_Col)
...
jr_b=false;if(!this.PrintHtml_IconAdmin(qi_oCell,jg_oe.jc_oQUR.jc_QUR_QueryNewEntity,true))
jr_b=false;if(!this.PrintHtml_IconAdmin(qi_oCell,jg_oe.jc_oQUR.jc_QUR_QueryEditEntity,false))
jr_b=false;if(!this.PrintHtml_IconAdmin(qi_oCell,jg_oe.jc_oQUR.jc_QUR_QueryDeleteEntity,false))
jr_b=false;if(!this.PrintHtml_IconInfoAdmin(qi_oCell,jg_oe.jc_oQUR.jc_QUR_QueryNewEntity,null))
jr_b=false;if(!this.PrintHtml_IconInfoAdmin(qi_oCell,jg_oe.jc_oQUR.jc_QUR_QueryEditEntity,null))
jr_b=false;return jr_b;};this.PrintHtml_IconAdmin=function(qi_oCell,ji_QUR,ji_bSecundary)
{if(ji_QUR==jg_oe.jc_oQUR.jc_QUR_QueryNewEntity&&ji_bSecundary&&(!this.jm_oxe.Get_3xXEID().IsGroupMajor()))
return false;var jt_oUrlLink=A3xaEntity_MakeUrl_Edit_Params2(jg_oe.jc_oMisc.jc_XURFN_EditEntity,ji_QUR,this.jm_oxe.Get_3xXEID(),ji_QUR==jg_oe.jc_oQUR.jc_QUR_QueryNewEntity?ji_bSecundary:null,jg_oe.jm_Itemid);if(!jt_oUrlLink)
return false;var jt_o3xmngic=jg_oe.Get_3xAppMngIcons();var jt_odfic=jt_o3xmngic.Get_DefIcons();var jt_absid=jt_o3xmngic.Get_AbsidIconAdmin(ji_QUR,ji_bSecundary,false);var jt_o3xhici=jt_o3xmngic.NewSprite(jt_absid);jt_o3xhici.Set_Dim(24,24);jt_o3xhici.Set_UrlLink(jt_oUrlLink.Get_Url());jt_o3xhici.Set_Title(this.jm_oxe.Get_3xEBIS().Get_Name(),jg_oe.Get_AppXUR().QUR_Get_Descr2(ji_QUR,this.jm_oxe.Get_3xXEID().Get_TypEntity()));jt_o3xhici.Set_Options(null,false);var jt_ohButton=new A3xaSimpleButton3(jt_o3xhici);jt_ohButton.PrintHtml(qi_oCell);return true;};this.PrintHtml_IconInfoAdmin=function(qi_oCell,ji_QUR,ji_IdFieldInfo)
{var jt_oUrlLink=A3xaEntity_MakeUrl_EditInfo_Params(jg_oe.jc_oMisc.jc_XURFN_EditEntityInfo,ji_QUR,ji_IdFieldInfo,this.jm_oxe.Get_3xXEID().Get_TypEntity(),this.jm_oxe.Get_3xXEID().Get_IdEntity(),jg_oe.jm_Itemid);if(!jt_oUrlLink)
...
{var jt_oglrCategory=this.jm_oxe.Get_CommonLinkedRecord(jg_oe.jc_oEntity.jc_Typ_Category);var jt_oglrGeoArea=this.jm_oxe.Get_CommonLinkedRecord(jg_oe.jc_oEntity.jc_Typ_GeoArea);var jt_oglrGeoRegion=this.jm_oxe.Get_CommonLinkedRecord(jg_oe.jc_oEntity.jc_Typ_GeoRegion);var jt_sUrlWebsite="";if(!jt_sUrlWebsite&&this.jm_oxe)
...
var jt_ogeiattrCommon=new A3xaEntityInfo_Attributes(null,this.jm_oxe.Get_3xEBIS().Get_Name(),true,ji_Row,ji_Col,null);var jt_aoeifaMain=this.jm_oxe.Get_Info(jg_oe.jc_oEntityInfo.jc_TI_Image,null);var jt_ogeiset=new A3xaEntityInfoSet(this.jm_oxe,jt_aoeifaMain,jt_ogeiattrCommon);jt_ogeiset.PrintHtml(qt_oParent);if(jt_oglrGeoRegion)
...
var jt_oCPLandButtonStatus={jm_Value:null};var jt_ocpLand=new A3xaPanelLandIcons3(null,-1,ji_Row,jg_oe.jc_oHtml.jc_Col_LandIcons,true,ji_Col);jt_ocpLand.InitButtonsStatus(jt_oCPLandButtonStatus.jm_Value);return true;};this.PrintHtml_InfoIconsBox=function(qi_oCell,ji_Row,ji_Col)
...
{jt_sfn="jg_oPanelControlIcons_Builder.OnClick";var jt_oxur=new A3xaXur();jt_oxur.Set_UrlParams(jg_oe.jc_oMisc.jc_XURFN_AjaxEntity,null,jg_oe.jc_oAjax.jc_sAjaxTypFans,null,this.jm_oxe.Get_3xXEID().Get_String(),null,null,null);jt_oAjaxUrlParams=jt_oxur.Get_A3xaUrl(true);jt_oAjaxUrlParams.Add_UrlParam2("p_TypRelation","F");jt_oAjaxUrlParams.Add_UrlParam2("p_Op","I");jt_oAjaxUrlParams.Add_UrlParam2("p_Rating","0");}
var jt_ohBtnLikes=new A3xaEntityButton2("Like",-1,ji_Row,ji_Col,null);var jt_o3xhici=jg_oe.Get_3xAppMngIcons().NewSprite(jg_oe.jc_oIcons.jc_oIconMS_Like.absid);jt_ohBtnLikes.Set_SrcInfo3(jt_o3xhici,"Me gusta","Like",jt_sfn,-1,jt_oAjaxUrlParams?jt_oAjaxUrlParams.Get_UrlParams():"");var qi_oDivLikes=jQuery("<div>");qi_oDivLikes.attr("id","btnlikes_"+this.jm_oxe.Get_3xXEID().Get_TypEntity()+"_"+
...
{var jt_oxeid=new A3xaDCEntity();jt_oxeid.Get_3xXEID().Set_GEID(ji_TypEntity,ji_IdEntity,null,null);var jt_oxur=new A3xaXur();jt_oxur.Set_UrlParams(jg_oe.jc_oMisc.jc_XURFN_AjaxEntity,null,jg_oe.jc_oAjax.jc_sAjaxTypEntity,jg_oe.jc_oQUR.jc_QUR_UpdateEntity,jt_oxeid.Get_3xXEID().Get_String(),null,null,null);var jt_oUrl=jt_oxur.Get_A3xaUrl(true);var jt_sAjaxUrlParams=jt_oUrl.Get_UrlParams();jt_sAjaxUrlParams+="&p_TypInfo="+ji_TypInfo+"&p_IdInfo="+ji_IdInfo+"&p_CodInfo="+ji_CodInfo+"&p_Op="+jg_oe.jc_oAjax.jc_AjaxOp_WriteDelta+"&p_Field=Clicks"+"&p_Value=1";jg_oe.jm_oAjax2.QueueRequest(new A3xaAjaxRequest2(jt_oUrl.Get_UrlBase(),jt_sAjaxUrlParams,this));return true;};this.OnAjaxReadyFn=function(ji_ogAjaxResponse)
{var jt_xmlAjaxTypEntity=ji_ogAjaxResponse.Get_ItemElement(jg_oe.jc_oAjax.jc_sAjaxTypEntity);if(jt_xmlAjaxTypEntity)
...
return null;if(ji_QUR!=jg_oe.jc_oQUR.jc_QUR_QueryNewEntity&&ji_QUR!=jg_oe.jc_oQUR.jc_QUR_QueryEditEntity&&ji_QUR!=jg_oe.jc_oQUR.jc_QUR_QueryDeleteEntity)
return null;var jt_oxur=new A3xaXur();jt_oxur.Set_UrlParams(ji_FormEvent,null,null,ji_QUR,ji_ogle.Get_3xXEID().Get_String(),null,ji_bSecundary?jg_oe.jc_oMisc.jc_XURTG_Secundary:jg_oe.jc_oMisc.jc_XURTG_Master,null);return jt_oxur.Get_A3xaUrl();}
...
return false;var jt_oxur=new A3xaXur();jt_oxur.Set_UrlParams(jg_oe.jc_oMisc.jc_XURFN_ListEntity,null,null,jg_oe.jc_oQUR.jc_QUR_QueryViewEntity,jt_oglrCategory.Get_3xXEID().Get_String(),jg_oe.jc_oMisc.jc_XURTG_Single,"",null);var jt_o3xmngic=jg_oe.Get_3xAppMngIcons();var jt_odfic=jt_o3xmngic.Get_DefIcons();var jt_o3xurl=jt_oxur.Get_A3xaUrl();var jt_o3xhici=jt_o3xmngic.NewSprite(jt_oglrCategory.Get_3xEBIS().Get_Idsym());jt_o3xhici.Set_Dim(24,24);jt_o3xhici.Set_UrlLink(jt_o3xurl.Get_Url());jt_o3xhici.Set_Title(jt_oglrCategory.Get_3xEBIS().Get_Name(),jt_o3xcat.Get_Code());jt_o3xhici.Set_Options(null,false);var jt_ohButton=new A3xaSimpleButton3(jt_o3xhici);if(!jt_ohButton.PrintHtml(qi_oParent))
return false;return true;};}
...
var jt_oddiCategory=new A3xaDDItemCategory();jt_oddiCategory.Set_Descr("*** TODOS ***");var jt_aoglr=jt_ogldtMain.Get_Recordsel();var jt_nOfRows=jt_aoglr.Get_Count();for(var i=0;i<jt_nOfRows;i++)
...
{jr_oxur.Get_3xXEID().Set_GEID(jt_TypGeo,null,null,null);jr_oxur.Get_3xXEID().Get_3xAZNC().Clear();jr_oxur.Get_3xXEID().Get_3xPS().Clear();jr_oxur.MakeQUR(true,false);jr_oxur.jm_Single=jg_oe.jc_oMisc.jc_XURTG_Multiple;jr_oxur.jm_SubEntity=jg_oe.jc_oMisc.jc_XURTG_Master;}
else if(jt_TypGeo==jg_oe.jc_oEntity.jc_Typ_GeoRegion)
{if(!jr_oxur.Get_3xXEID().Get_3xAZNC().Get_Z()||New_A3xaAZNC_XApp(jr_oxur.Get_3xXEID()).IsBestFromBabylon())
return null;jr_oxur.Get_3xXEID().Get_3xCat().Clear();jr_oxur.Get_3xXEID().Set_GEID(jt_TypGeo,null,null,null);jr_oxur.Get_3xXEID().Get_3xAZNC().Clear_NC();jr_oxur.Get_3xXEID().Get_3xPS().Clear();jr_oxur.MakeQUR(true,false);jr_oxur.jm_Single=jg_oe.jc_oMisc.jc_XURTG_Multiple;jr_oxur.jm_SubEntity=jg_oe.jc_oMisc.jc_XURTG_Master;}
else if(jt_TypGeo==jg_oe.jc_oEntity.jc_Typ_GeoCity)
{if(!jr_oxur.Get_3xXEID().Get_3xAZNC().Get_Z()||New_A3xaAZNC_XApp(jr_oxur.Get_3xXEID()).IsBestFromBabylon())
return null;jr_oxur.Get_3xXEID().Get_3xCat().Clear();jr_oxur.Get_3xXEID().Set_GEID(jt_TypGeo,null,null,null);jr_oxur.Get_3xXEID().Get_3xAZNC().Clear_C();jr_oxur.Get_3xXEID().Get_3xPS().Clear();jr_oxur.MakeQUR(true,false);jr_oxur.jm_Single=jg_oe.jc_oMisc.jc_XURTG_Multiple;jr_oxur.jm_SubEntity=jg_oe.jc_oMisc.jc_XURTG_Master;}
else if(jt_TypGeo==jg_oe.jc_oEntity.jc_Typ_GeoCountry)
{jr_oxur.Get_3xXEID().Set_GEID(jt_TypGeo,null,null,null);jr_oxur.Get_3xXEID().Get_3xAZNC().Clear();jr_oxur.Get_3xXEID().Get_3xPS().Clear();jr_oxur.MakeQUR(true,false);jr_oxur.jm_Single=jg_oe.jc_oMisc.jc_XURTG_Multiple;jr_oxur.jm_SubEntity=jg_oe.jc_oMisc.jc_XURTG_Master;}
else if(jt_TypGeo==jg_oe.jc_oEntity.jc_Typ_GeoState)
{if(!jr_oxur.Get_3xXEID().Get_3xPS().Get_P()||New_A3xaAZNC_XApp(jr_oxur.Get_3xXEID()).IsBestFromBabylon())
return null;jr_oxur.Get_3xXEID().Set_GEID(jt_TypGeo,null,null,null);jr_oxur.Get_3xXEID().Get_3xAZNC().Clear();jr_oxur.Get_3xXEID().Get_3xPS().Clear_S();jr_oxur.MakeQUR(true,false);jr_oxur.jm_Single=jg_oe.jc_oMisc.jc_XURTG_Multiple;jr_oxur.jm_SubEntity=jg_oe.jc_oMisc.jc_XURTG_Master;}
else
...
{jr_oxur.jm_QUR=jg_oe.jc_oQUR.jc_QUR_QuerySBS;}
jr_oxur.jm_Single=jg_oe.jc_oMisc.jc_XURTG_Multiple;jr_oxur.jm_SubEntity=jg_oe.jc_oMisc.jc_XURTG_Master;}
return jr_oxur;};}
function A3xaMgrCategory_Request(ji_bShowLabel)
{this.jm_oddiRoot=null;this.jm_oddbox=null;this._A3xaMgrCategory_Request=function()
...
return false;var jt_ogldtCategory=jt_odb.Get_DataTable(jg_oe.jc_oA3xaDbZero.jc_GLID_Category);if(!jt_ogldtCategory)
return false;var jt_oddiRequestCategory=new A3xaDDItemRequestCategory();var jt_nOfRows=jt_ogldtCategory.Get_Recordset().Get_Count();jt_oddiRequestCategory.Set_Descr("*** TODOS ***");jt_oddiRequestCategory.Set_ValueXUR(null);for(var i=0;i<jt_nOfRows;i++)
...
{var jt_oxur=new A3xaXur();jt_oxur.Set_UrlParams(jg_oe.jc_oMisc.jc_XURFN_ListEntity,null,null,jg_oe.jc_oQUR.jc_QUR_QueryViewEntity,null,jg_oe.jc_oMisc.jc_XURTG_Single,"",null);jt_oxur.CopyFrom(jt_oglrGeoCountry,true,true,false,false);var jt_o3xmngic=jg_oe.Get_3xAppMngIcons();var jt_odfic=jt_o3xmngic.Get_DefIcons();var jt_o3xurl=jt_oxur.Get_A3xaUrl(false,true);var jt_o3xhici=jt_o3xmngic.NewSprite(jt_oglrGeoCountry.Get_3xEBIS().Get_Idsym());jt_o3xhici.Set_Dim(24,16);jt_o3xhici.Set_UrlLink(jt_o3xurl.Get_Url());jt_o3xhici.Set_Title(jt_oglrGeoCountry.Get_3xEBIS().Get_Name(),jt_oglrGeoCountry.Get_3xXEID().Get_3xPS().Get_P());jt_o3xhici.Set_Options(null,false);var jt_ohButton=new A3xaSimpleButton3(jt_o3xhici);if(!jt_ohButton.PrintHtml(qi_oParent))
return false;}
...
{var jt_oxur=new A3xaXur();jt_oxur.Set_UrlParams(jg_oe.jc_oMisc.jc_XURFN_ListEntity,null,null,jg_oe.jc_oQUR.jc_QUR_QueryViewEntity,null,jg_oe.jc_oMisc.jc_XURTG_Single,"",null);jt_oxur.CopyFrom(jt_oglrGeoState,true,true,false,false);jt_oxur.LinkCommonData(jg_oe.Get_Database(),true);var jt_o3xmngic=jg_oe.Get_3xAppMngIcons();var jt_odfic=jt_o3xmngic.Get_DefIcons();var jt_o3xurl=jt_oxur.Get_A3xaUrl(false,true);var jt_o3xhici=jt_o3xmngic.NewSprite(jt_oglrGeoState.Get_3xEBIS().Get_Idsym());jt_o3xhici.Set_Dim(24,16);jt_o3xhici.Set_UrlLink(jt_o3xurl.Get_Url());jt_o3xhici.Set_Title(jt_oglrGeoState.Get_3xEBIS().Get_Name()+" ("+jt_oglrGeoState.Get_3xXEID().Get_3xPS().Get_P()+")",jt_oglrGeoState.Get_3xXEID().Get_3xPS().Get_S()+"("+jt_oglrGeoState.Get_3xXEID().Get_3xPS().Get_P()+")");jt_o3xhici.Set_Options(null,false);var jt_ohButton=new A3xaSimpleButton3(jt_o3xhici);if(!jt_ohButton.PrintHtml(qi_oParent))
return false;}
...
{var jt_oxur=new A3xaXur();jt_oxur.Set_UrlParams(jg_oe.jc_oMisc.jc_XURFN_ListEntity,null,null,jg_oe.jc_oQUR.jc_QUR_QueryViewEntity,null,jg_oe.jc_oMisc.jc_XURTG_Single,"",null);jt_oxur.CopyFrom(jt_oglrGeoRegion,true,true,false,false);jt_oxur.LinkCommonData(jg_oe.Get_Database(),true);var jt_flagCode=A3xaToString(jt_oglrGeoArea.Get_3xXEID().Get_3xAZNC().Get_A())+
A3xaToString(jt_oglrGeoArea.Get_3xXEID().Get_3xAZNC().Get_Z());var jt_shortdescr=jt_oglrGeoRegion.Get_3xXEID().Get_3xAZNC().Get_N()+"("+jt_flagCode+")";var jt_o3xmngic=jg_oe.Get_3xAppMngIcons();var jt_odfic=jt_o3xmngic.Get_DefIcons();var jt_o3xurl=jt_oxur.Get_A3xaUrl(false,true);var jt_o3xhici=jt_o3xmngic.NewSprite(jt_oglrGeoArea.Get_3xEBIS().Get_Idsym());jt_o3xhici.Set_Dim(24,16);jt_o3xhici.Set_UrlLink(jt_o3xurl.Get_Url());jt_o3xhici.Set_Title(jt_oglrGeoRegion.Get_3xEBIS().Get_Name()+", "+jt_oglrGeoArea.Get_3xEBIS().Get_Name(),jt_shortdescr);jt_o3xhici.Set_Options(null,false);var jt_ohButton=new A3xaSimpleButton3(jt_o3xhici);if(!jt_ohButton.PrintHtml(qi_oParent))
return false;}
...
{var jt_oxur=new A3xaXur();jt_oxur.Set_UrlParams(jg_oe.jc_oMisc.jc_XURFN_ListEntity,null,null,jg_oe.jc_oQUR.jc_QUR_QueryViewEntity,null,jg_oe.jc_oMisc.jc_XURTG_Single,"",null);jt_oxur.CopyFrom(jt_oglrGeoCity,true,true,false,false);jt_oxur.LinkCommonData(jg_oe.Get_Database(),true);var jt_o3xcat_Category_Geo_City=new A3xaCategoryCode();jt_o3xcat_Category_Geo_City.Set_Category(jg_oe.jc_oEntity.jc_UCat_Geo,jg_oe.jc_oEntity.jc_VCat_Geo_City);var jt_o3xmngic=jg_oe.Get_3xAppMngIcons();var jt_odfic=jt_o3xmngic.Get_DefIcons();var jt_o3xurl=jt_oxur.Get_A3xaUrl(false,true);var jt_o3xhici=jt_o3xmngic.NewSprite(jt_odfic.jc_oIconCat_City.absid);jt_o3xhici.Set_Dim(24,24);jt_o3xhici.Set_UrlLink(jt_o3xurl.Get_Url());jt_o3xhici.Set_Title(jt_oglrGeoCity.Get_3xEBIS().Get_Name(),"CTY");jt_o3xhici.Set_Options(null,false);var jt_ohButton=new A3xaSimpleButton3(jt_o3xhici);if(!jt_ohButton.PrintHtml(qi_oParent))
return false;}
...
{jt_oxur.Set_UrlParams(null,null,null,jg_oe.jc_oQUR.jc_QUR_QuerySBS,jt_sxeidQUR,null,null,null);this.Set_Value("p3x="+jt_oxur.Get_XURString());}
else if(this.jm_odce.Get_3xXEID().Get_3xAZNC().Get_Z())
{jt_oxur.Set_UrlParams(null,null,null,jg_oe.jc_oQUR.jc_QUR_QueryLimSBS,jt_sxeidQUR,null,null,null);this.Set_Value("p3x="+jt_oxur.Get_XURString());}
else if(this.jm_odce.Get_3xXEID().Get_3xAZNC().Get_A())
{this.jm_bOnChange=false;jt_oxur.Set_UrlParams(null,null,null,jg_oe.jc_oQUR.jc_QUR_QueryLimSBS,jt_sxeidQUR,null,null,null);this.Set_Value("p3x="+jt_oxur.Get_XURString());}
else
{jt_oxur.Set_UrlParams(null,null,null,jg_oe.jc_oQUR.jc_QUR_QueryLimSBS,jt_sxeidQUR,null,null,null);this.Set_Value("p3x="+jt_oxur.Get_XURString());}}
...
{var jt_this=this;this.jm_oddiRoot=null;this.jm_oddbox=null;this._A3xaMgrLand_RequestArea=function()
{if(this.IsArea())
...
if(this.IsArea())
{var jt_oddiRequestArea=new A3xaDDItemRequestArea();var jt_nOfRows=jt_ogldtArea.Get_Recordset().Get_Count();jt_oddiRequestArea.Set_Descr("*** TODOS ***");var jt_odcer=new A3xaDCEntity();jt_odcer.Get_3xXEID().Set_GEID(jg_oe.jc_oEntity.jc_Typ_Enterprise,null,null,null);jt_odcer.Get_3xXEID().Get_3xCat().Clear();jt_odcer.Get_3xXEID().Get_3xAZNC().Clear();jt_odcer.Get_3xXEID().Get_3xPS().Clear();jt_oddiRequestArea.Set_DCEntity(jt_odcer);for(var i=0;i<jt_nOfRows;i++)
...
{if(!ji_odc)
return null;var jt_QUR=jg_oe.jc_oQUR.jc_QUR_QueryLimSBS;var jt_odc=new A3xaDCEntity();jt_odc.CopyFrom(ji_odc,true,false,false,false);jt_odc.Get_3xXEID().Set_GEID(jg_oe.jc_oEntity.jc_Typ_Enterprise,null,null,null);jt_odc.Get_3xXEID().Get_3xCat().Clear();if(this.IsArea())
{jt_QUR=jg_oe.jc_oQUR.jc_QUR_QuerySBS;jt_odc.Get_3xXEID().Get_3xAZNC().Clear_C();}
else if(this.IsRegion())
{jt_QUR=jg_oe.jc_oQUR.jc_QUR_QuerySBS;}
else
...
{if(!ji_Status)
ji_Status="DIS";if(this.jm_sTypArea=="LA")
return jg_oe.Get_3xAppMngIcons().MakeUrlIcon_UserControls2(jg_oe.jc_oIcons.jc_oIconMS_StaticMapLA,ji_Status,true);else if(this.jm_sTypArea=="Area")
return jg_oe.Get_3xAppMngIcons().MakeUrlIcon_UserControls2(jg_oe.jc_oIcons.jc_oIconMS_StaticMapArea,ji_Status,true);else if(this.jm_sTypArea=="Region")
return jg_oe.Get_3xAppMngIcons().MakeUrlIcon_UserControls2(jg_oe.jc_oIcons.jc_oIconMS_StaticMapRegion,ji_Status,true);return"";};this.PrintHtml=function(qi_oParent)
...
{var jt_surlIcon_DIS=this.Get_UrlIcon("DIS");qt_oTabsImg=jQuery("<img>",{id:jt_sQHTabsImg,src:jt_surlIcon_DIS,width:'16',height:'16',border:'0'});}
...
return"DIS";else if(jt_urlCur==this.Get_UrlIcon("ON"))
return"ON";else if(jt_urlCur==this.Get_UrlIcon("OFF"))
return"OFF";}
...
{qi_oTabsImg.attr('src',this.Get_UrlIcon(ji_Status));}
...
return false;return true;};this._A3xaMgrLand_InteractiveMap();};function A3xaECPOrder_DDIOption(ji_sKey,ji_sValue,ji_sDescr)
...
{var jt_oDatabase=jg_oe.Get_Database();var jt_ohes=jg_oe.Get_HtmlSetEntity();var jt_oxur=jg_oApp.Get_AppXUR().Get_3xXUR();var jt_oxurNew=new A3xaXur();jt_oxurNew.CopyFromXUR(jt_oxur);if(ji_oddi.Get_Value()==this.jc_Opt_ByTimeDesc)
...
{if(!this.PrintHtml_IconAdmin(qi_oCell,jg_oe.jc_oQUR.jc_QUR_QueryNewEntity,false))
{}}
return true;};this.PrintHtml_SummaryBoxCP=function(qi_oCell,ji_Row,ji_Col)
...
jr_gei=new GEISimpleButton(this.jm_oglr,ji_oeifa,new Array(new GEISimpleButton_Parameters2(jg_oe.jc_oEntityInfo.jc_CI_Facebook_Page,true,jg_oe.jc_oIcons.jc_oIconSS_FacebookPage,"Pagina Facebook","fbp"),new GEISimpleButton_Parameters2(jg_oe.jc_oEntityInfo.jc_CI_Facebook_Group,false,jg_oe.jc_oIcons.jc_oIconSS_FacebookGroup,"Grupo Facebook","fbg"),new GEISimpleButton_Parameters2(jg_oe.jc_oEntityInfo.jc_CI_Facebook_User,false,jg_oe.jc_oIcons.jc_oIconSS_FacebookUser,"Perfil Facebook","fbu")));else if(jt_ti==jg_oe.jc_oEntityInfo.jc_TI_Twitter)
...
jr_gei=new GEISimpleButton(this.jm_oglr,ji_oeifa,new Array(new GEISimpleButton_Parameters2(jg_oe.jc_oEntityInfo.jc_CI_Gallery_FlickrUrl,true,jg_oe.jc_oIcons.jc_oIconSS_Flickrtxt,"Galeria Foto","gal"),new GEISimpleButton_Parameters2(jg_oe.jc_oEntityInfo.jc_CI_Gallery_Flickrset,true,jg_oe.jc_oIcons.jc_oIconSS_Flickrtxt,"Flickr-set","gfs",null,null,null,null,null,null,"http://www.flickr.com/photos/avenidaazul/sets/"),new GEISimpleButton_Parameters2(jg_oe.jc_oEntityInfo.jc_CI_A3xaGallery_FlickrGallery,true,jg_oe.jc_oIcons.jc_oIconSS_Flickrtxt,"Flickr-gallery","gfg",null,null,null,null,null,null,"http://www.flickr.com/photos/avenidaazul/galleries/")));else if(jt_ti==jg_oe.jc_oEntityInfo.jc_TI_A3xaGallery)
jr_gei=new GEISimpleButton(this.jm_oglr,ji_oeifa,new Array(new GEISimpleButton_Parameters2(jg_oe.jc_oEntityInfo.jc_CI_A3xaGallery_Url,true,jg_oe.jc_oIcons.jc_oIconSS_A3xaGallery,"Galeria Foto A3xa","gaa"),new GEISimpleButton_Parameters2(jg_oe.jc_oEntityInfo.jc_CI_A3xaGallery_Flickrset,true,jg_oe.jc_oIcons.jc_oIconSS_A3xaGallery,"Galeria Foto A3xa","gaa",null,null,null,null,null,null,"index.php?option=com_content&view=article&id=34"+"&Itemid=397"+"&p_TypInfo="+jg_oe.jc_oEntityInfo.jc_TI_A3xaGallery+"&p_CodInfo="+jg_oe.jc_oEntityInfo.jc_CI_A3xaGallery_Flickrset+"&p_Flickrset=")));else if(jt_ti==jg_oe.jc_oEntityInfo.jc_TI_Person)
...
{var jt_oUrlLink=null;var jt_sTitle=null;var jt_sId=null;var jt_sSimplePopupPluginContents=null;if(jt_oParSB.jm_bSimplePopupPlugin)
...
{if(!ji_s)
return null;if(ji_oParametersSB.jm_CodInfo==jg_oe.jc_oEntityInfo.jc_CI_Video_YoutubeId)
...
{if(!this.IsValid())
return false;if(!(qi_oParent&&qi_oParent.length))
return false;var jt_aMaster=this.jm_oeifa.Get_Master();var jt_ogeiattr=this.jm_oeifa.Get_Attributes();var jt_sText=jt_aMaster[jg_oe.jc_oA3xaDbZero.jc_Eifa_Info];var jt_CodInfo=jt_aMaster[jg_oe.jc_oA3xaDbZero.jc_Eifa_Cod];if(!jt_CodInfo||jt_CodInfo==jg_oe.jc_oEntityInfo.jc_CI_QueryUnifiedRequest_DD)
...
continue;var jt_sUrlImg="";var jt_sTitle="";var jt_QUR="";if(jt_addi[0].indexOf(jg_oe.jc_oQUR.jc_QUR_QueryLimSBS)>=0)
jt_QUR=jg_oe.jc_oQUR.jc_QUR_QueryLimSBS;else if(jt_addi[0].indexOf(jg_oe.jc_oQUR.jc_QUR_QuerySBS)>=0)
jt_QUR=jg_oe.jc_oQUR.jc_QUR_QuerySBS;else if(jt_addi[0].indexOf(jg_oe.jc_oQUR.jc_QUR_QuerySBT)>=0)
jt_QUR=jg_oe.jc_oQUR.jc_QUR_QuerySBT;else if(jt_addi[0].indexOf(jg_oe.jc_oQUR.jc_QUR_QueryLimSBT)>=0)
jt_QUR=jg_oe.jc_oQUR.jc_QUR_QueryLimSBT;if(jt_QUR)
{var jt_oxur=new A3xaXur();jt_oxur.Set_UrlParams(jg_oe.jc_oMisc.jc_XURFN_ListEntity,null,null,null,null,null,null,jt_addi[0]);jt_oxur.LinkCommonData(jg_oe.Get_Database(),true);var jt_ohButton=new A3xaSimpleButton(jg_oe.Get_3xAppMngIcons().Get_UrlIconQUR(jt_QUR,i==jt_ddiSelected?"ON":"OFF"),jt_oxur.Get_A3xaUrl(false,true),jg_oe.Get_AppXUR().QUR_Get_Descr2(jt_QUR,jt_oxur.Get_3xXEID().Get_TypEntity()),jt_QUR);jt_ohButton.Set_Options(null,null,false,null,false,null,null);jt_ohButton.PrintHtml(qi_oParent);}}
...
jg_oe.jc_oA3xaDbZero.jc_GLMID_DT);jt_oAjaxUrlParams.Add_UrlParam2("p_GLAltIndex",jg_oe.jc_oA3xaDbZero.jc_GLID_Enterprise+
jg_oe.jc_oA3xaDbZero.jc_GLMID_AX);var jt_o3xhici=jg_oe.Get_3xAppMngIcons().NewSprite(jg_oe.jc_oIcons.jc_oIconMS_Turbo.absid);jt_oBtnTurbo.Set_SrcInfo3(jt_o3xhici,"A3xaTurboZero (...en desarrollo...) - ahora está "+jg_oe.Get_TurboDescr(),"Turbo","jg_oPanelControlIcons_Builder.OnClick",-1,jt_oAjaxUrlParams?jt_oAjaxUrlParams.Get_UrlParams():"");jt_oBtnTurbo.AttachProperties(false,false,true);jt_oBtnTurbo.Set_Status(jg_oe.IsTurboON()?"ON":"OFF",false);}
var jt_oBtnGLMore=this.Get_Button("GLMore");if(jt_oBtnGLMore)
{var jt_o3xhici=jg_oe.Get_3xAppMngIcons().NewSprite(jg_oe.jc_oIcons.jc_oIconMS_GLMore.absid);jt_oBtnGLMore.Set_SrcInfo3(jt_o3xhici,"Expandir","xpd","jg_oPanelControlIcons_Builder.OnClick",-1,null);jt_oBtnGLMore.Set_Properties(false);jt_oBtnGLMore.AttachProperties(this.IsMaster(),true,false);}
...
jt_RowElem=document.getElementById("RowS_"+jt_Row);if(jt_RowElem==null)
break;var jt_oxeid=new A3xaDCEntity();var jt_o3xxeid=jt_oxeid.Get_3xXEID();jt_o3xxeid.Set_String(jt_RowElem.getAttribute('XEIDCode'));var jt_TypEntity=jt_o3xxeid.Get_TypEntity();if(jt_TypEntity==jg_oe.jc_oEntity.jc_Typ_MetaSystemControl)
{if(jg_oApp.jm_oecp.Set_MasterPanelRow(jt_Row))
{var jt_oExecPanel=new A3xaPanelControlIcons(null,-1,jt_Row,jg_oe.jc_oHtml.jc_Col_ControlIcons,true,true,"");var jt_oHostReporter=jg_oe.Get_Reporter();jt_oHostReporter.Set_AjaxUrlParams("&p_GLTurbo="+jg_oe.Get_TurboString()+"&p_GLHeader="+jg_oe.jc_oA3xaDbZero.jc_GLID_All+jg_oe.jc_oA3xaDbZero.jc_GLMID_DT+"&p_GLAltIndex="+jg_oe.jc_oA3xaDbZero.jc_GLID_Enterprise+jg_oe.jc_oA3xaDbZero.jc_GLMID_AX);jt_oHostReporter.Set_ExecDevice(jt_oExecPanel);var jt_bSingle=false;var jt_oxur=null;var jt_oAppXUR=jg_oApp.Get_AppXUR();if(jt_oAppXUR)
...
{var jt_o3xhici=jg_oe.Get_3xAppMngIcons().NewSprite(jg_oe.jc_oIcons.jc_oIconMS_StaticMapArea.absid);jt_o3xhici.Set_Options=(null,false);jt_oBtnStaticMapA.Set_SrcInfo3(jt_o3xhici,"Mapa Area","MapA","A3xaPanelLandIcons3_OnClick",ji_ColImages,"",null);jt_oBtnStaticMapA.Set_Properties(false);jt_oBtnStaticMapA.AttachProperties(this.IsMaster(),false,false);}
var jt_oBtnStaticMapR=this.Get_Button("StaticMapR");if(jt_oBtnStaticMapR)
{var jt_o3xhici=jg_oe.Get_3xAppMngIcons().NewSprite(jg_oe.jc_oIcons.jc_oIconMS_StaticMapRegion.absid);jt_o3xhici.Set_Options=(null,false);jt_oBtnStaticMapR.Set_SrcInfo3(jt_o3xhici,"Mapa Region","MapR","A3xaPanelLandIcons3_OnClick",ji_ColImages,"",null);jt_oBtnStaticMapR.Set_Properties(false);jt_oBtnStaticMapR.AttachProperties(this.IsMaster(),false,false);}
...
{this.jm_o3xehf=ji_o3xehf;this.jm_oxe=ji_oxe;this.jm_Row=(ji_Row||null);this.jm_Col=(ji_Col||null);this.jm_Header_Id="CellH_"+this.jm_Row+"_"+this.jm_Col;this.jm_Body_Id="Cell_"+this.jm_Row+"_"+this.jm_Col;this.jm_Header_Width=30;this.jm_Header_Colspan=null;this.jm_Header_Padding=1;this.jm_Header_Align=null;this.jm_Header_VerticalAlign=null;this.jm_Header_Float=null;this.jm_Header_Height=null;this.jm_Header_Bkgnd_o3xhIconInfo=null;this.jm_Header_BkgndColor="FFFFFF";this.jm_Body_Width=30;this.jm_Body_Padding=1;this.jm_Body_Align=null;this.jm_Body_VerticalAlign=null;this.jm_Body_Float=null;this.jm_Body_Height=null;this.jm_Body_Bkgnd_o3xhIconInfo=null;this.jm_Body_BkgndColor="FFFFFF";this._A3xaEntity_HtmlFrameColumn=function()
{var jt_sColor=this.jm_oxe.Get_3xEBIS().Get_Color();if(jt_sColor)
this.jm_Header_BkgndColor=jt_sColor;};this.Get_Elem=function(ji_bHeader)
{if(ji_bHeader)
...
return null;return qt_oCell;};this.Set_Options_Header=function(ji_Width,ji_Padding,ji_VerticalAlign,ji_Float,ji_Height,ji_Colspan)
{if(!(ji_Width===null))
...
return false;var jt_oglrCategory=this.jm_oxe.Get_CommonLinkedRecord(jg_oe.jc_oEntity.jc_Typ_Category);var jt_oglrGeoArea=this.jm_oxe.Get_CommonLinkedRecord(jg_oe.jc_oEntity.jc_Typ_GeoArea);var jt_oglrGeoCountry=this.jm_oxe.Get_CommonLinkedRecord(jg_oe.jc_oEntity.jc_Typ_GeoCountry);var jt_sBgColor=null;if(jt_oglrCategory)
jt_sBgColor=jt_oglrCategory.Get_3xEBIS().Get_Color();if(this.jm_Col==jg_oe.jc_oHtml.jc_Col_IdTag)
{this.Set_Options_Header(100,null,null,null,null,null);this.Set_Options_Body(100,null,"top","none","none");this.Set_Options_Header_Bkgnd("");this.Set_XtdOptions_Header("right");this.Set_XtdOptions_Body("right");}
else if(this.jm_Col==jg_oe.jc_oHtml.jc_Col_LandIcons)
{this.Set_Options_Header(30,null,null,null,null,null);this.Set_Options_Body(30,null,"top","none","none");var jt_o3xhici=null;if(jt_oglrGeoArea)
...
{this.Set_Options_Header("",null,null,null,null,2);this.Set_Options_Body(210,"1px","top","none","none");this.Set_Options_Header_Bkgnd(jt_sBgColor);}
else if(this.jm_Col==jg_oe.jc_oHtml.jc_Col_InfoIcons)
{this.Set_Options_Body(110,null,"top","none","none");if(ji_bFrameHeader)
return true;}
else if(this.jm_Col==jg_oe.jc_oHtml.jc_Col_ControlIcons)
{this.Set_Options_Header(70,null,null,null,null,2);this.Set_Options_Body(null,null,null,"none","none");this.Set_Options_Header_Bkgnd(jt_sBgColor);}
else if(this.jm_Col==jg_oe.jc_oHtml.jc_Col_AdminIcons)
{this.Set_Options_Body(null,null,"top","none","none");if(ji_bFrameHeader)
return true;}
...
{if(jt_oStyle)
qi_oCell.css(jt_oStyle);}}}
var qt_oCellPrev=null;for(var ib=this.jm_Col-1;ib>0&&!(qt_oCellPrev&&qt_oCellPrev.length);ib--)
...
{this.jm_RowHF=(ji_RowHF||null);this.jm_oxeid=null;this.qm_oHeader=null;this.qm_oBody=null;this.jm_bStick=false;this.jm_oxe=null;this.jm_ao3xehc=new Array();this.Set_XtdEntity=function(ji_oxe)
...
{return this.jm_oxeid&&this.jm_oxeid.Get_3xXEID().Get_TypEntity()==jg_oe.jc_oEntity.jc_Typ_MetaSystemControl;};this.Get_3xXEID=function(){return this.jm_oxeid||null;};this.ReplaceId=function(ji_RowHF)
{if(this.IsEOT())
return false;this.qm_oHeader.attr("id","RowH_"+ji_RowHF);this.qm_oBody.attr("id",(this.IsStick()?"RowS_":"Row_")+ji_RowHF);this.jm_RowHF=ji_RowHF;return true;};this.Clear=function()
{this.jm_oxeid=null;this.qm_oHeader=null;this.qm_oBody=null;this.jm_bStick=false;return true;};this.LoadFromHtml=function()
{this.qm_oHeader=null;this.qm_oBody=null;this.jm_bStick=false;this.jm_oxeid=null;if(!(this.jm_RowHF>0))
return false;var qt_oHeader=jQuery("#RowH_"+this.jm_RowHF);if(!(qt_oHeader&&qt_oHeader.length))
return false;this.qm_oHeader=qt_oHeader;var qt_oBody=jQuery("#Row_"+this.jm_RowHF);if(!(qt_oBody&&qt_oBody.length))
...
{if(!(this.jm_RowHF>0))
return null;this.qm_oHeader=jQuery('#RowH_'+this.jm_RowHF);if(!(this.qm_oHeader&&this.qm_oHeader.length))
return null;}
return this.qm_oHeader;};this.Get_ElemRow=function()
{if(!(this.qm_oBody&&this.qm_oBody.length))
{if(!(this.jm_RowHF>0))
return null;this.qm_oBody=jQuery('#Row_'+this.jm_RowHF);if(!(this.qm_oBody&&this.qm_oBody.length))
{this.qm_oBody=jQuery('#RowS_'+this.jm_RowHF);if(!(this.qm_oBody&&this.qm_oBody.length))
return null;}}
return this.qm_oBody;};this.MoveAfter=function(ji_RowHF,ji_bReplaceId)
...
{var jt_shTableRowH="<tr id='RowH_"+this.jm_RowHF+"'"+" XEIDCode='"+this.jm_oxe.Get_3xXEID().Get_String()+"'"+" style='float:none; height:none; visibility: visible;'></tr>";var jt_RowBPfx=(this.IsStick()?"RowS_":"Row_");var qt_oRowB=jQuery("#"+jt_RowBPfx+this.jm_RowHF);if(qt_oRowB&&qt_oRowB.length)
qt_oRowB.before(jt_shTableRowH);else
{jQuery("#A3xaTableMainBody").append(jt_shTableRowH);}
var jt_RowPfx=(this.IsStick()?"RowS_":"Row_");var jt_shTableRow="<tr id='"+jt_RowPfx+this.jm_RowHF+"'"+" XEIDCode='"+this.jm_oxe.Get_3xXEID().Get_String()+"'";if(this.IsStick())
...
jt_shTableRow+="</tr>";var qt_oRowH=jQuery("#RowH_"+this.jm_RowHF);if(qt_oRowH&&qt_oRowH.length)
qt_oRowH.after(jt_shTableRow);else;this.jm_ao3xehc.push(new A3xaEntity_HtmlFrameColumn(this,this.jm_oxe,this.jm_RowHF,jg_oe.jc_oHtml.jc_Col_IdTag));this.jm_ao3xehc.push(new A3xaEntity_HtmlFrameColumn(this,this.jm_oxe,this.jm_RowHF,jg_oe.jc_oHtml.jc_Col_LandIcons));this.jm_ao3xehc.push(new A3xaEntity_HtmlFrameColumn(this,this.jm_oxe,this.jm_RowHF,jg_oe.jc_oHtml.jc_Col_Identity));this.jm_ao3xehc.push(new A3xaEntity_HtmlFrameColumn(this,this.jm_oxe,this.jm_RowHF,jg_oe.jc_oHtml.jc_Col_InfoIcons));this.jm_ao3xehc.push(new A3xaEntity_HtmlFrameColumn(this,this.jm_oxe,this.jm_RowHF,jg_oe.jc_oHtml.jc_Col_ControlIcons));this.jm_ao3xehc.push(new A3xaEntity_HtmlFrameColumn(this,this.jm_oxe,this.jm_RowHF,jg_oe.jc_oHtml.jc_Col_AdminIcons));this.jm_ao3xehc.push(new A3xaEntity_HtmlFrameColumn(this,this.jm_oxe,this.jm_RowHF,jg_oe.jc_oHtml.jc_Col_Info));for(var i=0;i<this.jm_ao3xehc.length;i++)
...
{var jt_this=this;this.jm_nRows=null;this.jm_nRowsHF=null;this.jm_TimerLoPry=null;this.jm_bReleased=false;this.jm_ao3xehf=new Array();this.jm_ao3xeh=new Array();this.Release=function(ji_bClearHtml)
{this.jm_bReleased=true;this.jm_TimerLoPry=null;this.jm_ao3xeh=new Array();this.jm_ao3xehf=new Array();if(ji_bClearHtml)
...
{var jt_o3xAppWindow=new A3xaAppWindow();jt_o3xAppWindow.Stop();this.jm_TimerLoPry=null;return true;}
this.Init=function()
{var jt_ogldtMain=null;var jt_odb=jg_oe.Get_Database();if(jt_odb)
jt_ogldtMain=jt_odb.Get_MainDataTable();var jt_RowHF=1;var jt_o3xxemsc=jt_odb.Get_3xXEMSC_ByXUR();if(jt_o3xxemsc)
jt_RowHF++;var jt_nRows=0;var jt_nRowsHF=0;var jt_aoglr=null;if(jt_ogldtMain)
jt_aoglr=jt_ogldtMain.Get_Recordsel();if(jt_aoglr)
jt_nRows=jt_aoglr.Get_Count();jt_nRowsHF=jt_nRows+jt_RowHF-1;this.jm_nRows=jt_nRows;this.jm_nRowsHF=jt_nRowsHF;if(!(jt_nRows>0))
{if(jt_nRowsHF>0)
return true;return false;}
return true;};this.Get_EHRowList=function(ji_bIncludeCP)
{var jt_odb=jg_oe.Get_Database();if(!jt_odb)
return null;var jr_ao3xehf=new Array();var jt_RowHF=1;if(ji_bIncludeCP)
{var jt_o3xxemsc=jt_odb.Get_3xXEMSC_ByXUR();if(jt_o3xxemsc)
{var jt_o3xehf=this.FindRowElem(jt_oxe.Get_3xXEID(),1,jt_nRows);if(jt_o3xehf&&!jt_o3xehf.IsEOT())
{jr_ao3xehf.push(jt_o3xehf);jt_RowHF++;}}}
var jt_nRows=this.jm_nRows;var jt_nRowsHF=this.jm_nRowsHF;if(!(jt_nRows>0))
{if(jt_nRowsHF>0)
return jr_ao3xehf;return null;}
var jt_ogldtMain=jt_odb.Get_MainDataTable();if(!jt_ogldtMain)
return null;var jt_aoglr=jt_ogldtMain.Get_Recordsel();for(var jt_Row=1;jt_Row<=jt_nRows;jt_Row++)
{var jt_oxe=jt_aoglr.Get_Item_ByIndex(jt_Row-1);if(!jt_oxe)
break;var jt_o3xehf=this.FindRowElem(jt_oxe.Get_3xXEID(),1,jt_nRowsHF);if(!jt_o3xehf||jt_o3xehf.IsEOT())
...
var jt_odb=jg_oe.Get_Database();if(!jt_odb)
return false;var jt_RowHF=1;var jt_o3xxemsc=jt_odb.Get_3xXEMSC_ByXUR();if(jt_o3xxemsc)
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("PrintHtml-CP row:1");var jt_o3xehf=new A3xaEntity_HtmlFrame(jt_RowHF);jt_o3xehf.Set_XtdEntity(jt_o3xxemsc);this.jm_ao3xehf.push(jt_o3xehf);jt_o3xehf.PrintHtml();jt_RowHF++;}
jg_oe.CanLogInfo()&&jg_oe.LogInfo("PrintHtml-main Data Table:");var jt_nRows=this.jm_nRows;var jt_nRowsHF=this.jm_nRowsHF;jg_oe.CanLogInfo()&&jg_oe.LogInfo("PrintHtml-rows:"+jt_nRows);if(!(jt_nRows>0))
{if(jt_nRowsHF>0)
return true;return false;}
jg_oe.CanLogInfo()&&jg_oe.LogInfo("PrintHtml-rows2:"+jt_nRows);var jt_ogldtMain=jt_odb.Get_MainDataTable();if(!jt_ogldtMain)
return false;var jt_o3xait=jt_ogldtMain.Get_Recordsel();while(!jt_o3xait.IsEOF())
{var jt_oxe=jt_o3xait.Get_CurrentItem();if(jt_o3xxemsc&&jt_o3xait.Get_Index()==0)
{if(jt_oxe.Get_3xXEID().Get_TypEntity()==jg_oe.jc_oEntity.jc_Typ_MetaSystemControl)
continue;}
jg_oe.CanLogInfo()&&jg_oe.LogInfo("PrintHtml-current row:"+jt_RowHF);var jt_o3xehf=new A3xaEntity_HtmlFrame(jt_RowHF);jt_o3xehf.Set_XtdEntity(jt_oxe);this.jm_ao3xehf.push(jt_o3xehf);jt_o3xehf.PrintHtml();jt_RowHF++;jt_o3xait.Next();}
...
{var jt_RowHF=1;var jt_o3xxemsc=jt_odb.Get_3xXEMSC_ByXUR();if(jt_o3xxemsc)
{var jt_o3xehf=this.jm_ao3xehf[jt_RowHF-1];var jt_o3xeh=new A3xaECP_Mgr(jt_o3xxemsc,jt_o3xehf);jg_oApp.jm_oecp=jt_o3xeh;this.jm_ao3xeh.push(jt_o3xeh);jt_o3xeh.PrintHtml(true);jt_RowHF++;}
var jt_nRows=this.jm_nRows;var jt_nRowsHF=this.jm_nRowsHF;if(!(jt_nRowsHF>0))
return false;var jt_ogldtMain=jt_odb.Get_MainDataTable();if(jt_ogldtMain)
{var jt_aoglr=jt_ogldtMain.Get_Recordsel();for(var jt_Row=1;jt_Row<=jt_nRows;jt_Row++)
{var jt_oxe=jt_aoglr.Get_Item_ByIndex(jt_Row-1);if(jt_Row==1&&jt_oxe.Get_3xXEID().Get_TypEntity()==jg_oe.jc_oEntity.jc_Typ_MetaSystemControl)
continue;var jt_o3xehf=this.jm_ao3xehf[jt_RowHF-1];var jt_o3xeh=new A3xaEntity_Html(jt_oxe,jt_o3xehf);this.jm_ao3xeh.push(jt_o3xeh);if(jt_Row==jt_RowHF)
jt_o3xeh.DoNotShiftIdTag();jt_o3xeh.PrintHtml(true);jt_RowHF++;}}
...
{var jr_aoxeid=new Array();var jt_RowHF=1;while(1)
{var jt_o3xehf=new A3xaEntity_HtmlFrame(jt_RowHF,true);if(jt_o3xehf.IsEOT())
...
{jt_RowHF++;continue;}
jr_aoxeid.push(jt_o3xehf.Get_3xXEID());jt_RowHF++;}
return jr_aoxeid;};this.FindRowElem=function(ji_oxeid,ji_FirstRowHF,ji_LastRowHF)
{if(ji_oxeid)
ji_oxeid=ji_oxeid.Get_3xXEID();if(!ji_oxeid)
return null;if(!(ji_LastRowHF>0))
return null;if(!(ji_FirstRowHF>=1&&ji_FirstRowHF<=ji_LastRowHF))
return null;for(var jt_RowHF=ji_FirstRowHF;jt_RowHF<=ji_LastRowHF;jt_RowHF++)
{var jr_o3xehf=new A3xaEntity_HtmlFrame(jt_RowHF,true);if(jr_o3xehf.IsEOT())
...
{var jt_ao3xehf=this.Get_EHRowList(false);if(!(jt_ao3xehf&&jt_ao3xehf.length))
...
{var jt_oUrlLink=A3xaEntity_MakeUrl_Edit_Params2(jg_oe.jc_oMisc.jc_XURFN_ReloadEntity,ji_QUR,this.Get_Cache(true,true,false),ji_bSecundary,ji_Itemid);jt_oUrlLink.Redirect();return true;}
...
jt_IdFieldInfo=null;var jt_oUrlLink=A3xaEntity_MakeUrl_EditInfo_Params(jg_oe.jc_oMisc.jc_XURFN_EditEntityInfo,ji_QUR,jt_IdFieldInfo,ji_TypEntity,ji_IdEntity,ji_Itemid);jt_oUrlLink.Redirect();return true;}
...
{this.jc_oMisc=new A3xaDefines();this.jc_oStorage=new A3xaDefines_Storage();this.jm_StorageTypeDefault=this.jc_oStorage.jc_FLY;this.jc_oAjax=new A3xaDefines_Ajax();this.jc_oA3xaDbZero=new A3xaDefines_A3xaDbZero();this.jc_oA3xaDbZero.Init(this.jc_oStorage);this.jc_oEntity=new A3xaDefines_Entity();this.jc_oEntityInfo=new A3xaDefines_EntityInfo();this.jc_oHtml=new A3xaDefines_Html();this.jm_oAppXUR=new A3xaAppXUR();this.jm_oAppXUR.Set_DefQur(new A3xaDefines_QUR());this.jc_oQUR=this.jm_oAppXUR.Get_DefQur();this.jm_oAppMngIcons=new A3xaAppMngIcons();this.jm_oAppMngIcons.Set_DefIcons(new A3xaDefines_Icons());this.jc_oIcons=this.jm_oAppMngIcons.Get_DefIcons();this.Set_Storage(new A3xaStorageFLY());this.Set_Storage(new A3xaStorageSS());this.Set_Storage(new A3xaStorageLS());this.Set_Storage(new A3xaStorageIDB());this.Set_Reporter(new GLReporter());this.Set_Database(new A3xaDbZero());this.Set_TurboStatus(false);};this.Set_CommonValues=function(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_IdUser,ji_Itemid,ji_sxur,ji_sDirBase)
