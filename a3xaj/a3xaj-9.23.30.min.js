...
{A3xaEntity_Html.call(this,null,ji_o3xehf);var jt_this=this;this.jm_oDDCategoryCode=null;this.jm_oDDPairLand=null;this.jm_o3xMgrLand_IMap=null;this.jm_oecpOrder=null;this._A3xaECP_Mgr=function()
...
this.jm_oecpOrder=new A3xaECPOrder_Mgr();};this.Set_DataSource=function(ji_oxe)
...
{this.ResetApp();this.ShowCPTemplate();this.LogStatusBar("Ready");this.StoreData();return true;};this.StoreData=function()
...
{if(this.Get_ECPMgr())
this.Get_ECPMgr().ResetECP();this.Set_Reporter(new A3xaReporter());return true;};this.OnClickTurbo=function(ji_bCurrentStatus,ji_fnChangeStatus)
...
{jt_oheSet.Release(true);if(!jt_oheSet.PrintHtml2(true))
jr_b=false;}
else
{jt_oheSet=new A3xaHtmlEntitySet();this.Set_HtmlSetEntity(jt_oheSet);if(!jt_oheSet.PrintHtml2())
jr_b=false;}
if(jr_b)
...
if(jr_b)
jg_oe.LogStatusBar("",true);return jr_b;};this.ClearView=function()
{var jt_ohse=this.Get_HtmlSetEntity();if(jt_ohse)
{jt_ohse.Release(true);this.AbortHttpRequests();}
