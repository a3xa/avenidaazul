...
{if(ji_sText)
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("suspend:"+ji_sText,"","A3xaAbsEnvironment.LogStatusBar");this.jm_alsb.push({text:ji_sText,bchild:ji_bAsChild,bclean:ji_bClear});}
return true;}
if(ji_bClear)
{if(!this._ExecLogStatusBar("",ji_bAsChild,ji_bClear));}
while(this.jm_alsb&&this.jm_alsb.length)
{var jt_oText=this.jm_alsb.shift();jg_oe.CanLogInfo()&&jg_oe.LogInfo("grant:"+jt_oText.text,"","A3xaAbsEnvironment.LogStatusBar");if(!this._ExecLogStatusBar(jt_oText.text,jt_oText.bchild,jt_oText.bclean));}
if(ji_sText)
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("w2sb:"+ji_sText,"","A3xaAbsEnvironment.LogStatusBar");if(!this._ExecLogStatusBar(ji_sText,ji_bAsChild,ji_bClear));}
return true;};this._ExecLogStatusBar=function(ji_sText,ji_bAsChild,ji_bClear){return false;};this.Set_CommonValues=function(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_IdUser,ji_Itemid,ji_sDirBase,ji_sHomeDir,ji_sLang)
...
{jg_oe.CanLogInfo()&&jg_oe.LogInfo("Begin to","Store Tables","A3xaDatabase_StoreAllData");jg_oe.LogStatusBar("Storing");this.jm_oDTStatus.Set(jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreInProgress);}
...
jg_oe.LogStatusBar("Storing... "+this.jm_oDbSchema.Get_Descr(jt_ogldt.Get_Glid()),true);jt_oDbTransaction.UsingTable(jt_ogldt.Get_Glid());var jt_bResult=jt_ogldt.StoreToGLS(jt_oDbTransaction);jt_oDbTransaction.Release();if(!jt_bResult)
{return new GLDataStatus(jg_oe.jc_oA3xaDbZero.jc_DTStatus_StoreFail,"Store Database Table "+jt_ogldt.Get_Glid());}
...
{var jt_this=this;jg_oe.CanLogInfo({DB:4})&&jg_oe.LogInfo("Start Common","","A3xaDbLoaderManager.DatabaseLoadCommon");jg_oe.LogStatusBar("Loading Common");this.jm_odbLoader=new A3xaDbLoader(function(ji_oDTStatus)
...
{var jt_this=this;jg_oe.CanLogInfo({DB:4})&&jg_oe.LogInfo("Start Ext Header","","A3xaDbLoaderManager.DatabaseLoadExtHeader");jg_oe.LogStatusBar("Loading Extended Headers");this.jm_odbLoader=new A3xaDbLoader(function(ji_oDTStatus)
...
{var jt_this=this;jg_oe.CanLogInfo({DB:4})&&jg_oe.LogInfo("Start Load Main","","A3xaDbLoaderManager.DatabaseLoadMain");jg_oe.LogStatusBar("Loading Main");this.jm_odbLoader=new A3xaDbLoader(function(ji_oDTStatus)
...
{jg_oe.CanLogInfo({DB:4})&&jg_oe.LogInfo("Start Turbo Header","","A3xaDbLoaderManager.DatabaseLoadTurboHeader");jg_oe.LogStatusBar("Loading Turbo Headers");this.jm_odbLoader=new A3xaDbLoader(function(ji_oDTStatus)
...
jg_oe.LogStatusBar("Loading.... Extended Headers",true);this.jm_omthxLoader=new A3xaMTHXLoader(function(){return jt_this.Task();},this.jm_oDatabase,jt_aGlidToLoad,this.jm_oDatabase.Get_ArrayDTLoad(this.jm_pTypTables),this.jm_pTypTables);jg_oe.CanLogInfo()&&jg_oe.LogInfo("","","A3xaDbLoader._OnStart_TableHX");return true;};this._OnStart_Record=function()
...
this.jm_oDatabase.jm_oDbSchema.Get_Descr(jt_odt.Get_Glid()),true);var jt_otkrLoader=new A3xaTaskRecordLoader(function(){return jt_this.Task();},this.jm_oDatabase,jt_odt);jg_oe.CanLogInfo()&&jg_oe.LogInfo("Table id: "+jt_odt.Get_Glid(),"","A3xaMTRecordLoader.StartNextRecordTaskLoader");this.jm_otkrLoader=jt_otkrLoader;this.jm_oDTStatus.Set2(jg_oe.jc_oA3xaDbZero.jc_DTStatus2_StInProgress);jt_otkrLoader.Start();return true;};this._OnEnd=function(ji_oDTStatusEnd)
{if(ji_oDTStatusEnd&&ji_oDTStatusEnd.IsFail())
...
function A3xaDDItemAppLogger(ji_sKey,ji_sValue,ji_sDescr)
{A3xaDDItem.call(this,ji_sKey,ji_sValue,ji_sDescr);}
function A3xaAppLogger()
{var jt_this=this;this.jm_oddbox=null;this.jm_CurrentTextId=1;this.jm_ChildTextId=1;this.jm_bPrintHtml=false;this._A3xaAppLogger=function()
{this.jm_oddbox=new A3xaDDSelectBox(new A3xaDDItemAppLogger(1,1,"App Logger"),"AppLogger","App Logger");this.jm_oddbox.NewDDItem=function()
{return new A3xaDDItemAppLogger(jt_this.jm_CurrentTextId,jt_this.jm_CurrentTextId,"???");};this.jm_oddbox.OnChange=function(ji_eddbox,ji_oddi)
{var jt_sValue=ji_oddi.Get_Value();if(!jt_sValue)
return false;return true;};this.jm_oddbox.Set_ColorsBGHL(["80FF80","80FF80","C0FFC0"]);return true;};this.ConfigDD=function()
...
{this.jm_oddbox.ClearAllOptions();this.jm_CurrentTextId=1;this.jm_ChildTextId=1;return true;};this.Append=function(ji_sText,ji_bAsChild,ji_bClear)
{var jt_oddiRoot=this.jm_oddbox.jm_oddiRoot;if(!jt_oddiRoot)
return false;if(ji_bClear)
{this.Clear();if(!ji_sText)
{this.RefreshHtmlDD();return true;}}
if(ji_bAsChild)
{var jt_id=this.jm_CurrentTextId-1;if(jt_id<1)
this.Append("-",false,false);var jt_oddiParent=jt_oddiRoot.Get_Child(jt_id);if(!jt_oddiParent)
return false;var jt_oddiChild=new A3xaDDItemAppLogger(this.jm_ChildTextId,this.jm_ChildTextId,ji_sText?ji_sText:"-");this.jm_oddbox.Add_ChildAndHtml(jt_oddiParent,jt_oddiChild,!this.jm_bPrintHtml);this.jm_ChildTextId++;}
else
{this.jm_ChildTextId=1;var jt_oddi=new A3xaDDItemAppLogger(this.jm_CurrentTextId,this.jm_CurrentTextId,ji_sText?ji_sText:"-");this.jm_oddbox.jm_sKeySelected=this.jm_CurrentTextId;this.jm_oddbox.Add_ChildAndHtml(jt_oddiRoot,jt_oddi,!this.jm_bPrintHtml);this.jm_CurrentTextId++;}
...
return jr_oAjaxUrlParams.Get_UrlParams();jr_oAjaxUrlParams.Modify_UrlParam("p_GLAltIndex",jt_sGLAx);return jr_oAjaxUrlParams.Get_UrlParams();};this.NotifyWrite=function()
...
function A3xaEntity_Html(ji_oxe_NotUsed,ji_o3xehf)
{var jt_this=this;this.jm_oxe=null;this.jm_o3xehf=ji_o3xehf;this.jm_bNoShiftIdTag=false;this._A3xaEntity_Html=function()
{};this.Set_DataSource=function(ji_oxe){return this._A3xaEntity_Html_Set_DataSource(ji_oxe);};this._A3xaEntity_Html_Set_DataSource=function(ji_oxe){this.jm_oxe=ji_oxe;return true;};this.IsValid=function()
...
{if(!this.IsValid())
return false;if(!this.jm_bNoShiftIdTag&&ji_Row>0)
ji_Row--;if(ji_Row>0)
...
{if(!this.IsValid())
return false;var jt_oebid=this.jm_oxe.Get_3xEBID();var qi_oDivScore=jQuery("<div>");qi_oDivScore.attr("id","score_"+this.jm_oxe.Get_3xXEID().Get_TypEntity()+"_"+
...
{if(!this.IsValid())
return false;var jt_oebid=this.jm_oxe.Get_3xEBID();var qi_oDivClicks=jQuery("<div>");qi_oDivClicks.attr("id","clicks_"+this.jm_oxe.Get_3xXEID().Get_TypEntity()+"_"+
...
{if(!this.IsValid())
return false;var jt_oebid=this.jm_oxe.Get_3xEBID();var qi_oDivLikes=jQuery("<div>");qi_oDivLikes.attr("id","likes_"+this.jm_oxe.Get_3xXEID().Get_TypEntity()+"_"+
...
{if(!this.IsValid())
return false;var jt_o3xDate=new A3xaDateTime();jt_o3xDate.Set_DateTime(this.jm_oxe.Get_3xEBIS().Get_Created());if(jt_o3xDate.IsValid())
...
{if(!this.IsValid())
return false;var jt_sDescr=this.jm_oxe.Get_3xEBIS().Get_Descr();if(jt_sDescr)
...
{this.PrintHtml_GLMore(qi_oCell,ji_Row,ji_Col);if(!this.IsValid())
return false;var jt_oxeidGroup=new A3xaXEID();jt_oxeidGroup.CopyFrom(this.jm_oxe);if(jt_oxeidGroup.IsGroupMinor())
...
{if(!this.IsValid())
return false;if(ji_QUR==jg_oe.jc_oXUR.jc_QUR_QueryNewEntity&&ji_bSecundary&&(!this.jm_oxe.Get_3xXEID().IsGroupMajor()))
...
{if(!this.IsValid())
return false;var jt_oUrlLink=A3xaEntity_MakeUrl_EditInfo_Params(jg_oe.jc_oXUR.jc_XURFN_EditEntityInfo,ji_QUR,ji_IdFieldInfo,this.jm_oxe.Get_3xXEID().Get_TypEntity(),this.jm_oxe.Get_3xXEID().Get_IdEntity(),jg_oe.jm_Itemid);if(!jt_oUrlLink)
...
{if(!this.IsValid())
return false;var jt_oglmLand=new A3xaMgrLand();if(ji_bCountryFlag)
...
{if(!this.IsValid())
return false;var jt_oglmCat=new GLMgrCategory(jg_oe.Get_Database().Get_MainDataTable(),jg_oe.jm_Itemid);jt_oglmCat.PrintHtml_Icon(qi_oCell,this.jm_oxe);return true;};this.PrintHtml_ImageBox=function(qi_oCell,ji_Row,ji_Col)
{if(!this.IsValid())
...
function A3xaECP_Mgr(ji_oxe_NOTUSED,ji_o3xehf)
{A3xaEntity_Html.call(this,null,ji_o3xehf);var jt_this=this;this.jm_oDDCategoryCode=null;this.jm_oDDPairLand=null;this.jm_o3xMgrLand_IMap=null;this.jm_oecpOrder=null;this.jm_o3xAppLogger=null;this._A3xaECP_Mgr=function()
{this.jm_oDDCategoryCode=null;this.jm_oDDPairLand=null;var jt_oxeidHL=jg_oApp.Get_AppXUR().Get_3xXUR().Get_XEIDHighlights();if(jt_oxeidHL)
...
if(!this.jm_oecpOrder)
this.jm_oecpOrder=new A3xaECPOrder_Mgr();if(!this.jm_o3xAppLogger)
this.jm_o3xAppLogger=new A3xaAppLogger();};this.Set_DataSource=function(ji_oxe)
{this._A3xaEntity_Html_Set_DataSource(ji_oxe);this._A3xaECP_Mgr();return true;};this.ResetECP=function()
{this.jm_oDDCategoryCode=null;this.jm_oDDPairLand=null;this.jm_oecpOrder=null;this.jm_o3xMgrLand_IMap=null;return true;};this.Get_AppLogger=function(){return this.jm_o3xAppLogger;};this.PrintHtml_LandBox=function(qi_oCell,ji_Row,ji_Col,ji_bCountryFlag,ji_ColImages)
{if(!ji_bCountryFlag)
...
{if(!this.IsValid())
return false;jg_oe.CanLogInfo()&&jg_oe.LogInfo("","","A3xaECP_Mgr.PrintHtml_FilterBox");var jt_bBestFromBabylon=New_A3xaAZNC_XApp(this.jm_oxe.Get_3xXEID()).IsBestFromBabylon();var jt_oglmLand=new A3xaMgrLand();var jt_oglmCategory=new GLMgrCategory(jt_bBestFromBabylon);if(!jt_bBestFromBabylon)
...
return false;}
this.jm_o3xAppLogger.LoadDataDD();this.jm_o3xAppLogger.PrintHtmlDD(qi_oCell);return true;};this.PrintHtml_ControlIconsBox=function(qi_oCell,ji_Row,ji_Col)
{if(!this.PrintHtml_ControlIconsBox_Header(qi_oCell,ji_Row,ji_Col))
...
this.Set_Options_Body_Bkgnd(jt_sColorB);return true;};this.Get_Elem=function(ji_bHeader)
{if(ji_bHeader)
...
{A3pqhfpair.call(this);this.jm_RowHF=(ji_RowHF||null);this.jm_oxeid=null;this.jm_oxe=null;this.jm_ao3xehc=new Array();this.Set_XtdEntity=function(ji_oxe,ji_bStick)
...
return null;return this.jm_ao3xehc[ji_Col-1];};this.Get_XEIDCode=function(){return(this.jm_oxe?this.jm_oxe.Get_3xXEID().Get_String():"");};this.Get_RowHeaderHtmlID=function(){return"RowH_"+this.jm_RowHF;};this.Get_RowBodyHtmlID=function(){return(this.IsStick()?"RowS_":"Row_")+this.jm_RowHF;};this.PrintHtml=function(ji_bUpdateOnly)
{if(ji_bUpdateOnly)
...
return jr_b;var jt_ogldtMain=null;var jt_odb=jg_oe.Get_Database();if(jt_odb)
...
return false;this.jm_FirstFrameRow=((this.jm_o3xheCP&&this.jm_o3xheCP.Get_3xEH())?2:1);var jt_FrameRow=this.jm_FirstFrameRow;while(!jt_o3xait.IsEOF())
...
return true;};this.Release=function(ji_bClearHtml)
...
{this.ResetApp();this.ShowCPTemplate();this.LogStatusBar("Ready",false,true);this.StoreData();return true;};this.StoreData=function()
...
{if(this.Get_ECPMgr())
this.Get_ECPMgr().ResetECP();this.Set_Reporter(new A3xaReporter());return true;};this._ExecLogStatusBar=function(ji_sText,ji_bAsChild,ji_bClear)
{if(this.Get_ECPMgr()&&this.Get_ECPMgr().Get_AppLogger())
return this.Get_ECPMgr().Get_AppLogger().Append(ji_sText,ji_bAsChild,ji_bClear);return false;};this.OnClickTurbo=function(ji_bCurrentStatus,ji_fnChangeStatus)
...
jr_b=false;this.HideLeftPanel();return jr_b;};this.DocumentShow=function()
{var jr_b=true;try
...
{jg_oe.LogStatusBar("Clean App Logger",false,true);jt_ohse.Release(true);this.AbortHttpRequests();}
return true;};this.WriteGLRS2=function(ji_glid,ji_sGLRS,ji_sGLRS_AltIndex)
{var jr_b=false;try
