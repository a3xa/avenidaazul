...
jg_oe.CanLogInfo()&&jg_oe.LogInfo("w2sb:"+ji_o3xsText.Get_LString(),"","A3xaAbsEnvironment.LogStatusBar");if(!this._ExecLogStatusBar2(ji_o3xsText,ji_bAsChild,ji_bClear));return true;};this._ExecLogStatusBar2=function(ji_o3xsText,ji_bAsChild,ji_bClear){return false;};this.jm_o3x2Envars=A3xa2EnvironmentVariables();this.Set_CommonValues=function(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_IdUser,ji_sDirBase,ji_sHomeDir,ji_sLang)
{return this.A3xaAbsEnvironment_Set_CommonValues(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_IdUser,ji_sDirBase,ji_sHomeDir,ji_sLang);}
this.A3xaAbsEnvironment_Set_CommonValues=function(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_IdUser,ji_sDirBase,ji_sHomeDir,ji_sLang)
...
return false;var jt_oUrl=jt_o3xXUR.Get_A3xaUrl(true);jg_oe.jm_oAjax2.QueueRequest(new A3xaAjaxRequest2(jt_oUrl.Get_UrlBase(),jt_oUrl.Get_UrlParams(),jt_oAjaxResponse));return true;};}
...
encodeURIComponent(ji_oefParams.oxeNew.Get_3xEBID().Get_XJSon(ji_oefParams.bNew?null:ji_oefParams.oxeCur));alert("p3000-ajax-start="+jt_sAjaxUrlParams);jg_oe.jm_oAjax2.QueueRequest(new A3xaAjaxRequest2(jt_oUrl.Get_UrlBase(),jt_sAjaxUrlParams,jt_this));}}
...
jt_o3xhici_LA.Set_UrlLink(jg_oe.jm_sHomeDir+jg_oe.jm_sLang+"/"+jg_oe.jc_oUrls.jc_surlRelHomeDirLA,false);jt_o3xhici_LA.Set_Title(jt_odfic.jc_oIconMS_TopMenu_LA.title,jt_odfic.jc_oIconMS_TopMenu_LA.alt);jt_o3xhici_LA.Set_Options(null,false);var jt_ohButton_LA=new A3xaSimpleButton3(jt_o3xhici_LA);if(jt_bYB)
...
jt_o3xhici_YB.Set_UrlLink(jg_oe.jm_sHomeDir+jg_oe.jm_sLang+"/"+jg_oe.jc_oUrls.jc_surlRelHomeDirYB,false);jt_o3xhici_YB.Set_Title(jt_odfic.jc_oIconMS_TopMenu_YB.title,jt_odfic.jc_oIconMS_TopMenu_YB.alt);jt_o3xhici_YB.Set_Options(null,false);var jt_ohButton_YB=new A3xaSimpleButton3(jt_o3xhici_YB);if(jt_bYB)
...
{this.jc_oStorage=new A3xaDefines_Storage();this.jc_oA3xaDbZero=new A3xaDefines_A3xaDbZero();this.jc_oEntity=new A3xaDefines_Entity();this.jc_oEntityInfo=new A3xaDefines_EntityInfo();this.jc_oHtml=new A3xaDefines_Html();this.jc_oUrls=new A3xaDefines_Urls();this.jm_oAppXUR=new A3xaAppXUR();this.jm_oAppXUR.Set_DefXUR(new A3xaDefines_XUR());this.jc_oXUR=this.jm_oAppXUR.Get_DefXUR();this.jm_oAppMngIcons=new A3xaAppMngIcons();this.jm_oAppMngIcons.Set_DefIcons(new A3xaDefines_Icons());this.jc_oIcons=this.jm_oAppMngIcons.Get_DefIcons();this.jm_oMgrStorage=new A3xaStorageManager();this.Set_Reporter(new A3xaReporter());this.Set_Database(new A3xaDbZero());this.Get_MgrStorage().EnableStorage(function(ji_bReady){return jt_this.CheckInitDone();});this.jm_oMgrSummary=new A3xaMgrSummary();};this.HostInitApplication=function(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_IdUser,ji_sxur,ji_sDirBase,ji_sHomeDir,ji_sLang)
{this.A3xaAbsEnvironment_Set_CommonValues(ji_bDebug,ji_bCanEdit,ji_bCanLike,ji_IdUser,ji_sDirBase,ji_sHomeDir,ji_sLang);this.Set_Debug((ji_bDebug?1:0),{DB:3,DBT:"idb"});this.Get_AppXUR().Set_XURString(ji_sxur);return true;};this.Get_ECPMgr=function()
