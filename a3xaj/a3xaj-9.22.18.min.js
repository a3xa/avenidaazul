...
{this.jc_sFlickrset_avenidaazul="https://www.flickr.com/photos/avenidaazul/sets/";this.jc_sFlickrgal_avenidaazul="https://www.flickr.com/photos/avenidaazul/galleries/";}
...
jt_ogldtMain.SortByClick(true);if(jt_te==jg_oe.jc_oEntity.jc_Typ_MetaSystemControl);else if(jt_te==jg_oe.jc_oEntity.jc_Typ_Category)
...
{this.jm_QUR=jg_oe.jc_oXUR.jc_QUR_QuerySBT;return true;};this.MakeQUR=function(ji_bUnlimited,ji_bSortByTime)
{if(ji_bUnlimited)
...
{return this.jm_QUR==jg_oe.jc_oXUR.jc_QUR_QuerySBT;};this.IsUnlimited=function()
...
this.jm_oddbox.jm_sKeySelected=this.jc_Opt_ByClickDesc;else if(jt_oxur.IsSortByTime())
...
this.jm_oddbox.jm_sKeySelected=this.jc_Opt_ByScoreDesc;this.jm_oddi.jm_bVisible=false;var jt_oddip=new A3xaECPOrder_DDIOption(this.jc_Opt_By,this.jc_Opt_By,"Order by");this.jm_oddi.Add_Child(jt_oddip);jt_oddip.jm_bVisible=false;jt_oddip.Add_Child(new A3xaECPOrder_DDIOption(this.jc_Opt_ByScoreDesc,this.jc_Opt_ByScoreDesc,"Clasificación"));jt_oddip.Add_Child(new A3xaECPOrder_DDIOption(this.jc_Opt_ByClickDesc,this.jc_Opt_ByClickDesc,"Clicks"));jt_oddip.Add_Child(new A3xaECPOrder_DDIOption(this.jc_Opt_ByTimeDesc,this.jc_Opt_ByTimeDesc,"Tiempo"));jt_oddip.Add_Child(new A3xaECPOrder_DDIOption(this.jc_Opt_ByName,this.jc_Opt_ByName,"Nombre"));return true;};}
