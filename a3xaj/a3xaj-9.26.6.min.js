...
{this.jc_MaxViewRows=50;this.jc_Col_IdTag=1;this.jc_Col_LandIcons=2;this.jc_Col_CtrlInfoIcons=3;this.jc_Col_Identity=4;this.jc_Col_Info=5;this.jc_Col_Last=6;this.jc_Col_DefaultWidth=30;this.jc_Col_IdTagWidth=100;this.jc_Col_CtrlInfoIconsWidth=110;this.jc_Col_IdentityWidth=210;this.jc_Body_MinWidth=800;this.jc_Body_NormalWidth=1000;}
...
return null;return qt_oCell;};this.AppendHook=function(ji_bHeader,ji_IdCellFrame,ji_IdCellHook)
{if(ji_bHeader)
...
{A3pqhfpair.call(this);this.jm_RowHF=(ji_RowHF||null);this.jm_oxeid=null;this.jm_oxe=null;this.jm_ao3xehc=new Array();this.jm_bNarrowView=null;this.Set_XtdEntity=function(ji_oxe,ji_bStick)
...
return null;var jt_BrowserWidth=qt_oBody.width();if(this.jm_bNarrowView===true||this.jm_bNarrowView===false)
{if(this.jm_bNarrowView)
{if(jt_BrowserWidth>=jg_oe.jc_oHtml.jc_Body_NormalWidth)
{this.Set_NarrowView(false);return false;}}
else
{if(jt_BrowserWidth<jg_oe.jc_oHtml.jc_Body_MinWidth)
{this.Set_NarrowView(true);return true;}}}
else
{if(jt_BrowserWidth>=jg_oe.jc_oHtml.jc_Body_NormalWidth)
this.Set_NarrowView(false);else if(jt_BrowserWidth<jg_oe.jc_oHtml.jc_Body_MinWidth)
this.Set_NarrowView(true);else
this.Set_NarrowView(false);return this.jm_bNarrowView;}
return null;};this.Set_NarrowView=function(ji_bNarrowView)
{if(ji_bNarrowView===true)
this.jm_bNarrowView=true;else
this.jm_bNarrowView=false;return true;};this.IsNarrowView=function(){return this.jm_bNarrowView;};this.PrintHtml=function(ji_bUpdateOnly)
{if(ji_bUpdateOnly)
...
{if(this.IsNarrowView()&&this.jm_ao3xehc[i].jm_Col==jg_oe.jc_oHtml.jc_Col_Info)
{if(this.jm_ao3xehc[i].PrintHtml(true))
{}}
else
{if(this.jm_ao3xehc[i].PrintHtml(true))
{this.jm_ao3xehc[i].AppendHook(true);}
if(this.IsNarrowView()&&this.jm_ao3xehc[i].jm_Col==jg_oe.jc_oHtml.jc_Col_Identity)
{this.jm_ao3xehc[i].AppendHook(true,null,this.Get_Column(jg_oe.jc_oHtml.jc_Col_Info).jm_Header_Id);}}}
...
{if(this.jm_ao3xehc[i].PrintHtml(false))
{this.jm_ao3xehc[i].AppendHook(false);}
if(this.IsNarrowView()&&this.jm_ao3xehc[i].jm_Col==jg_oe.jc_oHtml.jc_Col_Identity)
{this.jm_ao3xehc[i].AppendHook(false,null,this.Get_Column(jg_oe.jc_oHtml.jc_Col_Info).jm_Body_Id);}}}
return true;};this.UpdateHtmlOnResize=function()
{if(!this.jm_ao3xehc)
return true;var jt_o3xehcIdentity=this.Get_Column(jg_oe.jc_oHtml.jc_Col_Identity);var jt_o3xehcInfo=this.Get_Column(jg_oe.jc_oHtml.jc_Col_Info);if(this.IsNarrowView())
{jt_o3xehcIdentity.AppendHook(true,null,jt_o3xehcInfo.jm_Header_Id);jt_o3xehcIdentity.AppendHook(false,null,jt_o3xehcInfo.jm_Body_Id);}
else
{jt_o3xehcInfo.AppendHook(true,null,jt_o3xehcInfo.jm_Header_Id);jt_o3xehcInfo.AppendHook(false,null,jt_o3xehcInfo.jm_Body_Id);}
...
return false;var jt_bnv=jt_o3xhePilot.jm_ao3xehf[0].CheckNarrowView();if(this.jm_ao3xehf)
{var jt_bnv2=jt_o3xhePilot.jm_ao3xehf[0].IsNarrowView();for(var ixf=0;ixf<this.jm_ao3xehf.length;ixf++)
{this.jm_ao3xehf[ixf].Set_NarrowView(jt_bnv2);}}
if(ji_bUpdateHtml&&(jt_bnv===true||jt_bnv===false))
...
jr_b=false;}
var jt_o3xAppWindow=new A3xaAppWindow();jt_o3xAppWindow.Set_EHResize(function(){jt_oheSet.OnWindowResize(true);});}}
catch(e)
