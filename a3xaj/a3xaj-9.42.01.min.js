...
return false;this.jm_bCheckInitDone=true;this.ResetApp();this.ShowCPTemplate();this.LogStatusBar2(new A3xaString(["Ready","Listo","Pronto","Pronto"]),false,true);this.Get_DataManager().ManageData();return true;};this.ResetApp=function()
{if(this.Get_ECPMgr())
